    ...
    private class FlingRunnable implements Runnable {
        ...
        public void run() {
            if (this.layout != null && HeaderBehavior.this.scroller != null) {
                boolean zComputeScrollOffset = HeaderBehavior.this.scroller.computeScrollOffset();
                HeaderBehavior headerBehavior = HeaderBehavior.this;
                if (zComputeScrollOffset) {
                    headerBehavior.setHeaderTopBottomOffset(this.parent, this.layout, HeaderBehavior.this.scroller.getCurrY());
