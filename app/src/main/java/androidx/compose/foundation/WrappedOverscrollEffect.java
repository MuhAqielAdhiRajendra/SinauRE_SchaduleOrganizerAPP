...
final class WrappedOverscrollEffect implements OverscrollEffect {
    ...
    public long mo264applyToScrollRhakbz0(long delta, int source, Function1<? super Offset, Offset> performScroll) {
        if (this.eventHandlingEnabled) {
            return this.innerOverscrollEffect.mo264applyToScrollRhakbz0(delta, source, performScroll);
        }
    ...
    public Object mo263applyToFlingBMRW4eQ(long velocity, Function2<? super Velocity, ? super Continuation<? super Velocity>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        if (this.eventHandlingEnabled) {
            Object objMo263applyToFlingBMRW4eQ = this.innerOverscrollEffect.mo263applyToFlingBMRW4eQ(velocity, function2, continuation);
