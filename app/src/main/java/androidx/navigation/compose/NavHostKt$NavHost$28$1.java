...
@DebugMetadata(c = "androidx.navigation.compose.NavHostKt$NavHost$28$1", f = "NavHost.kt", i = {}, l = {628}, m = "invokeSuspend", n = {}, s = {})
        ...
        switch (this.label) {
            case 0:
                ...
                if (NavHostKt.NavHost$lambda$38(this.$currentBackStack$delegate).size() > 1) {
                    ...
                    this.label = 1;
                    if (this.$transitionState.seekTo(NavHostKt.NavHost$lambda$40(this.$progress$delegate), previousEntry, this) == coroutine_suspended) {
