...
public class Explode extends Visibility {
    ...
    public Animator onDisappear(ViewGroup sceneRoot, View view, TransitionValues startValues, TransitionValues endValues) {
        ...
        calculateOut(sceneRoot, bounds, this.mTempLoc);
        return TranslationAnimationCreator.createAnimation(view, startValues, viewPosX, viewPosY, startX, startY, endX + this.mTempLoc[0], this.mTempLoc[1] + endY, sAccelerate, this);
    }
    ...
    private void calculateOut(View sceneRoot, Rect bounds, int[] outVector) {
        ...
        if (epicenter == null) {
            ...
            focalY = (sceneRoot.getHeight() / 2) + sceneRootY2 + Math.round(sceneRoot.getTranslationY());
        } else {
