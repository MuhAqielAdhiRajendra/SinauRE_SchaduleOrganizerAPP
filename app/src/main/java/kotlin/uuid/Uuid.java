...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m9097boximpl(ULong.m9103constructorimpl(getMostSignificantBits())), ULong.m9097boximpl(ULong.m9103constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m10421toUByteArrayTcUX1vc() {
        return UByteArray.m9000constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        return this.mostSignificantBits != other.mostSignificantBits ? Long.compare(ULong.m9103constructorimpl(this.mostSignificantBits) ^ Long.MIN_VALUE, ULong.m9103constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE) : Long.compare(ULong.m9103constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m9103constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m10423fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m10422fromUByteArrayGBYM_sE(byte[] ubyteArray) {
        ...
        public final Uuid generateV7NonMonotonicAt(Instant timestamp) {
            ...
            int verAndRandA = (((randomBytes[8] & 15) | 112) << 8) | (randomBytes[9] & UByte.MAX_VALUE);
