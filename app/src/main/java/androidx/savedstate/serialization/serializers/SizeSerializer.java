...
public final class SizeSerializer implements KSerializer<Size> {
    ...
    public void serialize(Encoder encoder, Size value) {
        ...
        SavedStateWriter.m8638putSizeimpl($this$serialize_u24lambda_u242_u24lambda_u241, $this$serialize_u24lambda_u242.getKey(), value);
    }
    ...
    public Size deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m8585getSizeimpl($this$deserialize_u24lambda_u245_u24lambda_u244, $this$deserialize_u24lambda_u245.getKey());
    }
}
