...
final class TextFieldImplKt$CommonDecorationBox$3$decoratedSuffix$1 implements Function2<Composer, Integer, Unit> {
    ...
    TextFieldImplKt$CommonDecorationBox$3$decoratedSuffix$1(State<Float> state, long j, TextStyle textStyle, Function2<? super Composer, ? super Integer, Unit> function2) {
    ...
    */
    public final void invoke(androidx.compose.runtime.Composer r29, int r30) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.internal.TextFieldImplKt$CommonDecorationBox$3$decoratedSuffix$1.invoke(androidx.compose.runtime.Composer, int):void");
    }
}
