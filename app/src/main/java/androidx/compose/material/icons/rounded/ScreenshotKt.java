...
public final class ScreenshotKt {
    ...
    public static final ImageVector getScreenshot(Icons.Rounded $this$Screenshot) {
        if (_screenshot != null) {
        ...
        ImageVector.Builder $this$_get_Screenshot__u24lambda_u241 = new ImageVector.Builder("Rounded.Screenshot", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(11.66f, 8.5f, 12.0f, 8.16f, 12.0f, 7.75f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(12.0f, 7.34f, 11.66f, 7.0f, 11.25f, 7.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(-2.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(8.34f, 7.0f, 8.0f, 7.34f, 8.0f, 7.75f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(2.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(8.0f, 10.66f, 8.34f, 11.0f, 8.75f, 11.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(12.75f, 17.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(2.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.41f, 0.0f, 0.75f, -0.34f, 0.75f, -0.75f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(-2.5f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(12.0f, 16.66f, 12.34f, 17.0f, 12.75f, 17.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _screenshot = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_Screenshot__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
