...
public final class TextFieldLayoutStateCache implements State<TextLayoutResult>, StateObject {
    ...
    public final void updateNonMeasureInputs(TransformedTextFieldState textFieldState, TextStyle textStyle, boolean singleLine, boolean softWrap, KeyboardOptions keyboardOptions) {
        setNonMeasureInputs(new NonMeasureInputs(textFieldState, textStyle, singleLine, softWrap, KeyboardType.m7794equalsimpl0(keyboardOptions.getKeyboardType(), KeyboardType.INSTANCE.m7814getPhonePjHm6EE())));
    }

    /* JADX INFO: renamed from: layoutWithNewMeasureInputs--hBUhpc */
    public final TextLayoutResult m1870layoutWithNewMeasureInputshBUhpc(Density density, LayoutDirection layoutDirection, FontFamily.Resolver fontFamilyResolver, long constraints) {
    ...
    private final TextLayoutResult getOrComputeLayout(NonMeasureInputs nonMeasureInputs, MeasureInputs measureInputs) throws Throwable {
        ...
        List<AnnotatedString.Range<AnnotatedString.Annotation>> listMergeNullableLists = TextFieldLayoutStateCacheKt.mergeNullableLists(visualText.getComposingAnnotations(), visualText.getOutputAnnotations());
        ...
        if (cachedResult != null) {
            ...
            if ((visualText2 != null && StringsKt.contentEquals(visualText2, visualText)) && Intrinsics.areEqual(cachedRecord.getAnnotations(), listMergeNullableLists) && Intrinsics.areEqual(cachedRecord.getComposition(), visualText.getComposition()) && cachedRecord.getSingleLine() == nonMeasureInputs.getSingleLine() && cachedRecord.getSoftWrap() == nonMeasureInputs.getSoftWrap() && cachedRecord.getLayoutDirection() == measureInputs.getLayoutDirection()) {
                if (cachedRecord.getDensityValue() == measureInputs.getDensity().getDensity()) {
                    if ((cachedRecord.getFontScale() == measureInputs.getDensity().getFontScale()) && Constraints.m8096equalsimpl0(cachedRecord.getConstraints(), measureInputs.getConstraints()) && Intrinsics.areEqual(cachedRecord.getFontFamilyResolver(), measureInputs.getFontFamilyResolver()) && !cachedResult.getMultiParagraph().getIntrinsics().getHasStaleResolvedFonts()) {
                        TextStyle textStyle = cachedRecord.getTextStyle();
                        boolean isLayoutAffectingSame = textStyle != null ? textStyle.hasSameLayoutAffectingAttributes(nonMeasureInputs.getTextStyle()) : false;
        ...
        TextFieldLayoutStateCache state$iv$iv = this;
        Object lock$iv$iv$iv$iv = SnapshotKt.getLock();
        synchronized (lock$iv$iv$iv$iv) {
            try {
                CacheRecord $this$getOrComputeLayout_u24lambda_u240_u240_u240 = (CacheRecord) SnapshotKt.writableRecord($this$writable$iv$iv, state$iv$iv, snapshot$iv);
                try {
                    $this$getOrComputeLayout_u24lambda_u240_u240_u240.setVisualText(visualText);
                    $this$getOrComputeLayout_u24lambda_u240_u240_u240.setAnnotations(listMergeNullableLists);
                    $this$getOrComputeLayout_u24lambda_u240_u240_u240.m1873setCompositionOEnZFl4(visualText.getComposition());
                    $this$getOrComputeLayout_u24lambda_u240_u240_u240.setSingleLine(nonMeasureInputs.getSingleLine());
                    $this$getOrComputeLayout_u24lambda_u240_u240_u240.setSoftWrap(nonMeasureInputs.getSoftWrap());
                    $this$getOrComputeLayout_u24lambda_u240_u240_u240.setTextStyle(nonMeasureInputs.getTextStyle());
                    $this$getOrComputeLayout_u24lambda_u240_u240_u240.setLayoutDirection(measureInputs.getLayoutDirection());
                    $this$getOrComputeLayout_u24lambda_u240_u240_u240.setDensityValue(measureInputs.getDensityValue());
                    $this$getOrComputeLayout_u24lambda_u240_u240_u240.setFontScale(measureInputs.getFontScale());
                    try {
                        $this$getOrComputeLayout_u24lambda_u240_u240_u240.m1874setConstraintsBRTryo0(measureInputs.getConstraints());
                        $this$getOrComputeLayout_u24lambda_u240_u240_u240.setFontFamilyResolver(measureInputs.getFontFamilyResolver());
                        $this$getOrComputeLayout_u24lambda_u240_u240_u240.setLayoutResult(newResult);
                        Unit unit = Unit.INSTANCE;
                        SnapshotKt.notifyWrite(snapshot$iv, state$iv$iv);
                        return newResult;
                    } catch (Throwable th) {
                        th = th;
                        throw th;
    ...
    private final void updateCacheIfWritable(Function1<? super CacheRecord, Unit> block) {
        ...
        if (!snapshot.getReadOnly()) {
            ...
            TextFieldLayoutStateCache state$iv = this;
            Object lock$iv$iv$iv = SnapshotKt.getLock();
            synchronized (lock$iv$iv$iv) {
                block.invoke(SnapshotKt.writableRecord($this$writable$iv, state$iv, snapshot));
            }
            SnapshotKt.notifyWrite(snapshot, state$iv);
        }
    }
    ...
    private static final class CacheRecord extends StateRecord {
        ...
        /* JADX INFO: renamed from: getComposition-MzsxiRA, reason: from getter */
        public final TextRange getComposition() {
            return this.composition;
        }

        /* JADX INFO: renamed from: setComposition-OEnZFl4 */
        public final void m1873setCompositionOEnZFl4(TextRange textRange) {
        ...
        /* JADX INFO: renamed from: setConstraints-BRTryo0 */
        public final void m1874setConstraintsBRTryo0(long j) {
            this.constraints = j;
        }
    ...
    /* JADX INFO: compiled from: TextFieldLayoutStateCache.kt */
    @Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\f\n\u0002\u0010\u0007\n\u0002\b\u0005\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0002\u0018\u0000 \u001d2\u00020\u0001:\u0001\u001dB'\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007\u0012\u0006\u0010\b\u001a\u00020\t¢\u0006\u0004\b\n\u0010\u000bJ\b\u0010\u001b\u001a\u00020\u001cH\u0016R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\f\u0010\rR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u000e\u0010\u000fR\u0011\u0010\u0006\u001a\u00020\u0007¢\u0006\b\n\u0000\u001a\u0004\b\u0010\u0010\u0011R\u0013\u0010\b\u001a\u00020\t¢\u0006\n\n\u0002\u0010\u0014\u001a\u0004\b\u0012\u0010\u0013R\u0011\u0010\u0015\u001a\u00020\u0016¢\u0006\b\n\u0000\u001a\u0004\b\u0017\u0010\u0018R\u0011\u0010\u0019\u001a\u00020\u0016¢\u0006\b\n\u0000\u001a\u0004\b\u001a\u0010\u0018¨\u0006\u001e"}, d2 = {"Landroidx/compose/foundation/text/input/internal/TextFieldLayoutStateCache$MeasureInputs;", "", "density", "Landroidx/compose/ui/unit/Density;", "layoutDirection", "Landroidx/compose/ui/unit/LayoutDirection;", "fontFamilyResolver", "Landroidx/compose/ui/text/font/FontFamily$Resolver;", "constraints", "Landroidx/compose/ui/unit/Constraints;", "<init>", "(Landroidx/compose/ui/unit/Density;Landroidx/compose/ui/unit/LayoutDirection;Landroidx/compose/ui/text/font/FontFamily$Resolver;JLkotlin/jvm/internal/DefaultConstructorMarker;)V", "getDensity", "()Landroidx/compose/ui/unit/Density;", "getLayoutDirection", "()Landroidx/compose/ui/unit/LayoutDirection;", "getFontFamilyResolver", "()Landroidx/compose/ui/text/font/FontFamily$Resolver;", "getConstraints-msEJaDk", "()J", "J", "densityValue", "", "getDensityValue", "()F", "fontScale", "getFontScale", "toString", "", "Companion", "foundation"}, k = 1, mv = {2, 1, 0}, xi = 48)
    static final class MeasureInputs {
        ...
        private static final SnapshotMutationPolicy<MeasureInputs> mutationPolicy = new SnapshotMutationPolicy<MeasureInputs>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldLayoutStateCache$MeasureInputs$Companion$mutationPolicy$1
            ...
            public boolean equivalent(TextFieldLayoutStateCache.MeasureInputs a, TextFieldLayoutStateCache.MeasureInputs b) {
                ...
                if (a.getDensityValue() == b.getDensityValue()) {
                    if ((a.getFontScale() == b.getFontScale()) && a.getLayoutDirection() == b.getLayoutDirection() && Intrinsics.areEqual(a.getFontFamilyResolver(), b.getFontFamilyResolver()) && Constraints.m8096equalsimpl0(a.getConstraints(), b.getConstraints())) {
                        return true;
                    }
                }
                return false;
        ...
        public String toString() {
            return "MeasureInputs(density=" + this.density + ", densityValue=" + this.densityValue + ", fontScale=" + this.fontScale + ", layoutDirection=" + this.layoutDirection + ", fontFamilyResolver=" + this.fontFamilyResolver + ", constraints=" + ((Object) Constraints.m8108toStringimpl(this.constraints)) + ')';
        }
