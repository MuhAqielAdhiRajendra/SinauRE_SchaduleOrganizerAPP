...
public final class MaterialContainerTransform extends Transition {
    ...
    private static void captureValues(TransitionValues transitionValues, View viewOverride, int viewIdOverride, ShapeAppearanceModel shapeAppearanceModelOverride) {
        ...
        if (snapshotView2.isLaidOut() || snapshotView2.getWidth() != 0 || snapshotView2.getHeight() != 0) {
            RectF bounds = snapshotView2.getParent() == null ? TransitionUtils.getRelativeBounds(snapshotView2) : TransitionUtils.getLocationInWindow(snapshotView2);
    ...
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
        ...
        addListener(new TransitionListenerAdapter() { // from class: com.google.android.material.transition.MaterialContainerTransform.2
            ...
            public void onTransitionStart(Transition transition) {
                drawingView2.getOverlay().add(transitionDrawable);
            ...
            public void onTransitionEnd(Transition transition) {
                ...
                drawingView2.getOverlay().remove(transitionDrawable);
            }
        });
        return animator;
    }
    ...
    private static float getElevationOrDefault(float elevation, View view) {
        return elevation != -1.0f ? elevation : view.getElevation();
    }
    ...
    private static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float progress) {
            ...
            RectF maskBounds2 = this.currentStartBounds;
            RectF maskBounds3 = this.currentStartBoundsMasked;
            RectF maskBounds4 = this.currentEndBoundsMasked;
            maskEvaluator.evaluate(progress, shapeAppearanceModel, shapeAppearanceModel2, maskBounds2, maskBounds3, maskBounds4, this.progressThresholds.shapeMask);
