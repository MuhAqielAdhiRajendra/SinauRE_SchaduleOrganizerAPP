...
public final class AndroidParagraph_androidKt {
    ...
    public static final Paragraph ActualParagraph(String text, TextStyle style, List<? extends AnnotatedString.Range<? extends AnnotatedString.Annotation>> list, List<AnnotatedString.Range<Placeholder>> list2, int maxLines, boolean ellipsis, float width, Density density, Font.ResourceLoader resourceLoader) {
        ...
        return new AndroidParagraph(androidParagraphIntrinsics, maxLines, ellipsis ? companion.m8061getEllipsisgIe3tQ8() : companion.m8060getClipgIe3tQ8(), ConstraintsKt.Constraints$default(0, ParagraphKt.ceilToInt(width), 0, 0, 13, null), null);
    }

    /* JADX INFO: renamed from: ActualParagraph-XGqx6AY, reason: not valid java name */
    public static final Paragraph m7834ActualParagraphXGqx6AY(String text, TextStyle style, List<? extends AnnotatedString.Range<? extends AnnotatedString.Annotation>> list, List<AnnotatedString.Range<Placeholder>> list2, int maxLines, int overflow, long constraints, Density density, FontFamily.Resolver fontFamilyResolver) {
    ...
    public static final Paragraph m7833ActualParagraph4FmOz70(ParagraphIntrinsics paragraphIntrinsics, int maxLines, int overflow, long constraints) {
