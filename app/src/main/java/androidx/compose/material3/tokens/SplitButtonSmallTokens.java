...
public final class SplitButtonSmallTokens {
    ...
    private static final float LeadingButtonLeadingSpace = Dp.m8150constructorimpl((float) 16.0d);
    private static final float LeadingButtonTrailingSpace = Dp.m8150constructorimpl((float) 12.0d);
