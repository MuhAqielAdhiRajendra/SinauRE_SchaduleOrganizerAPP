...
public final class SurfingKt {
    ...
    public static final ImageVector getSurfing(Icons.Sharp $this$Surfing) {
        if (_surfing != null) {
        ...
        ImageVector.Builder $this$_get_Surfing__u24lambda_u241 = new ImageVector.Builder("Sharp.Surfing", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(7.83f, 8.59f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(3.12f, -2.1f);
