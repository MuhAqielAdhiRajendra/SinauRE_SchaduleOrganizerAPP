...
public final class EmbeddingAnimationParams {
    ...
    private EmbeddingAnimationParams(EmbeddingAnimationBackground animationBackground, AnimationSpec openAnimation, AnimationSpec closeAnimation, AnimationSpec changeAnimation) {
    ...
    public static final class AnimationSpec {
        ...
        private AnimationSpec(int value) {
            this.value = value;
        }
    ...
    public int hashCode() {
        int result = this.animationBackground.hashCode();
        return (((((result * 31) + this.openAnimation.hashCode()) * 31) + this.closeAnimation.hashCode()) * 31) + this.changeAnimation.hashCode();
    }
    ...
    public static final class Builder {
        ...
        public final Builder setAnimationBackground(EmbeddingAnimationBackground background) {
            ...
            Builder $this$setAnimationBackground_u24lambda_u240 = this;
            $this$setAnimationBackground_u24lambda_u240.animationBackground = background;
            return this;
        }

        public final Builder setOpenAnimation(AnimationSpec spec) {
            Intrinsics.checkNotNullParameter(spec, "spec");
            Builder $this$setOpenAnimation_u24lambda_u241 = this;
            $this$setOpenAnimation_u24lambda_u241.openAnimation = spec;
            return this;
        }

        public final Builder setCloseAnimation(AnimationSpec spec) {
            Intrinsics.checkNotNullParameter(spec, "spec");
            Builder $this$setCloseAnimation_u24lambda_u242 = this;
            $this$setCloseAnimation_u24lambda_u242.closeAnimation = spec;
            return this;
        }

        public final Builder setChangeAnimation(AnimationSpec spec) {
            Intrinsics.checkNotNullParameter(spec, "spec");
            Builder $this$setChangeAnimation_u24lambda_u243 = this;
            $this$setChangeAnimation_u24lambda_u243.changeAnimation = spec;
            return this;
        }
