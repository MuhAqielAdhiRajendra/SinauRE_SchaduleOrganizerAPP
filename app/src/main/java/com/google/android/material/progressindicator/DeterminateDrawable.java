...
public final class DeterminateDrawable<S extends BaseProgressIndicatorSpec> extends DrawableWithAnimatedVisibilityChange {
    ...
    DeterminateDrawable(Context context, final BaseProgressIndicatorSpec baseSpec, DrawingDelegate<S> drawingDelegate) {
        ...
        this.springAnimation.setSpring(new SpringForce().setDampingRatio(1.0f).setStiffness(50.0f));
        ...
        this.phaseAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.progressindicator.DeterminateDrawable$$ExternalSyntheticLambda1
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m8852x8c297d3e(baseSpec, valueAnimator);
            }
        });
    ...
    /* synthetic */ void m8852x8c297d3e(BaseProgressIndicatorSpec baseSpec, ValueAnimator animation) {
    ...
    private void maybeInitializeAmplitudeAnimator() {
        ...
        this.amplitudeAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.progressindicator.DeterminateDrawable$$ExternalSyntheticLambda0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m8851x5e685e4b(valueAnimator);
            }
        });
    }
    ...
    /* synthetic */ void m8851x5e685e4b(ValueAnimator animation) {
    ...
    private void updateSpringMinVisibleChange() {
        ...
        if (z) {
            ...
            springAnimation.setMinimumVisibleChange((float) (10000.0d / (((double) Math.min(height, width)) * 3.141592653589793d)));
        }
    }
    ...
    public void setSpringForce(SpringForce spring) {
        this.springAnimation.setSpring(spring);
    }
    ...
    private float getAmplitudeFractionFromLevel(int level) {
        if (level >= this.baseSpec.waveAmplitudeRampProgressMin * 10000.0f && level <= this.baseSpec.waveAmplitudeRampProgressMax * 10000.0f) {
            return 1.0f;
        }
        return 0.0f;
    }
    ...
    void setWaveAmplitudeRampProgressMin(float progress) {
        this.baseSpec.waveAmplitudeRampProgressMin = progress;
        invalidateSelf();
    }

    void setWaveAmplitudeRampProgressMax(float progress) {
        this.baseSpec.waveAmplitudeRampProgressMax = progress;
        invalidateSelf();
    }
}
