...
public final class CompositionLocalsKt {
    ...
    private static final ProvidableCompositionLocal<LocaleList> LocalProvidableLocaleList = CompositionLocalKt.staticCompositionLocalOf(new Function0<LocaleList>() { // from class: androidx.compose.ui.platform.CompositionLocalsKt$LocalProvidableLocaleList$1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
    ...
    private static final CompositionLocal<Locale> LocalLocale = CompositionLocalKt.compositionLocalWithComputedDefaultOf(new Function1<CompositionLocalAccessorScope, Locale>() { // from class: androidx.compose.ui.platform.CompositionLocalsKt$LocalLocale$1
        @Override // kotlin.jvm.functions.Function1
        public final Locale invoke(CompositionLocalAccessorScope $this$compositionLocalWithComputedDefaultOf) {
            return (Locale) CollectionsKt.first((Iterable) $this$compositionLocalWithComputedDefaultOf.getCurrentValue(CompositionLocalsKt.getLocalLocaleList()));
        }
    });
    ...
    public static final ProvidableCompositionLocal<LocaleList> getLocalProvidableLocaleList() {
        return LocalProvidableLocaleList;
    }

    public static final CompositionLocal<LocaleList> getLocalLocaleList() {
        return LocalProvidableLocaleList;
    }

    public static final CompositionLocal<Locale> getLocalLocale() {
        return LocalLocale;
    }
    ...
    public static final void ProvideCommonCompositionLocals(final Owner owner, final UriHandler uriHandler, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        Composer $composer2 = $composer.startRestartGroup(1925803616);
        ComposerKt.sourceInformation($composer2, "C(ProvideCommonCompositionLocals)N(owner,uriHandler,content)236@10049L1497:CompositionLocals.kt#itgzvw");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.platform.CompositionLocalsKt.ProvideCommonCompositionLocals.1
                ...
                public final void invoke(Composer composer, int i) {
                    CompositionLocalsKt.ProvideCommonCompositionLocals(owner, uriHandler, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
