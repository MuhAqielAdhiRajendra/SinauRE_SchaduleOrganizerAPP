...
public final class EmbeddingAspectRatio {
    ...
    private EmbeddingAspectRatio(String description, float value) {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof EmbeddingAspectRatio) {
            return ((this.value > ((EmbeddingAspectRatio) other).value ? 1 : (this.value == ((EmbeddingAspectRatio) other).value ? 0 : -1)) == 0) && Intrinsics.areEqual(this.description, ((EmbeddingAspectRatio) other).description);
        }
        return false;
    }
    ...
    @JvmStatic
    public static final EmbeddingAspectRatio ratio(float ratio) {
