...
public final class DonutSmallKt {
    ...
    public static final ImageVector getDonutSmall(Icons.Rounded $this$DonutSmall) {
        if (_donutSmall != null) {
        ...
        ImageVector.Builder $this$_get_DonutSmall__u24lambda_u241 = new ImageVector.Builder("Rounded.DonutSmall", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
