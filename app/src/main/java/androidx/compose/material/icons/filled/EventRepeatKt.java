...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_eventRepeat", "Landroidx/compose/ui/graphics/vector/ImageVector;", "EventRepeat", "Landroidx/compose/material/icons/Icons$Filled;", "getEventRepeat", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class EventRepeatKt {
    private static ImageVector _eventRepeat;

    public static final ImageVector getEventRepeat(Icons.Filled $this$EventRepeat) {
        ...
        ImageVector.Builder $this$_get_EventRepeat__u24lambda_u241 = new ImageVector.Builder("Filled.EventRepeat", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(15.64f, 20.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.43f, 1.45f, 1.77f, 2.5f, 3.36f, 2.5f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.95f, 0.0f, -1.82f, 0.38f, -2.45f, 1.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(1.45f, 0.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(0.0f, 1.43f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(16.4f, 14.55f, 17.64f, 14.0f, 19.0f, 14.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(15.64f, 20.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
