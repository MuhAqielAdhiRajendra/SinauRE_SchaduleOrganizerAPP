...
public final class FeedKt {
    ...
    public static final ImageVector getFeed(Icons.AutoMirrored.Sharp $this$Feed) {
        if (_feed != null) {
        ...
        ImageVector.Builder $this$_get_Feed__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Sharp.Feed", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
