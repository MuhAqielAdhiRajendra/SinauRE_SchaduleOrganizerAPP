...
final class EnterExitTransitionElement extends ModifierNodeElement<EnterExitTransitionModifierNode> {
    ...
    public boolean equals(Object other) {
        return (other instanceof EnterExitTransitionElement) && Intrinsics.areEqual(((EnterExitTransitionElement) other).transition, this.transition) && Intrinsics.areEqual(((EnterExitTransitionElement) other).sizeAnimation, this.sizeAnimation) && Intrinsics.areEqual(((EnterExitTransitionElement) other).offsetAnimation, this.offsetAnimation) && Intrinsics.areEqual(((EnterExitTransitionElement) other).slideAnimation, this.slideAnimation) && Intrinsics.areEqual(((EnterExitTransitionElement) other).enter, this.enter) && Intrinsics.areEqual(((EnterExitTransitionElement) other).exit, this.exit) && ((EnterExitTransitionElement) other).isEnabled == this.isEnabled && Intrinsics.areEqual(((EnterExitTransitionElement) other).graphicsLayerBlock, this.graphicsLayerBlock);
    }
}
