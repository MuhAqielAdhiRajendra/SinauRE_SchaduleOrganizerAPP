...
public final class FloatingActionButtonDefaults {
    ...
    private static final float LargeIconSize = Dp.m8150constructorimpl(36);

    private FloatingActionButtonDefaults() {
    }

    /* JADX INFO: renamed from: getLargeIconSize-D9Ej5fM, reason: not valid java name */
    public final float m2551getLargeIconSizeD9Ej5fM() {
    ...
    public final FloatingActionButtonElevation m2550elevationxZ9QkE(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, Composer $composer, int $changed, int i) {
        ...
        if ((i & 1) != 0) {
            float defaultElevation3 = FabPrimaryContainerTokens.INSTANCE.m3856getContainerElevationD9Ej5fM();
            defaultElevation2 = defaultElevation3;
        } else {
            defaultElevation2 = defaultElevation;
        }
        if ((i & 2) != 0) {
            float pressedElevation3 = FabPrimaryContainerTokens.INSTANCE.m3859getPressedContainerElevationD9Ej5fM();
            pressedElevation2 = pressedElevation3;
        } else {
            pressedElevation2 = pressedElevation;
        }
        if ((i & 4) != 0) {
            float focusedElevation3 = FabPrimaryContainerTokens.INSTANCE.m3857getFocusedContainerElevationD9Ej5fM();
            focusedElevation2 = focusedElevation3;
        } else {
            focusedElevation2 = focusedElevation;
        }
        if ((i & 8) != 0) {
            float hoveredElevation3 = FabPrimaryContainerTokens.INSTANCE.m3858getHoveredContainerElevationD9Ej5fM();
    ...
    public final FloatingActionButtonElevation m2552loweredElevationxZ9QkE(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, Composer $composer, int $changed, int i) {
        float defaultElevation2;
        float pressedElevation2;
        float focusedElevation2;
        float hoveredElevation2;
        ...
        if ((i & 1) != 0) {
            float defaultElevation3 = ElevationTokens.INSTANCE.m3805getLevel1D9Ej5fM();
            defaultElevation2 = defaultElevation3;
        } else {
            defaultElevation2 = defaultElevation;
        }
        if ((i & 2) != 0) {
            float pressedElevation3 = ElevationTokens.INSTANCE.m3805getLevel1D9Ej5fM();
            pressedElevation2 = pressedElevation3;
        } else {
            pressedElevation2 = pressedElevation;
        }
        if ((i & 4) != 0) {
            float focusedElevation3 = ElevationTokens.INSTANCE.m3805getLevel1D9Ej5fM();
            focusedElevation2 = focusedElevation3;
        } else {
            focusedElevation2 = focusedElevation;
        }
        if ((i & 8) != 0) {
            float hoveredElevation3 = ElevationTokens.INSTANCE.m3806getLevel2D9Ej5fM();
            hoveredElevation2 = hoveredElevation3;
        } else {
            hoveredElevation2 = hoveredElevation;
        }
    ...
    public static /* synthetic */ FloatingActionButtonElevation m2548bottomAppBarFabElevationa9UjIt4$default(FloatingActionButtonDefaults floatingActionButtonDefaults, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return floatingActionButtonDefaults.m2549bottomAppBarFabElevationa9UjIt4(f, f2, f3, f4);
    }

    /* JADX INFO: renamed from: bottomAppBarFabElevation-a9UjIt4, reason: not valid java name */
    public final FloatingActionButtonElevation m2549bottomAppBarFabElevationa9UjIt4(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation) {
