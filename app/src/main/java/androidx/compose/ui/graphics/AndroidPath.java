...
public final class AndroidPath implements Path {
    ...
    public int mo5201getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.INSTANCE.m5609getEvenOddRgk1Os();
        }
        return PathFillType.INSTANCE.m5610getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* JADX INFO: renamed from: setFillType-oQ8Xj4U, reason: not valid java name */
    public void mo5203setFillTypeoQ8Xj4U(int value) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m5605equalsimpl0(value, PathFillType.INSTANCE.m5609getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect, Path.Direction direction) {
        ...
        path.addRoundRect(rectF2, fArr, AndroidPath_androidKt.toPlatformPathDirection(direction));
    }
    ...
    public void mo5200addPathUv8p0NA(Path path, long offset) {
    ...
    public void mo5205translatek4lQ0M(long offset) {
    ...
    public void mo5204transform58bKbWc(float[] matrix) {
        if (this.mMatrix == null) {
            this.mMatrix = new android.graphics.Matrix();
        }
        android.graphics.Matrix matrix2 = this.mMatrix;
        Intrinsics.checkNotNull(matrix2);
        AndroidMatrixConversions_androidKt.m5180setFromEL8BTi8(matrix2, matrix);
        android.graphics.Path path = this.internalPath;
        android.graphics.Matrix matrix3 = this.mMatrix;
        Intrinsics.checkNotNull(matrix3);
        path.transform(matrix3);
    ...
    public Rect getBounds() {
        ...
        RectF $this$getBounds_u24lambda_u240 = this.rectF;
        Intrinsics.checkNotNull($this$getBounds_u24lambda_u240);
        this.internalPath.computeBounds($this$getBounds_u24lambda_u240, true);
        return new Rect($this$getBounds_u24lambda_u240.left, $this$getBounds_u24lambda_u240.top, $this$getBounds_u24lambda_u240.right, $this$getBounds_u24lambda_u240.bottom);
    }

    @Override // androidx.compose.ui.graphics.Path
    /* JADX INFO: renamed from: op-N5in7k0, reason: not valid java name */
    public boolean mo5202opN5in7k0(Path path1, Path path2, int operation) {
        Path.Op op;
        if (PathOperation.m5615equalsimpl0(operation, PathOperation.INSTANCE.m5619getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m5615equalsimpl0(operation, PathOperation.INSTANCE.m5620getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m5615equalsimpl0(operation, PathOperation.INSTANCE.m5621getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m5615equalsimpl0(operation, PathOperation.INSTANCE.m5622getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
