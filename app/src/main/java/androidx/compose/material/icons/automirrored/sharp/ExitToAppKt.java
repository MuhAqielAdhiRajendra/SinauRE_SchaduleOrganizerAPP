...
public final class ExitToAppKt {
    ...
    public static final ImageVector getExitToApp(Icons.AutoMirrored.Sharp $this$ExitToApp) {
        if (_exitToApp != null) {
        ...
        ImageVector.Builder $this$_get_ExitToApp__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Sharp.ExitToApp", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
