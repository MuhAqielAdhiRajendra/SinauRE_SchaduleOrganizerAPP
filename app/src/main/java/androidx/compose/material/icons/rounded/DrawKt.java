...
public final class DrawKt {
    ...
    public static final ImageVector getDraw(Icons.Rounded $this$Draw) {
        if (_draw != null) {
        ...
        ImageVector.Builder $this$_get_Draw__u24lambda_u241 = new ImageVector.Builder("Rounded.Draw", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(4.05f, 16.7f, 4.0f, 16.83f, 4.0f, 16.96f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(3.54f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(4.0f, 20.78f, 4.22f, 21.0f, 4.5f, 21.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(3.54f);
