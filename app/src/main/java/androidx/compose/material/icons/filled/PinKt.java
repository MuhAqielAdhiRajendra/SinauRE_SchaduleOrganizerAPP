...
public final class PinKt {
    ...
    public static final ImageVector getPin(Icons.Filled $this$Pin) {
        if (_pin != null) {
        ...
        ImageVector.Builder $this$_get_Pin__u24lambda_u241 = new ImageVector.Builder("Filled.Pin", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
