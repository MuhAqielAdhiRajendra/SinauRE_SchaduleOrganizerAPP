        ...
        public final TwoWayConverter<Color, AnimationVector4D> invoke(final ColorSpace colorSpace) {
            return VectorConvertersKt.TwoWayConverter(new Function1<Color, AnimationVector4D>() { // from class: androidx.compose.animation.ColorVectorConverterKt$ColorToVector$1.1
                ...
                public /* bridge */ /* synthetic */ AnimationVector4D invoke(Color color) {
                    return m82invoke8_81llA(color.m5323unboximpl());
                }

                /* JADX INFO: renamed from: invoke-8_81llA, reason: not valid java name */
                public final AnimationVector4D m82invoke8_81llA(long color) {
                    long jM5310convertvNxB06k = Color.m5310convertvNxB06k(color, ColorSpaces.INSTANCE.getOklab());
                    float l = Color.m5319getRedimpl(jM5310convertvNxB06k);
                    float a = Color.m5318getGreenimpl(jM5310convertvNxB06k);
                    float b = Color.m5316getBlueimpl(jM5310convertvNxB06k);
                    float alpha = Color.m5315getAlphaimpl(jM5310convertvNxB06k);
                ...
                public /* bridge */ /* synthetic */ Color invoke(AnimationVector4D animationVector4D) {
                    return Color.m5303boximpl(m83invokevNxB06k(animationVector4D));
                }

                /* JADX INFO: renamed from: invoke-vNxB06k, reason: not valid java name */
                public final long m83invokevNxB06k(AnimationVector4D vector) {
                    ...
                    return Color.m5310convertvNxB06k(ColorKt.Color($this$fastCoerceAtLeast$iv$iv, $this$fastCoerceAtLeast$iv$iv2, $this$fastCoerceAtLeast$iv$iv3, $this$fastCoerceAtLeast$iv$iv4, ColorSpaces.INSTANCE.getOklab()), colorSpace);
                }
            });
        }
    };
