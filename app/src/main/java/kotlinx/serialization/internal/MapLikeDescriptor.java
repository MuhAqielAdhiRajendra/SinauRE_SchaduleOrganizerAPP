...
public abstract class MapLikeDescriptor implements SerialDescriptor {
    ...
    public int hashCode() {
        ...
        return (((result * 31) + this.keyDescriptor.hashCode()) * 31) + this.valueDescriptor.hashCode();
    }
