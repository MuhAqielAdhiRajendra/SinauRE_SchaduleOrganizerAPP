...
public final class PeopleKt {
    ...
    public static final ImageVector getPeople(Icons.Outlined $this$People) {
        if (_people != null) {
        ...
        ImageVector.Builder $this$_get_People__u24lambda_u241 = new ImageVector.Builder("Outlined.People", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
