...
public final class AddCardKt {
    ...
    public static final ImageVector getAddCard(Icons.Outlined $this$AddCard) {
        if (_addCard != null) {
        ...
        ImageVector.Builder $this$_get_AddCard__u24lambda_u241 = new ImageVector.Builder("Outlined.AddCard", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
