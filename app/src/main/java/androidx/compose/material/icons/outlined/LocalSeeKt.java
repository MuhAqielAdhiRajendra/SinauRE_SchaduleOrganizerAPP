...
public final class LocalSeeKt {
    ...
    public static final ImageVector getLocalSee(Icons.Outlined $this$LocalSee) {
        if (_localSee != null) {
        ...
        ImageVector.Builder $this$_get_LocalSee__u24lambda_u241 = new ImageVector.Builder("Outlined.LocalSee", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(-2.24f, -5.0f, -5.0f, -5.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(12.0f, 15.2f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-1.77f, 0.0f, -3.2f, -1.43f, -3.2f, -3.2f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -1.77f, 1.43f, -3.2f, 3.2f, -3.2f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(3.2f, 1.43f, 3.2f, 3.2f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, 1.77f, -1.43f, 3.2f, -3.2f, 3.2f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _localSee = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_LocalSee__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
