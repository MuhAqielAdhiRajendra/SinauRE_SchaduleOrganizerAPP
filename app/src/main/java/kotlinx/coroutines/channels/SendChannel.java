...
public interface SendChannel<E> {
    ...
    Object mo10436trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo10436trySendJP2dKIU(e);
            if (ChannelResult.m10460isSuccessimpl(result)) {
                return true;
            }
            Throwable thM10454exceptionOrNullimpl = ChannelResult.m10454exceptionOrNullimpl(result);
