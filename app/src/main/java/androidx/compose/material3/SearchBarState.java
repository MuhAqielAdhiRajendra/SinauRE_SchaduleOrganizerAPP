...
public final class SearchBarState {
    ...
    static final SearchBarValue currentValue_delegate$lambda$0(SearchBarState this$0) {
    ...
    public final Object animateToExpanded(Continuation<? super Unit> continuation) {
        ...
        Object objAnimateTo = animatable.animateTo(Boxing.boxFloat(1.0f), (14 & 2) != 0 ? animatable.defaultSpringSpec : this.animationSpecForExpand, (14 & 4) != 0 ? animatable.getVelocity() : null, (14 & 8) != 0 ? null : null, continuation);
    ...
    public final Object animateToCollapsed(Continuation<? super Unit> continuation) {
        Animatable<Float, AnimationVector1D> animatable = this.animatable;
        Object objAnimateTo = animatable.animateTo(Boxing.boxFloat(0.0f), (14 & 2) != 0 ? animatable.defaultSpringSpec : this.animationSpecForCollapse, (14 & 4) != 0 ? animatable.getVelocity() : null, (14 & 8) != 0 ? null : null, continuation);
        return objAnimateTo == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objAnimateTo : Unit.INSTANCE;
    }

    public final Object snapTo(float fraction, Continuation<? super Unit> continuation) {
        Object objSnapTo = this.animatable.snapTo(Boxing.boxFloat(fraction), continuation);
    ...
    public static final class Companion {
        ...
        static final SearchBarState Saver$lambda$1(AnimationSpec $animationSpecForExpand, AnimationSpec $animationSpecForCollapse, List it) {
