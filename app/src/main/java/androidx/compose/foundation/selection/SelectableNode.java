...
final class SelectableNode extends ClickableNode {
    ...
    public final void m1346updateO2vRcR0(boolean selected, MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean useLocalIndication, boolean enabled, Role role, Function0<Unit> onClick) {
