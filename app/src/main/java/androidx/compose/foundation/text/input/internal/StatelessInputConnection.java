...
public final class StatelessInputConnection implements InputConnection {
            ...
            public boolean onCommitContent(InputContentInfoCompat inputContentInfo, int flags, Bundle opts) {
                ...
                if (Build.VERSION.SDK_INT >= 25 && (flags & 1) != 0) {
                    try {
                        ...
                        Parcelable inputContentInfoFmk = (Parcelable) objUnwrap;
                ...
                return this.this$0.session.onCommitContent(StatelessInputConnection_androidKt.toTransferableContent(inputContentInfo, extras));
            }
        });
    }
    ...
    public CharSequence getSelectedText(int flags) {
        CharSequence result;
        if (TextRange.m7567getCollapsedimpl(getText().getSelection())) {
            result = null;
        } else {
    ...
    public int getCursorCapsMode(int reqModes) {
        ...
        return TextUtils.getCapsMode(getText(), TextRange.m7571getMinimpl(getText().getSelection()), reqModes);
    }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        this.session.mo1751onImeActionKlQnJC8(imeAction);
        return true;
    }
