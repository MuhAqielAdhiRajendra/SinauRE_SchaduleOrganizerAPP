...
public final class RuleKt {
    ...
    public static final ImageVector getRule(Icons.Rounded $this$Rule) {
        if (_rule != null) {
        ...
        ImageVector.Builder $this$_get_Rule__u24lambda_u241 = new ImageVector.Builder("Rounded.Rule", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
