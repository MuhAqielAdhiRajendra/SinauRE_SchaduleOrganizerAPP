...
public final class LockOpenKt {
    ...
    public static final ImageVector getLockOpen(Icons.Filled $this$LockOpen) {
        if (_lockOpen != null) {
        ...
        ImageVector.Builder $this$_get_LockOpen__u24lambda_u241 = new ImageVector.Builder("Filled.LockOpen", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
