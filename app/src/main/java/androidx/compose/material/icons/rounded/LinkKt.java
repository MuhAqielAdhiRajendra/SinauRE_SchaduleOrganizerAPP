...
public final class LinkKt {
    ...
    public static final ImageVector getLink(Icons.Rounded $this$Link) {
        if (_link != null) {
        ...
        ImageVector.Builder $this$_get_Link__u24lambda_u241 = new ImageVector.Builder("Rounded.Link", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(8.45f, 11.0f, 8.0f, 11.45f, 8.0f, 12.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
