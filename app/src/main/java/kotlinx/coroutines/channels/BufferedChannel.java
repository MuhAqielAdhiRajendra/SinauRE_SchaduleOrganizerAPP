...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public Object mo10442receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        return m10440receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
    ...
    public final Object onClosedSend(E e, Continuation<? super Unit> continuation) {
        ...
        if (function1 != null && (it = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            $this$resumeWithStackTrace$iv.resumeWith(Result.m8929constructorimpl(ResultKt.createFailure(undeliveredElementExceptionRecoverFromStackFrame)));
        } else {
            ...
            $this$resumeWithStackTrace$iv2.resumeWith(Result.m8929constructorimpl(ResultKt.createFailure(thRecoverFromStackFrame)));
        }
                ...
                try {
                    switch (updateCellSend(channelSegment, index, e, s, cont, false)) {
                        case 0:
                            channelSegment.cleanPrev();
                            Result.Companion companion = Result.INSTANCE;
                            cont.resumeWith(Result.m8929constructorimpl(Unit.INSTANCE));
                            break;
                        case 1:
                            Result.Companion companion2 = Result.INSTANCE;
                            cont.resumeWith(Result.m8929constructorimpl(Unit.INSTANCE));
                            ...
                            while (true) {
                                ...
                                switch (updateCellSend(segment$iv$iv, i$iv$iv, e, s$iv$iv, cont2, closed$iv$iv)) {
                                    case 0:
                                        ...
                                        cont2.resumeWith(Result.m8929constructorimpl(Unit.INSTANCE));
                                        break;
                                    case 1:
    ...
    public final void onClosedSendOnNoWaiterSuspend(E element, CancellableContinuation<? super Unit> cont) {
        ...
        Result.Companion companion = Result.INSTANCE;
        cancellableContinuation.resumeWith(Result.m8929constructorimpl(ResultKt.createFailure(exception$iv)));
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo10436trySendJP2dKIU(E element) {
        ...
        if (!shouldSendSuspend(sendersAndCloseStatus$volatile$FU.get(this))) {
            ...
            while (true) {
                ...
                if (segment$iv2.id != id$iv) {
                    ...
                    if (segment$iv == null) {
                        if (closed$iv) {
                            return ChannelResult.INSTANCE.m10463closedJP2dKIU(getSendException());
                        }
                    }
                } else {
                ...
                switch (updateCellSend(segment$iv, i$iv, element, s$iv, waiter$iv, closed$iv)) {
                    case 0:
                        ...
                        return ChannelResult.INSTANCE.m10465successJP2dKIU(Unit.INSTANCE);
                    case 1:
                        return ChannelResult.INSTANCE.m10465successJP2dKIU(Unit.INSTANCE);
                    case 2:
                        if (closed$iv) {
                        ...
                        segm.onSlotCleaned();
                        return ChannelResult.INSTANCE.m10464failurePtdJZtk();
                    case 3:
                        throw new IllegalStateException("unexpected".toString());
                    case 4:
        ...
        while (true) {
            ...
            if (segment$iv.id != id$iv) {
                ...
                if (channelSegmentFindSegmentSend != null) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    cont.resumeWith(Result.m8929constructorimpl(Boxing.boxBoolean(false)));
                } else {
                    z = z2;
                }
            }
            switch (bufferedChannel.updateCellSend(segment$iv, i$iv, e, s$iv, waiter$iv, closed$iv)) {
                case 0:
                    segment$iv.cleanPrev();
                    Result.Companion companion2 = Result.INSTANCE;
                    cont.resumeWith(Result.m8929constructorimpl(Boxing.boxBoolean(z2)));
                    break;
                case 1:
                    Result.Companion companion3 = Result.INSTANCE;
                    cont.resumeWith(Result.m8929constructorimpl(Boxing.boxBoolean(z2)));
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x004c, code lost:
        ...
        return kotlinx.coroutines.channels.ChannelResult.INSTANCE.m10463closedJP2dKIU(getSendException());
     */
    ...
    */
    protected final java.lang.Object m10444trySendDropOldestJP2dKIU(E r20) {
        /*
            Method dump skipped, instruction units count: 218
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m10444trySendDropOldestJP2dKIU(java.lang.Object):java.lang.Object");
    }
    ...
    private final boolean tryResumeReceiver(Object $this$tryResumeReceiver, E e) {
        ...
        if ($this$tryResumeReceiver instanceof ReceiveCatching) {
            ...
            ChannelResult channelResultM10450boximpl = ChannelResult.m10450boximpl(ChannelResult.INSTANCE.m10465successJP2dKIU(e));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            return BufferedChannelKt.tryResume0(cancellableContinuationImpl, channelResultM10450boximpl, (Function3) (function1 != null ? bindCancellationFunResult(function1) : null));
        }
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation<? super E> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m8929constructorimpl(ResultKt.createFailure(getReceiveException())));
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    static /* synthetic */ <E> java.lang.Object m10440receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel<E> r14, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r15) {
        /*
            Method dump skipped, instruction units count: 224
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m10440receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.Object m10441receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment<E> r26, int r27, long r28, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r30) {
        /*
            Method dump skipped, instruction units count: 440
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m10441receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment, int, long, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation<? super ChannelResult<? extends E>> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m8929constructorimpl(ChannelResult.m10450boximpl(ChannelResult.INSTANCE.m10463closedJP2dKIU(getCloseCause()))));
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* JADX INFO: renamed from: tryReceive-PtdJZtk, reason: not valid java name */
    public Object mo10443tryReceivePtdJZtk() {
        ...
        if (isClosedForReceive0(sendersAndCloseStatusCur)) {
            return ChannelResult.INSTANCE.m10463closedJP2dKIU(getCloseCause());
        }
        ...
        while (!isClosedForReceive()) {
            ...
            if (updCellResult$iv != BufferedChannelKt.FAILED) {
                ...
                return ChannelResult.INSTANCE.m10465successJP2dKIU(updCellResult$iv);
            }
        ...
        while (true) {
            ...
            if (receivers$volatile$FU.compareAndSet(this, r, 1 + r)) {
                ...
                if (channelSegment2.id == id) {
                    ...
                    ChannelSegment<E> channelSegmentFindSegmentReceive = findSegmentReceive(id, channelSegment2);
                    if (channelSegmentFindSegmentReceive == null) {
                        continue;
                    } else {
                        channelSegment = channelSegmentFindSegmentReceive;
    ...
    private final void incCompletedExpandBufferAttempts(long nAttempts) {
        ...
        if ((it & SieveCacheKt.NodeVisitedBit) != 0) {
            ...
            } while (($this$ebPauseExpandBuffers$iv & SieveCacheKt.NodeVisitedBit) != 0);
        }
    }
    ...
    public final Object processResultSelectReceiveCatching(Object ignoredParam, Object selectResult) {
        return ChannelResult.m10450boximpl(selectResult == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.INSTANCE.m10463closedJP2dKIU(getCloseCause()) : ChannelResult.INSTANCE.m10465successJP2dKIU(selectResult));
    }
    ...
    private final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (cause == null) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m8929constructorimpl(false));
                return;
            }
            ...
            Result.Companion companion2 = Result.INSTANCE;
            cancellableContinuationImpl2.resumeWith(Result.m8929constructorimpl(ResultKt.createFailure(thRecoverFromStackFrame)));
        }
    ...
    */
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment<E> lastSegment, long sendersCounter) {
        Object suspendedReceivers = InlineList.m10489constructorimpl$default(null, 1, null);
            ...
            for (int index = BufferedChannelKt.SEGMENT_SIZE - 1; -1 < index; index--) {
                ...
                while (true) {
                    ...
                    if (state == null || state == BufferedChannelKt.IN_BUFFER) {
                        ...
                        if (channelSegment.casState$kotlinx_coroutines_core(index, state, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            suspendedReceivers = InlineList.m10494plusFjFbRPM(suspendedReceivers, ((WaiterEB) state).waiter);
                        ...
                        if (channelSegment.casState$kotlinx_coroutines_core(index, state, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            suspendedReceivers = InlineList.m10494plusFjFbRPM(suspendedReceivers, state);
                            channelSegment.onCancelledRequest(index, true);
                            break;
                        }
                    }
    ...
    private final void resumeWaiterOnClosedChannel(Waiter $this$resumeWaiterOnClosedChannel, boolean receiver) {
        if (!($this$resumeWaiterOnClosedChannel instanceof SendBroadcast)) {
            if (!($this$resumeWaiterOnClosedChannel instanceof CancellableContinuation)) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m8929constructorimpl(ChannelResult.m10450boximpl(ChannelResult.INSTANCE.m10463closedJP2dKIU(getCloseCause()))));
                return;
            }
            Continuation continuation = (Continuation) $this$resumeWaiterOnClosedChannel;
            Result.Companion companion2 = Result.INSTANCE;
            continuation.resumeWith(Result.m8929constructorimpl(ResultKt.createFailure(receiver ? getReceiveException() : getSendException())));
            return;
        }
        CancellableContinuation<Boolean> cont = ((SendBroadcast) $this$resumeWaiterOnClosedChannel).getCont();
        Result.Companion companion3 = Result.INSTANCE;
        cont.resumeWith(Result.m8929constructorimpl(false));
    }
    ...
    public final ChannelSegment<E> findSegmentSend(long id, ChannelSegment<E> startFrom) {
        ...
        do {
            ...
            if (SegmentOrClosed.m10506isClosedimpl(s$iv)) {
                break;
            }
            Segment to$iv$iv = SegmentOrClosed.m10504getSegmentimpl(s$iv);
            while (true) {
        ...
        ChannelSegment<E> channelSegment = (ChannelSegment) SegmentOrClosed.m10504getSegmentimpl(s$iv);
        if (channelSegment.id > id) {
    ...
    */
    ...
    /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function3<Throwable, ChannelResult<? extends E>, CoroutineContext, Unit> {
        ...
        public /* bridge */ /* synthetic */ Unit invoke(Throwable th, Object p2, CoroutineContext coroutineContext) {
            m10445invoke5_sEAP8(th, ((ChannelResult) p2).getHolder(), coroutineContext);
            return Unit.INSTANCE;
        }

        /* JADX INFO: renamed from: invoke-5_sEAP8, reason: not valid java name */
        public final void m10445invoke5_sEAP8(Throwable p0, Object p1, CoroutineContext p2) {
            ((BufferedChannel) this.receiver).m10439onCancellationChannelResultImplDoNotCall5_sEAP8(p0, p1, p2);
        }
    }
    ...
    public final void m10439onCancellationChannelResultImplDoNotCall5_sEAP8(Throwable cause, Object element, CoroutineContext context) {
        Function1<E, Unit> function1 = this.onUndeliveredElement;
        Intrinsics.checkNotNull(function1);
        Object objM10455getOrNullimpl = ChannelResult.m10455getOrNullimpl(element);
        Intrinsics.checkNotNull(objM10455getOrNullimpl);
        OnUndeliveredElementKt.callUndeliveredElement(function1, objM10455getOrNullimpl, context);
    }
