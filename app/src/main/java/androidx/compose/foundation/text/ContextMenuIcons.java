...
public final class ContextMenuIcons {
    ...
    public static final /* synthetic */ ContextMenuIcons m1509boximpl(int i) {
        return new ContextMenuIcons(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m1510constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m1511equalsimpl(int i, Object obj) {
        return (obj instanceof ContextMenuIcons) && i == ((ContextMenuIcons) obj).m1515unboximpl();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1512equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m1513hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m1514toStringimpl(int i) {
        return "ContextMenuIcons(value=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m1511equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m1513hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m1517getActionModeCutDrawable3I4p1mQ() {
            return ContextMenuIcons.m1510constructorimpl(R.attr.actionModeCutDrawable);
        }

        /* JADX INFO: renamed from: getActionModeCopyDrawable-3I4p1mQ, reason: not valid java name */
        public final int m1516getActionModeCopyDrawable3I4p1mQ() {
            return ContextMenuIcons.m1510constructorimpl(R.attr.actionModeCopyDrawable);
        }

        /* JADX INFO: renamed from: getActionModePasteDrawable-3I4p1mQ, reason: not valid java name */
        public final int m1518getActionModePasteDrawable3I4p1mQ() {
            return ContextMenuIcons.m1510constructorimpl(R.attr.actionModePasteDrawable);
        }

        /* JADX INFO: renamed from: getActionModeSelectAllDrawable-3I4p1mQ, reason: not valid java name */
        public final int m1519getActionModeSelectAllDrawable3I4p1mQ() {
            return ContextMenuIcons.m1510constructorimpl(R.attr.actionModeSelectAllDrawable);
        }

        /* JADX INFO: renamed from: getID_NULL-3I4p1mQ, reason: not valid java name */
        public final int m1520getID_NULL3I4p1mQ() {
            return ContextMenuIcons.m1510constructorimpl(0);
        }
    }

    private /* synthetic */ ContextMenuIcons(int value) {
        this.value = value;
    }
