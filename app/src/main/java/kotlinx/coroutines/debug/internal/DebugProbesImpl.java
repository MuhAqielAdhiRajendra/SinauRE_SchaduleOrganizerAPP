...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            objM8929constructorimpl = Result.m8929constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(objNewInstance, 1));
        } catch (Throwable th) {
        ...
        return (Function1) objM8929constructorimpl;
    }
    ...
    public final String hierarchyToString$kotlinx_coroutines_core(Job job) {
        ...
        for (Object element$iv$iv : $this$filter$iv) {
            ...
            if (it.delegate.get$context().get(Job.INSTANCE) != null) {
        ...
        for (Object element$iv$iv2 : $this$associateBy$iv) {
            ...
            jobToStack.put(JobKt.getJob(it2.delegate.get$context()), it3.info);
        }
        ...
        String string = $this$hierarchyToString_u24lambda_u247.toString();
    ...
    static final boolean dumpCoroutinesSynchronized$lambda$14(CoroutineOwner it) {
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            DebugProbesImpl debugProbesImpl = this;
            objM8929constructorimpl = Result.m8929constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM8929constructorimpl = Result.m8929constructorimpl(ResultKt.createFailure(th));
        }
        ...
        StackTraceElement[] actualTrace = (StackTraceElement[]) objM8929constructorimpl;
        if (actualTrace == null) {
            return coroutineTrace;
        }
        int index$iv = 0;
    ...
    private final <T> Continuation<T> createOwner(Continuation<? super T> completion, StackTraceFrame frame) {
        ...
        DebugCoroutineInfo info = new DebugCoroutineInfo(completion.get$context(), frame, DebugProbesImpl$DebugProbesImpl$VolatileWrapper$atomicfu$private.sequenceNumber$volatile$FU.incrementAndGet(debugProbesImpl$VolatileWrapper$atomicfu$private));
