...
public final class InsightsKt {
    ...
    public static final ImageVector getInsights(Icons.Sharp $this$Insights) {
        if (_insights != null) {
        ...
        ImageVector.Builder $this$_get_Insights__u24lambda_u243 = new ImageVector.Builder("Sharp.Insights", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
