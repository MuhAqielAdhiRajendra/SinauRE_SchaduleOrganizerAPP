...
@DebugMetadata(c = "androidx.compose.animation.AnimatedVisibilityKt$AnimatedEnterExitImpl$shouldDisposeAfterExit$2$1", f = "AnimatedVisibility.kt", i = {}, l = {746}, m = "invokeSuspend", n = {}, s = {}, v = 1)
            ...
            case 0:
                ...
                if (flowSnapshotFlow.collect(new FlowCollector() { // from class: androidx.compose.animation.AnimatedVisibilityKt$AnimatedEnterExitImpl$shouldDisposeAfterExit$2$1.2
                    ...
                    public final Object emit(boolean it, Continuation<? super Unit> continuation) {
                        ...
                        if (it) {
                            zBooleanValue = ((Boolean) AnimatedVisibilityKt.AnimatedEnterExitImpl$lambda$1(state).invoke(transition2.getCurrentState(), transition2.getTargetState())).booleanValue();
                        } else {
                            zBooleanValue = false;
                        }
                        produceStateScope.setValue(Boxing.boxBoolean(zBooleanValue));
