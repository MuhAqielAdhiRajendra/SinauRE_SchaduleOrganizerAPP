...
public final class BlindKt {
    ...
    public static final ImageVector getBlind(Icons.Sharp $this$Blind) {
        if (_blind != null) {
        ...
        ImageVector.Builder $this$_get_Blind__u24lambda_u242 = new ImageVector.Builder("Sharp.Blind", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
