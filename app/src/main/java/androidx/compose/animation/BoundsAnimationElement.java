...
public final class BoundsAnimationElement extends ModifierNodeElement<BoundsAnimationModifierNode> {
    ...
    public boolean equals(Object other) {
        return (other instanceof BoundsAnimationElement) && Intrinsics.areEqual(((BoundsAnimationElement) other).lookaheadScope, this.lookaheadScope) && Intrinsics.areEqual(((BoundsAnimationElement) other).boundsTransform, this.boundsTransform) && ((BoundsAnimationElement) other).resolveMeasureConstraints == this.resolveMeasureConstraints && ((BoundsAnimationElement) other).animateMotionFrameOfReference == this.animateMotionFrameOfReference;
    }
}
