...
final class KeyInputNode extends Modifier.Node implements KeyInputModifierNode {
    ...
    public boolean mo254onKeyEventZmokQxo(android.view.KeyEvent event) {
    ...
    public boolean mo256onPreKeyEventZmokQxo(android.view.KeyEvent event) {
