...
public final class ThermostatKt {
    ...
    public static final ImageVector getThermostat(Icons.Filled $this$Thermostat) {
        if (_thermostat != null) {
        ...
        ImageVector.Builder $this$_get_Thermostat__u24lambda_u241 = new ImageVector.Builder("Filled.Thermostat", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
