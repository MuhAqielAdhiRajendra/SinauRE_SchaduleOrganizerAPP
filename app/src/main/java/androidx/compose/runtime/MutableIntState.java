...
public class MutableIntState extends StateObjectImpl implements androidx.compose.runtime.MutableIntState, SnapshotMutableState<Integer> {
    ...
    public void setIntValue(int value) {
        ...
        if (it.getValue() != value) {
            ...
            MutableIntState state$iv = this;
            IntStateStateRecord candidate$iv = it;
            Object lock$iv$iv$iv = SnapshotKt.getLock();
            synchronized (lock$iv$iv$iv) {
                current = Snapshot.INSTANCE.getCurrent();
                IntStateStateRecord $this$_set_intValue__u24lambda_u240_u240 = (IntStateStateRecord) SnapshotKt.overwritableRecord($this$overwritable$iv, state$iv, current, candidate$iv);
                $this$_set_intValue__u24lambda_u240_u240.setValue(value);
    ...
    static final Unit component2$lambda$0(MutableIntState this$0, int it) {
    ...
    public Function1<Integer, Unit> component2() {
        return new Function1() { // from class: androidx.compose.runtime.SnapshotMutableIntStateImpl$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return MutableIntState.component2$lambda$0(this.f$0, ((Integer) obj).intValue());
            }
        };
    }
