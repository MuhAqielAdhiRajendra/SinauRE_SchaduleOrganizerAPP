...
public final class HeadsetKt {
    ...
    public static final ImageVector getHeadset(Icons.Sharp $this$Headset) {
        if (_headset != null) {
        ...
        ImageVector.Builder $this$_get_Headset__u24lambda_u241 = new ImageVector.Builder("Sharp.Headset", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
