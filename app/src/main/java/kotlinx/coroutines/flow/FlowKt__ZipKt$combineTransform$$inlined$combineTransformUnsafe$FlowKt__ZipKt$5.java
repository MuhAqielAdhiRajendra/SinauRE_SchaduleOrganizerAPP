        ...
        public final Object invokeSuspend(Object $completion) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    Object obj5 = args[4];
                    this.label = 1;
                    if (function7.invoke($this$combineInternal, obj, obj2, obj3, obj4, obj5, this) == coroutine_suspended) {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (CombineKt.combineInternal($this$safeFlow, this.$flows, FlowKt__ZipKt.nullArrayFactory$FlowKt__ZipKt(), new AnonymousClass1(null, this.$transform$inlined), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                break;
            case 1:
