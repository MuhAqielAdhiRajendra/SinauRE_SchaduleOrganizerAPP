...
public final class SosKt {
    ...
    public static final ImageVector getSos(Icons.Sharp $this$Sos) {
        if (_sos != null) {
        ...
        ImageVector.Builder $this$_get_Sos__u24lambda_u241 = new ImageVector.Builder("Sharp.Sos", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
