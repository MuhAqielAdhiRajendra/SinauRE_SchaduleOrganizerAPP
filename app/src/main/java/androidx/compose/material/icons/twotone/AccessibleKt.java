...
public final class AccessibleKt {
    ...
    public static final ImageVector getAccessible(Icons.TwoTone $this$Accessible) {
        if (_accessible != null) {
        ...
        ImageVector.Builder $this$_get_Accessible__u24lambda_u242 = new ImageVector.Builder("TwoTone.Accessible", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
