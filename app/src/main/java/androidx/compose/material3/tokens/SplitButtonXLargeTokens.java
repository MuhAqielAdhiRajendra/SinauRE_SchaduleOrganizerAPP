...
public final class SplitButtonXLargeTokens {
    ...
    private static final float LeadingButtonLeadingSpace = Dp.m8150constructorimpl((float) 64.0d);
    private static final float LeadingButtonTrailingSpace = Dp.m8150constructorimpl((float) 64.0d);
    private static final float TrailingIconSize = Dp.m8150constructorimpl((float) 50.0d);
    private static final float TrailingInnerSelectedCornerCornerSizePercent = 50.0f;
    private static final float TrailingButtonLeadingSpace = Dp.m8150constructorimpl((float) 43.0d);
    private static final float TrailingButtonTrailingSpace = Dp.m8150constructorimpl((float) 43.0d);

    private SplitButtonXLargeTokens() {
    }

    /* JADX INFO: renamed from: getBetweenSpace-D9Ej5fM, reason: not valid java name */
    public final float m4212getBetweenSpaceD9Ej5fM() {
        return BetweenSpace;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m4213getContainerHeightD9Ej5fM() {
    ...
    public final float m4216getTrailingButtonLeadingSpaceD9Ej5fM() {
    ...
    public final float m4217getTrailingButtonTrailingSpaceD9Ej5fM() {
