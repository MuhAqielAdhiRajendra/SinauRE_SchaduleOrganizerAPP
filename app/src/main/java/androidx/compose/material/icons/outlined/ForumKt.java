...
public final class ForumKt {
    ...
    public static final ImageVector getForum(Icons.Outlined $this$Forum) {
        if (_forum != null) {
        ...
        ImageVector.Builder $this$_get_Forum__u24lambda_u241 = new ImageVector.Builder("Outlined.Forum", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(4.0f, 12.17f);
