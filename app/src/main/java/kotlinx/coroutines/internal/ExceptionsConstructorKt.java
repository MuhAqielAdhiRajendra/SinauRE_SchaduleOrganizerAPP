...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM8929constructorimpl = Result.m8929constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
            ...
            return (E) objM8929constructorimpl;
        }
        ...
        while (true) {
            ...
            switch (parameterTypes.length) {
                ...
                case 1:
                    ...
                    pair = !Intrinsics.areEqual(cls2, String.class) ? !Intrinsics.areEqual(cls2, Throwable.class) ? TuplesKt.to(null, -1) : TuplesKt.to(safeCtor(new Function1() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$$ExternalSyntheticLambda3
                        @Override // kotlin.jvm.functions.Function1
                        public final Object invoke(Object obj) {
                            return ExceptionsConstructorKt.createConstructor$lambda$7$lambda$4(constructor, (Throwable) obj);
                        }
                    }), 1) : TuplesKt.to(safeCtor(new Function1() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$$ExternalSyntheticLambda2
                        @Override // kotlin.jvm.functions.Function1
                        public final Object invoke(Object obj) {
                ...
                case 2:
                    i = i2;
                    pair = (!Intrinsics.areEqual(parameterTypes[i2], String.class) || !Intrinsics.areEqual(parameterTypes[1], Throwable.class)) ? TuplesKt.to(null, -1) : TuplesKt.to(safeCtor(new Function1() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$$ExternalSyntheticLambda1
                        @Override // kotlin.jvm.functions.Function1
                        public final Object invoke(Object obj) {
    ...
    static final Throwable createConstructor$lambda$7$lambda$1(Constructor $constructor, Throwable e) throws IllegalAccessException, InstantiationException, InvocationTargetException {
    ...
    static final Throwable createConstructor$lambda$7$lambda$3(Constructor $constructor, Throwable e) throws IllegalAccessException, InstantiationException, InvocationTargetException {
    ...
    static final Throwable createConstructor$lambda$7$lambda$4(Constructor $constructor, Throwable e) throws IllegalAccessException, InstantiationException, InvocationTargetException {
        Object objNewInstance = $constructor.newInstance(e);
        Intrinsics.checkNotNull(objNewInstance, "null cannot be cast to non-null type kotlin.Throwable");
        return (Throwable) objNewInstance;
    }

    static final Throwable createConstructor$lambda$7$lambda$6(Constructor $constructor, Throwable e) throws IllegalAccessException, InstantiationException, InvocationTargetException {
    ...
    static final Throwable safeCtor$lambda$9(Function1 $block, Throwable e) {
        Object objM8929constructorimpl;
        try {
            Result.Companion companion = Result.INSTANCE;
            ...
            objM8929constructorimpl = Result.m8929constructorimpl(result);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM8929constructorimpl = Result.m8929constructorimpl(ResultKt.createFailure(th));
        }
        return (Throwable) (Result.m8935isFailureimpl(objM8929constructorimpl) ? null : objM8929constructorimpl);
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM8929constructorimpl = Result.m8929constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM8929constructorimpl = Result.m8929constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m8935isFailureimpl(objM8929constructorimpl)) {
            objM8929constructorimpl = numValueOf;
        }
        return ((Number) objM8929constructorimpl).intValue();
    }
