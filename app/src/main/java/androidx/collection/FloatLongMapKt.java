...
public final class FloatLongMapKt {
    ...
    public static final FloatLongMap floatLongMapOf(float key1, long value1) {
        MutableFloatLongMap map = new MutableFloatLongMap(0, 1, null);
        map.set(key1, value1);
        return map;
    }
    ...
    public static final FloatLongMap buildFloatLongMap(int initialCapacity, Function1<? super MutableFloatLongMap, Unit> builderAction) {
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
        MutableFloatLongMap mutableFloatLongMap = new MutableFloatLongMap(initialCapacity);
        builderAction.invoke(mutableFloatLongMap);
        return mutableFloatLongMap;
    }
}
