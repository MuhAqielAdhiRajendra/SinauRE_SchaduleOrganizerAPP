...
public final class CleanHandsKt {
    ...
    public static final ImageVector getCleanHands(Icons.Filled $this$CleanHands) {
        if (_cleanHands != null) {
        ...
        ImageVector.Builder $this$_get_CleanHands__u24lambda_u241 = new ImageVector.Builder("Filled.CleanHands", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(11.0f, 6.13f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-1.48f, 0.0f, -5.5f, 0.0f, -5.5f, 0.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(7.23f, 6.51f, 5.81f, 7.8f, 5.26f, 9.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(3.98f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(15.0f, 8.61f, 13.28f, 6.59f, 11.0f, 6.13f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(1.0f, 22.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-2.09f, -0.73f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(0.33f, -0.94f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(8.97f, 11.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(14.0f, 22.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(8.0f, -3.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(0.0f, 0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(21.99f, 17.9f, 21.11f, 17.0f, 20.0f, 17.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
