...
public class ShapeAppearanceModel implements ShapeAppearance {
    ...
    public static final class Builder {
        ...
        public Builder setCornerSizeOverride(int cornerPositionSet, CornerSize cornerSize) {
            if (ShapeAppearanceModel.containsFlag(cornerPositionSet, 1)) {
                setTopLeftCornerSize(cornerSize);
            }
            if (ShapeAppearanceModel.containsFlag(cornerPositionSet, 2)) {
                setTopRightCornerSize(cornerSize);
            }
            if (ShapeAppearanceModel.containsFlag(cornerPositionSet, 4)) {
                setBottomLeftCornerSize(cornerSize);
            }
            if (ShapeAppearanceModel.containsFlag(cornerPositionSet, 8)) {
    ...
    public static Builder builder(Resources.Theme theme, int shapeAppearanceResId) {
        TypedArray a = theme.obtainStyledAttributes(shapeAppearanceResId, R.styleable.ShapeAppearance);
        return builder(a, new AbsoluteCornerSize(0.0f));
    }
    ...
    private static Builder builder(TypedArray a, CornerSize defaultCornerSize) {
        try {
