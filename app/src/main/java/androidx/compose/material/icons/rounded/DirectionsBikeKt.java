...
public final class DirectionsBikeKt {
    ...
    public static final ImageVector getDirectionsBike(Icons.Rounded $this$DirectionsBike) {
        ...
        ImageVector.Builder $this$_get_DirectionsBike__u24lambda_u241 = new ImageVector.Builder("Rounded.DirectionsBike", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(1.06f, 1.06f, 2.38f, 1.78f, 3.96f, 2.02f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.6f, 0.09f, 1.14f, -0.39f, 1.14f, -1.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -0.49f, -0.37f, -0.91f, -0.85f, -0.99f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-1.11f, -0.18f, -2.02f, -0.71f, -2.75f, -1.43f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(-4.4f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -0.52f, -0.2f, -1.01f, -0.55f, -1.38f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(10.8f, 10.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(-1.6f, 3.5f, -3.5f, 3.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _directionsBike = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_DirectionsBike__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
