...
public final class GasMeterKt {
    ...
    public static final ImageVector getGasMeter(Icons.Rounded $this$GasMeter) {
        if (_gasMeter != null) {
        ...
        ImageVector.Builder $this$_get_GasMeter__u24lambda_u241 = new ImageVector.Builder("Rounded.GasMeter", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -1.02f, 0.38f, -1.35f, 2.12f, -3.35f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.2f, -0.23f, 0.56f, -0.23f, 0.75f, 0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(1.73f, 1.99f, 2.12f, 2.34f, 2.12f, 3.35f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _gasMeter = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_GasMeter__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
