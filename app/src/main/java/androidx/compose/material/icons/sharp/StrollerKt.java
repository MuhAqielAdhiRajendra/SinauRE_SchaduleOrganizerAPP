...
public final class StrollerKt {
    ...
    public static final ImageVector getStroller(Icons.Sharp $this$Stroller) {
        if (_stroller != null) {
        ...
        ImageVector.Builder $this$_get_Stroller__u24lambda_u241 = new ImageVector.Builder("Sharp.Stroller", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(8.03f, 3.0f, 6.21f, 3.64f, 4.72f, 4.72f);
