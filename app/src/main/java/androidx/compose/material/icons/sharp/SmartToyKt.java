...
public final class SmartToyKt {
    ...
    public static final ImageVector getSmartToy(Icons.Sharp $this$SmartToy) {
        if (_smartToy != null) {
        ...
        ImageVector.Builder $this$_get_SmartToy__u24lambda_u241 = new ImageVector.Builder("Sharp.SmartToy", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
