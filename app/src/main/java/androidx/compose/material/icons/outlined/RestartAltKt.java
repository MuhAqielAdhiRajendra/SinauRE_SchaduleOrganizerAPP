...
public final class RestartAltKt {
    ...
    public static final ImageVector getRestartAlt(Icons.Outlined $this$RestartAlt) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _restartAlt = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_RestartAlt__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
