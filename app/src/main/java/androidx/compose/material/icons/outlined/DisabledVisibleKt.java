...
public final class DisabledVisibleKt {
    ...
    public static final ImageVector getDisabledVisible(Icons.Outlined $this$DisabledVisible) {
        ...
        ImageVector.Builder $this$_get_DisabledVisible__u24lambda_u241 = new ImageVector.Builder("Outlined.DisabledVisible", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(20.76f, 19.02f, 18.95f, 20.0f, 17.0f, 20.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(-3.76f, -0.98f, -4.75f, -2.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(13.24f, 15.98f, 15.05f, 15.0f, 17.0f, 15.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(16.17f, 16.0f, 17.0f, 16.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(1.5f, 0.67f, 1.5f, 1.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(17.83f, 19.0f, 17.0f, 19.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _disabledVisible = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_DisabledVisible__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
