...
public final class AndroidAutofill implements Autofill {
    ...
    public void requestAutofillForNode(AutofillNode autofillNode) {
        ...
        autofillManager.notifyViewEntered(view, id, new android.graphics.Rect(iRound, iRound2, iRound3, Math.round($this$fastRoundToInt$iv4)));
    }
