...
public final class NestedScrollSource {
    ...
    private static final int UserInput = m6505constructorimpl(1);
    private static final int SideEffect = m6505constructorimpl(2);
    private static final int Drag = UserInput;
    private static final int Fling = SideEffect;
    private static final int Relocate = m6505constructorimpl(3);
    private static final int Wheel = UserInput;

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ NestedScrollSource m6504boximpl(int i) {
        return new NestedScrollSource(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m6505constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m6506equalsimpl(int i, Object obj) {
        return (obj instanceof NestedScrollSource) && i == ((NestedScrollSource) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m6507equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m6508hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object other) {
        return m6506equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m6508hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m6509toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m6509toStringimpl(int arg0) {
        return m6507equalsimpl0(arg0, UserInput) ? "UserInput" : m6507equalsimpl0(arg0, SideEffect) ? "SideEffect" : m6507equalsimpl0(arg0, Relocate) ? "Relocate" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m6511getDragWNlRxjI$annotations() {
        }
        ...
        public static /* synthetic */ void m6512getFlingWNlRxjI$annotations() {
        }
        ...
        public static /* synthetic */ void m6513getRelocateWNlRxjI$annotations() {
        }

        @Deprecated(message = "This has been replaced by UserInput.", replaceWith = @ReplaceWith(expression = "NestedScrollSource.UserInput", imports = {"import androidx.compose.ui.input.nestedscroll.NestedScrollSource.Companion.UserInput"}))
        /* JADX INFO: renamed from: getWheel-WNlRxjI$annotations, reason: not valid java name */
        public static /* synthetic */ void m6514getWheelWNlRxjI$annotations() {
        }
