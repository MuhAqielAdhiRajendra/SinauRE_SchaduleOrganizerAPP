...
public final class BlockRunner<T> {
    ...
    public BlockRunner(CoroutineLiveData<T> liveData, Function2<? super LiveDataScope<T>, ? super Continuation<? super Unit>, ? extends Object> block, long timeoutInMs, CoroutineScope scope, Function0<Unit> onDone) {
    ...
    public final void maybeRun() {
        ...
        this.runningJob = BuildersKt__Builders_commonKt.launch$default(this.scope, null, null, new C03461(this, null), 3, null);
    }
    ...
    static final class C03461 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C03461(BlockRunner<T> blockRunner, Continuation<? super C03461> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03461 c03461 = new C03461(this.this$0, continuation);
            c03461.L$0 = obj;
            return c03461;
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    LiveDataScopeImpl liveDataScope = new LiveDataScopeImpl(((BlockRunner) this.this$0).liveData, $this$launch.getCoroutineContext());
