...
@DebugMetadata(c = "androidx.compose.foundation.text.BasicTextFieldKt$BasicTextField$textToolbarHandler$1$1", f = "BasicTextField.kt", i = {0, 0}, l = {336}, m = "showTextToolbar", n = {"rect", "$this$showTextToolbar_u24lambda_u240"}, s = {"L$0", "L$3"}, v = 1)
