...
public final class PagerScrollPosition {
    ...
    public final void applyScrollDelta(int delta) {
        ...
        if (this.state.getPageSizeWithSpacing$foundation() == 0) {
            fractionUpdate = 0.0f;
        } else {
            fractionUpdate = delta / this.state.getPageSizeWithSpacing$foundation();
        }
