...
public final class AlarmOnKt {
    ...
    public static final ImageVector getAlarmOn(Icons.Sharp $this$AlarmOn) {
        if (_alarmOn != null) {
        ...
        ImageVector.Builder $this$_get_AlarmOn__u24lambda_u241 = new ImageVector.Builder("Sharp.AlarmOn", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
