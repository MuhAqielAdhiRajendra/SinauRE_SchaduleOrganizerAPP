...
final /* synthetic */ class FlowKt__DelayKt {
        ...
        if (timeoutMillis >= 0) {
            return timeoutMillis == 0 ? flow : debounceInternal$FlowKt__DelayKt(flow, new Function1() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt$$ExternalSyntheticLambda1
                ...
                public final Object invoke(Object obj) {
                    return Long.valueOf(FlowKt__DelayKt.debounce$lambda$1$FlowKt__DelayKt(timeoutMillis, obj));
                }
            });
        }
    ...
    public static final <T> Flow<T> m10475debounceHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt.debounce(flow, DelayKt.m10426toDelayMillisLRDsOJo(timeout));
    }
    ...
    public static final long debounce$lambda$2$FlowKt__DelayKt(Function1 $timeout, Object emittedItem) {
        return DelayKt.m10426toDelayMillisLRDsOJo(((Duration) $timeout.invoke(emittedItem)).getRawValue());
    }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    CoroutineScope $this$scopedFlow = (CoroutineScope) anonymousClass2.L$0;
                    FlowCollector downstream2 = (FlowCollector) anonymousClass2.L$1;
                    ReceiveChannel values2 = ProduceKt.produce$default($this$scopedFlow, null, -1, new FlowKt__DelayKt$sample$2$values$1(anonymousClass2.$this_sample, null), 1, null);
                    lastValue = new Ref.ObjectRef();
                    values = values2;
                    receiveChannelFixedPeriodTicker = FlowKt.fixedPeriodTicker($this$scopedFlow, anonymousClass2.$periodMillis);
                    downstream = downstream2;
                    break;
                case 1:
                    anonymousClass2 = this;
                    receiveChannelFixedPeriodTicker = (ReceiveChannel) anonymousClass2.L$3;
                    lastValue = (Ref.ObjectRef) anonymousClass2.L$2;
                    values = (ReceiveChannel) anonymousClass2.L$1;
                    downstream = (FlowCollector) anonymousClass2.L$0;
                    ResultKt.throwOnFailure($result);
                    break;
                default:
            ...
            while (lastValue.element != NullSurrogateKt.DONE) {
                SelectImplementation $this$select_u24lambda_u240$iv = new SelectImplementation(anonymousClass2.getContext());
                SelectImplementation $this$invokeSuspend_u24lambda_u240 = $this$select_u24lambda_u240$iv;
                ...
                anonymousClass2.L$0 = downstream;
                anonymousClass2.L$1 = values;
                anonymousClass2.L$2 = lastValue;
                anonymousClass2.L$3 = receiveChannelFixedPeriodTicker;
                anonymousClass2.label = 1;
                if ($this$select_u24lambda_u240$iv.doSelect(anonymousClass2) == coroutine_suspended) {
    ...
    public static final <T> Flow<T> sample(Flow<? extends T> flow, long periodMillis) {
        if (periodMillis > 0) {
            return FlowCoroutineKt.scopedFlow(new AnonymousClass2(periodMillis, flow, null));
        }
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<ProducerScope<? super Unit>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:37:0x0069 -> B:33:0x0046). Please report as a decompilation issue!!! */
    ...
    public static final <T> Flow<T> m10476sampleHG0u8IE(Flow<? extends T> flow, long period) {
        return FlowKt.sample(flow, DelayKt.m10426toDelayMillisLRDsOJo(period));
    }

    /* JADX INFO: renamed from: timeout-HG0u8IE */
    public static final <T> Flow<T> m10477timeoutHG0u8IE(Flow<? extends T> flow, long timeout) {
        return m10478timeoutInternalHG0u8IE$FlowKt__DelayKt(flow, timeout);
    }

    /* JADX INFO: renamed from: timeoutInternal-HG0u8IE$FlowKt__DelayKt */
    private static final <T> Flow<T> m10478timeoutInternalHG0u8IE$FlowKt__DelayKt(Flow<? extends T> flow, long timeout) {
