...
public class MaterialSwitch extends SwitchCompat {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (this.trackDrawable != null && (focusRingDrawable = FocusRingDrawable.find(getBackground())) != null) {
            focusRingDrawable.mutate();
            focusRingDrawable.setFocusRingBounds(this.trackDrawable.getBounds());
        }
    }
