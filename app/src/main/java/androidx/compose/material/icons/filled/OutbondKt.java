...
public final class OutbondKt {
    ...
    public static final ImageVector getOutbond(Icons.Filled $this$Outbond) {
        if (_outbond != null) {
        ...
        ImageVector.Builder $this$_get_Outbond__u24lambda_u241 = new ImageVector.Builder("Filled.Outbond", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
