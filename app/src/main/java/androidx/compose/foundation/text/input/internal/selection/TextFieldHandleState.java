...
public final /* data */ class TextFieldHandleState {
    ...
    public static /* synthetic */ TextFieldHandleState m1920copyYqVAtuI$default(TextFieldHandleState textFieldHandleState, boolean z, long j, float f, ResolvedTextDirection resolvedTextDirection, boolean z2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        boolean z3 = z2;
        float f2 = f;
        return textFieldHandleState.m1922copyYqVAtuI(z, j, f2, resolvedTextDirection, z3);
    }
    ...
    public final TextFieldHandleState m1922copyYqVAtuI(boolean visible, long position, float lineHeight, ResolvedTextDirection direction, boolean handlesCrossed) {
    ...
    public boolean equals(Object other) {
        ...
        return this.visible == textFieldHandleState.visible && Offset.m5065equalsimpl0(this.position, textFieldHandleState.position) && Float.compare(this.lineHeight, textFieldHandleState.lineHeight) == 0 && this.direction == textFieldHandleState.direction && this.handlesCrossed == textFieldHandleState.handlesCrossed;
    }

    public int hashCode() {
        return (((((((Boolean.hashCode(this.visible) * 31) + Offset.m5070hashCodeimpl(this.position)) * 31) + Float.hashCode(this.lineHeight)) * 31) + this.direction.hashCode()) * 31) + Boolean.hashCode(this.handlesCrossed);
    }

    public String toString() {
        return "TextFieldHandleState(visible=" + this.visible + ", position=" + ((Object) Offset.m5076toStringimpl(this.position)) + ", lineHeight=" + this.lineHeight + ", direction=" + this.direction + ", handlesCrossed=" + this.handlesCrossed + ')';
    }
    ...
    public final long m1923getPositionF1C5BW0() {
        return this.position;
    }
