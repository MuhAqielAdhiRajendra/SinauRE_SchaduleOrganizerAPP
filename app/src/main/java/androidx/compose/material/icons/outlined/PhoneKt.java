...
public final class PhoneKt {
    ...
    public static final ImageVector getPhone(Icons.Outlined $this$Phone) {
        ...
        ImageVector.Builder $this$_get_Phone__u24lambda_u241 = new ImageVector.Builder("Outlined.Phone", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        _phone = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_Phone__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
