...
public class MaterialRadioButton extends AppCompatRadioButton {
    ...
    public MaterialRadioButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attributes.hasValue(R.styleable.MaterialRadioButton_rippleColor)) {
            setRippleColor(MaterialResources.getColorStateList(context2, attributes, R.styleable.MaterialRadioButton_rippleColor));
        }
    ...
    private void setRippleColor(ColorStateList rippleColor) {
        if (rippleColor == null) {
            return;
        }
