    ...
    public MeasureResult mo1537measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, placeable.getWidth(), height, null, new Function1() { // from class: androidx.compose.foundation.text.VerticalScrollLayoutModifier$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return VerticalScrollLayoutModifier.measure_3p2s80s$lambda$0(this.f$0, placeable, height, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }

    static final Unit measure_3p2s80s$lambda$0(VerticalScrollLayoutModifier this$0, Placeable $placeable, int $height, Placeable.PlacementScope $this$layout) {
        ...
        Rect cursorRect = TextFieldScrollKt.getCursorRectInScroller(placementScope, i, transformedText, textLayoutResultProxyInvoke != null ? textLayoutResultProxyInvoke.getValue() : null, false, $placeable.getWidth());
