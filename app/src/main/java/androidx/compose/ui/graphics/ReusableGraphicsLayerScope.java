...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private int compositingStrategy = CompositingStrategy.INSTANCE.m5402getAutoNrFUSI();
    private long size = Size.INSTANCE.m5145getUnspecifiedNHjbRc();
    ...
    public void mo5510setAmbientShadowColor8_81llA(long value) {
        if (!Color.m5314equalsimpl0(this.ambientShadowColor, value)) {
    ...
    public void mo5513setSpotShadowColor8_81llA(long value) {
        if (!Color.m5314equalsimpl0(this.spotShadowColor, value)) {
    ...
    public void mo5514setTransformOrigin__ExYCQ(long value) {
        if (!TransformOrigin.m5720equalsimpl0(this.transformOrigin, value)) {
    ...
    public void mo5512setCompositingStrategyaDBOjCE(int value) {
        if (!CompositingStrategy.m5398equalsimpl0(this.compositingStrategy, value)) {
    ...
    public void m5641setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public float get_density() {
        return this.graphicsDensity.get_density();
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* JADX INFO: renamed from: getFontScale */
    public float get_fontScale() {
        return this.graphicsDensity.get_fontScale();
    }
    ...
    public void setColorFilter(ColorFilter value) {
        if (!Intrinsics.areEqual(this.colorFilter, value)) {
    ...
    public void mo5511setBlendModes9anfk8(int value) {
    ...
    public final void reset() {
        ...
        mo5510setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo5513setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo5514setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m5726getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        setColorFilter(null);
        mo5511setBlendModes9anfk8(BlendMode.INSTANCE.m5253getSrcOver0nO6VwU());
        mo5512setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m5402getAutoNrFUSI());
        m5641setSizeuvyYCjk(Size.INSTANCE.m5145getUnspecifiedNHjbRc());
        this.outline = null;
        this.mutatedFields = 0;
    }

    public final void updateOutline$ui() {
        this.outline = getShape().mo342createOutlinePq9zytI(getSize(), this.layoutDirection, this.graphicsDensity);
    }
}
