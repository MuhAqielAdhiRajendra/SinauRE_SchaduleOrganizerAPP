...
public interface OwnedLayer {
    ...
    float[] mo7157getUnderlyingMatrixsQKQjiQ();

    void invalidate();

    /* JADX INFO: renamed from: inverseTransform-58bKbWc, reason: not valid java name */
    void mo7158inverseTransform58bKbWc(float[] matrix);
    ...
    void mo7163transform58bKbWc(float[] matrix);
