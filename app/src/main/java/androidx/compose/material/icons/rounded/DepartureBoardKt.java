...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_departureBoard", "Landroidx/compose/ui/graphics/vector/ImageVector;", "DepartureBoard", "Landroidx/compose/material/icons/Icons$Rounded;", "getDepartureBoard", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class DepartureBoardKt {
    private static ImageVector _departureBoard;

    public static final ImageVector getDepartureBoard(Icons.Rounded $this$DepartureBoard) {
        ...
        ImageVector.Builder $this$_get_DepartureBoard__u24lambda_u241 = new ImageVector.Builder("Rounded.DepartureBoard", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(17.34f, 1.13f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-2.94f, -0.55f, -5.63f, 0.75f, -7.12f, 2.92f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(1.28f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, 0.83f, 0.67f, 1.5f, 1.5f, 1.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(5.0f, 22.33f, 5.0f, 21.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(5.0f, 21.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(3.72f, -0.54f, 6.5f, -3.98f, 5.92f, -7.97f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.42f, -2.9f, -2.7f, -5.29f, -5.58f, -5.82f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(-2.24f, 5.0f, -5.0f, 5.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(15.75f, 4.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(2.52f, 1.51f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.34f, 0.2f, 0.78f, 0.09f, 0.98f, -0.24f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.21f, -0.34f, 0.1f, -0.79f, -0.25f, -0.99f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(16.5f, 8.25f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _departureBoard = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_DepartureBoard__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
