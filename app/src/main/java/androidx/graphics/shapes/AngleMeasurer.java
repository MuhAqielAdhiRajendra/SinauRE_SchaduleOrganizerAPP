    ...
    public float findCubicCutPoint(final Cubic c, final float m) {
        ...
        return Utils.findMinimum(0.0f, 1.0f, 1.0E-5f, new FindMinimumFunction() { // from class: androidx.graphics.shapes.AngleMeasurer$$ExternalSyntheticLambda0
            ...
            public final float invoke(float f) {
                return AngleMeasurer.findCubicCutPoint$lambda$1(c, this, angle0, m, f);
            }
        });
    }

    static final float findCubicCutPoint$lambda$1(Cubic c, AngleMeasurer this$0, float $angle0, float $m, float t) {
        Intrinsics.checkNotNullParameter(c, "$c");
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        long curvePoint = c.m8463pointOnCurveOOQOV4g$graphics_shapes_release(t);
        float angle = Utils.angle(PointKt.m8475getXDnnuFBc(curvePoint) - this$0.centerX, PointKt.m8476getYDnnuFBc(curvePoint) - this$0.centerY);
