...
public final class MarkEmailReadKt {
    ...
    public static final ImageVector getMarkEmailRead(Icons.Rounded $this$MarkEmailRead) {
        ...
        ImageVector.Builder $this$_get_MarkEmailRead__u24lambda_u241 = new ImageVector.Builder("Rounded.MarkEmailRead", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(18.05f, 21.29f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.39f, 0.39f, 0.39f, 1.02f, 0.0f, 1.41f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(18.05f, 21.29f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(12.08f, 20.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(21.09f, 12.25f, 20.08f, 12.0f, 19.0f, 12.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-3.87f, 0.0f, -7.0f, 3.13f, -7.0f, 7.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(12.0f, 19.34f, 12.03f, 19.67f, 12.08f, 20.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(11.47f, 12.67f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(19.85f, 8.09f, 20.0f, 7.82f, 20.0f, 7.53f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(5.3f, 6.81f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(4.73f, 6.46f, 4.0f, 6.86f, 4.0f, 7.53f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, 0.29f, 0.15f, 0.56f, 0.4f, 0.72f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(11.47f, 12.67f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _markEmailRead = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_MarkEmailRead__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
