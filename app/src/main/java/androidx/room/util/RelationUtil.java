...
public final class RelationUtil {
    ...
    public static final <K, V> void recursiveFetchHashMap(HashMap<K, V> map, boolean isRelationCollection, Function1<? super HashMap<K, V>, Unit> function1) {
        RelationUtil__RelationUtil_androidKt.recursiveFetchHashMap(map, isRelationCollection, function1);
    }
