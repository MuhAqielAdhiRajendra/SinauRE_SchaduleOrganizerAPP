...
public final class ButtonColors {
    ...
    public final ButtonColors m2203copyjRlVdoo(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor) {
    ...
    public final long m2201containerColorvNxB06k$material3(boolean enabled) {
    ...
    public final long m2202contentColorvNxB06k$material3(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof ButtonColors) && Color.m5314equalsimpl0(this.containerColor, ((ButtonColors) other).containerColor) && Color.m5314equalsimpl0(this.contentColor, ((ButtonColors) other).contentColor) && Color.m5314equalsimpl0(this.disabledContainerColor, ((ButtonColors) other).disabledContainerColor) && Color.m5314equalsimpl0(this.disabledContentColor, ((ButtonColors) other).disabledContentColor)) {
            return true;
        }
        return false;
    }
