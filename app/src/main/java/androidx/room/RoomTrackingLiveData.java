...
public abstract class RoomTrackingLiveData<T> extends LiveData<T> {
    ...
    static final class C03561 extends ContinuationImpl {
        ...
        C03561(RoomTrackingLiveData<T> roomTrackingLiveData, Continuation<? super C03561> continuation) {
            super(continuation);
    ...
    /* JADX WARN: Type inference failed for: r3v5, types: [androidx.room.RoomTrackingLiveData] */
    /* JADX WARN: Type inference failed for: r3v6, types: [androidx.room.RoomTrackingLiveData] */
    /* JADX WARN: Type inference failed for: r3v9 */
    /* JADX WARN: Type inference failed for: r6v10 */
    /* JADX WARN: Type inference failed for: r6v13 */
    /* JADX WARN: Type inference failed for: r6v9 */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:24:0x005d -> B:41:0x00a0). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:25:0x0060 -> B:26:0x0061). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:32:0x0076 -> B:33:0x007c). Please report as a decompilation issue!!! */
    /*
    ...
    */
    public final java.lang.Object refresh(kotlin.coroutines.Continuation<? super kotlin.Unit> r11) {
        /*
            r10 = this;
            boolean r0 = r11 instanceof androidx.room.RoomTrackingLiveData.C03561
            if (r0 == 0) goto L14
            r0 = r11
            androidx.room.RoomTrackingLiveData$refresh$1 r0 = (androidx.room.RoomTrackingLiveData.C03561) r0
            int r1 = r0.label
    ...
    protected void onActive() {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.database.getCoroutineScope(), this.launchContext, null, new C03551(this, null), 2, null);
    }
    ...
    static final class C03551 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03551(RoomTrackingLiveData<T> roomTrackingLiveData, Continuation<? super C03551> continuation) {
            super(2, continuation);
            this.this$0 = roomTrackingLiveData;
        }
