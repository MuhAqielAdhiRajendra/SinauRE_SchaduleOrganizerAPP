...
public final class PictureInPictureUiStateCompat {
    ...
    public PictureInPictureUiStateCompat(boolean isStashed, boolean isTransitioningToPip) {
    ...
    @JvmStatic
    public static final PictureInPictureUiStateCompat fromPictureInPictureUiState(PictureInPictureUiState uiState) {
        return INSTANCE.fromPictureInPictureUiState(uiState);
    }
}
