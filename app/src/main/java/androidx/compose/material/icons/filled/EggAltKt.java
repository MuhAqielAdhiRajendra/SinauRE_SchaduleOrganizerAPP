...
public final class EggAltKt {
    ...
    public static final ImageVector getEggAlt(Icons.Filled $this$EggAlt) {
        if (_eggAlt != null) {
        ...
        ImageVector.Builder $this$_get_EggAlt__u24lambda_u241 = new ImageVector.Builder("Filled.EggAlt", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
