...
public abstract class LongList {
    ...
    public final <R> R fold(R initial, Function2<? super R, ? super Long, ? extends R> operation) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            rInvoke = operation.invoke(rInvoke, Long.valueOf(jArr[i2]));
        }
        return rInvoke;
    }
    ...
    public final <R> R foldIndexed(R initial, Function3<? super Integer, ? super R, ? super Long, ? extends R> operation) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            R r = rInvoke;
            rInvoke = operation.invoke(Integer.valueOf(i2), r, Long.valueOf(jArr[i2]));
        }
        return rInvoke;
    }
    ...
    public final <R> R foldRight(R initial, Function2<? super Long, ? super R, ? extends R> operation) {
        ...
        while (true) {
            ...
            rInvoke = operation.invoke(Long.valueOf(jArr[i]), rInvoke);
        }
    }
    ...
    public final <R> R foldRightIndexed(R initial, Function3<? super Integer, ? super Long, ? super R, ? extends R> operation) {
        ...
        while (true) {
            ...
            rInvoke = operation.invoke(Integer.valueOf(i), Long.valueOf(jArr[i]), rInvoke);
        }
    }
    ...
    public final void forEach(Function1<? super Long, Unit> block) {
        ...
        int i = this._size;
        for (int i2 = 0; i2 < i; i2++) {
            block.invoke(Long.valueOf(content[i2]));
        }
    }
    ...
    public final void forEachIndexed(Function2<? super Integer, ? super Long, Unit> block) {
        ...
        int i = this._size;
        for (int i2 = 0; i2 < i; i2++) {
            block.invoke(Integer.valueOf(i2), Long.valueOf(content[i2]));
        }
    }
    ...
    public final void forEachReversed(Function1<? super Long, Unit> block) {
        ...
        while (true) {
            i--;
            if (-1 < i) {
                block.invoke(Long.valueOf(content[i]));
            } else {
                return;
            }
        }
    ...
    public final void forEachReversedIndexed(Function2<? super Integer, ? super Long, Unit> block) {
        ...
        while (true) {
            i--;
            if (-1 < i) {
                block.invoke(Integer.valueOf(i), Long.valueOf(content[i]));
            } else {
                return;
            }
        }
    ...
    public final int indexOfLast(Function1<? super Long, Boolean> predicate) {
        ...
        } while (!predicate.invoke(Long.valueOf(item)).booleanValue());
        return i$iv;
    }
    ...
    public static /* synthetic */ int binarySearch$default(LongList this_$iv, int i, int i2, int i3, int i4, Object obj) {
        if (obj != null) {
    ...
    public static /* synthetic */ String joinToString$default(LongList longList, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        ...
        return longList.joinToString(charSequence, charSequence2, charSequence3, i, (i2 & 16) != 0 ? "..." : charSequence4);
    }
    ...
    public static /* synthetic */ String joinToString$default(LongList $this, CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated, Function1 transform, int i, Object obj) {
        ...
        while (true) {
            ...
            $this$joinToString_u24lambda_u2432.append((CharSequence) transform.invoke(Long.valueOf(element)));
            i$iv++;
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated, Function1<? super Long, ? extends CharSequence> transform) {
        ...
        while (true) {
            ...
            $this$joinToString_u24lambda_u2432.append(transform.invoke(Long.valueOf(element)));
            i$iv++;
    ...
    public int hashCode() {
        ...
        for (int i$iv = 0; i$iv < i; i$iv++) {
            long element = content$iv[i$iv];
            hashCode += Long.hashCode(element) * 31;
        }
        return hashCode;
    }
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, Function1<? super Long, ? extends CharSequence> transform) {
        ...
        while (true) {
            if (i$iv$iv < i) {
                ...
                $this$joinToString_u24lambda_u2432$iv.append(transform.invoke(Long.valueOf(element$iv)));
                i$iv$iv++;
                separator2 = separator;
