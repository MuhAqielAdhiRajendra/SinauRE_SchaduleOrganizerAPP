...
final class ParametrizedCacheEntry<T> {
    ...
    public final Object m10514computeIfAbsentgIAlus(List<? extends KType> types, Function0<? extends KSerializer<T>> producer) {
        ...
        if (obj == null) {
            try {
                ...
                objM8929constructorimpl = Result.m8929constructorimpl(producer.invoke());
            } catch (Throwable th) {
            ...
            Object objPutIfAbsent = $this$getOrPut$iv.putIfAbsent(arrayList, resultM8928boximpl);
