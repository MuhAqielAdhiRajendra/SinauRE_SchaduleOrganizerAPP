...
public final class IntListNavType extends CollectionNavType<List<? extends Integer>> {
    ...
    public void put(Bundle bundle, String key, List<Integer> value) {
        ...
        SavedStateWriter.m8626putIntArrayimpl($this$put_u24lambda_u240, key, CollectionsKt.toIntArray(value));
    }
    ...
    public List<Integer> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m8554getIntArrayimpl($this$get_u24lambda_u241, key));
    }
    ...
    public boolean valueEquals(List<Integer> value, List<Integer> other) {
        ...
        if (other != null) {
            ...
            otherArray = (Integer[]) $this$toTypedArray$iv2.toArray(new Integer[0]);
        }
