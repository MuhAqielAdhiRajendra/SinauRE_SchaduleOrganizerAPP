...
final class BoxChildDataElement extends ModifierNodeElement<BoxChildDataNode> {
    ...
    public BoxChildDataElement(Alignment alignment, boolean matchParentSize, Function1<? super InspectorInfo, Unit> function1) {
    ...
    public int hashCode() {
        ...
        return (result * 31) + Boolean.hashCode(this.matchParentSize);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.alignment, otherModifier.alignment) && this.matchParentSize == otherModifier.matchParentSize;
    }
}
