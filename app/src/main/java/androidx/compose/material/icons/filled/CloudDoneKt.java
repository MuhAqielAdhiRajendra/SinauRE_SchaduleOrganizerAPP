...
public final class CloudDoneKt {
    ...
    public static final ImageVector getCloudDone(Icons.Filled $this$CloudDone) {
        if (_cloudDone != null) {
        ...
        ImageVector.Builder $this$_get_CloudDone__u24lambda_u241 = new ImageVector.Builder("Filled.CloudDone", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
