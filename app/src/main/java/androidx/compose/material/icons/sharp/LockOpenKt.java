...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_lockOpen", "Landroidx/compose/ui/graphics/vector/ImageVector;", "LockOpen", "Landroidx/compose/material/icons/Icons$Sharp;", "getLockOpen", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class LockOpenKt {
    private static ImageVector _lockOpen;

    public static final ImageVector getLockOpen(Icons.Sharp $this$LockOpen) {
        if (_lockOpen != null) {
        ...
        ImageVector.Builder $this$_get_LockOpen__u24lambda_u241 = new ImageVector.Builder("Sharp.LockOpen", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -1.13f, 0.6f, -2.24f, 1.64f, -2.7f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(12.85f, 2.31f, 15.0f, 3.9f, 15.0f, 6.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(0.9f, 2.0f, 2.0f, 2.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _lockOpen = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_LockOpen__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
