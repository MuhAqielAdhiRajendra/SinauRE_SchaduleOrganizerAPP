...
public final class FilePresentKt {
    ...
    public static final ImageVector getFilePresent(Icons.Filled $this$FilePresent) {
        ...
        ImageVector.Builder $this$_get_FilePresent__u24lambda_u241 = new ImageVector.Builder("Filled.FilePresent", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(8.0f, 8.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -1.47f, 1.26f, -2.64f, 2.76f, -2.49f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(1.3f, 0.13f, 2.24f, 1.32f, 2.24f, 2.63f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(11.0f, 8.5f);
