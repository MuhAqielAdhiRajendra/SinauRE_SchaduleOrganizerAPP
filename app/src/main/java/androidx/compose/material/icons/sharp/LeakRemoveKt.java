...
public final class LeakRemoveKt {
    ...
    public static final ImageVector getLeakRemove(Icons.Sharp $this$LeakRemove) {
        if (_leakRemove != null) {
        ...
        ImageVector.Builder $this$_get_LeakRemove__u24lambda_u241 = new ImageVector.Builder("Sharp.LeakRemove", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
