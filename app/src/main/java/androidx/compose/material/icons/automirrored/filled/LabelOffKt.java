...
public final class LabelOffKt {
    ...
    public static final ImageVector getLabelOff(Icons.AutoMirrored.Filled $this$LabelOff) {
        if (_labelOff != null) {
        ...
        ImageVector.Builder $this$_get_LabelOff__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Filled.LabelOff", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
