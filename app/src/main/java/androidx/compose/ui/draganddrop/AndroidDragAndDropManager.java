...
public final class AndroidDragAndDropManager implements View.OnDragListener, DragAndDropManager {
    ...
    private final DragAndDropNode rootDragAndDropNode = new DragAndDropNode(null, 0 == true ? 1 : 0, 3, 0 == true ? 1 : 0);
    private final ArraySet<DragAndDropTarget> interestedTargets = new ArraySet<>(0, 1, 0 == true ? 1 : 0);
    ...
    public void mo4817requestDragAndDropTransferUv8p0NA(DragAndDropNode node, long offset) {
        final Ref.BooleanRef isTransferStarted = new Ref.BooleanRef();
        node.m4823startDragAndDropTransferd4ec7I(new DragAndDropStartTransferScope() { // from class: androidx.compose.ui.draganddrop.AndroidDragAndDropManager$requestDragAndDropTransfer$dragAndDropSourceScope$1
            ...
            public boolean mo4818startDragAndDropTransfer12SF9DM(DragAndDropTransferData transferData, long decorationSize, Function1<? super DrawScope, Unit> drawDragDecoration) {
                isTransferStarted.element = ((Boolean) this.startDrag.invoke(transferData, Size.m5125boximpl(decorationSize), drawDragDecoration)).booleanValue();
            ...
            public final Boolean invoke() {
                return Boolean.valueOf(isTransferStarted.element);
            }
        });
    }
