...
abstract class BinaryReader implements Reader {
    ...
    /* synthetic */ BinaryReader(AnonymousClass1 x0) {
        this();
    }
    ...
    private static final class SafeHeapReader extends BinaryReader {
        ...
        public ByteString readBytes() throws IOException {
            ...
            if (z) {
                bytes = ByteString.wrap(bArr, this.pos, size);
            } else {
                bytes = ByteString.copyFrom(bArr, this.pos, size);
            }
            this.pos += size;
            return bytes;
        }
            ...
            if (y2 < 0) {
                ...
                if (y3 >= 0) {
                    ...
                    if (y4 < 0) {
                        ...
                        long x2 = y4;
                        int i5 = i3 + 1;
                        long x3 = x2 ^ (((long) buffer[i3]) << 28);
                        if (x3 >= 0) {
                            x = 266354560 ^ x3;
                            i3 = i5;
                        } else {
                            i3 = i5 + 1;
                            long x4 = (((long) buffer[i5]) << 35) ^ x3;
                            if (x4 < 0) {
                                x = (-34093383808L) ^ x4;
                            } else {
                                int i6 = i3 + 1;
                                long x5 = (((long) buffer[i3]) << 42) ^ x4;
                                if (x5 >= 0) {
                                    x = 4363953127296L ^ x5;
                                    i3 = i6;
                                } else {
                                    i3 = i6 + 1;
                                    long x6 = (((long) buffer[i6]) << 49) ^ x5;
                                    if (x6 < 0) {
                                        x = (-558586000294016L) ^ x6;
                                    } else {
                                        int i7 = i3 + 1;
                                        x = ((((long) buffer[i3]) << 56) ^ x6) ^ 71499008037633920L;
                                        if (x >= 0) {
                                            i3 = i7;
                                        } else {
                                            i3 = i7 + 1;
        ...
        private int readLittleEndian32_NoCheck() {
            ...
            byte[] buffer = this.buffer;
            this.pos = p + 4;
            return (buffer[p] & UByte.MAX_VALUE) | ((buffer[p + 1] & UByte.MAX_VALUE) << 8) | ((buffer[p + 2] & UByte.MAX_VALUE) << 16) | ((buffer[p + 3] & UByte.MAX_VALUE) << 24);
        }
        ...
        private long readLittleEndian64_NoCheck() {
            ...
            byte[] buffer = this.buffer;
            this.pos = p + 8;
            return (((long) buffer[p]) & 255) | ((((long) buffer[p + 1]) & 255) << 8) | ((((long) buffer[p + 2]) & 255) << 16) | ((((long) buffer[p + 3]) & 255) << 24) | ((((long) buffer[p + 4]) & 255) << 32) | ((((long) buffer[p + 5]) & 255) << 40) | ((((long) buffer[p + 6]) & 255) << 48) | ((255 & ((long) buffer[p + 7])) << 56);
        }
