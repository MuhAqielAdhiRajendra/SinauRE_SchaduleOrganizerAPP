...
public final class MoneyKt {
    ...
    public static final ImageVector getMoney(Icons.TwoTone $this$Money) {
        if (_money != null) {
        ...
        ImageVector.Builder $this$_get_Money__u24lambda_u242 = new ImageVector.Builder("TwoTone.Money", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_Money__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 0.3f, null, 0.3f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
