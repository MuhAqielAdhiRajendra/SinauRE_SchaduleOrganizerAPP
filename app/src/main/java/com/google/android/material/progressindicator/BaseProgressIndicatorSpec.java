...
public abstract class BaseProgressIndicatorSpec {
    ...
    protected BaseProgressIndicatorSpec(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.waveAmplitudeRampProgressMin = a.getFloat(R.styleable.BaseProgressIndicator_waveAmplitudeRampProgressMin, 0.1f);
        this.waveAmplitudeRampProgressMax = a.getFloat(R.styleable.BaseProgressIndicator_waveAmplitudeRampProgressMax, 0.9f);
