...
public final class MutableFloatFloatMap extends FloatFloatMap {
    ...
    */
    ...
    public final void dropDeletes$collection() {
        ...
        long[] metadata = mutableFloatFloatMap.metadata;
        int capacity = mutableFloatFloatMap._capacity;
        float[] keys = mutableFloatFloatMap.keys;
        float[] values = mutableFloatFloatMap.values;
        ...
        while (index != capacity) {
            ...
            if (m == 128) {
                ...
                int $i$f$h1 = hash >>> 7;
                int i = hash1;
                int targetIndex = mutableFloatFloatMap.findFirstAvailableSlot($i$f$h1);
    ...
    public final void resizeStorage$collection(int newCapacity) {
        ...
        long[] newMetadata = mutableFloatFloatMap.metadata;
