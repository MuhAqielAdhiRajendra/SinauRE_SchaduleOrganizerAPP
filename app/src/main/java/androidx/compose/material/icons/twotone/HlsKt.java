...
public final class HlsKt {
    ...
    public static final ImageVector getHls(Icons.TwoTone $this$Hls) {
        if (_hls != null) {
        ...
        ImageVector.Builder $this$_get_Hls__u24lambda_u241 = new ImageVector.Builder("TwoTone.Hls", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
