...
public final class AirlineSeatLegroomExtraKt {
    ...
    public static final ImageVector getAirlineSeatLegroomExtra(Icons.Filled $this$AirlineSeatLegroomExtra) {
        ...
        ImageVector.Builder $this$_get_AirlineSeatLegroomExtra__u24lambda_u241 = new ImageVector.Builder("Filled.AirlineSeatLegroomExtra", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.34f, -0.68f, -1.03f, -1.12f, -1.79f, -1.12f);
