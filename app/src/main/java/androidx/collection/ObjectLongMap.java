...
public abstract class ObjectLongMap<K> {
            ...
            if ((((~slot$iv) << 7) & slot$iv & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (j$iv < bitCount$iv) {
                    ...
                    if (!(value$iv$iv < 128)) {
                        ...
                        i = i2;
                        block.invoke(k2[index$iv], Long.valueOf(v[index$iv]));
                    }
                    slot$iv >>= i;
                    j$iv++;
                    i2 = i;
    ...
    public final int count(Function2<? super K, ? super Long, Boolean> predicate) {
        ObjectLongMap<K> objectLongMap;
        int i;
        ObjectLongMap<K> objectLongMap2;
        Intrinsics.checkNotNullParameter(predicate, "predicate");
        int $i$f$count = 0;
        int count = 0;
        ObjectLongMap<K> objectLongMap3 = this;
        Object[] k$iv = objectLongMap3.keys;
        long[] v$iv = objectLongMap3.values;
        long[] m$iv$iv = objectLongMap3.metadata;
        int lastIndex$iv$iv = m$iv$iv.length - 2;
        int i$iv$iv = 0;
        if (0 <= lastIndex$iv$iv) {
            while (true) {
    ...
    */
    ...
    public static /* synthetic */ String joinToString$default(ObjectLongMap objectLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        ...
        return objectLongMap.joinToString(charSequence, charSequence2, charSequence3, i, (i2 & 16) != 0 ? "..." : charSequence4);
    }
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated) {
        ...
        int index = 0;
        ObjectLongMap<K> objectLongMap = this;
        int $i$f$forEach = 0;
        Object[] k$iv3 = objectLongMap.keys;
        long[] v$iv = objectLongMap.values;
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated, Function2<? super K, ? super Long, ? extends CharSequence> transform) {
        ...
        ObjectLongMap<K> objectLongMap = this;
        int $i$f$forEach = 0;
        Object[] k$iv = objectLongMap.keys;
        long[] v$iv = objectLongMap.values;
        long[] m$iv$iv = objectLongMap.metadata;
        int $i$f$joinToString = m$iv$iv.length;
        int lastIndex$iv$iv = $i$f$joinToString - 2;
    ...
    public boolean equals(Object other) {
        ...
        ObjectLongMap<K> objectLongMap2 = this;
        Object[] k$iv = objectLongMap2.keys;
        long[] v$iv = objectLongMap2.values;
        long[] m$iv$iv = objectLongMap2.metadata;
        int lastIndex$iv$iv = m$iv$iv.length - 2;
        int i$iv$iv = 0;
        if (0 > lastIndex$iv$iv) {
            return true;
        ...
        loop0: while (true) {
            ...
            boolean z4 = z2;
            z = z3;
            ObjectLongMap<K> objectLongMap3 = objectLongMap2;
            long $this$maskEmptyOrDeleted$iv$iv$iv = ((~slot$iv$iv) << 7) & slot$iv$iv & (-9187201950435737472L);
            if ($this$maskEmptyOrDeleted$iv$iv$iv != -9187201950435737472L) {
                int i2 = 8;
                int bitCount$iv$iv = 8 - ((~(i$iv$iv - lastIndex$iv$iv)) >>> 31);
                ...
                while (j$iv$iv < bitCount$iv$iv) {
                    ...
                    if (!(value$iv$iv$iv < 128 ? z4 : z)) {
                        ...
                        long value = v$iv[index$iv$iv];
                        i = i2;
                        int index = objectLongMap.findKeyIndex(key);
                        if (index < 0 || value != objectLongMap.values[index]) {
                            break loop0;
                        }
                    }
                    slot$iv$iv >>= i;
