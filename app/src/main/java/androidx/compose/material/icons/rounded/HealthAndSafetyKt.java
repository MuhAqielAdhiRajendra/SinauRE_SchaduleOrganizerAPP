...
public final class HealthAndSafetyKt {
    ...
    public static final ImageVector getHealthAndSafety(Icons.Rounded $this$HealthAndSafety) {
        ...
        ImageVector.Builder $this$_get_HealthAndSafety__u24lambda_u241 = new ImageVector.Builder("Rounded.HealthAndSafety", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(8.67f, 13.0f, 8.0f, 12.33f, 8.0f, 11.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(8.0f, 10.67f, 8.67f, 10.0f, 9.5f, 10.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(1.0f);
