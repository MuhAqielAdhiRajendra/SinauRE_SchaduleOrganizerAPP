...
final class DelegatingThemeAwareRippleNode extends DelegatingNode implements CompositionLocalConsumerModifierNode, ObserverModifierNode {
    ...
    static final Unit updateConfiguration$lambda$0(DelegatingThemeAwareRippleNode this$0) {
    ...
    private final void attachNewRipple() {
        ColorProducer calculateColor = new ColorProducer() { // from class: androidx.compose.material3.DelegatingThemeAwareRippleNode$attachNewRipple$calculateColor$1
            ...
            */
            public final long mo2472invoke0d7_KjU() {
                /*
                    r10 = this;
                    androidx.compose.material3.DelegatingThemeAwareRippleNode r0 = r10.this$0
                    ...
                    long r0 = r0.mo2472invoke0d7_KjU()
                    r2 = r0
                    r4 = 0
                    r5 = 16
                ...
                L17:
                    ...
                    goto L58
                L1b:
                    androidx.compose.material3.DelegatingThemeAwareRippleNode r2 = r10.this$0
                ...
                L3d:
                    ...
                    goto L58
                L44:
                    androidx.compose.material3.DelegatingThemeAwareRippleNode r3 = r10.this$0
                    ...
                    long r3 = r3.m5323unboximpl()
                L58:
                    return r3
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.DelegatingThemeAwareRippleNode$attachNewRipple$calculateColor$1.mo2472invoke0d7_KjU():long");
            }
        };
        ...
        this.rippleNode = delegate(androidx.compose.material.ripple.RippleKt.m2132createRippleModifierNodeTDGSqEk(this.interactionSource, this.bounded, this.radius, calculateColor, calculateRippleAlpha));
    }

    static final RippleAlpha attachNewRipple$lambda$1(DelegatingThemeAwareRippleNode this$0) {
