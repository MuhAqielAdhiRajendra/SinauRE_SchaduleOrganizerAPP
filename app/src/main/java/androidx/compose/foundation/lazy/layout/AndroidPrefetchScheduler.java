...
public final class AndroidPrefetchScheduler implements PrefetchScheduler, PriorityPrefetchScheduler, View.OnAttachStateChangeListener, Runnable, Choreographer.FrameCallback {
    ...
    public void run() {
        ...
        this.scope.setFrameIdle(System.nanoTime() > (2 * frameIntervalNs) + viewDrawTimeNanos);
        ...
        while (!this.prefetchRequests.isEmpty() && !scheduleForNextFrame) {
            ...
            scheduleForNextFrame = zRunRequest;
        }
    ...
    private final boolean runRequest() {
        ...
        if (availableTimeNanos > 0) {
            ...
            PrefetchRequest request = priorityTaskPeek.getRequest();
    ...
    /* JADX INFO: compiled from: PrefetchScheduler.android.kt */
    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0010\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\tH\u0002R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\n"}, d2 = {"Landroidx/compose/foundation/lazy/layout/AndroidPrefetchScheduler$Companion;", "", "<init>", "()V", "frameIntervalNs", "", "calculateFrameIntervalIfNeeded", "", "view", "Landroid/view/View;", "foundation"}, k = 1, mv = {2, 1, 0}, xi = 48)
