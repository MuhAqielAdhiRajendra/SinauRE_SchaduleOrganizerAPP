...
public final class CropFreeKt {
    ...
    public static final ImageVector getCropFree(Icons.Rounded $this$CropFree) {
        if (_cropFree != null) {
        ...
        ImageVector.Builder $this$_get_CropFree__u24lambda_u241 = new ImageVector.Builder("Rounded.CropFree", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
