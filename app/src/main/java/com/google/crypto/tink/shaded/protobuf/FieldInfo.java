...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    public static FieldInfo forProto2OptionalField(java.lang.reflect.Field field, int fieldNumber, FieldType fieldType, java.lang.reflect.Field presenceField, int presenceMask, boolean enforceUtf8, Internal.EnumVerifier enumVerifier) {
        ...
        if (presenceField == null || isExactlyOneBitSet(presenceMask)) {
            int i = presenceMask;
            return new FieldInfo(field, fieldNumber, fieldType, null, presenceField, i, false, enforceUtf8, null, null, null, enumVerifier, null);
        }
    ...
    public static FieldInfo forProto2RequiredField(java.lang.reflect.Field field, int fieldNumber, FieldType fieldType, java.lang.reflect.Field presenceField, int presenceMask, boolean enforceUtf8, Internal.EnumVerifier enumVerifier) {
        ...
        if (presenceField == null || isExactlyOneBitSet(presenceMask)) {
            int i = presenceMask;
            return new FieldInfo(field, fieldNumber, fieldType, null, presenceField, i, true, enforceUtf8, null, null, null, enumVerifier, null);
        }
        throw new IllegalArgumentException("presenceMask must have exactly one bit set: " + presenceMask);
    }
    ...
    public static final class Builder {
        ...
        public FieldInfo build() {
            ...
            if (this.presenceField != null) {
                ...
                if (z) {
                    return FieldInfo.forProto2RequiredField(field, this.fieldNumber, this.type, this.presenceField, this.presenceMask, this.enforceUtf8, this.enumVerifier);
                }
                return FieldInfo.forProto2OptionalField(field, this.fieldNumber, this.type, this.presenceField, this.presenceMask, this.enforceUtf8, this.enumVerifier);
            }
            ...
            if (enumVerifier != null) {
                ...
                if (field2 == null) {
                    return FieldInfo.forFieldWithEnumVerifier(field3, this.fieldNumber, this.type, this.enumVerifier);
                }
                return FieldInfo.forPackedFieldWithEnumVerifier(field3, this.fieldNumber, this.type, this.enumVerifier, this.cachedSizeField);
            }
            java.lang.reflect.Field field4 = this.field;
            if (field2 == null) {
                return FieldInfo.forField(field4, this.fieldNumber, this.type, this.enforceUtf8);
            }
            return FieldInfo.forPackedField(field4, this.fieldNumber, this.type, this.cachedSizeField);
        }
    }
