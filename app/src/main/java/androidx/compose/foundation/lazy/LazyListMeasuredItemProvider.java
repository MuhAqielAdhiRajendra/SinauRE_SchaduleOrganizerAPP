...
public abstract class LazyListMeasuredItemProvider extends LazyLayoutMeasuredItemProvider<LazyListMeasuredItem> {
    ...
    public abstract LazyListMeasuredItem mo1173createItemX9ElhV4(int index, Object key, Object contentType, List<? extends Placeable> placeables, long constraints);
    ...
    private LazyListMeasuredItemProvider(long constraints, boolean isVertical, LazyListItemProvider itemProvider, LazyLayoutMeasureScope measureScope) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, isVertical ? Constraints.m8103getMaxWidthimpl(constraints) : Integer.MAX_VALUE, 0, isVertical ? Integer.MAX_VALUE : Constraints.m8102getMaxHeightimpl(constraints), 5, null);
    }
    ...
    public LazyListMeasuredItem mo1184getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return m1185getAndMeasure0kLqBqw(index, constraints);
    }

    /* JADX INFO: renamed from: getAndMeasure-0kLqBqw$default, reason: not valid java name */
    public static /* synthetic */ LazyListMeasuredItem m1183getAndMeasure0kLqBqw$default(LazyListMeasuredItemProvider lazyListMeasuredItemProvider, int i, long j, int i2, Object obj) {
        if (obj != null) {
        ...
        return lazyListMeasuredItemProvider.m1185getAndMeasure0kLqBqw(i, j);
    }

    /* JADX INFO: renamed from: getAndMeasure-0kLqBqw, reason: not valid java name */
    public final LazyListMeasuredItem m1185getAndMeasure0kLqBqw(int index, long constraints) {
        Object key = this.itemProvider.getKey(index);
        Object contentType = this.itemProvider.getContentType(index);
        return mo1173createItemX9ElhV4(index, key, contentType, m1246getPlaceables3p2s80s(this.measureScope, index, constraints), constraints);
    }

    public final void keepAround(int index) {
        boolean z = false;
        if (index >= 0 && index < this.itemProvider.getItemCount()) {
            z = true;
        }
        if (z) {
