...
public final class EscalatorWarningKt {
    ...
    public static final ImageVector getEscalatorWarning(Icons.Sharp $this$EscalatorWarning) {
        ...
        ImageVector.Builder $this$_get_EscalatorWarning__u24lambda_u241 = new ImageVector.Builder("Sharp.EscalatorWarning", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(14.21f, 12.86f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-0.92f, 1.32f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(9.72f, 8.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(9.37f, 7.38f, 8.71f, 7.0f, 7.99f, 7.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(15.19f, 12.0f, 14.58f, 12.32f, 14.21f, 12.86f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
