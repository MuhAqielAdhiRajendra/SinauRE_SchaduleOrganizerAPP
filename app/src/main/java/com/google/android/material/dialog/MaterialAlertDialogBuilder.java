...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    ...
    public MaterialAlertDialogBuilder(Context context, int overrideThemeResId) {
        ...
        TypedArray a = context2.obtainStyledAttributes(null, com.google.android.material.R.styleable.MaterialAlertDialog, DEF_STYLE_ATTR, DEF_STYLE_RES);
    ...
    public MaterialAlertDialogBuilder setBackgroundInsetStart(int backgroundInsetStart) {
        ...
        if (layoutDirection == 1) {
            rect.right = backgroundInsetStart;
        } else {
            rect.left = backgroundInsetStart;
        }
        return this;
    }
    ...
    public MaterialAlertDialogBuilder setBackgroundInsetEnd(int backgroundInsetEnd) {
        ...
        Rect rect = this.backgroundInsets;
        if (layoutDirection == 1) {
            rect.left = backgroundInsetEnd;
        } else {
            rect.right = backgroundInsetEnd;
        }
        return this;
    }
