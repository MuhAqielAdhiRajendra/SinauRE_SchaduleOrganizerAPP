...
public final class TopAppBarState {
    ...
    public final float getOverlappedFraction() {
        ...
        return 1.0f - (RangesKt.coerceIn(this.heightOffsetLimit - getContentOffset(), this.heightOffsetLimit, 0.0f) / this.heightOffsetLimit);
    }
    ...
    static final TopAppBarState Saver$lambda$1(List it) {
