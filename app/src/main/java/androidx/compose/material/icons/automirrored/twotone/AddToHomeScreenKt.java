...
public final class AddToHomeScreenKt {
    ...
    public static final ImageVector getAddToHomeScreen(Icons.AutoMirrored.TwoTone $this$AddToHomeScreen) {
        ...
        ImageVector.Builder $this$_get_AddToHomeScreen__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.TwoTone.AddToHomeScreen", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
