...
public final class CallMergeKt {
    ...
    @Deprecated(message = "Use the AutoMirrored version at Icons.AutoMirrored.Filled.CallMerge", replaceWith = @ReplaceWith(expression = "Icons.AutoMirrored.Filled.CallMerge", imports = {"androidx.compose.material.icons.automirrored.filled.CallMerge"}))
    public static /* synthetic */ void getCallMerge$annotations(Icons.Filled filled) {
    }

    public static final ImageVector getCallMerge(Icons.Filled $this$CallMerge) {
        if (_callMerge != null) {
        ...
        ImageVector.Builder $this$_get_CallMerge__u24lambda_u241 = new ImageVector.Builder("Filled.CallMerge", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
