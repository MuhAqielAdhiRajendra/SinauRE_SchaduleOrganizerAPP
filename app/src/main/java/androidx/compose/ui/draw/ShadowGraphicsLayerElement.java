...
public final /* data */ class ShadowGraphicsLayerElement extends ModifierNodeElement<BlockGraphicsLayerModifier> {
    ...
    public static /* synthetic */ ShadowGraphicsLayerElement m4902copygNMxBKI$default(ShadowGraphicsLayerElement shadowGraphicsLayerElement, float f, Shape shape, boolean z, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        long j3 = j2;
        boolean z2 = z;
        return shadowGraphicsLayerElement.m4906copygNMxBKI(f, shape, z2, j, j3);
    }
    ...
    public final ShadowGraphicsLayerElement m4906copygNMxBKI(float elevation, Shape shape, boolean clip, long ambientColor, long spotColor) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m8155equalsimpl0(this.elevation, shadowGraphicsLayerElement.elevation) && Intrinsics.areEqual(this.shape, shadowGraphicsLayerElement.shape) && this.clip == shadowGraphicsLayerElement.clip && Color.m5314equalsimpl0(this.ambientColor, shadowGraphicsLayerElement.ambientColor) && Color.m5314equalsimpl0(this.spotColor, shadowGraphicsLayerElement.spotColor);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((Dp.m8156hashCodeimpl(this.elevation) * 31) + this.shape.hashCode()) * 31) + Boolean.hashCode(this.clip)) * 31) + Color.m5320hashCodeimpl(this.ambientColor)) * 31) + Color.m5320hashCodeimpl(this.spotColor);
    }

    public String toString() {
        return "ShadowGraphicsLayerElement(elevation=" + ((Object) Dp.m8161toStringimpl(this.elevation)) + ", shape=" + this.shape + ", clip=" + this.clip + ", ambientColor=" + ((Object) Color.m5321toStringimpl(this.ambientColor)) + ", spotColor=" + ((Object) Color.m5321toStringimpl(this.spotColor)) + ')';
    }
    ...
    public final float m4908getElevationD9Ej5fM() {
        return this.elevation;
    }
    ...
    public final long m4907getAmbientColor0d7_KjU() {
        return this.ambientColor;
    }

    /* JADX INFO: renamed from: getSpotColor-0d7_KjU, reason: not valid java name */
    public final long m4909getSpotColor0d7_KjU() {
        return this.spotColor;
    }
    ...
    private final Function1<GraphicsLayerScope, Unit> createBlock() {
        return new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.ui.draw.ShadowGraphicsLayerElement.createBlock.1
            ...
            public final void invoke2(GraphicsLayerScope graphicsLayerScope) {
                graphicsLayerScope.setShadowElevation(graphicsLayerScope.mo432toPx0680j_4(ShadowGraphicsLayerElement.this.m4908getElevationD9Ej5fM()));
                ...
                graphicsLayerScope.mo5510setAmbientShadowColor8_81llA(ShadowGraphicsLayerElement.this.m4907getAmbientColor0d7_KjU());
                graphicsLayerScope.mo5513setSpotShadowColor8_81llA(ShadowGraphicsLayerElement.this.m4909getSpotColor0d7_KjU());
            }
        };
    }
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("elevation", Dp.m8148boximpl(this.elevation));
        ...
        $this$inspectableProperties.getProperties().set("ambientColor", Color.m5303boximpl(this.ambientColor));
        $this$inspectableProperties.getProperties().set("spotColor", Color.m5303boximpl(this.spotColor));
    }
}
