...
public final class PinEndKt {
    ...
    public static final ImageVector getPinEnd(Icons.Rounded $this$PinEnd) {
        if (_pinEnd != null) {
        ...
        ImageVector.Builder $this$_get_PinEnd__u24lambda_u241 = new ImageVector.Builder("Rounded.PinEnd", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(14.66f, 13.66f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(14.12f, 8.54f, 13.9f, 8.0f, 13.45f, 8.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineTo(9.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(9.22f, 8.0f, 9.0f, 8.22f, 9.0f, 8.5f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(1.27f, -1.27f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(2.12f, 2.12f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(13.63f, 14.05f, 14.27f, 14.05f, 14.66f, 13.66f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
