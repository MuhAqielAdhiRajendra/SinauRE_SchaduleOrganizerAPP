...
public final class StairsKt {
    ...
    public static final ImageVector getStairs(Icons.Rounded $this$Stairs) {
        if (_stairs != null) {
        ...
        ImageVector.Builder $this$_get_Stairs__u24lambda_u241 = new ImageVector.Builder("Rounded.Stairs", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(10.45f, 18.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(18.0f, 7.55f, 17.55f, 8.0f, 17.0f, 8.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
