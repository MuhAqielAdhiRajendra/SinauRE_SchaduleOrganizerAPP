...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    void performAttach() {
        for (OnPreAttachedListener listener : this.mOnPreAttachedListeners) {
    ...
    void performSaveInstanceState(Bundle outState) {
        ...
        Parcelable p = this.mChildFragmentManager.m8456lambda$attachController$4$androidxfragmentappFragmentManager();
        if (p != null) {
    ...
    void setSharedElementNames(ArrayList<String> sharedElementSourceNames, ArrayList<String> sharedElementTargetNames) {
        ensureAnimationInfo();
