...
public final class PlayDisabledKt {
    ...
    public static final ImageVector getPlayDisabled(Icons.TwoTone $this$PlayDisabled) {
        ...
        ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_PlayDisabled__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 0.3f, null, 0.3f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
