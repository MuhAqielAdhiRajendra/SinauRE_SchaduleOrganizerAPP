...
public final class SelectableChipElevation {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof SelectableChipElevation) && Dp.m8155equalsimpl0(this.elevation, ((SelectableChipElevation) other).elevation) && Dp.m8155equalsimpl0(this.pressedElevation, ((SelectableChipElevation) other).pressedElevation) && Dp.m8155equalsimpl0(this.focusedElevation, ((SelectableChipElevation) other).focusedElevation) && Dp.m8155equalsimpl0(this.hoveredElevation, ((SelectableChipElevation) other).hoveredElevation) && Dp.m8155equalsimpl0(this.disabledElevation, ((SelectableChipElevation) other).disabledElevation)) {
            return true;
        }
        return false;
    }
