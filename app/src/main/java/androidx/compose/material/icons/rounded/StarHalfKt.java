...
public final class StarHalfKt {
    ...
    public static final ImageVector getStarHalf(Icons.Rounded $this$StarHalf) {
        if (_starHalf != null) {
        ...
        ImageVector.Builder $this$_get_StarHalf__u24lambda_u241 = new ImageVector.Builder("Rounded.StarHalf", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
