...
public final class FlightTakeoffKt {
    ...
    public static final ImageVector getFlightTakeoff(Icons.Sharp $this$FlightTakeoff) {
        ...
        ImageVector.Builder $this$_get_FlightTakeoff__u24lambda_u241 = new ImageVector.Builder("Sharp.FlightTakeoff", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(1.82f, 3.16f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(0.77f, 1.33f);
