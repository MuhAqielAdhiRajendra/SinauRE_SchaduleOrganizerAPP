...
public final class ShowChartKt {
    ...
    public static final ImageVector getShowChart(Icons.AutoMirrored.Rounded $this$ShowChart) {
        if (_showChart != null) {
        ...
        ImageVector.Builder $this$_get_ShowChart__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Rounded.ShowChart", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
