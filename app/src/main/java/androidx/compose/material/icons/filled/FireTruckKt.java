...
public final class FireTruckKt {
    ...
    public static final ImageVector getFireTruck(Icons.Filled $this$FireTruck) {
        if (_fireTruck != null) {
        ...
        ImageVector.Builder $this$_get_FireTruck__u24lambda_u242 = new ImageVector.Builder("Filled.FireTruck", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
