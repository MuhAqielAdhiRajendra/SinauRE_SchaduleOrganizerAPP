...
public final class TouchBoundsExpansion {
    ...
    public static final /* synthetic */ TouchBoundsExpansion m7185boximpl(long j) {
        return new TouchBoundsExpansion(j);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m7188constructorimpl(long j) {
        return j;
    }
    ...
    public static int m7195hashCodeimpl(long j) {
    ...
    public int hashCode() {
        return m7195hashCodeimpl(this.packedValue);
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ long m7199Absolutevsh68fg$default(Companion companion, int i, int i2, int i3, int i4, int i5, Object obj) {
            if ((i5 & 1) != 0) {
                i = 0;
            }
            if ((i5 & 2) != 0) {
            ...
            return companion.m7200Absolutevsh68fg(i, i2, i3, i4);
        }

        /* JADX INFO: renamed from: Absolute-vsh68fg, reason: not valid java name */
        public final long m7200Absolutevsh68fg(int left, int top, int right, int bottom) {
            boolean value$iv = left >= 0 && left < 32768;
            if (!value$iv) {
            ...
            boolean value$iv3 = right >= 0 && right < 32768;
            if (!value$iv3) {
            ...
            return TouchBoundsExpansion.m7188constructorimpl(pack$ui(left, top, right, bottom, false));
        }

        /* JADX INFO: renamed from: getNone-RZrCHBk, reason: not valid java name */
        public final long m7201getNoneRZrCHBk() {
    ...
    public static final int m7193getStartimpl(long arg0) {
        return INSTANCE.unpack(arg0, 0);
    }

    /* JADX INFO: renamed from: getTop-impl, reason: not valid java name */
    public static final int m7194getTopimpl(long arg0) {
        return INSTANCE.unpack(arg0, 1);
    }

    /* JADX INFO: renamed from: getEnd-impl, reason: not valid java name */
    public static final int m7192getEndimpl(long arg0) {
        return INSTANCE.unpack(arg0, 2);
    }

    /* JADX INFO: renamed from: getBottom-impl, reason: not valid java name */
    public static final int m7191getBottomimpl(long arg0) {
        return INSTANCE.unpack(arg0, 3);
    }

    /* JADX INFO: renamed from: isLayoutDirectionAware-impl, reason: not valid java name */
    public static final boolean m7196isLayoutDirectionAwareimpl(long arg0) {
        return (Long.MIN_VALUE & arg0) != 0;
    }

    /* JADX INFO: renamed from: computeLeft-impl$ui, reason: not valid java name */
    public static final int m7186computeLeftimpl$ui(long arg0, LayoutDirection layoutDirection) {
        if (!m7196isLayoutDirectionAwareimpl(arg0) || layoutDirection == LayoutDirection.Ltr) {
            return m7193getStartimpl(arg0);
        }
        return m7192getEndimpl(arg0);
    }

    /* JADX INFO: renamed from: computeRight-impl$ui, reason: not valid java name */
    public static final int m7187computeRightimpl$ui(long arg0, LayoutDirection layoutDirection) {
        if (!m7196isLayoutDirectionAwareimpl(arg0) || layoutDirection == LayoutDirection.Ltr) {
            return m7192getEndimpl(arg0);
        }
        return m7193getStartimpl(arg0);
