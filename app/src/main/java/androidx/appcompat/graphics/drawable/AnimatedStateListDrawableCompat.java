...
public class AnimatedStateListDrawableCompat extends StateListDrawableCompat implements TintAwareDrawable {
    ...
    public static AnimatedStateListDrawableCompat createFromXmlInner(Context context, Resources resources, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
    ...
    static class AnimatedStateListState extends StateListDrawableCompat.StateListState {
        ...
        int addTransition(int fromId, int toId, Drawable anim, boolean reversible) {
            ...
            if (reversible) {
                ...
                this.mTransitions.append(keyToFrom, Long.valueOf(((long) pos) | REVERSED_BIT | reversibleBit));
            }
            return pos;
        }
