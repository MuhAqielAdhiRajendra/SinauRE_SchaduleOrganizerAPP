...
public final class PinEndKt {
    ...
    public static final ImageVector getPinEnd(Icons.Outlined $this$PinEnd) {
        if (_pinEnd != null) {
        ...
        ImageVector.Builder $this$_get_PinEnd__u24lambda_u241 = new ImageVector.Builder("Outlined.PinEnd", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
