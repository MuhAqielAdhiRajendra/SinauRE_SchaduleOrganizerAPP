...
public final class PreferencesFactory {
    ...
    public static final MutablePreferences createMutable(Preferences.Pair<?>... pairs) {
        Intrinsics.checkNotNullParameter(pairs, "pairs");
        MutablePreferences $this$mutablePreferencesOf_u24lambda_u2d0 = new MutablePreferences(null, false, 1, null);
        $this$mutablePreferencesOf_u24lambda_u2d0.putAll((Preferences.Pair[]) Arrays.copyOf(pairs, pairs.length));
        return $this$mutablePreferencesOf_u24lambda_u2d0;
    }
}
