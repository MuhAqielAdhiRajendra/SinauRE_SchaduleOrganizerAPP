...
public class DrawChildContainer extends ViewGroup {
    ...
    public final void drawChild$ui(androidx.compose.ui.graphics.Canvas canvas, View view, long drawingTime) {
