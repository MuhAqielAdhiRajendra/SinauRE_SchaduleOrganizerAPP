...
public final class WorkQueue {
    ...
    private final Task tryExtractFromTheMiddle(int index, boolean onlyBlocking) {
        ...
        if (value == null || value.taskContext != onlyBlocking || !AtomicArraysKt__AtomicArrays_jvmKt$$ExternalSyntheticBackportWithForwarding0.m(this.buffer, arrayIndex, value, null)) {
            return null;
        }
        if (onlyBlocking) {
