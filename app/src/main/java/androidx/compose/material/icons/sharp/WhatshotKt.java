...
public final class WhatshotKt {
    ...
    public static final ImageVector getWhatshot(Icons.Sharp $this$Whatshot) {
        if (_whatshot != null) {
        ...
        ImageVector.Builder $this$_get_Whatshot__u24lambda_u241 = new ImageVector.Builder("Sharp.Whatshot", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
