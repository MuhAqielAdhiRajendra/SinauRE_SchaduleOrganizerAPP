...
final class EdgeEffectWrapper {
    ...
    private final EdgeEffect createEdgeEffect(Orientation orientation) {
        EdgeEffect $this$createEdgeEffect_u24lambda_u240 = EdgeEffectCompat.INSTANCE.create(this.context);
        $this$createEdgeEffect_u24lambda_u240.setColor(this.glowColor);
        if (!IntSize.m8319equalsimpl0(this.size, IntSize.INSTANCE.m8326getZeroYbymL2g())) {
            if (orientation == Orientation.Vertical) {
                long arg0$iv = this.size;
                int i = (int) (arg0$iv >> 32);
                long arg0$iv2 = this.size;
                $this$createEdgeEffect_u24lambda_u240.setSize(i, (int) (4294967295L & arg0$iv2));
            } else {
                long arg0$iv3 = this.size;
                long arg0$iv4 = this.size;
                $this$createEdgeEffect_u24lambda_u240.setSize((int) (4294967295L & arg0$iv3), (int) (arg0$iv4 >> 32));
            }
        }
        return $this$createEdgeEffect_u24lambda_u240;
    }

    /* JADX INFO: renamed from: updateSize-ozmzZPI, reason: not valid java name */
    public final void m340updateSizeozmzZPI(long size) {
        this.size = size;
        EdgeEffect edgeEffect = this.topEffect;
        if (edgeEffect != null) {
