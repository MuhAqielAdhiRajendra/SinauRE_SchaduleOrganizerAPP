...
public abstract class ComputableLiveData<T> {
    ...
    static final void refreshRunnable$lambda$0(ComputableLiveData this$0) {
        do {
    ...
    static final void invalidationRunnable$lambda$0(ComputableLiveData this$0) {
