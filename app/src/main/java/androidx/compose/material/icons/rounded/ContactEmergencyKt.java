...
public final class ContactEmergencyKt {
    ...
    public static final ImageVector getContactEmergency(Icons.Rounded $this$ContactEmergency) {
        ...
        ImageVector.Builder $this$_get_ContactEmergency__u24lambda_u241 = new ImageVector.Builder("Rounded.ContactEmergency", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(20.6f, 10.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(20.6f, 10.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.21f, 0.36f, -0.67f, 0.48f, -1.02f, 0.27f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-0.82f, -0.48f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(0.95f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.21f, -0.36f, -0.08f, -0.82f, 0.27f, -1.02f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(16.5f, 9.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-0.82f, -0.48f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.36f, -0.21f, -0.48f, -0.67f, -0.27f, -1.02f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(0.0f, 0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.21f, -0.36f, 0.67f, -0.48f, 1.02f, -0.27f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(0.82f, 0.48f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineTo(6.75f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(17.25f, 6.34f, 17.59f, 6.0f, 18.0f, 6.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.41f, 0.0f, 0.75f, 0.34f, 0.75f, 0.75f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(0.82f, 0.48f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(20.68f, 9.68f, 20.81f, 10.14f, 20.6f, 10.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _contactEmergency = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_ContactEmergency__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
