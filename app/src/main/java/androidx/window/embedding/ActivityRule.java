...
public final class ActivityRule extends EmbeddingRule {
    ...
    public ActivityRule(String tag, Set<ActivityFilter> filters, boolean alwaysExpand) {
        super(tag);
    ...
    public static final class Builder {
        ...
        public final Builder setAlwaysExpand(boolean alwaysExpand) {
            Builder $this$setAlwaysExpand_u24lambda_u240 = this;
            $this$setAlwaysExpand_u24lambda_u240.alwaysExpand = alwaysExpand;
            return this;
        }

        public final Builder setTag(String tag) {
            Builder $this$setTag_u24lambda_u241 = this;
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ActivityRule) && super.equals(other) && Intrinsics.areEqual(this.filters, ((ActivityRule) other).filters) && this.alwaysExpand == ((ActivityRule) other).alwaysExpand;
    }

    @Override // androidx.window.embedding.EmbeddingRule
    public int hashCode() {
        int result = super.hashCode();
        return (((result * 31) + this.filters.hashCode()) * 31) + Boolean.hashCode(this.alwaysExpand);
    }
