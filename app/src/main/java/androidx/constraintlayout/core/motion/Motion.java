    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        for (int i = 0; i < this.mAttributeNames.length; i++) {
            ...
            while (true) {
                ...
                if (!motionPathsArr[j3].mCustomAttributes.containsKey(attributeName) || (attribute = motionPathsArr[j3].mCustomAttributes.get(attributeName)) == null) {
                    j3++;
                } else {
        ...
        while (i6 < motionPathsArr.length) {
            ...
            timePoint[i6] = motionPathsArr[i6].mTime;
            i6++;
            count3 = count3;
        }
        int j4 = 0;
            ...
            while (true) {
                ...
                if (j5 < motionPathsArr.length) {
                    if (!motionPathsArr[j5].hasCustomData(name)) {
                        ...
                        timePoints[pointCount] = motionPathsArr[j].mTime;
        ...
        if (motionPathsArr[0].mPathMotionArc != -1) {
            ...
            while (i10 < size) {
                ...
                time[i10] = motionPathsArr[i10].mTime;
                values[i10][0] = motionPathsArr[i10].mX;
                values[i10][c] = motionPathsArr[i10].mY;
                i10++;
