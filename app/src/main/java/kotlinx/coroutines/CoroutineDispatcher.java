...
public abstract class CoroutineDispatcher extends AbstractCoroutineContextElement implements ContinuationInterceptor {
    ...
    public abstract void mo10498dispatch(CoroutineContext context, Runnable block);
    ...
    public static final class Companion extends AbstractCoroutineContextKey<ContinuationInterceptor, CoroutineDispatcher> {
        ...
        static final CoroutineDispatcher _init_$lambda$0(CoroutineContext.Element it) {
