...
public final class LoginKt {
    ...
    public static final ImageVector getLogin(Icons.AutoMirrored.TwoTone $this$Login) {
        if (_login != null) {
        ...
        ImageVector.Builder $this$_get_Login__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.TwoTone.Login", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
