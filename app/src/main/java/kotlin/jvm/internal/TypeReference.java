...
public final class TypeReference implements KType {
    ...
    private final String asString(boolean convertPrimitiveToWrapper) {
        ...
        if (javaClass == null) {
            ...
            klass = (convertPrimitiveToWrapper && javaClass.isPrimitive()) ? JvmClassMappingKt.getJavaObjectType((KClass) getClassifier()).getName() : javaClass.getName();
        }
        String args = getArguments().isEmpty() ? "" : CollectionsKt.joinToString$default(getArguments(), ", ", "<", ">", 0, null, new Function1() { // from class: kotlin.jvm.internal.TypeReference$$ExternalSyntheticLambda0
    ...
    static final CharSequence asString$lambda$0(TypeReference this$0, KTypeProjection it) {
