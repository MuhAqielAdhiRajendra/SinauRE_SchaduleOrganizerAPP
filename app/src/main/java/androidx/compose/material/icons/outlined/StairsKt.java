...
public final class StairsKt {
    ...
    public static final ImageVector getStairs(Icons.Outlined $this$Stairs) {
        if (_stairs != null) {
        ...
        ImageVector.Builder $this$_get_Stairs__u24lambda_u241 = new ImageVector.Builder("Outlined.Stairs", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
