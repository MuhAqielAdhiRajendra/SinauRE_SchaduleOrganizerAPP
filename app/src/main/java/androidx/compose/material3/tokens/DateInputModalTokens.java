...
public final class DateInputModalTokens {
    ...
    private static final float ContainerHeight = Dp.m8150constructorimpl((float) 512.0d);
    ...
    private static final float ContainerWidth = Dp.m8150constructorimpl((float) 328.0d);
    private static final float HeaderContainerHeight = Dp.m8150constructorimpl((float) 120.0d);
    private static final float HeaderContainerWidth = Dp.m8150constructorimpl((float) 328.0d);
    ...
    public final float m3755getHeaderContainerHeightD9Ej5fM() {
        return HeaderContainerHeight;
    }

    /* JADX INFO: renamed from: getHeaderContainerWidth-D9Ej5fM, reason: not valid java name */
    public final float m3756getHeaderContainerWidthD9Ej5fM() {
