...
public final class ScrollCapture implements ComposeScrollCaptureCallback.ScrollCaptureSessionListener {
    ...
    public final void onScrollCaptureSearch(View view, SemanticsOwner semanticsOwner, CoroutineContext coroutineContext, Consumer<ScrollCaptureTarget> targets) {
        ...
        Object obj = null;
        ScrollCapture_androidKt.visitScrollCaptureCandidates$default(semanticsOwner.getUnmergedRootSemanticsNode(), 0, new AnonymousClass1(candidates), 2, null);
        ...
        if (!(candidates.getSize() == 0)) {
            ...
            obj = candidates.content[index$iv$iv];
        }
        ScrollCaptureCandidate candidate = (ScrollCaptureCandidate) obj;
        if (candidate == null) {
            return;
        }
        ...
        long windowOffsetOfCandidate = candidate.getViewportBoundsInWindow().m8307getTopLeftnOccac();
        ScrollCaptureTarget $this$onScrollCaptureSearch_u24lambda_u241 = new ScrollCaptureTarget(view, RectHelper_androidKt.toAndroidRect(IntRectKt.roundToIntRect(localVisibleRectOfCandidate)), new Point(IntOffset.m8278getXimpl(windowOffsetOfCandidate), IntOffset.m8279getYimpl(windowOffsetOfCandidate)), callback);
