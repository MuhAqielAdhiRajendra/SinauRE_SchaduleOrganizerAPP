...
public final class SupportKt {
    ...
    public static final ImageVector getSupport(Icons.Filled $this$Support) {
        if (_support != null) {
        ...
        ImageVector.Builder $this$_get_Support__u24lambda_u241 = new ImageVector.Builder("Filled.Support", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
