...
final class XChaCha20Poly1305ProtoSerialization {
    ...
    private static final ParametersSerializer<XChaCha20Poly1305Parameters, ProtoParametersSerialization> PARAMETERS_SERIALIZER = ParametersSerializer.create(new ParametersSerializer.ParametersSerializationFunction() { // from class: com.google.crypto.tink.aead.XChaCha20Poly1305ProtoSerialization$$ExternalSyntheticLambda0
    ...
    private static final ParametersParser<ProtoParametersSerialization> PARAMETERS_PARSER = ParametersParser.create(new ParametersParser.ParametersParsingFunction() { // from class: com.google.crypto.tink.aead.XChaCha20Poly1305ProtoSerialization$$ExternalSyntheticLambda1
    ...
    private static final KeySerializer<XChaCha20Poly1305Key, ProtoKeySerialization> KEY_SERIALIZER = KeySerializer.create(new KeySerializer.KeySerializationFunction() { // from class: com.google.crypto.tink.aead.XChaCha20Poly1305ProtoSerialization$$ExternalSyntheticLambda2
    ...
    private static final KeyParser<ProtoKeySerialization> KEY_PARSER = KeyParser.create(new KeyParser.KeyParsingFunction() { // from class: com.google.crypto.tink.aead.XChaCha20Poly1305ProtoSerialization$$ExternalSyntheticLambda3
