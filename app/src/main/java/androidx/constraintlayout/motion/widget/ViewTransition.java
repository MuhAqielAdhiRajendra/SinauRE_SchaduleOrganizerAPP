...
public class ViewTransition {
    ...
    */
    ViewTransition(android.content.Context r9, org.xmlpull.v1.XmlPullParser r10) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
    ...
    static class Animate {
        ...
        void reverse(boolean dir) {
            ...
            if (this.mReverse && this.mUpDuration != -1) {
                this.mDpositionDt = this.mUpDuration == 0 ? Float.MAX_VALUE : 1.0f / this.mUpDuration;
            }
        ...
        void mutateReverse() {
            ...
            this.mPosition -= ((float) (elapse * 1.0E-6d)) * this.mDpositionDt;
    ...
    void applyTransition(ViewTransitionController controller, MotionLayout layout, int fromId, ConstraintSet current, final View... views) {
        ...
        for (View view2 : views) {
            ConstraintSet.Constraint constraint2 = transformedState.getConstraint(view2.getId());
            if (this.mConstraintDelta != null) {
    ...
    /* synthetic */ void m8411x14d7500(View[] views) {
        if (this.mSetsTag != -1) {
            for (View view : views) {
    ...
    private void updateTransition(MotionScene.Transition transition, View view) {
        ...
        if (this.mKeyFrames != null) {
            ...
            for (Key key : keys) {
                keyFrames.addKey(key.mo8410clone().setViewId(id));
            }
    ...
    boolean supports(int action) {
        return this.mOnStateTransition == 1 ? action == 0 : this.mOnStateTransition == 2 ? action == 1 : this.mOnStateTransition == 3 && action == 0;
    }
