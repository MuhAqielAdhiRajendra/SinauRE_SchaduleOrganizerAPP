...
public final class LazyWindowInfo implements WindowInfo {
    ...
    public void m7292setKeyboardModifiers5xRPYO0(int value) {
        WindowInfoImpl.INSTANCE.getGlobalKeyboardModifiers$ui().setValue(PointerKeyboardModifiers.m6713boximpl(value));
    }
    ...
    public long mo7290getContainerSizeYbymL2g() {
        DerivedSize initialSize;
        if (this._containerSize == null) {
            Function0<DerivedSize> function0 = this.onInitializeContainerSize;
            if (function0 == null || (initialSize = function0.invoke()) == null) {
                initialSize = DerivedSize.INSTANCE.getZero();
            }
            this._containerSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(initialSize, null, 2, null);
