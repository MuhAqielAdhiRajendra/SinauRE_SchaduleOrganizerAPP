...
public class MaskableFrameLayout extends FrameLayout implements Maskable, Shapeable {
    ...
    protected void dispatchDraw(Canvas canvas) {
        this.shapeableDelegate.maybeClip(canvas, new CanvasCompat.CanvasOperation() { // from class: com.google.android.material.carousel.MaskableFrameLayout$$ExternalSyntheticLambda1
            ...
            public final void run(Canvas canvas2) {
                this.f$0.m8791x418c47c0(canvas2);
            }
        });
    }
    ...
    /* synthetic */ void m8791x418c47c0(Canvas x$0) {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        if (getX() > 0.0f) {
            this.screenBoundsRect.left = (int) (this.screenBoundsRect.left + this.maskRect.left);
        }
        if (getY() > 0.0f) {
            this.screenBoundsRect.top = (int) (this.screenBoundsRect.top + this.maskRect.top);
        }
