...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m7637getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int fontStyle) {
        boolean isBold = fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0;
        boolean isItalic = FontStyle.m7685equalsimpl0(fontStyle, FontStyle.INSTANCE.m7691getItalic_LCdwA());
