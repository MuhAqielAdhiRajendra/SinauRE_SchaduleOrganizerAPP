...
public final class FormatTextdirectionRToLKt {
    ...
    public static final ImageVector getFormatTextdirectionRToL(Icons.AutoMirrored.Rounded $this$FormatTextdirectionRToL) {
        ...
        ImageVector.Builder $this$_get_FormatTextdirectionRToL__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Rounded.FormatTextdirectionRToL", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
