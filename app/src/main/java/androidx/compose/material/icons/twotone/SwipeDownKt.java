...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_swipeDown", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SwipeDown", "Landroidx/compose/material/icons/Icons$TwoTone;", "getSwipeDown", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class SwipeDownKt {
    private static ImageVector _swipeDown;

    public static final ImageVector getSwipeDown(Icons.TwoTone $this$SwipeDown) {
        if (_swipeDown != null) {
        ...
        ImageVector.Builder $this$_get_SwipeDown__u24lambda_u242 = new ImageVector.Builder("TwoTone.SwipeDown", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_SwipeDown__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 0.3f, null, 0.3f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
        $this$PathData_u24lambda_u240$iv$iv$iv2.moveTo(3.8f, 12.18f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveToRelative(-0.2f, -0.86f, -0.3f, -1.76f, -0.3f, -2.68f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveToRelative(0.0f, -2.84f, 0.99f, -5.45f, 2.63f, -7.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineTo(7.2f, 3.07f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveTo(5.82f, 4.85f, 5.0f, 7.08f, 5.0f, 9.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveToRelative(0.0f, 0.88f, 0.11f, 1.74f, 0.32f, 2.56f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineToRelative(1.62f, -1.62f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineTo(8.0f, 11.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineTo(4.5f, 15.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineTo(1.0f, 11.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineToRelative(1.06f, -1.06f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineTo(3.8f, 12.18f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
