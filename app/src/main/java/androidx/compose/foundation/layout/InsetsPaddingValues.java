...
final class InsetsPaddingValues implements PaddingValues {
    ...
    public float mo998calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        ...
        return $this$calculateLeftPadding_u2uoSUM_u24lambda_u240.mo429toDpu2uoSUM(this.insets.getLeft($this$calculateLeftPadding_u2uoSUM_u24lambda_u240, layoutDirection));
    }

    @Override // androidx.compose.foundation.layout.PaddingValues
    /* JADX INFO: renamed from: calculateTopPadding-D9Ej5fM, reason: not valid java name */
    public float getTop() {
        Density $this$calculateTopPadding_D9Ej5fM_u24lambda_u240 = this.density;
        return $this$calculateTopPadding_D9Ej5fM_u24lambda_u240.mo429toDpu2uoSUM(this.insets.getTop($this$calculateTopPadding_D9Ej5fM_u24lambda_u240));
    }
    ...
    public float mo999calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Density $this$calculateRightPadding_u2uoSUM_u24lambda_u240 = this.density;
        return $this$calculateRightPadding_u2uoSUM_u24lambda_u240.mo429toDpu2uoSUM(this.insets.getRight($this$calculateRightPadding_u2uoSUM_u24lambda_u240, layoutDirection));
    }

    @Override // androidx.compose.foundation.layout.PaddingValues
    /* JADX INFO: renamed from: calculateBottomPadding-D9Ej5fM, reason: not valid java name */
    public float getBottom() {
        Density $this$calculateBottomPadding_D9Ej5fM_u24lambda_u240 = this.density;
        return $this$calculateBottomPadding_D9Ej5fM_u24lambda_u240.mo429toDpu2uoSUM(this.insets.getBottom($this$calculateBottomPadding_D9Ej5fM_u24lambda_u240));
    }
