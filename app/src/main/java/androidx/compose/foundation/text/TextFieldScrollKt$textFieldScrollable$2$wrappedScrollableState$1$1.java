...
public final class TextFieldScrollKt$textFieldScrollable$2$wrappedScrollableState$1$1 implements ScrollableState {
    ...
    TextFieldScrollKt$textFieldScrollable$2$wrappedScrollableState$1$1(ScrollableState $scrollableState, final TextFieldScrollerPosition $scrollerPosition) {
        ...
        this.canScrollForward = SnapshotStateKt.derivedStateOf(new Function0() { // from class: androidx.compose.foundation.text.TextFieldScrollKt$textFieldScrollable$2$wrappedScrollableState$1$1$$ExternalSyntheticLambda0
            ...
            public final Object invoke() {
                return Boolean.valueOf(TextFieldScrollKt$textFieldScrollable$2$wrappedScrollableState$1$1.canScrollForward_delegate$lambda$0($scrollerPosition));
            }
        });
        this.canScrollBackward = SnapshotStateKt.derivedStateOf(new Function0() { // from class: androidx.compose.foundation.text.TextFieldScrollKt$textFieldScrollable$2$wrappedScrollableState$1$1$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return Boolean.valueOf(TextFieldScrollKt$textFieldScrollable$2$wrappedScrollableState$1$1.canScrollBackward_delegate$lambda$1($scrollerPosition));
            }
        });
    }
    ...
    static final boolean canScrollForward_delegate$lambda$0(TextFieldScrollerPosition $scrollerPosition) {
    ...
    static final boolean canScrollBackward_delegate$lambda$1(TextFieldScrollerPosition $scrollerPosition) {
