...
public final class PinchKt {
    ...
    public static final ImageVector getPinch(Icons.Filled $this$Pinch) {
        if (_pinch != null) {
        ...
        ImageVector.Builder $this$_get_Pinch__u24lambda_u241 = new ImageVector.Builder("Filled.Pinch", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(22.98f, 16.82f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(22.66f, 15.14f, 23.1f, 15.97f, 22.98f, 16.82f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
