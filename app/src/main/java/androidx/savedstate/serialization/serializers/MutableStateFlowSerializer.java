...
public final class MutableStateFlowSerializer<T> implements KSerializer<MutableStateFlow<T>> {
    ...
    public MutableStateFlowSerializer(KSerializer<T> valueSerializer) {
        ...
        MutableStateFlowSerializer<T> mutableStateFlowSerializer = this;
        SerialKind kind = mutableStateFlowSerializer.valueSerializer.getDescriptor().getKind();
        this.descriptor = kind instanceof PrimitiveKind ? SerialDescriptorsKt.PrimitiveSerialDescriptor("kotlinx.coroutines.flow.MutableStateFlow", (PrimitiveKind) kind) : SerialDescriptorsKt.SerialDescriptor("kotlinx.coroutines.flow.MutableStateFlow", mutableStateFlowSerializer.valueSerializer.getDescriptor());
    }
