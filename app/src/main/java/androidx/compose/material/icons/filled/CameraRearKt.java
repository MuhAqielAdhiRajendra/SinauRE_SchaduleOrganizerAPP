...
public final class CameraRearKt {
    ...
    public static final ImageVector getCameraRear(Icons.Filled $this$CameraRear) {
        if (_cameraRear != null) {
        ...
        ImageVector.Builder $this$_get_CameraRear__u24lambda_u241 = new ImageVector.Builder("Filled.CameraRear", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
