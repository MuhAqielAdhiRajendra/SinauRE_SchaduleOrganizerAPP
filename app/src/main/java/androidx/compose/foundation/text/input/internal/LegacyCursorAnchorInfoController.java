...
public final class LegacyCursorAnchorInfoController {
    ...
    private final void updateCursorAnchorInfo() {
        ...
        this.localToScreen.invoke(Matrix.m5555boximpl(this.matrix));
        ...
        Matrix.m5578translateimpl(fArr, f, -rect2.getTop(), 0.0f);
