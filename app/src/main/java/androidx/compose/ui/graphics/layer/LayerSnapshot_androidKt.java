...
@Metadata(d1 = {"\u0000\f\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u001a\f\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u0002¨\u0006\u0003"}, d2 = {"toBitmap", "Landroid/graphics/Bitmap;", "Landroid/media/Image;", "ui-graphics"}, k = 2, mv = {2, 1, 0}, xi = 48)
public final class LayerSnapshot_androidKt {
    ...
    public static final Bitmap toBitmap(Image $this$toBitmap) {
        ...
        for (int i = 0; i < pixelCount; i++) {
            ...
            colors[i] = ColorKt.m5367toArgb8_81llA(ColorKt.Color(red, green, blue, alpha));
        }
