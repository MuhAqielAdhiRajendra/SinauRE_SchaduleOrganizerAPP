...
public final class DirectionsBusFilledKt {
    ...
    public static final ImageVector getDirectionsBusFilled(Icons.Rounded $this$DirectionsBusFilled) {
        ...
        ImageVector.Builder $this$_get_DirectionsBusFilled__u24lambda_u241 = new ImageVector.Builder("Rounded.DirectionsBusFilled", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(5.0f, 20.33f, 5.67f, 21.0f, 6.5f, 21.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(7.33f, 21.0f, 8.0f, 20.33f, 8.0f, 19.5f);
