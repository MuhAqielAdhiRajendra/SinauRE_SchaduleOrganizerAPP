...
public final class ScoreKt {
    ...
    public static final ImageVector getScore(Icons.Filled $this$Score) {
        if (_score != null) {
        ...
        ImageVector.Builder $this$_get_Score__u24lambda_u241 = new ImageVector.Builder("Filled.Score", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
