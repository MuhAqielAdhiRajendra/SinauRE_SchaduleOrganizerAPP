...
public final class HeadphonesBatteryKt {
    ...
    public static final ImageVector getHeadphonesBattery(Icons.Rounded $this$HeadphonesBattery) {
        ...
        ImageVector.Builder $this$_get_HeadphonesBattery__u24lambda_u242 = new ImageVector.Builder("Rounded.HeadphonesBattery", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(20.0f, 6.22f, 19.78f, 6.0f, 19.5f, 6.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(-1.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(18.22f, 6.0f, 18.0f, 6.22f, 18.0f, 6.5f);
