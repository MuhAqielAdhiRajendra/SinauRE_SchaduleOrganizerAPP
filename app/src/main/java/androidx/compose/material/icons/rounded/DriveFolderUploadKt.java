...
public final class DriveFolderUploadKt {
    ...
    public static final ImageVector getDriveFolderUpload(Icons.Rounded $this$DriveFolderUpload) {
        ...
        ImageVector.Builder $this$_get_DriveFolderUpload__u24lambda_u241 = new ImageVector.Builder("Rounded.DriveFolderUpload", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.2f, -0.2f, 0.51f, -0.19f, 0.71f, 0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(2.79f, 2.79f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(15.46f, 12.46f, 15.24f, 13.0f, 14.8f, 13.0f);
