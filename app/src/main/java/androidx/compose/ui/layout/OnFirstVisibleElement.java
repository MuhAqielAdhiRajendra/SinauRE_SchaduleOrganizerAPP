...
final class OnFirstVisibleElement extends ModifierNodeElement<OnFirstVisibleNode> {
    ...
    public OnFirstVisibleElement(long minDurationMs, float minFractionVisible, LayoutBoundsHolder viewportBounds, Function0<Unit> function0) {
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        $this$inspectableProperties.setName("onFirstVisible");
        ...
        $this$inspectableProperties.getProperties().set("viewportBounds", this.viewportBounds);
    ...
    public boolean equals(Object other) {
        ...
        if (this.minDurationMs != ((OnFirstVisibleElement) other).minDurationMs) {
            return false;
        }
        if (this.minFractionVisible == ((OnFirstVisibleElement) other).minFractionVisible) {
            z = true;
        } else {
            z = false;
        }
        if (z && Intrinsics.areEqual(this.viewportBounds, ((OnFirstVisibleElement) other).viewportBounds) && this.callback == ((OnFirstVisibleElement) other).callback) {
            return true;
        }
        return false;
    }
