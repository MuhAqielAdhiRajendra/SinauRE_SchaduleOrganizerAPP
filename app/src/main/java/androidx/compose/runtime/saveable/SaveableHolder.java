...
final class SaveableHolder<T> implements SaverScope, RememberObserver {
    ...
    public SaveableHolder(Saver<T, Object> saver, SaveableStateRegistry registry, String key, T t, Object[] inputs) {
        this.saver = saver;
    ...
    static final Object valueProvider$lambda$0(SaveableHolder this$0) {
        Saver<T, Object> saver = this$0.saver;
        SaveableHolder saveableHolder = this$0;
        T t = this$0.value;
        if (t != null) {
            return saver.save(saveableHolder, t);
        }
    ...
    private final void register() {
        ...
        if (registry != null) {
            RememberSaveableKt.requireCanBeSaved(registry, this.valueProvider.invoke());
