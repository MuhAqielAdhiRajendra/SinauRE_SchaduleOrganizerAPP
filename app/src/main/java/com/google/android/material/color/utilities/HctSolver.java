...
public class HctSolver {
            ...
            if (mid[0] < 0.0d) {
                ...
                if (!initialized) {
                    ...
                    if (uncut) {
                        ...
                        rightHue = rightHue2;
                        if (areInCyclicOrder(leftHue, midHue, rightHue2)) {
                        }
                    }
                    uncut = false;
    ...
    static int findResultByJ(double hueRadians, double chroma, double y) {
        ...
        while (iterationRound < 5) {
            ...
            double ac = viewingConditions.getAw() * Math.pow(jNormalized, (d3 / viewingConditions.getC()) / viewingConditions.getZ());
