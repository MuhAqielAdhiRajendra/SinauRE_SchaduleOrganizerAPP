...
public final class LocalPrintshopKt {
    ...
    public static final ImageVector getLocalPrintshop(Icons.Rounded $this$LocalPrintshop) {
        ...
        ImageVector.Builder $this$_get_LocalPrintshop__u24lambda_u242 = new ImageVector.Builder("Rounded.LocalPrintshop", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.verticalLineToRelative(-5.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveTo(22.0f, 9.34f, 20.66f, 8.0f, 19.0f, 8.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
        $this$PathData_u24lambda_u240$iv$iv$iv2.moveTo(18.0f, 12.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.reflectiveCurveTo(18.55f, 12.5f, 18.0f, 12.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
