...
public final class BentoKt {
    ...
    public static final ImageVector getBento(Icons.TwoTone $this$Bento) {
        if (_bento != null) {
        ...
        ImageVector.Builder $this$_get_Bento__u24lambda_u242 = new ImageVector.Builder("TwoTone.Bento", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(8.83f, 13.5f, 8.0f, 13.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(6.5f, 12.83f, 6.5f, 12.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(7.17f, 10.5f, 8.0f, 10.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_Bento__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 0.3f, null, 0.3f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
        $this$PathData_u24lambda_u240$iv$iv$iv2.moveTo(9.5f, 12.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveToRelative(0.0f, 0.83f, -0.67f, 1.5f, -1.5f, 1.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.reflectiveCurveTo(6.5f, 12.83f, 6.5f, 12.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.reflectiveCurveToRelative(0.67f, -1.5f, 1.5f, -1.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.reflectiveCurveTo(9.5f, 11.17f, 9.5f, 12.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
        _bento = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_Bento__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv2.getNodes(), pathFillType$iv2, "", fill$iv$iv2, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv2, strokeLineJoin$iv$iv2, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
        ImageVector imageVector2 = _bento;
