...
public final /* data */ class TabIndicatorModifier extends ModifierNodeElement<TabIndicatorOffsetNode> {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public TabIndicatorModifier(State<? extends List<TabPosition>> state, int selectedTabIndex, boolean followContentSize, FiniteAnimationSpec<Dp> finiteAnimationSpec) {
