...
public final class ForwardToInboxKt {
    ...
    public static final ImageVector getForwardToInbox(Icons.TwoTone $this$ForwardToInbox) {
        ...
        ImageVector.Builder $this$_get_ForwardToInbox__u24lambda_u242 = new ImageVector.Builder("TwoTone.ForwardToInbox", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
