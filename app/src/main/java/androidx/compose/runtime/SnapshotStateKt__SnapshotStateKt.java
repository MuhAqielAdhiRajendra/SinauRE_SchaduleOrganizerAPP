...
final /* synthetic */ class SnapshotStateKt__SnapshotStateKt {
    ...
    public static final <T> T getValue(State<? extends T> state, Object thisObj, KProperty<?> kProperty) {
    ...
    public static final <T> State<T> rememberUpdatedState(T t, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1058319986, $changed, -1, "androidx.compose.runtime.rememberUpdatedState (SnapshotState.kt:340)");
        }
        ComposerKt.sourceInformationMarkerStart($composer, 861744499, "CC(remember):SnapshotState.kt#9igjgp");
        Object it$iv = $composer.rememberedValue();
        if (it$iv == Composer.INSTANCE.getEmpty()) {
            Object value$iv = mutableStateOf$default(t, null, 2, null);
            $composer.updateRememberedValue(value$iv);
            it$iv = value$iv;
        }
        MutableState $this$rememberUpdatedState_u24lambda_u241 = (MutableState) it$iv;
        ComposerKt.sourceInformationMarkerEnd($composer);
        $this$rememberUpdatedState_u24lambda_u241.setValue(t);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        return $this$rememberUpdatedState_u24lambda_u241;
    }
}
