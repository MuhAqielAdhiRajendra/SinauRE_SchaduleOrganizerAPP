...
final class LazyStaggeredGridSlotCache implements LazyGridStaggeredGridSlotsProvider {
    ...
    public LazyStaggeredGridSlots mo1276invoke0kLqBqw(Density density, long constraints) {
        if (this.cachedSizes != null && Constraints.m8096equalsimpl0(this.cachedConstraints, constraints)) {
        ...
        LazyStaggeredGridSlots lazyStaggeredGridSlotsInvoke = this.calculation.invoke(density, Constraints.m8090boximpl(constraints));
        LazyStaggeredGridSlots it = lazyStaggeredGridSlotsInvoke;
        this.cachedSizes = it;
