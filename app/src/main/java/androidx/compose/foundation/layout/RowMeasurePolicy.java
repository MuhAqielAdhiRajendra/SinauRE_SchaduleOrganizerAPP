...
public final /* data */ class RowMeasurePolicy implements MeasurePolicy, RowColumnMeasurePolicy {
    ...
    public MeasureResult mo39measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        return RowColumnMeasurePolicyKt.measure$default(this, Constraints.m8105getMinWidthimpl(constraints), Constraints.m8104getMinHeightimpl(constraints), Constraints.m8103getMaxWidthimpl(constraints), Constraints.m8102getMaxHeightimpl(constraints), $this$measure_u2d3p2s80s.mo426roundToPx0680j_4(this.horizontalArrangement.getSpacing()), $this$measure_u2d3p2s80s, list, new Placeable[list.size()], 0, list.size(), null, 0, 3072, null);
    }
    ...
    public static final Unit placeHelper$lambda$0$0(Placeable[] $placeables, RowMeasurePolicy this$0, int $crossAxisLayoutSize, int $beforeCrossAxisAlignmentLine, int[] $mainAxisPositions, Placeable.PlacementScope $this$layout) {
        int index$iv = 0;
    ...
    private final int getCrossAxisPosition(Placeable placeable, RowColumnParentData parentData, int crossAxisLayoutSize, int beforeCrossAxisAlignmentLine) {
        ...
        if (childCrossAlignment != null) {
            return childCrossAlignment.align$foundation_layout(crossAxisLayoutSize, crossAxisSize(placeable), LayoutDirection.Ltr, placeable, beforeCrossAxisAlignmentLine);
        }
        return this.verticalAlignment.align(crossAxisSize(placeable), crossAxisLayoutSize);
    }
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends IntrinsicMeasurable> list, int height) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMinWidth(list, height, $this$minIntrinsicWidth.mo426roundToPx0680j_4(this.horizontalArrangement.getSpacing()));
    }
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List<? extends IntrinsicMeasurable> list, int width) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMinHeight(list, width, $this$minIntrinsicHeight.mo426roundToPx0680j_4(this.horizontalArrangement.getSpacing()));
    }
    ...
    public int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List<? extends IntrinsicMeasurable> list, int height) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMaxWidth(list, height, $this$maxIntrinsicWidth.mo426roundToPx0680j_4(this.horizontalArrangement.getSpacing()));
    }
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List<? extends IntrinsicMeasurable> list, int width) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMaxHeight(list, width, $this$maxIntrinsicHeight.mo426roundToPx0680j_4(this.horizontalArrangement.getSpacing()));
    }
}
