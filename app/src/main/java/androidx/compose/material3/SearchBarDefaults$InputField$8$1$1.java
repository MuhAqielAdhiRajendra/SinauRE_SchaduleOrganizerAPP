...
final class SearchBarDefaults$InputField$8$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ SearchBarState $searchBarState;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    SearchBarDefaults$InputField$8$1$1(SearchBarState searchBarState, Continuation<? super SearchBarDefaults$InputField$8$1$1> continuation) {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((SearchBarDefaults$InputField$8$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
