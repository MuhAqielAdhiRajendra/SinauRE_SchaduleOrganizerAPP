...
public class MutableState<T> extends StateObjectImpl implements SnapshotMutableState<T> {
    ...
    public MutableState(T t, SnapshotMutationPolicy<T> snapshotMutationPolicy) {
        ...
        StateStateRecord<T> stateStateRecord = new StateStateRecord<>(snapshot.getSnapshotId(), t);
    ...
    public void setValue(T t) {
        ...
        if (!getPolicy().equivalent(stateStateRecord.getValue(), t)) {
            ...
            MutableState<T> mutableState = this;
            StateStateRecord stateStateRecord3 = stateStateRecord;
            synchronized (SnapshotKt.getLock()) {
                current = Snapshot.INSTANCE.getCurrent();
                ((StateStateRecord) SnapshotKt.overwritableRecord(stateStateRecord2, mutableState, current, stateStateRecord3)).setValue(t);
                Unit unit = Unit.INSTANCE;
            }
            SnapshotKt.notifyWrite(current, mutableState);
        }
    }
    ...
    /* JADX INFO: compiled from: SnapshotState.kt */
    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0002\b\t\b\u0002\u0018\u0000*\u0004\b\u0001\u0010\u00012\u00020\u0002B\u001b\u0012\n\u0010\u0003\u001a\u00060\u0004j\u0002`\u0005\u0012\u0006\u0010\u0006\u001a\u00028\u0001¢\u0006\u0004\b\u0007\u0010\bJ\u0010\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\u0002H\u0016J\u000e\u0010\f\u001a\b\u0012\u0004\u0012\u00028\u00010\u0000H\u0016J\u001f\u0010\f\u001a\b\u0012\u0004\u0012\u00028\u00010\u00002\n\u0010\u0003\u001a\u00060\u0004j\u0002`\u0005H\u0016¢\u0006\u0002\u0010\rR\u001c\u0010\u000b\u001a\u00028\u0001X\u0086\u000e¢\u0006\u0010\n\u0002\u0010\u0012\u001a\u0004\b\u000e\u0010\u000f\"\u0004\b\u0010\u0010\u0011¨\u0006\u0013"}, d2 = {"Landroidx/compose/runtime/SnapshotMutableStateImpl$StateStateRecord;", "T", "Landroidx/compose/runtime/snapshots/StateRecord;", "snapshotId", "", "Landroidx/compose/runtime/snapshots/SnapshotId;", "myValue", "<init>", "(JLjava/lang/Object;)V", "assign", "", "value", "create", "(J)Landroidx/compose/runtime/SnapshotMutableStateImpl$StateStateRecord;", "getValue", "()Ljava/lang/Object;", "setValue", "(Ljava/lang/Object;)V", "Ljava/lang/Object;", "runtime"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    static final Unit component2$lambda$0(MutableState this$0, Object it) {
        this$0.setValue(it);
    ...
    public Function1<T, Unit> component2() {
        return new Function1() { // from class: androidx.compose.runtime.SnapshotMutableStateImpl$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return MutableState.component2$lambda$0(this.f$0, obj);
            }
        };
    }
