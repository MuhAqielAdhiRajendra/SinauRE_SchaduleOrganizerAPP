...
public final class MutableObjectFloatMap<K> extends ObjectFloatMap<K> {
    ...
    public final void putAll(ObjectFloatMap<K> from) {
        ...
        int $i$f$forEach3 = 0;
        Object[] k$iv3 = objectFloatMap.keys;
    ...
    */
    ...
    public final void dropDeletes$collection() {
        ...
        long[] metadata = mutableObjectFloatMap.metadata;
        int capacity = mutableObjectFloatMap._capacity;
        Object[] keys = mutableObjectFloatMap.keys;
        float[] values = mutableObjectFloatMap.values;
        ...
        while (index != capacity) {
            ...
            if (m == 128) {
                ...
                int $i$f$h1 = hash >>> 7;
                int i = hash1;
                int targetIndex = mutableObjectFloatMap.findFirstAvailableSlot($i$f$h1);
                ...
                if (newProbeIndex != oldProbeIndex) {
                    ...
                    if (((metadata2[targetIndex >> 3] >> ((targetIndex & 7) << 3)) & 255) == 128) {
                        ...
                        keys[targetIndex] = keys[index];
                        keys[index] = oldKey;
                        float oldValue = values[targetIndex];
                        values[targetIndex] = values[index];
