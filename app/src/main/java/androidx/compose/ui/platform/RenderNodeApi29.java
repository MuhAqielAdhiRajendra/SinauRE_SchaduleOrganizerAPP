...
public final class RenderNodeApi29 implements DeviceRenderNode {
    ...
    private int internalCompositingStrategy = CompositingStrategy.INSTANCE.m5402getAutoNrFUSI();
    ...
    public void mo7263setBlendModes9anfk8(int value) {
        this.blendMode = value;
        Paint $this$setBlendMode_s9anfk8_u24lambda_u240 = obtainLayerPaint();
        $this$setBlendMode_s9anfk8_u24lambda_u240.mo5188setBlendModes9anfk8(value);
    ...
    public void setColorFilter(ColorFilter value) {
        ...
        $this$_set_colorFilter__u24lambda_u240.setColorFilter(value);
        updateLayerProperties();
    }
    ...
    public void mo7264setCompositingStrategyaDBOjCE(int value) {
    ...
    private final void updateLayerProperties() {
        ...
        if (zRequiresCompositingLayer) {
            m7318applyCompositingStrategyQu9p0E8(renderNode, CompositingStrategy.INSTANCE.m5404getOffscreenNrFUSI());
        } else {
            m7318applyCompositingStrategyQu9p0E8(renderNode, this.internalCompositingStrategy);
        }
    }

    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m5398equalsimpl0(getInternalCompositingStrategy(), CompositingStrategy.INSTANCE.m5404getOffscreenNrFUSI()) || requiresLayerPaint();
    }
    ...
    private final void m7318applyCompositingStrategyQu9p0E8(RenderNode $this$applyCompositingStrategy_u2dQu9p0E8, int compositingStrategy) {
        if (CompositingStrategy.m5398equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m5404getOffscreenNrFUSI())) {
            Paint paint = this.layerPaint;
            $this$applyCompositingStrategy_u2dQu9p0E8.setUseCompositingLayer(true, paint != null ? AndroidPaint_androidKt.getNativePaint(paint) : null);
            $this$applyCompositingStrategy_u2dQu9p0E8.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m5398equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m5403getModulateAlphaNrFUSI())) {
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            ...
            Canvas.m5284clipPathmtrdDE$default($this$record_u24lambda_u240, clipPath, 0, 2, null);
        }
