...
public final class GppMaybeKt {
    ...
    public static final ImageVector getGppMaybe(Icons.Rounded $this$GppMaybe) {
        if (_gppMaybe != null) {
        ...
        ImageVector.Builder $this$_get_GppMaybe__u24lambda_u241 = new ImageVector.Builder("Rounded.GppMaybe", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
