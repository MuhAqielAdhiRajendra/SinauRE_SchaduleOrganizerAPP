...
public final class OpenWithKt {
    ...
    public static final ImageVector getOpenWith(Icons.Rounded $this$OpenWith) {
        if (_openWith != null) {
        ...
        ImageVector.Builder $this$_get_OpenWith__u24lambda_u241 = new ImageVector.Builder("Rounded.OpenWith", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(10.5f, 9.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(7.85f, 5.15f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(6.0f, 8.21f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -0.28f, -0.22f, -0.5f, -0.5f, -0.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(22.65f, 11.65f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-3.79f, -3.79f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(8.21f, 18.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.45f, 0.0f, -0.67f, 0.54f, -0.35f, 0.85f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(3.79f, 3.79f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.2f, 0.2f, 0.51f, 0.2f, 0.71f, 0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(3.79f, -3.79f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -0.28f, -0.22f, -0.5f, -0.5f, -0.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _openWith = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_OpenWith__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
        ImageVector imageVector2 = _openWith;
