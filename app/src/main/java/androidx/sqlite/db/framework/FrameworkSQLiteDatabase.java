...
public final class FrameworkSQLiteDatabase implements SupportSQLiteDatabase {
    ...
    public void m8648setMaximumSize(long numBytes) {
    ...
    public Cursor query(final SupportSQLiteQuery query) {
        ...
        Cursor cursorRawQueryWithFactory = this.delegate.rawQueryWithFactory(new SQLiteDatabase.CursorFactory() { // from class: androidx.sqlite.db.framework.FrameworkSQLiteDatabase$$ExternalSyntheticLambda2
            ...
            public final Cursor newCursor(SQLiteDatabase sQLiteDatabase, SQLiteCursorDriver sQLiteCursorDriver, String str, SQLiteQuery sQLiteQuery) {
                return FrameworkSQLiteDatabase.query$lambda$1(cursorFactory, sQLiteDatabase, sQLiteCursorDriver, str, sQLiteQuery);
            }
    ...
    static final SQLiteCursor query$lambda$0(SupportSQLiteQuery $query, SQLiteDatabase sQLiteDatabase, SQLiteCursorDriver masterQuery, String editTable, SQLiteQuery sqLiteQuery) {
        Intrinsics.checkNotNull(sqLiteQuery);
        $query.bindTo(new FrameworkSQLiteProgram(sqLiteQuery));
        return new SQLiteCursor(masterQuery, editTable, sqLiteQuery);
    }

    static final Cursor query$lambda$1(Function4 $tmp0, SQLiteDatabase p0, SQLiteCursorDriver p1, String p2, SQLiteQuery p3) {
    ...
    static final Cursor query$lambda$2(SupportSQLiteQuery $query, SQLiteDatabase sQLiteDatabase, SQLiteCursorDriver masterQuery, String editTable, SQLiteQuery sqLiteQuery) {
        Intrinsics.checkNotNull(sqLiteQuery);
        $query.bindTo(new FrameworkSQLiteProgram(sqLiteQuery));
        return new SQLiteCursor(masterQuery, editTable, sqLiteQuery);
    }
    ...
    static final Method getThreadSessionMethod_delegate$lambda$7() {
        try {
    ...
    static final Method beginTransactionMethod_delegate$lambda$8() {
        Class<?> returnType;
        try {
            Method getThreadSessionMethod = Companion.getGetThreadSessionMethod();
