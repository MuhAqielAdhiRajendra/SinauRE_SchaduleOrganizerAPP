...
public final class EventAvailableKt {
    ...
    public static final ImageVector getEventAvailable(Icons.Filled $this$EventAvailable) {
        ...
        ImageVector.Builder $this$_get_EventAvailable__u24lambda_u241 = new ImageVector.Builder("Filled.EventAvailable", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(16.53f, 11.06f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(15.47f, 10.0f);
