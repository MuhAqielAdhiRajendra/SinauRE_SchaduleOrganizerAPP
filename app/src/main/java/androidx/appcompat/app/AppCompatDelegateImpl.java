...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public Context attachBaseContext2(Context baseContext) {
        ...
        if (!(baseContext instanceof ContextThemeWrapper)) {
            ...
            baseContext2 = baseContext;
            Configuration config = createOverrideAppConfiguration(baseContext2, modeToApply, localesToApply, null, false);
            try {
                ((ContextThemeWrapper) baseContext2).applyOverrideConfiguration(config);
                return baseContext2;
            } catch (IllegalStateException e) {
            }
        }
        if (baseContext2 instanceof androidx.appcompat.view.ContextThemeWrapper) {
            Configuration config2 = createOverrideAppConfiguration(baseContext2, modeToApply, localesToApply, null, false);
            try {
                ((androidx.appcompat.view.ContextThemeWrapper) baseContext2).applyOverrideConfiguration(config2);
                return baseContext2;
        ...
        Configuration config3 = createOverrideAppConfiguration(baseContext2, modeToApply, localesToApply, configOverlay, true);
        androidx.appcompat.view.ContextThemeWrapper wrappedContext = new androidx.appcompat.view.ContextThemeWrapper(baseContext2, androidx.appcompat.R.style.Theme_AppCompat_Empty);
    ...
    @Override // androidx.appcompat.app.AppCompatDelegate
    public void onConfigurationChanged(Configuration newConfig) throws IllegalAccessException {
        ActionBar ab;
        ...
        if (mode != null) {
                ...
                if (this.mIsFloating) {
                    ...
                    this.mShowActionModePopup = new Runnable() { // from class: androidx.appcompat.app.AppCompatDelegateImpl.6
                        ...
                        public void run() {
                            ...
                            boolean zShouldAnimateActionModeView = AppCompatDelegateImpl.this.shouldAnimateActionModeView();
                            AppCompatDelegateImpl appCompatDelegateImpl = AppCompatDelegateImpl.this;
                            if (!zShouldAnimateActionModeView) {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode2, mode2.getMenu())) {
                    ...
                    boolean zShouldAnimateActionModeView = shouldAnimateActionModeView();
    ...
    public View createView(View view, String name, Context context, AttributeSet attrs) {
        ...
        if (!IS_PRE_LOLLIPOP) {
            ...
            if (this.mLayoutIncludeDetector.detect(attrs)) {
                ...
                boolean inheritContext2 = zShouldInheritContext;
                inheritContext = inheritContext2;
            }
        }
        View parent = this.mAppCompatViewInflater.createView(view, name, context, attrs, inheritContext, IS_PRE_LOLLIPOP, true, VectorEnabledTintResources.shouldBeUsed());
        return parent;
    }
    ...
    */
    ...
    private void updateStatusGuardColor(View v) {
        ...
        Context context = this.mContext;
        if (lightStatusBar) {
            color = ContextCompat.getColor(context, androidx.appcompat.R.color.abc_decor_view_status_guard_light);
        } else {
            color = ContextCompat.getColor(context, androidx.appcompat.R.color.abc_decor_view_status_guard);
        }
    ...
    private boolean applyApplicationSpecificConfig(boolean allowRecreation, boolean isLocalesApplicationRequired) throws IllegalAccessException {
        if (this.mDestroyed) {
            return false;
        }
    ...
    private boolean updateAppConfiguration(int nightMode, LocaleListCompat locales, boolean allowRecreation) throws IllegalAccessException {
    ...
    private void updateResourcesConfiguration(int uiModeNightModeValue, LocaleListCompat locales, boolean callOnConfigChange, Configuration configOverlay) throws IllegalAccessException {
    ...
    private void updateActivityConfiguration(Configuration conf) {
        ...
        if (activity instanceof LifecycleOwner) {
            Lifecycle lifecycle = ((LifecycleOwner) activity).getLifecycleRegistry();
    ...
    private final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public void onCloseMenu(MenuBuilder menu, boolean allMenusAreClosing) {
            ...
            if (panel != null) {
                AppCompatDelegateImpl appCompatDelegateImpl = AppCompatDelegateImpl.this;
                if (isSubMenu) {
                    appCompatDelegateImpl.callOnPanelClosed(panel.featureId, panel, parentMenu);
                    AppCompatDelegateImpl.this.closePanel(panel, true);
                } else {
                    appCompatDelegateImpl.closePanel(panel, allMenusAreClosing);
                }
            }
        }
