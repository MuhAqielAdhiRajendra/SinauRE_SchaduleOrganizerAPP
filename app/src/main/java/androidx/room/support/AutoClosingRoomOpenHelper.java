...
public final class AutoClosingRoomOpenHelper implements SupportSQLiteOpenHelper, DelegatingOpenHelper {
    ...
    public static final class AutoClosingSupportSQLiteDatabase implements SupportSQLiteDatabase {
        ...
        static final Object pokeOpen$lambda$0(SupportSQLiteDatabase it) {
        ...
        static final Unit _set_version_$lambda$1(int $version, SupportSQLiteDatabase db) {
        ...
        static final long setMaximumSize$lambda$2(long $numBytes, SupportSQLiteDatabase db) {
            Intrinsics.checkNotNullParameter(db, "db");
        ...
        static final Object _set_pageSize_$lambda$3(long $numBytes, SupportSQLiteDatabase db) {
            Intrinsics.checkNotNullParameter(db, "db");
        ...
        static final long insert$lambda$4(String $table, int $conflictAlgorithm, ContentValues $values, SupportSQLiteDatabase db) {
            Intrinsics.checkNotNullParameter(db, "db");
        ...
        static final int delete$lambda$5(String $table, String $whereClause, Object[] $whereArgs, SupportSQLiteDatabase db) {
            Intrinsics.checkNotNullParameter(db, "db");
        ...
        static final int update$lambda$6(String $table, int $conflictAlgorithm, ContentValues $values, String $whereClause, Object[] $whereArgs, SupportSQLiteDatabase db) {
            Intrinsics.checkNotNullParameter(db, "db");
            return db.update($table, $conflictAlgorithm, $values, $whereClause, $whereArgs);
        }

        static final Unit execSQL$lambda$7(String $sql, SupportSQLiteDatabase db) {
            Intrinsics.checkNotNullParameter(db, "db");
            db.execSQL($sql);
            return Unit.INSTANCE;
        }
        ...
        static final Unit execSQL$lambda$8(String $sql, Object[] $bindArgs, SupportSQLiteDatabase db) {
            Intrinsics.checkNotNullParameter(db, "db");
        ...
        static final boolean needUpgrade$lambda$9(int $newVersion, SupportSQLiteDatabase db) {
            Intrinsics.checkNotNullParameter(db, "db");
        ...
        static final Unit setLocale$lambda$10(Locale $locale, SupportSQLiteDatabase db) {
            Intrinsics.checkNotNullParameter(db, "db");
            db.setLocale($locale);
            return Unit.INSTANCE;
        }
        ...
        static final Unit setMaxSqlCacheSize$lambda$11(int $cacheSize, SupportSQLiteDatabase db) {
            Intrinsics.checkNotNullParameter(db, "db");
        ...
        static final Unit setForeignKeyConstraintsEnabled$lambda$12(boolean $enabled, SupportSQLiteDatabase db) {
            Intrinsics.checkNotNullParameter(db, "db");
    ...
    static final class AutoClosingSupportSQLiteStatement implements SupportSQLiteStatement {
        ...
        static final Unit execute$lambda$0(SupportSQLiteStatement statement) {
        ...
        static final int executeUpdateDelete$lambda$1(SupportSQLiteStatement obj) {
        ...
        static final long executeInsert$lambda$2(SupportSQLiteStatement obj) {
            Intrinsics.checkNotNullParameter(obj, "obj");
        ...
        static final long simpleQueryForLong$lambda$3(SupportSQLiteStatement obj) {
            Intrinsics.checkNotNullParameter(obj, "obj");
        ...
        static final String simpleQueryForString$lambda$4(SupportSQLiteStatement obj) {
            Intrinsics.checkNotNullParameter(obj, "obj");
        ...
        static final Object executeWithRefCount$lambda$5(AutoClosingSupportSQLiteStatement this$0, Function1 $block, SupportSQLiteDatabase db) {
            Intrinsics.checkNotNullParameter(db, "db");
