...
/* JADX INFO: compiled from: TransactionExecutor.android.kt */
...
public final class TransactionExecutor implements Executor {
    ...
    static final void execute$lambda$1$lambda$0(Runnable $command, TransactionExecutor this$0) {
        try {
            $command.run();
        } finally {
            this$0.scheduleNext();
