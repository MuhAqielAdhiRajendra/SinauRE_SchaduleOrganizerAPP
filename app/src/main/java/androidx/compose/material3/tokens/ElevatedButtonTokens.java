...
public final class ElevatedButtonTokens {
    ...
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m3805getLevel1D9Ej5fM();
    ...
    private static final float FocusedContainerElevation = ElevationTokens.INSTANCE.m3805getLevel1D9Ej5fM();
    ...
    private static final float HoveredContainerElevation = ElevationTokens.INSTANCE.m3806getLevel2D9Ej5fM();
    ...
    private static final float PressedContainerElevation = ElevationTokens.INSTANCE.m3805getLevel1D9Ej5fM();
    ...
    private static final ColorSchemeKeyTokens UnselectedContainerColor = ColorSchemeKeyTokens.SurfaceContainerLow;
    private static final ColorSchemeKeyTokens UnselectedFocusedIconColor = ColorSchemeKeyTokens.Primary;
    private static final ColorSchemeKeyTokens UnselectedFocusedLabelTextColor = ColorSchemeKeyTokens.Primary;
    private static final ColorSchemeKeyTokens UnselectedHoveredIconColor = ColorSchemeKeyTokens.Primary;
    private static final ColorSchemeKeyTokens UnselectedHoveredLabelTextColor = ColorSchemeKeyTokens.Primary;
    private static final ColorSchemeKeyTokens UnselectedIconColor = ColorSchemeKeyTokens.OnPrimary;
    private static final ColorSchemeKeyTokens UnselectedPressedIconColor = ColorSchemeKeyTokens.Primary;
    private static final ColorSchemeKeyTokens UnselectedPressedLabelTextColor = ColorSchemeKeyTokens.Primary;
    ...
    public final float m3792getContainerElevationD9Ej5fM() {
    ...
    public final float m3793getDisabledContainerElevationD9Ej5fM() {
    ...
    public final float m3794getFocusedContainerElevationD9Ej5fM() {
    ...
    public final float m3795getHoveredContainerElevationD9Ej5fM() {
    ...
    public final float m3796getPressedContainerElevationD9Ej5fM() {
