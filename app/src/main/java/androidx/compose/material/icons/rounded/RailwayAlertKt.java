...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_railwayAlert", "Landroidx/compose/ui/graphics/vector/ImageVector;", "RailwayAlert", "Landroidx/compose/material/icons/Icons$Rounded;", "getRailwayAlert", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class RailwayAlertKt {
    private static ImageVector _railwayAlert;

    public static final ImageVector getRailwayAlert(Icons.Rounded $this$RailwayAlert) {
        ...
        ImageVector.Builder $this$_get_RailwayAlert__u24lambda_u242 = new ImageVector.Builder("Rounded.RailwayAlert", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(2.0f, 18.43f, 3.57f, 20.0f, 5.5f, 20.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-1.21f, 0.81f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(4.11f, 20.93f, 4.0f, 21.13f, 4.0f, 21.35f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(4.0f, 21.71f, 4.29f, 22.0f, 4.65f, 22.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(11.5f, 16.33f, 10.83f, 17.0f, 10.0f, 17.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_RailwayAlert__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveTo(17.5f, 8.22f, 17.72f, 8.0f, 18.0f, 8.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
        _railwayAlert = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_RailwayAlert__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv2.getNodes(), pathFillType$iv2, "", fill$iv$iv2, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv2, strokeLineJoin$iv$iv2, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
