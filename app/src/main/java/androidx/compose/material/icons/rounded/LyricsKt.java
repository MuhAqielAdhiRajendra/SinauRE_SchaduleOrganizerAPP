...
public final class LyricsKt {
    ...
    public static final ImageVector getLyrics(Icons.Rounded $this$Lyrics) {
        if (_lyrics != null) {
        ...
        ImageVector.Builder $this$_get_Lyrics__u24lambda_u242 = new ImageVector.Builder("Rounded.Lyrics", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
