...
public final class FlatwareKt {
    ...
    public static final ImageVector getFlatware(Icons.Sharp $this$Flatware) {
        if (_flatware != null) {
        ...
        ImageVector.Builder $this$_get_Flatware__u24lambda_u241 = new ImageVector.Builder("Sharp.Flatware", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(5.28f, 3.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(4.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineTo(4.44f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineTo(3.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(3.72f, 3.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineTo(3.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(8.28f, 3.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
