...
public final class TransparentObserverMutableSnapshot extends MutableSnapshot {
    ...
    public TransparentObserverMutableSnapshot(MutableSnapshot parentSnapshot, Function1<Object, Unit> function1, Function1<Object, Unit> function12, boolean mergeParentObservers, boolean ownsParentSnapshot) {
        Function1<Object, Unit> writeObserver$runtime;
        Function1<Object, Unit> readObserver;
        super(SnapshotKt.INVALID_SNAPSHOT, SnapshotIdSet.INSTANCE.getEMPTY(), SnapshotKt.mergedReadObserver(function1, (parentSnapshot == null || (readObserver = parentSnapshot.getReadObserver()) == null) ? SnapshotKt.globalSnapshot.getReadObserver() : readObserver, mergeParentObservers), SnapshotKt.mergedWriteObserver(function12, (parentSnapshot == null || (writeObserver$runtime = parentSnapshot.getWriteObserver$runtime()) == null) ? SnapshotKt.globalSnapshot.getWriteObserver$runtime() : writeObserver$runtime));
    ...
    public void mo4710recordModified$runtime(StateObject state) {
        getCurrentSnapshot().mo4710recordModified$runtime(state);
    }
    ...
    public MutableSnapshot takeNestedMutableSnapshot(Function1<Object, Unit> readObserver, Function1<Object, Unit> writeObserver) {
        ...
        if (!this.mergeParentObservers) {
            MutableSnapshot nestedSnapshot = getCurrentSnapshot().takeNestedMutableSnapshot(null, function1MergedWriteObserver);
            return new TransparentObserverMutableSnapshot(nestedSnapshot, function1MergedReadObserver$default, function1MergedWriteObserver, false, true);
        }
