...
public final class BallotKt {
    ...
    public static final ImageVector getBallot(Icons.Filled $this$Ballot) {
        if (_ballot != null) {
        ...
        ImageVector.Builder $this$_get_Ballot__u24lambda_u241 = new ImageVector.Builder("Filled.Ballot", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(21.0f, 20.1f, 20.1f, 21.0f, 19.0f, 21.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
