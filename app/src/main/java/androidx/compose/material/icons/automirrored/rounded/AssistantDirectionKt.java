...
public final class AssistantDirectionKt {
    ...
    public static final ImageVector getAssistantDirection(Icons.AutoMirrored.Rounded $this$AssistantDirection) {
        ...
        ImageVector.Builder $this$_get_AssistantDirection__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Rounded.AssistantDirection", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
