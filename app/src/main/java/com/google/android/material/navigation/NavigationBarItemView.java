...
public abstract class NavigationBarItemView extends FrameLayout implements NavigationBarMenuItemView {
    ...
    public NavigationBarItemView(Context context) {
        ...
        this.innerContentContainer.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: com.google.android.material.navigation.NavigationBarItemView$$ExternalSyntheticLambda0
            ...
            public final void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                this.f$0.m8847xe6e25373(view, i, i2, i3, i4, i5, i6, i7, i8);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$0$com-google-android-material-navigation-NavigationBarItemView, reason: not valid java name */
    /* synthetic */ void m8847xe6e25373(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
    ...
    private void refreshItemBackground() {
        ...
        if (this.itemRippleColor != null) {
            ...
            if (this.activeIndicatorEnabled && activeIndicatorDrawable != null) {
                ...
                RippleDrawable rippleDrawable = new RippleDrawable(RippleUtils.sanitizeRippleDrawableColor(this.itemRippleColor), null, activeIndicatorDrawable);
                MaterialShapeDrawable shapeDrawable = activeIndicatorDrawable instanceof MaterialShapeDrawable ? (MaterialShapeDrawable) activeIndicatorDrawable : null;
    ...
    private Drawable createItemBackgroundCompat(ColorStateList rippleColor) {
