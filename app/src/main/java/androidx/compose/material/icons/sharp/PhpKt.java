...
public final class PhpKt {
    ...
    public static final ImageVector getPhp(Icons.Sharp $this$Php) {
        if (_php != null) {
        ...
        ImageVector.Builder $this$_get_Php__u24lambda_u241 = new ImageVector.Builder("Sharp.Php", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
