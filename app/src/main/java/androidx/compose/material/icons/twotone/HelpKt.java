...
public final class HelpKt {
    ...
    public static final ImageVector getHelp(Icons.TwoTone $this$Help) {
        if (_help != null) {
        ...
        ImageVector.Builder $this$_get_Help__u24lambda_u242 = new ImageVector.Builder("TwoTone.Help", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
