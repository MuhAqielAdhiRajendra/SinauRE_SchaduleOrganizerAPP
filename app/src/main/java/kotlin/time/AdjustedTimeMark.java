...
final class AdjustedTimeMark implements TimeMark {
    ...
    public /* bridge */ TimeMark mo10269minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m10395minusLRDsOJo(this, duration);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: elapsedNow-UwyO8pc */
    public long mo10268elapsedNowUwyO8pc() {
        return Duration.m10308minusLRDsOJo(this.mark.mo10268elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo10271plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m10309plusLRDsOJo(this.adjustment, duration), null);
    }
}
