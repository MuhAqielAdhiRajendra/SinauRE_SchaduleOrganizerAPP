...
public final class AudioFileKt {
    ...
    public static final ImageVector getAudioFile(Icons.Sharp $this$AudioFile) {
        if (_audioFile != null) {
        ...
        ImageVector.Builder $this$_get_AudioFile__u24lambda_u241 = new ImageVector.Builder("Sharp.AudioFile", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
