...
public final class NavigationRailItemColors {
    ...
    public final long m2775getSelectedIndicatorColor0d7_KjU() {
    ...
    public final NavigationRailItemColors m2770copy4JmcsL4(long selectedIconColor, long selectedTextColor, long selectedIndicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor) {
    ...
    public final long m2779iconColorWaAFU9c$material3(boolean selected, boolean enabled) {
    ...
    public final long m2780textColorWaAFU9c$material3(boolean selected, boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof NavigationRailItemColors) && Color.m5314equalsimpl0(this.selectedIconColor, ((NavigationRailItemColors) other).selectedIconColor) && Color.m5314equalsimpl0(this.unselectedIconColor, ((NavigationRailItemColors) other).unselectedIconColor) && Color.m5314equalsimpl0(this.selectedTextColor, ((NavigationRailItemColors) other).selectedTextColor) && Color.m5314equalsimpl0(this.unselectedTextColor, ((NavigationRailItemColors) other).unselectedTextColor) && Color.m5314equalsimpl0(this.selectedIndicatorColor, ((NavigationRailItemColors) other).selectedIndicatorColor) && Color.m5314equalsimpl0(this.disabledIconColor, ((NavigationRailItemColors) other).disabledIconColor) && Color.m5314equalsimpl0(this.disabledTextColor, ((NavigationRailItemColors) other).disabledTextColor)) {
            return true;
        }
        return false;
    }
