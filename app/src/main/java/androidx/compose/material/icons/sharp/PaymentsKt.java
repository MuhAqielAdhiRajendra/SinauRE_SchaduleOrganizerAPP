...
public final class PaymentsKt {
    ...
    public static final ImageVector getPayments(Icons.Sharp $this$Payments) {
        if (_payments != null) {
        ...
        ImageVector.Builder $this$_get_Payments__u24lambda_u241 = new ImageVector.Builder("Sharp.Payments", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(13.0f, 11.66f, 13.0f, 10.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
