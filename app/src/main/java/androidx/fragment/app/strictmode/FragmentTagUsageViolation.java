...
public final class FragmentTagUsageViolation extends Violation {
    ...
    public FragmentTagUsageViolation(Fragment fragment, ViewGroup parentContainer) {
        super(fragment, "Attempting to use <fragment> tag to add fragment " + fragment + " to container " + parentContainer);
