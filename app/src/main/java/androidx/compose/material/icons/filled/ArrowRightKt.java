...
public final class ArrowRightKt {
    ...
    public static final ImageVector getArrowRight(Icons.Filled $this$ArrowRight) {
        if (_arrowRight != null) {
        ...
        ImageVector.Builder $this$_get_ArrowRight__u24lambda_u241 = new ImageVector.Builder("Filled.ArrowRight", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
