...
public interface LayoutCoordinates {
    ...
    long mo6792localPositionOfR5De75A(LayoutCoordinates sourceCoordinates, long relativeToSource);

    /* JADX INFO: renamed from: localToRoot-MK-Hz9U, reason: not valid java name */
    long mo6794localToRootMKHz9U(long relativeToLocal);

    /* JADX INFO: renamed from: localToWindow-MK-Hz9U, reason: not valid java name */
    long mo6796localToWindowMKHz9U(long relativeToLocal);

    /* JADX INFO: renamed from: windowToLocal-MK-Hz9U, reason: not valid java name */
    long mo6800windowToLocalMKHz9U(long relativeToWindow);
    ...
    public static final class DefaultImpls {
        ...
        public static long m6804screenToLocalMKHz9U(LayoutCoordinates $this, long relativeToScreen) {
            return LayoutCoordinates.super.mo6797screenToLocalMKHz9U(relativeToScreen);
        }

        @Deprecated
        /* JADX INFO: renamed from: localToScreen-MK-Hz9U, reason: not valid java name */
        public static long m6803localToScreenMKHz9U(LayoutCoordinates $this, long relativeToLocal) {
            return LayoutCoordinates.super.mo6795localToScreenMKHz9U(relativeToLocal);
        }

        @Deprecated
        /* JADX INFO: renamed from: localPositionOf-S_NoaFU, reason: not valid java name */
        public static long m6801localPositionOfS_NoaFU(LayoutCoordinates $this, LayoutCoordinates sourceCoordinates, long relativeToSource, boolean includeMotionFrameOfReference) {
            return LayoutCoordinates.super.mo6793localPositionOfS_NoaFU(sourceCoordinates, relativeToSource, includeMotionFrameOfReference);
        }

        @Deprecated
        /* JADX INFO: renamed from: transformFrom-EL8BTi8, reason: not valid java name */
        public static void m6805transformFromEL8BTi8(LayoutCoordinates $this, LayoutCoordinates sourceCoordinates, float[] matrix) {
            LayoutCoordinates.super.mo6798transformFromEL8BTi8(sourceCoordinates, matrix);
        }

        @Deprecated
        /* JADX INFO: renamed from: transformToScreen-58bKbWc, reason: not valid java name */
        public static void m6806transformToScreen58bKbWc(LayoutCoordinates $this, float[] matrix) {
            LayoutCoordinates.super.mo6799transformToScreen58bKbWc(matrix);
        }
    }
    ...
    /* JADX INFO: renamed from: screenToLocal-MK-Hz9U, reason: not valid java name */
    default long mo6797screenToLocalMKHz9U(long relativeToScreen) {
        return Offset.INSTANCE.m5083getUnspecifiedF1C5BW0();
    }

    /* JADX INFO: renamed from: localToScreen-MK-Hz9U, reason: not valid java name */
    default long mo6795localToScreenMKHz9U(long relativeToLocal) {
        return Offset.INSTANCE.m5083getUnspecifiedF1C5BW0();
    }

    /* JADX INFO: renamed from: localPositionOf-S_NoaFU$default, reason: not valid java name */
    static /* synthetic */ long m6790localPositionOfS_NoaFU$default(LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2, long j, boolean z, int i, Object obj) {
        if (obj != null) {
        ...
        return layoutCoordinates.mo6793localPositionOfS_NoaFU(layoutCoordinates2, j, z);
    }

    /* JADX INFO: renamed from: localPositionOf-S_NoaFU, reason: not valid java name */
    default long mo6793localPositionOfS_NoaFU(LayoutCoordinates sourceCoordinates, long relativeToSource, boolean includeMotionFrameOfReference) {
    ...
    /* JADX INFO: renamed from: transformFrom-EL8BTi8, reason: not valid java name */
    default void mo6798transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        InlineClassHelperKt.throwUnsupportedOperationException("transformFrom is not implemented on this LayoutCoordinates");
    }

    /* JADX INFO: renamed from: transformToScreen-58bKbWc, reason: not valid java name */
    default void mo6799transformToScreen58bKbWc(float[] matrix) {
