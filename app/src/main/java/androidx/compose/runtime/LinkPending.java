...
final class LinkPending {
    ...
    public LinkPending(List<KeyInfo> list, int startIndex) {
        this.keyInfos = list;
        ...
        LinkPending $this$groupInfos_u24lambda_u240 = this;
        ...
        for (int index = 0; index < size; index++) {
            ...
            mutableIntObjectMap.set(GroupHandleKt.getGroup(keyInfo.getHandle()), new GroupInfo(index, runningNodeIndex, keyInfo.getNodes()));
            runningNodeIndex += keyInfo.getNodes();
        }
        this.groupInfos = mutableIntObjectMap;
        this.keyMap = LazyKt.lazy(new Function0<MultiValueMap<Object, KeyInfo>>() { // from class: androidx.compose.runtime.LinkPending$keyMap$2
            @Override // kotlin.jvm.functions.Function0
            public /* bridge */ /* synthetic */ MultiValueMap<Object, KeyInfo> invoke() {
                return MultiValueMap.m4447boximpl(m4405invokefVlnmYg());
            }

            /* JADX INFO: renamed from: invoke-fVlnmYg, reason: not valid java name */
            public final MutableScatterMap<Object, Object> m4405invokefVlnmYg() {
                MutableScatterMap<Object, Object> mutableScatterMapMultiMap = LinkComposerKt.multiMap(this.this$0.getKeyInfos().size());
                LinkPending linkPending = this.this$0;
                int size2 = linkPending.getKeyInfos().size();
                for (int index2 = 0; index2 < size2; index2++) {
                    KeyInfo keyInfo2 = linkPending.getKeyInfos().get(index2);
                    MultiValueMap.m4446addimpl(mutableScatterMapMultiMap, keyInfo2.getJoinedKey(), keyInfo2);
                }
    ...
    public final MutableScatterMap<Object, Object> m4404getKeyMapfVlnmYg() {
    ...
    public final KeyInfo getNext(int key, Object dataKey) {
        ...
        return (KeyInfo) MultiValueMap.m4460removeFirstimpl(m4404getKeyMapfVlnmYg(), joinedKey);
    }
    ...
    public final void markGroupLocationReconciled(int index) {
        this.placedGroups.set(index, true);
    }
    ...
    */
    public final void registerMoveNode(int r32, int r33, int r34) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.LinkPending.registerMoveNode(int, int, int):void");
    }

    public final void registerInsert(KeyInfo keyInfo, int insertIndex) {
        this.groupInfos.set(GroupHandleKt.getGroup(keyInfo.getHandle()), new GroupInfo(-1, insertIndex, 0));
    }
