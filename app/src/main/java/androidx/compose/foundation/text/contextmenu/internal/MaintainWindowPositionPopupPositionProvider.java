...
final class MaintainWindowPositionPopupPositionProvider implements PopupPositionProvider {
    ...
    public final void m1699setPreviousWindowSizefhxjrPA(IntSize intSize) {
    ...
    public final void m1697setPreviousPopupContentSizefhxjrPA(IntSize intSize) {
    ...
    public final void m1698setPreviousPositionfg0MpWk(IntOffset intOffset) {
    ...
    public long mo399calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        if (position == null) {
            ...
            boolean zM8319equalsimpl0 = false;
            if (!(intSize == null ? false : IntSize.m8319equalsimpl0(intSize.m8325unboximpl(), windowSize)) || this.previousLayoutDirection != layoutDirection) {
                j = popupContentSize;
            } else {
                ...
                if (intSize2 == null) {
                    ...
                    j = popupContentSize;
                    zM8319equalsimpl0 = IntSize.m8319equalsimpl0(intSize2.m8325unboximpl(), j);
                }
                if (zM8319equalsimpl0) {
                    return position.m8287unboximpl();
                }
            }
        }
        long newPosition = this.popupPositionProvider.mo399calculatePositionllwVHH4(anchorBounds, windowSize, layoutDirection, j);
        this.previousWindowSize = IntSize.m8313boximpl(windowSize);
        this.previousLayoutDirection = layoutDirection;
        this.previousPopupContentSize = IntSize.m8313boximpl(popupContentSize);
        this.previousPosition = IntOffset.m8269boximpl(newPosition);
        return newPosition;
    }
}
