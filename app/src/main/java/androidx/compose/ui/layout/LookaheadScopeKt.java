...
public final class LookaheadScopeKt {
    ...
    public static final void LookaheadScope(final Function3<? super LookaheadScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(LookaheadScope)N(content)50@2121L33,52@2224L32,51@2159L429:LookaheadScope.kt#80mrfh");
        int i2 = i;
        if ((i & 6) == 0) {
        ...
        if (!composerStartRestartGroup.shouldExecute((i2 & 3) != 2, i2 & 1)) {
            ...
            if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                ...
                objRememberedValue = lookaheadScopeImpl;
            }
            LookaheadScopeImpl lookaheadScopeImpl2 = (LookaheadScopeImpl) objRememberedValue;
            ...
            if (objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                ...
                composerStartRestartGroup.updateRememberedValue(lookaheadScopeKt$LookaheadScope$1$1);
                objRememberedValue2 = lookaheadScopeKt$LookaheadScope$1$1;
            }
            ...
            Updater.m4438initimpl(composerM4433constructorimpl, new Function1<LayoutNode, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt$LookaheadScope$2$1
                ...
                public final void invoke2(LayoutNode $this$init) {
                    $this$init.setVirtualLookaheadRoot$ui(true);
                }
            });
            Updater.m4441setimpl(composerM4433constructorimpl, lookaheadScopeImpl2, new Function2<LayoutNode, LookaheadScopeImpl, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt$LookaheadScope$2$2
                @Override // kotlin.jvm.functions.Function2
                ...
                public final void invoke2(final LayoutNode $this$set, LookaheadScopeImpl scope) {
                    scope.setScopeCoordinates(new Function0<LayoutCoordinates>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt$LookaheadScope$2$2.1
                        ...
                        public final LayoutCoordinates invoke() {
                            LayoutNode parent$ui = $this$set.getParent$ui();
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static final LayoutCoordinates lookaheadScopeCoordinates(LookaheadScope $this$lookaheadScopeCoordinates, LayoutCoordinates layoutCoordinates) {
        ...
        return $this$lookaheadScopeCoordinates.getLookaheadScopeCoordinates(((LookaheadCapablePlaceable) layoutCoordinates).getPlacementScope());
    }

    /* JADX INFO: renamed from: localLookaheadPositionOf-Fgt4K4Q, reason: not valid java name */
    public static final long m6814localLookaheadPositionOfFgt4K4Q(LookaheadScope $this$localLookaheadPositionOf_u2dFgt4K4Q, LayoutCoordinates coordinates, LayoutCoordinates sourceCoordinates, long relativeToSource, boolean includeMotionFrameOfReference) {
        ...
        if (lookaheadCoords instanceof LookaheadLayoutCoordinates) {
            return ((LookaheadLayoutCoordinates) lookaheadCoords).mo6793localPositionOfS_NoaFU(source, relativeToSource, includeMotionFrameOfReference);
        }
        if (source instanceof LookaheadLayoutCoordinates) {
            long arg0$iv = ((LookaheadLayoutCoordinates) source).mo6793localPositionOfS_NoaFU(lookaheadCoords, relativeToSource, includeMotionFrameOfReference);
            return Offset.m5060constructorimpl((-9223372034707292160L) ^ arg0$iv);
        }
        return lookaheadCoords.mo6793localPositionOfS_NoaFU(lookaheadCoords, relativeToSource, includeMotionFrameOfReference);
    }
}
