...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    private static class ArrayEncoder extends CodedOutputStream {
        ...
        public final void writeUInt32NoTag(int value) throws IOException {
            ...
            this.position = i6 + 1;
            UnsafeUtil.putByte(bArr2, i6, (byte) (value | 128));
            int value2 = value >>> 7;
            int i7 = value2 & (-128);
            ...
            if (i7 == 0) {
                ...
                this.position = i8 + 1;
                UnsafeUtil.putByte(bArr3, i8, (byte) value2);
                return;
            }
            int i9 = this.position;
            this.position = i9 + 1;
            UnsafeUtil.putByte(bArr3, i9, (byte) (value2 | 128));
            int value3 = value2 >>> 7;
            int i10 = value3 & (-128);
            ...
            if (i10 == 0) {
                ...
                this.position = i11 + 1;
                UnsafeUtil.putByte(bArr4, i11, (byte) value3);
                return;
            }
            int i12 = this.position;
            this.position = i12 + 1;
            UnsafeUtil.putByte(bArr4, i12, (byte) (value3 | 128));
            int value4 = value3 >>> 7;
            int i13 = value4 & (-128);
            ...
            if (i13 == 0) {
                ...
                this.position = i14 + 1;
                UnsafeUtil.putByte(bArr5, i14, (byte) value4);
                return;
            }
            int i15 = this.position;
            this.position = i15 + 1;
            UnsafeUtil.putByte(bArr5, i15, (byte) (value4 | 128));
            byte[] bArr6 = this.buffer;
            int i16 = this.position;
            this.position = i16 + 1;
            UnsafeUtil.putByte(bArr6, i16, (byte) (value4 >>> 7));
        }
        ...
        public final void writeUInt64NoTag(long value) throws IOException {
            ...
            while (true) {
                ...
                if (j2 == 0) {
                    int i3 = this.position;
                    this.position = i3 + 1;
                    UnsafeUtil.putByte(bArr2, i3, (byte) value);
                    return;
                } else {
                    int i4 = this.position;
                    this.position = i4 + 1;
                    UnsafeUtil.putByte(bArr2, i4, (byte) ((((int) value) & WorkQueueKt.MASK) | 128));
                    value >>>= 7;
                }
            }
        }
    ...
    private static final class SafeDirectNioEncoder extends CodedOutputStream {
        ...
        public void writeUInt32NoTag(int value) throws IOException {
            while (true) {
                ...
                try {
                    byteBuffer.put((byte) ((value & WorkQueueKt.MASK) | 128));
                    value >>>= 7;
                } catch (BufferOverflowException e) {
                    throw new OutOfSpaceException(e);
                }
        ...
        public void writeUInt64NoTag(long value) throws IOException {
            while (true) {
                ...
                try {
                    byteBuffer.put((byte) ((((int) value) & WorkQueueKt.MASK) | 128));
                    value >>>= 7;
                } catch (BufferOverflowException e) {
                    throw new OutOfSpaceException(e);
                }
    ...
    private static final class UnsafeDirectNioEncoder extends CodedOutputStream {
        ...
        public void writeUInt64NoTag(long value) throws IOException {
            ...
            while (true) {
                ...
                if (j3 == 0) {
                    this.position = 1 + j4;
                    UnsafeUtil.putByte(j4, (byte) value);
                    return;
                } else {
                    this.position = j4 + 1;
        ...
        final void bufferUInt32NoTag(int value) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while (true) {
                    ...
                    int i3 = this.position;
                    this.position = i3 + 1;
                    UnsafeUtil.putByte(bArr, i3, (byte) ((value & WorkQueueKt.MASK) | 128));
                    value >>>= 7;
                }
            } else {
                while (true) {
                    ...
                    int i6 = this.position;
                    this.position = i6 + 1;
                    bArr2[i6] = (byte) ((value & WorkQueueKt.MASK) | 128);
                    this.totalBytesWritten++;
                    value >>>= 7;
                }
            }
            ...
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while (true) {
                    ...
                    if (j == 0) {
                        int i = this.position;
                        this.position = i + 1;
                        UnsafeUtil.putByte(bArr, i, (byte) value);
                        int delta = (int) (((long) this.position) - originalPos);
                        this.totalBytesWritten += delta;
                        return;
                    }
                    int i2 = this.position;
                    this.position = i2 + 1;
                    UnsafeUtil.putByte(bArr, i2, (byte) ((((int) value) & WorkQueueKt.MASK) | 128));
                    value >>>= 7;
                }
            } else {
                while (true) {
                    long originalPos2 = value & (-128);
                    byte[] bArr2 = this.buffer;
                    if (originalPos2 == 0) {
                        int i3 = this.position;
                        this.position = i3 + 1;
                    ...
                    int i4 = this.position;
                    this.position = i4 + 1;
                    bArr2[i4] = (byte) ((((int) value) & WorkQueueKt.MASK) | 128);
                    this.totalBytesWritten++;
                    value >>>= 7;
                }
            }
