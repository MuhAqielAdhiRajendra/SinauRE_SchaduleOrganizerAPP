...
public final class PinInvokeKt {
    ...
    public static final ImageVector getPinInvoke(Icons.Sharp $this$PinInvoke) {
        if (_pinInvoke != null) {
        ...
        ImageVector.Builder $this$_get_PinInvoke__u24lambda_u241 = new ImageVector.Builder("Sharp.PinInvoke", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
