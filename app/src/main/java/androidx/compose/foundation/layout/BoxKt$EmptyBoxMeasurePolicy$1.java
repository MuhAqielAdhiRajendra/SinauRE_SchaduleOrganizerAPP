...
final class BoxKt$EmptyBoxMeasurePolicy$1 implements MeasurePolicy {
    ...
    public final MeasureResult mo39measure3p2s80s(MeasureScope $this$MeasurePolicy, List<? extends Measurable> list, long constraints) {
        return MeasureScope.layout$default($this$MeasurePolicy, Constraints.m8105getMinWidthimpl(constraints), Constraints.m8104getMinHeightimpl(constraints), null, new Function1() { // from class: androidx.compose.foundation.layout.BoxKt$EmptyBoxMeasurePolicy$1$$ExternalSyntheticLambda0
