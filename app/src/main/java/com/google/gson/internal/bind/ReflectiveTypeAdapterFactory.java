...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
        ...
        ObjectConstructor<T> constructor = this.constructorConstructor.get(type, true);
    ...
    private BoundField createBoundField(Gson context, Field field, final Method accessor, String serializedName, TypeToken<?> fieldType, boolean serialize, final boolean blockInaccessible) {
        ...
        final TypeAdapter<?> typeAdapter2 = mapped;
        if (serialize) {
        ...
        final boolean isStaticFinalField2 = isStaticFinalField;
        return new BoundField(serializedName, field) { // from class: com.google.gson.internal.bind.ReflectiveTypeAdapterFactory.2
            ...
            void readIntoArray(JsonReader reader, int index, Object[] target) throws JsonParseException, IOException {
                Object fieldValue = typeAdapter2.read(reader);
        ...
        while (raw2 != Object.class) {
            ...
            while (i3 < length) {
                ...
                if (!serialize && !deserialize2) {
                    ...
                    Type fieldType = GsonTypes.resolve(type3.getType(), raw2, field.getGenericType());
                    List<String> fieldNames = reflectiveTypeAdapterFactory.getFieldNames(field);
                    type2 = type3;
                    String serializedName = fieldNames.get(0);
                    i = i4;
                    i2 = length;
                    BoundField boundField = reflectiveTypeAdapterFactory.createBoundField(context, field, accessor, serializedName, TypeToken.get(fieldType), serialize, blockInaccessible2);
                    if (deserialize) {
            ...
            type3 = TypeToken.get(GsonTypes.resolve(type3.getType(), raw2, raw2.getGenericSuperclass()));
    ...
    private static final class RecordAdapter<T> extends Adapter<T, Object[]> {
        ...
        RecordAdapter(Class<T> raw, FieldsData fieldsData, boolean blockInaccessible) {
            ...
            if (blockInaccessible) {
                ReflectiveTypeAdapterFactory.checkAccessible(null, constructor);
            } else {
