...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    protected static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        private boolean ignoreUpdateVisibility(View dependency, FloatingActionButton child) {
            ...
            return (this.autoHideEnabled && lp.getAnchorId() == dependency.getId() && child.getUserSetVisibility() == 0) ? false : true;
        }
        ...
        private boolean updateFabVisibilityForAppBarLayout(CoordinatorLayout parent, AppBarLayout appBarLayout, FloatingActionButton child) {
            ...
            if (i <= minimumHeightForVisibleOverlappingContent) {
                child.hide(onVisibilityChangedListener, false);
                return true;
            }
            child.show(onVisibilityChangedListener, false);
            return true;
        }
        ...
        private boolean updateFabVisibilityForBottomSheet(View bottomSheet, FloatingActionButton child) {
            ...
            int height = (child.getHeight() / 2) + lp.topMargin;
            OnVisibilityChangedListener onVisibilityChangedListener = this.internalAutoHideListener;
            if (top < height) {
                child.hide(onVisibilityChangedListener, false);
                return true;
