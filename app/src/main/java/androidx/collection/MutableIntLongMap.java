...
public final class MutableIntLongMap extends IntLongMap {
    ...
    public final void removeIf(Function2<? super Integer, ? super Long, Boolean> predicate) {
        ...
        int $i$f$removeIf3 = 0;
        MutableIntLongMap this_$iv = this;
            ...
            if ($this$maskEmptyOrDeleted$iv$iv == -9187201950435737472L) {
                ...
                while (j$iv < bitCount$iv) {
                    ...
                    if (!(value$iv$iv < 128)) {
                        ...
                        i = i2;
                        $i$f$removeIf2 = $i$f$removeIf3;
                        if (predicate.invoke(Integer.valueOf(this.keys[index$iv]), Long.valueOf(this.values[index$iv])).booleanValue()) {
    ...
    */
    ...
    public final void dropDeletes$collection() {
        ...
        long[] metadata = mutableIntLongMap.metadata;
        int capacity = mutableIntLongMap._capacity;
        int[] keys = mutableIntLongMap.keys;
        long[] values = mutableIntLongMap.values;
        ...
        while (index != capacity) {
            ...
            if (m == 128) {
                ...
                int $i$f$h1 = k$iv >>> 7;
                int i = hash1;
                int targetIndex = mutableIntLongMap.findFirstAvailableSlot($i$f$h1);
    ...
    public final void resizeStorage$collection(int newCapacity) {
        ...
        long[] newMetadata = mutableIntLongMap.metadata;
        ...
        while (i < previousCapacity) {
            if (!(((previousMetadata2[i >> 3] >> ((i & 7) << 3)) & 255) < 128)) {
                ...
                int index = mutableIntLongMap.findFirstAvailableSlot($i$f$h1);
