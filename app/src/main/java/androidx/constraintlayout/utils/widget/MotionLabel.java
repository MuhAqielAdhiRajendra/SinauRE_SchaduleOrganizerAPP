...
public class MotionLabel extends View implements FloatLayout {
    ...
    private float getHorizontalOffset() {
        ...
        float textWidth = this.mPaint.measureText(this.mText, 0, this.mText.length()) * scale;
    ...
    public void layout(int l, int t, int r, int b) {
        ...
        if (this.mAutoSize) {
            ...
            if (normalScale) {
                ...
                TextPaint textPaint = this.mPaint;
                if (f > f2) {
                    textPaint.setTextSize((this.mPaintTextSize * vw) / tw);
                } else {
                    textPaint.setTextSize((this.mPaintTextSize * vh) / th);
                }
            } else {
    ...
    public void layout(float l, float t, float r, float b) {
        ...
        if (getMeasuredHeight() == h && getMeasuredWidth() == w) {
            ...
            int widthMeasureSpec = View.MeasureSpec.makeMeasureSpec(w, 1073741824);
            int heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(h, 1073741824);
    ...
    public void setRoundPercent(float round) {
        ...
        if (this.mRoundPercent != 0.0f) {
            ...
            if (this.mViewOutlineProvider == null) {
                this.mViewOutlineProvider = new ViewOutlineProvider() { // from class: androidx.constraintlayout.utils.widget.MotionLabel.1
    ...
    public void setRound(float round) {
        ...
        if (this.mRound != 0.0f) {
            ...
            if (this.mViewOutlineProvider == null) {
                this.mViewOutlineProvider = new ViewOutlineProvider() { // from class: androidx.constraintlayout.utils.widget.MotionLabel.2
                    @Override // android.view.ViewOutlineProvider
                    public void getOutline(View view, Outline outline) {
                        int w = MotionLabel.this.getWidth();
                        int h = MotionLabel.this.getHeight();
    ...
    private void updateShaderMatrix() {
        ...
        float panX2 = sh / 2.0f;
        this.mTextShaderMatrix.postRotate(rota, sw / 2.0f, panX2);
