...
final class DerivedWidthModifierNode extends InsetsConsumingModifierNode implements LayoutModifierNode {
    ...
    public DerivedWidthModifierNode(WindowInsets insets, WindowInsetsWidthCalculator widthCalc) {
        this.insets = insets;
    ...
    public MeasureResult mo67measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        int width = this.widthCalc.calculate(this.widthInsets, $this$measure_u2d3p2s80s.getLayoutDirection(), $this$measure_u2d3p2s80s);
        if (width != 0) {
            long childConstraints = Constraints.m8092copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m8105getMinWidthimpl(constraints) : width, (11 & 2) != 0 ? Constraints.m8103getMaxWidthimpl(constraints) : width, (11 & 4) != 0 ? Constraints.m8104getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m8102getMaxHeightimpl(constraints) : 0);
            final Placeable placeable = measurable.mo6783measureBRTryo0(childConstraints);
            return MeasureScope.layout$default($this$measure_u2d3p2s80s, width, placeable.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.layout.DerivedWidthModifierNode$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return DerivedWidthModifierNode.measure_3p2s80s$lambda$1(placeable, (Placeable.PlacementScope) obj);
                }
            }, 4, null);
        }
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, 0, 0, null, new Function1() { // from class: androidx.compose.foundation.layout.DerivedWidthModifierNode$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
