...
public final class FormatIndentDecreaseKt {
    ...
    public static final ImageVector getFormatIndentDecrease(Icons.AutoMirrored.TwoTone $this$FormatIndentDecrease) {
        ...
        ImageVector.Builder $this$_get_FormatIndentDecrease__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.TwoTone.FormatIndentDecrease", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
