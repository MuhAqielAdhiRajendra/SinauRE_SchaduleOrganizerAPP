...
public final class AwaitFirstLayoutModifier extends ModifierNodeElement<Node> {
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        $this$inspectableProperties.setName("AwaitFirstLayoutModifier");
    }
    ...
    public final class Node extends Modifier.Node {
        ...
        static final Unit requestOnAfterLayoutCallback$lambda$0(Node this$0, AwaitFirstLayoutModifier this$1, RelativeLayoutBounds it) {
            DelegatableNode.RegistrationHandle registrationHandle = this$0.handle;
            if (registrationHandle != null) {
                registrationHandle.unregister();
            }
            this$0.handle = null;
            CompletableDeferred completableDeferred = this$1.lock;
