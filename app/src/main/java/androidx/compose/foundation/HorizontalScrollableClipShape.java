...
final class HorizontalScrollableClipShape implements Shape {
    ...
    public Outline mo342createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        float inflateSize = density.mo426roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
