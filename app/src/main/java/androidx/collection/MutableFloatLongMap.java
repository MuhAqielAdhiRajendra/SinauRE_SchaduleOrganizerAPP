...
public final class MutableFloatLongMap extends FloatLongMap {
    ...
    */
    ...
    public final void dropDeletes$collection() {
        ...
        long[] metadata = mutableFloatLongMap.metadata;
        int capacity = mutableFloatLongMap._capacity;
        float[] keys = mutableFloatLongMap.keys;
        long[] values = mutableFloatLongMap.values;
        ...
        while (index != capacity) {
            ...
            if (m == 128) {
                ...
                int $i$f$h1 = hash >>> 7;
                int i = hash1;
                int targetIndex = mutableFloatLongMap.findFirstAvailableSlot($i$f$h1);
    ...
    public final void resizeStorage$collection(int newCapacity) {
        ...
        long[] newMetadata = mutableFloatLongMap.metadata;
