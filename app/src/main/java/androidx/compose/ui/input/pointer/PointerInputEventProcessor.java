...
public final class PointerInputEventProcessor {
    ...
    public static /* synthetic */ int m6672processBIzXfog$default(PointerInputEventProcessor pointerInputEventProcessor, PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            z = true;
        }
        return pointerInputEventProcessor.m6673processBIzXfog(pointerInputEvent, positionCalculator, z);
    }

    /* JADX INFO: renamed from: process-BIzXfog, reason: not valid java name */
    public final int m6673processBIzXfog(PointerInputEvent pointerEvent, PositionCalculator positionCalculator, boolean isInBounds) {
        ...
        if (!this.isProcessing) {
            ...
            try {
                ...
                for (int i2 = 0; i2 < size2; i2++) {
                    ...
                    if (isHover || PointerEventKt.changedToDownIgnoreConsumed(pointerInputChange2)) {
                        LayoutNode.m7005hitTest6fMxITs$ui$default(this.root, pointerInputChange2.getPosition(), this.hitResult, pointerInputChange2.getType(), false, 8, null);
                        if (!this.hitResult.isEmpty()) {
                            this.hitPathTracker.m6553addHitPathQJqDSyo(pointerInputChange2.getId(), this.hitResult, PointerEventKt.changedToDownIgnoreConsumed(pointerInputChange2));
            ...
            try {
                ...
                int iProcessResult = PointerInputEventProcessorKt.ProcessResult(dispatchedToSomething, result, anyChangeConsumed);
                this.isProcessing = false;
