...
public final class WheelchairPickupKt {
    ...
    public static final ImageVector getWheelchairPickup(Icons.Rounded $this$WheelchairPickup) {
        ...
        ImageVector.Builder $this$_get_WheelchairPickup__u24lambda_u241 = new ImageVector.Builder("Rounded.WheelchairPickup", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(1.92f, 2.88f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.31f, 0.46f, 0.93f, 0.58f, 1.39f, 0.28f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.46f, -0.31f, 0.58f, -0.93f, 0.28f, -1.39f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-2.21f, -3.32f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(19.65f, 14.17f, 19.33f, 14.0f, 19.0f, 14.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
