...
public final class BathtubKt {
    ...
    public static final ImageVector getBathtub(Icons.Outlined $this$Bathtub) {
        if (_bathtub != null) {
        ...
        ImageVector.Builder $this$_get_Bathtub__u24lambda_u242 = new ImageVector.Builder("Outlined.Bathtub", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
