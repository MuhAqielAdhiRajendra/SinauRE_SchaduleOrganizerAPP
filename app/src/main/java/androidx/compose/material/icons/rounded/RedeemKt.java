...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_redeem", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Redeem", "Landroidx/compose/material/icons/Icons$Rounded;", "getRedeem", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class RedeemKt {
    private static ImageVector _redeem;

    public static final ImageVector getRedeem(Icons.Rounded $this$Redeem) {
        if (_redeem != null) {
        ...
        ImageVector.Builder $this$_get_Redeem__u24lambda_u241 = new ImageVector.Builder("Rounded.Redeem", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(4.08f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(7.6f, 10.02f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.33f, 0.45f, -0.23f, 1.08f, 0.22f, 1.4f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.44f, 0.32f, 1.07f, 0.22f, 1.39f, -0.22f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(12.0f, 7.4f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(2.79f, 3.8f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.32f, 0.44f, 0.95f, 0.54f, 1.39f, 0.22f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.45f, -0.32f, 0.55f, -0.95f, 0.22f, -1.4f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _redeem = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_Redeem__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
