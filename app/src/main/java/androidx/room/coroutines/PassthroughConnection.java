...
final class PassthroughConnection implements Transactor, RawConnectionAccessor {
    ...
    static final class C03601<R> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;
    ...
    */
    public <R> java.lang.Object usePrepared(java.lang.String r9, kotlin.jvm.functions.Function1<? super androidx.sqlite.SQLiteStatement, ? extends R> r10, kotlin.coroutines.Continuation<? super R> r11) throws java.lang.Exception {
        /*
            r8 = this;
            boolean r0 = r11 instanceof androidx.room.coroutines.PassthroughConnection.C03601
            if (r0 == 0) goto L14
            r0 = r11
            androidx.room.coroutines.PassthroughConnection$usePrepared$1 r0 = (androidx.room.coroutines.PassthroughConnection.C03601) r0
            int r1 = r0.label
    ...
    public <R> Object withTransaction(Transactor.SQLiteTransactionType type, Function2<? super TransactionScope<R>, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        if (this.transactionWrapper != null) {
            Object objInvoke = this.transactionWrapper.invoke(new C03612(type, function2, null), continuation);
    ...
    static final class C03612 extends SuspendLambda implements Function1<Continuation<? super Object>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C03612(Transactor.SQLiteTransactionType sQLiteTransactionType, Function2<? super TransactionScope<R>, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super C03612> continuation) {
            super(1, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return PassthroughConnection.this.new C03612(this.$type, this.$block, continuation);
        }
        ...
        /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
        public final Object invoke2(Continuation<Object> continuation) {
            return ((C03612) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
