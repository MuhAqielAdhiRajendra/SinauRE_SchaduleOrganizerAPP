...
public final class InternalPointerEvent {
    ...
    public final boolean m6555activeHoverEvent0FcD4WY(long pointerId) {
        Object it$iv;
        ...
        while (true) {
            if (index$iv$iv < size) {
                Object item$iv$iv = pointers.get(index$iv$iv);
                it$iv = item$iv$iv;
                PointerInputEventData it = (PointerInputEventData) it$iv;
                if (PointerId.m6629equalsimpl0(it.m6665getIdJ3iCeTQ(), pointerId)) {
                    break;
                }
                index$iv$iv++;
            } else {
