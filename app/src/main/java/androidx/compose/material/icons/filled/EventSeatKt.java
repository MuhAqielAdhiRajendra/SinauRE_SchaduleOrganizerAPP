...
public final class EventSeatKt {
    ...
    public static final ImageVector getEventSeat(Icons.Filled $this$EventSeat) {
        if (_eventSeat != null) {
        ...
        ImageVector.Builder $this$_get_EventSeat__u24lambda_u241 = new ImageVector.Builder("Filled.EventSeat", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
