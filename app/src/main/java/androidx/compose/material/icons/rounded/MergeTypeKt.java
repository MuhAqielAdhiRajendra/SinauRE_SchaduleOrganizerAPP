...
public final class MergeTypeKt {
    ...
    public static final ImageVector getMergeType(Icons.Rounded $this$MergeType) {
        if (_mergeType != null) {
        ...
        ImageVector.Builder $this$_get_MergeType__u24lambda_u241 = new ImageVector.Builder("Rounded.MergeType", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
