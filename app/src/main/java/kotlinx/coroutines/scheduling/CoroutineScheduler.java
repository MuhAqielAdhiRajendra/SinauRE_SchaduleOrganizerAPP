...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    public final void parkedWorkersStackTopUpdate(Worker worker, int oldIndex, int newIndex) {
        ...
        while (true) {
            ...
            if (updIndex >= 0 && parkedWorkersStack$volatile$FU.compareAndSet(this, top, ((long) updIndex) | updVersion)) {
                return;
            }
        }
    }
    ...
    */
    ...
    private final int createNewWorker() {
        ...
        synchronized (lock$iv) {
            ...
            int newIndex = ((int) (getControlState$volatile$FU().get(this) & 2097151)) + 1;
    ...
    public final class Worker extends Thread {
        ...
        private final boolean tryAcquireCpuPermit() {
            ...
            while (true) {
                ...
                if (CoroutineScheduler.getControlState$volatile$FU().compareAndSet(this_$iv, state$iv, update$iv)) {
        ...
        private final Task pollGlobalQueues() {
            ...
            if (iNextInt == 0) {
                Task it = coroutineScheduler.globalCpuQueue.removeFirstOrNull();
                if (it != null) {
                    return it;
                }
                return CoroutineScheduler.this.globalBlockingQueue.removeFirstOrNull();
            }
            Task it2 = coroutineScheduler.globalBlockingQueue.removeFirstOrNull();
            if (it2 != null) {
                return it2;
            }
