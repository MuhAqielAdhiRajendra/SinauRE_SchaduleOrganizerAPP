...
public final class SwipeLeftKt {
    ...
    public static final ImageVector getSwipeLeft(Icons.Sharp $this$SwipeLeft) {
        if (_swipeLeft != null) {
        ...
        ImageVector.Builder $this$_get_SwipeLeft__u24lambda_u241 = new ImageVector.Builder("Sharp.SwipeLeft", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
