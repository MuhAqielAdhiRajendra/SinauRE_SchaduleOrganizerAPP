...
final class AndroidShadowContext implements PlatformShadowContext, DropShadowRendererProvider, InnerShadowRendererProvider {
    ...
    public static final /* data */ class ShadowKey {
        ...
        public static /* synthetic */ ShadowKey m6016copyeZhPAX0$default(ShadowKey shadowKey, Shape shape, long j, LayoutDirection layoutDirection, float f, Shadow shadow, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return shadowKey.m6018copyeZhPAX0(shape, j, layoutDirection2, f, shadow2);
        }
        ...
        public final ShadowKey m6018copyeZhPAX0(Shape shape, long size, LayoutDirection layoutDirection, float density, Shadow shadow) {
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(this.shape, shadowKey.shape) && Size.m5133equalsimpl0(this.size, shadowKey.size) && this.layoutDirection == shadowKey.layoutDirection && Float.compare(this.density, shadowKey.density) == 0 && Intrinsics.areEqual(this.shadow, shadowKey.shadow);
        }

        public int hashCode() {
            return (((((((this.shape.hashCode() * 31) + Size.m5138hashCodeimpl(this.size)) * 31) + this.layoutDirection.hashCode()) * 31) + Float.hashCode(this.density)) * 31) + (this.shadow == null ? 0 : this.shadow.hashCode());
        }

        public String toString() {
            return "ShadowKey(shape=" + this.shape + ", size=" + ((Object) Size.m5141toStringimpl(this.size)) + ", layoutDirection=" + this.layoutDirection + ", density=" + this.density + ", shadow=" + this.shadow + ')';
        }

        private ShadowKey(Shape shape, long size, LayoutDirection layoutDirection, float density, Shadow shadow) {
            this.shape = shape;
            this.size = size;
        ...
        public /* synthetic */ ShadowKey(Shape shape, long j, LayoutDirection layoutDirection, float f, Shadow shadow, int i, DefaultConstructorMarker defaultConstructorMarker) {
            this((i & 1) != 0 ? RectangleShapeKt.getRectangleShape() : shape, (i & 2) != 0 ? Size.INSTANCE.m5146getZeroNHjbRc() : j, (i & 4) != 0 ? LayoutDirection.Ltr : layoutDirection, (i & 8) != 0 ? 1.0f : f, (i & 16) != 0 ? null : shadow, null);
        }
        ...
        public final long m6019getSizeNHjbRc() {
            return this.size;
        }

        /* JADX INFO: renamed from: setSize-uvyYCjk, reason: not valid java name */
        public final void m6020setSizeuvyYCjk(long j) {
            this.size = j;
        }
    ...
    public DropShadowRenderer mo6014obtainDropShadowRenderereZhPAX0(Shape shape, long size, LayoutDirection layoutDirection, Density density, Shadow shadow) throws Throwable {
        ShadowKey $this$obtainDropShadowRenderer_eZhPAX0_u24lambda_u240_u240;
        synchronized (this) {
            try {
                $this$obtainDropShadowRenderer_eZhPAX0_u24lambda_u240_u240 = obtainShadowKey();
            } catch (Throwable th) {
                th = th;
            }
            try {
                $this$obtainDropShadowRenderer_eZhPAX0_u24lambda_u240_u240.setShape(shape);
            } catch (Throwable th2) {
                th = th2;
                throw th;
            }
            try {
                $this$obtainDropShadowRenderer_eZhPAX0_u24lambda_u240_u240.m6020setSizeuvyYCjk(size);
                try {
                    $this$obtainDropShadowRenderer_eZhPAX0_u24lambda_u240_u240.setLayoutDirection(layoutDirection);
                    $this$obtainDropShadowRenderer_eZhPAX0_u24lambda_u240_u240.setDensity(density.getDensity());
                    $this$obtainDropShadowRenderer_eZhPAX0_u24lambda_u240_u240.setShadow(shadow.copyWithoutOffset$ui_graphics());
                    DropShadowRenderer renderer = obtainDropShadowCache().get($this$obtainDropShadowRenderer_eZhPAX0_u24lambda_u240_u240);
                    if (renderer == null) {
                        Outline outline = shape.mo342createOutlinePq9zytI(size, layoutDirection, density);
                        try {
                            renderer = new DropShadowRenderer(shadow, outline);
                            obtainDropShadowCache().set(ShadowKey.m6016copyeZhPAX0$default($this$obtainDropShadowRenderer_eZhPAX0_u24lambda_u240_u240, null, 0L, null, 0.0f, null, 31, null), renderer);
                        } catch (Throwable th3) {
                            th = th3;
                            throw th;
                        }
    ...
    public InnerShadowRenderer mo6015obtainInnerShadowRenderereZhPAX0(Shape shape, long size, LayoutDirection layoutDirection, Density density, Shadow shadow) throws Throwable {
        ShadowKey $this$obtainInnerShadowRenderer_eZhPAX0_u24lambda_u240_u240;
        synchronized (this) {
            try {
                $this$obtainInnerShadowRenderer_eZhPAX0_u24lambda_u240_u240 = obtainShadowKey();
            } catch (Throwable th) {
                th = th;
            }
            try {
                $this$obtainInnerShadowRenderer_eZhPAX0_u24lambda_u240_u240.setShape(shape);
            } catch (Throwable th2) {
                th = th2;
                throw th;
            }
            try {
                $this$obtainInnerShadowRenderer_eZhPAX0_u24lambda_u240_u240.m6020setSizeuvyYCjk(size);
            } catch (Throwable th3) {
                th = th3;
                throw th;
            }
            try {
                $this$obtainInnerShadowRenderer_eZhPAX0_u24lambda_u240_u240.setLayoutDirection(layoutDirection);
                $this$obtainInnerShadowRenderer_eZhPAX0_u24lambda_u240_u240.setDensity(density.getDensity());
                $this$obtainInnerShadowRenderer_eZhPAX0_u24lambda_u240_u240.setShadow(shadow);
                InnerShadowRenderer renderer = obtainInnerShadowCache().get($this$obtainInnerShadowRenderer_eZhPAX0_u24lambda_u240_u240);
                if (renderer == null) {
                    Outline outline = shape.mo342createOutlinePq9zytI(size, layoutDirection, density);
                    renderer = new InnerShadowRenderer(shadow, outline);
                    obtainInnerShadowCache().set(ShadowKey.m6016copyeZhPAX0$default($this$obtainInnerShadowRenderer_eZhPAX0_u24lambda_u240_u240, null, 0L, null, 0.0f, null, 31, null), renderer);
                }
                return renderer;
            } catch (Throwable th4) {
                th = th4;
