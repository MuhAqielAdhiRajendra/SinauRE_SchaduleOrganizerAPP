...
public final class BlindsKt {
    ...
    public static final ImageVector getBlinds(Icons.Outlined $this$Blinds) {
        if (_blinds != null) {
        ...
        ImageVector.Builder $this$_get_Blinds__u24lambda_u241 = new ImageVector.Builder("Outlined.Blinds", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
