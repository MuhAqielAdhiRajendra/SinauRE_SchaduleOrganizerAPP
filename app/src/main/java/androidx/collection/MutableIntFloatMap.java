...
public final class MutableIntFloatMap extends IntFloatMap {
    ...
    */
    ...
    public final void dropDeletes$collection() {
        ...
        long[] metadata = mutableIntFloatMap.metadata;
        int capacity = mutableIntFloatMap._capacity;
        int[] keys = mutableIntFloatMap.keys;
        float[] values = mutableIntFloatMap.values;
        ...
        while (index != capacity) {
            ...
            if (m == 128) {
                ...
                int $i$f$h1 = k$iv >>> 7;
                int i = hash1;
                int targetIndex = mutableIntFloatMap.findFirstAvailableSlot($i$f$h1);
