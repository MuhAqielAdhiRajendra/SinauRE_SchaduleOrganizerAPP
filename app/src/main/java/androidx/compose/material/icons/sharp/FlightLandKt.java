...
public final class FlightLandKt {
    ...
    public static final ImageVector getFlightLand(Icons.Sharp $this$FlightLand) {
        if (_flightLand != null) {
        ...
        ImageVector.Builder $this$_get_FlightLand__u24lambda_u241 = new ImageVector.Builder("Sharp.FlightLand", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
