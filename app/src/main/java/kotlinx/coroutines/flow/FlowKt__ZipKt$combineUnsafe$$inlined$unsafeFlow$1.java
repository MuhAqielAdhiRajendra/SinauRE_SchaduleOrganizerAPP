...
public final class FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1<R> implements Flow<R> {
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation $completion) {
        ...
        Function0 function0NullArrayFactory$FlowKt__ZipKt = FlowKt__ZipKt.nullArrayFactory$FlowKt__ZipKt();
        Intrinsics.needClassReification();
        CombineKt.combineInternal(collector, flowArr, function0NullArrayFactory$FlowKt__ZipKt, new FlowKt__ZipKt$combineUnsafe$1$1(this.$transform$inlined, null), $completion);
