...
public final class ScrollState implements ScrollableState {
    ...
    /* JADX WARN: Type inference failed for: r0v8, types: [androidx.compose.foundation.ScrollState$_scrollIndicatorState$1] */
    ...
    public final void setMaxValue$foundation(int newMax) {
    ...
    public final int getContentSize$foundation() {
        IntState $this$getValue$iv = this.contentSize;
        return $this$getValue$iv.getIntValue();
    }

    public final void setContentSize$foundation(int i) {
        MutableIntState $this$setValue$iv = this.contentSize;
        $this$setValue$iv.setIntValue(i);
    }
    ...
    static final float scrollableState$lambda$0(ScrollState this$0, float it) {
    ...
    public Object scroll(MutatePriority scrollPriority, Function2<? super ScrollScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        Object objScroll = this.scrollableState.scroll(scrollPriority, function2, continuation);
    ...
    static final boolean canScrollForward_delegate$lambda$0(ScrollState this$0) {
    ...
    static final boolean canScrollBackward_delegate$lambda$0(ScrollState this$0) {
    ...
    public final Object animateScrollTo(int value, AnimationSpec<Float> animationSpec, Continuation<? super Unit> continuation) {
        Object objAnimateScrollBy = ScrollExtensionsKt.animateScrollBy(this, value - getValue(), animationSpec, continuation);
    ...
    /* JADX INFO: compiled from: Scroll.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u001b\u0010\u0004\u001a\f\u0012\u0004\u0012\u00020\u0006\u0012\u0002\b\u00030\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\b¨\u0006\t"}, d2 = {"Landroidx/compose/foundation/ScrollState$Companion;", "", "<init>", "()V", "Saver", "Landroidx/compose/runtime/saveable/Saver;", "Landroidx/compose/foundation/ScrollState;", "getSaver", "()Landroidx/compose/runtime/saveable/Saver;", "foundation"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    static final ScrollState Saver$lambda$1(int it) {
