...
public final class HandlerContext extends HandlerDispatcher implements Delay {
    ...
    public void mo10499scheduleResumeAfterDelay(long timeMillis, final CancellableContinuation<? super Unit> continuation) {
        ...
        if (this.handler.postDelayed(block, RangesKt.coerceAtMost(timeMillis, 4611686018427387903L))) {
            continuation.invokeOnCancellation(new Function1() { // from class: kotlinx.coroutines.android.HandlerContext$$ExternalSyntheticLambda1
                ...
                public final Object invoke(Object obj) {
                    return HandlerContext.scheduleResumeAfterDelay$lambda$2(this.f$0, block, (Throwable) obj);
                }
            });
        } else {
    ...
    static final Unit scheduleResumeAfterDelay$lambda$2(HandlerContext this$0, Runnable $block, Throwable it) {
