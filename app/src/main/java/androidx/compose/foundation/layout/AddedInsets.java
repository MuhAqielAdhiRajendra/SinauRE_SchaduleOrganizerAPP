...
final class AddedInsets implements WindowInsets {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof AddedInsets) {
            return Intrinsics.areEqual(((AddedInsets) other).first, this.first) && Intrinsics.areEqual(((AddedInsets) other).second, this.second);
        }
        return false;
    }
