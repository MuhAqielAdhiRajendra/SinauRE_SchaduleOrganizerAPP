...
class EndCompoundLayout extends LinearLayout {
    ...
    EndCompoundLayout(TextInputLayout textInputLayout, TintTypedArray a) {
        ...
        this.errorIconView.setOnFocusableChangedListener(new CheckableImageButton.OnFocusableChangedListener() { // from class: com.google.android.material.textfield.EndCompoundLayout$$ExternalSyntheticLambda0
            ...
            public final void onFocusableChanged(View view, boolean z) {
                this.f$0.m8896x75feeb9b(view, z);
            }
        });
        this.endIconView.setOnFocusableChangedListener(new CheckableImageButton.OnFocusableChangedListener() { // from class: com.google.android.material.textfield.EndCompoundLayout$$ExternalSyntheticLambda1
            @Override // com.google.android.material.internal.CheckableImageButton.OnFocusableChangedListener
            public final void onFocusableChanged(View view, boolean z) {
                this.f$0.m8897x9b92f49c(view, z);
            }
        });
    ...
    /* JADX INFO: renamed from: lambda$new$0$com-google-android-material-textfield-EndCompoundLayout, reason: not valid java name */
    /* synthetic */ void m8896x75feeb9b(View v, boolean focusable) {
        IconHelper.updateIconTooltip(this.errorIconView, this.errorIconOnLongClickListener, this.errorIconView.getContentDescription());
    }

    /* JADX INFO: renamed from: lambda$new$1$com-google-android-material-textfield-EndCompoundLayout, reason: not valid java name */
    /* synthetic */ void m8897x9b92f49c(View v, boolean focusable) {
    ...
    void setEndIconVisible(boolean visible) {
        if (isEndIconVisible() != visible) {
            if (!visible && this.endIconView.hasFocus() && this.editText != null) {
    ...
    void setEndIconContentDescription(CharSequence endIconContentDescription) {
        if (getEndIconContentDescription() != endIconContentDescription) {
            ...
            IconHelper.updateIconTooltip(this.endIconView, this.endIconOnLongClickListener, endIconContentDescription);
        }
    }
    ...
    void updateSuffixTextViewPadding() {
        ...
        int endPadding = (isEndIconVisible() || isErrorIconVisible()) ? 0 : this.textInputLayout.editText.getPaddingEnd();
        this.suffixTextView.setPaddingRelative(getContext().getResources().getDimensionPixelSize(R.dimen.material_input_text_to_prefix_suffix_padding), this.textInputLayout.editText.getPaddingTop(), endPadding, this.textInputLayout.editText.getPaddingBottom());
    }
