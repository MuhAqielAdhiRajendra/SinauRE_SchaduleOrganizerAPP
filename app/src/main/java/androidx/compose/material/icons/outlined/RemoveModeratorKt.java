...
public final class RemoveModeratorKt {
    ...
    public static final ImageVector getRemoveModerator(Icons.Outlined $this$RemoveModerator) {
        ...
        ImageVector.Builder $this$_get_RemoveModerator__u24lambda_u241 = new ImageVector.Builder("Outlined.RemoveModerator", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, 1.19f, -0.23f, 2.36f, -0.64f, 3.44f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(1.51f, 1.51f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.72f, -1.53f, 1.13f, -3.22f, 1.13f, -4.95f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(12.0f, 19.92f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(9.14f, 9.14f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(14.24f, 18.85f, 13.17f, 19.54f, 12.0f, 19.92f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
