...
public final class ScrollableDefaults {
    ...
    public final FlingBehavior flingBehavior(Composer $composer, int $changed) {
        ComposerKt.sourceInformationMarkerStart($composer, 1107739818, "C(flingBehavior)622@25948L38:Scrollable.kt#8bwon0");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1107739818, $changed, -1, "androidx.compose.foundation.gestures.ScrollableDefaults.flingBehavior (Scrollable.kt:622)");
        }
    ...
    public final OverscrollEffect overscrollEffect(Composer $composer, int $changed) {
        ComposerKt.sourceInformationMarkerStart($composer, 1809802212, "C(overscrollEffect)640@26668L34:Scrollable.kt#8bwon0");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1809802212, $changed, -1, "androidx.compose.foundation.gestures.ScrollableDefaults.overscrollEffect (Scrollable.kt:639)");
        }
    ...
    private static final class NoOpOverscrollEffect implements OverscrollEffect {
        ...
        public long mo264applyToScrollRhakbz0(long delta, int source, Function1<? super Offset, Offset> performScroll) {
            return performScroll.invoke(Offset.m5057boximpl(delta)).m5078unboximpl();
        }

        @Override // androidx.compose.foundation.OverscrollEffect
        /* JADX INFO: renamed from: applyToFling-BMRW4eQ */
        public Object mo263applyToFlingBMRW4eQ(long velocity, Function2<? super Velocity, ? super Continuation<? super Velocity>, ? extends Object> function2, Continuation<? super Unit> continuation) {
            Object objInvoke = function2.invoke(Velocity.m8379boximpl(velocity), continuation);
