...
public final class TuneKt {
    ...
    public static final ImageVector getTune(Icons.Sharp $this$Tune) {
        if (_tune != null) {
        ...
        ImageVector.Builder $this$_get_Tune__u24lambda_u241 = new ImageVector.Builder("Sharp.Tune", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
