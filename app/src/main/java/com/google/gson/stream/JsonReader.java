...
public class JsonReader implements Closeable {
    ...
    private int peekKeyword() throws IOException {
        ...
        while (true) {
            int i2 = this.pos;
            if (i < length) {
                if (i2 + i >= this.limit && !fillBuffer(i + 1)) {
                    return 0;
                }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:61:0x009f, code lost:
        ...
        if (isLiteral(r10) != false) goto L83;
     */
    ...
    */
    ...
    private String nextUnquotedValue() throws IOException {
        ...
        String result = builder == null ? new String(cArr2, this.pos, i) : builder.append(cArr2, this.pos, i).toString();
        this.pos += i;
        return result;
    }
