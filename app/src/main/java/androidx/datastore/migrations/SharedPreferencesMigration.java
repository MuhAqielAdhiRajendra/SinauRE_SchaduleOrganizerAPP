...
public final class SharedPreferencesMigration<T> implements DataMigration<T> {
    ...
    static final class C03441 extends ContinuationImpl {
        ...
        C03441(SharedPreferencesMigration<T> sharedPreferencesMigration, Continuation<? super C03441> continuation) {
            super(continuation);
    ...
    public /* synthetic */ SharedPreferencesMigration(Context context, String str, Set set, Function2 function2, Function3 function3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        if ((i & 4) == 0) {
            ...
            migrate_all_keys = SharedPreferencesMigrationKt.getMIGRATE_ALL_KEYS();
        }
        if ((i & 8) == 0) {
    ...
    */
    public java.lang.Object shouldMigrate(T r11, kotlin.coroutines.Continuation<? super java.lang.Boolean> r12) {
        /*
            r10 = this;
            boolean r0 = r12 instanceof androidx.datastore.migrations.SharedPreferencesMigration.C03441
            if (r0 == 0) goto L14
            r0 = r12
            androidx.datastore.migrations.SharedPreferencesMigration$shouldMigrate$1 r0 = (androidx.datastore.migrations.SharedPreferencesMigration.C03441) r0
            int r1 = r0.label
        ...
        L39:
            ...
            r0.L$0 = r2
            r0.label = r3
            java.lang.Object r11 = r4.invoke(r11, r0)
            if (r11 != r1) goto L4a
            return r1
        L4a:
