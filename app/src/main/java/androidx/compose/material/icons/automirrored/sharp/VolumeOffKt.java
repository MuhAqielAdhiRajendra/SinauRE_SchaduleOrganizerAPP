...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_volumeOff", "Landroidx/compose/ui/graphics/vector/ImageVector;", "VolumeOff", "Landroidx/compose/material/icons/Icons$AutoMirrored$Sharp;", "getVolumeOff", "(Landroidx/compose/material/icons/Icons$AutoMirrored$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class VolumeOffKt {
    private static ImageVector _volumeOff;

    public static final ImageVector getVolumeOff(Icons.AutoMirrored.Sharp $this$VolumeOff) {
        if (_volumeOff != null) {
        ...
        ImageVector.Builder $this$_get_VolumeOff__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Sharp.VolumeOff", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(4.34f, 2.93f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(2.93f, 4.34f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.65f, 0.49f, -1.38f, 0.88f, -2.18f, 1.11f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(2.06f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(1.34f, -0.3f, 2.57f, -0.92f, 3.61f, -1.75f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(4.34f, 2.93f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _volumeOff = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_VolumeOff__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
