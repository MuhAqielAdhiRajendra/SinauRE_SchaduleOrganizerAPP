...
public final class ExpandCircleDownKt {
    ...
    public static final ImageVector getExpandCircleDown(Icons.TwoTone $this$ExpandCircleDown) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_ExpandCircleDown__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 0.3f, null, 0.3f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
        _expandCircleDown = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_ExpandCircleDown__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv2.getNodes(), pathFillType$iv2, "", fill$iv$iv2, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv2, strokeLineJoin$iv$iv2, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
