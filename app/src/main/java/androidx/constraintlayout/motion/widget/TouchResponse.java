        ...
        switch (event.getAction()) {
            ...
            case 2:
                ...
                if (Math.abs(drag) > this.mDragThreshold || this.mDragStarted) {
                    ...
                    float movmentInDir = (this.mTouchDirectionX * this.mAnchorDpDt[c2]) + (this.mTouchDirectionY * this.mAnchorDpDt[1]);
                    if (Math.abs(movmentInDir * this.mDragScale) < 0.01d) {
                        this.mAnchorDpDt[c2] = 0.01f;
                    ...
                    if (pos4 != current) {
                        if (current == 0.0f || current == 1.0f) {
                            this.mMotionLayout.endTrigger(current == 0.0f ? 1 : c2);
                        }
                        ...
                        float velocity3 = f4 != 0.0f ? tvx3 / fArr3[c2] : tvy2 / fArr3[1];
