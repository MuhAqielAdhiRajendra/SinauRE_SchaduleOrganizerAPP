...
public class MockView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (!this.mDrawDiagonals) {
            ...
            canvas2 = canvas;
            canvas2.drawLine(0.0f, h, w, 0.0f, this.mPaintDiagonals);
            canvas2.drawLine(0.0f, 0.0f, w, 0.0f, this.mPaintDiagonals);
            canvas2.drawLine(w, 0.0f, w, h, this.mPaintDiagonals);
            canvas2.drawLine(w, h, 0.0f, h, this.mPaintDiagonals);
            canvas2.drawLine(0.0f, h, 0.0f, 0.0f, this.mPaintDiagonals);
        }
