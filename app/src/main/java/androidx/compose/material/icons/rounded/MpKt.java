...
public final class MpKt {
    ...
    public static final ImageVector getMp(Icons.Rounded $this$Mp) {
        if (_mp != null) {
        ...
        ImageVector.Builder $this$_get_Mp__u24lambda_u241 = new ImageVector.Builder("Rounded.Mp", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(6.0f, 9.45f, 6.45f, 9.0f, 7.0f, 9.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(14.25f, 15.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(14.25f, 15.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(15.0f, 14.66f, 14.66f, 15.0f, 14.25f, 15.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
