...
public final class AccessTimeFilledKt {
    ...
    public static final ImageVector getAccessTimeFilled(Icons.Rounded $this$AccessTimeFilled) {
        ...
        ImageVector.Builder $this$_get_AccessTimeFilled__u24lambda_u241 = new ImageVector.Builder("Rounded.AccessTimeFilled", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(11.11f, 12.52f, 11.0f, 12.27f, 11.0f, 12.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(16.39f, 14.98f, 16.39f, 15.61f, 16.0f, 16.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
