...
public final class WbShadeKt {
    ...
    public static final ImageVector getWbShade(Icons.Outlined $this$WbShade) {
        if (_wbShade != null) {
        ...
        ImageVector.Builder $this$_get_WbShade__u24lambda_u241 = new ImageVector.Builder("Outlined.WbShade", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
