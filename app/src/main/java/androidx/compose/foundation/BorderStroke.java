...
public final class BorderStroke {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof BorderStroke) && Dp.m8155equalsimpl0(this.width, ((BorderStroke) other).width) && Intrinsics.areEqual(this.brush, ((BorderStroke) other).brush);
    }

    public int hashCode() {
        int result = Dp.m8156hashCodeimpl(this.width);
        return (result * 31) + this.brush.hashCode();
    }

    public String toString() {
        return "BorderStroke(width=" + ((Object) Dp.m8161toStringimpl(this.width)) + ", brush=" + this.brush + ')';
    }

    /* JADX INFO: renamed from: copy-D5KLDUw$default, reason: not valid java name */
    public static /* synthetic */ BorderStroke m309copyD5KLDUw$default(BorderStroke borderStroke, float f, Brush brush, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return borderStroke.m310copyD5KLDUw(f, brush);
    }

    /* JADX INFO: renamed from: copy-D5KLDUw, reason: not valid java name */
    public final BorderStroke m310copyD5KLDUw(float width, Brush brush) {
