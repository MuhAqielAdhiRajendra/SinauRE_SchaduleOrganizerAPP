...
public final class TableInfo {
    ...
    public static final class Column {
        ...
        public static final boolean defaultValueEquals(String current, String other) {
            return INSTANCE.defaultValueEquals(current, other);
        }
