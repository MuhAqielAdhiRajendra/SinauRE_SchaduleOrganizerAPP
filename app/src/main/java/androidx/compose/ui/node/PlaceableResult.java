...
final class PlaceableResult implements OwnerScope {
    ...
    public PlaceableResult(MeasureResult result, LookaheadCapablePlaceable placeable) {
        this.result = result;
