...
final class AlignmentLineOffsetTextUnitElement extends ModifierNodeElement<AlignmentLineOffsetTextUnitNode> {
    ...
    public int hashCode() {
        ...
        return (((result * 31) + TextUnit.m8345hashCodeimpl(this.before)) * 31) + TextUnit.m8345hashCodeimpl(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, otherModifier.alignmentLine) && TextUnit.m8341equalsimpl0(this.before, otherModifier.before) && TextUnit.m8341equalsimpl0(this.after, otherModifier.after);
    }
    ...
    public void update(AlignmentLineOffsetTextUnitNode node) {
        ...
        node.m729setBeforeR2X_6o(this.before);
        node.m728setAfterR2X_6o(this.after);
    }
}
