...
public final class ChipElevation {
    ...
    public final State<Dp> shadowElevation$material3(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1881877139, $changed, -1, "androidx.compose.material3.ChipElevation.shadowElevation (Chip.kt:2353)");
        }
    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        ChipElevation$animateElevation$2$1 value$iv;
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-2071499570, $changed, -1, "androidx.compose.material3.ChipElevation.animateElevation (Chip.kt:2361)");
        }
        ...
        if (invalid$iv || it$iv3 == Composer.INSTANCE.getEmpty()) {
            Object value$iv4 = (Function2) new ChipElevation$animateElevation$1$1(interactionSource, interactions, null);
        ...
        if (it$iv4 == Composer.INSTANCE.getEmpty()) {
            Object value$iv5 = new Animatable(Dp.m8148boximpl(target), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
        ...
        if (invalid$iv2 || it$iv5 == Composer.INSTANCE.getEmpty()) {
            ...
            value$iv = new ChipElevation$animateElevation$2$1(animatable, target, enabled, interaction, lastInteraction$delegate, null);
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof ChipElevation) && Dp.m8155equalsimpl0(this.elevation, ((ChipElevation) other).elevation) && Dp.m8155equalsimpl0(this.pressedElevation, ((ChipElevation) other).pressedElevation) && Dp.m8155equalsimpl0(this.focusedElevation, ((ChipElevation) other).focusedElevation) && Dp.m8155equalsimpl0(this.hoveredElevation, ((ChipElevation) other).hoveredElevation) && Dp.m8155equalsimpl0(this.disabledElevation, ((ChipElevation) other).disabledElevation)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Dp.m8156hashCodeimpl(this.elevation);
