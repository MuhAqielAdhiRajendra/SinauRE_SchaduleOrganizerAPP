...
public final class ArrowCircleRightKt {
    ...
    public static final ImageVector getArrowCircleRight(Icons.Rounded $this$ArrowCircleRight) {
        ...
        ImageVector.Builder $this$_get_ArrowCircleRight__u24lambda_u241 = new ImageVector.Builder("Rounded.ArrowCircleRight", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(12.0f, 14.79f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-2.79f, 2.79f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(12.54f, 15.46f, 12.0f, 15.24f, 12.0f, 14.79f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
