...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_interpreterMode", "Landroidx/compose/ui/graphics/vector/ImageVector;", "InterpreterMode", "Landroidx/compose/material/icons/Icons$Outlined;", "getInterpreterMode", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class InterpreterModeKt {
    private static ImageVector _interpreterMode;

    public static final ImageVector getInterpreterMode(Icons.Outlined $this$InterpreterMode) {
        ...
        ImageVector.Builder $this$_get_InterpreterMode__u24lambda_u241 = new ImageVector.Builder("Outlined.InterpreterMode", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, 0.0f, 0.0f, -1.54f, 0.0f, -1.54f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(1.69f, -0.24f, 3.0f, -1.7f, 3.0f, -3.46f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(-1.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, 1.38f, -1.12f, 2.5f, -2.5f, 2.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(18.0f, 16.38f, 18.0f, 15.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(-1.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, 1.76f, 1.31f, 3.22f, 3.0f, 3.46f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(20.0f, 18.46f, 20.0f, 20.0f, 20.0f, 20.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.5f, 0.86f, 1.25f, 1.56f, 2.15f, 2.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(7.0f, 20.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(-2.78f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -1.12f, 0.61f, -2.15f, 1.61f, -2.66f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(10.29f, 13.7f, 12.47f, 13.0f, 15.0f, 13.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.39f, 0.0f, 0.77f, 0.02f, 1.14f, 0.05f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.33f, 0.59f, -0.55f, 1.26f, -0.62f, 1.96f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(15.35f, 15.0f, 15.18f, 15.0f, 15.0f, 15.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _interpreterMode = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_InterpreterMode__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
