...
public final class WindowInfoImpl implements WindowInfo {
    ...
    private static final MutableState<PointerKeyboardModifiers> GlobalKeyboardModifiers = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(PointerKeyboardModifiers.m6713boximpl(PointerEvent_androidKt.EmptyPointerKeyboardModifiers()), null, 2, null);
    private final MutableState<IntSize> _containerSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m8313boximpl(IntSize.INSTANCE.m8326getZeroYbymL2g()), null, 2, null);
    private final MutableState<DpSize> _containerDpSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(DpSize.m8236boximpl(DpSize.INSTANCE.m8258getZeroMYxV2XQ()), null, 2, null);
    ...
    public int mo7291getKeyboardModifiersk7X9c1A() {
    ...
    public void m7326setKeyboardModifiers5xRPYO0(int value) {
        GlobalKeyboardModifiers.setValue(PointerKeyboardModifiers.m6713boximpl(value));
    }

    @Override // androidx.compose.ui.platform.WindowInfo
    /* JADX INFO: renamed from: getContainerSize-YbymL2g */
    public long mo7290getContainerSizeYbymL2g() {
        return this._containerSize.getValue().m8325unboximpl();
    }

    /* JADX INFO: renamed from: setContainerSize-ozmzZPI, reason: not valid java name */
    public void m7325setContainerSizeozmzZPI(long value) {
        this._containerSize.setValue(IntSize.m8313boximpl(value));
    }

    @Override // androidx.compose.ui.platform.WindowInfo
    /* JADX INFO: renamed from: getContainerDpSize-MYxV2XQ */
    public long mo7289getContainerDpSizeMYxV2XQ() {
    ...
    public void m7324setContainerDpSizeEaSLcWc(long value) {
        this._containerDpSize.setValue(DpSize.m8236boximpl(value));
    }
