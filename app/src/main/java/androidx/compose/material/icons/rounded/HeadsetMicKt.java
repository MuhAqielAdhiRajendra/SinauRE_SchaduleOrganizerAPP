...
public final class HeadsetMicKt {
    ...
    public static final ImageVector getHeadsetMic(Icons.Rounded $this$HeadsetMic) {
        if (_headsetMic != null) {
        ...
        ImageVector.Builder $this$_get_HeadsetMic__u24lambda_u241 = new ImageVector.Builder("Rounded.HeadsetMic", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
