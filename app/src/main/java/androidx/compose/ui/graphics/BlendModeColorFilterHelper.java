...
final class BlendModeColorFilterHelper {
    ...
    public final android.graphics.BlendModeColorFilter m5257BlendModeColorFilterxETnrds(long color, int blendMode) {
        return new android.graphics.BlendModeColorFilter(ColorKt.m5367toArgb8_81llA(color), AndroidBlendMode_androidKt.m5160toAndroidBlendModes9anfk8(blendMode));
    }
