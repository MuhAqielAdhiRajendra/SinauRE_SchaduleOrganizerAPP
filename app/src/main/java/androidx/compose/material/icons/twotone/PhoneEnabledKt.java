...
public final class PhoneEnabledKt {
    ...
    public static final ImageVector getPhoneEnabled(Icons.TwoTone $this$PhoneEnabled) {
        ...
        ImageVector.Builder $this$_get_PhoneEnabled__u24lambda_u241 = new ImageVector.Builder("TwoTone.PhoneEnabled", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(20.55f, 3.0f, 21.0f, 3.45f, 21.0f, 4.0f);
