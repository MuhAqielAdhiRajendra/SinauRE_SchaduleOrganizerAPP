...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    public final void mo10498dispatch(CoroutineContext context, Runnable block) {
        enqueue(block);
    }
    ...
    private final Runnable dequeue() {
        ...
        while (true) {
            ...
            if (!(queue instanceof LockFreeTaskQueueCore)) {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_queue$volatile$FU, this, queue, null)) {
                    Intrinsics.checkNotNull(queue, "null cannot be cast to non-null type java.lang.Runnable");
            ...
            do {
                ...
                synchronized (this_$iv) {
                    ...
                    if (first$iv != null) {
                        ...
                        delayedTaskRemoveAtImpl = zEnqueueImpl ? this_$iv.removeAtImpl(0) : null;
                    }
                }
    ...
    private final int scheduleImpl(long now, DelayedTask delayedTask) {
        ...
        if (delayedQueue == null) {
            ...
            AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_delayed$volatile$FU, $this$scheduleImpl_u24lambda_u248, null, new DelayedTaskQueue(now));
        ...
        public final int scheduleTask(long now, DelayedTaskQueue delayed, EventLoopImplBase eventLoop) {
            ...
            synchronized (this) {
                ...
                synchronized (this_$iv) {
                    ...
                    if (this.nanoTime - delayed.timeNow < j) {
