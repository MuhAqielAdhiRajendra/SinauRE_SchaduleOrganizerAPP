...
public final class BadgeState {
    ...
    BadgeState(Context context, int badgeResId, int defStyleAttr, int defStyleRes, State storedState) {
        ...
        if (storedState.number == -2) {
            boolean zHasValue = a.hasValue(R.styleable.Badge_number);
        ...
        state3.contentDescriptionQuantityStrings = i;
        ...
        state8.badgeShapeAppearanceResId = Integer.valueOf(iIntValue);
        ...
        state9.badgeShapeAppearanceOverlayResId = Integer.valueOf(iIntValue2);
        ...
        state10.badgeWithTextShapeAppearanceResId = Integer.valueOf(iIntValue3);
        ...
        state11.badgeWithTextShapeAppearanceOverlayResId = Integer.valueOf(iIntValue4);
        ...
        state12.backgroundColor = Integer.valueOf(iIntValue5);
        ...
        state13.badgeTextAppearanceResId = Integer.valueOf(iIntValue6);
        ...
        state14.badgeGravity = Integer.valueOf(iIntValue7);
        ...
        state15.badgeHorizontalPadding = Integer.valueOf(iIntValue8);
        ...
        state16.badgeVerticalPadding = Integer.valueOf(iIntValue9);
        ...
        state17.horizontalOffsetWithoutText = Integer.valueOf(iIntValue10);
        ...
        state18.verticalOffsetWithoutText = Integer.valueOf(iIntValue11);
        ...
        state19.horizontalOffsetWithText = Integer.valueOf(iIntValue12);
        ...
        state20.verticalOffsetWithText = Integer.valueOf(iIntValue13);
        ...
        state21.largeFontVerticalOffsetAdjustment = Integer.valueOf(iIntValue14);
        State state22 = this.currentState;
        if (storedState.additionalHorizontalOffset == null) {
            iIntValue15 = 0;
        } else {
            iIntValue15 = storedState.additionalHorizontalOffset.intValue();
        }
        state22.additionalHorizontalOffset = Integer.valueOf(iIntValue15);
        State state23 = this.currentState;
        if (storedState.additionalVerticalOffset == null) {
            iIntValue16 = 0;
        } else {
            iIntValue16 = storedState.additionalVerticalOffset.intValue();
        }
        state23.additionalVerticalOffset = Integer.valueOf(iIntValue16);
        ...
        state24.autoAdjustToWithinGrandparentBounds = Boolean.valueOf(zBooleanValue);
        a.recycle();
        Locale locale = storedState.numberLocale;
        State state25 = this.currentState;
        if (locale == null) {
            state25.numberLocale = Locale.getDefault(Locale.Category.FORMAT);
        } else {
            state25.numberLocale = storedState.numberLocale;
        }
