...
public final class MuseumKt {
    ...
    public static final ImageVector getMuseum(Icons.Filled $this$Museum) {
        if (_museum != null) {
        ...
        ImageVector.Builder $this$_get_Museum__u24lambda_u241 = new ImageVector.Builder("Filled.Museum", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
