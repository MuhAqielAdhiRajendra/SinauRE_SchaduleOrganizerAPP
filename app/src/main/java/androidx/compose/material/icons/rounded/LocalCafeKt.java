...
public final class LocalCafeKt {
    ...
    public static final ImageVector getLocalCafe(Icons.Rounded $this$LocalCafe) {
        if (_localCafe != null) {
        ...
        ImageVector.Builder $this$_get_LocalCafe__u24lambda_u241 = new ImageVector.Builder("Rounded.LocalCafe", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
