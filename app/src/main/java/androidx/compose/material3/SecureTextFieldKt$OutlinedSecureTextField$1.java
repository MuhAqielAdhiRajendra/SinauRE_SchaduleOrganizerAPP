    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        BasicSecureTextFieldKt.m1479BasicSecureTextFieldegD4TGM(this.$state, modifierM1099defaultMinSizeVpY3zN4, this.$enabled, false, this.$inputTransformation, this.$mergedTextStyle, this.$keyboardOptions, this.$onKeyboardAction, this.$onTextLayout, this.$interactionSource, solidColor, outlinedTextFieldDefaults.decorator(textFieldState, z2, singleLine, null, mutableInteractionSource, textFieldLabelPosition, function3, function2, function22, function23, function24, function25, function26, z3, textFieldColors, paddingValues, ComposableLambdaKt.rememberComposableLambda(-1406782897, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SecureTextFieldKt$OutlinedSecureTextField$1.2
            ...
            public final void invoke(Composer $composer2, int $changed2) {
                ...
                OutlinedTextFieldDefaults.INSTANCE.m2791Container4EFweAY(z4, z5, mutableInteractionSource2, null, textFieldColors2, shape, 0.0f, 0.0f, $composer2, 100663296, 200);
                if (ComposerKt.isTraceInProgress()) {
