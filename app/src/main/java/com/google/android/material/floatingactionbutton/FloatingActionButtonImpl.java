...
class FloatingActionButtonImpl {
    ...
    void initializeBackgroundDrawable(ColorStateList backgroundTint, PorterDuff.Mode backgroundTintMode, ColorStateList rippleColor, int borderWidth) {
        ...
        RippleDrawable rippleDrawable = new RippleDrawable(RippleUtils.sanitizeRippleDrawableColor(rippleColor), rippleContent, null);
    ...
    void setRippleColor(ColorStateList rippleColor) {
        boolean z = this.rippleDrawable instanceof RippleDrawable;
    ...
    void show(final InternalVisibilityChangedListener listener, final boolean fromUser) {
        ...
        floatingActionButton.internalSetVisibility(0, fromUser);
    ...
    private AnimatorSet createDefaultAnimator(final float targetOpacity, final float targetScale, final float targetIconScale, int duration, int interpolator) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl$$ExternalSyntheticLambda0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m8843x7a82a444(startAlpha, targetOpacity, startScaleX, targetScale, startScaleY, startImageMatrixScale, targetIconScale, matrix, valueAnimator);
            }
        });
    ...
    /* JADX INFO: renamed from: lambda$createDefaultAnimator$0$com-google-android-material-floatingactionbutton-FloatingActionButtonImpl, reason: not valid java name */
    /* synthetic */ void m8843x7a82a444(float startAlpha, float targetOpacity, float startScaleX, float targetScale, float startScaleY, float startImageMatrixScale, float targetIconScale, Matrix matrix, ValueAnimator animation) {
