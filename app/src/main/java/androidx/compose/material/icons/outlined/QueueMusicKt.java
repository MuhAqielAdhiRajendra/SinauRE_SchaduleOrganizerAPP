...
public final class QueueMusicKt {
    ...
    public static final ImageVector getQueueMusic(Icons.Outlined $this$QueueMusic) {
        if (_queueMusic != null) {
        ...
        ImageVector.Builder $this$_get_QueueMusic__u24lambda_u241 = new ImageVector.Builder("Outlined.QueueMusic", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
