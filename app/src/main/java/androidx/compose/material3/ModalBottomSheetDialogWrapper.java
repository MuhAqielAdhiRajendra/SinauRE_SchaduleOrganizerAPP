...
final class ModalBottomSheetDialogWrapper extends ComponentDialog implements ViewRootForInspector {
    ...
    private ModalBottomSheetDialogWrapper(Function0<Unit> function0, ModalBottomSheetProperties properties, long contentColor, View composeView, LayoutDirection layoutDirection, Density density, UUID dialogId, Animatable<Float, AnimationVector1D> animatable, CoroutineScope scope) {
        ...
        $this$_init__u24lambda_u241.setElevation(density.mo432toPx0680j_4(this.maxSupportedElevation));
        ...
        $this$_init__u24lambda_u242.setAppearanceLightStatusBars(isAppearanceLightStatusBars != null ? isAppearanceLightStatusBars.booleanValue() : ModalBottomSheet_androidKt.m2702isDark8_81llA(this.contentColor));
        Boolean isAppearanceLightNavigationBars = this.properties.getIsAppearanceLightNavigationBars();
        $this$_init__u24lambda_u242.setAppearanceLightNavigationBars(isAppearanceLightNavigationBars != null ? isAppearanceLightNavigationBars.booleanValue() : ModalBottomSheet_androidKt.m2702isDark8_81llA(this.contentColor));
    ...
    static final Unit _init_$lambda$3(ModalBottomSheetDialogWrapper this$0) {
    ...
    public final void m2694updateParameters9LQNqLg(Function0<Unit> onDismissRequest, ModalBottomSheetProperties properties, long contentColor, LayoutDirection layoutDirection) {
        int i;
