...
public final class DoneAllKt {
    ...
    public static final ImageVector getDoneAll(Icons.Sharp $this$DoneAll) {
        if (_doneAll != null) {
        ...
        ImageVector.Builder $this$_get_DoneAll__u24lambda_u241 = new ImageVector.Builder("Sharp.DoneAll", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
