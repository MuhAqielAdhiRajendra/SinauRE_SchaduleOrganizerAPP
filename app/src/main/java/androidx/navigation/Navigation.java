...
public final class Navigation {
    ...
    static final void createNavigateOnClickListener$lambda$0(int $resId, Bundle $args, View view) {
    ...
    public static final View.OnClickListener createNavigateOnClickListener(int resId) {
        return createNavigateOnClickListener$default(resId, null, 2, null);
    }
    ...
    static final void createNavigateOnClickListener$lambda$1(NavDirections $directions, View view) {
        Intrinsics.checkNotNull(view);
    ...
    static final View findViewNavController$lambda$2(View it) {
    ...
    static final NavController findViewNavController$lambda$3(View it) {
        Intrinsics.checkNotNullParameter(it, "it");
