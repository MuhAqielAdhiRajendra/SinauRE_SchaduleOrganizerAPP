...
public final class WindowRecomposerPolicy {
    ...
    public final <R> R withFactory(WindowRecomposerFactory factory2, Function0<? extends R> block) {
        ...
        try {
            ...
            try {
                ...
                IllegalStateException err3 = new IllegalStateException("WindowRecomposerFactory was set to unexpected value; cannot safely restore old state");
                ExceptionsKt.addSuppressed(t, err3);
                throw t;
            }
        }
    }
    ...
    public final Recomposer createAndInstallWindowRecomposer$ui(View rootView) {
        ...
        final Job unsetJob = BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, HandlerDispatcherKt.from(rootView.getHandler(), "windowRecomposer cleanup").getImmediate(), null, new WindowRecomposerPolicy$createAndInstallWindowRecomposer$unsetJob$1(newRecomposer, rootView, null), 2, null);
        rootView.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: androidx.compose.ui.platform.WindowRecomposerPolicy$createAndInstallWindowRecomposer$1
            ...
            public void onViewDetachedFromWindow(View v) {
                ...
                Job.DefaultImpls.cancel$default(unsetJob, (CancellationException) null, 1, (Object) null);
            }
        });
