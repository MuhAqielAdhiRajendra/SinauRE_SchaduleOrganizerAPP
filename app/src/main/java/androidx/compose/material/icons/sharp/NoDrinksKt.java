...
public final class NoDrinksKt {
    ...
    public static final ImageVector getNoDrinks(Icons.Sharp $this$NoDrinks) {
        if (_noDrinks != null) {
        ...
        ImageVector.Builder $this$_get_NoDrinks__u24lambda_u241 = new ImageVector.Builder("Sharp.NoDrinks", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
