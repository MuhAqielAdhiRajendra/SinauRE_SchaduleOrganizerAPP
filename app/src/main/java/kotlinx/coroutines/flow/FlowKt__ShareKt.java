...
final /* synthetic */ class FlowKt__ShareKt {
    ...
    private static final <T> SharingConfig<T> configureSharing$FlowKt__ShareKt(Flow<? extends T> flow, int replay) {
        ...
        if (!(flow instanceof ChannelFlow) || (flowDropChannelOperators = ((ChannelFlow) flow).dropChannelOperators()) == null) {
        ...
        return new SharingConfig<>(flowDropChannelOperators, i, ((ChannelFlow) flow).onBufferOverflow, ((ChannelFlow) flow).context);
    }
