...
public final class FontListFontFamily extends FileBasedFontFamily implements List<Font>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ Object m7667removeFirst() {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public /* bridge */ /* synthetic */ Object m7668removeLast() {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public FontListFontFamily(List<? extends Font> list) {
        super(null);
        this.fonts = list;
        boolean value$iv = !this.fonts.isEmpty();
        if (value$iv) {
            return;
        }
