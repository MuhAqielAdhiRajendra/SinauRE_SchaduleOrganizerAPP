...
public final class PlatformMagnifierFactoryApi29Impl implements PlatformMagnifierFactory {
    ...
    public PlatformMagnifierImpl mo376createnHHXs2Y(View view, boolean useTextDefault, long size, float cornerRadius, float elevation, boolean clippingEnabled, Density density, float initialZoom) {
        if (useTextDefault) {
            return new PlatformMagnifierImpl(new Magnifier(view));
        }
        long pixelSize = density.mo433toSizeXkaWNTQ(size);
        float pixelCornerRadius = density.mo432toPx0680j_4(cornerRadius);
        float pixelElevation = density.mo432toPx0680j_4(elevation);
        Magnifier.Builder $this$create_nHHXs2Y_u24lambda_u240_u240 = new Magnifier.Builder(view);
        if (pixelSize != InlineClassHelperKt.UnspecifiedPackedFloats) {
            ...
            $this$create_nHHXs2Y_u24lambda_u240_u240.setSize(MathKt.roundToInt(Float.intBitsToFloat(bits$iv$iv$iv)), MathKt.roundToInt(Float.intBitsToFloat(bits$iv$iv$iv2)));
        }
        if (!Float.isNaN(pixelCornerRadius)) {
            $this$create_nHHXs2Y_u24lambda_u240_u240.setCornerRadius(pixelCornerRadius);
        }
        if (!Float.isNaN(pixelElevation)) {
            $this$create_nHHXs2Y_u24lambda_u240_u240.setElevation(pixelElevation);
        }
        if (!Float.isNaN(initialZoom)) {
            $this$create_nHHXs2Y_u24lambda_u240_u240.setInitialZoom(initialZoom);
        }
        $this$create_nHHXs2Y_u24lambda_u240_u240.setClippingEnabled(clippingEnabled);
        Magnifier magnifier = $this$create_nHHXs2Y_u24lambda_u240_u240.build();
        return new PlatformMagnifierImpl(magnifier);
    }

    /* JADX INFO: compiled from: PlatformMagnifier.android.kt */
    @Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0007\n\u0002\b\u0003\b\u0007\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J'\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\t2\u0006\u0010\u000b\u001a\u00020\fH\u0016¢\u0006\u0004\b\r\u0010\u000e¨\u0006\u000f"}, d2 = {"Landroidx/compose/foundation/PlatformMagnifierFactoryApi29Impl$PlatformMagnifierImpl;", "Landroidx/compose/foundation/PlatformMagnifierFactoryApi28Impl$PlatformMagnifierImpl;", "magnifier", "Landroid/widget/Magnifier;", "<init>", "(Landroid/widget/Magnifier;)V", "update", "", "sourceCenter", "Landroidx/compose/ui/geometry/Offset;", "magnifierCenter", "zoom", "", "update-Wko1d7g", "(JJF)V", "foundation"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class PlatformMagnifierImpl extends PlatformMagnifierFactoryApi28Impl.PlatformMagnifierImpl {
        ...
        public void mo375updateWko1d7g(long sourceCenter, long magnifierCenter, float zoom) {
            if (!Float.isNaN(zoom)) {
