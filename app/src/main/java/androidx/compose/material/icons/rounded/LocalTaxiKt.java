...
public final class LocalTaxiKt {
    ...
    public static final ImageVector getLocalTaxi(Icons.Rounded $this$LocalTaxi) {
        if (_localTaxi != null) {
        ...
        ImageVector.Builder $this$_get_LocalTaxi__u24lambda_u241 = new ImageVector.Builder("Rounded.LocalTaxi", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
