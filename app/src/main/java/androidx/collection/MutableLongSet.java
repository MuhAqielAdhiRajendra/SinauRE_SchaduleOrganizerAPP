...
public final class MutableLongSet extends LongSet {
    ...
    */
    ...
    public final void dropDeletes$collection() {
        ...
        long[] metadata2 = mutableLongSet.metadata;
        int capacity = mutableLongSet._capacity;
        long[] elements = mutableLongSet.elements;
        ...
        while (index != capacity) {
            ...
            if (m == 128) {
                ...
                long k$iv = elements[index];
                int hash$iv = Long.hashCode(k$iv) * ScatterMapKt.MurmurHashC1;
                int hash = hash$iv ^ (hash$iv << 16);
                int $i$f$h1 = hash >>> 7;
                int targetIndex = mutableLongSet.findFirstAvailableSlot($i$f$h1);
                ...
                if (newProbeIndex2 != oldProbeIndex) {
                    ...
                    if (((metadata2[targetIndex >> 3] >> ((targetIndex & 7) << 3)) & 255) != 128) {
                        ...
                        long oldElement = elements[targetIndex];
    ...
    public final void resizeStorage$collection(int newCapacity) {
        ...
        long[] previousElements = this.elements;
        int previousCapacity = this._capacity;
        initializeStorage(newCapacity);
        long[] newMetadata = this.metadata;
        long[] newElements = this.elements;
