...
public final class SquareFootKt {
    ...
    public static final ImageVector getSquareFoot(Icons.Outlined $this$SquareFoot) {
        if (_squareFoot != null) {
        ...
        ImageVector.Builder $this$_get_SquareFoot__u24lambda_u241 = new ImageVector.Builder("Outlined.SquareFoot", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
