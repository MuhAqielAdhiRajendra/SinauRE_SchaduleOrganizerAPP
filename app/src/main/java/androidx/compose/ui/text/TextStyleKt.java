...
public final class TextStyleKt {
    ...
    public static final int m7619resolveTextDirectionIhaHGbI(LayoutDirection layoutDirection, int textDirection) {
        if (TextDirection.m8016equalsimpl0(textDirection, TextDirection.INSTANCE.m8020getContents_7Xco())) {
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
                    return TextDirection.INSTANCE.m8021getContentOrLtrs_7Xco();
                case 2:
                    return TextDirection.INSTANCE.m8022getContentOrRtls_7Xco();
                default:
                    throw new NoWhenBranchMatchedException();
            }
        }
        if (TextDirection.m8016equalsimpl0(textDirection, TextDirection.INSTANCE.m8025getUnspecifieds_7Xco())) {
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
