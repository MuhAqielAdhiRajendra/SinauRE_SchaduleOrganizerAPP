...
public final class WeekendKt {
    ...
    public static final ImageVector getWeekend(Icons.Outlined $this$Weekend) {
        if (_weekend != null) {
        ...
        ImageVector.Builder $this$_get_Weekend__u24lambda_u241 = new ImageVector.Builder("Outlined.Weekend", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(4.35f, 4.0f, 3.0f, 5.35f, 3.0f, 7.0f);
