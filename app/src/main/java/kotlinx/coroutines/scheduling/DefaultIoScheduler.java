...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    public void execute(Runnable command) {
        mo10498dispatch(EmptyCoroutineContext.INSTANCE, command);
    }
    ...
    public void mo10498dispatch(CoroutineContext context, Runnable block) {
        default.mo10498dispatch(context, block);
    }
