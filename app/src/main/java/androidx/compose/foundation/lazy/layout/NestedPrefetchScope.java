...
public interface NestedPrefetchScope {
    ...
    void mo1253schedulePrecompositionAndPremeasure0kLqBqw(int index, long constraints);
    ...
    default void m1255schedulePrefetch0kLqBqw(int index, long constraints) {
        mo1253schedulePrecompositionAndPremeasure0kLqBqw(index, constraints);
    }
}
