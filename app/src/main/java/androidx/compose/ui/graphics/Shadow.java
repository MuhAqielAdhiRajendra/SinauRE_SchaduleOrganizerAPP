...
public final class Shadow {
    ...
    public static /* synthetic */ void m5655getOffsetF1C5BW0$annotations() {
    }
    ...
    public /* synthetic */ Shadow(long j, long j2, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4278190080L) : j, (i & 2) != 0 ? Offset.INSTANCE.m5084getZeroF1C5BW0() : j2, (i & 4) != 0 ? 0.0f : f, null);
    }
    ...
    /* JADX INFO: compiled from: Shadow.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u001c\u0010\u0004\u001a\u00020\u00058\u0006X\u0087\u0004¢\u0006\u000e\n\u0000\u0012\u0004\b\u0006\u0010\u0003\u001a\u0004\b\u0007\u0010\b¨\u0006\t"}, d2 = {"Landroidx/compose/ui/graphics/Shadow$Companion;", "", "<init>", "()V", "None", "Landroidx/compose/ui/graphics/Shadow;", "getNone$annotations", "getNone", "()Landroidx/compose/ui/graphics/Shadow;", "ui-graphics"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Shadow) && Color.m5314equalsimpl0(this.color, ((Shadow) other).color) && Offset.m5065equalsimpl0(this.offset, ((Shadow) other).offset)) {
    ...
    public int hashCode() {
        int result = Color.m5320hashCodeimpl(this.color);
        return (((result * 31) + Offset.m5070hashCodeimpl(this.offset)) * 31) + Float.hashCode(this.blurRadius);
    }

    public String toString() {
        return "Shadow(color=" + ((Object) Color.m5321toStringimpl(this.color)) + ", offset=" + ((Object) Offset.m5076toStringimpl(this.offset)) + ", blurRadius=" + this.blurRadius + ')';
    }

    /* JADX INFO: renamed from: copy-qcb84PM, reason: not valid java name */
    public final Shadow m5656copyqcb84PM(long color, long offset, float blurRadius) {
