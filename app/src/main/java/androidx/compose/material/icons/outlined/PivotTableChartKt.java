...
public final class PivotTableChartKt {
    ...
    public static final ImageVector getPivotTableChart(Icons.Outlined $this$PivotTableChart) {
        ...
        ImageVector.Builder $this$_get_PivotTableChart__u24lambda_u241 = new ImageVector.Builder("Outlined.PivotTableChart", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(4.0f, 4.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(1.41f, -1.41f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(12.83f, 19.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _pivotTableChart = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_PivotTableChart__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
