...
public final class Magnifier_androidKt {
    ...
    public static /* synthetic */ Modifier m353magnifierUpNRX3w$default(Modifier modifier, Function1 function1, Function1 function12, Function1 function13, float f, long j, float f2, float f3, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            function12 = null;
        }
        if ((i & 4) != 0) {
        ...
        if ((i & 16) != 0) {
            j = DpSize.INSTANCE.m8257getUnspecifiedMYxV2XQ();
        }
        if ((i & 32) != 0) {
        ...
        return m352magnifierUpNRX3w(modifier, function1, function12, function13, f, j, f2, f3, z);
    }

    /* JADX INFO: renamed from: magnifier-UpNRX3w, reason: not valid java name */
    public static final Modifier m352magnifierUpNRX3w(Modifier $this$magnifier_u2dUpNRX3w, Function1<? super Density, Offset> function1, Function1<? super Density, Offset> function12, Function1<? super DpSize, Unit> function13, float zoom, long size, float cornerRadius, float elevation, boolean clip) {
        return m355magnifierjPUL71Q$default($this$magnifier_u2dUpNRX3w, function1, function12, function13, zoom, false, size, cornerRadius, elevation, clip, null, 512, null);
    }

    /* JADX INFO: renamed from: magnifier-jPUL71Q$default, reason: not valid java name */
    public static /* synthetic */ Modifier m355magnifierjPUL71Q$default(Modifier modifier, Function1 function1, Function1 function12, Function1 function13, float f, boolean z, long j, float f2, float f3, boolean z2, PlatformMagnifierFactory platformMagnifierFactory, int i, Object obj) {
        if ((i & 2) != 0) {
            function12 = null;
        }
        if ((i & 4) != 0) {
