...
public final class NoLuggageKt {
    ...
    public static final ImageVector getNoLuggage(Icons.Filled $this$NoLuggage) {
        if (_noLuggage != null) {
        ...
        ImageVector.Builder $this$_get_NoLuggage__u24lambda_u241 = new ImageVector.Builder("Filled.NoLuggage", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
