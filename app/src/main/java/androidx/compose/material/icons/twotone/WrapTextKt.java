...
public final class WrapTextKt {
    ...
    @Deprecated(message = "Use the AutoMirrored version at Icons.AutoMirrored.TwoTone.WrapText", replaceWith = @ReplaceWith(expression = "Icons.AutoMirrored.TwoTone.WrapText", imports = {"androidx.compose.material.icons.automirrored.twotone.WrapText"}))
    public static /* synthetic */ void getWrapText$annotations(Icons.TwoTone twoTone) {
    }

    public static final ImageVector getWrapText(Icons.TwoTone $this$WrapText) {
        if (_wrapText != null) {
        ...
        ImageVector.Builder $this$_get_WrapText__u24lambda_u241 = new ImageVector.Builder("TwoTone.WrapText", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
