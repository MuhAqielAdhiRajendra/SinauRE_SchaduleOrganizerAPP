...
public abstract class LongLongMap {
            ...
            if ((((~slot$iv) << 7) & slot$iv & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (j$iv < bitCount$iv) {
                    ...
                    if (!(value$iv$iv < 128)) {
                        ...
                        i = i2;
                        block.invoke(Long.valueOf(k2[index$iv]), Long.valueOf(v[index$iv]));
                    }
                    slot$iv >>= i;
                    j$iv++;
                    i2 = i;
    ...
    */
    ...
    public static /* synthetic */ String joinToString$default(LongLongMap longLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        ...
        return longLongMap.joinToString(charSequence, charSequence2, charSequence3, i, (i2 & 16) != 0 ? "..." : charSequence4);
    }
    ...
    public boolean equals(Object other) {
        ...
        boolean z4 = false;
        if (!(obj instanceof LongLongMap) || ((LongLongMap) obj).get_size() != get_size()) {
            return false;
        }
        LongLongMap this_$iv3 = this;
        int $i$f$forEach = 0;
            ...
            if ($this$maskEmptyOrDeleted$iv$iv$iv == -9187201950435737472L) {
                ...
                while (j$iv$iv < bitCount$iv$iv) {
                    ...
                    if (!(value$iv$iv$iv < 128 ? z5 : z6)) {
                        ...
                        long value = v$iv[index$iv$iv];
                        z2 = z6;
                        int index = ((LongLongMap) obj).findKeyIndex(key);
                        if (index < 0 || value != ((LongLongMap) other).values[index]) {
                            break loop0;
                        }
                    }
                    slot$iv$iv >>= i;
