...
public final class KeyboardOptions {
    ...
    private static final KeyboardOptions SecureTextField = new KeyboardOptions(0, (Boolean) false, KeyboardType.INSTANCE.m7813getPasswordPjHm6EE(), 0, (PlatformImeOptions) (0 == true ? 1 : 0), (Boolean) (0 == true ? 1 : 0), (LocaleList) null, 121, (DefaultConstructorMarker) null);
    ...
    public /* synthetic */ KeyboardOptions(int i, Boolean bool, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool2, LocaleList localeList, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        int iM7789getUnspecifiedIUNYP9k = (i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m7789getUnspecifiedIUNYP9k() : i;
        Boolean bool3 = (i4 & 2) != 0 ? null : bool;
        int iM7816getUnspecifiedPjHm6EE = (i4 & 4) != 0 ? KeyboardType.INSTANCE.m7816getUnspecifiedPjHm6EE() : i2;
        int iM7762getUnspecifiedeUduSuo = (i4 & 8) != 0 ? ImeAction.INSTANCE.m7762getUnspecifiedeUduSuo() : i3;
        PlatformImeOptions platformImeOptions2 = (i4 & 16) != 0 ? null : platformImeOptions;
        Boolean bool4 = (i4 & 32) != 0 ? null : bool2;
        this(iM7789getUnspecifiedIUNYP9k, bool3, iM7816getUnspecifiedPjHm6EE, iM7762getUnspecifiedeUduSuo, platformImeOptions2, bool4, (i4 & 64) == 0 ? localeList : null, (DefaultConstructorMarker) null);
    }
    ...
    /* JADX INFO: compiled from: KeyboardOptions.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u001c\u0010\u0004\u001a\u00020\u00058\u0006X\u0087\u0004¢\u0006\u000e\n\u0000\u0012\u0004\b\u0006\u0010\u0003\u001a\u0004\b\u0007\u0010\bR\u001c\u0010\t\u001a\u00020\u00058\u0000X\u0081\u0004¢\u0006\u000e\n\u0000\u0012\u0004\b\n\u0010\u0003\u001a\u0004\b\u000b\u0010\b¨\u0006\f"}, d2 = {"Landroidx/compose/foundation/text/KeyboardOptions$Companion;", "", "<init>", "()V", "Default", "Landroidx/compose/foundation/text/KeyboardOptions;", "getDefault$annotations", "getDefault", "()Landroidx/compose/foundation/text/KeyboardOptions;", "SecureTextField", "getSecureTextField$foundation$annotations", "getSecureTextField$foundation", "foundation"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool, LocaleList localeList, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m7789getUnspecifiedIUNYP9k() : i, z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m7816getUnspecifiedPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m7762getUnspecifiedeUduSuo() : i3, (i4 & 16) != 0 ? null : platformImeOptions, (i4 & 32) != 0 ? null : bool, (i4 & 64) != 0 ? null : localeList, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m7789getUnspecifiedIUNYP9k() : i, (i4 & 2) != 0 ? Default.getAutoCorrectOrDefault() : z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m7816getUnspecifiedPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m7754getDefaulteUduSuo() : i3, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m7787getNoneIUNYP9k() : i, (i4 & 2) != 0 ? Default.getAutoCorrectOrDefault() : z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m7815getTextPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m7754getDefaulteUduSuo() : i3, (i4 & 16) != 0 ? null : platformImeOptions, (DefaultConstructorMarker) null);
    }
    ...
    private KeyboardOptions(int capitalization, boolean autoCorrect, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions) {
        this(capitalization, Boolean.valueOf(autoCorrect), keyboardType, imeAction, platformImeOptions, Boolean.valueOf(Default.getShowKeyboardOnFocusOrDefault$foundation()), (LocaleList) null, 64, (DefaultConstructorMarker) null);
    }
    ...
    private final int m1592getCapitalizationOrDefaultIUNYP9k() {
        KeyboardCapitalization keyboardCapitalizationM7774boximpl = KeyboardCapitalization.m7774boximpl(this.capitalization);
        int it = keyboardCapitalizationM7774boximpl.getValue();
        if (KeyboardCapitalization.m7777equalsimpl0(it, KeyboardCapitalization.INSTANCE.m7789getUnspecifiedIUNYP9k())) {
            keyboardCapitalizationM7774boximpl = null;
        }
        return keyboardCapitalizationM7774boximpl != null ? keyboardCapitalizationM7774boximpl.getValue() : KeyboardCapitalization.INSTANCE.m7787getNoneIUNYP9k();
    }

    /* JADX INFO: renamed from: getKeyboardTypeOrDefault-PjHm6EE, reason: not valid java name */
    private final int m1593getKeyboardTypeOrDefaultPjHm6EE() {
        KeyboardType keyboardTypeM7791boximpl = KeyboardType.m7791boximpl(this.keyboardType);
        int it = keyboardTypeM7791boximpl.getValue();
        if (KeyboardType.m7794equalsimpl0(it, KeyboardType.INSTANCE.m7816getUnspecifiedPjHm6EE())) {
            keyboardTypeM7791boximpl = null;
        }
        return keyboardTypeM7791boximpl != null ? keyboardTypeM7791boximpl.getValue() : KeyboardType.INSTANCE.m7815getTextPjHm6EE();
    }

    /* JADX INFO: renamed from: getImeActionOrDefault-eUduSuo$foundation, reason: not valid java name */
    public final int m1600getImeActionOrDefaulteUduSuo$foundation() {
        ImeAction imeActionM7738boximpl = ImeAction.m7738boximpl(this.imeAction);
        int it = imeActionM7738boximpl.getValue();
        if (ImeAction.m7741equalsimpl0(it, ImeAction.INSTANCE.m7762getUnspecifiedeUduSuo())) {
            imeActionM7738boximpl = null;
        }
        return imeActionM7738boximpl != null ? imeActionM7738boximpl.getValue() : ImeAction.INSTANCE.m7754getDefaulteUduSuo();
    }
    ...
    private final boolean isCompletelyUnspecified() {
        return KeyboardCapitalization.m7777equalsimpl0(this.capitalization, KeyboardCapitalization.INSTANCE.m7789getUnspecifiedIUNYP9k()) && this.autoCorrectEnabled == null && KeyboardType.m7794equalsimpl0(this.keyboardType, KeyboardType.INSTANCE.m7816getUnspecifiedPjHm6EE()) && ImeAction.m7741equalsimpl0(this.imeAction, ImeAction.INSTANCE.m7762getUnspecifiedeUduSuo()) && this.platformImeOptions == null && this.showKeyboardOnFocus == null && this.hintLocales == null;
    }
    ...
    public final ImeOptions toImeOptions$foundation(boolean singleLine) {
        return new ImeOptions(singleLine, m1592getCapitalizationOrDefaultIUNYP9k(), getAutoCorrectOrDefault(), m1593getKeyboardTypeOrDefaultPjHm6EE(), m1600getImeActionOrDefaulteUduSuo$foundation(), this.platformImeOptions, getHintLocalesOrDefault(), (DefaultConstructorMarker) null);
    }

    /* JADX INFO: renamed from: copy-INvB4aQ$default, reason: not valid java name */
    public static /* synthetic */ KeyboardOptions m1589copyINvB4aQ$default(KeyboardOptions keyboardOptions, int i, Boolean bool, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool2, LocaleList localeList, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return keyboardOptions.m1595copyINvB4aQ(i, bool, i2, i3, platformImeOptions, bool2, (i4 & 64) != 0 ? null : localeList);
    }

    /* JADX INFO: renamed from: copy-INvB4aQ, reason: not valid java name */
    public final KeyboardOptions m1595copyINvB4aQ(int capitalization, Boolean autoCorrectEnabled, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions, Boolean showKeyboardOnFocus, LocaleList hintLocales) {
    ...
    /* JADX INFO: renamed from: copy-INvB4aQ$default, reason: not valid java name */
    public static /* synthetic */ KeyboardOptions m1590copyINvB4aQ$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool, LocaleList localeList, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = keyboardOptions.capitalization;
        }
        if ((i4 & 2) != 0) {
        ...
        return keyboardOptions.m1596copyINvB4aQ(i, z, i2, i3, platformImeOptions, bool, localeList2);
    }
    ...
    /* JADX INFO: renamed from: copy-INvB4aQ, reason: not valid java name */
    public final /* synthetic */ KeyboardOptions m1596copyINvB4aQ(int capitalization, boolean autoCorrect, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions, Boolean showKeyboardOnFocus, LocaleList hintLocales) {
    ...
    public static /* synthetic */ KeyboardOptions m1591copyij11fho$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = keyboardOptions.capitalization;
        }
        if ((i4 & 2) != 0) {
        ...
        return keyboardOptions.m1597copyij11fho(i, z, i2, i3, (i4 & 16) != 0 ? keyboardOptions.platformImeOptions : platformImeOptions);
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "Maintained for binary compatibility")
    /* JADX INFO: renamed from: copy-ij11fho, reason: not valid java name */
    public final /* synthetic */ KeyboardOptions m1597copyij11fho(int capitalization, boolean autoCorrect, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions) {
    ...
    public static /* synthetic */ KeyboardOptions m1588copy3m2b7yw$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = keyboardOptions.capitalization;
        }
        if ((i4 & 2) != 0) {
        ...
        return keyboardOptions.m1594copy3m2b7yw(i, z, i2, i3);
    }
    ...
    public final /* synthetic */ KeyboardOptions m1594copy3m2b7yw(int capitalization, boolean autoCorrect, int keyboardType, int imeAction) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof KeyboardOptions) && KeyboardCapitalization.m7777equalsimpl0(this.capitalization, ((KeyboardOptions) other).capitalization) && Intrinsics.areEqual(this.autoCorrectEnabled, ((KeyboardOptions) other).autoCorrectEnabled) && KeyboardType.m7794equalsimpl0(this.keyboardType, ((KeyboardOptions) other).keyboardType) && ImeAction.m7741equalsimpl0(this.imeAction, ((KeyboardOptions) other).imeAction) && Intrinsics.areEqual(this.platformImeOptions, ((KeyboardOptions) other).platformImeOptions) && Intrinsics.areEqual(this.showKeyboardOnFocus, ((KeyboardOptions) other).showKeyboardOnFocus) && Intrinsics.areEqual(this.hintLocales, ((KeyboardOptions) other).hintLocales);
    }

    public int hashCode() {
        int result = KeyboardCapitalization.m7778hashCodeimpl(this.capitalization);
        int i = result * 31;
        Boolean bool = this.autoCorrectEnabled;
        int result2 = i + (bool != null ? bool.hashCode() : 0);
        int result3 = ((((result2 * 31) + KeyboardType.m7795hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m7742hashCodeimpl(this.imeAction)) * 31;
    ...
    public String toString() {
        return "KeyboardOptions(capitalization=" + ((Object) KeyboardCapitalization.m7779toStringimpl(this.capitalization)) + ", autoCorrectEnabled=" + this.autoCorrectEnabled + ", keyboardType=" + ((Object) KeyboardType.m7796toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m7743toStringimpl(this.imeAction)) + ", platformImeOptions=" + this.platformImeOptions + "showKeyboardOnFocus=" + this.showKeyboardOnFocus + ", hintLocales=" + this.hintLocales + ')';
    }
    ...
    public final KeyboardOptions fillUnspecifiedValuesWith$foundation(KeyboardOptions other) {
        ...
        int value = keyboardCapitalizationM7774boximpl != null ? keyboardCapitalizationM7774boximpl.getValue() : other.capitalization;
        Boolean bool = this.autoCorrectEnabled;
        if (bool == null) {
        ...
        Boolean bool2 = bool;
        KeyboardType keyboardTypeM7791boximpl = KeyboardType.m7791boximpl(this.keyboardType);
        int it2 = keyboardTypeM7791boximpl.getValue();
        if (KeyboardType.m7794equalsimpl0(it2, KeyboardType.INSTANCE.m7816getUnspecifiedPjHm6EE())) {
            keyboardTypeM7791boximpl = null;
        }
        int value2 = keyboardTypeM7791boximpl != null ? keyboardTypeM7791boximpl.getValue() : other.keyboardType;
        ImeAction imeActionM7738boximpl = ImeAction.m7738boximpl(this.imeAction);
        int it3 = imeActionM7738boximpl.getValue();
        ImeAction imeAction = ImeAction.m7741equalsimpl0(it3, ImeAction.INSTANCE.m7762getUnspecifiedeUduSuo()) ? null : imeActionM7738boximpl;
