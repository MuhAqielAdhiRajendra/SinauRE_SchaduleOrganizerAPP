...
public final class SetTargetFragmentUsageViolation extends TargetFragmentUsageViolation {
    ...
    public SetTargetFragmentUsageViolation(Fragment fragment, Fragment targetFragment, int requestCode) {
        super(fragment, "Attempting to set target fragment " + targetFragment + " with request code " + requestCode + " for fragment " + fragment);
