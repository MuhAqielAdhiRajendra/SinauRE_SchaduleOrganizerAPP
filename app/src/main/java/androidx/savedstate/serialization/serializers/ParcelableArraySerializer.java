...
public final class ParcelableArraySerializer implements KSerializer<Parcelable[]> {
    ...
    public void serialize(Encoder encoder, Parcelable[] value) {
        ...
        SavedStateWriter.m8633putParcelableArrayimpl($this$serialize_u24lambda_u242_u24lambda_u241, $this$serialize_u24lambda_u242.getKey(), value);
    }
    ...
    public Parcelable[] deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m8570getParcelableArrayimpl($this$deserialize_u24lambda_u245_u24lambda_u244, key$iv, Reflection.getOrCreateKotlinClass(Parcelable.class));
    }
}
