...
public final class ChannelResult<T> {
    ...
    public static final /* synthetic */ ChannelResult m10450boximpl(Object obj) {
        return new ChannelResult(obj);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <T> Object m10451constructorimpl(Object obj) {
        return obj;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m10452equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof ChannelResult) && Intrinsics.areEqual(obj, ((ChannelResult) obj2).getHolder());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m10453equalsimpl0(Object obj, Object obj2) {
    ...
    public static int m10457hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public boolean equals(Object other) {
        return m10452equalsimpl(this.holder, other);
    }

    public int hashCode() {
        return m10457hashCodeimpl(this.holder);
    }
    ...
    public static final T m10456getOrThrowimpl(Object obj) throws Throwable {
        if (!(obj instanceof Failed)) {
            return obj;
        }
    ...
    public static final Throwable m10454exceptionOrNullimpl(Object arg0) {
    ...
    public static final class Companion {
        ...
        public final <E> Object m10465successJP2dKIU(E value) {
            return ChannelResult.m10451constructorimpl(value);
        }

        /* JADX INFO: renamed from: failure-PtdJZtk, reason: not valid java name */
        public final <E> Object m10464failurePtdJZtk() {
            return ChannelResult.m10451constructorimpl(ChannelResult.failed);
        }

        /* JADX INFO: renamed from: closed-JP2dKIU, reason: not valid java name */
        public final <E> Object m10463closedJP2dKIU(Throwable cause) {
            return ChannelResult.m10451constructorimpl(new Closed(cause));
        }
    }

    public String toString() {
        return m10461toStringimpl(this.holder);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m10461toStringimpl(Object arg0) {
