...
public final class SyncKt {
    ...
    public static final ImageVector getSync(Icons.Rounded $this$Sync) {
        if (_sync != null) {
        ...
        ImageVector.Builder $this$_get_Sync__u24lambda_u241 = new ImageVector.Builder("Rounded.Sync", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
