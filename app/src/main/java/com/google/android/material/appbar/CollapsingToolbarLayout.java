...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.extraMultilineHeightEnabled && this.collapsingTitleHelper.getExpandedMaxLines() > 1 && this.collapsingTitleHelper.getExpansionFraction() == 1.0f) {
            maybeSetPendingActionCollapsed();
        }
    }
    ...
    private void updateTextBounds(int left, int top, int right, int bottom, boolean forceRecalculate) {
        if (this.collapsingTitleEnabled && this.dummyView != null) {
            ...
            if (this.drawCollapsingTitle || forceRecalculate) {
                ...
                if (zIsEmpty) {
                    collapsingTextHelper.setExpandedBounds(titleBoundsLeft, titleBoundsTop, titleBoundsRight, titleBoundsBottom);
                    this.collapsingTitleHelper.recalculate(forceRecalculate);
                } else {
                    collapsingTextHelper.setExpandedBounds(titleBoundsLeft, titleBoundsTop, titleBoundsRight, (int) ((titleBoundsBottom - (this.collapsingSubtitleHelper.getExpandedTextFullSingleLineHeight() + this.extraMultilineSubtitleHeight)) - this.expandedTitleSpacing), false);
    ...
    private void updateCollapsedBounds(boolean isRtl) {
        ...
        if (!(this.toolbar instanceof Toolbar)) {
            if (this.toolbar instanceof android.widget.Toolbar) {
        ...
        CollapsingTextHelper collapsingTextHelper = this.collapsingTitleHelper;
        if (zIsEmpty) {
            collapsingTextHelper.setCollapsedBounds(titleBoundsLeft, titleBoundsTop, titleBoundsRight, titleBoundsBottom);
        } else {
            collapsingTextHelper.setCollapsedBounds(titleBoundsLeft, titleBoundsTop, titleBoundsRight, titleBoundsBottomWithSubtitle);
        ...
        if (this.collapsedTitleGravityMode == 0) {
            ...
            if (zIsEmpty2) {
                collapsingTextHelper2.setCollapsedBoundsForOffsets(validTitleBoundsLeft, titleBoundsTop, validTitleBoundsRight, titleBoundsBottom);
            } else {
                collapsingTextHelper2.setCollapsedBoundsForOffsets(validTitleBoundsLeft, titleBoundsTop, validTitleBoundsRight, titleBoundsBottomWithSubtitle);
