...
public final class AccountCircleKt {
    ...
    public static final ImageVector getAccountCircle(Icons.Outlined $this$AccountCircle) {
        ...
        ImageVector.Builder $this$_get_AccountCircle__u24lambda_u242 = new ImageVector.Builder("Outlined.AccountCircle", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_AccountCircle__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
        _accountCircle = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_AccountCircle__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv2.getNodes(), pathFillType$iv2, "", fill$iv$iv2, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv2, strokeLineJoin$iv$iv2, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
