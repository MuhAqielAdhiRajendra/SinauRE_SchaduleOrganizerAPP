...
public interface PlatformFocusOwner {
    ...
    boolean mo5009moveFocusInChildren3ESFkO8(int focusDirection);

    /* JADX INFO: renamed from: requestOwnerFocus-7o62pno, reason: not valid java name */
    boolean mo5010requestOwnerFocus7o62pno(FocusDirection focusDirection, Rect previouslyFocusedRect);
