...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    public Map<T, Object> getAllFields() {
        ...
        SmallSortedMap<T, Object> smallSortedMap = this.fields;
        if (z) {
            SmallSortedMap<T, Object> result = cloneAllFieldsMap(smallSortedMap, false);
    ...
    public void writeMessageSetTo(final CodedOutputStream output) throws IOException {
        ...
        while (true) {
            ...
            writeMessageSetTo(smallSortedMap.getArrayEntryAt(i), output);
            i++;
        }
        Iterator it = smallSortedMap.getOverflowEntries().iterator();
        while (it.hasNext()) {
    ...
    public int getMessageSetSerializedSize() {
        ...
        while (true) {
            ...
            size += getMessageSetSerializedSize(smallSortedMap.getArrayEntryAt(i));
            i++;
        }
        Iterator it = smallSortedMap.getOverflowEntries().iterator();
        while (it.hasNext()) {
    ...
    static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        public Map<T, Object> getAllFields() {
            ...
            SmallSortedMap<T, Object> smallSortedMap = this.fields;
            if (z) {
                SmallSortedMap<T, Object> result = FieldSet.cloneAllFieldsMap(smallSortedMap, false);
                if (this.fields.isImmutable()) {
                    result.makeImmutable();
                } else {
