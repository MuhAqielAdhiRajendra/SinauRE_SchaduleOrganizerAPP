...
public final class BezierKt {
    ...
    private static final float findFirstQuadraticRoot(float p0, float p1, float p2) {
        ...
        float minimumValue$iv$iv$iv = 0.0f;
        if (r$iv2 >= 0.0f) {
            minimumValue$iv$iv$iv = r$iv2;
        }
        float maximumValue$iv$iv$iv = 1.0f;
        if (minimumValue$iv$iv$iv <= 1.0f) {
            maximumValue$iv$iv$iv = minimumValue$iv$iv$iv;
        }
        if (Math.abs(maximumValue$iv$iv$iv - r$iv2) > FloatEpsilon) {
            maximumValue$iv$iv$iv = Float.NaN;
        }
        if (!Float.isNaN(maximumValue$iv$iv$iv)) {
            return maximumValue$iv$iv$iv;
        }
        float r$iv3 = (float) ((v1 - v2) / d);
        float minimumValue$iv$iv$iv2 = 0.0f;
        if (r$iv3 >= 0.0f) {
            minimumValue$iv$iv$iv2 = r$iv3;
        }
        float maximumValue$iv$iv$iv2 = 1.0f;
        if (minimumValue$iv$iv$iv2 <= 1.0f) {
            maximumValue$iv$iv$iv2 = minimumValue$iv$iv$iv2;
        }
        if (Math.abs(maximumValue$iv$iv$iv2 - r$iv3) > FloatEpsilon) {
            return Float.NaN;
        }
        return maximumValue$iv$iv$iv2;
    }

    public static final float findFirstCubicRoot(float p0, float p1, float p2, float p3) {
        double a = ((((double) p0) - (((double) p1) * 2.0d)) + ((double) p2)) * 3.0d;
        double b = ((double) (p1 - p0)) * 3.0d;
        double c = p0;
        double d = ((double) (-p0)) + (((double) (p1 - p2)) * 3.0d) + ((double) p3);
        if (Math.abs(d - 0.0d) < Epsilon) {
            ...
            if ($i$f$closeTo != 0) {
                ...
                float minimumValue$iv$iv$iv = 0.0f;
                if (r$iv >= 0.0f) {
                    minimumValue$iv$iv$iv = r$iv;
                }
                float maximumValue$iv$iv$iv = 1.0f;
                if (minimumValue$iv$iv$iv <= 1.0f) {
                    maximumValue$iv$iv$iv = minimumValue$iv$iv$iv;
                }
                if (Math.abs(maximumValue$iv$iv$iv - r$iv) > FloatEpsilon) {
                    return Float.NaN;
                }
                return maximumValue$iv$iv$iv;
            }
            ...
            float minimumValue$iv$iv$iv2 = 0.0f;
            if (r$iv2 >= 0.0f) {
                minimumValue$iv$iv$iv2 = r$iv2;
            }
            float maximumValue$iv$iv$iv2 = 1.0f;
            if (minimumValue$iv$iv$iv2 <= 1.0f) {
                maximumValue$iv$iv$iv2 = minimumValue$iv$iv$iv2;
            }
            if (Math.abs(maximumValue$iv$iv$iv2 - r$iv2) > FloatEpsilon) {
                maximumValue$iv$iv$iv2 = Float.NaN;
            }
            if (!Float.isNaN(maximumValue$iv$iv$iv2)) {
                return maximumValue$iv$iv$iv2;
            }
            float r$iv3 = (float) (((-b) - q) / a2);
            float minimumValue$iv$iv$iv3 = 0.0f;
            if (r$iv3 >= 0.0f) {
                minimumValue$iv$iv$iv3 = r$iv3;
            }
            float maximumValue$iv$iv$iv3 = 1.0f;
            if (minimumValue$iv$iv$iv3 <= 1.0f) {
                maximumValue$iv$iv$iv3 = minimumValue$iv$iv$iv3;
            }
            if (Math.abs(maximumValue$iv$iv$iv3 - r$iv3) > FloatEpsilon) {
                return Float.NaN;
            }
            return maximumValue$iv$iv$iv3;
        }
        double a3 = a / d;
        double b2 = b / d;
        ...
        if (discriminant >= 0.0d) {
            if (discriminant == 0.0d) {
                ...
                float minimumValue$iv$iv$iv4 = 0.0f;
                if (r$iv4 >= 0.0f) {
                    minimumValue$iv$iv$iv4 = r$iv4;
                }
                float maximumValue$iv$iv$iv4 = 1.0f;
                if (minimumValue$iv$iv$iv4 <= 1.0f) {
                    maximumValue$iv$iv$iv4 = minimumValue$iv$iv$iv4;
                }
                if (Math.abs(maximumValue$iv$iv$iv4 - r$iv4) > FloatEpsilon) {
                    maximumValue$iv$iv$iv4 = Float.NaN;
                }
                if (!Float.isNaN(maximumValue$iv$iv$iv4)) {
                    return maximumValue$iv$iv$iv4;
                }
                float r$iv5 = (-u1) - ((float) a32);
                float minimumValue$iv$iv$iv5 = 0.0f;
                if (r$iv5 >= 0.0f) {
                    minimumValue$iv$iv$iv5 = r$iv5;
                }
                float maximumValue$iv$iv$iv5 = 1.0f;
                if (minimumValue$iv$iv$iv5 <= 1.0f) {
                    maximumValue$iv$iv$iv5 = minimumValue$iv$iv$iv5;
                }
                if (Math.abs(maximumValue$iv$iv$iv5 - r$iv5) > FloatEpsilon) {
                    return Float.NaN;
                }
                return maximumValue$iv$iv$iv5;
            }
            double sd = Math.sqrt(discriminant);
            float u12 = MathHelpersKt.fastCbrt((float) ((-q2) + sd));
            float v1 = MathHelpersKt.fastCbrt((float) (q2 + sd));
            float r$iv6 = (float) (((double) (u12 - v1)) - a32);
            float minimumValue$iv$iv$iv6 = 0.0f;
            if (r$iv6 >= 0.0f) {
                minimumValue$iv$iv$iv6 = r$iv6;
            }
            float maximumValue$iv$iv$iv6 = 1.0f;
            if (minimumValue$iv$iv$iv6 <= 1.0f) {
                maximumValue$iv$iv$iv6 = minimumValue$iv$iv$iv6;
            }
            if (Math.abs(maximumValue$iv$iv$iv6 - r$iv6) > FloatEpsilon) {
                return Float.NaN;
            }
            return maximumValue$iv$iv$iv6;
        }
        ...
        float r$iv7 = (float) ((((double) t1) * Math.cos(phi / 3.0d)) - a32);
        float minimumValue$iv$iv$iv7 = 0.0f;
        if (r$iv7 >= 0.0f) {
            minimumValue$iv$iv$iv7 = r$iv7;
        }
        float maximumValue$iv$iv$iv7 = 1.0f;
        if (minimumValue$iv$iv$iv7 <= 1.0f) {
            maximumValue$iv$iv$iv7 = minimumValue$iv$iv$iv7;
        }
        if (Math.abs(maximumValue$iv$iv$iv7 - r$iv7) > FloatEpsilon) {
            maximumValue$iv$iv$iv7 = Float.NaN;
        }
        if (!Float.isNaN(maximumValue$iv$iv$iv7)) {
            return maximumValue$iv$iv$iv7;
        }
        float r$iv8 = (float) ((((double) t1) * Math.cos((phi + Tau) / 3.0d)) - a32);
        float minimumValue$iv$iv$iv8 = 0.0f;
        if (r$iv8 >= 0.0f) {
            minimumValue$iv$iv$iv8 = r$iv8;
        }
        float maximumValue$iv$iv$iv8 = 1.0f;
        if (minimumValue$iv$iv$iv8 <= 1.0f) {
            maximumValue$iv$iv$iv8 = minimumValue$iv$iv$iv8;
        }
        if (Math.abs(maximumValue$iv$iv$iv8 - r$iv8) > FloatEpsilon) {
            maximumValue$iv$iv$iv8 = Float.NaN;
        }
        if (!Float.isNaN(maximumValue$iv$iv$iv8)) {
            return maximumValue$iv$iv$iv8;
        }
        float r$iv9 = (float) ((((double) t1) * Math.cos((phi + 12.566370614359172d) / 3.0d)) - a32);
        float minimumValue$iv$iv$iv9 = 0.0f;
        if (r$iv9 >= 0.0f) {
            minimumValue$iv$iv$iv9 = r$iv9;
        }
        float maximumValue$iv$iv$iv9 = 1.0f;
        if (minimumValue$iv$iv$iv9 <= 1.0f) {
            maximumValue$iv$iv$iv9 = minimumValue$iv$iv$iv9;
        }
        if (Math.abs(maximumValue$iv$iv$iv9 - r$iv9) > FloatEpsilon) {
            return Float.NaN;
        }
        return maximumValue$iv$iv$iv9;
    }
    ...
    private static final int findDerivativeRoots(PathSegment pathSegment, boolean z, float[] fArr, int i) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[pathSegment.getType().ordinal()]) {
            ...
            case 4:
                ...
                int iFindQuadraticRoots = findQuadraticRoots(f2, f3, f4, fArr, i);
                float f5 = (f3 - f2) * 2.0f;
                return iFindQuadraticRoots + writeValidRootInUnitRange((-f5) / (((f4 - f3) * 2.0f) - f5), fArr, i + iFindQuadraticRoots);
            default:
                return 0;
        }
    }
    ...
    public static final long computeHorizontalBounds(PathSegment segment, float[] roots, int index) {
        ...
        return FloatFloatPair.m10constructorimpl(minX, maxX);
    }
    ...
    public static final long computeVerticalBounds(PathSegment segment, float[] roots, int index) {
        ...
        return FloatFloatPair.m10constructorimpl(minY, maxY);
    }
    ...
    public static final long computeCubicVerticalBounds(float p0y, float p1y, float p2y, float p3y, float[] roots, int index) {
        ...
        int count = findQuadraticRoots(d0, d1, d2, roots, index);
        float dd0 = (d1 - d0) * 2.0f;
        float dd1 = (d2 - d1) * 2.0f;
        int index$iv = index + count;
        int count2 = count + writeValidRootInUnitRange((-dd0) / (dd1 - dd0), roots, index$iv);
    ...
    */
    private static final int monotonicQuadraticWinding(float[] r14, int r15, float r16, float r17, float[] r18) {
        ...
        L56:
            ...
            r12 = 898428346(0x358cedba, float:1.05E-6)
    ...
    /* JADX WARN: Code restructure failed: missing block: B:33:0x00ac, code lost:
        ...
        if ((r22 == r1) == false) goto L34;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private static final int monotonicCubicWinding(float[] r19, int r20, float r21, float r22) {
        /*
            int r0 = r20 + 1
            r0 = r19[r0]
            int r1 = r20 + 7
        ...
        L1c:
            ...
            r11 = r5
            r12 = 0
            float r13 = java.lang.Math.min(r9, r8)
            float r13 = java.lang.Math.min(r11, r13)
            float r13 = java.lang.Math.min(r10, r13)
        ...
        L43:
            ...
            r11 = r3
            r12 = 0
            float r14 = java.lang.Math.max(r9, r8)
            float r14 = java.lang.Math.max(r10, r14)
            float r14 = java.lang.Math.max(r11, r14)
            int r8 = (r21 > r14 ? 1 : (r21 == r14 ? 0 : -1))
            if (r8 <= 0) goto L5a
            return r2
        L5a:
            int r8 = r20 + 1
            ...
            float r12 = r9 - r22
            float r15 = r1 - r22
            float r10 = findFirstCubicRoot(r10, r11, r12, r15)
            boolean r11 = java.lang.Float.isNaN(r10)
            if (r11 == 0) goto L7d
            return r4
        L7d:
            float r11 = evaluateCubic(r3, r5, r6, r7, r10)
            r12 = r21
            r15 = r11
            r16 = 0
            float r17 = r15 - r12
            float r17 = java.lang.Math.abs(r17)
            r18 = 898428346(0x358cedba, float:1.05E-6)
    ...
    private static final int cubicToMonotonicCubics(float[] cubic, float[] dst, float[] tmpRoot) {
        ...
        if (rootCount == 0) {
            ...
            for (int i = 0; i < rootCount; i++) {
                ...
                float minimumValue$iv$iv = $this$fastCoerceIn$iv >= 0.0f ? $this$fastCoerceIn$iv : 0.0f;
                float maximumValue$iv$iv = 1.0f;
                if (minimumValue$iv$iv <= 1.0f) {
                    maximumValue$iv$iv = minimumValue$iv$iv;
                }
                lastT = maximumValue$iv$iv;
                splitCubicAt(src, dstOffset, dst, dstOffset, maximumValue$iv$iv);
                src = dst;
                dstOffset += 6;
            }
        }
