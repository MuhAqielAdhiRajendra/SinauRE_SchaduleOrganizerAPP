...
public final class VaccinesKt {
    ...
    public static final ImageVector getVaccines(Icons.Rounded $this$Vaccines) {
        if (_vaccines != null) {
        ...
        ImageVector.Builder $this$_get_Vaccines__u24lambda_u241 = new ImageVector.Builder("Rounded.Vaccines", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(7.0f, 22.5f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(6.0f, 22.05f, 6.45f, 22.5f, 7.0f, 22.5f);
