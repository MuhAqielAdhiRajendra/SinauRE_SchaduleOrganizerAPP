...
public final class RepeatOnKt {
    ...
    public static final ImageVector getRepeatOn(Icons.Rounded $this$RepeatOn) {
        if (_repeatOn != null) {
        ...
        ImageVector.Builder $this$_get_RepeatOn__u24lambda_u241 = new ImageVector.Builder("Rounded.RepeatOn", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
