...
public final class RangeSliderState {
    ...
    static final Unit gestureEndAction$lambda$0(RangeSliderState this$0, boolean it) {
    ...
    public final void onDrag$material3(boolean isStart, float offset) {
        ...
        if (isStart) {
            ...
            jSliderRange = SliderKt.SliderRange(RangesKt.coerceAtMost(SliderKt.snapValueToTick(RangesKt.coerceIn(getRawOffsetStart$material3(), getMinPx(), offsetEnd), this.tickFractions, getMinPx(), getMaxPx()), offsetEnd), offsetEnd);
        } else {
            ...
            jSliderRange = SliderKt.SliderRange(offsetStart, RangesKt.coerceAtLeast(SliderKt.snapValueToTick(RangesKt.coerceIn(getRawOffsetEnd$material3(), offsetStart, getMaxPx()), this.tickFractions, getMinPx(), getMaxPx()), offsetStart));
        }
        long offsetRange = jSliderRange;
        long scaledUserValue = m2838scaleToUserValue8bqG3aw(isStart, getMinPx(), getMaxPx(), offsetRange);
        if (!SliderRange.m2988equalsimpl0(scaledUserValue, SliderKt.SliderRange(getActiveRangeStart(), getActiveRangeEnd()))) {
            if (this.onValueChange != null) {
                Function1<? super SliderRange, Unit> function1 = this.onValueChange;
                if (function1 != null) {
                    function1.invoke(SliderRange.m2985boximpl(scaledUserValue));
                    return;
                }
                return;
            }
            setActiveRangeStart(SliderRange.m2990getStartimpl(scaledUserValue));
            setActiveRangeEnd(SliderRange.m2989getEndInclusiveimpl(scaledUserValue));
        }
    }
    ...
    private final long m2838scaleToUserValue8bqG3aw(boolean isStart, float minPx, float maxPx, long offset) {
        return SliderKt.m2982scale2geJ7wY(isStart, minPx, maxPx, offset, this.valueRange.getStart().floatValue(), this.valueRange.getEndInclusive().floatValue());
    }
    ...
    public final void updateMinMaxPx$material3() {
        float newMaxPx = Math.max(getTotalWidth$material3() - (getEndThumbWidth$material3() / 2.0f), 0.0f);
        float newMinPx = Math.min(getStartThumbWidth$material3() / 2.0f, newMaxPx);
    ...
    public static final class Companion {
        ...
        static final RangeSliderState Saver$lambda$1(Function0 $onValueChangeFinished, ClosedFloatingPointRange $valueRange, List it) {
            Object obj = it.get(0);
            ...
            return new RangeSliderState(fFloatValue, fFloatValue2, ((Integer) obj3).intValue(), $onValueChangeFinished, $valueRange);
        }
    }
}
