...
public final class FloatFloatPair {
    ...
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m10constructorimpl(float first, float second) {
        long v1$iv = Float.floatToRawIntBits(first);
        long v2$iv = Float.floatToRawIntBits(second);
        return m11constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }

    /* JADX INFO: renamed from: getFirst-impl, reason: not valid java name */
    public static final float m14getFirstimpl(long arg0) {
    ...
    public static final float m15getSecondimpl(long arg0) {
        int bits$iv = (int) (4294967295L & arg0);
        return Float.intBitsToFloat(bits$iv);
    }

    /* JADX INFO: renamed from: component1-impl, reason: not valid java name */
    public static final float m8component1impl(long arg0) {
        int bits$iv = (int) (arg0 >> 32);
        return Float.intBitsToFloat(bits$iv);
    }

    /* JADX INFO: renamed from: component2-impl, reason: not valid java name */
    public static final float m9component2impl(long arg0) {
        int bits$iv = (int) (4294967295L & arg0);
        return Float.intBitsToFloat(bits$iv);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m17toStringimpl(long arg0) {
