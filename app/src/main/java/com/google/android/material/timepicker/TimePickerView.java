...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public TimePickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.toggle.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() { // from class: com.google.android.material.timepicker.TimePickerView$$ExternalSyntheticLambda0
            ...
            public final void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup, int i, boolean z) {
                this.f$0.m8909x9f44237d(materialButtonToggleGroup, i, z);
            }
        });
        ...
        this.clockFace.setOnEnterKeyPressedListener(new ClockFaceView.OnEnterKeyPressedListener() { // from class: com.google.android.material.timepicker.TimePickerView$$ExternalSyntheticLambda1
    ...
    /* synthetic */ void m8909x9f44237d(MaterialButtonToggleGroup group, int checkedId, boolean isChecked) {
    ...
    /* JADX INFO: renamed from: lambda$new$1$com-google-android-material-timepicker-TimePickerView, reason: not valid java name */
    /* synthetic */ void m8910xc89878be() {
        if (this.hourView.isChecked() && this.onSelectionChangeListener != null) {
            this.onSelectionChangeListener.onSelectionChanged(12);
        }
    }
