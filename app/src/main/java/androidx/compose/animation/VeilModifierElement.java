...
final /* data */ class VeilModifierElement extends ModifierNodeElement<VeilModifierNode> {
    ...
    public VeilModifierElement(Transition<EnterExitState> transition, Transition<EnterExitState>.DeferredAnimation<Color, AnimationVector4D> deferredAnimation, EnterTransition enter, ExitTransition exit) {
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        $this$inspectableProperties.setName("veil");
        $this$inspectableProperties.getProperties().set("transition", this.transition);
        $this$inspectableProperties.getProperties().set("veilAnimation", this.veilAnimation);
