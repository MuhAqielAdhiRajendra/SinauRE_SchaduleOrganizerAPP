...
public final class FormatTextdirectionLToRKt {
    ...
    @Deprecated(message = "Use the AutoMirrored version at Icons.AutoMirrored.Rounded.FormatTextdirectionLToR", replaceWith = @ReplaceWith(expression = "Icons.AutoMirrored.Rounded.FormatTextdirectionLToR", imports = {"androidx.compose.material.icons.automirrored.rounded.FormatTextdirectionLToR"}))
    public static /* synthetic */ void getFormatTextdirectionLToR$annotations(Icons.Rounded rounded) {
    }

    public static final ImageVector getFormatTextdirectionLToR(Icons.Rounded $this$FormatTextdirectionLToR) {
        ...
        ImageVector.Builder $this$_get_FormatTextdirectionLToR__u24lambda_u241 = new ImageVector.Builder("Rounded.FormatTextdirectionLToR", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(9.17f, 2.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(7.08f, 2.0f, 5.22f, 3.53f, 5.02f, 5.61f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(4.79f, 7.99f, 6.66f, 10.0f, 9.0f, 10.0f);
