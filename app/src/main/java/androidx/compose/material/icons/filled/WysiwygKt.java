...
public final class WysiwygKt {
    ...
    public static final ImageVector getWysiwyg(Icons.Filled $this$Wysiwyg) {
        if (_wysiwyg != null) {
        ...
        ImageVector.Builder $this$_get_Wysiwyg__u24lambda_u241 = new ImageVector.Builder("Filled.Wysiwyg", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
