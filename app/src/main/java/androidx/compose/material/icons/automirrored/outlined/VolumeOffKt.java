...
public final class VolumeOffKt {
    ...
    public static final ImageVector getVolumeOff(Icons.AutoMirrored.Outlined $this$VolumeOff) {
        if (_volumeOff != null) {
        ...
        ImageVector.Builder $this$_get_VolumeOff__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Outlined.VolumeOff", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
