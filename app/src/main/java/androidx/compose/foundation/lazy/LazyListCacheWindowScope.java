...
public final class LazyListCacheWindowScope implements CacheWindowScope {
    ...
    static final Unit schedulePrefetch$lambda$0(Function2 $onItemPrefetched, LazyListPrefetchResultScope $this$schedulePrefetch) {
