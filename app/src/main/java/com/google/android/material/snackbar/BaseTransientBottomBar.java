...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
        ...
        this.bottomMarginGestureInsetRunnable = new Runnable() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.2
            ...
            public void run() {
                if (BaseTransientBottomBar.this.view != null && BaseTransientBottomBar.this.context != null) {
                    ...
                    if (currentInsetBottom >= i) {
                        baseTransientBottomBar.appliedBottomMarginGestureInset = BaseTransientBottomBar.this.extraBottomMarginGestureInset;
                        return;
                    }
    ...
    protected static class SnackbarBaseLayout extends FrameLayout {
        ...
        void removeOrRestorePaddingEnd(boolean remove) {
            setPaddingRelative(getPaddingStart(), getPaddingTop(), remove ? 0 : this.originalPaddingEnd, getPaddingBottom());
        }
