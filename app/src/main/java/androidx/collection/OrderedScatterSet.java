...
public abstract class OrderedScatterSet<E> {
    ...
    */
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated, Function1<? super E, ? extends CharSequence> transform) {
        ...
        int index = 0;
        OrderedScatterSet<E> orderedScatterSet = this;
        int $i$f$forEach = 0;
        Object[] elements$iv = orderedScatterSet.elements;
        long[] nodes$iv = orderedScatterSet.nodes;
        int candidate$iv = orderedScatterSet.tail;
        while (true) {
            ...
            long $this$previousNode$iv$iv = nodes$iv[candidate$iv];
            OrderedScatterSet<E> orderedScatterSet2 = orderedScatterSet;
            ...
            orderedScatterSet = orderedScatterSet2;
            $i$f$forEach = $i$f$forEach2;
        }
        String string = $this$joinToString_u24lambda_u2425.toString();
    ...
    public int hashCode() {
        ...
        OrderedScatterSet<E> orderedScatterSet = this;
        Object[] elements$iv = orderedScatterSet.elements;
        long[] m$iv$iv = orderedScatterSet.metadata;
        int lastIndex$iv$iv = m$iv$iv.length - 2;
        int i$iv$iv = 0;
        if (0 <= lastIndex$iv$iv) {
            while (true) {
    ...
    public boolean equals(Object other) {
        ...
        OrderedScatterSet<E> orderedScatterSet2 = this;
        Object[] elements$iv = orderedScatterSet2.elements;
        long[] m$iv$iv = orderedScatterSet2.metadata;
        int lastIndex$iv$iv = m$iv$iv.length - 2;
        int i$iv$iv = 0;
        if (0 > lastIndex$iv$iv) {
            return true;
        ...
        while (true) {
            ...
            boolean z5 = z3;
            boolean z6 = z4;
            OrderedScatterSet<E> orderedScatterSet3 = orderedScatterSet2;
            ...
            i$iv$iv++;
            orderedScatterSet2 = orderedScatterSet3;
            z3 = z5;
            z4 = z;
        }
    }
