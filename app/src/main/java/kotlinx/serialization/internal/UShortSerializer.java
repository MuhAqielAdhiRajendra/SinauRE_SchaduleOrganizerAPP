...
public final class UShortSerializer implements KSerializer<UShort> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return UShort.m9204boximpl(m10546deserializeBwKQO78(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object value) {
        m10547serializei8woANY(encoder, ((UShort) value).getData());
    }
    ...
    public void m10547serializei8woANY(Encoder encoder, short value) {
    ...
    public short m10546deserializeBwKQO78(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return UShort.m9210constructorimpl(decoder.decodeInline(getDescriptor()).decodeShort());
    }
}
