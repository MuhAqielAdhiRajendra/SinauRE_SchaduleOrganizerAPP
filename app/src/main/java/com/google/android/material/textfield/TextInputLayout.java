...
public class TextInputLayout extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public TextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int helperTextTextAppearance2 = R.styleable.TextInputLayout_hintMaxLines;
        setHintMaxLines(a.getInt(helperTextTextAppearance2, 1));
        a.recycle();
    ...
    private void updateEditTextBoxBackground() {
        ...
        this.editText.setBackground(editTextBoxBackground);
    }
    ...
    private void adjustFilledEditTextPaddingForLargeFont() {
        ...
        if (!isHintTextSingleLine()) {
            this.editText.setPaddingRelative(this.editText.getPaddingStart(), (int) (this.collapsingTextHelper.getCollapsedTextHeight() + this.extraSpaceBetweenPlaceholderAndHint), this.editText.getPaddingEnd(), getResources().getDimensionPixelSize(R.dimen.material_filled_edittext_font_1_3_padding_bottom));
        ...
        this.editText.addTextChangedListener(new TextWatcher() { // from class: com.google.android.material.textfield.TextInputLayout.1
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (currentLineCount != this.previousLineCount) {
                    if (currentLineCount < this.previousLineCount && editText.getMinimumHeight() != TextInputLayout.this.originalEditTextMinimumHeight) {
    ...
    public void setError(CharSequence errorText) {
        ...
        boolean zIsEmpty = TextUtils.isEmpty(errorText);
    ...
    private Rect calculateExpandedTextBounds(Rect rect) {
        ...
        CollapsingTextHelper collapsingTextHelper = this.collapsingTextHelper;
        if (zIsHintTextSingleLine) {
            labelHeight = collapsingTextHelper.getExpandedTextSingleLineHeight();
        } else {
            labelHeight = collapsingTextHelper.getExpandedTextFullSingleLineHeight() * this.collapsingTextHelper.getExpandedLineCount();
        }
    ...
    private void updateEditTextHeight(int availableWidth) {
            ...
            try {
                StaticLayout placeholderLayout = StaticLayoutBuilderCompat.obtain(this.placeholderText, textPaint, availableWidth).setIsRtl(getLayoutDirection() == 1).setIncludePad(true).setLineSpacing(this.placeholderTextView.getLineSpacingExtra(), this.placeholderTextView.getLineSpacingMultiplier()).setStaticLayoutBuilderConfigurer(new StaticLayoutBuilderConfigurer() { // from class: com.google.android.material.textfield.TextInputLayout$$ExternalSyntheticLambda2
                    ...
                    public final void configure(StaticLayout.Builder builder) {
                        this.f$0.m8901xd6b8ec95(builder);
                    }
                }).build();
                float extraHeight = 0.0f;
                if (this.boxBackgroundMode == 1) {
                    extraHeight = this.collapsingTextHelper.getCollapsedTextHeight() + this.boxCollapsedPaddingTopPx + this.extraSpaceBetweenPlaceholderAndHint;
                }
        ...
        if (this.editText.getMeasuredHeight() < minHeight2) {
            this.editText.setMinimumHeight(Math.round(minHeight2));
        }
    }

    /* JADX INFO: renamed from: lambda$updateEditTextHeight$2$com-google-android-material-textfield-TextInputLayout, reason: not valid java name */
    /* synthetic */ void m8901xd6b8ec95(StaticLayout.Builder builder) {
    ...
    boolean updateDummyDrawables() {
        ...
        if (shouldUpdateStartDummyDrawable()) {
            int right = Math.max(0, this.startLayout.getMeasuredWidth() - this.editText.getPaddingLeft());
            ...
            this.editText.setCompoundDrawablesRelative(null, compounds2[1], compounds2[2], compounds2[3]);
        ...
        if (shouldUpdateEndDummyDrawable()) {
            ...
            int right3 = Math.max(0, right2);
            Drawable[] compounds3 = this.editText.getCompoundDrawablesRelative();
            if (this.endDummyDrawable != null && this.endDummyDrawableWidth != right3) {
                this.endDummyDrawableWidth = right3;
    ...
    public static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            if (TextUtils.isEmpty(helperText) || !this.layout.indicatorViewController.helperTextShouldBeShown()) {
                hint = hint2;
            } else {
                hint = TextUtils.isEmpty(hint2) ? helperText.toString() : hint2 + ", " + ((Object) helperText);
            }
