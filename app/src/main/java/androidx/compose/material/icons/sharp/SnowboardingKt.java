...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_snowboarding", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Snowboarding", "Landroidx/compose/material/icons/Icons$Sharp;", "getSnowboarding", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class SnowboardingKt {
    private static ImageVector _snowboarding;

    public static final ImageVector getSnowboarding(Icons.Sharp $this$Snowboarding) {
        ...
        ImageVector.Builder $this$_get_Snowboarding__u24lambda_u241 = new ImageVector.Builder("Sharp.Snowboarding", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(21.4f, 20.09f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-1.0f, -6.19f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-3.32f, -2.67f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(1.8f, -2.89f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(15.63f, 10.78f, 17.68f, 12.0f, 20.0f, 12.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(5.5f, 9.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(8.5f, 11.7f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(1.0f, 4.3f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(22.06f, 20.6f, 21.83f, 20.18f, 21.4f, 20.09f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(8.73f, 18.93f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(3.02f, -2.03f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-0.44f, -3.32f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _snowboarding = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_Snowboarding__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
