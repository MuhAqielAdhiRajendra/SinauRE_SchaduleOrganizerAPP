...
public final class TaskKt {
    ...
    public static final ImageVector getTask(Icons.Sharp $this$Task) {
        if (_task != null) {
        ...
        ImageVector.Builder $this$_get_Task__u24lambda_u241 = new ImageVector.Builder("Sharp.Task", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
