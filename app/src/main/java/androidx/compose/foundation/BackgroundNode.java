...
final class BackgroundNode extends Modifier.Node implements DrawModifierNode, ObserverModifierNode, SemanticsModifierNode {
    ...
    public final void m288setColor8_81llA(long j) {
        this.color = j;
    }
    ...
    private final void drawRect(ContentDrawScope $this$drawRect) {
        if (!Color.m5314equalsimpl0(this.color, Color.INSTANCE.m5349getUnspecified0d7_KjU())) {
            DrawScope.m5881drawRectnJ9OG0$default($this$drawRect, this.color, 0L, 0L, 0.0f, null, null, 0, 126, null);
        }
        Brush it = this.brush;
        if (it != null) {
            DrawScope.m5880drawRectAsUm42w$default($this$drawRect, it, 0L, 0L, this.alpha, null, null, 0, 118, null);
        }
    }
    ...
    private final void drawOutline(ContentDrawScope $this$drawOutline) {
        ...
        if (!Color.m5314equalsimpl0(this.color, Color.INSTANCE.m5349getUnspecified0d7_KjU())) {
            OutlineKt.m5585drawOutlinewDX37Ww($this$drawOutline, outline, this.color, (60 & 4) != 0 ? 1.0f : 0.0f, (60 & 8) != 0 ? Fill.INSTANCE : null, (60 & 16) != 0 ? null : null, (60 & 32) != 0 ? DrawScope.INSTANCE.m5889getDefaultBlendMode0nO6VwU() : 0);
        }
        Brush it = this.brush;
        if (it != null) {
            OutlineKt.m5583drawOutlinehn5TExg($this$drawOutline, outline, it, (60 & 4) != 0 ? 1.0f : this.alpha, (60 & 8) != 0 ? Fill.INSTANCE : null, (60 & 16) != 0 ? null : null, (60 & 32) != 0 ? DrawScope.INSTANCE.m5889getDefaultBlendMode0nO6VwU() : 0);
        }
    }

    private final Outline getOutline(final ContentDrawScope $this$getOutline) {
        Outline outline;
        if (Size.m5133equalsimpl0($this$getOutline.mo5887getSizeNHjbRc(), this.lastSize) && $this$getOutline.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.areEqual(this.lastShape, this.shape)) {
            ...
            ObserverModifierNodeKt.observeReads(this, new Function0() { // from class: androidx.compose.foundation.BackgroundNode$$ExternalSyntheticLambda0
                ...
                public final Object invoke() {
                    return BackgroundNode.getOutline$lambda$0(this.f$0, $this$getOutline);
                }
            });
        ...
        this.lastSize = $this$getOutline.mo5887getSizeNHjbRc();
    ...
    static final Unit getOutline$lambda$0(BackgroundNode this$0, ContentDrawScope $this_getOutline) {
        this$0.tmpOutline = this$0.shape.mo342createOutlinePq9zytI($this_getOutline.mo5887getSizeNHjbRc(), $this_getOutline.getLayoutDirection(), $this_getOutline);
