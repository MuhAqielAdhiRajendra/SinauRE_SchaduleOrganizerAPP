...
public final class InputKt {
    ...
    public static final ImageVector getInput(Icons.Sharp $this$Input) {
        if (_input != null) {
        ...
        ImageVector.Builder $this$_get_Input__u24lambda_u241 = new ImageVector.Builder("Sharp.Input", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
