...
public final class ImagesearchRollerKt {
    ...
    public static final ImageVector getImagesearchRoller(Icons.Rounded $this$ImagesearchRoller) {
        ...
        ImageVector.Builder $this$_get_ImagesearchRoller__u24lambda_u241 = new ImageVector.Builder("Rounded.ImagesearchRoller", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(6.45f, 8.0f, 6.0f, 7.55f, 6.0f, 7.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(19.55f, 2.0f, 20.0f, 2.45f, 20.0f, 3.0f);
