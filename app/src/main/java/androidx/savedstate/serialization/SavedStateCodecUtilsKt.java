...
public final class SavedStateCodecUtilsKt {
    ...
    static {
        KSerializer elementSerializer$iv = BuiltinSerializersKt.ArraySerializer(Reflection.getOrCreateKotlinClass(String.class), BuiltinSerializersKt.serializer(StringCompanionObject.INSTANCE));
        stringArrayDescriptor = elementSerializer$iv.getDescriptor();
    }
