...
public final class LoadingIndicatorTokens {
    ...
    private static final float ActiveSize = Dp.m8150constructorimpl((float) 38.0d);
    ...
    private static final float ContainerWidth = Dp.m8150constructorimpl((float) 48.0d);
