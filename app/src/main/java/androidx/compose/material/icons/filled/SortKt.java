...
public final class SortKt {
    ...
    public static final ImageVector getSort(Icons.Filled $this$Sort) {
        if (_sort != null) {
        ...
        ImageVector.Builder $this$_get_Sort__u24lambda_u241 = new ImageVector.Builder("Filled.Sort", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
