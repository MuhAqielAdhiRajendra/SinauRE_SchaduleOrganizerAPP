...
public final class TextIndent {
    ...
    /* JADX INFO: compiled from: TextIndent.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u001c\u0010\u0004\u001a\u00020\u00058\u0006X\u0087\u0004¢\u0006\u000e\n\u0000\u0012\u0004\b\u0006\u0010\u0003\u001a\u0004\b\u0007\u0010\b¨\u0006\t"}, d2 = {"Landroidx/compose/ui/text/style/TextIndent$Companion;", "", "<init>", "()V", "None", "Landroidx/compose/ui/text/style/TextIndent;", "getNone$annotations", "getNone", "()Landroidx/compose/ui/text/style/TextIndent;", "ui-text"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    public static /* synthetic */ TextIndent m8031copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textIndent.m8032copyNB67dxo(j, j2);
    }

    /* JADX INFO: renamed from: copy-NB67dxo, reason: not valid java name */
    public final TextIndent m8032copyNB67dxo(long firstLine, long restLine) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TextIndent) && TextUnit.m8341equalsimpl0(this.firstLine, ((TextIndent) other).firstLine) && TextUnit.m8341equalsimpl0(this.restLine, ((TextIndent) other).restLine);
    }

    public int hashCode() {
        int result = TextUnit.m8345hashCodeimpl(this.firstLine);
        return (result * 31) + TextUnit.m8345hashCodeimpl(this.restLine);
    }

    public String toString() {
        return "TextIndent(firstLine=" + ((Object) TextUnit.m8351toStringimpl(this.firstLine)) + ", restLine=" + ((Object) TextUnit.m8351toStringimpl(this.restLine)) + ')';
    }
}
