...
public final class FileOpenKt {
    ...
    public static final ImageVector getFileOpen(Icons.Rounded $this$FileOpen) {
        if (_fileOpen != null) {
        ...
        ImageVector.Builder $this$_get_FileOpen__u24lambda_u241 = new ImageVector.Builder("Rounded.FileOpen", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(22.66f, 17.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(19.0f, 19.41f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(0.0f, 1.24f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(22.21f, 16.0f, 22.66f, 16.45f, 22.66f, 17.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _fileOpen = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_FileOpen__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
