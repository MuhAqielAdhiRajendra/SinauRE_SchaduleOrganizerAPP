...
public final class BringIntoViewResponderNode extends Modifier.Node implements BringIntoViewModifierNode, LayoutAwareModifierNode {
    ...
    public static final Rect bringIntoView$localRect(BringIntoViewResponderNode this$0, LayoutCoordinates $childCoordinates, Function0<Rect> function0) {
        ...
        return BringIntoViewRequesterKt__BringIntoViewResponderKt.localRectOf$BringIntoViewRequesterKt__BringIntoViewResponderKt(layoutCoordinates, childCoordinates, rect);
    }

    static final Rect bringIntoView$lambda$1(BringIntoViewResponderNode this$0, LayoutCoordinates $childCoordinates, Function0 $boundsProvider) {
    ...
    public Object bringIntoView(final LayoutCoordinates childCoordinates, final Function0<Rect> function0, Continuation<? super Unit> continuation) {
        Function0 parentRect = new Function0() { // from class: androidx.compose.foundation.relocation.BringIntoViewResponderNode$$ExternalSyntheticLambda0
            ...
            public final Object invoke() {
                return BringIntoViewResponderNode.bringIntoView$lambda$1(this.f$0, childCoordinates, function0);
            }
        };
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new AnonymousClass2(childCoordinates, function0, parentRect, null), continuation);
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    BuildersKt__Builders_commonKt.launch$default($this$coroutineScope, null, null, new AnonymousClass1(BringIntoViewResponderNode.this, this.$childCoordinates, this.$boundsProvider, null), 3, null);
                    return BuildersKt__Builders_commonKt.launch$default($this$coroutineScope, null, null, new C00242(BringIntoViewResponderNode.this, this.$parentRect, null), 3, null);
                default:
        ...
        @DebugMetadata(c = "androidx.compose.foundation.relocation.BringIntoViewResponderNode$bringIntoView$2$1", f = "BringIntoViewResponder.kt", i = {}, l = {183}, m = "invokeSuspend", n = {}, s = {}, v = 1)
        static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object $result) {
                ...
                switch (this.label) {
                    case 0:
                        ...
                        this.label = 1;
                        if (this.this$0.getResponder().bringChildIntoView(new C00231(this.this$0, this.$childCoordinates, this.$boundsProvider), this) == coroutine_suspended) {
            ...
            static final /* synthetic */ class C00231 extends FunctionReferenceImpl implements Function0<Rect> {
                final /* synthetic */ Function0<Rect> $boundsProvider;
                final /* synthetic */ LayoutCoordinates $childCoordinates;
                final /* synthetic */ BringIntoViewResponderNode this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C00231(BringIntoViewResponderNode bringIntoViewResponderNode, LayoutCoordinates layoutCoordinates, Function0<Rect> function0) {
        ...
        static final class C00242 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00242(BringIntoViewResponderNode bringIntoViewResponderNode, Function0<Rect> function0, Continuation<? super C00242> continuation) {
                super(2, continuation);
                this.this$0 = bringIntoViewResponderNode;
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C00242(this.this$0, this.$parentRect, continuation);
            }
