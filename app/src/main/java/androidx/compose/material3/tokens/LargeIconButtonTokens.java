...
public final class LargeIconButtonTokens {
    ...
    private static final float IconSize = Dp.m8150constructorimpl((float) 32.0d);
    private static final float NarrowLeadingSpace = Dp.m8150constructorimpl((float) 16.0d);
    private static final float NarrowTrailingSpace = Dp.m8150constructorimpl((float) 16.0d);
    private static final float OutlinedOutlineWidth = Dp.m8150constructorimpl((float) 2.0d);
    ...
    private static final float UniformLeadingSpace = Dp.m8150constructorimpl((float) 32.0d);
    private static final float UniformTrailingSpace = Dp.m8150constructorimpl((float) 32.0d);
    private static final float WideLeadingSpace = Dp.m8150constructorimpl((float) 48.0d);
    private static final float WideTrailingSpace = Dp.m8150constructorimpl((float) 48.0d);

    private LargeIconButtonTokens() {
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m3929getContainerHeightD9Ej5fM() {
