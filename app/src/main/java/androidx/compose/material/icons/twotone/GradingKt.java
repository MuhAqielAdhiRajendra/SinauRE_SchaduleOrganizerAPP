...
public final class GradingKt {
    ...
    public static final ImageVector getGrading(Icons.TwoTone $this$Grading) {
        if (_grading != null) {
        ...
        ImageVector.Builder $this$_get_Grading__u24lambda_u241 = new ImageVector.Builder("TwoTone.Grading", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
