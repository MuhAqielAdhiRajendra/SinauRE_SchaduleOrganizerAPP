...
public final class RoomSQLiteQuery implements SupportSQLiteQuery, SupportSQLiteProgram {
    ...
    static final Unit toRoomRawQuery$lambda$1(RoomSQLiteQuery this$0, SQLiteStatement it) {
    ...
    public final void bindTo(SQLiteStatement statement) {
        ...
        while (true) {
            switch (this.bindingTypes[index]) {
                case 1:
                    statement.mo8516bindNull(index);
                    break;
                case 2:
                    statement.mo8515bindLong(index, this.longBindings[index]);
                    break;
                case 3:
                    statement.mo8514bindDouble(index, this.doubleBindings[index]);
                    break;
                case 4:
                    String str = this.stringBindings[index];
                    if (str == null) {
                    ...
                    statement.mo8517bindText(index, str);
                    break;
                    break;
                case 5:
                    byte[] bArr = this.blobBindings[index];
                    ...
                    statement.mo8513bindBlob(index, bArr);
                    break;
                    break;
            }
            if (index == argCount) {
