...
public final class KeyboardArrowRightKt {
    ...
    public static final ImageVector getKeyboardArrowRight(Icons.AutoMirrored.Sharp $this$KeyboardArrowRight) {
        ...
        ImageVector.Builder $this$_get_KeyboardArrowRight__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Sharp.KeyboardArrowRight", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
