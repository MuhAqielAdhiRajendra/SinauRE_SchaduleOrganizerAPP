...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver, RippleHostKey {
    ...
    private AndroidRippleIndicationInstance(boolean bounded, float radius, State<Color> state, State<RippleAlpha> state2, ViewGroup view) {
        ...
        this.rippleSize = Size.INSTANCE.m5146getZeroNHjbRc();
        this.rippleRadius = -1;
    ...
    static final Unit onInvalidateRipple$lambda$0(AndroidRippleIndicationInstance this$0) {
    ...
    public void drawIndication(ContentDrawScope $this$drawIndication) {
        int iRoundToInt;
        this.rippleSize = $this$drawIndication.mo5887getSizeNHjbRc();
        float $this$isUnspecified$iv = this.radius;
        if (Float.isNaN($this$isUnspecified$iv)) {
            iRoundToInt = MathKt.roundToInt(RippleAnimationKt.m2127getRippleEndRadiuscSwnlzA($this$drawIndication, this.bounded, $this$drawIndication.mo5887getSizeNHjbRc()));
        } else {
            iRoundToInt = $this$drawIndication.mo426roundToPx0680j_4(this.radius);
        }
        ...
        getInvalidateTick();
        RippleHostView $this$drawIndication_u24lambda_u240_u240 = getRippleHostView();
        if ($this$drawIndication_u24lambda_u240_u240 != null) {
            $this$drawIndication_u24lambda_u240_u240.m2130setRipplePropertiesbiQXAtU($this$drawIndication.mo5887getSizeNHjbRc(), this.rippleRadius, color, alpha);
            $this$drawIndication_u24lambda_u240_u240.draw(AndroidCanvas_androidKt.getNativeCanvas(canvas));
        }
    }

    @Override // androidx.compose.material.ripple.RippleIndicationInstance
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        RippleContainer $this$addRipple_u24lambda_u240 = getOrCreateRippleContainer();
        RippleHostView $this$addRipple_u24lambda_u240_u240 = $this$addRipple_u24lambda_u240.getRippleHostView(this);
        $this$addRipple_u24lambda_u240_u240.m2129addRippleKOepWvA(interaction, this.bounded, this.rippleSize, this.rippleRadius, this.color.getValue().m5323unboximpl(), this.rippleAlpha.getValue().getPressedAlpha(), this.onInvalidateRipple);
        setRippleHostView($this$addRipple_u24lambda_u240_u240);
    }
    ...
    private final void dispose() {
        RippleContainer $this$dispose_u24lambda_u240 = this.rippleContainer;
        if ($this$dispose_u24lambda_u240 != null) {
            $this$dispose_u24lambda_u240.disposeRippleIfNeeded(this);
        }
    }
    ...
    private final RippleContainer getOrCreateRippleContainer() {
        ...
        this.rippleContainer = Ripple_androidKt.createAndAttachRippleContainerIfNeeded(this.view);
