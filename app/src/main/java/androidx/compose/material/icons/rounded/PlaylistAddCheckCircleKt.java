...
public final class PlaylistAddCheckCircleKt {
    ...
    public static final ImageVector getPlaylistAddCheckCircle(Icons.Rounded $this$PlaylistAddCheckCircle) {
        ...
        ImageVector.Builder $this$_get_PlaylistAddCheckCircle__u24lambda_u241 = new ImageVector.Builder("Rounded.PlaylistAddCheckCircle", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(18.29f, 14.12f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.39f, -0.39f, 1.02f, -0.39f, 1.41f, 0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(18.68f, 13.1f, 18.68f, 13.73f, 18.29f, 14.12f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
