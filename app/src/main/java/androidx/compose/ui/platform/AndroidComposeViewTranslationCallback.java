...
final class AndroidComposeViewTranslationCallback implements ViewTranslationCallback {
    ...
    public boolean onShowTranslation(View view) {
        ...
        androidComposeView.getContentCaptureManager().onShowTranslation$ui();
        return true;
    }
    ...
    public boolean onHideTranslation(View view) {
        Intrinsics.checkNotNull(view, "null cannot be cast to non-null type androidx.compose.ui.platform.AndroidComposeView");
        AndroidComposeView androidComposeView = (AndroidComposeView) view;
        androidComposeView.getContentCaptureManager().onHideTranslation$ui();
        return true;
    }
    ...
    public boolean onClearTranslation(View view) {
        Intrinsics.checkNotNull(view, "null cannot be cast to non-null type androidx.compose.ui.platform.AndroidComposeView");
        AndroidComposeView androidComposeView = (AndroidComposeView) view;
        androidComposeView.getContentCaptureManager().onClearTranslation$ui();
        return true;
    }
}
