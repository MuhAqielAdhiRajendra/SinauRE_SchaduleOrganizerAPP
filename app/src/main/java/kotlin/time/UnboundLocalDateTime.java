...
final class UnboundLocalDateTime {
    ...
    public final <T> T toInstant(int offsetSeconds, Function2<? super Long, ? super Integer, ? extends T> buildInstant) {
        ...
        long total3 = total + ((long) ((($this$toInstant_u24lambda_u240.getMonth() * 367) - 362) / 12)) + ((long) ($this$toInstant_u24lambda_u240.getDay() - 1));
        ...
        long epochSeconds = ((86400 * epochDays) + ((long) daySeconds)) - ((long) offsetSeconds);
