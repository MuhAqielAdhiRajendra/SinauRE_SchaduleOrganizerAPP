    ...
    public PinnedScrollBehavior(TopAppBarState state, Function0<Boolean> function0) {
        ...
        this.nestedScrollConnection = new NestedScrollConnection() { // from class: androidx.compose.material3.PinnedScrollBehavior$nestedScrollConnection$1
            ...
            public Object mo600onPostFlingRZ2iAVY(long consumed, long available, Continuation<? super Velocity> continuation) {
                if (Velocity.m8389getYimpl(available) > 0.0f) {
                    this.this$0.getState().setContentOffset(0.0f);
                }
                return super.mo600onPostFlingRZ2iAVY(consumed, available, continuation);
            }
        };
    }
