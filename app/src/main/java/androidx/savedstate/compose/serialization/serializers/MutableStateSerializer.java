...
public final class MutableStateSerializer<T> implements KSerializer<MutableState<T>> {
    ...
    public MutableStateSerializer(KSerializer<T> valueSerializer) {
        Intrinsics.checkNotNullParameter(valueSerializer, "valueSerializer");
        this.valueSerializer = valueSerializer;
        MutableStateSerializer<T> mutableStateSerializer = this;
        SerialKind kind = mutableStateSerializer.valueSerializer.getDescriptor().getKind();
        this.descriptor = kind instanceof PrimitiveKind ? SerialDescriptorsKt.PrimitiveSerialDescriptor("androidx.compose.runtime.MutableState", (PrimitiveKind) kind) : SerialDescriptorsKt.SerialDescriptor("androidx.compose.runtime.MutableState", mutableStateSerializer.valueSerializer.getDescriptor());
    }
    ...
    public MutableState<T> deserialize(Decoder decoder) {
