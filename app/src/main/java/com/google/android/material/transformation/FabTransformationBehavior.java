...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private void createDependencyTranslationAnimation(View dependency, View child, boolean expanded, FabTransformationSpec spec, List<Animator> animations) {
        ...
        ValueAnimator translationXAnimator = ObjectAnimator.ofFloat(dependency, (Property<View, Float>) View.TRANSLATION_X, expanded ? translationX : this.dependencyOriginalTranslationX);
        ValueAnimator translationYAnimator = ObjectAnimator.ofFloat(dependency, (Property<View, Float>) View.TRANSLATION_Y, expanded ? translationY : this.dependencyOriginalTranslationY);
    ...
    private void createExpansionAnimation(View dependency, View view, boolean expanded, boolean currentlyAnimating, FabTransformationSpec spec, float childWidth, float childHeight, List<Animator> animations, List<Animator.AnimatorListener> listeners) {
        ...
        ((FloatingActionButton) dependency).getMeasuredContentRect(this.tmpRect);
        ...
        if (expanded) {
            ...
            Animator animator2 = CircularRevealCompat.createCircularReveal(circularRevealChild, revealCenterX, revealCenterY, toRadius);
            ...
            Animator animator3 = CircularRevealCompat.createCircularReveal(circularRevealChild, revealCenterX, revealCenterY, dependencyRadius);
            createPreFillRadialExpansion(view, timing2.getDelay(), (int) revealCenterX, (int) revealCenterY, fromRadius2, animations);
            timing = timing2;
            createPostFillRadialExpansion(view, timing2.getDelay(), timing2.getDuration(), spec.timings.getTotalDuration(), (int) revealCenterX, (int) revealCenterY, dependencyRadius, animations);
            animator = animator3;
        }
        timing.apply(animator);
        animations.add(animator);
