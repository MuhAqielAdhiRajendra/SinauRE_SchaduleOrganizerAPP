...
public final class HdrEnhancedSelectKt {
    ...
    public static final ImageVector getHdrEnhancedSelect(Icons.Outlined $this$HdrEnhancedSelect) {
        ...
        ImageVector.Builder $this$_get_HdrEnhancedSelect__u24lambda_u241 = new ImageVector.Builder("Outlined.HdrEnhancedSelect", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(8.69f, 2.0f, 12.0f, 2.0f);
