...
public final class PersistentOrderedSetBuilder<E> extends AbstractMutableSet<E> implements PersistentSet.Builder<E> {
    ...
    public PersistentOrderedSetBuilder(PersistentOrderedSet<E> persistentOrderedSet) {
        ...
        this.firstElement = this.set.getFirstElement();
    ...
    public PersistentSet<E> build() {
        ...
        if (persistentHashMapBuild2 == this.set.getHashMap$runtime()) {
            CommonFunctionsKt.m4649assert(this.firstElement == this.set.getFirstElement());
            CommonFunctionsKt.m4649assert(this.lastElement == this.set.getLastElement());
