...
public final class AppBarDslKt {
    public static final AppBarOverflowState rememberAppBarOverflowState(Composer $composer, int $changed) {
        ...
        AppBarOverflowStateImpl appBarOverflowStateImpl = (AppBarOverflowStateImpl) RememberSaveableKt.m4704rememberSaveable(objArr, (Saver) saver, (Function0) it$iv, $composer, 384);
        if (ComposerKt.isTraceInProgress()) {
