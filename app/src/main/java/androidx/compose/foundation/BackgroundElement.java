...
final class BackgroundElement extends ModifierNodeElement<BackgroundNode> {
    ...
    public /* synthetic */ BackgroundElement(long j, Brush brush, float f, Shape shape, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        long jM5349getUnspecified0d7_KjU;
        Brush brush2;
        if ((i & 1) == 0) {
            jM5349getUnspecified0d7_KjU = j;
        } else {
            jM5349getUnspecified0d7_KjU = Color.INSTANCE.m5349getUnspecified0d7_KjU();
        }
        if ((i & 2) == 0) {
            brush2 = brush;
        } else {
        ...
        this(jM5349getUnspecified0d7_KjU, brush2, f, shape, function1, null);
    }
    ...
    public void update(BackgroundNode node) {
        node.m288setColor8_81llA(this.color);
    ...
    public boolean equals(Object other) {
        ...
        if (otherModifier != null && Color.m5314equalsimpl0(this.color, otherModifier.color) && Intrinsics.areEqual(this.brush, otherModifier.brush)) {
