...
final class ModalBottomSheetDialogLayout extends AbstractComposeView implements DialogWindowProvider {
    ...
    public ModalBottomSheetDialogLayout(Context context, Window window) {
        ...
        this.window = window;
        this.content = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$ModalBottomSheet_androidKt.INSTANCE.m2386getLambda$91331245$material3(), null, 2, null);
    }
    ...
    public void Content(Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(Content)438@18981L9:ModalBottomSheet.android.kt#uh7d8r");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if (!$composer2.shouldExecute(($dirty & 3) != 2, $dirty & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(576708319, $dirty, -1, "androidx.compose.material3.ModalBottomSheetDialogLayout.Content (ModalBottomSheet.android.kt:437)");
            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material3.ModalBottomSheetDialogLayout$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj, Object obj2) {
                    return ModalBottomSheetDialogLayout.Content$lambda$0(this.f$0, $changed, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
