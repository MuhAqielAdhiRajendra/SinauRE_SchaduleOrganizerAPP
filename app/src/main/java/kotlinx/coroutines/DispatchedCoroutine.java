...
public final class DispatchedCoroutine<T> extends ScopeCoroutine<T> {
    ...
    private final boolean trySuspend() {
        /*
            r7 = this;
            java.util.concurrent.atomic.AtomicIntegerFieldUpdater r0 = get_decision$volatile$FU()
            r1 = r7
        L5:
            int r2 = r0.get(r7)
            r3 = 0
        ...
        L1a:
            return r4
        L1b:
            java.util.concurrent.atomic.AtomicIntegerFieldUpdater r5 = get_decision$volatile$FU()
            r6 = 1
