...
public final class BedtimeOffKt {
    ...
    public static final ImageVector getBedtimeOff(Icons.Filled $this$BedtimeOff) {
        if (_bedtimeOff != null) {
        ...
        ImageVector.Builder $this$_get_BedtimeOff__u24lambda_u242 = new ImageVector.Builder("Filled.BedtimeOff", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
