...
public final class EllipticCurvesUtil {
    ...
    static JacobianEcPoint addJacobianPoints(JacobianEcPoint p1, JacobianEcPoint p2, BigInteger a, BigInteger modulus) {
        ...
        BigInteger bigIntegerMod = p1.y.multiply(p2.z).mod(modulus).multiply(z2z2).mod(modulus);
        BigInteger bigIntegerMod2 = p2.y.multiply(p1.z).mod(modulus).multiply(z1z1).mod(modulus);
        if (u1.equals(u2)) {
            if (bigIntegerMod.equals(bigIntegerMod2)) {
        ...
        BigInteger r = bigIntegerMod2.subtract(bigIntegerMod).multiply(TWO).mod(modulus);
        ...
        BigInteger y3 = r.multiply(v.subtract(x3)).subtract(bigIntegerMod.multiply(TWO).multiply(j)).mod(modulus);
