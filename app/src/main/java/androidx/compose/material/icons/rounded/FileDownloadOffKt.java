...
public final class FileDownloadOffKt {
    ...
    public static final ImageVector getFileDownloadOff(Icons.Rounded $this$FileDownloadOff) {
        ...
        ImageVector.Builder $this$_get_FileDownloadOff__u24lambda_u241 = new ImageVector.Builder("Rounded.FileDownloadOff", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.26f, 0.37f, -0.28f, 0.91f, 0.1f, 1.28f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(4.59f, 4.59f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.35f, 0.35f, 0.88f, 0.37f, 1.27f, 0.09f);
