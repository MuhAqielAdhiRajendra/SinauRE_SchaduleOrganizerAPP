...
public interface ParametrizedSerializerCache<T> {
    ...
    Object mo10511getgIAlus(KClass<Object> key, List<? extends KType> types);
    ...
    public static final class DefaultImpls {
        ...
        public static /* synthetic */ Object m10515getgIAlus$default(ParametrizedSerializerCache parametrizedSerializerCache, KClass kClass, List list, int i, Object obj) {
            if (obj != null) {
            ...
            return parametrizedSerializerCache.mo10511getgIAlus(kClass, list);
        }
    }
}
