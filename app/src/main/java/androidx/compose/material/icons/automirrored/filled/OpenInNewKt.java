...
public final class OpenInNewKt {
    ...
    public static final ImageVector getOpenInNew(Icons.AutoMirrored.Filled $this$OpenInNew) {
        if (_openInNew != null) {
        ...
        ImageVector.Builder $this$_get_OpenInNew__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Filled.OpenInNew", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
