...
public final class ClockDialNode extends DelegatingNode implements PointerInputModifierNode, CompositionLocalConsumerModifierNode, LayoutAwareModifierNode {
    ...
    private ClockDialNode(AnalogTimePickerState state, boolean autoSwitchToMinute, int selection, AnimationSpec<Float> animationSpec) {
        ...
        this.center = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m8269boximpl(IntOffset.INSTANCE.m8289getZeronOccac()), null, 2, null);
    ...
    public final long m2286getCenternOccac() {
    ...
    private final void m2287setCentergyyYBs(long j) {
    ...
    public final float getMaxDist() {
        ...
        return ($this$_get_maxDist__u24lambda_u240.mo432toPx0680j_4(TimePickerKt.MaxDistance) * $this$_get_maxDist__u24lambda_u240.mo426roundToPx0680j_4(this.state.m2146getCurrentDiameterD9Ej5fM())) / $this$_get_maxDist__u24lambda_u240.mo426roundToPx0680j_4(TimePickerTokens.INSTANCE.m4257getClockDialContainerSizeD9Ej5fM());
    }
    ...
    public void mo421onRemeasuredozmzZPI(long size) {
        m2287setCentergyyYBs(IntSizeKt.m8327getCenterozmzZPI(size));
        ...
        analogTimePickerState.m2148setCurrentDiameter0680j_4($this$onRemeasured_ozmzZPI_u24lambda_u241.mo429toDpu2uoSUM((int) (size >> 32)));
    }

    @Override // androidx.compose.ui.node.PointerInputModifierNode
    /* JADX INFO: renamed from: onPointerEvent-H0pRuoY */
    public void mo255onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        this.pointerInputTapNode.mo255onPointerEventH0pRuoY(pointerEvent, pass, bounds);
        this.pointerInputDragNode.mo255onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public final void m2288updateNodeJwYzU44(AnalogTimePickerState state, boolean autoSwitchToMinute, int selection, AnimationSpec<Float> animationSpec) {
        this.state = state;
        this.autoSwitchToMinute = autoSwitchToMinute;
        this.animationSpec = animationSpec;
        if (!TimePickerSelectionMode.m3223equalsimpl0(this.selection, selection)) {
            this.selection = selection;
