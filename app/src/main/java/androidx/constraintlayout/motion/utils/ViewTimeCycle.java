...
public abstract class ViewTimeCycle extends TimeCycleSplineSet {
    ...
    public float get(float pos, long time, View view, KeyCache cache) {
        ...
        if (Float.isNaN(this.mLastCycle)) {
            this.mLastCycle = cache.getFloatValue(view, this.mType, 0);
            if (Float.isNaN(this.mLastCycle)) {
        ...
        cache.setFloatValue(view, this.mType, 0, this.mLastCycle);
        this.mLastTime = time;
    ...
    */
    ...
    static class ProgressSet extends ViewTimeCycle {
        ...
        @Override // androidx.constraintlayout.motion.utils.ViewTimeCycle
        public boolean setProperty(View view, float t, long time, KeyCache cache) throws NoSuchMethodException {
