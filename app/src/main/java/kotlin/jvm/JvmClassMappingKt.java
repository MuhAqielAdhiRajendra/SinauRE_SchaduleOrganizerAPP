        ...
        if (name != null) {
            switch (name.hashCode()) {
                ...
                case 3625364:
                    ...
                    break;
                case 64711720:
                    cls = !name.equals(TypedValues.Custom.S_BOOLEAN) ? thisJClass : Boolean.class;
                    break;
                case 97526364:
                    cls = !name.equals(TypedValues.Custom.S_FLOAT) ? thisJClass : Float.class;
                    break;
                case 109413500:
