...
@DebugMetadata(c = "androidx.compose.material3.SelectableChipElevation$animateElevation$2$1", f = "Chip.kt", i = {}, l = {2562, 2564}, m = "invokeSuspend", n = {}, s = {})
            ...
            case 0:
                ...
                if (!Dp.m8155equalsimpl0(this.$animatable.getTargetValue().m8164unboximpl(), this.$target)) {
                    if (this.$enabled) {
                        ...
                        this.label = 2;
                        if (ElevationKt.m3448animateElevationrAjV9yQ(this.$animatable, this.$target, interactionAnimateElevation$lambda$2, this.$interaction, this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } else {
                        this.label = 1;
                        if (this.$animatable.snapTo(Dp.m8148boximpl(this.$target), this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    }
