...
public class TabLayout extends HorizontalScrollView {
    ...
    public final class TabView extends LinearLayout {
        ...
        public void updateBackgroundDrawable(Context context) {
            ...
            if (TabLayout.this.tabRippleColorStateList != null) {
                ...
                if (TabLayout.this.unboundedRipple) {
                    drawableWrap = FocusRingDrawable.wrap(context, new RippleDrawable(colorStateListConvertToRippleDrawableColor, null, null));
                } else {
                    RippleDrawable rippleDrawable = new RippleDrawable(colorStateListConvertToRippleDrawableColor, gradientDrawable, gradientDrawable2);
                    FocusRingDrawable.layer(context, rippleDrawable);
                    drawableWrap = rippleDrawable;
                }
            } else {
                drawableWrap = gradientDrawable;
            }
        ...
        public void tryUpdateBadgeDrawableBounds(View anchor) {
            if (hasBadgeDrawable() && anchor == this.badgeAnchorView) {
                BadgeUtils.setBadgeDrawableBounds(this.badgeDrawable, anchor, null);
            }
        }
    ...
    class SlidingTabIndicator extends LinearLayout {
        ...
        public void tweenIndicatorPosition(View startTitle, View endTitle, float fraction) {
            ...
            if (hasVisibleTitle) {
                tabLayout.tabIndicatorInterpolator.updateIndicatorForOffset(TabLayout.this, startTitle, endTitle, fraction, TabLayout.this.tabSelectedIndicator);
            } else {
                tabLayout.tabSelectedIndicator.setBounds(-1, TabLayout.this.tabSelectedIndicator.getBounds().top, -1, TabLayout.this.tabSelectedIndicator.getBounds().bottom);
            }
