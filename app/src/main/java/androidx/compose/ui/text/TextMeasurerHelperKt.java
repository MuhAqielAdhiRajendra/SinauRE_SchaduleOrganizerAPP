...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\u001a\u0017\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u0001H\u0007¢\u0006\u0002\u0010\u0005\"\u000e\u0010\u0000\u001a\u00020\u0001X\u0082D¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"DefaultCacheSize", "", "rememberTextMeasurer", "Landroidx/compose/ui/text/TextMeasurer;", "cacheSize", "(ILandroidx/compose/runtime/Composer;II)Landroidx/compose/ui/text/TextMeasurer;", "ui"}, k = 2, mv = {2, 1, 0}, xi = 48)
public final class TextMeasurerHelperKt {
    ...
    public static final TextMeasurer rememberTextMeasurer(int cacheSize, Composer $composer, int $changed, int i) {
        ComposerKt.sourceInformationMarkerStart($composer, 1538166871, "C(rememberTextMeasurer)N(cacheSize)42@1995L7,43@2034L7,44@2089L7,46@2109L151:TextMeasurerHelper.kt#ruzxt2");
        boolean z = true;
        if ((i & 1) != 0) {
        ...
        FontFamily.Resolver fontFamilyResolver = (FontFamily.Resolver) objConsume;
        ...
        boolean zChanged = $composer.changed(fontFamilyResolver) | $composer.changed(density) | $composer.changed(layoutDirection.ordinal());
