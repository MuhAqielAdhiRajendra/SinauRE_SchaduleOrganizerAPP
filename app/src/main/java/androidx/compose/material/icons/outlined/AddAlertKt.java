...
public final class AddAlertKt {
    ...
    public static final ImageVector getAddAlert(Icons.Outlined $this$AddAlert) {
        if (_addAlert != null) {
        ...
        ImageVector.Builder $this$_get_AddAlert__u24lambda_u241 = new ImageVector.Builder("Outlined.AddAlert", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
