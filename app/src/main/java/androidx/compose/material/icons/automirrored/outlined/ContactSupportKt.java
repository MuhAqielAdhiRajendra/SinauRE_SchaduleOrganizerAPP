...
public final class ContactSupportKt {
    ...
    public static final ImageVector getContactSupport(Icons.AutoMirrored.Outlined $this$ContactSupport) {
        ...
        ImageVector.Builder $this$_get_ContactSupport__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Outlined.ContactSupport", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(11.0f, 23.59f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(-3.6f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-5.01f, -0.26f, -9.0f, -4.42f, -9.0f, -9.49f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(2.0f, 5.26f, 6.26f, 1.0f, 11.5f, 1.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(21.0f, 5.26f, 21.0f, 10.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, 4.95f, -3.44f, 9.93f, -8.57f, 12.4f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-1.43f, 0.69f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(10.5f, 14.5f);
