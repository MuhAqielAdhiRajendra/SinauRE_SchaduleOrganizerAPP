...
public final class SemanticsActions {
    ...
    private static final SemanticsPropertyKey<AccessibilityAction<Function1<FillableData, Boolean>>> OnFillData;
    ...
    static {
        Function2 mergePolicy$iv$iv = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        GetTextLayoutResult = new SemanticsPropertyKey<>("GetTextLayoutResult", true, mergePolicy$iv$iv, null, 8, null);
        Function2 mergePolicy$iv$iv2 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        OnClick = new SemanticsPropertyKey<>("OnClick", true, mergePolicy$iv$iv2, null, 8, null);
        Function2 mergePolicy$iv$iv3 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        OnLongClick = new SemanticsPropertyKey<>("OnLongClick", true, mergePolicy$iv$iv3, null, 8, null);
        Function2 mergePolicy$iv$iv4 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        ...
        Function2 mergePolicy$iv$iv5 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        ScrollToIndex = new SemanticsPropertyKey<>("ScrollToIndex", true, mergePolicy$iv$iv5, null, 8, null);
        Function2 mergePolicy$iv$iv6 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        OnAutofillText = new SemanticsPropertyKey<>("OnAutofillText", true, mergePolicy$iv$iv6, null, 8, null);
        Function2 mergePolicy$iv$iv7 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        OnFillData = new SemanticsPropertyKey<>("OnFillData", true, mergePolicy$iv$iv7, null, 8, null);
        Function2 mergePolicy$iv$iv8 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        SetProgress = new SemanticsPropertyKey<>("SetProgress", true, mergePolicy$iv$iv8, null, 8, null);
        Function2 mergePolicy$iv$iv9 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        SetSelection = new SemanticsPropertyKey<>("SetSelection", true, mergePolicy$iv$iv9, null, 8, null);
        Function2 mergePolicy$iv$iv10 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        SetText = new SemanticsPropertyKey<>("SetText", true, mergePolicy$iv$iv10, null, 8, null);
        Function2 mergePolicy$iv$iv11 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        SetTextSubstitution = new SemanticsPropertyKey<>("SetTextSubstitution", true, mergePolicy$iv$iv11, null, 8, null);
        Function2 mergePolicy$iv$iv12 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        ShowTextSubstitution = new SemanticsPropertyKey<>("ShowTextSubstitution", true, mergePolicy$iv$iv12, null, 8, null);
        Function2 mergePolicy$iv$iv13 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        ClearTextSubstitution = new SemanticsPropertyKey<>("ClearTextSubstitution", true, mergePolicy$iv$iv13, null, 8, null);
        Function2 mergePolicy$iv$iv14 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        InsertTextAtCursor = new SemanticsPropertyKey<>("InsertTextAtCursor", true, mergePolicy$iv$iv14, null, 8, null);
        Function2 mergePolicy$iv$iv15 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        OnImeAction = new SemanticsPropertyKey<>("PerformImeAction", true, mergePolicy$iv$iv15, null, 8, null);
        Function2 mergePolicy$iv$iv16 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        PerformImeAction = new SemanticsPropertyKey<>("PerformImeAction", true, mergePolicy$iv$iv16, null, 8, null);
        Function2 mergePolicy$iv$iv17 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        CopyText = new SemanticsPropertyKey<>("CopyText", true, mergePolicy$iv$iv17, null, 8, null);
        Function2 mergePolicy$iv$iv18 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        CutText = new SemanticsPropertyKey<>("CutText", true, mergePolicy$iv$iv18, null, 8, null);
        Function2 mergePolicy$iv$iv19 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        PasteText = new SemanticsPropertyKey<>("PasteText", true, mergePolicy$iv$iv19, null, 8, null);
        Function2 mergePolicy$iv$iv20 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        Expand = new SemanticsPropertyKey<>("Expand", true, mergePolicy$iv$iv20, null, 8, null);
        Function2 mergePolicy$iv$iv21 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        Collapse = new SemanticsPropertyKey<>("Collapse", true, mergePolicy$iv$iv21, null, 8, null);
        Function2 mergePolicy$iv$iv22 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        Dismiss = new SemanticsPropertyKey<>("Dismiss", true, mergePolicy$iv$iv22, null, 8, null);
        Function2 mergePolicy$iv$iv23 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        RequestFocus = new SemanticsPropertyKey<>("RequestFocus", true, mergePolicy$iv$iv23, null, 8, null);
        Function2 mergePolicy$iv = new Function2<List<? extends CustomAccessibilityAction>, List<? extends CustomAccessibilityAction>, List<? extends CustomAccessibilityAction>>() { // from class: androidx.compose.ui.semantics.SemanticsActions$CustomActions$1
            ...
            public final List<CustomAccessibilityAction> invoke2(List<CustomAccessibilityAction> list, List<CustomAccessibilityAction> list2) {
                return CollectionsKt.plus((Collection) (list == null ? CollectionsKt.emptyList() : list), (Iterable) list2);
            }
        };
        CustomActions = new SemanticsPropertyKey<>("CustomActions", true, mergePolicy$iv, null, 8, null);
        Function2 mergePolicy$iv$iv24 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        PageUp = new SemanticsPropertyKey<>("PageUp", true, mergePolicy$iv$iv24, null, 8, null);
        Function2 mergePolicy$iv$iv25 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        PageLeft = new SemanticsPropertyKey<>("PageLeft", true, mergePolicy$iv$iv25, null, 8, null);
        Function2 mergePolicy$iv$iv26 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        PageDown = new SemanticsPropertyKey<>("PageDown", true, mergePolicy$iv$iv26, null, 8, null);
        Function2 mergePolicy$iv$iv27 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        PageRight = new SemanticsPropertyKey<>("PageRight", true, mergePolicy$iv$iv27, null, 8, null);
        Function2 mergePolicy$iv$iv28 = SemanticsPropertiesKt.AnonymousClass1.INSTANCE;
        GetScrollViewportLength = new SemanticsPropertyKey<>("GetScrollViewportLength", true, mergePolicy$iv$iv28, null, 8, null);
        $stable = 8;
    }
