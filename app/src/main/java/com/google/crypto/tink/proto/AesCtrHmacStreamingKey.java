...
public final class AesCtrHmacStreamingKey extends GeneratedMessageLite<AesCtrHmacStreamingKey, Builder> implements AesCtrHmacStreamingKeyOrBuilder {
    ...
    public void mergeParams(AesCtrHmacStreamingParams value) {
        ...
        if (this.params_ != null && this.params_ != AesCtrHmacStreamingParams.getDefaultInstance()) {
            this.params_ = (AesCtrHmacStreamingParams) AesCtrHmacStreamingParams.newBuilder(this.params_).mergeFrom(value).buildPartial();
        } else {
            this.params_ = value;
        }
    }
    ...
    static {
        AesCtrHmacStreamingKey defaultInstance = new AesCtrHmacStreamingKey();
        DEFAULT_INSTANCE = defaultInstance;
        GeneratedMessageLite.registerDefaultInstance(AesCtrHmacStreamingKey.class, defaultInstance);
    }
