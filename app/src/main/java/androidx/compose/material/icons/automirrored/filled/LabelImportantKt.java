...
public final class LabelImportantKt {
    ...
    public static final ImageVector getLabelImportant(Icons.AutoMirrored.Filled $this$LabelImportant) {
        ...
        ImageVector.Builder $this$_get_LabelImportant__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Filled.LabelImportant", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
