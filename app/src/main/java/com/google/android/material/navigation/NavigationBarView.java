...
public abstract class NavigationBarView extends FrameLayout {
    ...
    public NavigationBarView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        boolean zHasValue = attributes.hasValue(R.styleable.NavigationBarView_itemIconTint);
        NavigationBarMenuView navigationBarMenuView = this.menuView;
        if (zHasValue) {
            navigationBarMenuView.setIconTintList(attributes.getColorStateList(R.styleable.NavigationBarView_itemIconTint));
        } else {
            navigationBarMenuView.setIconTintList(this.menuView.createDefaultColorStateList(android.R.attr.textColorSecondary));
        }
        ...
        if (activeIndicatorStyleResId != 0) {
            ...
            int itemActiveIndicatorExpandedWidth3 = R.styleable.NavigationBarActiveIndicator_expandedMarginHorizontal;
            int itemActiveIndicatorExpandedMarginHorizontal = activeIndicatorAttributes.getDimensionPixelOffset(itemActiveIndicatorExpandedWidth3, itemActiveIndicatorMarginHorizontal);
