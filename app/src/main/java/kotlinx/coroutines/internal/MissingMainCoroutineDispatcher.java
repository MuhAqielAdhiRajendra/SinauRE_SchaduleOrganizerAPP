...
final class MissingMainCoroutineDispatcher extends MainCoroutineDispatcher implements Delay {
    ...
    public /* bridge */ /* synthetic */ void mo10499scheduleResumeAfterDelay(long timeMillis, CancellableContinuation continuation) {
    ...
    private final Void missing() {
        ...
        StringBuilder sbAppend = new StringBuilder().append("Module with the Main dispatcher had failed to initialize");
        String it2 = this.errorHint;
        if (it2 == null || (it = ". " + it2) == null) {
            it = "";
        }
        String message = sbAppend.append(it).toString();
