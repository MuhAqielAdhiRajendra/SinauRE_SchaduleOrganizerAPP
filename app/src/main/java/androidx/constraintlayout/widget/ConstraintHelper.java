...
public abstract class ConstraintHelper extends View {
    ...
    public ConstraintHelper(Context context) throws IllegalAccessException {
        super(context);
    ...
    public ConstraintHelper(Context context, AttributeSet attrs) throws IllegalAccessException {
        super(context, attrs);
        this.mIds = new int[32];
        this.mUseViewMeasure = false;
        this.mViews = null;
    ...
    public ConstraintHelper(Context context, AttributeSet attrs, int defStyleAttr) throws IllegalAccessException {
    ...
    protected void init(AttributeSet attrs) throws IllegalAccessException {
        if (attrs != null) {
    ...
    protected void onAttachedToWindow() throws IllegalAccessException {
    ...
    public void validateParams() {
        ...
        if (params instanceof ConstraintLayout.LayoutParams) {
            ...
            layoutParams.mWidget = (ConstraintWidget) this.mHelperWidget;
        }
    }

    private void addID(String idString) throws IllegalAccessException {
    ...
    private int findId(String referenceId) throws IllegalAccessException {
        ConstraintLayout parent = null;
        if (getParent() instanceof ConstraintLayout) {
            parent = (ConstraintLayout) getParent();
        }
    ...
    protected void setIds(String idList) throws IllegalAccessException {
    ...
    private int[] convertReferenceString(String referenceIdString) throws IllegalAccessException {
