...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_addShoppingCart", "Landroidx/compose/ui/graphics/vector/ImageVector;", "AddShoppingCart", "Landroidx/compose/material/icons/Icons$Filled;", "getAddShoppingCart", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class AddShoppingCartKt {
    private static ImageVector _addShoppingCart;

    public static final ImageVector getAddShoppingCart(Icons.Filled $this$AddShoppingCart) {
        ...
        ImageVector.Builder $this$_get_AddShoppingCart__u24lambda_u241 = new ImageVector.Builder("Filled.AddShoppingCart", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(-0.9f, -2.0f, -2.0f, -2.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(7.17f, 14.75f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(3.86f, -7.01f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(19.42f, 4.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-0.13f, -0.27f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.13f, 0.0f, -0.25f, -0.11f, -0.25f, -0.25f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
