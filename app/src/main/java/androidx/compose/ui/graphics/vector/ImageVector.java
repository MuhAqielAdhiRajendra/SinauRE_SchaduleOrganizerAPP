...
public final class ImageVector {
    ...
    public /* synthetic */ ImageVector(String str, float f, float f2, float f3, float f4, VectorGroup vectorGroup, long j, int i, boolean z, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        int iGenerateImageVectorId$ui;
        if ((i3 & 512) == 0) {
            iGenerateImageVectorId$ui = i2;
        } else {
            iGenerateImageVectorId$ui = INSTANCE.generateImageVectorId$ui();
        }
        this(str, f, f2, f3, f4, vectorGroup, j, i, z, iGenerateImageVectorId$ui, null);
    }
    ...
    public static final class Builder {
        ...
        public /* synthetic */ Builder(String str, float f, float f2, float f3, float f4, long j, int i, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this((i2 & 1) != 0 ? "" : str, f, f2, f3, f4, (i2 & 32) != 0 ? Color.INSTANCE.m5349getUnspecified0d7_KjU() : j, (i2 & 64) != 0 ? BlendMode.INSTANCE.m5251getSrcIn0nO6VwU() : i, (i2 & 128) != 0 ? false : z, (DefaultConstructorMarker) null);
        }
        ...
        public /* synthetic */ Builder(String str, float f, float f2, float f3, float f4, long j, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this((i2 & 1) != 0 ? "" : str, f, f2, f3, f4, (i2 & 32) != 0 ? Color.INSTANCE.m5349getUnspecified0d7_KjU() : j, (i2 & 64) != 0 ? BlendMode.INSTANCE.m5251getSrcIn0nO6VwU() : i, (DefaultConstructorMarker) null);
        }
        ...
        public final Builder clearGroup() {
            ensureNotConsumed();
            GroupParams popped = (GroupParams) ImageVectorKt.pop(this.nodes);
        ...
        public static /* synthetic */ Builder m6044addPathoIyEayM$default(Builder builder, List list, int i, String str, Brush brush, float f, Brush brush2, float f2, float f3, int i2, int i3, float f4, float f5, float f6, float f7, int i4, Object obj) {
            return builder.m6045addPathoIyEayM(list, (i4 & 2) != 0 ? VectorKt.getDefaultFillType() : i, (i4 & 4) != 0 ? "" : str, (i4 & 8) != 0 ? null : brush, (i4 & 16) != 0 ? 1.0f : f, (i4 & 32) == 0 ? brush2 : null, (i4 & 64) != 0 ? 1.0f : f2, (i4 & 128) != 0 ? 0.0f : f3, (i4 & 256) != 0 ? VectorKt.getDefaultStrokeLineCap() : i2, (i4 & 512) != 0 ? VectorKt.getDefaultStrokeLineJoin() : i3, (i4 & 1024) != 0 ? 4.0f : f4, (i4 & 2048) != 0 ? 0.0f : f5, (i4 & 4096) == 0 ? f6 : 1.0f, (i4 & 8192) == 0 ? f7 : 0.0f);
        }

        /* JADX INFO: renamed from: addPath-oIyEayM, reason: not valid java name */
        public final Builder m6045addPathoIyEayM(List<? extends PathNode> pathData, int pathFillType, String name, Brush fill, float fillAlpha, Brush stroke, float strokeAlpha, float strokeLineWidth, int strokeLineCap, int strokeLineJoin, float strokeLineMiter, float trimPathStart, float trimPathEnd, float trimPathOffset) {
            ensureNotConsumed();
    ...
    /* JADX INFO: compiled from: ImageVector.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\r\u0010\t\u001a\u00020\u0005H\u0000¢\u0006\u0002\b\nR\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u000e¢\u0006\u0002\n\u0000R\u0014\u0010\u0006\u001a\u00060\u0001j\u0002`\u0007X\u0082\u0004¢\u0006\u0004\n\u0002\u0010\b¨\u0006\u000b"}, d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector$Companion;", "", "<init>", "()V", "imageVectorCount", "", "lock", "Landroidx/compose/ui/platform/SynchronizedObject;", "Ljava/lang/Object;", "generateImageVectorId", "generateImageVectorId$ui", "ui"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {
        ...
        public final int generateImageVectorId$ui() {
            int i;
            Object lock$iv = ImageVector.lock;
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ImageVector) || !Intrinsics.areEqual(this.name, ((ImageVector) other).name) || !Dp.m8155equalsimpl0(this.defaultWidth, ((ImageVector) other).defaultWidth) || !Dp.m8155equalsimpl0(this.defaultHeight, ((ImageVector) other).defaultHeight)) {
            return false;
        }
        if (this.viewportWidth == ((ImageVector) other).viewportWidth) {
            return ((this.viewportHeight > ((ImageVector) other).viewportHeight ? 1 : (this.viewportHeight == ((ImageVector) other).viewportHeight ? 0 : -1)) == 0) && Intrinsics.areEqual(this.root, ((ImageVector) other).root) && Color.m5314equalsimpl0(this.tintColor, ((ImageVector) other).tintColor) && BlendMode.m5222equalsimpl0(this.tintBlendMode, ((ImageVector) other).tintBlendMode) && this.autoMirror == ((ImageVector) other).autoMirror;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((((((((result * 31) + Dp.m8156hashCodeimpl(this.defaultWidth)) * 31) + Dp.m8156hashCodeimpl(this.defaultHeight)) * 31) + Float.hashCode(this.viewportWidth)) * 31) + Float.hashCode(this.viewportHeight)) * 31) + this.root.hashCode()) * 31) + Color.m5320hashCodeimpl(this.tintColor)) * 31) + BlendMode.m5223hashCodeimpl(this.tintBlendMode)) * 31) + Boolean.hashCode(this.autoMirror);
    }
}
