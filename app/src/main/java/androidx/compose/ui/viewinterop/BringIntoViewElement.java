...
final class BringIntoViewElement extends ModifierNodeElement<BringIntoViewNode> {
    ...
    public boolean equals(Object other) {
        return this == other || ((other instanceof BringIntoViewElement) && this.onRequesterReady == ((BringIntoViewElement) other).onRequesterReady);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        $this$inspectableProperties.setName("requestRectangleBringIntoViewBridge");
    }
}
