...
public final class NestedReadonlySnapshot extends Snapshot {
    ...
    public NestedReadonlySnapshot takeNestedSnapshot(Function1<Object, Unit> readObserver) {
        NestedReadonlySnapshot parent$iv = this;
        ...
        Snapshot result$iv = new NestedReadonlySnapshot(getSnapshotId(), getInvalid(), SnapshotKt.mergedReadObserver$default(readObserver2, getReadObserver(), false, 4, null), getParent());
        if (observers$iv != null) {
            SnapshotObserverKt.dispatchCreatedObservers(observers$iv, parent$iv, result$iv, second);
        }
        return (NestedReadonlySnapshot) result$iv;
    }
