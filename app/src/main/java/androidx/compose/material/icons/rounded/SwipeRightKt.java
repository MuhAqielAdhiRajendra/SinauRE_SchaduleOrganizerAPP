...
public final class SwipeRightKt {
    ...
    public static final ImageVector getSwipeRight(Icons.Rounded $this$SwipeRight) {
        ...
        ImageVector.Builder $this$_get_SwipeRight__u24lambda_u241 = new ImageVector.Builder("Rounded.SwipeRight", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(7.19f, 1.0f, 3.7f, 3.39f, 2.41f, 5.92f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(2.16f, 6.41f, 2.53f, 7.0f, 3.09f, 7.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.28f, 0.0f, 0.54f, -0.15f, 0.66f, -0.4f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(4.73f, 4.69f, 7.58f, 2.5f, 12.0f, 2.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(3.03f, 0.0f, 5.79f, 1.14f, 7.91f, 3.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(-2.16f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(17.34f, 5.5f, 17.0f, 5.84f, 17.0f, 6.25f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(17.34f, 7.0f, 17.75f, 7.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(22.0f, 2.34f, 21.66f, 2.0f, 21.25f, 2.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(20.5f, 2.34f, 20.5f, 2.75f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(1.27f);
