...
public final class DeveloperBoardOffKt {
    ...
    public static final ImageVector getDeveloperBoardOff(Icons.Sharp $this$DeveloperBoardOff) {
        ...
        ImageVector.Builder $this$_get_DeveloperBoardOff__u24lambda_u241 = new ImageVector.Builder("Sharp.DeveloperBoardOff", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(18.17f, 21.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineTo(18.17f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
