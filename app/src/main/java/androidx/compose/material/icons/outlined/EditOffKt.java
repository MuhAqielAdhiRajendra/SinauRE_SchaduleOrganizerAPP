...
public final class EditOffKt {
    ...
    public static final ImageVector getEditOff(Icons.Outlined $this$EditOff) {
        if (_editOff != null) {
        ...
        ImageVector.Builder $this$_get_EditOff__u24lambda_u241 = new ImageVector.Builder("Outlined.EditOff", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(18.17f, 3.09f, 17.92f, 3.0f, 17.66f, 3.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(3.75f, 3.75f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(20.71f, 7.04f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
