    ...
    public static final class Companion {
        ...
        public final MeasuredPolygon measurePolygon$graphics_shapes_release(Measurer measurer, RoundedPolygon polygon) {
            ...
            for (int i2 = 0; i2 < size4; i2++) {
                ...
                $this$measurePolygon_u24lambda_u244.add(new ProgressableFeature((outlineProgress.get(ix) + outlineProgress.get(ix + 1)) / 2.0f, (Feature) ((Pair) featureToCubic.get(i2)).getFirst()));
            }
