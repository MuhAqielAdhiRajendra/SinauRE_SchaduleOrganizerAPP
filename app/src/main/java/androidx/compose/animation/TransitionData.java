...
public final /* data */ class TransitionData {
    ...
    public int hashCode() {
        return ((((((((((((this.fade == null ? 0 : this.fade.hashCode()) * 31) + (this.slide == null ? 0 : this.slide.hashCode())) * 31) + (this.changeSize == null ? 0 : this.changeSize.hashCode())) * 31) + (this.scale == null ? 0 : this.scale.hashCode())) * 31) + (this.veil != null ? this.veil.hashCode() : 0)) * 31) + Boolean.hashCode(this.hold)) * 31) + this.effectsMap.hashCode();
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public TransitionData(Fade fade, Slide slide, ChangeSize changeSize, Scale scale, Veil veil, boolean hold, Map<TransitionEffectKey<?>, ? extends TransitionEffect> map) {
        this.fade = fade;
        this.slide = slide;
