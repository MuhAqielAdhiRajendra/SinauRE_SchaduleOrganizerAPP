...
public final class SendToMobileKt {
    ...
    @Deprecated(message = "Use the AutoMirrored version at Icons.AutoMirrored.Outlined.SendToMobile", replaceWith = @ReplaceWith(expression = "Icons.AutoMirrored.Outlined.SendToMobile", imports = {"androidx.compose.material.icons.automirrored.outlined.SendToMobile"}))
    public static /* synthetic */ void getSendToMobile$annotations(Icons.Outlined outlined) {
    }

    public static final ImageVector getSendToMobile(Icons.Outlined $this$SendToMobile) {
        ...
        ImageVector.Builder $this$_get_SendToMobile__u24lambda_u241 = new ImageVector.Builder("Outlined.SendToMobile", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
