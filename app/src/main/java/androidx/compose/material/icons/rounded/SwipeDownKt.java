...
public final class SwipeDownKt {
    ...
    public static final ImageVector getSwipeDown(Icons.Rounded $this$SwipeDown) {
        if (_swipeDown != null) {
        ...
        ImageVector.Builder $this$_get_SwipeDown__u24lambda_u241 = new ImageVector.Builder("Rounded.SwipeDown", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(5.59f, 2.73f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(4.27f, 4.65f, 3.5f, 6.99f, 3.5f, 9.5f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.29f, -0.29f, -0.77f, -0.32f, -1.07f, -0.04f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.31f, 0.29f, -0.31f, 0.78f, -0.02f, 1.08f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.29f, -0.29f, 0.32f, -0.77f, 0.04f, -1.07f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.29f, -0.31f, -0.78f, -0.31f, -1.08f, -0.02f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-1.09f, 1.09f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(5.11f, 11.24f, 5.0f, 10.38f, 5.0f, 9.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -2.2f, 0.68f, -4.24f, 1.83f, -5.93f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.2f, -0.3f, 0.17f, -0.7f, -0.09f, -0.95f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(6.41f, 2.28f, 5.86f, 2.34f, 5.59f, 2.73f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
