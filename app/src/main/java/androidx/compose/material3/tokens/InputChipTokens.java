...
public final class InputChipTokens {
    ...
    private static final float UnselectedOutlineWidth = Dp.m8150constructorimpl((float) 1.0d);
    ...
    private static final float AvatarSize = Dp.m8150constructorimpl((float) 24.0d);
    ...
    private static final float TrailingIconSize = Dp.m8150constructorimpl((float) 18.0d);
