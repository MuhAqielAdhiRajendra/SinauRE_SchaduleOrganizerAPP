...
public final class OverlayInfo {
    ...
    public OverlayInfo(String overlayTag, OverlayAttributes currentOverlayAttributes, ActivityStack activityStack) {
        Intrinsics.checkNotNullParameter(overlayTag, "overlayTag");
        this.overlayTag = overlayTag;
        this.currentOverlayAttrs = currentOverlayAttributes;
