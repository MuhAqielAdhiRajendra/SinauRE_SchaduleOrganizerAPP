...
public final class DefaultTooltipCaretShape implements Shape {
    ...
    public /* synthetic */ DefaultTooltipCaretShape(long j, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? TooltipDefaults.INSTANCE.m3331getCaretSizeMYxV2XQ() : j, null);
    }
    ...
    public Outline mo342createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        ...
        float caretWidthPx = density.mo432toPx0680j_4(DpSize.m8248getWidthD9Ej5fM(this.caretSize));
        float caretHeightPx = density.mo432toPx0680j_4(DpSize.m8246getHeightD9Ej5fM(this.caretSize));
        caretPath.moveTo(0.0f, 0.0f);
        caretPath.lineTo(caretWidthPx / 2.0f, 0.0f);
