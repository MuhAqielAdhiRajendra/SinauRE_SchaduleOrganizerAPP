...
public final class JwtRsaSsaPssPublicKey extends GeneratedMessageLite<JwtRsaSsaPssPublicKey, Builder> implements JwtRsaSsaPssPublicKeyOrBuilder {
    ...
    static {
        JwtRsaSsaPssPublicKey defaultInstance = new JwtRsaSsaPssPublicKey();
        DEFAULT_INSTANCE = defaultInstance;
        GeneratedMessageLite.registerDefaultInstance(JwtRsaSsaPssPublicKey.class, defaultInstance);
    }
