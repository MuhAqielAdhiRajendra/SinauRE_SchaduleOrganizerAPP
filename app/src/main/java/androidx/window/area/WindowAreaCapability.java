...
public final class WindowAreaCapability {
    ...
    public boolean equals(Object other) {
        return (other instanceof WindowAreaCapability) && Intrinsics.areEqual(this.operation, ((WindowAreaCapability) other).operation) && Intrinsics.areEqual(this.status, ((WindowAreaCapability) other).status);
    }

    public int hashCode() {
        int result = this.operation.hashCode();
        return (result * 31) + this.status.hashCode();
    }
}
