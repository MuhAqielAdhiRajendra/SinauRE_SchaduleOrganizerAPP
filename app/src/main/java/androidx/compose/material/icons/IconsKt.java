...
public final class IconsKt {
    ...
    public static /* synthetic */ ImageVector.Builder m2121materialPathYwgOQQI$default(ImageVector.Builder $this$materialPath_u2dYwgOQQI_u24default, float fillAlpha, float strokeAlpha, int pathFillType, Function1 pathBuilder, int i, Object obj) {
    ...
    public static final ImageVector.Builder m2120materialPathYwgOQQI(ImageVector.Builder $this$materialPath_u2dYwgOQQI, float fillAlpha, float strokeAlpha, int pathFillType, Function1<? super PathBuilder, Unit> function1) {
        Brush fill$iv = new SolidColor(Color.INSTANCE.m5339getBlack0d7_KjU(), null);
        int strokeLineCap$iv = StrokeCap.INSTANCE.m5687getButtKaPHkGw();
        int strokeLineJoin$iv = StrokeJoin.INSTANCE.m5697getBevelLxFBmk8();
        PathBuilder $this$PathData_u24lambda_u240$iv$iv = new PathBuilder();
