...
public final class LocalShippingKt {
    ...
    public static final ImageVector getLocalShipping(Icons.Outlined $this$LocalShipping) {
        ...
        ImageVector.Builder $this$_get_LocalShipping__u24lambda_u241 = new ImageVector.Builder("Outlined.LocalShipping", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(-0.45f, 1.0f, -1.0f, 1.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(8.22f, 15.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(8.22f, 15.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
