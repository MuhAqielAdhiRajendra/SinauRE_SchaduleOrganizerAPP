...
public final class MarqueeAnimationMode {
    ...
    private static final int Immediately = m357constructorimpl(0);
    private static final int WhileFocused = m357constructorimpl(1);
    private final int value;

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ MarqueeAnimationMode m356boximpl(int i) {
        return new MarqueeAnimationMode(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m357constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m358equalsimpl(int i, Object obj) {
    ...
    public boolean equals(Object other) {
        return m358equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m360hashCodeimpl(this.value);
    }
    ...
    public static String m361toStringimpl(int arg0) {
        if (m359equalsimpl0(arg0, Immediately)) {
            return "Immediately";
        }
        if (m359equalsimpl0(arg0, WhileFocused)) {
            return "WhileFocused";
        }
