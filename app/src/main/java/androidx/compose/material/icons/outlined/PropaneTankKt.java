...
public final class PropaneTankKt {
    ...
    public static final ImageVector getPropaneTank(Icons.Outlined $this$PropaneTank) {
        ...
        ImageVector.Builder $this$_get_PropaneTank__u24lambda_u241 = new ImageVector.Builder("Outlined.PropaneTank", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(17.0f, 6.14f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(-8.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(20.0f, 8.14f, 18.72f, 6.59f, 17.0f, 6.14f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(-3.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(6.0f, 8.9f, 6.9f, 8.0f, 8.0f, 8.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(3.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(18.0f, 19.1f, 17.1f, 20.0f, 16.0f, 20.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _propaneTank = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_PropaneTank__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
