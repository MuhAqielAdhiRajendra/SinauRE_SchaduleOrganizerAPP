...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    static final Object _get_keys_$lambda$0(Object k, Object obj) {
        return k;
    }
    ...
    static final Map.Entry _get_entries_$lambda$1(Object k, Object v) {
    ...
    private final class Core {
        ...
        private final void removeCleanedAt(int index) {
            ...
            } while (!AtomicArraysKt__AtomicArrays_jvmKt$$ExternalSyntheticBackportWithForwarding0.m(getValues(), index, oldValue, null));
        ...
        public final Object putImpl(K key, V value, HashedWeakRef<K> weakKey0) {
            ...
            while (true) {
                ...
                if (w != null) {
                    ...
                    if (!loadIncremented) {
                        ...
                        do {
                            n = handler$atomicfu$iv.get(this);
                            if (n >= this.threshold) {
                                return ConcurrentWeakMapKt.REHASH;
                            }
                        } while (!handler$atomicfu$iv.compareAndSet(this, n, n + 1));
                        loadIncremented = true;
                    }
                    if (hashedWeakRef == null) {
                        hashedWeakRef = new HashedWeakRef<>(key, ((ConcurrentWeakMap) ConcurrentWeakMap.this).weakRefQueue);
                    }
                    if (AtomicArraysKt__AtomicArrays_jvmKt$$ExternalSyntheticBackportWithForwarding0.m(getKeys(), index, null, hashedWeakRef)) {
                        break;
                    }
                }
            }
            ...
            } while (!AtomicArraysKt__AtomicArrays_jvmKt$$ExternalSyntheticBackportWithForwarding0.m(getValues(), index, oldValue, value));
            return oldValue;
        }
                ...
                for (int i2 = 0; i2 < i; i2++) {
                    ...
                    while (true) {
                        ...
                        if (!(obj instanceof Marked)) {
                            if (AtomicArraysKt__AtomicArrays_jvmKt$$ExternalSyntheticBackportWithForwarding0.m(getValues(), i2, obj, ConcurrentWeakMapKt.mark(obj))) {
                                break;
                            }
                        } else {
                            obj = ((Marked) obj).ref;
