...
public interface Canvas {
    ...
    void mo5165drawCircle9KIMszo(long center, float radius, Paint paint);

    /* JADX INFO: renamed from: drawImage-d-4ec7I */
    void mo5166drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint);

    /* JADX INFO: renamed from: drawImageRect-HPBpro0 */
    void mo5167drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint);

    /* JADX INFO: renamed from: drawLine-Wko1d7g */
    void mo5168drawLineWko1d7g(long p1, long p2, Paint paint);
    ...
    void mo5169drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint);

    /* JADX INFO: renamed from: drawRawPoints-O7TthRY */
    void mo5170drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint);
    ...
    void mo5171drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint);
    ...
    public static final class DefaultImpls {
        ...
        public static void skewRad(Canvas $this, float sxRad, float syRad) {
            Canvas.super.skewRad(sxRad, syRad);
        }

        @Deprecated
        /* JADX INFO: renamed from: clipRect-mtrdD-E, reason: not valid java name */
        public static void m5291clipRectmtrdDE(Canvas $this, Rect rect, int clipOp) {
            Canvas.super.m5288clipRectmtrdDE(rect, clipOp);
        }
        ...
        public static void drawArc(Canvas $this, Rect rect, float startAngle, float sweepAngle, boolean useCenter, Paint paint) {
            Canvas.super.drawArc(rect, startAngle, sweepAngle, useCenter, paint);
        }
        ...
        public static void drawArcRad(Canvas $this, Rect rect, float startAngleRad, float sweepAngleRad, boolean useCenter, Paint paint) {
            Canvas.super.drawArcRad(rect, startAngleRad, sweepAngleRad, useCenter, paint);
        }
    }
    ...
    static /* synthetic */ void m5286clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: clipRect-mtrdD-E");
        }
        if ((i2 & 2) != 0) {
            i = ClipOp.INSTANCE.m5302getIntersectrtfAjoo();
        }
        canvas.m5288clipRectmtrdDE(rect, i);
    }

    /* JADX INFO: renamed from: clipRect-mtrdD-E, reason: not valid java name */
    default void m5288clipRectmtrdDE(Rect rect, int clipOp) {
        mo5163clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), clipOp);
    }

    /* JADX INFO: renamed from: clipRect-N_I0leg$default, reason: not valid java name */
    static /* synthetic */ void m5285clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
        int iM5302getIntersectrtfAjoo;
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: clipRect-N_I0leg");
        }
        if ((i2 & 16) == 0) {
            iM5302getIntersectrtfAjoo = i;
        } else {
            iM5302getIntersectrtfAjoo = ClipOp.INSTANCE.m5302getIntersectrtfAjoo();
        }
        canvas.mo5163clipRectN_I0leg(f, f2, f3, f4, iM5302getIntersectrtfAjoo);
    }

    /* JADX INFO: renamed from: clipPath-mtrdD-E$default, reason: not valid java name */
    static /* synthetic */ void m5284clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.mo5162clipPathmtrdDE(path, i);
    }
    ...
    static /* synthetic */ void m5287drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
        long jM8316constructorimpl;
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: drawImageRect-HPBpro0");
        }
        long jM8289getZeronOccac = (i & 2) != 0 ? IntOffset.INSTANCE.m8289getZeronOccac() : j;
        if ((i & 4) != 0) {
        ...
        canvas.mo5167drawImageRectHPBpro0(imageBitmap, jM8289getZeronOccac, jM8316constructorimpl, (i & 8) != 0 ? IntOffset.INSTANCE.m8289getZeronOccac() : j3, (i & 16) != 0 ? jM8316constructorimpl : j4, paint);
    }
}
