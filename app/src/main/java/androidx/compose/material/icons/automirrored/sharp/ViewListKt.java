...
public final class ViewListKt {
    ...
    public static final ImageVector getViewList(Icons.AutoMirrored.Sharp $this$ViewList) {
        if (_viewList != null) {
        ...
        ImageVector.Builder $this$_get_ViewList__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Sharp.ViewList", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
