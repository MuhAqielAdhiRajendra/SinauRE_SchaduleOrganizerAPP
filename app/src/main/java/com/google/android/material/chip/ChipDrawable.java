...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private void loadFromAttributes(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            int fontVariationSettingsIndex = MaterialResources.getIndexWithValue(a, com.google.android.material.R.styleable.Chip_fontVariationSettings, com.google.android.material.R.styleable.Chip_android_fontVariationSettings);
    ...
    public void draw(Canvas canvas) {
        ...
        if (!bounds.isEmpty() && getAlpha() != 0) {
            ...
            if (this.alpha >= 255) {
                ...
                canvas2 = canvas;
                saveCount = CanvasCompat.saveLayerAlpha(canvas2, bounds.left, bounds.top, bounds.right, bounds.bottom, this.alpha);
            }
    ...
    private void drawText(Canvas canvas, Rect bounds) {
        ...
        if (this.text != null) {
            ...
            if (clip && this.truncateAt != null) {
                CharSequence finalText3 = TextUtils.ellipsize(this.text, this.textDrawableHelper.getTextPaint(), this.rectF.width(), this.truncateAt);
    ...
    private void drawDebug(Canvas canvas, Rect bounds) {
        ...
        if (this.debugPaint != null) {
            ...
            if (this.text == null) {
                ...
                canvas2 = canvas;
                canvas2.drawLine(bounds.left, bounds.exactCenterY(), bounds.right, bounds.exactCenterY(), this.debugPaint);
            }
            if (showsCloseIcon()) {
                calculateCloseIconBounds(bounds, this.rectF);
    ...
    public void setFontVariationSettings(String fontVariationSettings) {
        TextAppearance textAppearance = getTextAppearance();
        if (textAppearance != null && Build.VERSION.SDK_INT >= 26) {
    ...
    boolean refreshCloseIconFocus(boolean closeIconFocused) {
        ...
        boolean changed = setCloseIconState(closeIconFocused ? new int[]{R.attr.state_pressed, R.attr.state_enabled} : DEFAULT_STATE);
        return changed;
    }
    ...
    public void setChipIconTint(ColorStateList chipIconTint) {
        ...
        if (this.chipIconTint != chipIconTint) {
            ...
            if (showsChipIcon()) {
                this.chipIcon.setTintList(chipIconTint);
            }
            onStateChange(getState());
        }
    }
    ...
    public void setCloseIconTint(ColorStateList closeIconTint) {
        if (this.closeIconTint != closeIconTint) {
            ...
            if (showsCloseIcon()) {
                this.closeIcon.setTintList(closeIconTint);
            }
            onStateChange(getState());
        }
    }
