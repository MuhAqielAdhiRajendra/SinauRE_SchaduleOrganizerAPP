...
final class TabIndicatorOffsetNode$measure$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    TabIndicatorOffsetNode$measure$3(Animatable<Dp, AnimationVector1D> animatable, float f, TabIndicatorOffsetNode tabIndicatorOffsetNode, Continuation<? super TabIndicatorOffsetNode$measure$3> continuation) {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                Dp dpM8148boximpl = Dp.m8148boximpl(this.$indicatorOffset);
                FiniteAnimationSpec<Dp> animationSpec = this.this$0.getAnimationSpec();
                this.label = 1;
                if (animatable.animateTo(dpM8148boximpl, (14 & 2) != 0 ? animatable.defaultSpringSpec : animationSpec, (14 & 4) != 0 ? animatable.getVelocity() : null, (14 & 8) != 0 ? null : null, this) == coroutine_suspended) {
