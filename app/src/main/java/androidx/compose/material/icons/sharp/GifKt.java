...
public final class GifKt {
    ...
    public static final ImageVector getGif(Icons.Sharp $this$Gif) {
        if (_gif != null) {
        ...
        ImageVector.Builder $this$_get_Gif__u24lambda_u241 = new ImageVector.Builder("Sharp.Gif", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
