...
public final class WideNavigationRailStateImpl implements WideNavigationRailState {
    ...
    static final WideNavigationRailValue _currentVal$lambda$0(WideNavigationRailStateImpl this$0) {
    ...
    public Object expand(Continuation<? super Unit> continuation) {
        Animatable<Float, AnimationVector1D> animatable = this.internalState;
        Object objAnimateTo = animatable.animateTo(Boxing.boxFloat(1.0f), (14 & 2) != 0 ? animatable.defaultSpringSpec : this.animationSpec, (14 & 4) != 0 ? animatable.getVelocity() : null, (14 & 8) != 0 ? null : null, continuation);
    ...
    public Object collapse(Continuation<? super Unit> continuation) {
        Animatable<Float, AnimationVector1D> animatable = this.internalState;
        Object objAnimateTo = animatable.animateTo(Boxing.boxFloat(0.0f), (14 & 2) != 0 ? animatable.defaultSpringSpec : this.animationSpec, (14 & 4) != 0 ? animatable.getVelocity() : null, (14 & 8) != 0 ? null : null, continuation);
        return objAnimateTo == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objAnimateTo : Unit.INSTANCE;
    }
    ...
    public Object toggle(Continuation<? super Unit> continuation) {
        Animatable<Float, AnimationVector1D> animatable = this.internalState;
        Object objAnimateTo = animatable.animateTo(Boxing.boxFloat(WideNavigationRailStateKt.isExpanded(getTargetValue()) ? 0.0f : 1.0f), (14 & 2) != 0 ? animatable.defaultSpringSpec : this.animationSpec, (14 & 4) != 0 ? animatable.getVelocity() : null, (14 & 8) != 0 ? null : null, continuation);
        return objAnimateTo == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objAnimateTo : Unit.INSTANCE;
    }
    ...
    public Object snapTo(WideNavigationRailValue targetValue, Continuation<? super Unit> continuation) {
        ...
        Object objSnapTo = this.internalState.snapTo(Boxing.boxFloat(target), continuation);
    ...
    public static final class Companion {
        ...
        static final WideNavigationRailState Saver$lambda$1(AnimationSpec $animationSpec, WideNavigationRailValue it) {
