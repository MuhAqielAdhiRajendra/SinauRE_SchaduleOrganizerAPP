...
public final class MultiParagraphKt {
    ...
    public static final CharSequence findParagraphByIndex$lambda$2$0(ParagraphInfo it) {
    ...
    public static final void m7440findParagraphsByRangeSbBc2M(List<ParagraphInfo> list, long range, Function1<? super ParagraphInfo, Unit> function1) {
        int paragraphIndex = findParagraphByIndex(list, TextRange.m7571getMinimpl(range));
        int size = list.size();
        for (int i = paragraphIndex; i < size; i++) {
            ParagraphInfo paragraph = list.get(i);
            if (paragraph.getStartIndex() < TextRange.m7570getMaximpl(range)) {
