...
public final class NewspaperKt {
    ...
    public static final ImageVector getNewspaper(Icons.TwoTone $this$Newspaper) {
        if (_newspaper != null) {
        ...
        ImageVector.Builder $this$_get_Newspaper__u24lambda_u241 = new ImageVector.Builder("TwoTone.Newspaper", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
