...
public final class CoroutineLiveDataKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super EmittedSource>, Object> {
                ...
                case 0:
                    ...
                    mediatorLiveData.addSource(obj2, new CoroutineLiveDataKt$sam$androidx_lifecycle_Observer$0(new Function1() { // from class: androidx.lifecycle.CoroutineLiveDataKt$addDisposableSource$2$$ExternalSyntheticLambda0
                        ...
                        public final Object invoke(Object obj3) {
                            return CoroutineLiveDataKt.AnonymousClass2.invokeSuspend$lambda$0(mediatorLiveData2, obj3);
                        }
                    }));
        ...
        static final Unit invokeSuspend$lambda$0(MediatorLiveData $this_addDisposableSource, Object it) {
    ...
    public static final <T> LiveData<T> liveData(CoroutineContext context, long timeoutInMs, Function2<? super LiveDataScope<T>, ? super Continuation<? super Unit>, ? extends Object> block) {
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(block, "block");
        return new CoroutineLiveData(context, timeoutInMs, block);
    }
