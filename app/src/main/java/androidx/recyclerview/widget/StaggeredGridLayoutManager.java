...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    boolean checkForGaps() {
        ...
        if (validFsi != null) {
            lazySpanLookup.forceInvalidateAfter(validFsi.mPosition + 1);
        } else {
            lazySpanLookup.forceInvalidateAfter(invalidFsi.mPosition);
        }
        requestSimpleAnimationsInNextLayout();
        requestLayout();
        return true;
    ...
    View hasGapsToFix() {
        ...
        for (int i = firstChildIndex; i != childLimit; i += nextChildDiff) {
            ...
            if (!lp.mFullSpan && i + nextChildDiff != childLimit) {
                ...
                if (z) {
                    int myEnd = orientationHelper.getDecoratedEnd(child);
                    ...
                    int myStart = orientationHelper.getDecoratedStart(child);
            ...
            if (this.mPendingSavedState.mSpanOffsetsSize == this.mSpanCount) {
                for (int i = 0; i < this.mSpanCount; i++) {
                    ...
                    if (line != Integer.MIN_VALUE) {
                        ...
                        OrientationHelper orientationHelper = this.mPrimaryOrientation;
                        if (z) {
                            line += orientationHelper.getEndAfterPadding();
                        } else {
                            line += orientationHelper.getStartAfterPadding();
                        }
                    }
        ...
        if (this.mPendingSavedState == null || this.mPendingSavedState.mAnchorPosition == -1 || this.mPendingSavedState.mSpanOffsetsSize < 1) {
            ...
            if (child != null) {
                ...
                if (this.mPendingScrollPositionOffset != Integer.MIN_VALUE) {
                    ...
                    OrientationHelper orientationHelper = this.mPrimaryOrientation;
                    if (z) {
                        int target = orientationHelper.getEndAfterPadding() - this.mPendingScrollPositionOffset;
                        anchorInfo.mOffset = target - this.mPrimaryOrientation.getDecoratedEnd(child);
                    } else {
                        int target2 = orientationHelper.getStartAfterPadding() + this.mPendingScrollPositionOffset;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (getChildCount() > 0) {
            ...
            for (int i = 0; i < this.mSpanCount; i++) {
                ...
                if (z) {
                    line = spanArr[i].getEndLine(Integer.MIN_VALUE);
                    if (line != Integer.MIN_VALUE) {
                        line -= this.mPrimaryOrientation.getEndAfterPadding();
                    }
                } else {
                    line = spanArr[i].getStartLine(Integer.MIN_VALUE);
                    if (line != Integer.MIN_VALUE) {
    ...
    private void updateLayoutState(int anchorPosition, RecyclerView.State state) {
        ...
        if (isSmoothScrolling() && (targetPos = state.getTargetScrollPosition()) != -1) {
            ...
            boolean z3 = targetPos < anchorPosition;
            OrientationHelper orientationHelper = this.mPrimaryOrientation;
            if (z2 == z3) {
                endExtra = orientationHelper.getTotalSpace();
            } else {
                startExtra = orientationHelper.getTotalSpace();
            }
        }
        boolean clipToPadding = getClipToPadding();
        LayoutState layoutState = this.mLayoutState;
        if (clipToPadding) {
            layoutState.mStartLine = this.mPrimaryOrientation.getStartAfterPadding() - startExtra;
            this.mLayoutState.mEndLine = this.mPrimaryOrientation.getEndAfterPadding() + endExtra;
        } else {
            layoutState.mEndLine = this.mPrimaryOrientation.getEnd() + endExtra;
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        staggeredGridLayoutManager2.updateAllRemainingSpans(layoutState.mLayoutDirection, i);
        boolean z = staggeredGridLayoutManager2.mShouldReverseLayout;
        ...
        boolean z2 = false;
        ?? r0 = staggeredGridLayoutManager2;
        while (true) {
            if (!layoutState.hasMore(state)) {
                r2 = r8;
                break;
            }
            if (!r0.mLayoutState.mInfinite && r0.mRemainingSpans.isEmpty()) {
                r2 = r8;
                break;
            }
            ...
            int span2 = r0.mLazySpanLookup.getSpan(viewLayoutPosition);
            ?? r16 = span2 == -1 ? r9 : r8;
            if (r16 != 0) {
                nextSpan = layoutParams.mFullSpan ? r0.mSpans[r8] : r0.getNextSpan(layoutState);
                r0.mLazySpanLookup.setSpan(viewLayoutPosition, nextSpan);
            } else {
                nextSpan = r0.mSpans[span2];
            }
            layoutParams.mSpan = nextSpan;
            if (layoutState.mLayoutDirection == r9) {
                r0.addView(next);
            } else {
                r0.addView(next, r8);
            }
            r0.measureChildWithDecorationsAndMargin(next, layoutParams, r8);
            if (layoutState.mLayoutDirection == r9) {
                decoratedMeasurement = layoutParams.mFullSpan ? r0.getMaxEnd(i4) : nextSpan.getEndLine(i4);
                minStart = r0.mPrimaryOrientation.getDecoratedMeasurement(next) + decoratedMeasurement;
                if (r16 != 0 && layoutParams.mFullSpan) {
                    LazySpanLookup.FullSpanItem fullSpanItemCreateFullSpanItemFromEnd = r0.createFullSpanItemFromEnd(decoratedMeasurement);
                    fullSpanItemCreateFullSpanItemFromEnd.mGapDir = -1;
                    fullSpanItemCreateFullSpanItemFromEnd.mPosition = viewLayoutPosition;
                    r0.mLazySpanLookup.addFullSpanItem(fullSpanItemCreateFullSpanItemFromEnd);
                }
            } else {
                minStart = layoutParams.mFullSpan ? r0.getMinStart(i4) : nextSpan.getStartLine(i4);
                decoratedMeasurement = minStart - r0.mPrimaryOrientation.getDecoratedMeasurement(next);
                if (r16 != 0 && layoutParams.mFullSpan) {
                    LazySpanLookup.FullSpanItem fullSpanItemCreateFullSpanItemFromStart = r0.createFullSpanItemFromStart(minStart);
                    fullSpanItemCreateFullSpanItemFromStart.mGapDir = r9;
                    fullSpanItemCreateFullSpanItemFromStart.mPosition = viewLayoutPosition;
                    r0.mLazySpanLookup.addFullSpanItem(fullSpanItemCreateFullSpanItemFromStart);
                }
            }
            int i5 = decoratedMeasurement;
            int i6 = minStart;
            if (layoutParams.mFullSpan && layoutState.mItemDirection == -1) {
                if (r16 != 0) {
                    r0.mLaidOutInvalidFullSpan = r9;
                } else {
                    if ((layoutState.mLayoutDirection == r9 ? (r0.areAllEndsEqual() ? 1 : 0) ^ r9 : (r0.areAllStartsEqual() ? 1 : 0) ^ r9) != 0) {
                        LazySpanLookup.FullSpanItem fullSpanItem = r0.mLazySpanLookup.getFullSpanItem(viewLayoutPosition);
                        if (fullSpanItem != null) {
                            fullSpanItem.mHasUnwantedGapAfter = r9;
                        }
                        r0.mLaidOutInvalidFullSpan = r9;
                    }
                }
            }
            r0.attachViewToSpans(next, layoutParams, layoutState);
            if (r0.isLayoutRTL() && r0.mOrientation == r9) {
                boolean z3 = layoutParams.mFullSpan;
                OrientationHelper orientationHelper2 = r0.mSecondaryOrientation;
                decoratedMeasurement2 = z3 ? orientationHelper2.getEndAfterPadding() : orientationHelper2.getEndAfterPadding() - (((r0.mSpanCount - r9) - nextSpan.mIndex) * r0.mSizePerSpan);
                startAfterPadding2 = decoratedMeasurement2 - r0.mSecondaryOrientation.getDecoratedMeasurement(next);
            } else {
                startAfterPadding2 = layoutParams.mFullSpan ? r0.mSecondaryOrientation.getStartAfterPadding() : (nextSpan.mIndex * r0.mSizePerSpan) + r0.mSecondaryOrientation.getStartAfterPadding();
                decoratedMeasurement2 = r0.mSecondaryOrientation.getDecoratedMeasurement(next) + startAfterPadding2;
            }
            int i7 = startAfterPadding2;
            if (r0.mOrientation == 1) {
                span = nextSpan;
                i2 = i7;
                r0.layoutDecoratedWithMargins(next, i2, i5, decoratedMeasurement2, i6);
                staggeredGridLayoutManager = this;
            } else {
                span = nextSpan;
                StaggeredGridLayoutManager staggeredGridLayoutManager3 = this;
                staggeredGridLayoutManager3.layoutDecoratedWithMargins(next, i5, i7, i6, decoratedMeasurement2);
                i2 = i7;
                staggeredGridLayoutManager = staggeredGridLayoutManager3;
            }
            boolean z4 = layoutParams.mFullSpan;
            LayoutState layoutState2 = staggeredGridLayoutManager.mLayoutState;
            if (z4) {
                staggeredGridLayoutManager.updateAllRemainingSpans(layoutState2.mLayoutDirection, i);
            } else {
                staggeredGridLayoutManager.updateRemainingSpans(span, layoutState2.mLayoutDirection, i);
            }
            ...
            r8 = i3;
            r9 = 1;
            r0 = staggeredGridLayoutManager;
        }
        if (!z2) {
            r0.recycle(recycler, r0.mLayoutState);
        }
        int i8 = r0.mLayoutState.mLayoutDirection;
        OrientationHelper orientationHelper3 = r0.mPrimaryOrientation;
        if (i8 == -1) {
            maxEnd = r0.mPrimaryOrientation.getStartAfterPadding() - r0.getMinStart(orientationHelper3.getStartAfterPadding());
        } else {
            maxEnd = r0.getMaxEnd(orientationHelper3.getEndAfterPadding()) - r0.mPrimaryOrientation.getEndAfterPadding();
        }
        return maxEnd > 0 ? Math.min(layoutState.mAvailable, maxEnd) : r2 == true ? 1 : 0;
    }
    ...
    private Span getNextSpan(LayoutState layoutState) {
        ...
        if (i == 1) {
            ...
            int defaultLine = orientationHelper.getStartAfterPadding();
        ...
        int defaultLine2 = orientationHelper.getEndAfterPadding();
        for (int i3 = startIndex; i3 != endIndex; i3 += diff) {
            Span other2 = this.mSpans[i3];
    ...
    public View onFocusSearchFailed(View focused, int direction, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (!prevFocusFullSpan) {
            if (shouldSearchFromStart) {
                iFindLastPartiallyVisibleItemPosition3 = prevFocusSpan.findFirstPartiallyVisibleItemPosition();
            } else {
                iFindLastPartiallyVisibleItemPosition3 = prevFocusSpan.findLastPartiallyVisibleItemPosition();
            }
            View unfocusableCandidate = findViewByPosition(iFindLastPartiallyVisibleItemPosition3);
        ...
        if (preferLastSpan(layoutDir)) {
            for (int i3 = this.mSpanCount - 1; i3 >= 0; i3--) {
                if (i3 != prevFocusSpan.mIndex) {
                    Span[] spanArr = this.mSpans;
                    if (shouldSearchFromStart) {
                        iFindLastPartiallyVisibleItemPosition2 = spanArr[i3].findFirstPartiallyVisibleItemPosition();
                    } else {
                        iFindLastPartiallyVisibleItemPosition2 = spanArr[i3].findLastPartiallyVisibleItemPosition();
                    }
                    View unfocusableCandidate2 = findViewByPosition(iFindLastPartiallyVisibleItemPosition2);
            ...
            for (int i4 = 0; i4 < this.mSpanCount; i4++) {
                ...
                if (shouldSearchFromStart) {
                    iFindLastPartiallyVisibleItemPosition = spanArr2[i4].findFirstPartiallyVisibleItemPosition();
                } else {
                    iFindLastPartiallyVisibleItemPosition = spanArr2[i4].findLastPartiallyVisibleItemPosition();
                }
                View unfocusableCandidate3 = findViewByPosition(iFindLastPartiallyVisibleItemPosition);
    ...
    class Span {
        ...
        public int findFirstPartiallyVisibleItemPosition() {
            ...
            return z ? findOnePartiallyVisibleChild(arrayList.size() - 1, -1, true) : findOnePartiallyVisibleChild(0, arrayList.size(), true);
        }

        public int findFirstCompletelyVisibleItemPosition() {
            boolean z = StaggeredGridLayoutManager.this.mReverseLayout;
            ArrayList<View> arrayList = this.mViews;
            return z ? findOneVisibleChild(arrayList.size() - 1, -1, true) : findOneVisibleChild(0, arrayList.size(), true);
        }
        ...
        public int findLastPartiallyVisibleItemPosition() {
            boolean z = StaggeredGridLayoutManager.this.mReverseLayout;
            ArrayList<View> arrayList = this.mViews;
            return z ? findOnePartiallyVisibleChild(0, arrayList.size(), true) : findOnePartiallyVisibleChild(arrayList.size() - 1, -1, true);
        }

        public int findLastCompletelyVisibleItemPosition() {
            boolean z = StaggeredGridLayoutManager.this.mReverseLayout;
            ArrayList<View> arrayList = this.mViews;
            return z ? findOneVisibleChild(0, arrayList.size(), true) : findOneVisibleChild(arrayList.size() - 1, -1, true);
        }
    ...
    static class LazySpanLookup {
        ...
        int invalidateAfter(int position) {
            ...
            int[] iArr = this.mData;
            if (endPosition == -1) {
                Arrays.fill(iArr, position, this.mData.length, -1);
                return this.mData.length;
            }
            int invalidateToIndex = Math.min(endPosition + 1, iArr.length);
    ...
    class AnchorInfo {
        ...
        void assignCoordinateFromPadding() {
            ...
            this.mOffset = z ? staggeredGridLayoutManager.mPrimaryOrientation.getEndAfterPadding() : staggeredGridLayoutManager.mPrimaryOrientation.getStartAfterPadding();
        }
        ...
        void assignCoordinateFromPadding(int addedDistance) {
            ...
            StaggeredGridLayoutManager staggeredGridLayoutManager = StaggeredGridLayoutManager.this;
            if (z) {
                this.mOffset = staggeredGridLayoutManager.mPrimaryOrientation.getEndAfterPadding() - addedDistance;
            } else {
                this.mOffset = staggeredGridLayoutManager.mPrimaryOrientation.getStartAfterPadding() + addedDistance;
            }
        }
    }
}
