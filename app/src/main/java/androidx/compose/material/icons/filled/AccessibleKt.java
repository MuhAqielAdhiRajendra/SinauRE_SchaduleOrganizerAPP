...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u001e\u0010\u0002\u001a\u00020\u0001*\u00020\u00038FX\u0087\u0004¢\u0006\f\u0012\u0004\b\u0004\u0010\u0005\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, d2 = {"_accessible", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Accessible", "Landroidx/compose/material/icons/Icons$Filled;", "getAccessible$annotations", "(Landroidx/compose/material/icons/Icons$Filled;)V", "getAccessible", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class AccessibleKt {
    private static ImageVector _accessible;

    @Deprecated(message = "Use the AutoMirrored version at Icons.AutoMirrored.Filled.Accessible", replaceWith = @ReplaceWith(expression = "Icons.AutoMirrored.Filled.Accessible", imports = {"androidx.compose.material.icons.automirrored.filled.Accessible"}))
    public static /* synthetic */ void getAccessible$annotations(Icons.Filled filled) {
    }

    public static final ImageVector getAccessible(Icons.Filled $this$Accessible) {
        if (_accessible != null) {
        ...
        ImageVector.Builder $this$_get_Accessible__u24lambda_u242 = new ImageVector.Builder("Filled.Accessible", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
