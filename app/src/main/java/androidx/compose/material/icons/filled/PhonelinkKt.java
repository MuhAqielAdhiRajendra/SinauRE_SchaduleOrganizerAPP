...
public final class PhonelinkKt {
    ...
    public static final ImageVector getPhonelink(Icons.Filled $this$Phonelink) {
        if (_phonelink != null) {
        ...
        ImageVector.Builder $this$_get_Phonelink__u24lambda_u241 = new ImageVector.Builder("Filled.Phonelink", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
