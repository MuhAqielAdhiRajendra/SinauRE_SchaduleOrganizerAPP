...
public final class LockResetKt {
    ...
    public static final ImageVector getLockReset(Icons.Sharp $this$LockReset) {
        if (_lockReset != null) {
        ...
        ImageVector.Builder $this$_get_LockReset__u24lambda_u241 = new ImageVector.Builder("Sharp.LockReset", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
