...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
                    ...
                    try {
                        ...
                        if (this.mScene != null) {
                            ...
                            if (this.mDecoratorsHelpers != null) {
                                for (MotionHelper mh : this.mDecoratorsHelpers) {
        ...
        void apply() {
            if (this.mStartState != -1 || this.mEndState != -1) {
                if (this.mStartState == -1) {
                    ...
                    if (i == -1) {
                        motionLayout.setState(this.mStartState, -1, -1);
                    } else {
                        motionLayout.setTransition(this.mStartState, this.mEndState);
                    }
                }
    ...
    public void setupMotionViews() {
        ...
        for (int i3 = 0; i3 < n; i3++) {
            View view = motionLayout.getChildAt(i3);
        ...
        if (motionLayout.mDecoratorsHelpers != null) {
            ...
            for (MotionHelper mDecoratorsHelper : motionLayout.mDecoratorsHelpers) {
        ...
        if (stagger != 0.0f) {
            boolean flip2 = ((double) stagger) < 0.0d;
        ...
        switch (touchUpMode) {
            ...
            case 7:
                ...
                if (autoCompleteMode == 0) {
                    stopLogic.config(this.mTransitionLastPosition, position2, currentVelocity, this.mTransitionDuration, this.mScene.getMaxAcceleration(), this.mScene.getMaxVelocity());
                } else {
                    stopLogic.springConfig(this.mTransitionLastPosition, position2, currentVelocity, this.mScene.getSpringMass(), this.mScene.getSpringStiffiness(), this.mScene.getSpringDamping(), this.mScene.getSpringStopThreshold(), this.mScene.getSpringBoundary());
                }
            ...
            case 5:
                if (willJump(currentVelocity, this.mTransitionLastPosition, this.mScene.getMaxAcceleration())) {
                    ...
                    position3 = position;
                    this.mStopLogic.config(this.mTransitionLastPosition, position3, currentVelocity, this.mTransitionDuration, this.mScene.getMaxAcceleration(), this.mScene.getMaxVelocity());
                    this.mLastVelocity = 0.0f;
    ...
    class DecelerateInterpolator extends MotionInterpolator {
        ...
        public float getInterpolation(float time) {
            float f = this.mInitialV;
            float f2 = this.mInitialV;
            if (f > 0.0f) {
                if (f2 / this.mMaxA < time) {
                    time = this.mInitialV / this.mMaxA;
                }
                MotionLayout.this.mLastVelocity = this.mInitialV - (this.mMaxA * time);
                float pos = (this.mInitialV * time) - (((this.mMaxA * time) * time) / 2.0f);
                return this.mCurrentP + pos;
            }
            float pos2 = -f2;
            if (pos2 / this.mMaxA < time) {
                time = (-this.mInitialV) / this.mMaxA;
            }
            MotionLayout.this.mLastVelocity = this.mInitialV + (this.mMaxA * time);
            float pos3 = (this.mInitialV * time) + (((this.mMaxA * time) * time) / 2.0f);
            return this.mCurrentP + pos3;
        }
    ...
    */
    ...
    class Model {
        ...
        void copy(ConstraintWidgetContainer src, ConstraintWidgetContainer dest) {
            ...
            for (ConstraintWidget child_s2 : children) {
        ...
        private void setupConstraintWidget(ConstraintWidgetContainer base, ConstraintSet cSet) {
            ...
            for (ConstraintWidget child2 : base.getChildren()) {
            ...
            for (ConstraintWidget constraintWidget : base.getChildren()) {
                if (constraintWidget instanceof VirtualLayout) {
                    ...
                    ((ConstraintHelper) constraintWidget.getCompanionWidget()).updatePreLayout(base, helper, mapIdToWidget);
        ...
        private void debugWidget(String str, ConstraintWidget child) {
            ...
            String a = sbAppend.append(str2).toString();
            StringBuilder sbAppend2 = new StringBuilder().append(a);
            if (child.mBottom.mTarget != null) {
                str3 = "B" + (child.mBottom.mTarget.mType == ConstraintAnchor.Type.TOP ? "T" : "B");
            } else {
                str3 = "__";
            }
            String a2 = sbAppend2.append(str3).toString();
            StringBuilder sbAppend3 = new StringBuilder().append(a2);
            if (child.mLeft.mTarget != null) {
                str4 = "L" + (child.mLeft.mTarget.mType == ConstraintAnchor.Type.LEFT ? "L" : "R");
            } else {
                str4 = "__";
            }
            String a3 = sbAppend3.append(str4).toString();
            StringBuilder sbAppend4 = new StringBuilder().append(a3);
            if (child.mRight.mTarget != null) {
                str5 = "R" + (child.mRight.mTarget.mType == ConstraintAnchor.Type.LEFT ? "L" : "R");
            }
            String a4 = sbAppend4.append(str5).toString();
            ...
            for (int i2 = 0; i2 < n; i2++) {
                ...
                if (motionController2 != null) {
                    if (this.mStart == null) {
                        ...
                        MotionLayout motionLayout = MotionLayout.this;
                        if (startWidget != null) {
                            motionController2.setStartState(motionLayout.toRect(startWidget), this.mStart, MotionLayout.this.getWidth(), MotionLayout.this.getHeight());
                    ...
                    if (this.mEnd != null) {
                        ...
                        if (endWidget != null) {
                            motionController2.setEndState(motionLayout2.toRect(endWidget), this.mEnd, MotionLayout.this.getWidth(), MotionLayout.this.getHeight());
    ...
    private class DevModeDraw {
        ...
        private void drawTicks(Canvas canvas, int mode, int keyFrames, MotionController motionController) {
            ...
            if (motionController.mView == null) {
                ...
                int viewWidth3 = motionController.mView.getWidth();
                int viewHeight3 = motionController.mView.getHeight();
                viewWidth = viewWidth3;
                viewHeight = viewHeight3;
            }
            int i = 1;
            while (i < keyFrames - 1) {
        ...
        private void drawPathCartesianTicks(Canvas canvas, float x, float y) {
            ...
            String text = "" + (((int) (((double) ((xgap * 100.0f) / Math.abs(x2 - x1))) + 0.5d)) / 100.0f);
            getTextBounds(text, this.mTextPaint);
            ...
            String text2 = "" + (((int) (((double) ((ygap * 100.0f) / Math.abs(y2 - y1))) + 0.5d)) / 100.0f);
        ...
        private void drawPathScreenTicks(Canvas canvas, float x, float y, int viewWidth, int viewHeight) {
            String text = "" + (((int) (((double) (((x - (viewWidth / 2)) * 100.0f) / (MotionLayout.this.getWidth() - viewWidth))) + 0.5d)) / 100.0f);
            getTextBounds(text, this.mTextPaint);
            ...
            String text2 = "" + (((int) (((double) (((y - (viewHeight / 2)) * 100.0f) / (MotionLayout.this.getHeight() - viewHeight))) + 0.5d)) / 100.0f);
            getTextBounds(text2, this.mTextPaint);
    ...
    protected void dispatchDraw(Canvas canvas) {
        if (this.mDecoratorsHelpers != null) {
            for (MotionHelper decor : this.mDecoratorsHelpers) {
        ...
        if (this.mDecoratorsHelpers != null) {
            for (MotionHelper decor2 : this.mDecoratorsHelpers) {
            ...
            if (this.mInterpolator != null && !done) {
                if (this.mTemporalInterpolator) {
                    ...
                    if (this.mInterpolator instanceof MotionInterpolator) {
                        ...
                        if (Math.abs(lastVelocity) * this.mTransitionDuration <= EPSILON && stopLogicDone2 == 2) {
                            this.mInTransition = false;
                        }
                    ...
                    float p2 = position;
                    position = this.mInterpolator.getInterpolation(position);
                    boolean z = this.mInterpolator instanceof MotionInterpolator;
                    Interpolator interpolator = this.mInterpolator;
                    if (z) {
                        this.mLastVelocity = ((MotionInterpolator) interpolator).getVelocity();
                    } else {
                        this.mLastVelocity = ((interpolator.getInterpolation(p2 + deltaPos) - position) * dir) / deltaPos;
                    }
                    stopLogicDone = 0;
                }
            } else {
