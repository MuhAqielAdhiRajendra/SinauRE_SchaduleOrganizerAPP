...
public final class StarBorderKt {
    ...
    public static final ImageVector getStarBorder(Icons.TwoTone $this$StarBorder) {
        if (_starBorder != null) {
        ...
        ImageVector.Builder $this$_get_StarBorder__u24lambda_u241 = new ImageVector.Builder("TwoTone.StarBorder", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
