...
public final class FileOpenKt {
    ...
    public static final ImageVector getFileOpen(Icons.Outlined $this$FileOpen) {
        if (_fileOpen != null) {
        ...
        ImageVector.Builder $this$_get_FileOpen__u24lambda_u241 = new ImageVector.Builder("Outlined.FileOpen", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(19.0f, 21.66f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(20.41f, 18.0f);
