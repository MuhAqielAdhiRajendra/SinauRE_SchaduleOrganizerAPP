...
public final class GradingKt {
    ...
    public static final ImageVector getGrading(Icons.AutoMirrored.Sharp $this$Grading) {
        if (_grading != null) {
        ...
        ImageVector.Builder $this$_get_Grading__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Sharp.Grading", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
