...
public final class LivingKt {
    ...
    public static final ImageVector getLiving(Icons.Outlined $this$Living) {
        if (_living != null) {
        ...
        ImageVector.Builder $this$_get_Living__u24lambda_u241 = new ImageVector.Builder("Outlined.Living", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(17.75f, 10.35f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(5.51f, 10.78f, 5.0f, 11.58f, 5.0f, 12.5f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(19.0f, 11.58f, 18.49f, 10.78f, 17.75f, 10.35f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(9.25f, 7.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(5.5f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(14.99f, 10.15f, 14.0f, 11.2f, 14.0f, 12.5f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -1.3f, -0.99f, -2.35f, -2.25f, -2.47f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineTo(9.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(7.75f, 8.17f, 8.42f, 7.5f, 9.25f, 7.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _living = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_Living__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
