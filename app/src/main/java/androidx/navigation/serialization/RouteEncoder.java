...
public final class RouteEncoder<T> extends AbstractEncoder {
    ...
    private final void internalEncodeValue(Object value) {
        ...
        NavType<Object> navType = this.typeMap.get(argName);
        if (navType == null) {
        ...
        this.map.put(argName, listListOf);
    }
}
