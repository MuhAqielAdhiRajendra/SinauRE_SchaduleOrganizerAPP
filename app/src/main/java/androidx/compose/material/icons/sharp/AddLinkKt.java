...
public final class AddLinkKt {
    ...
    public static final ImageVector getAddLink(Icons.Sharp $this$AddLink) {
        if (_addLink != null) {
        ...
        ImageVector.Builder $this$_get_AddLink__u24lambda_u241 = new ImageVector.Builder("Sharp.AddLink", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
