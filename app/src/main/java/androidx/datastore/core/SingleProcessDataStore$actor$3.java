...
final class SingleProcessDataStore$actor$3<T> extends SuspendLambda implements Function2<SingleProcessDataStore.Message<T>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        SingleProcessDataStore$actor$3<T> singleProcessDataStore$actor$3;
        SingleProcessDataStore$actor$3<T> singleProcessDataStore$actor$32;
        ...
        switch (this.label) {
            case 0:
                ...
                if (msg instanceof SingleProcessDataStore.Message.Read) {
                    this.label = 1;
                    if (this.this$0.handleRead((SingleProcessDataStore.Message.Read) msg, this) == coroutine_suspended) {
                ...
                if (msg instanceof SingleProcessDataStore.Message.Update) {
                    this.label = 2;
                    if (this.this$0.handleUpdate((SingleProcessDataStore.Message.Update) msg, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
