...
public class PersistentHashMapBuilder<K, V> extends AbstractMutableMap<K, V> implements PersistentMap.Builder<K, V> {
    ...
    public void putAll(Map<? extends K, ? extends V> from) {
        ...
        if (persistentHashMapBuild == null) {
            ...
            persistentHashMapBuild = persistentHashMapBuilder != null ? persistentHashMapBuilder.build2() : null;
        }
        if (persistentHashMapBuild != null) {
            ...
            int newSize = (persistentHashMapBuild.size() + oldSize) - intersectionCounter.getCount();
            if (oldSize != newSize) {
                setSize(newSize);
                return;
            }
