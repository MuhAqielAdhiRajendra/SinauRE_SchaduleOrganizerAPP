...
public final class DrawKt {
    ...
    public static final ImageVector getDraw(Icons.Sharp $this$Draw) {
        if (_draw != null) {
        ...
        ImageVector.Builder $this$_get_Draw__u24lambda_u241 = new ImageVector.Builder("Sharp.Draw", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.48f, 0.0f, -1.0f, -0.07f, -1.0f, -0.07f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -0.34f, 0.0f, -2.03f, 0.0f, -2.03f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(13.46f, 19.0f, 14.0f, 19.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(5.76f, 5.0f, 5.0f, 5.61f, 5.0f, 6.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineTo(3.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -1.65f, 1.7f, -3.0f, 4.0f, -3.0f);
