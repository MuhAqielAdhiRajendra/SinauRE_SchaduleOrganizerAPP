...
public final class CommitTextCommand implements EditCommand {
    ...
    public void applyTo(EditingBuffer buffer) {
        ...
        if (i > 0) {
            ...
            newCursorInBuffer = (i2 + newCursor) - getText().length();
        }
