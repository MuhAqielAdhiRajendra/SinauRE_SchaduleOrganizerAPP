...
public final class ZoomOutKt {
    ...
    public static final ImageVector getZoomOut(Icons.Outlined $this$ZoomOut) {
        if (_zoomOut != null) {
        ...
        ImageVector.Builder $this$_get_ZoomOut__u24lambda_u241 = new ImageVector.Builder("Outlined.ZoomOut", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
