...
public final class PathIteratorImplKt {
    ...
    public static final PathSegment.Type platformToAndroidXSegmentType(int platformType) {
        switch (platformType) {
            case 0:
            ...
            default:
                throw new IllegalArgumentException("Unknown path segment type " + platformType);
        }
    }
}
