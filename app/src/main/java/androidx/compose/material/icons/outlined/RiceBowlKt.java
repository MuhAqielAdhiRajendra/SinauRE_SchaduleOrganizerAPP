...
public final class RiceBowlKt {
    ...
    public static final ImageVector getRiceBowl(Icons.Outlined $this$RiceBowl) {
        if (_riceBowl != null) {
        ...
        ImageVector.Builder $this$_get_RiceBowl__u24lambda_u241 = new ImageVector.Builder("Outlined.RiceBowl", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(1.36f, 0.1f, 2.0f, 0.26f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(2.39f, 1.39f, 4.0f, 3.96f, 4.0f, 6.92f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _riceBowl = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_RiceBowl__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
