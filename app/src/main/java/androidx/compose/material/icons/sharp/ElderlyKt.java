...
public final class ElderlyKt {
    ...
    public static final ImageVector getElderly(Icons.Sharp $this$Elderly) {
        if (_elderly != null) {
        ...
        ImageVector.Builder $this$_get_Elderly__u24lambda_u241 = new ImageVector.Builder("Sharp.Elderly", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
