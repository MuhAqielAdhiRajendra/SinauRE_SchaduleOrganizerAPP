...
public final class LayoutNodeAlignmentLines extends AlignmentLines {
    ...
    protected Map<AlignmentLine, Integer> getAlignmentLinesMap(NodeCoordinator $this$alignmentLinesMap) {
        return $this$alignmentLinesMap.getMeasureResult$ui().getAlignmentLines();
    }
    ...
    protected long mo6937calculatePositionInParentR5De75A(NodeCoordinator $this$calculatePositionInParent_u2dR5De75A, long position) {
        return NodeCoordinator.m7077toParentPosition8S9VItk$default($this$calculatePositionInParent_u2dR5De75A, position, false, 2, null);
    }
}
