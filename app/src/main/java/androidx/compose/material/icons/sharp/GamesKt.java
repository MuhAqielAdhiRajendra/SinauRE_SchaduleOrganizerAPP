...
public final class GamesKt {
    ...
    public static final ImageVector getGames(Icons.Sharp $this$Games) {
        if (_games != null) {
        ...
        ImageVector.Builder $this$_get_Games__u24lambda_u241 = new ImageVector.Builder("Sharp.Games", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
