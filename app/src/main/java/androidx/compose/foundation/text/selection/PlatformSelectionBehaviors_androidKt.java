...
public final class PlatformSelectionBehaviors_androidKt {
    ...
    static final PlatformSelectionBehaviorsImpl PlatformSelectionBehaviorsFactory$lambda$0(CoroutineContext coroutineContext, Context context, SelectedTextType selectionType, LocaleList localeList) {
    ...
    public static final PlatformSelectionBehaviors rememberPlatformSelectionBehaviors(SelectedTextType selectedTextType, LocaleList localeList, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(430530635, $changed, -1, "androidx.compose.foundation.text.selection.rememberPlatformSelectionBehaviors (PlatformSelectionBehaviors.android.kt:95)");
        }
    ...
    public static final boolean m2044canReuseh5sm0ck(TextClassificationResult $this$canReuse_u2dh5sm0ck, CharSequence text, long selection) {
        return TextRange.m7566equalsimpl0(selection, $this$canReuse_u2dh5sm0ck.m2092getSelectiond9O1mEE()) && Intrinsics.areEqual(text, $this$canReuse_u2dh5sm0ck.getText());
    }

    /* JADX INFO: renamed from: addPlatformTextContextMenuItems-71BSaZU, reason: not valid java name */
    public static final void m2043addPlatformTextContextMenuItems71BSaZU(TextContextMenuBuilderScope $this$addPlatformTextContextMenuItems_u2d71BSaZU, Context context, boolean editable, CharSequence text, TextRange selection, PlatformSelectionBehaviors platformSelectionBehaviors, Function1<? super TextContextMenuBuilderScope, Unit> function1) {
        if (Build.VERSION.SDK_INT < 28 || text == null || selection == null || platformSelectionBehaviors == null || !(platformSelectionBehaviors instanceof PlatformSelectionBehaviorsImpl)) {
            ...
            if (text != null && selection != null) {
                ProcessText_androidKt.m1685addProcessedTextContextMenuItemsUAq72N0($this$addPlatformTextContextMenuItems_u2d71BSaZU, context, editable, text, selection.getPackedValue());
                return;
            }
            return;
        }
        PlatformSelectionBehaviorsImpl $this$addPlatformTextContextMenuItems_71BSaZU_u24lambda_u240 = (PlatformSelectionBehaviorsImpl) platformSelectionBehaviors;
        $this$addPlatformTextContextMenuItems_71BSaZU_u24lambda_u240.m2040addSmartSelectionTextContextMenuItemsYmzfRxQ$foundation($this$addPlatformTextContextMenuItems_u2d71BSaZU, text, selection.getPackedValue(), function1);
        ProcessText_androidKt.m1685addProcessedTextContextMenuItemsUAq72N0($this$addPlatformTextContextMenuItems_u2d71BSaZU, context, editable, text, selection.getPackedValue());
    }
}
