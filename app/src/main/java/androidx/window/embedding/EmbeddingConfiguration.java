...
public final class EmbeddingConfiguration {
    ...
    /* JADX INFO: renamed from: isAutoSaveEmbeddingState, reason: from kotlin metadata and from toString */
    ...
    private EmbeddingConfiguration(DimAreaBehavior dimAreaBehavior, boolean isAutoSaveEmbeddingState) {
        this.dimAreaBehavior = dimAreaBehavior;
        this.saveState = isAutoSaveEmbeddingState;
    }
    ...
    public static final class DimAreaBehavior {
        ...
        private DimAreaBehavior(int value) {
            this.value = value;
        }
        ...
        public String toString() {
            String str;
            StringBuilder sbAppend = new StringBuilder().append("DimAreaBehavior=");
            switch (this.value) {
                case 0:
                    str = "UNDEFINED";
                    break;
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof EmbeddingConfiguration) && Intrinsics.areEqual(this.dimAreaBehavior, ((EmbeddingConfiguration) other).dimAreaBehavior) && this.saveState == ((EmbeddingConfiguration) other).saveState;
    }

    public int hashCode() {
        int result = this.dimAreaBehavior.hashCode();
        return (result * 31) + Boolean.hashCode(this.saveState);
    }

    public String toString() {
        return "EmbeddingConfiguration{dimArea=" + this.dimAreaBehavior + ", saveState=" + this.saveState + '}';
    }
    ...
    public static final class Builder {
        ...
        public final Builder setDimAreaBehavior(DimAreaBehavior area) {
            ...
            Builder $this$setDimAreaBehavior_u24lambda_u240 = this;
            $this$setDimAreaBehavior_u24lambda_u240.mDimAreaBehavior = area;
            return this;
        }

        public final Builder setAutoSaveEmbeddingState(boolean saveState) {
            Builder $this$setAutoSaveEmbeddingState_u24lambda_u241 = this;
            $this$setAutoSaveEmbeddingState_u24lambda_u241.mSaveEmbeddingState = saveState;
            return this;
        }
