...
public final class DecodeHelper {
    ...
    public final SpanStyle decodeSpanStyle() {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (bDecodeByte == 1) {
                ...
                mutableSpanStyle.m7302setColor8_81llA(m7253decodeColor0d7_KjU());
            } else if (bDecodeByte == 2) {
                if (dataAvailable() < 5) {
                    break;
                }
                mutableSpanStyle.m7303setFontSizeR2X_6o(m7256decodeTextUnitXSAIIZE());
                ...
                mutableSpanStyle.m7304setFontStylemLjRB2g(FontStyle.m7682boximpl(m7254decodeFontStyle_LCdwA()));
            } else if (bDecodeByte == 5) {
                if (dataAvailable() < 1) {
                    break;
                }
                mutableSpanStyle.m7305setFontSynthesistDdu0R4(FontSynthesis.m7693boximpl(m7255decodeFontSynthesisGVVA2EU()));
                ...
                mutableSpanStyle.m7306setLetterSpacingR2X_6o(m7256decodeTextUnitXSAIIZE());
            } else if (bDecodeByte == 8) {
                if (dataAvailable() < 4) {
                    break;
                }
                mutableSpanStyle.m7301setBaselineShift_isdbwI(BaselineShift.m7865boximpl(m7251decodeBaselineShifty9eOQZs()));
                ...
                mutableSpanStyle.m7300setBackground8_81llA(m7253decodeColor0d7_KjU());
    ...
    public final long m7253decodeColor0d7_KjU() {
    ...
    public final long m7256decodeTextUnitXSAIIZE() {
        long type;
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 1) {
            type = TextUnitType.INSTANCE.m8377getSpUIouoOA();
        } else {
            type = bDecodeByte == 2 ? TextUnitType.INSTANCE.m8376getEmUIouoOA() : TextUnitType.INSTANCE.m8378getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m8372equalsimpl0(type, TextUnitType.INSTANCE.m8378getUnspecifiedUIouoOA())) {
            return TextUnit.INSTANCE.m8355getUnspecifiedXSAIIZE();
        }
        float value = decodeFloat();
        return TextUnitKt.m8356TextUnitanM5pPY(value, type);
    }
    ...
    public final int m7254decodeFontStyle_LCdwA() {
        byte bDecodeByte = decodeByte();
        return bDecodeByte == 0 ? FontStyle.INSTANCE.m7692getNormal_LCdwA() : bDecodeByte == 1 ? FontStyle.INSTANCE.m7691getItalic_LCdwA() : FontStyle.INSTANCE.m7692getNormal_LCdwA();
    }

    /* JADX INFO: renamed from: decodeFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m7255decodeFontSynthesisGVVA2EU() {
        byte bDecodeByte = decodeByte();
        return bDecodeByte == 0 ? FontSynthesis.INSTANCE.m7703getNoneGVVA2EU() : bDecodeByte == 1 ? FontSynthesis.INSTANCE.m7702getAllGVVA2EU() : bDecodeByte == 3 ? FontSynthesis.INSTANCE.m7704getStyleGVVA2EU() : bDecodeByte == 2 ? FontSynthesis.INSTANCE.m7705getWeightGVVA2EU() : FontSynthesis.INSTANCE.m7703getNoneGVVA2EU();
    }

    /* JADX INFO: renamed from: decodeBaselineShift-y9eOQZs, reason: not valid java name */
    private final float m7251decodeBaselineShifty9eOQZs() {
        return BaselineShift.m7866constructorimpl(decodeFloat());
    }
    ...
    private final TextDecoration decodeTextDecoration() {
        return TextDecoration.INSTANCE.valueOf(decodeInt());
    }

    private final Shadow decodeShadow() {
        long jM7253decodeColor0d7_KjU = m7253decodeColor0d7_KjU();
        float x$iv = decodeFloat();
        float y$iv = decodeFloat();
        long v1$iv$iv = Float.floatToRawIntBits(x$iv);
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
        return new Shadow(jM7253decodeColor0d7_KjU, Offset.m5060constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv)), decodeFloat(), null);
    }
    ...
    private final long m7252decodeULongsVKNKU() {
        return ULong.m9103constructorimpl(this.parcel.readLong());
    }
