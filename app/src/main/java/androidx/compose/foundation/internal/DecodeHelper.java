...
public final class DecodeHelper {
    ...
    public final SpanStyle decodeSpanStyle() {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (bDecodeByte == 1) {
                ...
                mutableSpanStyle.m703setColor8_81llA(m684decodeColor0d7_KjU());
            } else if (bDecodeByte == 2) {
                if (dataAvailable() < 5) {
                    break;
                }
                mutableSpanStyle.m704setFontSizeR2X_6o(m687decodeTextUnitXSAIIZE());
                ...
                mutableSpanStyle.m705setFontStylemLjRB2g(FontStyle.m7682boximpl(m685decodeFontStyle_LCdwA()));
            } else if (bDecodeByte == 5) {
                if (dataAvailable() < 1) {
                    break;
                }
                mutableSpanStyle.m706setFontSynthesistDdu0R4(FontSynthesis.m7693boximpl(m686decodeFontSynthesisGVVA2EU()));
                ...
                mutableSpanStyle.m707setLetterSpacingR2X_6o(m687decodeTextUnitXSAIIZE());
            } else if (bDecodeByte == 8) {
                if (dataAvailable() < 4) {
                    break;
                }
                mutableSpanStyle.m702setBaselineShift_isdbwI(BaselineShift.m7865boximpl(m682decodeBaselineShifty9eOQZs()));
                ...
                mutableSpanStyle.m701setBackground8_81llA(m684decodeColor0d7_KjU());
    ...
    public final long m684decodeColor0d7_KjU() {
    ...
    public final long m687decodeTextUnitXSAIIZE() {
        long type;
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 1) {
    ...
    public final int m685decodeFontStyle_LCdwA() {
        byte bDecodeByte = decodeByte();
    ...
    public final int m686decodeFontSynthesisGVVA2EU() {
        byte bDecodeByte = decodeByte();
    ...
    private final float m682decodeBaselineShifty9eOQZs() {
    ...
    private final Shadow decodeShadow() {
        long jM684decodeColor0d7_KjU = m684decodeColor0d7_KjU();
        float x$iv = decodeFloat();
        float y$iv = decodeFloat();
        long v1$iv$iv = Float.floatToRawIntBits(x$iv);
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
        return new Shadow(jM684decodeColor0d7_KjU, Offset.m5060constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv)), decodeFloat(), null);
    }
    ...
    private final long m683decodeULongsVKNKU() {
