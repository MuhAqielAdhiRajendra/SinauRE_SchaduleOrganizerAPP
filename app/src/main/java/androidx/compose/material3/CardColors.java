...
public final class CardColors {
    ...
    public final long m2222contentColorvNxB06k$material3(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof CardColors) && Color.m5314equalsimpl0(this.containerColor, ((CardColors) other).containerColor) && Color.m5314equalsimpl0(this.contentColor, ((CardColors) other).contentColor) && Color.m5314equalsimpl0(this.disabledContainerColor, ((CardColors) other).disabledContainerColor) && Color.m5314equalsimpl0(this.disabledContentColor, ((CardColors) other).disabledContentColor)) {
            return true;
        }
        return false;
    }
