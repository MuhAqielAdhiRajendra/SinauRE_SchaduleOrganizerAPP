...
public final class FoundationKt {
    ...
    public static final ImageVector getFoundation(Icons.Rounded $this$Foundation) {
        if (_foundation != null) {
        ...
        ImageVector.Builder $this$_get_Foundation__u24lambda_u241 = new ImageVector.Builder("Rounded.Foundation", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
