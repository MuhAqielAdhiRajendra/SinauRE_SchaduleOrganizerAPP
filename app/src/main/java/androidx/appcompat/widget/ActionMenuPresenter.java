...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public void updateMenuView(boolean cleared) {
        ...
        } else if (overflowMenuButton != null && this.mOverflowButton.getParent() == this.mMenuView) {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mReserveOverflow && (hasOverflow || requiredItems + requestedItems > maxActions)) {
            maxActions--;
        }
        ...
        if (actionMenuPresenter.mStrictWidthLimit) {
            ...
            int cellSizeRemaining = widthLimit % actionMenuPresenter.mMinCellSize;
