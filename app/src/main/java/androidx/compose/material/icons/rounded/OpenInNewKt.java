...
public final class OpenInNewKt {
    ...
    @Deprecated(message = "Use the AutoMirrored version at Icons.AutoMirrored.Rounded.OpenInNew", replaceWith = @ReplaceWith(expression = "Icons.AutoMirrored.Rounded.OpenInNew", imports = {"androidx.compose.material.icons.automirrored.rounded.OpenInNew"}))
    public static /* synthetic */ void getOpenInNew$annotations(Icons.Rounded rounded) {
    }

    public static final ImageVector getOpenInNew(Icons.Rounded $this$OpenInNew) {
        if (_openInNew != null) {
        ...
        ImageVector.Builder $this$_get_OpenInNew__u24lambda_u241 = new ImageVector.Builder("Rounded.OpenInNew", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
