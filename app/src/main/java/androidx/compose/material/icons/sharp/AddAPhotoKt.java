...
public final class AddAPhotoKt {
    ...
    public static final ImageVector getAddAPhoto(Icons.Sharp $this$AddAPhoto) {
        if (_addAPhoto != null) {
        ...
        ImageVector.Builder $this$_get_AddAPhoto__u24lambda_u241 = new ImageVector.Builder("Sharp.AddAPhoto", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
