            ...
            if (numChanges > 0) {
                if (!this.mResizeClip) {
                    ...
                    if (numChanges == 2) {
                        ...
                        } else if (startHeight2 == endHeight) {
                            Path topLeftPath = getPathMotion().getPath(startLeft, startTop, endLeft, endTop);
                            Animator anim2 = ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, topLeftPath);
                            anim = anim2;
                        } else {
                            startHeight = startHeight2;
                            startWidth = startWidth2;
                        ...
                        Path bottomRightPath = getPathMotion().getPath(startRight, startBottom2, endRight, endBottom2);
                        ...
                        Animator anim3 = ObjectAnimatorUtils.ofPointF(view, TOP_LEFT_ONLY_PROPERTY, topLeftPath3);
                        anim = anim3;
                    } else {
                        Path bottomRight = getPathMotion().getPath(startRight, startBottom2, endRight, endBottom2);
                        Animator anim4 = ObjectAnimatorUtils.ofPointF(view, BOTTOM_RIGHT_ONLY_PROPERTY, bottomRight);
                        anim = anim4;
                    }
                } else {
                    z = true;
                    ...
                    boolean startClipIsNull = startClip2 == null;
                    if (startClipIsNull) {
                        startClip = new Rect(0, 0, startWidth2, startHeight2);
                    } else {
