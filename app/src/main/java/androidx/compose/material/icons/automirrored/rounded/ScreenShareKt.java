...
public final class ScreenShareKt {
    ...
    public static final ImageVector getScreenShare(Icons.AutoMirrored.Rounded $this$ScreenShare) {
        ...
        ImageVector.Builder $this$_get_ScreenShare__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Rounded.ScreenShare", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
