...
public final class DragHandleSizes {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof DragHandleSizes) && DpSize.m8245equalsimpl0(this.size, ((DragHandleSizes) other).size) && DpSize.m8245equalsimpl0(this.pressedSize, ((DragHandleSizes) other).pressedSize) && DpSize.m8245equalsimpl0(this.draggedSize, ((DragHandleSizes) other).draggedSize)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = DpSize.m8250hashCodeimpl(this.size);
        return (((result * 31) + DpSize.m8250hashCodeimpl(this.pressedSize)) * 31) + DpSize.m8250hashCodeimpl(this.draggedSize);
    }
}
