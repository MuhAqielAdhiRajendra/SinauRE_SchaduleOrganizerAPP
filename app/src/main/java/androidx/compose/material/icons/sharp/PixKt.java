...
public final class PixKt {
    ...
    public static final ImageVector getPix(Icons.Sharp $this$Pix) {
        if (_pix != null) {
        ...
        ImageVector.Builder $this$_get_Pix__u24lambda_u243 = new ImageVector.Builder("Sharp.Pix", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
