...
final /* data */ class PainterElement extends ModifierNodeElement<PainterModifier> {
    ...
    public void update(PainterModifier node) {
        boolean intrinsicsChanged = node.getSizeToIntrinsics() != this.sizeToIntrinsics || (this.sizeToIntrinsics && !Size.m5133equalsimpl0(node.getPainter().mo6007getIntrinsicSizeNHjbRc(), this.painter.mo6007getIntrinsicSizeNHjbRc()));
