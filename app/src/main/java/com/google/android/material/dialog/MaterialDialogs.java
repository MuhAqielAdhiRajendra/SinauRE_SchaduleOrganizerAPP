...
public class MaterialDialogs {
    ...
    public static Rect getDialogBackgroundInsets(Context context, int defaultStyleAttribute, int defaultStyleResource) {
        ...
        int backgroundInsetLeft = layoutDirection == 1 ? backgroundInsetEnd : backgroundInsetStart;
        int backgroundInsetRight = layoutDirection == 1 ? backgroundInsetStart : backgroundInsetEnd;
