...
public final class NoFoodKt {
    ...
    public static final ImageVector getNoFood(Icons.Sharp $this$NoFood) {
        if (_noFood != null) {
        ...
        ImageVector.Builder $this$_get_NoFood__u24lambda_u241 = new ImageVector.Builder("Sharp.NoFood", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(3.46f, 9.83f, 1.0f, 11.76f, 1.0f, 15.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(1.0f, 23.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(15.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(-2.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineTo(1.0f);
