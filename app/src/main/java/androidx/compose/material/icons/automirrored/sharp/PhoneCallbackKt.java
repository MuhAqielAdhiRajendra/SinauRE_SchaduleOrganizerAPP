...
public final class PhoneCallbackKt {
    ...
    public static final ImageVector getPhoneCallback(Icons.AutoMirrored.Sharp $this$PhoneCallback) {
        ...
        ImageVector.Builder $this$_get_PhoneCallback__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Sharp.PhoneCallback", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(15.73f, 14.85f);
