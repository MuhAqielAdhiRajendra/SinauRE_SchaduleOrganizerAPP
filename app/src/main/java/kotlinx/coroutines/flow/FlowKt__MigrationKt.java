...
final /* synthetic */ class FlowKt__MigrationKt {
    ...
    /* JADX INFO: compiled from: Migration.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u00032\u0015\u0010\u0004\u001a\u00110\u0005¢\u0006\f\b\u0006\u0012\b\b\u0007\u0012\u0004\b\b(\bH\n"}, d2 = {"<anonymous>", "", "T", "Lkotlinx/coroutines/flow/FlowCollector;", "e", "", "Lkotlin/ParameterName;", HintConstants.AUTOFILL_HINT_NAME, "cause"}, k = 3, mv = {2, 0, 0}, xi = 48)
    ...
    public static final <T> Flow<T> onErrorReturn(Flow<? extends T> flow, T t, Function1<? super Throwable, Boolean> function1) {
        return FlowKt.m10470catch(flow, new AnonymousClass2(function1, t, null));
    }
    ...
    static final class C04651<T> extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        final /* synthetic */ long $timeMillis;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04651(long j, Continuation<? super C04651> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C04651(this.$timeMillis, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
            return ((C04651) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Flow<T> delayFlow(Flow<? extends T> flow, long timeMillis) {
        return FlowKt.onStart(flow, new C04651(timeMillis, null));
    }
    ...
    public static final <T> Flow<T> delayEach(Flow<? extends T> flow, long timeMillis) {
        return FlowKt.onEach(flow, new AnonymousClass1(timeMillis, null));
    }
