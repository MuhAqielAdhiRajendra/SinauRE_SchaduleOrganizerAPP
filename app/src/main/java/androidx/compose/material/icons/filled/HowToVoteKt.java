...
public final class HowToVoteKt {
    ...
    public static final ImageVector getHowToVote(Icons.Filled $this$HowToVote) {
        if (_howToVote != null) {
        ...
        ImageVector.Builder $this$_get_HowToVote__u24lambda_u241 = new ImageVector.Builder("Filled.HowToVote", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(17.0f, 7.95f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(12.76f, 2.29f);
