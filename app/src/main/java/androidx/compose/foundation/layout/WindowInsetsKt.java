...
public final class WindowInsetsKt {
    ...
    public static final WindowInsets m1143onlybOOhFvg(WindowInsets $this$only_u2dbOOhFvg, int sides) {
    ...
    public static final PaddingValues asPaddingValues(WindowInsets $this$asPaddingValues, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1485016250, $changed, -1, "androidx.compose.foundation.layout.asPaddingValues (WindowInsets.kt:221)");
        }
        ProvidableCompositionLocal<Density> localDensity = CompositionLocalsKt.getLocalDensity();
        ComposerKt.sourceInformationMarkerStart($composer, 2023513938, "CC(<get-current>):CompositionLocal.kt#9igjgp");
        Object objConsume = $composer.consume(localDensity);
        ComposerKt.sourceInformationMarkerEnd($composer);
        InsetsPaddingValues insetsPaddingValues = new InsetsPaddingValues($this$asPaddingValues, (Density) objConsume);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static /* synthetic */ WindowInsets m1142WindowInsetsa9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m1141WindowInsetsa9UjIt4(f, f2, f3, f4);
    }

    /* JADX INFO: renamed from: WindowInsets-a9UjIt4, reason: not valid java name */
    public static final WindowInsets m1141WindowInsetsa9UjIt4(float left, float top, float right, float bottom) {
