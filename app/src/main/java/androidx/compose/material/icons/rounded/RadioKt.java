...
public final class RadioKt {
    ...
    public static final ImageVector getRadio(Icons.Rounded $this$Radio) {
        if (_radio != null) {
        ...
        ImageVector.Builder $this$_get_Radio__u24lambda_u241 = new ImageVector.Builder("Rounded.Radio", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(7.43f, -3.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.46f, -0.19f, 0.68f, -0.71f, 0.49f, -1.17f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.19f, -0.46f, -0.71f, -0.68f, -1.17f, -0.49f);
