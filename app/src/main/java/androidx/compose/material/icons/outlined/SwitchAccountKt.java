...
public final class SwitchAccountKt {
    ...
    public static final ImageVector getSwitchAccount(Icons.Outlined $this$SwitchAccount) {
        ...
        ImageVector.Builder $this$_get_SwitchAccount__u24lambda_u241 = new ImageVector.Builder("Outlined.SwitchAccount", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(11.0f, 9.66f, 12.34f, 11.0f, 14.0f, 11.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(10.69f, 16.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.95f, -0.63f, 2.09f, -1.0f, 3.31f, -1.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(2.36f, 0.37f, 3.31f, 1.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineTo(10.69f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(20.0f, 15.73f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(18.53f, 14.06f, 16.4f, 13.0f, 14.0f, 13.0f);
