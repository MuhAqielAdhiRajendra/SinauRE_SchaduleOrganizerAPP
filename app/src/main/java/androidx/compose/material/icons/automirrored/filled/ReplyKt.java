...
public final class ReplyKt {
    ...
    public static final ImageVector getReply(Icons.AutoMirrored.Filled $this$Reply) {
        if (_reply != null) {
        ...
        ImageVector.Builder $this$_get_Reply__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Filled.Reply", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
