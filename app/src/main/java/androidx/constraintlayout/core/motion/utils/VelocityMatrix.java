...
public class VelocityMatrix {
    ...
    public void applyTransform(float locationX, float locationY, int width, int height, float[] mAnchorDpDt) {
        ...
        float dx4 = dx3 + (((float) ((((double) ((-width) * offx)) * Math.sin(r)) - (((double) (height * offy)) * Math.cos(r)))) * dr);
        float dy4 = dy3 + (((float) ((((double) (width * offx)) * Math.cos(r)) - (((double) (height * offy)) * Math.sin(r)))) * dr);
        mAnchorDpDt[0] = dx4;
        mAnchorDpDt[1] = dy4;
    }
}
