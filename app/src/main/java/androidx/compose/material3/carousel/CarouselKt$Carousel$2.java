...
final class CarouselKt$Carousel$2 implements Function4<PagerScope, Integer, Composer, Integer, Unit> {
    ...
    CarouselKt$Carousel$2(CarouselState carouselState, CarouselPageSize carouselPageSize, Function4<? super CarouselItemScope, ? super Integer, ? super Composer, ? super Integer, Unit> function4) {
    ...
    public final void invoke(PagerScope $this$HorizontalPager, int page, Composer $composer, int $changed) {
        Function0<ComposeUiNode> function0;
        ComposerKt.sourceInformation($composer, "CN(page)401@18647L39,402@18711L63,403@18803L390,420@19394L21,415@19207L409:Carousel.kt#dcf9yb");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1817116752, $changed, -1, "androidx.compose.material3.carousel.Carousel.<anonymous> (Carousel.kt:401)");
        }
        ...
        if (it$iv3 == Composer.INSTANCE.getEmpty()) {
            Object value$iv3 = new Shape() { // from class: androidx.compose.material3.carousel.CarouselKt$Carousel$2$clipShape$1$1
        ...
        CarouselKt$Carousel$2$clipShape$1$1 clipShape = (CarouselKt$Carousel$2$clipShape$1$1) it$iv3;
        ComposerKt.sourceInformationMarkerEnd($composer);
        ...
        if (invalid$iv || it$iv4 == Composer.INSTANCE.getEmpty()) {
            Object value$iv4 = new Function0() { // from class: androidx.compose.material3.carousel.CarouselKt$Carousel$2$$ExternalSyntheticLambda0
        ...
        int i2 = ((0 >> 6) & 112) | 6;
        ComposerKt.sourceInformationMarkerStart($composer, -868976154, "C425@19589L13:Carousel.kt#dcf9yb");
