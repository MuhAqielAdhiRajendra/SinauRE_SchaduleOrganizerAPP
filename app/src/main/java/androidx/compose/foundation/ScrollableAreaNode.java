...
final class ScrollableAreaNode extends DelegatingNode implements CompositionLocalConsumerModifierNode, ObserverModifierNode {
    ...
    public ScrollableAreaNode(ScrollableState state, Orientation orientation, boolean enabled, boolean reverseScrolling, FlingBehavior flingBehavior, MutableInteractionSource interactionSource, BringIntoViewSpec bringIntoViewSpec, boolean useLocalOverscrollFactory, OverscrollEffect userProvidedOverscrollEffect) {
        this.state = state;
    ...
    static final Unit attachOverscrollNodeIfNeeded$lambda$0(ScrollableAreaNode this$0) {
