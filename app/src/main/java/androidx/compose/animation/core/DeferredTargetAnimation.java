...
public final class DeferredTargetAnimation<T, V extends AnimationVector> {
    ...
    public final T updateTarget(T target, CoroutineScope coroutineScope, FiniteAnimationSpec<T> animationSpec) {
        ...
        BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new AnonymousClass1(animatable, this, target, animationSpec, null), 3, null);
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (!Intrinsics.areEqual(this.$anim.getTargetValue(), this.this$0.get_pendingTarget())) {
                        ...
                        T t = this.$target;
                        FiniteAnimationSpec<T> finiteAnimationSpec = this.$animationSpec;
                        this.label = 1;
                        if (animatable.animateTo(t, (14 & 2) != 0 ? animatable.defaultSpringSpec : finiteAnimationSpec, (14 & 4) != 0 ? animatable.getVelocity() : null, (14 & 8) != 0 ? null : null, this) == coroutine_suspended) {
