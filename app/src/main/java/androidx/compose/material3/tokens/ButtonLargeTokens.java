...
public final class ButtonLargeTokens {
    ...
    private static final float IconLabelSpace = Dp.m8150constructorimpl((float) 12.0d);
    private static final float IconSize = Dp.m8150constructorimpl((float) 32.0d);
    private static final float LeadingSpace = Dp.m8150constructorimpl((float) 48.0d);
    ...
    private static final float TrailingSpace = Dp.m8150constructorimpl((float) 48.0d);

    private ButtonLargeTokens() {
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m3597getContainerHeightD9Ej5fM() {
    ...
    public final float m3598getIconLabelSpaceD9Ej5fM() {
        return IconLabelSpace;
    }

    /* JADX INFO: renamed from: getIconSize-D9Ej5fM, reason: not valid java name */
    public final float m3599getIconSizeD9Ej5fM() {
        return IconSize;
    }

    /* JADX INFO: renamed from: getLeadingSpace-D9Ej5fM, reason: not valid java name */
    public final float m3600getLeadingSpaceD9Ej5fM() {
        return LeadingSpace;
    }

    /* JADX INFO: renamed from: getOutlinedOutlineWidth-D9Ej5fM, reason: not valid java name */
    public final float m3601getOutlinedOutlineWidthD9Ej5fM() {
    ...
    public final float m3602getTrailingSpaceD9Ej5fM() {
