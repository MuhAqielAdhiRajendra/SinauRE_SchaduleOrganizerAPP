...
public final class MarkChatReadKt {
    ...
    public static final ImageVector getMarkChatRead(Icons.Filled $this$MarkChatRead) {
        ...
        ImageVector.Builder $this$_get_MarkChatRead__u24lambda_u241 = new ImageVector.Builder("Filled.MarkChatRead", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(17.34f, 20.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(12.01f, 17.34f, 12.0f, 17.17f, 12.0f, 17.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
