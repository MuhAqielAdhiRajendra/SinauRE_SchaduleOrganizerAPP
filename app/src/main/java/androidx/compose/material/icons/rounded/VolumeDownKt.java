...
public final class VolumeDownKt {
    ...
    @Deprecated(message = "Use the AutoMirrored version at Icons.AutoMirrored.Rounded.VolumeDown", replaceWith = @ReplaceWith(expression = "Icons.AutoMirrored.Rounded.VolumeDown", imports = {"androidx.compose.material.icons.automirrored.rounded.VolumeDown"}))
    public static /* synthetic */ void getVolumeDown$annotations(Icons.Rounded rounded) {
    }

    public static final ImageVector getVolumeDown(Icons.Rounded $this$VolumeDown) {
        if (_volumeDown != null) {
        ...
        ImageVector.Builder $this$_get_VolumeDown__u24lambda_u241 = new ImageVector.Builder("Rounded.VolumeDown", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
