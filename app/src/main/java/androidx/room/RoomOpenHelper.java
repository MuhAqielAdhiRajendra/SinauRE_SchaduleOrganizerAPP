...
public class RoomOpenHelper extends SupportSQLiteOpenHelper.Callback {
    ...
    public void onCreate(SupportSQLiteDatabase db) throws IOException {
        Intrinsics.checkNotNullParameter(db, "db");
        boolean isEmptyDatabase = INSTANCE.hasEmptySchema$room_runtime(db);
    ...
    @Override // androidx.sqlite.db.SupportSQLiteOpenHelper.Callback
    public void onUpgrade(SupportSQLiteDatabase db, int oldVersion, int newVersion) throws IOException {
        Iterable iterableFindMigrationPath;
        Intrinsics.checkNotNullParameter(db, "db");
        boolean migrated = false;
        DatabaseConfiguration config = this.configuration;
        if (config != null && (iterableFindMigrationPath = config.migrationContainer.findMigrationPath(oldVersion, newVersion)) != null) {
            this.delegate.onPreMigrate(db);
            Iterable $this$forEach$iv = iterableFindMigrationPath;
            for (Object element$iv : $this$forEach$iv) {
    ...
    @Override // androidx.sqlite.db.SupportSQLiteOpenHelper.Callback
    public void onDowngrade(SupportSQLiteDatabase db, int oldVersion, int newVersion) throws IOException {
        Intrinsics.checkNotNullParameter(db, "db");
    ...
    private final void checkIdentity(SupportSQLiteDatabase db) throws IOException {
    ...
    public static final class Companion {
        ...
        public final boolean hasRoomMasterTable$room_runtime(SupportSQLiteDatabase db) throws IOException {
            Intrinsics.checkNotNullParameter(db, "db");
        ...
        public final boolean hasEmptySchema$room_runtime(SupportSQLiteDatabase db) throws IOException {
            Intrinsics.checkNotNullParameter(db, "db");
        ...
        public final void dropAllTables$room_runtime(SupportSQLiteDatabase db) throws IOException {
            Intrinsics.checkNotNullParameter(db, "db");
            ...
            try {
                ...
                Iterable iterableBuild = CollectionsKt.build($this$dropAllTables_u24lambda_u243_u24lambda_u242);
                CloseableKt.closeFinally(cursor, null);
                Iterable $this$forEach$iv = iterableBuild;
                for (Object element$iv : $this$forEach$iv) {
