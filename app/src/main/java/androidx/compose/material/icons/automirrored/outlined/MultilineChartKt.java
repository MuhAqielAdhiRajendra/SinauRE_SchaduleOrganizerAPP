...
public final class MultilineChartKt {
    ...
    public static final ImageVector getMultilineChart(Icons.AutoMirrored.Outlined $this$MultilineChart) {
        ...
        ImageVector.Builder $this$_get_MultilineChart__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Outlined.MultilineChart", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
