    ...
    protected boolean measureChildren() {
        ...
        while (true) {
            ...
            if (widget != null && !(widget instanceof Guideline)) {
                ...
                boolean skip = widthBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && widget.mMatchConstraintDefaultWidth != 1 && heightBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && widget.mMatchConstraintDefaultHeight != 1;
                if (!skip) {
