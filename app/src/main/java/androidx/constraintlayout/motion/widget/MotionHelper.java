...
public class MotionHelper extends ConstraintHelper implements MotionHelperInterface {
    ...
    public MotionHelper(Context context, AttributeSet attrs) throws IllegalAccessException {
        super(context, attrs);
        this.mUseOnShow = false;
        this.mUseOnHide = false;
        init(attrs);
    ...
    public MotionHelper(Context context, AttributeSet attrs, int defStyleAttr) throws IllegalAccessException {
