...
public interface MeasureBlocks {
    ...
    MeasureResult m7049measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> measurables, long constraints);
