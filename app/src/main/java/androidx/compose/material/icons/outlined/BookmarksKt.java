...
public final class BookmarksKt {
    ...
    public static final ImageVector getBookmarks(Icons.Outlined $this$Bookmarks) {
        if (_bookmarks != null) {
        ...
        ImageVector.Builder $this$_get_Bookmarks__u24lambda_u241 = new ImageVector.Builder("Outlined.Bookmarks", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveToRelative(4.0f, -6.0f);
