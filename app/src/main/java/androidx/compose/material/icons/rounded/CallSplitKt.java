...
public final class CallSplitKt {
    ...
    public static final ImageVector getCallSplit(Icons.Rounded $this$CallSplit) {
        if (_callSplit != null) {
        ...
        ImageVector.Builder $this$_get_CallSplit__u24lambda_u241 = new ImageVector.Builder("Rounded.CallSplit", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
