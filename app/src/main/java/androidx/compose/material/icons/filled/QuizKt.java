...
public final class QuizKt {
    ...
    public static final ImageVector getQuiz(Icons.Filled $this$Quiz) {
        if (_quiz != null) {
        ...
        ImageVector.Builder $this$_get_Quiz__u24lambda_u242 = new ImageVector.Builder("Filled.Quiz", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveToRelative(0.0f, -0.41f, -0.06f, -1.08f, 0.26f, -1.65f);
