...
public final class ScoreboardKt {
    ...
    public static final ImageVector getScoreboard(Icons.Sharp $this$Scoreboard) {
        if (_scoreboard != null) {
        ...
        ImageVector.Builder $this$_get_Scoreboard__u24lambda_u241 = new ImageVector.Builder("Sharp.Scoreboard", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
