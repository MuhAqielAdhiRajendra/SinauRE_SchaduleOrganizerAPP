...
final class AlignmentLineOffsetDpNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m723setBefore0680j_4(float f) {
        this.before = f;
    }
    ...
    public final void m722setAfter0680j_4(float f) {
        this.after = f;
    }
    ...
    public MeasureResult mo67measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        return AlignmentLineKt.m709alignmentLineOffsetMeasuretjqqzMA($this$measure_u2d3p2s80s, this.alignmentLine, this.before, this.after, measurable, constraints);
    }
}
