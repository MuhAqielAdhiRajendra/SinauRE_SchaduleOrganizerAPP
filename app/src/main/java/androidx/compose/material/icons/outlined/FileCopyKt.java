...
public final class FileCopyKt {
    ...
    public static final ImageVector getFileCopy(Icons.Outlined $this$FileCopy) {
        if (_fileCopy != null) {
        ...
        ImageVector.Builder $this$_get_FileCopy__u24lambda_u241 = new ImageVector.Builder("Outlined.FileCopy", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
