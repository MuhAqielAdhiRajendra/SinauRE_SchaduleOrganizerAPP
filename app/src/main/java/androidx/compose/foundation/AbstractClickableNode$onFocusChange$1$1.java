...
@DebugMetadata(c = "androidx.compose.foundation.AbstractClickableNode$onFocusChange$1$1", f = "Clickable.kt", i = {}, l = {1900}, m = "invokeSuspend", n = {}, s = {}, v = 1)
final class AbstractClickableNode$onFocusChange$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    AbstractClickableNode$onFocusChange$1$1(AbstractClickableNode abstractClickableNode, PressInteraction.Press press, Continuation<? super AbstractClickableNode$onFocusChange$1$1> continuation) {
