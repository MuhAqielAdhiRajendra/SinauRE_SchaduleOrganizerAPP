...
public abstract class IntIntMap {
            ...
            if ((((~slot$iv) << 7) & slot$iv & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (j$iv < bitCount$iv) {
                    ...
                    if (!(value$iv$iv < 128)) {
                        ...
                        i = i2;
                        block.invoke(Integer.valueOf(k2[index$iv]), Integer.valueOf(v[index$iv]));
                    }
                    slot$iv >>= i;
                    j$iv++;
                    i2 = i;
    ...
    public static /* synthetic */ String joinToString$default(IntIntMap intIntMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        ...
        return intIntMap.joinToString(charSequence, charSequence2, charSequence3, i, (i2 & 16) != 0 ? "..." : charSequence4);
    }
            ...
            if ($this$maskEmptyOrDeleted$iv$iv$iv == -9187201950435737472L) {
                ...
                while (j$iv$iv < bitCount$iv$iv) {
                    ...
                    if (!(value$iv$iv$iv < 128 ? z5 : z6)) {
                        ...
                        int key = k$iv[index$iv$iv];
                        i = value;
                        int value2 = v$iv[index$iv$iv];
                        int index = ((IntIntMap) other).findKeyIndex(key);
                        if (index < 0 || value2 != ((IntIntMap) other).values[index]) {
                            break loop0;
                        }
                    }
                    slot$iv$iv >>= i;
