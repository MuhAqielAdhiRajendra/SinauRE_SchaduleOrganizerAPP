...
public final class ChainedPlatformTextInputInterceptor$textInputSession$2$scope$1 implements PlatformTextInputSessionScope {
    ...
    ChainedPlatformTextInputInterceptor$textInputSession$2$scope$1(PlatformTextInputSessionScope $parentSession, AtomicReference<SessionMutex.Session<Unit>> atomicReference, ChainedPlatformTextInputInterceptor $receiver) {
    ...
    */
    public java.lang.Object startInputMethod(androidx.compose.ui.platform.PlatformTextInputMethodRequest r11, kotlin.coroutines.Continuation<?> r12) {
        ...
        L30:
            kotlin.ResultKt.throwOnFailure(r1)
            r3 = r10
            java.util.concurrent.atomic.AtomicReference<androidx.compose.ui.SessionMutex$Session<kotlin.Unit>> r4 = r3.$inputMethodMutex
            ...
            r7 = 1
            r0.label = r7
            java.lang.Object r11 = androidx.compose.ui.SessionMutex.m4757withSessionCancellingPreviousimpl(r4, r5, r6, r0)
            if (r11 != r2) goto L50
            return r2
        L50:
