...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo10442receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo10442receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo10443tryReceivePtdJZtk() {
        return this._channel.mo10443tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo10436trySendJP2dKIU(E e) {
        return this._channel.mo10436trySendJP2dKIU(e);
    }
