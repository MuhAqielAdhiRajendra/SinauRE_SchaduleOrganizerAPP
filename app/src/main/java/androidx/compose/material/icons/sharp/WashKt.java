...
public final class WashKt {
    ...
    public static final ImageVector getWash(Icons.Sharp $this$Wash) {
        if (_wash != null) {
        ...
        ImageVector.Builder $this$_get_Wash__u24lambda_u241 = new ImageVector.Builder("Sharp.Wash", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
