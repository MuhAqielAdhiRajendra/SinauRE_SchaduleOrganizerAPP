...
class SystemBarStateMonitor {
    ...
    SystemBarStateMonitor(final ViewGroup rootView) {
        ...
        this.mDetector.setVisibility(8);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this.mDetector, new OnApplyWindowInsetsListener() { // from class: androidx.core.view.insets.SystemBarStateMonitor$$ExternalSyntheticLambda0
            ...
            public final WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                return this.f$0.m8442lambda$new$0$androidxcoreviewinsetsSystemBarStateMonitor(view, windowInsetsCompat);
            }
        });
        ...
        addViewWhenReady(rootView, this.mDetector, 0);
    }

    /* JADX INFO: renamed from: lambda$new$0$androidx-core-view-insets-SystemBarStateMonitor, reason: not valid java name */
    /* synthetic */ WindowInsetsCompat m8442lambda$new$0$androidxcoreviewinsetsSystemBarStateMonitor(View view, WindowInsetsCompat windowInsets) {
    ...
    private static void addViewWhenReady(final ViewGroup group, final View child, final int index) {
        ...
        while (true) {
            ...
            View existingChild = group.getChildAt(i);
        ...
        if (lastDispatching == null) {
            ...
            lastDispatching.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: androidx.core.view.insets.SystemBarStateMonitor.3
