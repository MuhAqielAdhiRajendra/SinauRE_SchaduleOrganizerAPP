...
public final class ShopTwoKt {
    ...
    public static final ImageVector getShopTwo(Icons.Filled $this$ShopTwo) {
        if (_shopTwo != null) {
        ...
        ImageVector.Builder $this$_get_ShopTwo__u24lambda_u241 = new ImageVector.Builder("Filled.ShopTwo", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
