...
public final class AcUnitKt {
    ...
    public static final ImageVector getAcUnit(Icons.Rounded $this$AcUnit) {
        if (_acUnit != null) {
        ...
        ImageVector.Builder $this$_get_AcUnit__u24lambda_u241 = new ImageVector.Builder("Rounded.AcUnit", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(3.95f, -3.95f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(8.46f, 3.63f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.39f, 0.39f, -0.39f, 1.03f, 0.0f, 1.42f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(5.05f, 7.05f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.39f, -0.39f, -1.03f, -0.39f, -1.42f, 0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
