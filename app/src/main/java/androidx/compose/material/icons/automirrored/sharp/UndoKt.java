...
public final class UndoKt {
    ...
    public static final ImageVector getUndo(Icons.AutoMirrored.Sharp $this$Undo) {
        if (_undo != null) {
        ...
        ImageVector.Builder $this$_get_Undo__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Sharp.Undo", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
