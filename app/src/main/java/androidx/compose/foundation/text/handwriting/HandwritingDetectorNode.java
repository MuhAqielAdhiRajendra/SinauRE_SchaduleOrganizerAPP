...
final class HandwritingDetectorNode extends DelegatingNode implements PointerInputModifierNode {
    ...
    static final Unit pointerInputNode$lambda$0(HandwritingDetectorNode this$0) {
    ...
    public long mo1708getTouchBoundsExpansionRZrCHBk() {
        return this.pointerInputNode.mo1708getTouchBoundsExpansionRZrCHBk();
    }
}
