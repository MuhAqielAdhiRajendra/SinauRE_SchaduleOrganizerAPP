...
public class NavigationView extends ScrimInsetsFrameLayout implements MaterialBackHandler {
    ...
    public NavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (a.hasValue(com.google.android.material.R.styleable.NavigationView_android_background)) {
            setBackground(a.getDrawable(com.google.android.material.R.styleable.NavigationView_android_background));
        }
        ...
        if (itemBackground == null && hasShapeAppearance(a)) {
            ...
            if (itemRippleColor != null) {
                ...
                FocusRingDrawable focusRingDrawable = FocusRingDrawable.layer(context2, ripple);
                if (focusRingDrawable != null) {
                    focusRingDrawable.setFocusRingShapeAppearance(this.itemShapeAppearanceModel);
                }
        ...
        setStartInsetScrimEnabled(a.getBoolean(com.google.android.material.R.styleable.NavigationView_startInsetScrimEnabled, this.startInsetScrimEnabled));
        setEndInsetScrimEnabled(a.getBoolean(com.google.android.material.R.styleable.NavigationView_endInsetScrimEnabled, this.endInsetScrimEnabled));
    ...
    private void maybeUpdateCornerSizeForDrawerLayout(int width, int height) {
        if ((getParent() instanceof DrawerLayout) && (getLayoutParams() instanceof DrawerLayout.LayoutParams)) {
            if ((this.drawerLayoutCornerSize > 0 || this.drawerLayoutCornerSizeBackAnimationEnabled) && (getBackground() instanceof MaterialShapeDrawable)) {
                ...
                boolean isAbsGravityLeft = Gravity.getAbsoluteGravity(layoutGravity, getLayoutDirection()) == 3;
    ...
    private Drawable createDefaultItemDrawable(TintTypedArray a, ColorStateList fillColor) {
        ...
        this.itemShapeAppearanceModel = ShapeAppearanceModel.builder(getContext(), shapeAppearanceResId, shapeAppearanceOverlayResId).build();
    ...
    protected void dispatchDraw(Canvas canvas) {
        this.shapeableDelegate.maybeClip(canvas, new CanvasCompat.CanvasOperation() { // from class: com.google.android.material.navigation.NavigationView$$ExternalSyntheticLambda0
            ...
            public final void run(Canvas canvas2) {
                this.f$0.m8848xb790515(canvas2);
            }
        });
    }
    ...
    /* synthetic */ void m8848xb790515(Canvas x$0) {
    ...
    private class FocusDrawerListener extends DrawerLayout.SimpleDrawerListener {
        ...
        @Override // androidx.drawerlayout.widget.DrawerLayout.SimpleDrawerListener, androidx.drawerlayout.widget.DrawerLayout.DrawerListener
        public void onDrawerClosed(View drawerView) {
            if (drawerView != NavigationView.this || this.lastFocusedView == null) {
                return;
            }
            View viewToFocus = this.lastFocusedView.get();
