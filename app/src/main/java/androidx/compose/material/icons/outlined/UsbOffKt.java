...
public final class UsbOffKt {
    ...
    public static final ImageVector getUsbOff(Icons.Outlined $this$UsbOff) {
        if (_usbOff != null) {
        ...
        ImageVector.Builder $this$_get_UsbOff__u24lambda_u241 = new ImageVector.Builder("Outlined.UsbOff", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
