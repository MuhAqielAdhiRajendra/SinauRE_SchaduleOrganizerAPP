...
public final class VectorResources_androidKt {
    ...
    public static final ImageVector vectorResource(ImageVector.Companion $this$vectorResource, Resources.Theme theme, Resources res, int resId) throws XmlPullParserException, IOException {
