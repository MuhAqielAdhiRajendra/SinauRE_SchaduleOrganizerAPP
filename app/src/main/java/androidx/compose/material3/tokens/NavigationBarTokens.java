...
public final class NavigationBarTokens {
    ...
    private static final float ItemActiveIndicatorIconLabelSpace = Dp.m8150constructorimpl((float) 4.0d);
    ...
    private static final float ItemBetweenSpace = Dp.m8150constructorimpl((float) 0.0d);
    ...
    private static final float TallContainerHeight = Dp.m8150constructorimpl((float) 80.0d);
