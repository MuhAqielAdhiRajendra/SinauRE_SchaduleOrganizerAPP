...
public final class LayoutHelper {
    ...
    public final float getHorizontalPosition(int offset, boolean usePrimaryDirection, boolean upstream) {
        ...
        Bidi bidiAnalyzeBidi = analyzeBidi(paraNo);
        Bidi lineBidi = bidiAnalyzeBidi != null ? bidiAnalyzeBidi.createLineBidi(bidiStart, bidiEnd) : null;
        ...
        if (offset != lineStart) {
            ...
            if (isLeftRequested) {
                return layout2.getPrimaryHorizontal(runs[index$iv - 1].getEnd());
            }
            return layout2.getPrimaryHorizontal(runs[index$iv + 1].getEnd());
        }
        int index$iv2 = 0;
        ...
        if (isLeftRequested2) {
            return layout3.getPrimaryHorizontal(runs[index - 1].getStart());
        }
        return layout3.getPrimaryHorizontal(runs[index + 1].getStart());
    }
    ...
    /* JADX INFO: compiled from: LayoutHelper.android.kt */
    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u000e\n\u0002\u0010\u000e\n\u0000\b\u0081\b\u0018\u00002\u00020\u0001B\u001f\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0003\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0004\b\u0007\u0010\bJ\t\u0010\r\u001a\u00020\u0003HÆ\u0003J\t\u0010\u000e\u001a\u00020\u0003HÆ\u0003J\t\u0010\u000f\u001a\u00020\u0006HÆ\u0003J'\u0010\u0010\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u00032\b\b\u0002\u0010\u0005\u001a\u00020\u0006HÆ\u0001J\u0014\u0010\u0011\u001a\u00020\u00062\b\u0010\u0012\u001a\u0004\u0018\u00010\u0001HÖ\u0083\u0004J\n\u0010\u0013\u001a\u00020\u0003HÖ\u0081\u0004J\n\u0010\u0014\u001a\u00020\u0015HÖ\u0081\u0004R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\nR\u0011\u0010\u0004\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\nR\u0011\u0010\u0005\u001a\u00020\u0006¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\f¨\u0006\u0016"}, d2 = {"Landroidx/compose/ui/text/android/LayoutHelper$BidiRun;", "", "start", "", "end", "isRtl", "", "<init>", "(IIZ)V", "getStart", "()I", "getEnd", "()Z", "component1", "component2", "component3", "copy", "equals", "other", "hashCode", "toString", "", "ui-text"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    public final BidiRun[] getLineBidiRuns$ui_text(int lineIndex) {
        ...
        Bidi bidiAnalyzeBidi = analyzeBidi(paragraphIndex);
        if (bidiAnalyzeBidi == null || (lineBidi = bidiAnalyzeBidi.createLineBidi(bidiStart, bidiEnd)) == null) {
            char c2 = 0;
            BidiRun[] bidiRunArr = new BidiRun[1];
            bidiRunArr[c2] = new BidiRun(lineStart, lineEnd, this.layout.isRtlCharAt(lineStart));
            return bidiRunArr;
        }
        int runCount = lineBidi.getRunCount();
        BidiRun[] bidiRunArr2 = new BidiRun[runCount];
        int i = 0;
        while (i < runCount) {
            boolean z2 = z;
            char c3 = c;
            bidiRunArr2[i] = new BidiRun(lineStart + lineBidi.getRunStart(i), lineStart + lineBidi.getRunLimit(i), lineBidi.getRunLevel(i) % 2 == 1 ? true : z2);
            i++;
            z = z2;
            c = c3;
        }
