...
final /* data */ class GraphicsLayerElement extends ModifierNodeElement<SimpleGraphicsLayerModifier> {
    ...
    public static /* synthetic */ GraphicsLayerElement m5461copycp5nf6A$default(GraphicsLayerElement graphicsLayerElement, float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i, int i2, ColorFilter colorFilter, int i3, Object obj) {
        ...
        return graphicsLayerElement.m5467copycp5nf6A(f21, f12, f13, f14, f15, f16, f17, f18, f19, f20, j4, shape2, z2, renderEffect2, j5, j6, i4, i6, colorFilter2);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Float.compare(this.scaleX, graphicsLayerElement.scaleX) == 0 && Float.compare(this.scaleY, graphicsLayerElement.scaleY) == 0 && Float.compare(this.alpha, graphicsLayerElement.alpha) == 0 && Float.compare(this.translationX, graphicsLayerElement.translationX) == 0 && Float.compare(this.translationY, graphicsLayerElement.translationY) == 0 && Float.compare(this.shadowElevation, graphicsLayerElement.shadowElevation) == 0 && Float.compare(this.rotationX, graphicsLayerElement.rotationX) == 0 && Float.compare(this.rotationY, graphicsLayerElement.rotationY) == 0 && Float.compare(this.rotationZ, graphicsLayerElement.rotationZ) == 0 && Float.compare(this.cameraDistance, graphicsLayerElement.cameraDistance) == 0 && TransformOrigin.m5720equalsimpl0(this.transformOrigin, graphicsLayerElement.transformOrigin) && Intrinsics.areEqual(this.shape, graphicsLayerElement.shape) && this.clip == graphicsLayerElement.clip && Intrinsics.areEqual(this.renderEffect, graphicsLayerElement.renderEffect) && Color.m5314equalsimpl0(this.ambientShadowColor, graphicsLayerElement.ambientShadowColor) && Color.m5314equalsimpl0(this.spotShadowColor, graphicsLayerElement.spotShadowColor) && CompositingStrategy.m5398equalsimpl0(this.compositingStrategy, graphicsLayerElement.compositingStrategy) && BlendMode.m5222equalsimpl0(this.blendMode, graphicsLayerElement.blendMode) && Intrinsics.areEqual(this.colorFilter, graphicsLayerElement.colorFilter);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((Float.hashCode(this.scaleX) * 31) + Float.hashCode(this.scaleY)) * 31) + Float.hashCode(this.alpha)) * 31) + Float.hashCode(this.translationX)) * 31) + Float.hashCode(this.translationY)) * 31) + Float.hashCode(this.shadowElevation)) * 31) + Float.hashCode(this.rotationX)) * 31) + Float.hashCode(this.rotationY)) * 31) + Float.hashCode(this.rotationZ)) * 31) + Float.hashCode(this.cameraDistance)) * 31) + TransformOrigin.m5723hashCodeimpl(this.transformOrigin)) * 31) + this.shape.hashCode()) * 31) + Boolean.hashCode(this.clip)) * 31) + (this.renderEffect == null ? 0 : this.renderEffect.hashCode())) * 31) + Color.m5320hashCodeimpl(this.ambientShadowColor)) * 31) + Color.m5320hashCodeimpl(this.spotShadowColor)) * 31) + CompositingStrategy.m5399hashCodeimpl(this.compositingStrategy)) * 31) + BlendMode.m5223hashCodeimpl(this.blendMode)) * 31) + (this.colorFilter != null ? this.colorFilter.hashCode() : 0);
    }
    ...
    public final long m5472getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }
    ...
    public void update(SimpleGraphicsLayerModifier node) {
        ...
        node.m5668setTransformOrigin__ExYCQ(this.transformOrigin);
        node.setShape(this.shape);
        node.setClip(this.clip);
        node.setRenderEffect(this.renderEffect);
        node.m5664setAmbientShadowColor8_81llA(this.ambientShadowColor);
        node.m5667setSpotShadowColor8_81llA(this.spotShadowColor);
        node.m5666setCompositingStrategyaDBOjCE(this.compositingStrategy);
        node.m5665setBlendModes9anfk8(this.blendMode);
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("transformOrigin", TransformOrigin.m5713boximpl(this.transformOrigin));
        ...
        $this$inspectableProperties.getProperties().set("ambientShadowColor", Color.m5303boximpl(this.ambientShadowColor));
        $this$inspectableProperties.getProperties().set("spotShadowColor", Color.m5303boximpl(this.spotShadowColor));
        $this$inspectableProperties.getProperties().set("compositingStrategy", CompositingStrategy.m5395boximpl(this.compositingStrategy));
        $this$inspectableProperties.getProperties().set("blendMode", BlendMode.m5219boximpl(this.blendMode));
