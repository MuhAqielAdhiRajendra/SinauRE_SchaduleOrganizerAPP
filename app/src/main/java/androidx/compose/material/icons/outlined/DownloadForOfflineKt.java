...
public final class DownloadForOfflineKt {
    ...
    public static final ImageVector getDownloadForOffline(Icons.Outlined $this$DownloadForOffline) {
        ...
        ImageVector.Builder $this$_get_DownloadForOffline__u24lambda_u241 = new ImageVector.Builder("Outlined.DownloadForOffline", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(14.59f, 8.59f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(11.0f, 10.17f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(14.59f, 8.59f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _downloadForOffline = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_DownloadForOffline__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
