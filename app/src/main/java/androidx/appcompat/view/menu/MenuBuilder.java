    ...
    public boolean expandItemActionView(MenuItemImpl item) {
        ...
        for (WeakReference<MenuPresenter> ref : this.mPresenters) {
            ...
            if (presenter == null) {
                ...
                boolean zExpandItemActionView = presenter.expandItemActionView(this, item);
                expanded = zExpandItemActionView;
    ...
    public boolean collapseItemActionView(MenuItemImpl item) {
        ...
        for (WeakReference<MenuPresenter> ref : this.mPresenters) {
            ...
            if (presenter == null) {
                ...
                boolean zCollapseItemActionView = presenter.collapseItemActionView(this, item);
                collapsed = zCollapseItemActionView;
