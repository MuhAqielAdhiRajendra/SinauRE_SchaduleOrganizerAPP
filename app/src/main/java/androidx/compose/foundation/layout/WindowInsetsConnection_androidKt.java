...
public final class WindowInsetsConnection_androidKt {
    ...
    static final Modifier imeNestedScroll$lambda$1(Modifier $this$composed, Composer $composer, int $changed) {
        ...
        NestedScrollConnection nestedScrollConnection = m1140rememberWindowInsetsConnectionVRgvIgI(WindowInsetsHolder.INSTANCE.current($composer, 6).getIme(), WindowInsetsSides.INSTANCE.m1163getBottomJoeWqyM(), $composer, 48);
        Modifier modifierNestedScroll$default = NestedScrollModifierKt.nestedScroll$default($this$composed, nestedScrollConnection, null, 2, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final NestedScrollConnection m1140rememberWindowInsetsConnectionVRgvIgI(AndroidWindowInsets windowInsets, int side, Composer $composer, int $changed) {
        ...
        SideCalculator sideCalculator = SideCalculator.INSTANCE.m1098chooseCalculatorni1skBw(side, layoutDirection);
        ...
        if (invalid$iv2 || it$iv2 == Composer.INSTANCE.getEmpty()) {
            Object value$iv2 = new Function1() { // from class: androidx.compose.foundation.layout.WindowInsetsConnection_androidKt$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj) {
                    return WindowInsetsConnection_androidKt.rememberWindowInsetsConnection_VRgvIgI$lambda$1$0(connection, (DisposableEffectScope) obj);
                }
            };
    ...
    public static final DisposableEffectResult rememberWindowInsetsConnection_VRgvIgI$lambda$1$0(final WindowInsetsNestedScrollConnection $connection, DisposableEffectScope $this$DisposableEffect) {
