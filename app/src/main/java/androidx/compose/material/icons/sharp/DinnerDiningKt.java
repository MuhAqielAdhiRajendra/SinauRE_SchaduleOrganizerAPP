...
public final class DinnerDiningKt {
    ...
    public static final ImageVector getDinnerDining(Icons.Sharp $this$DinnerDining) {
        ...
        ImageVector.Builder $this$_get_DinnerDining__u24lambda_u242 = new ImageVector.Builder("Sharp.DinnerDining", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
        $this$PathData_u24lambda_u240$iv$iv$iv2.moveTo(10.0f, 5.25f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.horizontalLineTo(8.0f);
