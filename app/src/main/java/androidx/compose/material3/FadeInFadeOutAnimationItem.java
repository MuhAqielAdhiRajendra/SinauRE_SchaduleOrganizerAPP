...
final /* data */ class FadeInFadeOutAnimationItem<T> {
    ...
    public int hashCode() {
        return ((this.key == null ? 0 : this.key.hashCode()) * 31) + this.transition.hashCode();
    }
