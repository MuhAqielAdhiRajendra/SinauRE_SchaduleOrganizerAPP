...
final class RoundedCorner {
    ...
    private RoundedCorner(long p0, long p1, long p2, CornerRounding rounding) {
        ...
        this.d1 = PointKt.m8472getDirectionDnnuFBc(PointKt.m8478minusybeJwSQ(this.p0, this.p1));
        this.d2 = PointKt.m8472getDirectionDnnuFBc(PointKt.m8478minusybeJwSQ(this.p2, this.p1));
        ...
        this.cosAngle = PointKt.m8471dotProductybeJwSQ(this.d1, this.d2);
        this.sinAngle = (float) Math.sqrt(1.0f - Utils.square(this.cosAngle));
        if (this.sinAngle > 0.001d) {
            f = (this.cornerRadius * (this.cosAngle + 1.0f)) / this.sinAngle;
        } else {
            f = 0.0f;
        }
    ...
    public final void m8493setCenterDnnuFBc(long j) {
        this.center = j;
    }
    ...
    public final List<Cubic> getCubics(float allowedCut0, float allowedCut1) {
        ...
        if (this.expectedRoundCut < 1.0E-4f || allowedCut < 1.0E-4f || this.cornerRadius < 1.0E-4f) {
            this.center = this.p1;
            return CollectionsKt.listOf(Cubic.INSTANCE.straightLine(PointKt.m8475getXDnnuFBc(this.p1), PointKt.m8476getYDnnuFBc(this.p1), PointKt.m8475getXDnnuFBc(this.p1), PointKt.m8476getYDnnuFBc(this.p1)));
        }
        ...
        this.center = PointKt.m8479plusybeJwSQ(this.p1, PointKt.m8481timesso9K2fw(PointKt.m8472getDirectionDnnuFBc(PointKt.m8469divso9K2fw(PointKt.m8479plusybeJwSQ(this.d1, this.d2), 2.0f)), centerDistance));
        long circleIntersection0 = PointKt.m8479plusybeJwSQ(this.p1, PointKt.m8481timesso9K2fw(this.d1, actualRoundCut));
        long circleIntersection2 = PointKt.m8479plusybeJwSQ(this.p1, PointKt.m8481timesso9K2fw(this.d2, actualRoundCut));
        Cubic flanking0 = m8485computeFlankingCurveoAJzIJU(actualRoundCut, actualSmoothing0, this.p1, this.p0, circleIntersection0, circleIntersection2, this.center, actualR);
        Cubic flanking2 = m8485computeFlankingCurveoAJzIJU(actualRoundCut, actualSmoothing1, this.p1, this.p2, circleIntersection2, circleIntersection0, this.center, actualR).reverse();
        return CollectionsKt.listOf((Object[]) new Cubic[]{flanking0, Cubic.INSTANCE.circularArc(PointKt.m8475getXDnnuFBc(this.center), PointKt.m8476getYDnnuFBc(this.center), flanking0.getAnchor1X(), flanking0.getAnchor1Y(), flanking2.getAnchor0X(), flanking2.getAnchor0Y()), flanking2});
    }
    ...
    private final Cubic m8485computeFlankingCurveoAJzIJU(float actualRoundCut, float actualSmoothingValues, long corner, long sideStart, long circleSegmentIntersection, long otherCircleSegmentIntersection, long circleCenter, float actualR) {
        long sideDirection = PointKt.m8472getDirectionDnnuFBc(PointKt.m8478minusybeJwSQ(sideStart, corner));
        long curveStart = PointKt.m8479plusybeJwSQ(corner, PointKt.m8481timesso9K2fw(PointKt.m8481timesso9K2fw(sideDirection, actualRoundCut), 1.0f + actualSmoothingValues));
        long p = PointKt.m8477interpolatedLqxh1s(circleSegmentIntersection, PointKt.m8469divso9K2fw(PointKt.m8479plusybeJwSQ(circleSegmentIntersection, otherCircleSegmentIntersection), 2.0f), actualSmoothingValues);
        long curveEnd = PointKt.m8479plusybeJwSQ(circleCenter, PointKt.m8481timesso9K2fw(Utils.directionVector(PointKt.m8475getXDnnuFBc(p) - PointKt.m8475getXDnnuFBc(circleCenter), PointKt.m8476getYDnnuFBc(p) - PointKt.m8476getYDnnuFBc(circleCenter)), actualR));
        long circleTangent = Utils.m8496rotate90DnnuFBc(PointKt.m8478minusybeJwSQ(curveEnd, circleCenter));
        FloatFloatPair floatFloatPairM8486lineIntersectionCBFvKDc = m8486lineIntersectionCBFvKDc(sideStart, sideDirection, curveEnd, circleTangent);
        long anchorEnd = floatFloatPairM8486lineIntersectionCBFvKDc != null ? floatFloatPairM8486lineIntersectionCBFvKDc.getPackedValue() : circleSegmentIntersection;
        long anchorStart = PointKt.m8469divso9K2fw(PointKt.m8479plusybeJwSQ(curveStart, PointKt.m8481timesso9K2fw(anchorEnd, 2.0f)), 3.0f);
    ...
    private final FloatFloatPair m8486lineIntersectionCBFvKDc(long p0, long d0, long p1, long d1) {
        long rotatedD1 = Utils.m8496rotate90DnnuFBc(d1);
        float den = PointKt.m8471dotProductybeJwSQ(d0, rotatedD1);
        if (Math.abs(den) < 1.0E-4f) {
            return null;
        }
        float num = PointKt.m8471dotProductybeJwSQ(PointKt.m8478minusybeJwSQ(p1, p0), rotatedD1);
        if (Math.abs(den) < Math.abs(num) * 1.0E-4f) {
            return null;
        }
        float k = num / den;
        return FloatFloatPair.m7boximpl(PointKt.m8479plusybeJwSQ(p0, PointKt.m8481timesso9K2fw(d0, k)));
    }
}
