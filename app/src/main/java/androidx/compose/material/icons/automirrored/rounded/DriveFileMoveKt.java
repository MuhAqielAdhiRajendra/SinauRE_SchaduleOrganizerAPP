...
public final class DriveFileMoveKt {
    ...
    public static final ImageVector getDriveFileMove(Icons.AutoMirrored.Rounded $this$DriveFileMove) {
        ...
        ImageVector.Builder $this$_get_DriveFileMove__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Rounded.DriveFileMove", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
