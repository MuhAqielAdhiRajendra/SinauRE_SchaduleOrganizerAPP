...
public final class HotTubKt {
    ...
    public static final ImageVector getHotTub(Icons.Outlined $this$HotTub) {
        if (_hotTub != null) {
        ...
        ImageVector.Builder $this$_get_HotTub__u24lambda_u242 = new ImageVector.Builder("Outlined.HotTub", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
