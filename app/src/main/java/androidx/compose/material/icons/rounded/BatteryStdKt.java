...
public final class BatteryStdKt {
    ...
    public static final ImageVector getBatteryStd(Icons.Rounded $this$BatteryStd) {
        if (_batteryStd != null) {
        ...
        ImageVector.Builder $this$_get_BatteryStd__u24lambda_u241 = new ImageVector.Builder("Rounded.BatteryStd", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
