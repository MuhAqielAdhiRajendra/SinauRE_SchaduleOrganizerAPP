...
public final class FormatTextdirectionLToRKt {
    ...
    public static final ImageVector getFormatTextdirectionLToR(Icons.AutoMirrored.Outlined $this$FormatTextdirectionLToR) {
        ...
        ImageVector.Builder $this$_get_FormatTextdirectionLToR__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Outlined.FormatTextdirectionLToR", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
