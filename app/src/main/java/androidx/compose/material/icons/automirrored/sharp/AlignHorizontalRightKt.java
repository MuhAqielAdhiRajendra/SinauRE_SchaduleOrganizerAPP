...
public final class AlignHorizontalRightKt {
    ...
    public static final ImageVector getAlignHorizontalRight(Icons.AutoMirrored.Sharp $this$AlignHorizontalRight) {
        ...
        ImageVector.Builder $this$_get_AlignHorizontalRight__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Sharp.AlignHorizontalRight", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
