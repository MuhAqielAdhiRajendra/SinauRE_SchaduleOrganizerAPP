...
public final class CharSequenceArraySerializer implements KSerializer<CharSequence[]> {
    ...
    public void serialize(Encoder encoder, CharSequence[] value) {
        ...
        SavedStateWriter.m8619putCharSequenceArrayimpl($this$serialize_u24lambda_u242_u24lambda_u241, $this$serialize_u24lambda_u242.getKey(), value);
    }
    ...
    public CharSequence[] deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m8540getCharSequenceArrayimpl($this$deserialize_u24lambda_u245_u24lambda_u244, $this$deserialize_u24lambda_u245.getKey());
    }
}
