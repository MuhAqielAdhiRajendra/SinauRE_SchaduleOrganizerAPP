...
public interface DragAndDropModifierNode extends DelegatableNode, DragAndDropTarget {
    ...
    void mo4819drag12SF9DM(DragAndDropTransferData transferData, long decorationSize, Function1<? super DrawScope, Unit> drawDragDecoration);
}
