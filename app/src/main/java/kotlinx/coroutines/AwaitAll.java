...
final class AwaitAll<T> {
    ...
    public final Object await(Continuation<? super List<? extends T>> continuation) {
        ...
        Continuation<? super List<? extends T>> continuation2 = continuation;
        int i = 0;
        ...
        while (i2 < length) {
            ...
            $this$await_u24lambda_u242_u24lambda_u240.setHandle(JobKt__JobKt.invokeOnCompletion$default(deferred, false, $this$await_u24lambda_u242_u24lambda_u240, 1, null));
            Unit unit = Unit.INSTANCE;
            nodes[i2] = $this$await_u24lambda_u242_u24lambda_u240;
            i2++;
        ...
        public void invoke(Throwable cause) {
            if (cause == null) {
                if (AwaitAll.getNotCompletedCount$volatile$FU().decrementAndGet(AwaitAll.this) == 0) {
                    ...
                    cancellableContinuation.resumeWith(Result.m8929constructorimpl((List) destination$iv$iv));
                    return;
                }
                return;
            }
