...
public final class TerrainKt {
    ...
    public static final ImageVector getTerrain(Icons.Rounded $this$Terrain) {
        if (_terrain != null) {
        ...
        ImageVector.Builder $this$_get_Terrain__u24lambda_u241 = new ImageVector.Builder("Rounded.Terrain", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
