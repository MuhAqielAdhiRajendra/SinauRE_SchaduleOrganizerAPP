...
public final class RowScopeInstance implements RowScope {
    ...
    public Modifier alignBy(Modifier $this$alignBy, final Function1<? super Measured, Integer> function1) {
        return $this$alignBy.then(new WithAlignmentLineBlockElement(new AlignmentLineProviderBlock() { // from class: androidx.compose.foundation.layout.RowScopeInstance$$ExternalSyntheticLambda0
