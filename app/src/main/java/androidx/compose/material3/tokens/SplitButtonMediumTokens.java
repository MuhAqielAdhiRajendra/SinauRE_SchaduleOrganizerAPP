...
public final class SplitButtonMediumTokens {
    ...
    private static final float LeadingButtonLeadingSpace = Dp.m8150constructorimpl((float) 24.0d);
    private static final float LeadingButtonTrailingSpace = Dp.m8150constructorimpl((float) 24.0d);
    private static final float TrailingIconSize = Dp.m8150constructorimpl((float) 26.0d);
    private static final float TrailingInnerSelectedCornerCornerSizePercent = 50.0f;
    private static final float TrailingButtonLeadingSpace = Dp.m8150constructorimpl((float) 15.0d);
    private static final float TrailingButtonTrailingSpace = Dp.m8150constructorimpl((float) 15.0d);

    private SplitButtonMediumTokens() {
    }

    /* JADX INFO: renamed from: getBetweenSpace-D9Ej5fM, reason: not valid java name */
    public final float m4198getBetweenSpaceD9Ej5fM() {
        return BetweenSpace;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m4199getContainerHeightD9Ej5fM() {
    ...
    public final float m4202getTrailingButtonLeadingSpaceD9Ej5fM() {
    ...
    public final float m4203getTrailingButtonTrailingSpaceD9Ej5fM() {
