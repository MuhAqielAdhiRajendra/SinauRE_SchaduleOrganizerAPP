    ...
    public final void notifyByTableIds$room_runtime(Set<Integer> invalidatedTablesIds) {
        ...
        switch (this.tableIds.length) {
            case 0:
                ...
                break;
            case 1:
                setEmptySet = !invalidatedTablesIds.contains(Integer.valueOf(this.tableIds[0])) ? SetsKt.emptySet() : this.singleTableSet;
                break;
            default:
                ...
                setEmptySet = SetsKt.build($this$notifyByTableIds_u24lambda_u241);
                break;
        }
    ...
    public final void notifyByTableNames$room_runtime(Set<String> invalidatedTablesNames) {
        ...
        switch (this.tableNames.length) {
            ...
            default:
                ...
                setEmptySet = SetsKt.build($this$notifyByTableNames_u24lambda_u244);
                break;
        }
        if (!setEmptySet.isEmpty()) {
            this.observer.onInvalidated(setEmptySet);
