...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mUpdateChildViewsRunnable = new Runnable() { // from class: androidx.recyclerview.widget.RecyclerView.1
            ...
            public void run() {
                ...
                boolean z2 = RecyclerView.this.mIsAttached;
                RecyclerView recyclerView = RecyclerView.this;
                if (!z2) {
                    recyclerView.requestLayout();
                    return;
                }
                boolean z3 = recyclerView.mLayoutSuppressed;
        ...
        this.mViewInfoProcessCallback = new ViewInfoStore.ProcessCallback() { // from class: androidx.recyclerview.widget.RecyclerView.4
            ...
            public void processPersistent(ViewHolder viewHolder, ItemAnimator.ItemHolderInfo preInfo, ItemAnimator.ItemHolderInfo postInfo) {
                ...
                boolean z2 = RecyclerView.this.mDataSetHasChangedAfterLayout;
                RecyclerView recyclerView = RecyclerView.this;
                if (z2) {
        ...
        if (className != null) {
            ...
            if (!className2.isEmpty()) {
                ...
                try {
                    ...
                    Class<? extends U> clsAsSubclass = Class.forName(className3, false, classLoader).asSubclass(LayoutManager.class);
                    ...
                    try {
                        ...
                        try {
                            Constructor<? extends LayoutManager> constructor2 = clsAsSubclass.getConstructor(new Class[0]);
    ...
    public void scrollBy(int x, int y) {
        ...
        if (canScrollHorizontal || canScrollVertical) {
            scrollByInternal(canScrollHorizontal ? x : 0, canScrollVertical ? y : 0, null, 0);
        }
    }
    ...
    boolean scrollByInternal(int x, int y, MotionEvent ev, int type) {
        ...
        if (this.mAdapter == null) {
            ...
            int unconsumedX2 = x - consumedX2;
            int unconsumedY2 = y - consumedY2;
            consumedX = unconsumedX2;
            unconsumedX = consumedX2;
            consumedY = unconsumedY2;
            unconsumedY = consumedY2;
        }
        if (!this.mItemDecorations.isEmpty()) {
            invalidate();
        }
        ...
        int unconsumedX3 = consumedX - this.mReusableIntPair[0];
        int unconsumedY3 = consumedY - this.mReusableIntPair[1];
        ...
        if (getOverScrollMode() != 2) {
            if (ev != null && !MotionEventCompat.isFromSource(ev, 8194)) {
                pullGlows(ev.getX(), unconsumedX3, ev.getY(), unconsumedY3);
            }
        ...
        return (!consumedNestedScroll && unconsumedX == 0 && unconsumedY == 0) ? false : true;
    }
            ...
            case 2:
                ...
                if (this.mScrollState == 1) {
                    ...
                    if (canScrollHorizontally) {
                        ...
                        if (dx3 > 0) {
                            dx3 = Math.max(0, dx3 - i2);
                        } else {
                            dx3 = Math.min(0, i2 + dx3);
                        }
                        if (dx3 != 0) {
                            startScroll = true;
                        }
                    ...
                    if (canScrollVertically) {
                        ...
                        if (dy3 > 0) {
                            dy3 = Math.max(0, dy3 - i3);
                        } else {
                            dy3 = Math.min(0, i3 + dy3);
                        }
                        if (dy3 != 0) {
                            startScroll = true;
                        }
                ...
                if (this.mScrollState == i) {
                    ...
                    if (scrollByInternal(canScrollHorizontally ? dx2 : 0, canScrollVertically ? dy2 : 0, e, 0)) {
                        getParent().requestDisallowInterceptTouchEvent(true);
                    }
    ...
    */
        ...
        public void run() {
            ...
            if (RecyclerView.this.mLayout != null) {
                ...
                if (scroller.computeScrollOffset()) {
                    ...
                    if (RecyclerView.this.dispatchNestedPreScroll(unconsumedX2, unconsumedY2, RecyclerView.this.mReusableIntPair, null, 1)) {
                    ...
                    if (!scroller.isFinished() && ((!scrollerFinishedX && unconsumedX4 == 0) || (!scrollerFinishedY && unconsumedY4 == 0))) {
                        doneScrolling = false;
                    } else {
                        doneScrolling = true;
                    }
                    ...
                    if (!smoothScrollerPending && doneScrolling) {
                        if (RecyclerView.this.getOverScrollMode() != 2) {
                            ...
                            if (unconsumedX4 < 0) {
                                ...
                                velX = unconsumedX4 > 0 ? vel : 0;
                            }
                            if (unconsumedY4 < 0) {
                                velY = -vel;
                            } else {
                                velY = unconsumedY4 > 0 ? vel : 0;
                            }
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(View view, int position) {
            ...
            RecyclerView recyclerView = RecyclerView.this;
            if (lp == null) {
                rvLayoutParams = (LayoutParams) recyclerView.generateDefaultLayoutParams();
        ...
        void dispatchViewRecycled(ViewHolder holder) {
            ...
            while (true) {
                ...
                recyclerView.mRecyclerListeners.get(i).onViewRecycled(holder);
                i++;
            }
    ...
    public static abstract class LayoutManager {
        ...
        private void addViewInt(View child, int index, boolean disappearing) {
            ...
            if (holder.wasReturnedFromScrap() || holder.isScrap()) {
                ...
                if (parent == recyclerView) {
                    int currentIndex = childHelper.indexOfChild(child);
                    if (index == -1) {
                    ...
                    childHelper.addView(child, index, false);
        ...
        public void attachView(View child, int index, LayoutParams lp) {
            ViewHolder vh = RecyclerView.getChildViewHolderInt(child);
            boolean zIsRemoved = vh.isRemoved();
            RecyclerView recyclerView = this.mRecyclerView;
            if (zIsRemoved) {
                recyclerView.mViewInfoStore.addToDisappearedInLayout(vh);
            } else {
                recyclerView.mViewInfoStore.removeFromDisappearedInLayout(vh);
            }
            ...
            switch (action) {
                case 4096:
                    ...
                    if (!this.mRecyclerView.canScrollHorizontally(1)) {
                        ...
                        int hScroll2 = (getWidth() - getPaddingLeft()) - getPaddingRight();
                        vScroll = vScroll2;
                        hScroll = hScroll2;
                    }
                    break;
                case 8192:
                    ...
                    if (!this.mRecyclerView.canScrollHorizontally(-1)) {
                        ...
                        int hScroll3 = -((getWidth() - getPaddingLeft()) - getPaddingRight());
                        vScroll = vScroll2;
                        hScroll = hScroll3;
                    }
                    break;
    ...
    void dispatchPendingImportantForAccessibilityChanges() {
        int state;
        int i = this.mPendingAccessibilityImportanceChange.size();
        while (true) {
            i--;
