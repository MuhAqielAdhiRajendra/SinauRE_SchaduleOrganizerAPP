...
public final class FenceKt {
    ...
    public static final ImageVector getFence(Icons.Filled $this$Fence) {
        if (_fence != null) {
        ...
        ImageVector.Builder $this$_get_Fence__u24lambda_u241 = new ImageVector.Builder("Filled.Fence", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
