...
@DebugMetadata(c = "androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1", f = "AppBar.kt", i = {0}, l = {3434, 3436}, m = "onPostFling-RZ2iAVY", n = {"available"}, s = {"J$0"})
