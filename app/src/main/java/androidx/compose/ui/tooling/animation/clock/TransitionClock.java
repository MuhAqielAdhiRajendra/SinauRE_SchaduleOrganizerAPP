...
/* JADX INFO: compiled from: TransitionClock.android.kt */
...
public final class TransitionClock<T> implements ComposeAnimationClock<TransitionBasedAnimation<T>, TargetState<T>> {
    ...
    private TargetState<T> state = new TargetState<>(getAnimation().m8077getAnimationObject().getCurrentState(), getAnimation().m8077getAnimationObject().getTargetState());
    ...
    public void setStateParameters(Object par1, Object par2) {
        TargetState<T> parametersToValue = Utils_androidKt.parseParametersToValue(getState().getInitial(), par1, par2);
    ...
    public List<ComposeAnimatedProperty> getAnimatedProperties() {
        Iterable $this$mapNotNull$iv = Utils_androidKt.allAnimations(getAnimation().m8077getAnimationObject());
    ...
    public long getMaxDurationPerIteration() {
        return Utils_androidKt.nanosToMillis(getAnimation().m8077getAnimationObject().getTotalDurationNanos());
    }
    ...
    public List<TransitionInfo> getTransitions(long stepMillis) {
        Iterable $this$map$iv = Utils_androidKt.allAnimations(getAnimation().m8077getAnimationObject());
    ...
    public void setClockTime(long animationTimeNanos) {
        ...
        getAnimation().m8077getAnimationObject().seek(getState().getInitial(), getState().getTarget(), animationTimeNanos);
    }
}
