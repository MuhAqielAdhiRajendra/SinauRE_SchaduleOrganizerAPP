...
public final class InnerNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateImpl extends LookaheadDelegate {
        ...
        public Placeable mo6783measureBRTryo0(long constraints) {
            ...
            for (int i$iv$iv = 0; i$iv$iv < size$iv$iv; i$iv$iv++) {
                ...
                LookaheadPassDelegate lookaheadPassDelegate$ui = it.getLookaheadPassDelegate$ui();
            ...
            MeasurePolicy $this$measure_BRTryo0_u24lambda_u240_u241 = getLayoutNode().getMeasurePolicy();
            MeasureResult measureResult = $this$measure_BRTryo0_u24lambda_u240_u241.mo39measure3p2s80s(this, getLayoutNode().getChildLookaheadMeasurables$ui(), constraints);
    ...
    public Placeable mo6783measureBRTryo0(long constraints) {
        ...
        if (getForceMeasureWithLookaheadConstraints()) {
            ...
            constraints2 = lookaheadDelegate.m7035getConstraintsmsEJaDk$ui();
        } else {
            constraints2 = constraints;
        }
        InnerNodeCoordinator this_$iv = this;
        long constraints$iv = constraints2;
        this_$iv.m6848setMeasurementConstraintsBRTryo0(constraints$iv);
        MutableVector<LayoutNode> mutableVector = getLayoutNode().get_children$ui();
        int i$iv$iv = 0;
        Object[] content$iv$iv = mutableVector.content;
        int size$iv$iv = mutableVector.getSize();
        while (i$iv$iv < size$iv$iv) {
            LayoutNode it = (LayoutNode) content$iv$iv[i$iv$iv];
            it.getMeasurePassDelegate$ui().setMeasuredByParent$ui(LayoutNode.UsageByParent.NotUsed);
            i$iv$iv++;
            this_$iv = this_$iv;
            constraints$iv = constraints$iv;
        }
        MeasurePolicy $this$measure_BRTryo0_u24lambda_u240_u241 = getLayoutNode().getMeasurePolicy();
        setMeasureResult$ui($this$measure_BRTryo0_u24lambda_u240_u241.mo39measure3p2s80s(this, getLayoutNode().getChildMeasurables$ui(), constraints2));
        onMeasured();
        return this;
    }
    ...
    public void performDraw(Canvas canvas, GraphicsLayer graphicsLayer) throws Throwable {
        ...
        for (int i$iv = 0; i$iv < size$iv; i$iv++) {
            ...
            if (child.isPlaced()) {
                child.draw$ui(canvas, graphicsLayer);
            }
        }
    ...
    */
    public void mo7001hitTestChildqzLsGqo(androidx.compose.ui.node.NodeCoordinator.HitTestSource r21, long r22, androidx.compose.ui.node.HitTestResult r24, int r25, boolean r26) {
        /*
            Method dump skipped, instruction units count: 233
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.node.InnerNodeCoordinator.mo7001hitTestChildqzLsGqo(androidx.compose.ui.node.NodeCoordinator$HitTestSource, long, androidx.compose.ui.node.HitTestResult, int, boolean):void");
    }

    /* JADX INFO: compiled from: InnerNodeCoordinator.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0080\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, d2 = {"Landroidx/compose/ui/node/InnerNodeCoordinator$Companion;", "", "<init>", "()V", "innerBoundsPaint", "Landroidx/compose/ui/graphics/Paint;", "getInnerBoundsPaint", "()Landroidx/compose/ui/graphics/Paint;", "ui"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    static {
        ...
        paint.mo5189setColor8_81llA(Color.INSTANCE.m5347getRed0d7_KjU());
