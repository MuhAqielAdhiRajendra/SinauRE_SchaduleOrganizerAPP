...
public final class WindowInsetsControllerCompat {
    ...
    private static class Impl26 extends Impl23 {
        ...
        public void setAppearanceLightNavigationBars(boolean isLight) {
            if (isLight) {
                unsetWindowFlag(GroupFlagsKt.HasRecompositionRequiredFlag);
                setWindowFlag(Integer.MIN_VALUE);
                setSystemUiFlag(16);
                return;
            }
    ...
    static class Impl30 extends Impl {
        ...
        private boolean isAppearanceLight(int systemUiFlag, int appearanceFlag) {
            if (this.mWindow != null) {
                return (this.mWindow.getDecorView().getSystemUiVisibility() & systemUiFlag) != 0;
            }
            this.mInsetsController.setSystemBarsAppearance(0, 0);
            return (this.mInsetsController.getSystemBarsAppearance() & appearanceFlag) != 0;
        }
        ...
        private void setAppearanceLight(boolean isLight, int systemUiFlag, int appearanceFlag) {
            ...
            if (isLight) {
                windowInsetsController.setSystemBarsAppearance(appearanceFlag, appearanceFlag);
            } else {
                windowInsetsController.setSystemBarsAppearance(0, appearanceFlag);
            }
        }

        @Override // androidx.core.view.WindowInsetsControllerCompat.Impl
        public void setAppearanceLightStatusBars(boolean isLight) {
            setAppearanceLight(isLight, 8192, 8);
        }

        @Override // androidx.core.view.WindowInsetsControllerCompat.Impl
        public void setAppearanceLightNavigationBars(boolean isLight) {
            setAppearanceLight(isLight, 16, 16);
        }
        ...
        void addOnControllableInsetsChangedListener(final OnControllableInsetsChangedListener listener) {
            ...
            WindowInsetsController.OnControllableInsetsChangedListener fwListener = new WindowInsetsController.OnControllableInsetsChangedListener() { // from class: androidx.core.view.WindowInsetsControllerCompat$Impl30$$ExternalSyntheticLambda0
                public final void onControllableInsetsChanged(WindowInsetsController windowInsetsController, int i) {
                    this.f$0.m8438xe96d8c51(listener, windowInsetsController, i);
                }
            };
        ...
        /* synthetic */ void m8438xe96d8c51(OnControllableInsetsChangedListener listener, WindowInsetsController controller, int typeMask) {
    ...
    private static class Impl35 extends Impl31 {
        ...
        @Override // androidx.core.view.WindowInsetsControllerCompat.Impl30, androidx.core.view.WindowInsetsControllerCompat.Impl
        public void setAppearanceLightStatusBars(boolean isLight) {
            this.mInsetsController.setSystemBarsAppearance(isLight ? 8 : 0, 8);
        }

        @Override // androidx.core.view.WindowInsetsControllerCompat.Impl30, androidx.core.view.WindowInsetsControllerCompat.Impl
        public void setAppearanceLightNavigationBars(boolean isLight) {
            this.mInsetsController.setSystemBarsAppearance(isLight ? 16 : 0, 16);
        }
    }
}
