...
public final class ChannelLimitedFlowMerge<T> extends ChannelFlow<T> {
    ...
    protected Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
        ...
        for (Object element$iv : this.flows) {
            BuildersKt__Builders_commonKt.launch$default(producerScope, null, null, new ChannelLimitedFlowMerge$collectTo$2$1((Flow) element$iv, collector, null), 3, null);
        }
