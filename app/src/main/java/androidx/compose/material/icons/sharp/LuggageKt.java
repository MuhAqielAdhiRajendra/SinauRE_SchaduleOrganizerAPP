...
public final class LuggageKt {
    ...
    public static final ImageVector getLuggage(Icons.Sharp $this$Luggage) {
        if (_luggage != null) {
        ...
        ImageVector.Builder $this$_get_Luggage__u24lambda_u241 = new ImageVector.Builder("Sharp.Luggage", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
