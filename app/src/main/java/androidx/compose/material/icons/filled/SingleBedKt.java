...
public final class SingleBedKt {
    ...
    public static final ImageVector getSingleBed(Icons.Filled $this$SingleBed) {
        if (_singleBed != null) {
        ...
        ImageVector.Builder $this$_get_SingleBed__u24lambda_u241 = new ImageVector.Builder("Filled.SingleBed", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
