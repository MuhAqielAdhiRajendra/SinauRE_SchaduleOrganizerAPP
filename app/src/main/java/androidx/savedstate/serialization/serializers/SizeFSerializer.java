...
public final class SizeFSerializer implements KSerializer<SizeF> {
    ...
    public void serialize(Encoder encoder, SizeF value) {
        ...
        SavedStateWriter.m8639putSizeFimpl($this$serialize_u24lambda_u242_u24lambda_u241, $this$serialize_u24lambda_u242.getKey(), value);
    }
    ...
    public SizeF deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m8586getSizeFimpl($this$deserialize_u24lambda_u245_u24lambda_u244, $this$deserialize_u24lambda_u245.getKey());
    }
}
