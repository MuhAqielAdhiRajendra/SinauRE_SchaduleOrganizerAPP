...
public final class Profiling {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<ProducerScope<? super ProfilingResult>, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (ProduceKt.awaitClose($this$callbackFlow, new Function0() { // from class: androidx.core.os.Profiling$registerForAllProfilingResults$1$$ExternalSyntheticLambda2
                        @Override // kotlin.jvm.functions.Function0
                        public final Object invoke() {
                            return Profiling.AnonymousClass1.invokeSuspend$lambda$2(service, listener);
                        }
        ...
        static final void invokeSuspend$lambda$0(ProducerScope $$this$callbackFlow, ProfilingResult result) {
            ...
            $$this$callbackFlow.mo10436trySendJP2dKIU(result);
        }

        static final Unit invokeSuspend$lambda$2(ProfilingManager $service, Consumer $listener) {
