...
public final class FoodBankKt {
    ...
    public static final ImageVector getFoodBank(Icons.Sharp $this$FoodBank) {
        if (_foodBank != null) {
        ...
        ImageVector.Builder $this$_get_FoodBank__u24lambda_u241 = new ImageVector.Builder("Sharp.FoodBank", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
