...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    public void onAttachedToWindow() {
        ...
        Window window = getWindow();
        if (window != null) {
            boolean drawEdgeToEdge = this.edgeToEdgeEnabled && Color.alpha(EdgeToEdgeUtils.getNavigationBarColor(window)) < 255;
    ...
    public void setProtections(List<Protection> protections) {
        this.protectionsList = protections;
        if (this.protectionLayout != null) {
            this.protectionLayout.setProtections(protections);
            this.protectionLayout.setVisibility(protections.isEmpty() ? 8 : 0);
        }
    }
    ...
    private FrameLayout ensureContainerAndBehavior() {
        if (this.container == null) {
            ...
            this.protectionLayout = (ProtectionLayout) this.container.findViewById(R.id.protection_layout);
            if (this.protectionsList != null) {
                setProtections(this.protectionsList);
            }
