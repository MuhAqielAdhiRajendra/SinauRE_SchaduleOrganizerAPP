...
public final class ShapeLineKt {
    ...
    public static final ImageVector getShapeLine(Icons.Sharp $this$ShapeLine) {
        if (_shapeLine != null) {
        ...
        ImageVector.Builder $this$_get_ShapeLine__u24lambda_u243 = new ImageVector.Builder("Sharp.ShapeLine", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.moveTo(23.0f, 14.0f);
