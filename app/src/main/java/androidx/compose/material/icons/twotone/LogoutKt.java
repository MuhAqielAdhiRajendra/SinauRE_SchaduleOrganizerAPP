...
public final class LogoutKt {
    ...
    @Deprecated(message = "Use the AutoMirrored version at Icons.AutoMirrored.TwoTone.Logout", replaceWith = @ReplaceWith(expression = "Icons.AutoMirrored.TwoTone.Logout", imports = {"androidx.compose.material.icons.automirrored.twotone.Logout"}))
    public static /* synthetic */ void getLogout$annotations(Icons.TwoTone twoTone) {
    }

    public static final ImageVector getLogout(Icons.TwoTone $this$Logout) {
        if (_logout != null) {
        ...
        ImageVector.Builder $this$_get_Logout__u24lambda_u241 = new ImageVector.Builder("TwoTone.Logout", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
