...
public final class RealEstateAgentKt {
    ...
    public static final ImageVector getRealEstateAgent(Icons.Sharp $this$RealEstateAgent) {
        ...
        ImageVector.Builder $this$_get_RealEstateAgent__u24lambda_u241 = new ImageVector.Builder("Sharp.RealEstateAgent", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(10.0f, 4.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-7.0f, -1.98f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineTo(11.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(-4.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-1.76f, -0.68f);
