...
public final class ParagraphKt {
    ...
    public static final Paragraph Paragraph(String text, TextStyle style, float width, Density density, FontFamily.Resolver fontFamilyResolver, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int maxLines, boolean ellipsis) {
        ...
        return androidx.compose.ui.text.platform.AndroidParagraph_androidKt.m7834ActualParagraphXGqx6AY(text, style, list, list2, maxLines, ellipsis ? companion.m8061getEllipsisgIe3tQ8() : companion.m8060getClipgIe3tQ8(), ConstraintsKt.Constraints$default(0, ceilToInt(width), 0, 0, 13, null), density, fontFamilyResolver);
    }
    ...
    public static final /* synthetic */ Paragraph m7450ParagraphUdtVg6A(String text, TextStyle style, long constraints, Density density, FontFamily.Resolver fontFamilyResolver, List spanStyles, List placeholders, int maxLines, boolean ellipsis) {
        TextOverflow.Companion companion = TextOverflow.INSTANCE;
        return androidx.compose.ui.text.platform.AndroidParagraph_androidKt.m7834ActualParagraphXGqx6AY(text, style, spanStyles, placeholders, maxLines, ellipsis ? companion.m8061getEllipsisgIe3tQ8() : companion.m8060getClipgIe3tQ8(), constraints, density, fontFamilyResolver);
    }

    /* JADX INFO: renamed from: Paragraph-Ul8oQg4, reason: not valid java name */
    public static final Paragraph m7452ParagraphUl8oQg4(String text, TextStyle style, long constraints, Density density, FontFamily.Resolver fontFamilyResolver, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int maxLines, int overflow) {
        return androidx.compose.ui.text.platform.AndroidParagraph_androidKt.m7834ActualParagraphXGqx6AY(text, style, list, list2, maxLines, overflow, constraints, density, fontFamilyResolver);
    }
    ...
    public static final Paragraph Paragraph(ParagraphIntrinsics paragraphIntrinsics, int maxLines, boolean ellipsis, float width) {
        TextOverflow.Companion companion = TextOverflow.INSTANCE;
        return androidx.compose.ui.text.platform.AndroidParagraph_androidKt.m7833ActualParagraph4FmOz70(paragraphIntrinsics, maxLines, ellipsis ? companion.m8061getEllipsisgIe3tQ8() : companion.m8060getClipgIe3tQ8(), ConstraintsKt.Constraints$default(0, ceilToInt(width), 0, 0, 13, null));
    }

    /* JADX INFO: renamed from: Paragraph-_EkL_-Y$default, reason: not valid java name */
    public static /* synthetic */ Paragraph m7455Paragraph_EkL_Y$default(ParagraphIntrinsics paragraphIntrinsics, long j, int i, boolean z, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = Integer.MAX_VALUE;
        }
        if ((i2 & 8) != 0) {
        ...
        return m7454Paragraph_EkL_Y(paragraphIntrinsics, j, i, z);
    }
    ...
    public static final /* synthetic */ Paragraph m7454Paragraph_EkL_Y(ParagraphIntrinsics paragraphIntrinsics, long constraints, int maxLines, boolean ellipsis) {
        TextOverflow.Companion companion = TextOverflow.INSTANCE;
        return androidx.compose.ui.text.platform.AndroidParagraph_androidKt.m7833ActualParagraph4FmOz70(paragraphIntrinsics, maxLines, ellipsis ? companion.m8061getEllipsisgIe3tQ8() : companion.m8060getClipgIe3tQ8(), constraints);
    }

    /* JADX INFO: renamed from: Paragraph-czeN-Hc$default, reason: not valid java name */
    public static /* synthetic */ Paragraph m7457ParagraphczeNHc$default(ParagraphIntrinsics paragraphIntrinsics, long j, int i, int i2, int i3, Object obj) {
        if ((i3 & 4) != 0) {
            i = Integer.MAX_VALUE;
        }
        if ((i3 & 8) != 0) {
            i2 = TextOverflow.INSTANCE.m8060getClipgIe3tQ8();
        }
        return m7456ParagraphczeNHc(paragraphIntrinsics, j, i, i2);
    }

    /* JADX INFO: renamed from: Paragraph-czeN-Hc, reason: not valid java name */
    public static final Paragraph m7456ParagraphczeNHc(ParagraphIntrinsics paragraphIntrinsics, long constraints, int maxLines, int overflow) {
        return androidx.compose.ui.text.platform.AndroidParagraph_androidKt.m7833ActualParagraph4FmOz70(paragraphIntrinsics, maxLines, overflow, constraints);
    }
