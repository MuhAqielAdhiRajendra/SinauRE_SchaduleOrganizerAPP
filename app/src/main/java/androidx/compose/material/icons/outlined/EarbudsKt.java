...
public final class EarbudsKt {
    ...
    public static final ImageVector getEarbuds(Icons.Outlined $this$Earbuds) {
        if (_earbuds != null) {
        ...
        ImageVector.Builder $this$_get_Earbuds__u24lambda_u241 = new ImageVector.Builder("Outlined.Earbuds", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineTo(8.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(21.0f, 5.24f, 18.76f, 3.0f, 16.0f, 3.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _earbuds = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_Earbuds__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
