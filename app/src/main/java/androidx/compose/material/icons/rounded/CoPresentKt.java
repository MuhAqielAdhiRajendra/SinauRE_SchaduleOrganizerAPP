...
public final class CoPresentKt {
    ...
    public static final ImageVector getCoPresent(Icons.Rounded $this$CoPresent) {
        if (_coPresent != null) {
        ...
        ImageVector.Builder $this$_get_CoPresent__u24lambda_u243 = new ImageVector.Builder("Rounded.CoPresent", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
