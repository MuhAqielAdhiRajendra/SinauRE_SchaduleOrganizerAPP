...
public final class PersistentOrderedMapBuilder<K, V> extends AbstractMutableMap<K, V> implements PersistentMap.Builder<K, V> {
    ...
    public PersistentOrderedMapBuilder(PersistentOrderedMap<K, V> persistentOrderedMap) {
        ...
        this.firstKey = this.map.getFirstKey();
    ...
    public PersistentMap<K, V> build2() {
        ...
        if (persistentHashMapBuild2 == this.map.getHashMap$runtime()) {
            CommonFunctionsKt.m4649assert(this.firstKey == this.map.getFirstKey());
            CommonFunctionsKt.m4649assert(this.lastKey == this.map.getLastKey());
    ...
    public V put(K key, V value) {
        ...
        CommonFunctionsKt.m4649assert(!r3.getHasNext());
