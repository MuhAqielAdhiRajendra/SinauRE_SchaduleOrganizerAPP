...
final class TriStateToggleableNode extends ClickableNode {
    ...
    private TriStateToggleableNode(ToggleableState state, MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean useLocalIndication, boolean enabled, Role role, Function0<Unit> function0) {
    ...
    public final void m1360updateO2vRcR0(ToggleableState state, MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean useLocalIndication, boolean enabled, Role role, Function0<Unit> onClick) {
        if (this.state != state) {
            this.state = state;
            SemanticsModifierNodeKt.invalidateSemantics(this);
        }
        super.m336updateO2vRcR0(interactionSource, indicationNodeFactory, useLocalIndication, enabled, (String) null, role, onClick);
    }
    ...
    public void applyAdditionalSemantics(final SemanticsPropertyReceiver $this$applyAdditionalSemantics) {
        ...
        FillableData it = FillableData_androidKt.createFromBoolean(FillableData.INSTANCE, this.state != ToggleableState.Indeterminate);
        if (it != null) {
            SemanticsPropertiesKt.setFillableData($this$applyAdditionalSemantics, it);
        }
        SemanticsPropertiesKt.onFillData$default($this$applyAdditionalSemantics, null, new Function1() { // from class: androidx.compose.foundation.selection.TriStateToggleableNode$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return Boolean.valueOf(TriStateToggleableNode.applyAdditionalSemantics$lambda$1($this$applyAdditionalSemantics, (FillableData) obj));
            }
        }, 1, null);
    }
