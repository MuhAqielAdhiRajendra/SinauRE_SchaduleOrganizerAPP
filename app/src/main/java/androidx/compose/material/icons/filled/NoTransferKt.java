...
public final class NoTransferKt {
    ...
    public static final ImageVector getNoTransfer(Icons.Filled $this$NoTransfer) {
        if (_noTransfer != null) {
        ...
        ImageVector.Builder $this$_get_NoTransfer__u24lambda_u241 = new ImageVector.Builder("Filled.NoTransfer", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(1.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.05f, 0.0f, 0.09f, -0.02f, 0.14f, -0.03f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(9.0f, 14.67f, 9.0f, 15.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(9.0f, 16.33f, 8.33f, 17.0f, 7.5f, 17.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
