...
public final class SwapCallsKt {
    ...
    public static final ImageVector getSwapCalls(Icons.Outlined $this$SwapCalls) {
        if (_swapCalls != null) {
        ...
        ImageVector.Builder $this$_get_SwapCalls__u24lambda_u241 = new ImageVector.Builder("Outlined.SwapCalls", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
