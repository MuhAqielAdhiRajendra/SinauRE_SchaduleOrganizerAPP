...
public final class MedicalInformationKt {
    ...
    public static final ImageVector getMedicalInformation(Icons.Rounded $this$MedicalInformation) {
        ...
        ImageVector.Builder $this$_get_MedicalInformation__u24lambda_u241 = new ImageVector.Builder("Rounded.MedicalInformation", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(13.75f, 14.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.41f, 0.0f, -0.75f, -0.34f, -0.75f, -0.75f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(13.34f, 13.0f, 13.75f, 13.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineTo(13.75f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(13.75f, 17.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.41f, 0.0f, -0.75f, -0.34f, -0.75f, -0.75f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(13.34f, 16.0f, 13.75f, 16.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(2.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.41f, 0.0f, 0.75f, 0.34f, 0.75f, 0.75f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(-0.34f, 0.75f, -0.75f, 0.75f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineTo(13.75f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _medicalInformation = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_MedicalInformation__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
        ImageVector imageVector2 = _medicalInformation;
