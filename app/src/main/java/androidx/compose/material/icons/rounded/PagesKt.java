...
public final class PagesKt {
    ...
    public static final ImageVector getPages(Icons.Rounded $this$Pages) {
        if (_pages != null) {
        ...
        ImageVector.Builder $this$_get_Pages__u24lambda_u241 = new ImageVector.Builder("Rounded.Pages", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-0.6f, -2.38f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.18f, -0.74f, 0.48f, -1.4f, 1.22f, -1.22f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-2.38f, 0.6f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.73f, 0.18f, -1.4f, -0.48f, -1.21f, -1.21f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(8.0f, 13.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(15.38f, 16.6f);
