...
public final class RssFeedKt {
    ...
    public static final ImageVector getRssFeed(Icons.Filled $this$RssFeed) {
        if (_rssFeed != null) {
        ...
        ImageVector.Builder $this$_get_RssFeed__u24lambda_u242 = new ImageVector.Builder("Filled.RssFeed", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
