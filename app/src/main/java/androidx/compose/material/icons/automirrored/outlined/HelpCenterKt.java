...
public final class HelpCenterKt {
    ...
    public static final ImageVector getHelpCenter(Icons.AutoMirrored.Outlined $this$HelpCenter) {
        if (_helpCenter != null) {
        ...
        ImageVector.Builder $this$_get_HelpCenter__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Outlined.HelpCenter", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
