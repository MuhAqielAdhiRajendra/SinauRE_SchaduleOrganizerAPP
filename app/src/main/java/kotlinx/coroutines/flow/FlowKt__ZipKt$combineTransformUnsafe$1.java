...
public final class FlowKt__ZipKt$combineTransformUnsafe$1<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                Intrinsics.needClassReification();
                this.label = 1;
                if (CombineKt.combineInternal($this$safeFlow, flowArr, function0NullArrayFactory$FlowKt__ZipKt, new AnonymousClass1(this.$transform, null), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                break;
            case 1:
    ...
    public final Object invokeSuspend$$forInline(Object $result) {
        ...
        Function0 function0NullArrayFactory$FlowKt__ZipKt = FlowKt__ZipKt.nullArrayFactory$FlowKt__ZipKt();
        Intrinsics.needClassReification();
        CombineKt.combineInternal($this$safeFlow, flowArr, function0NullArrayFactory$FlowKt__ZipKt, new AnonymousClass1(this.$transform, null), this);
        return Unit.INSTANCE;
    }
}
