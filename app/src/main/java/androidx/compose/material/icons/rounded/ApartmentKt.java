...
public final class ApartmentKt {
    ...
    public static final ImageVector getApartment(Icons.Rounded $this$Apartment) {
        if (_apartment != null) {
        ...
        ImageVector.Builder $this$_get_Apartment__u24lambda_u241 = new ImageVector.Builder("Rounded.Apartment", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(7.9f, 3.0f, 7.0f, 3.9f, 7.0f, 5.0f);
