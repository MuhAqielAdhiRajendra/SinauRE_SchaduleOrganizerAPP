...
public final class PushPinKt {
    ...
    public static final ImageVector getPushPin(Icons.Filled $this$PushPin) {
        if (_pushPin != null) {
        ...
        ImageVector.Builder $this$_get_PushPin__u24lambda_u241 = new ImageVector.Builder("Filled.PushPin", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
