...
public final class TextRotateVerticalKt {
    ...
    public static final ImageVector getTextRotateVertical(Icons.Rounded $this$TextRotateVertical) {
        ...
        ImageVector.Builder $this$_get_TextRotateVertical__u24lambda_u241 = new ImageVector.Builder("Rounded.TextRotateVertical", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-3.88f, -8.97f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(15.87f, 5.27f, 15.46f, 5.0f, 15.0f, 5.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(6.35f, 19.64f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(-1.0f, 0.44f, -1.0f, 1.0f);
