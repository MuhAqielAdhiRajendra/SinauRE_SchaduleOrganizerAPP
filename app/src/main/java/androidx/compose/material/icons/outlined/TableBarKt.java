...
public final class TableBarKt {
    ...
    public static final ImageVector getTableBar(Icons.Outlined $this$TableBar) {
        if (_tableBar != null) {
        ...
        ImageVector.Builder $this$_get_TableBar__u24lambda_u241 = new ImageVector.Builder("Outlined.TableBar", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(4.05f, 0.0f, 6.74f, 0.86f, 7.72f, 1.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(18.74f, 8.14f, 16.05f, 9.0f, 12.0f, 9.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(5.26f, 8.14f, 4.28f, 7.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(5.26f, 6.86f, 7.95f, 6.0f, 12.0f, 6.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _tableBar = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_TableBar__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
