...
public final class LimitedDispatcher extends CoroutineDispatcher implements Delay {
    ...
    public void mo10499scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo10499scheduleResumeAfterDelay(timeMillis, continuation);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public LimitedDispatcher(CoroutineDispatcher coroutineDispatcher, int parallelism, String name) {
    ...
    public void mo10498dispatch(CoroutineContext context, Runnable block) {
        Runnable task$iv;
        ...
        if (runningWorkers$volatile$FU.get(this) < this.parallelism && tryAllocateWorker() && (task$iv = obtainTaskOrDeallocateWorker()) != null) {
            ...
            this.dispatcher.mo10498dispatch(this, worker);
        }
    }
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (fairnessCounter >= 16 && LimitedDispatcher.this.dispatcher.isDispatchNeeded(LimitedDispatcher.this)) {
                    LimitedDispatcher.this.dispatcher.mo10498dispatch(LimitedDispatcher.this, this);
                    return;
                }
            }
        }
