        ...
        if (this.animator == null) {
            ...
            this.animator.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.progressindicator.CircularIndeterminateAdvanceAnimatorDelegate.1
                ...
                public void onAnimationRepeat(Animator animation) {
                    ...
                    CircularIndeterminateAdvanceAnimatorDelegate.this.indicatorColorIndexOffset = (CircularIndeterminateAdvanceAnimatorDelegate.this.indicatorColorIndexOffset + 4) % CircularIndeterminateAdvanceAnimatorDelegate.this.baseSpec.indicatorColors.length;
                }
            });
        }
