...
public final class LockClockKt {
    ...
    public static final ImageVector getLockClock(Icons.Sharp $this$LockClock) {
        if (_lockClock != null) {
        ...
        ImageVector.Builder $this$_get_LockClock__u24lambda_u241 = new ImageVector.Builder("Sharp.LockClock", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineTo(6.21f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(19.65f, 20.35f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(19.65f, 20.35f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
