...
final class RenderEffectVerificationHelper {
    ...
    public final android.graphics.RenderEffect m5639createBlurEffect8A3gB4(RenderEffect inputRenderEffect, float radiusX, float radiusY, int edgeTreatment) {
        if (radiusX == 0.0f) {
            if (radiusY == 0.0f) {
        ...
        if (inputRenderEffect == null) {
            return android.graphics.RenderEffect.createBlurEffect(radiusX, radiusY, AndroidTileMode_androidKt.m5216toAndroidTileMode0vamqd0(edgeTreatment));
        }
        return android.graphics.RenderEffect.createBlurEffect(radiusX, radiusY, inputRenderEffect.asAndroidRenderEffect(), AndroidTileMode_androidKt.m5216toAndroidTileMode0vamqd0(edgeTreatment));
    }

    /* JADX INFO: renamed from: createOffsetEffect-Uv8p0NA, reason: not valid java name */
    public final android.graphics.RenderEffect m5640createOffsetEffectUv8p0NA(RenderEffect inputRenderEffect, long offset) {
        if (inputRenderEffect == null) {
