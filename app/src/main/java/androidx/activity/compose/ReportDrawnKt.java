...
public final class ReportDrawnKt {
    ...
    public static final void ReportDrawnAfter(final Function1<? super Continuation<? super Unit>, ? extends Object> function1, Composer $composer, final int $changed) {
        ...
        EffectsKt.LaunchedEffect(function1, fullyDrawnReporter, new C00901(fullyDrawnReporter, function1, null), $composer2, 584);
        ScopeUpdateScope scopeUpdateScopeEndRestartGroup2 = $composer2.endRestartGroup();
        if (scopeUpdateScopeEndRestartGroup2 == null) {
            return;
        }
    ...
    static final class C00901 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C00901(FullyDrawnReporter fullyDrawnReporter, Function1<? super Continuation<? super Unit>, ? extends Object> function1, Continuation<? super C00901> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C00901(this.$fullyDrawnReporter, this.$block, continuation);
        }
        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                ...
                case 1:
                    c00901 = this;
                    $this$reportWhenComplete$iv = (FullyDrawnReporter) c00901.L$0;
                    try {
                        ResultKt.throwOnFailure($result);
                        $this$reportWhenComplete$iv.removeReporter();
                        return Unit.INSTANCE;
