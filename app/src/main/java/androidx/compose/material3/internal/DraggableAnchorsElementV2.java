...
final class DraggableAnchorsElementV2<T> extends ModifierNodeElement<DraggableAnchorsNodeV2<T>> {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof DraggableAnchorsElementV2) && Intrinsics.areEqual(this.state, ((DraggableAnchorsElementV2) other).state) && this.anchors == ((DraggableAnchorsElementV2) other).anchors && this.orientation == ((DraggableAnchorsElementV2) other).orientation;
    }
