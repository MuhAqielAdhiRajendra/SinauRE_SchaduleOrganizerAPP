...
final class CarouselStrategyHelper {
    ...
    static KeylineState createLeftAlignedKeylineState(Context context, float childHorizontalMargins, int availableSpace, Arrangement arrangement) {
        ...
        KeylineState.Builder builderAddAnchorKeyline = new KeylineState.Builder(arrangement.largeSize, availableSpace).addAnchorKeyline(extraSmallHeadCenterX, extraSmallMask, extraSmallChildWidth);
        float mediumMask2 = arrangement.largeSize;
        KeylineState.Builder builder = builderAddAnchorKeyline.addKeylineRange(largeStartCenterX, 0.0f, mediumMask2, arrangement.largeCount, true);
    ...
    static KeylineState createCenterAlignedKeylineState(Context context, float childHorizontalMargins, int availableSpace, Arrangement arrangement) {
        ...
        float largeMask = arrangement.largeSize;
        KeylineState.Builder builder = new KeylineState.Builder(largeMask, availableSpace).addAnchorKeyline(extraSmallHeadCenterX, extraSmallMask, extraSmallChildWidth);
        if (arrangement.smallCount > 0) {
        ...
        float largeMask2 = arrangement.largeSize;
        builder.addKeylineRange(largeStartCenterX, 0.0f, largeMask2, arrangement.largeCount, true);
        if (arrangement.mediumCount > 0) {
