...
public interface Selectable {
    ...
    long mo2027getHandlePositiondBAh8RU(Selection selection, boolean isStartHandle);
    ...
    long mo2028getRangeOfLineContainingjx7JFs(int offset);
