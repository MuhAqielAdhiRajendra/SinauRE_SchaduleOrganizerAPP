...
public final class DurationSerializer implements KSerializer<Duration> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return Duration.m10278boximpl(m10512deserialize5sfh64U(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object value) {
        m10513serializeHG0u8IE(encoder, ((Duration) value).getRawValue());
    }
    ...
    public void m10513serializeHG0u8IE(Encoder encoder, long value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        encoder.encodeString(Duration.m10318toIsoStringimpl(value));
    }

    /* JADX INFO: renamed from: deserialize-5sfh64U, reason: not valid java name */
    public long m10512deserialize5sfh64U(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return Duration.INSTANCE.m10377parseIsoStringUwyO8pc(decoder.decodeString());
    }
}
