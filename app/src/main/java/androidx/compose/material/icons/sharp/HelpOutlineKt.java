...
public final class HelpOutlineKt {
    ...
    @Deprecated(message = "Use the AutoMirrored version at Icons.AutoMirrored.Sharp.HelpOutline", replaceWith = @ReplaceWith(expression = "Icons.AutoMirrored.Sharp.HelpOutline", imports = {"androidx.compose.material.icons.automirrored.sharp.HelpOutline"}))
    public static /* synthetic */ void getHelpOutline$annotations(Icons.Sharp sharp) {
    }

    public static final ImageVector getHelpOutline(Icons.Sharp $this$HelpOutline) {
        ...
        ImageVector.Builder $this$_get_HelpOutline__u24lambda_u241 = new ImageVector.Builder("Sharp.HelpOutline", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
