...
public final class FrontHandKt {
    ...
    public static final ImageVector getFrontHand(Icons.Sharp $this$FrontHand) {
        if (_frontHand != null) {
        ...
        ImageVector.Builder $this$_get_FrontHand__u24lambda_u241 = new ImageVector.Builder("Sharp.FrontHand", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
