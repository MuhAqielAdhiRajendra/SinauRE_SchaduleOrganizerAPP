...
public final class GasMeterKt {
    ...
    public static final ImageVector getGasMeter(Icons.Filled $this$GasMeter) {
        if (_gasMeter != null) {
        ...
        ImageVector.Builder $this$_get_GasMeter__u24lambda_u241 = new ImageVector.Builder("Filled.GasMeter", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
