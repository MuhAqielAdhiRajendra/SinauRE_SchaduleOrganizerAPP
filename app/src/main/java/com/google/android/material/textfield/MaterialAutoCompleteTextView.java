...
public class MaterialAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    ...
    public MaterialAutoCompleteTextView(Context context, AttributeSet attributeSet, int defStyleAttr) {
        ...
        this.selectedStateSet = new int[]{android.R.attr.state_selected};
        ...
        if (attributes.hasValue(com.google.android.material.R.styleable.MaterialAutoCompleteTextView_android_inputType)) {
            int inputType = attributes.getInt(com.google.android.material.R.styleable.MaterialAutoCompleteTextView_android_inputType, 0);
            if (inputType == 0) {
                setKeyListener(null);
            }
        }
        int inputType2 = com.google.android.material.R.styleable.MaterialAutoCompleteTextView_simpleItemLayout;
        this.simpleItemLayout = attributes.getResourceId(inputType2, com.google.android.material.R.layout.mtrl_auto_complete_simple_item);
        this.popupElevation = attributes.getDimensionPixelOffset(com.google.android.material.R.styleable.MaterialAutoCompleteTextView_android_popupElevation, com.google.android.material.R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
        ...
        this.modalListPopup.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.google.android.material.textfield.MaterialAutoCompleteTextView.1
            ...
            public void onItemClick(AdapterView<?> parent, View selectedView, int position, long id) {
                ...
                MaterialAutoCompleteTextView.this.setText(MaterialAutoCompleteTextView.this.convertSelectionToString(selectedItem), false);
                ...
                if (userOnItemClickListener != null) {
                    if (selectedView == null || position < 0) {
                        View selectedView3 = MaterialAutoCompleteTextView.this.modalListPopup.getSelectedView();
                        int position3 = MaterialAutoCompleteTextView.this.modalListPopup.getSelectedItemPosition();
                        long id3 = MaterialAutoCompleteTextView.this.modalListPopup.getSelectedItemId();
                        selectedView2 = selectedView3;
                        position2 = position3;
                        id2 = id3;
                    } else {
    ...
    public boolean isPopupShowing() {
        if (this.modalListPopup != null && this.modalListPopup.isShowing()) {
            return true;
        }
    ...
    boolean shouldShowPopup(int keyCode) {
        boolean isEnterKey = keyCode == 66 || keyCode == 23;
        boolean isSpaceKey = keyCode == 62;
        boolean isEditable = getKeyListener() != null;
        return isEditable ? isEnterKey && getMaxLines() == 1 : isEnterKey || isSpaceKey;
    }
        ...
        private Drawable getSelectedItemDrawable() {
            ...
            if (this.pressedRippleColor != null) {
                ...
                if (focusRingDrawable != null) {
                    focusRingDrawable.setFocusRingStateSet(MaterialAutoCompleteTextView.this.selectedStateSet);
                }
