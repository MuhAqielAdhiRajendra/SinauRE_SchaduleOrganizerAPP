...
public interface Path {
    ...
    /* JADX INFO: compiled from: Path.kt */
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0005\b\u0086\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003j\u0002\b\u0004j\u0002\b\u0005¨\u0006\u0006"}, d2 = {"Landroidx/compose/ui/graphics/Path$Direction;", "", "<init>", "(Ljava/lang/String;I)V", "CounterClockwise", "Clockwise", "ui-graphics"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    void mo5200addPathUv8p0NA(Path path, long offset);
    ...
    boolean mo5202opN5in7k0(Path path1, Path path2, int operation);
    ...
    void mo5203setFillTypeoQ8Xj4U(int i);

    /* JADX INFO: renamed from: translate-k-4lQ0M */
    void mo5205translatek4lQ0M(long offset);

    /* JADX INFO: compiled from: Path.kt */
    @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
    public static final class DefaultImpls {
        @Deprecated
        public static void quadraticTo(Path $this, float x1, float y1, float x2, float y2) {
            Path.super.quadraticTo(x1, y1, x2, y2);
        }

        @Deprecated
        public static void relativeQuadraticTo(Path $this, float dx1, float dy1, float dx2, float dy2) {
            Path.super.relativeQuadraticTo(dx1, dy1, dx2, dy2);
        }

        @Deprecated
        public static void arcToRad(Path $this, Rect rect, float startAngleRadians, float sweepAngleRadians, boolean forceMoveTo) {
            Path.super.arcToRad(rect, startAngleRadians, sweepAngleRadians, forceMoveTo);
        }
        ...
        public static void m5600transform58bKbWc(Path $this, float[] matrix) {
            Path.super.mo5204transform58bKbWc(matrix);
        }

        @Deprecated
        public static PathIterator iterator(Path $this) {
            return Path.super.iterator();
        }

        @Deprecated
        public static PathIterator iterator(Path $this, PathIterator.ConicEvaluation conicEvaluation, float tolerance) {
            return Path.super.iterator(conicEvaluation, tolerance);
        }

        @Deprecated
        public static Path plus(Path $this, Path path) {
            return Path.super.plus(path);
        }

        @Deprecated
        public static Path minus(Path $this, Path path) {
            return Path.super.minus(path);
        }

        @Deprecated
        public static Path or(Path $this, Path path) {
            return Path.super.or(path);
        }

        @Deprecated
        public static Path and(Path $this, Path path) {
            return Path.super.and(path);
        }

        @Deprecated
        public static Path xor(Path $this, Path path) {
            return Path.super.xor(path);
        }
    }
    ...
    static /* synthetic */ void m5597addPathUv8p0NA$default(Path path, Path path2, long j, int i, Object obj) {
        if (obj != null) {
        ...
        path.mo5200addPathUv8p0NA(path2, j);
    }
    ...
    default void mo5204transform58bKbWc(float[] matrix) {
    }
    ...
    default Path plus(Path path) {
        Path $this$plus_u24lambda_u240 = AndroidPath_androidKt.Path();
        $this$plus_u24lambda_u240.mo5202opN5in7k0(this, path, PathOperation.INSTANCE.m5622getUnionb3I0S0c());
        return $this$plus_u24lambda_u240;
    }

    default Path minus(Path path) {
        Path $this$minus_u24lambda_u240 = AndroidPath_androidKt.Path();
        $this$minus_u24lambda_u240.mo5202opN5in7k0(this, path, PathOperation.INSTANCE.m5619getDifferenceb3I0S0c());
        return $this$minus_u24lambda_u240;
    }
    ...
    default Path and(Path path) {
        Path $this$and_u24lambda_u240 = AndroidPath_androidKt.Path();
        $this$and_u24lambda_u240.mo5202opN5in7k0(this, path, PathOperation.INSTANCE.m5620getIntersectb3I0S0c());
        return $this$and_u24lambda_u240;
    }

    default Path xor(Path path) {
        Path $this$xor_u24lambda_u240 = AndroidPath_androidKt.Path();
        $this$xor_u24lambda_u240.mo5202opN5in7k0(this, path, PathOperation.INSTANCE.m5623getXorb3I0S0c());
        return $this$xor_u24lambda_u240;
    }

    /* JADX INFO: compiled from: Path.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J%\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\u00052\u0006\u0010\t\u001a\u00020\u0005¢\u0006\u0004\b\n\u0010\u000b¨\u0006\f"}, d2 = {"Landroidx/compose/ui/graphics/Path$Companion;", "", "<init>", "()V", "combine", "Landroidx/compose/ui/graphics/Path;", "operation", "Landroidx/compose/ui/graphics/PathOperation;", "path1", "path2", "combine-xh6zSI8", "(ILandroidx/compose/ui/graphics/Path;Landroidx/compose/ui/graphics/Path;)Landroidx/compose/ui/graphics/Path;", "ui-graphics"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {
        ...
        public final Path m5598combinexh6zSI8(int operation, Path path1, Path path2) {
            Path path = AndroidPath_androidKt.Path();
            if (path.mo5202opN5in7k0(path1, path2, operation)) {
                return path;
            }
