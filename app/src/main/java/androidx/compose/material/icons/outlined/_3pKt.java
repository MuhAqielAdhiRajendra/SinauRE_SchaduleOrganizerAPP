...
public final class _3pKt {
    ...
    public static final ImageVector get_3p(Icons.Outlined $this$_3p) {
        if (__3p != null) {
        ...
        ImageVector.Builder $this$_get__3p__u24lambda_u241 = new ImageVector.Builder("Outlined._3p", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(16.0f, 13.43f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -0.81f, -0.48f, -1.53f, -1.22f, -1.85f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(13.93f, 11.21f, 12.99f, 11.0f, 12.0f, 11.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.99f, 0.0f, -1.93f, 0.21f, -2.78f, 0.58f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(8.48f, 11.9f, 8.0f, 12.62f, 8.0f, 13.43f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineTo(13.43f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
