...
class AppCompatTextHelper {
    ...
    void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        if (this.mFontTypeface != null) {
            ...
            if (i2 == -1) {
                textView.setTypeface(this.mFontTypeface, this.mStyle);
            } else {
        ...
        if (!ViewUtils.SDK_LEVEL_SUPPORTS_AUTOSIZE || this.mAutoSizeTextHelper.getAutoSizeTextType() == 0) {
            ...
            if (autoSizeTextSizesInPx.length > 0) {
                ...
                if (autoSizeStepGranularity != -1.0f) {
                    Api26Impl.setAutoSizeTextTypeUniformWithConfiguration(textView2, this.mAutoSizeTextHelper.getAutoSizeMinTextSize(), this.mAutoSizeTextHelper.getAutoSizeMaxTextSize(), this.mAutoSizeTextHelper.getAutoSizeStepGranularity(), 0);
                } else {
                    Api26Impl.setAutoSizeTextTypeUniformWithPresetSizes(textView2, autoSizeTextSizesInPx, 0);
                }
            } else {
                f = -1.0f;
            }
        ...
        Drawable drawableStart3 = drawableEnd;
        Drawable drawableBottom2 = drawableBottom;
        Drawable drawableBottom3 = drawableRight;
        Drawable drawableRight2 = drawableTop;
        setCompoundDrawables(drawableLeft, drawableRight2, drawableBottom3, drawableBottom2, drawableStart2, drawableStart3);
        ...
        if (lineHeight != f) {
            ...
            if (lineHeightUnit == -1) {
                TextViewCompat.setLineHeight(textView3, (int) lineHeight);
            } else {
                TextViewCompat.setLineHeight(textView3, lineHeightUnit, lineHeight);
            }
        }
    }
        ...
        if (a.hasValue(R.styleable.TextAppearance_android_fontFamily) || a.hasValue(R.styleable.TextAppearance_fontFamily)) {
            ...
            if (!context.isRestricted()) {
                ...
                ResourcesCompat.FontCallback replyCallback = new ResourcesCompat.FontCallback() { // from class: androidx.appcompat.widget.AppCompatTextHelper.1
                    ...
                    public void m8418x46c88379(Typeface typeface) {
                    ...
                    public void m8417xb24343b7(int reason) {
                    }
                };
                try {
