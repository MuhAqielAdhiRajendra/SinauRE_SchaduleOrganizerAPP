...
public final class ReadonlySnapshot extends Snapshot {
    ...
    public Snapshot takeNestedSnapshot(Function1<Object, Unit> readObserver) {
        ...
        ReadonlySnapshot parent$iv = this;
        ...
        Snapshot result$iv = new NestedReadonlySnapshot(getSnapshotId(), getInvalid(), SnapshotKt.mergedReadObserver$default(readObserver2, getReadObserver(), false, 4, null), this);
        if (observers$iv != null) {
