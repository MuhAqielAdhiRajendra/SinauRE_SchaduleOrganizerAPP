...
public final class ComposeDragShadowBuilder extends View.DragShadowBuilder {
    ...
    public void onProvideShadowMetrics(Point outShadowSize, Point outShadowTouchPoint) {
        ...
        int iMo426roundToPx0680j_4 = $this$onProvideShadowMetrics_u24lambda_u240.mo426roundToPx0680j_4($this$onProvideShadowMetrics_u24lambda_u240.mo428toDpu2uoSUM(Float.intBitsToFloat(bits$iv$iv$iv)));
        long arg0$iv2 = this.decorationSize;
        int bits$iv$iv$iv2 = (int) (4294967295L & arg0$iv2);
        outShadowSize.set(iMo426roundToPx0680j_4, $this$onProvideShadowMetrics_u24lambda_u240.mo426roundToPx0680j_4($this$onProvideShadowMetrics_u24lambda_u240.mo428toDpu2uoSUM(Float.intBitsToFloat(bits$iv$iv$iv2))));
    ...
    public void onDrawShadow(Canvas canvas) {
        ...
        long size$iv = this.decorationSize;
        LayoutDirection layoutDirection$iv = LayoutDirection.Ltr;
