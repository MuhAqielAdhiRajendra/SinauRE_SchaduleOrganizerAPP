...
final class RotaryInputElement extends ModifierNodeElement<RotaryInputNode> {
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        if (function1 != null) {
            ...
            $this$inspectableProperties.getProperties().set("onRotaryScrollEvent", function1);
        }
        ...
        if (function12 != null) {
            ...
            $this$inspectableProperties.getProperties().set("onPreRotaryScrollEvent", function12);
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof RotaryInputElement) && this.onRotaryScrollEvent == ((RotaryInputElement) other).onRotaryScrollEvent && this.onPreRotaryScrollEvent == ((RotaryInputElement) other).onPreRotaryScrollEvent;
    }
