...
public final class LifecycleController {
    ...
    public LifecycleController(Lifecycle lifecycle, Lifecycle.State minState, DispatchQueue dispatchQueue, final Job parentJob) {
        ...
        this.observer = new LifecycleEventObserver() { // from class: androidx.lifecycle.LifecycleController$$ExternalSyntheticLambda0
    ...
    static final void observer$lambda$0(LifecycleController this$0, Job $parentJob, LifecycleOwner source, Lifecycle.Event event) {
