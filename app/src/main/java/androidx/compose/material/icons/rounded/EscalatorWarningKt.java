...
public final class EscalatorWarningKt {
    ...
    public static final ImageVector getEscalatorWarning(Icons.Rounded $this$EscalatorWarning) {
        ...
        ImageVector.Builder $this$_get_EscalatorWarning__u24lambda_u241 = new ImageVector.Builder("Rounded.EscalatorWarning", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(-9.39f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(2.24f, 3.89f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.18f, 0.31f, 0.51f, 0.5f, 0.87f, 0.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(1.1f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.33f, 0.0f, 0.63f, -0.16f, 0.82f, -0.43f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _escalatorWarning = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_EscalatorWarning__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
