...
final /* data */ class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public static /* synthetic */ BoxWithConstraintsScopeImpl m769copy0kLqBqw$default(BoxWithConstraintsScopeImpl boxWithConstraintsScopeImpl, Density density, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return boxWithConstraintsScopeImpl.m771copy0kLqBqw(density, j);
    }
    ...
    public final BoxWithConstraintsScopeImpl m771copy0kLqBqw(Density density, long constraints) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.density, boxWithConstraintsScopeImpl.density) && Constraints.m8096equalsimpl0(this.constraints, boxWithConstraintsScopeImpl.constraints);
    }

    public int hashCode() {
        return (this.density.hashCode() * 31) + Constraints.m8106hashCodeimpl(this.constraints);
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + ((Object) Constraints.m8108toStringimpl(this.constraints)) + ')';
    }
    ...
    public long mo764getConstraintsmsEJaDk() {
        return this.constraints;
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMinWidth-D9Ej5fM */
    public float mo768getMinWidthD9Ej5fM() {
        Density $this$getMinWidth_D9Ej5fM_u24lambda_u240 = this.density;
        return $this$getMinWidth_D9Ej5fM_u24lambda_u240.mo429toDpu2uoSUM(Constraints.m8105getMinWidthimpl(mo764getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMaxWidth-D9Ej5fM */
    public float mo766getMaxWidthD9Ej5fM() {
        Density $this$getMaxWidth_D9Ej5fM_u24lambda_u240 = this.density;
        return Constraints.m8099getHasBoundedWidthimpl(mo764getConstraintsmsEJaDk()) ? $this$getMaxWidth_D9Ej5fM_u24lambda_u240.mo429toDpu2uoSUM(Constraints.m8103getMaxWidthimpl(mo764getConstraintsmsEJaDk())) : Dp.INSTANCE.m8169getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMinHeight-D9Ej5fM */
    public float mo767getMinHeightD9Ej5fM() {
        Density $this$getMinHeight_D9Ej5fM_u24lambda_u240 = this.density;
        return $this$getMinHeight_D9Ej5fM_u24lambda_u240.mo429toDpu2uoSUM(Constraints.m8104getMinHeightimpl(mo764getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMaxHeight-D9Ej5fM */
    public float mo765getMaxHeightD9Ej5fM() {
        Density $this$getMaxHeight_D9Ej5fM_u24lambda_u240 = this.density;
        return Constraints.m8098getHasBoundedHeightimpl(mo764getConstraintsmsEJaDk()) ? $this$getMaxHeight_D9Ej5fM_u24lambda_u240.mo429toDpu2uoSUM(Constraints.m8102getMaxHeightimpl(mo764getConstraintsmsEJaDk())) : Dp.INSTANCE.m8169getInfinityD9Ej5fM();
    }
}
