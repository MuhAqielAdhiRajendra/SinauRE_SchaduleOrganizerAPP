...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    public Chip(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.fontCallback = new TextAppearanceFontCallback() { // from class: com.google.android.material.chip.Chip.1
            ...
            public void onFontRetrieved(Typeface typeface, boolean fontResolvedSynchronously) {
                Chip chip = Chip.this;
                boolean zShouldDrawText = Chip.this.chipDrawable.shouldDrawText();
        ...
        super.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.google.android.material.chip.Chip$$ExternalSyntheticLambda0
            ...
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                this.f$0.m8792lambda$new$0$comgoogleandroidmaterialchipChip(compoundButton, z);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$0$com-google-android-material-chip-Chip, reason: not valid java name */
    /* synthetic */ void m8792lambda$new$0$comgoogleandroidmaterialchipChip(CompoundButton buttonView, boolean isChecked) {
    ...
    public String getFontVariationSettings() {
        if (this.chipDrawable != null) {
            return this.chipDrawable.getFontVariationSettings();
        }
    ...
    public boolean setFontVariationSettings(String fontVariationSettings) {
        ...
        if (this.chipDrawable != null) {
            this.chipDrawable.setFontVariationSettings(fontVariationSettings);
            updateTextPaintDrawState();
            return true;
        }
        return false;
