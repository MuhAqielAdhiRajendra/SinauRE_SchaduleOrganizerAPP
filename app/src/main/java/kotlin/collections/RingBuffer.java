...
final class RingBuffer<T> extends AbstractList<T> implements RandomAccess {
    ...
    public <T> T[] toArray(T[] array) {
        ...
        return (T[]) CollectionsKt.terminateCollectionToArray(size, objArrCopyOf);
    }
    ...
    public final void removeFirst(int n) {
        ...
        if (n > 0) {
            ...
            Object[] objArr = this.buffer;
            if (start > end) {
                ArraysKt.fill(objArr, (Object) null, start, this.capacity);
                ArraysKt.fill(this.buffer, (Object) null, 0, end);
            } else {
                ArraysKt.fill(objArr, (Object) null, start, end);
            }
            this.startIndex = end;
            this.size = size() - n;
        }
