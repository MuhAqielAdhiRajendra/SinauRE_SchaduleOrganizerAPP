...
public final class LineAxisKt {
    ...
    public static final ImageVector getLineAxis(Icons.Outlined $this$LineAxis) {
        if (_lineAxis != null) {
        ...
        ImageVector.Builder $this$_get_LineAxis__u24lambda_u241 = new ImageVector.Builder("Outlined.LineAxis", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
