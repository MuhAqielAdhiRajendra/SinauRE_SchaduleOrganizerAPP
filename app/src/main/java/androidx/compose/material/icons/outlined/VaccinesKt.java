...
public final class VaccinesKt {
    ...
    public static final ImageVector getVaccines(Icons.Outlined $this$Vaccines) {
        if (_vaccines != null) {
        ...
        ImageVector.Builder $this$_get_Vaccines__u24lambda_u241 = new ImageVector.Builder("Outlined.Vaccines", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineTo(17.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(-4.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -0.51f, 0.0f, -1.02f, 0.0f, -1.5f);
