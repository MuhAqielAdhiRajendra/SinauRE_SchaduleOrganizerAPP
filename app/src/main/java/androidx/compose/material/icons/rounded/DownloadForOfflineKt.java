...
public final class DownloadForOfflineKt {
    ...
    public static final ImageVector getDownloadForOffline(Icons.Rounded $this$DownloadForOffline) {
        ...
        ImageVector.Builder $this$_get_DownloadForOffline__u24lambda_u241 = new ImageVector.Builder("Rounded.DownloadForOffline", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-2.79f, -2.79f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(8.54f, 10.54f, 8.76f, 10.0f, 9.21f, 10.0f);
