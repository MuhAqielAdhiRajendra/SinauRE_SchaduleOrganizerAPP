...
final /* data */ class DensityWithConverter implements Density {
    ...
    public float mo427toDpGaN1DYA(long $this$toDp_u2dGaN1DYA) {
        if (TextUnitType.m8372equalsimpl0(TextUnit.m8343getTypeUIouoOA($this$toDp_u2dGaN1DYA), TextUnitType.INSTANCE.m8377getSpUIouoOA())) {
            return Dp.m8150constructorimpl(this.converter.convertSpToDp(TextUnit.m8344getValueimpl($this$toDp_u2dGaN1DYA)));
        }
