...
public final class ArrowCircleLeftKt {
    ...
    public static final ImageVector getArrowCircleLeft(Icons.TwoTone $this$ArrowCircleLeft) {
        ...
        ImageVector.Builder $this$_get_ArrowCircleLeft__u24lambda_u242 = new ImageVector.Builder("TwoTone.ArrowCircleLeft", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(20.0f, 7.59f, 20.0f, 12.0f);
        ...
        ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_ArrowCircleLeft__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 0.3f, null, 0.3f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.reflectiveCurveTo(20.0f, 7.59f, 20.0f, 12.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
        _arrowCircleLeft = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_ArrowCircleLeft__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv2.getNodes(), pathFillType$iv2, "", fill$iv$iv2, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv2, strokeLineJoin$iv$iv2, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
