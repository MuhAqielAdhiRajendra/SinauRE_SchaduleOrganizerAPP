...
/* JADX INFO: compiled from: GifBox.kt */
...
public final class GifBoxKt {
    ...
    public static final ImageVector getGifBox(Icons.Rounded $this$GifBox) {
        if (_gifBox != null) {
        ...
        ImageVector.Builder $this$_get_GifBox__u24lambda_u241 = new ImageVector.Builder("Rounded.GifBox", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(10.5f, 10.5f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -0.29f, 0.25f, -0.53f, 0.55f, -0.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.26f, 0.02f, 0.45f, 0.26f, 0.45f, 0.52f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(10.28f, 10.0f, 10.5f, 10.22f, 10.5f, 10.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(-3.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(11.5f, 10.22f, 11.72f, 10.0f, 12.0f, 10.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.28f, 0.0f, 0.5f, 0.22f, 0.5f, 0.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(16.28f, 11.0f, 16.0f, 11.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(14.5f, 13.78f, 14.28f, 14.0f, 14.0f, 14.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _gifBox = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_GifBox__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
        ImageVector imageVector2 = _gifBox;
