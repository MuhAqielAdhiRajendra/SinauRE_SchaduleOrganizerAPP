...
final class FocusTargetInteropElement extends ModifierNodeElement<FocusTargetInteropNode> {
    ...
    public FocusTargetInteropNode getNode() {
        return new FocusTargetInteropNode();
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void update(FocusTargetInteropNode node) {
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        $this$inspectableProperties.setName("focusTargetInterop");
    }
