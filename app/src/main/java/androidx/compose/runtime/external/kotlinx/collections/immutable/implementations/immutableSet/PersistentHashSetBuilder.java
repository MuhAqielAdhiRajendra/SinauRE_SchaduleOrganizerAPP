...
public final class PersistentHashSetBuilder<E> extends AbstractMutableSet<E> implements PersistentSet.Builder<E> {
    ...
    public boolean retainAll(Collection<?> elements) {
        ...
        if (persistentHashSetBuild != null) {
            DeltaCounter deltaCounter = new DeltaCounter(0, 1, null);
            int size = size();
            Object result = this.node.mutableRetainAll(persistentHashSetBuild.getNode$runtime(), 0, deltaCounter, this);
    ...
    public boolean removeAll(Collection<?> elements) {
        ...
        if (persistentHashSetBuild != null) {
            ...
            int size = size();
            Object result = this.node.mutableRemoveAll(persistentHashSetBuild.getNode$runtime(), 0, counter, this);
