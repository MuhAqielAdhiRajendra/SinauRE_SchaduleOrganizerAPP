...
public final class ExclusiveLock {
    ...
    public ExclusiveLock(String filename, boolean useFileLock) {
        ...
        this.threadLock = INSTANCE.getThreadLock(filename);
        this.fileLock = useFileLock ? INSTANCE.getFileLock(filename) : null;
    }
