...
public final class CallMissedKt {
    ...
    public static final ImageVector getCallMissed(Icons.TwoTone $this$CallMissed) {
        if (_callMissed != null) {
        ...
        ImageVector.Builder $this$_get_CallMissed__u24lambda_u241 = new ImageVector.Builder("TwoTone.CallMissed", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
