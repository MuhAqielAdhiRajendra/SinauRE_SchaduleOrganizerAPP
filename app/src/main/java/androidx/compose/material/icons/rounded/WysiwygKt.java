...
public final class WysiwygKt {
    ...
    @Deprecated(message = "Use the AutoMirrored version at Icons.AutoMirrored.Rounded.Wysiwyg", replaceWith = @ReplaceWith(expression = "Icons.AutoMirrored.Rounded.Wysiwyg", imports = {"androidx.compose.material.icons.automirrored.rounded.Wysiwyg"}))
    public static /* synthetic */ void getWysiwyg$annotations(Icons.Rounded rounded) {
    }

    public static final ImageVector getWysiwyg(Icons.Rounded $this$Wysiwyg) {
        if (_wysiwyg != null) {
        ...
        ImageVector.Builder $this$_get_Wysiwyg__u24lambda_u241 = new ImageVector.Builder("Rounded.Wysiwyg", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
