...
public final /* data */ class SharedBoundsNodeElement extends ModifierNodeElement<SharedBoundsNode> {
    ...
    public final SharedElementEntry getSharedElementState() {
        return this.sharedElementState;
    }

    public final SharedBoundsNodeElement copy(SharedElementEntry sharedElementState) {
    ...
    public SharedBoundsNodeElement(SharedElementEntry sharedElementState) {
