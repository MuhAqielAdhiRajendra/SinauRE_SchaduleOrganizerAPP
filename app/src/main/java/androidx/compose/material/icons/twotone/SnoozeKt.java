...
public final class SnoozeKt {
    ...
    public static final ImageVector getSnooze(Icons.TwoTone $this$Snooze) {
        if (_snooze != null) {
        ...
        ImageVector.Builder $this$_get_Snooze__u24lambda_u241 = new ImageVector.Builder("TwoTone.Snooze", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
