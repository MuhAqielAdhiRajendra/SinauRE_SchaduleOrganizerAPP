...
/* JADX INFO: compiled from: FabPrimaryContainerTokens.kt */
...
public final class FabPrimaryContainerTokens {
    ...
    public final float m3856getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* JADX INFO: renamed from: getFocusedContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m3857getFocusedContainerElevationD9Ej5fM() {
    ...
    public final float m3858getHoveredContainerElevationD9Ej5fM() {
    ...
    public final float m3859getPressedContainerElevationD9Ej5fM() {
