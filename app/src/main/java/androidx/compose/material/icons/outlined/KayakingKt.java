...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_kayaking", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Kayaking", "Landroidx/compose/material/icons/Icons$Outlined;", "getKayaking", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class KayakingKt {
    private static ImageVector _kayaking;

    public static final ImageVector getKayaking(Icons.Outlined $this$Kayaking) {
        if (_kayaking != null) {
        ...
        ImageVector.Builder $this$_get_Kayaking__u24lambda_u241 = new ImageVector.Builder("Outlined.Kayaking", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(24.0f, 17.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, 0.0f, -1.52f, 0.71f, -3.93f, 1.37f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.82f, -0.23f, -1.53f, -0.75f, -2.07f, -1.37f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.73f, 0.84f, -1.8f, 1.5f, -3.0f, 1.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(-2.27f, -0.66f, -3.0f, -1.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.54f, 0.61f, -1.25f, 1.13f, -2.07f, 1.37f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(1.52f, 18.21f, 0.0f, 17.5f, 0.0f, 17.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(2.93f, -1.36f, 7.13f, -2.08f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-0.51f, -1.32f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(18.8f, 2.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(22.0f, 3.43f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(20.67f, 6.4f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-1.31f, 0.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-3.72f, 8.34f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(20.49f, 15.87f, 24.0f, 17.5f, 24.0f, 17.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(15.02f, 12.96f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-1.52f, 0.8f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-1.75f, -0.92f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _kayaking = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_Kayaking__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
