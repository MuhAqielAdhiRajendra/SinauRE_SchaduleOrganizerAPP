...
public final class EvStationKt {
    ...
    public static final ImageVector getEvStation(Icons.Sharp $this$EvStation) {
        if (_evStation != null) {
        ...
        ImageVector.Builder $this$_get_EvStation__u24lambda_u241 = new ImageVector.Builder("Sharp.EvStation", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
