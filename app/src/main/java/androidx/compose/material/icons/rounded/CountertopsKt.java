...
public final class CountertopsKt {
    ...
    public static final ImageVector getCountertops(Icons.Rounded $this$Countertops) {
        ...
        ImageVector.Builder $this$_get_Countertops__u24lambda_u241 = new ImageVector.Builder("Rounded.Countertops", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -1.62f, -1.22f, -3.08f, -2.84f, -3.17f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-1.21f, -0.06f, -2.27f, 0.59f, -2.8f, 1.57f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(12.01f, 6.22f, 12.53f, 7.0f, 13.27f, 7.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(14.28f, 6.22f, 14.62f, 6.0f, 15.0f, 6.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _countertops = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_Countertops__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
