...
public final class UIntSerializer implements KSerializer<UInt> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return UInt.m9018boximpl(m10530deserializeOGnWXxg(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object value) {
        m10531serializeQn1smSk(encoder, ((UInt) value).getData());
    }
    ...
    public void m10531serializeQn1smSk(Encoder encoder, int value) {
    ...
    public int m10530deserializeOGnWXxg(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return UInt.m9024constructorimpl(decoder.decodeInline(getDescriptor()).decodeInt());
    }
}
