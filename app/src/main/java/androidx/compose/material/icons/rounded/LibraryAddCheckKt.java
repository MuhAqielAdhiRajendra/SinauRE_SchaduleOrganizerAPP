...
public final class LibraryAddCheckKt {
    ...
    public static final ImageVector getLibraryAddCheck(Icons.Rounded $this$LibraryAddCheck) {
        ...
        ImageVector.Builder $this$_get_LibraryAddCheck__u24lambda_u241 = new ImageVector.Builder("Rounded.LibraryAddCheck", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(11.76f, 13.28f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(9.69f, 11.2f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.38f, -0.39f, -0.38f, -1.01f, 0.0f, -1.4f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(1.36f, 1.37f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(4.42f, -4.46f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.39f, -0.39f, 1.02f, -0.39f, 1.41f, 0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(0.0f, 0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.38f, 0.39f, 0.38f, 1.01f, 0.0f, 1.4f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-5.13f, 5.17f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(12.79f, 13.68f, 12.15f, 13.68f, 11.76f, 13.28f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
