...
public final class SliderState implements DraggableState {
    ...
    public final void setValue(float newVal) {
        float fCalculateSnappedValue;
        if (this.shouldAutoSnap) {
            fCalculateSnappedValue = calculateSnappedValue(newVal);
        } else {
            fCalculateSnappedValue = newVal;
        }
        setValueState(fCalculateSnappedValue);
    }
    ...
    private final float calculateSnappedValue(float newVal) {
        ...
        return SliderKt.snapValueToTick(coercedValue, this.tickFractions, this.valueRange.getStart().floatValue(), this.valueRange.getEndInclusive().floatValue());
    }
    ...
    static final Unit gestureEndAction$lambda$1(SliderState this$0) {
    ...
    public final void m2996onPressk4lQ0M$material3(long pos) {
        float to;
        if (this.orientation == Orientation.Vertical) {
    ...
    public static final class Companion {
        ...
        static final SliderState Saver$lambda$1(Function0 $onValueChangeFinished, ClosedFloatingPointRange $valueRange, List it) {
            Object obj = it.get(0);
            Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type kotlin.Float");
            float fFloatValue = ((Float) obj).floatValue();
            Object obj2 = it.get(1);
            Intrinsics.checkNotNull(obj2, "null cannot be cast to non-null type kotlin.Int");
            return new SliderState(fFloatValue, ((Integer) obj2).intValue(), $onValueChangeFinished, $valueRange);
        }
    }
}
