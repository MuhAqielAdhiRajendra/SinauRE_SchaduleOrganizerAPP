...
public final class LiveDataScopeImpl<T> implements LiveDataScope<T> {
    ...
    static final class C03502 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super DisposableHandle>, Object> {
        final /* synthetic */ LiveData<T> $source;
        int label;
        final /* synthetic */ LiveDataScopeImpl<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03502(LiveDataScopeImpl<T> liveDataScopeImpl, LiveData<T> liveData, Continuation<? super C03502> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C03502(this.this$0, this.$source, continuation);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (objEmitSource$lifecycle_livedata == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    return objEmitSource$lifecycle_livedata;
                case 1:
                    ResultKt.throwOnFailure($result);
                    return $result;
                default:
    ...
    public Object emitSource(LiveData<T> liveData, Continuation<? super DisposableHandle> continuation) {
        return BuildersKt.withContext(this.coroutineContext, new C03502(this, liveData, null), continuation);
    }
