...
public final class TabRowKt$TabRowImpl$1$scope$1$1 implements TabIndicatorScope, TabPositionsHolder {
    ...
    public Modifier tabIndicatorLayout(Modifier $this$tabIndicatorLayout, final Function4<? super MeasureScope, ? super Measurable, ? super Constraints, ? super List<TabPosition>, ? extends MeasureResult> function4) {
        return LayoutModifierKt.layout($this$tabIndicatorLayout, new Function3() { // from class: androidx.compose.material3.TabRowKt$TabRowImpl$1$scope$1$1$$ExternalSyntheticLambda0
    ...
    static final MeasureResult tabIndicatorLayout$lambda$0(Function4 $measure, TabRowKt$TabRowImpl$1$scope$1$1 this$0, MeasureScope $this$layout, Measurable measurable, Constraints constraints) {
