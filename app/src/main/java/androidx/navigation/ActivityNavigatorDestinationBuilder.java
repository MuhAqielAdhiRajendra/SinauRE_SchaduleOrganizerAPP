...
public final class ActivityNavigatorDestinationBuilder extends NavDestinationBuilder<ActivityNavigator.Destination> {
    ...
    public ActivityNavigatorDestinationBuilder(ActivityNavigator navigator, int id) {
        super(navigator, id);
    ...
    public ActivityNavigator.Destination build() {
        ...
        ActivityNavigator.Destination destination = (ActivityNavigator.Destination) navDestinationBuild;
        ...
        return (ActivityNavigator.Destination) navDestinationBuild;
    }
}
