...
public final class DrawCache {
    ...
    private int config = ImageBitmapConfig.INSTANCE.m5544getArgb8888_sVssgQ();
    ...
    public final void m6037drawCachedImageFqjB98A(int config, long size, Density density, LayoutDirection layoutDirection, Function1<? super DrawScope, Unit> block) {
        long j;
        ...
        if (targetImage == null || targetCanvas == null) {
            ...
            j = 4294967295L;
            if (((int) (size >> 32)) > targetImage.getWidth() || ((int) (size & 4294967295L)) > targetImage.getHeight() || !ImageBitmapConfig.m5539equalsimpl0(this.config, config)) {
            }
            this.size = size;
            CanvasDrawScope this_$iv = this.cacheScope;
            long size$iv = IntSizeKt.m8333toSizeozmzZPI(size);
            ...
            block.invoke($this$drawCachedImage_FqjB98A_u24lambda_u240);
            canvas$iv.restore();
        ...
        targetImage = ImageBitmapKt.m5549ImageBitmapx__hDU$default((int) (size >> 32), (int) (size & j), config, false, null, 24, null);
        targetCanvas = CanvasKt.Canvas(targetImage);
        this.mCachedImage = targetImage;
        this.cachedCanvas = targetCanvas;
        this.config = config;
        this.size = size;
        CanvasDrawScope this_$iv2 = this.cacheScope;
        long size$iv2 = IntSizeKt.m8333toSizeozmzZPI(size);
        ...
        $this$draw_yzxVdVo_u24lambda_u240$iv2.setDensity(density);
        $this$draw_yzxVdVo_u24lambda_u240$iv2.setLayoutDirection(layoutDirection);
        $this$draw_yzxVdVo_u24lambda_u240$iv2.setCanvas(canvas$iv2);
        $this$draw_yzxVdVo_u24lambda_u240$iv2.m5807setSizeuvyYCjk(size$iv2);
        canvas$iv2.save();
        CanvasDrawScope $this$drawCachedImage_FqjB98A_u24lambda_u2402 = this_$iv2;
        clear($this$drawCachedImage_FqjB98A_u24lambda_u2402);
        block.invoke($this$drawCachedImage_FqjB98A_u24lambda_u2402);
        canvas$iv2.restore();
        ...
        $this$draw_yzxVdVo_u24lambda_u241$iv2.m5807setSizeuvyYCjk(prevSize$iv2);
        targetImage.prepareToDraw();
    }
    ...
    public final void drawInto(DrawScope target, float alpha, ColorFilter colorFilter) {
        ...
        DrawScope.m5870drawImageAZ2fEMs$default(target, targetImage, 0L, this.size, 0L, 0L, alpha, null, colorFilter, 0, 0, 858, null);
    }

    private final void clear(DrawScope $this$clear) {
        DrawScope.m5881drawRectnJ9OG0$default($this$clear, Color.INSTANCE.m5339getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.INSTANCE.m5226getClear0nO6VwU(), 62, null);
    }
}
