...
public final class SplitButtonLargeTokens {
    ...
    private static final float ContainerHeight = Dp.m8150constructorimpl((float) 96.0d);
    ...
    private static final float LeadingButtonLeadingSpace = Dp.m8150constructorimpl((float) 48.0d);
    private static final float LeadingButtonTrailingSpace = Dp.m8150constructorimpl((float) 48.0d);
    private static final float TrailingIconSize = Dp.m8150constructorimpl((float) 38.0d);
    private static final float TrailingInnerSelectedCornerCornerSizePercent = 50.0f;
    private static final float TrailingButtonLeadingSpace = Dp.m8150constructorimpl((float) 29.0d);
    private static final float TrailingButtonTrailingSpace = Dp.m8150constructorimpl((float) 29.0d);

    private SplitButtonLargeTokens() {
    }

    /* JADX INFO: renamed from: getBetweenSpace-D9Ej5fM, reason: not valid java name */
    public final float m4191getBetweenSpaceD9Ej5fM() {
        return BetweenSpace;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m4192getContainerHeightD9Ej5fM() {
    ...
    public final float m4195getTrailingButtonLeadingSpaceD9Ej5fM() {
    ...
    public final float m4196getTrailingButtonTrailingSpaceD9Ej5fM() {
