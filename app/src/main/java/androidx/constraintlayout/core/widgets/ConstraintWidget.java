...
public class ConstraintWidget {
    ...
    public int getOptimizerWrapHeight() {
        ...
        if (this.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            int i2 = this.mMatchConstraintMinHeight;
            if (i == 1) {
                h = Math.max(i2, h2);
            } else if (i2 > 0) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:321:0x06b5  */
    /* JADX WARN: Removed duplicated region for block: B:323:0x06c4  */
    /* JADX WARN: Removed duplicated region for block: B:327:0x06ec  */
    /* JADX WARN: Removed duplicated region for block: B:330:0x06f6  */
    /* JADX WARN: Removed duplicated region for block: B:333:0x071d  */
    ...
    */
        ...
        if (!variableSize) {
            if (wrapContent) {
                ...
                if (maxDimension < Integer.MAX_VALUE) {
                    linearSystem.addLowerThan(end, begin, maxDimension, i3);
                }
            } else {
        ...
        if (isBeginConnected || isEndConnected || isCenterConnected) {
            if (isBeginConnected && !isEndConnected) {
                ...
                if (!parentWrapContent) {
                    endTarget3 = endTarget2;
                    wrapStrength = 5;
                } else if (this.mOptimizeWrapO && begin.isFinalValue && this.mParent != null) {
                ...
                if (this.mVisibility == i2 && !endAnchor.hasDependents()) {
                    return;
                }
                if (applyRangeCheck) {
                ...
                if (parentWrapContent2 && variableSize2 && minDimension == 0 && matchMinDimension2 == 0) {
                    if (variableSize2 && matchConstraintDefault3 == 3) {
                        ...
                        int i4 = 0;
                        linearSystem.addGreaterThan(end, begin, i4, wrapStrength);
                    }
                }
            } else {
                endTarget3 = endTarget2;
    ...
    public void addChildrenToSolverByDependency(ConstraintWidgetContainer container, LinearSystem system, HashSet<ConstraintWidget> widgets, int orientation, boolean addSelf) {
        ...
        if (orientation == 0) {
            ...
            if (dependents2 != null) {
                for (ConstraintAnchor anchor2 : dependents2) {
