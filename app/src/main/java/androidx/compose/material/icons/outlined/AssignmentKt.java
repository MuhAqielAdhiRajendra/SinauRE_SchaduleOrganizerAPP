...
public final class AssignmentKt {
    ...
    public static final ImageVector getAssignment(Icons.Outlined $this$Assignment) {
        if (_assignment != null) {
        ...
        ImageVector.Builder $this$_get_Assignment__u24lambda_u241 = new ImageVector.Builder("Outlined.Assignment", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
