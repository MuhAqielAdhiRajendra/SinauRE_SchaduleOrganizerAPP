...
public final class FormatTextdirectionRToLKt {
    ...
    @Deprecated(message = "Use the AutoMirrored version at Icons.AutoMirrored.Sharp.FormatTextdirectionRToL", replaceWith = @ReplaceWith(expression = "Icons.AutoMirrored.Sharp.FormatTextdirectionRToL", imports = {"androidx.compose.material.icons.automirrored.sharp.FormatTextdirectionRToL"}))
    public static /* synthetic */ void getFormatTextdirectionRToL$annotations(Icons.Sharp sharp) {
    }

    public static final ImageVector getFormatTextdirectionRToL(Icons.Sharp $this$FormatTextdirectionRToL) {
        ...
        ImageVector.Builder $this$_get_FormatTextdirectionRToL__u24lambda_u241 = new ImageVector.Builder("Sharp.FormatTextdirectionRToL", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
