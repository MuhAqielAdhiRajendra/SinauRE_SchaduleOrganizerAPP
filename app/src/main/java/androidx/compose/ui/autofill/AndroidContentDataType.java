...
final class AndroidContentDataType implements ContentDataType {
    ...
    public static boolean m4812equalsimpl(int i, Object obj) {
        return (obj instanceof AndroidContentDataType) && i == ((AndroidContentDataType) obj).m4816unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m4812equalsimpl(this.androidAutofillType, obj);
    }

    public int hashCode() {
        return m4814hashCodeimpl(this.androidAutofillType);
    }

    public String toString() {
        return m4815toStringimpl(this.androidAutofillType);
    }
