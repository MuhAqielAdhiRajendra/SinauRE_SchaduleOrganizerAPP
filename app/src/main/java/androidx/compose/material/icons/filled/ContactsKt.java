...
public final class ContactsKt {
    ...
    public static final ImageVector getContacts(Icons.Filled $this$Contacts) {
        if (_contacts != null) {
        ...
        ImageVector.Builder $this$_get_Contacts__u24lambda_u241 = new ImageVector.Builder("Filled.Contacts", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(4.0f, 0.0f);
