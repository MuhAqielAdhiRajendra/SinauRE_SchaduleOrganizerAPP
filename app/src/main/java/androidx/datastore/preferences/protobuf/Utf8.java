        ...
        int encodeUtf8(CharSequence in, byte[] out, int offset, int length) {
            ...
            while (i < utf16Length) {
                ...
                if (c2 < 128 && j < limit) {
                    ...
                    int j3 = j + 1;
                    out[j] = (byte) ((c2 >>> '\f') | WindowSizeClass.HEIGHT_DP_MEDIUM_LOWER_BOUND);
                    int j4 = j3 + 1;
            ...
            while (inIx < inLimit) {
                ...
                if (c4 >= c || outIx >= outLimit) {
                    ...
                    if (c4 < 2048 && outIx <= outLimit - 2) {
                        ...
                        UnsafeUtil.putByte(out, outIx, (byte) ((c4 >>> '\f') | WindowSizeClass.HEIGHT_DP_MEDIUM_LOWER_BOUND));
            ...
            while (inIx < inLimit) {
                ...
                if (c2 >= i || outIx >= outLimit) {
                    ...
                    if (c2 >= 2048 || outIx > outLimit - 2) {
                        ...
                        UnsafeUtil.putByte(outIx, (byte) ((c2 >>> '\f') | WindowSizeClass.HEIGHT_DP_MEDIUM_LOWER_BOUND));
        ...
        */
        private static int partialIsValidUtf8(byte[] r11, long r12, int r14) {
            ...
            L8:
                ...
                if (r14 <= 0) goto L1a
                long r4 = r12 + r2
                byte r12 = androidx.datastore.preferences.protobuf.UnsafeUtil.getByte(r11, r12)
                r1 = r12
                if (r12 < 0) goto L19
                int r14 = r14 + (-1)
                r12 = r4
            ...
            L5f:
                long r2 = r2 + r7
                byte r12 = androidx.datastore.preferences.protobuf.UnsafeUtil.getByte(r11, r7)
                if (r12 <= r5) goto L68
                r7 = r2
                goto L6a
            L68:
            ...
            L73:
                ...
                if (r12 > r5) goto L9b
                long r7 = r9 + r2
                byte r12 = androidx.datastore.preferences.protobuf.UnsafeUtil.getByte(r11, r9)
                if (r12 <= r5) goto L98
                goto L9c
            L98:
                r12 = r7
