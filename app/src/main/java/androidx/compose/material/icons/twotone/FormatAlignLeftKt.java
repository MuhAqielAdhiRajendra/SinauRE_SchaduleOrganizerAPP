...
public final class FormatAlignLeftKt {
    ...
    @Deprecated(message = "Use the AutoMirrored version at Icons.AutoMirrored.TwoTone.FormatAlignLeft", replaceWith = @ReplaceWith(expression = "Icons.AutoMirrored.TwoTone.FormatAlignLeft", imports = {"androidx.compose.material.icons.automirrored.twotone.FormatAlignLeft"}))
    public static /* synthetic */ void getFormatAlignLeft$annotations(Icons.TwoTone twoTone) {
    }

    public static final ImageVector getFormatAlignLeft(Icons.TwoTone $this$FormatAlignLeft) {
        ...
        ImageVector.Builder $this$_get_FormatAlignLeft__u24lambda_u241 = new ImageVector.Builder("TwoTone.FormatAlignLeft", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
