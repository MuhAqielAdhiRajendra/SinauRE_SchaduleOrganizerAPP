...
public final class CardElevation {
    ...
    public final State<Dp> shadowElevation$material3(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1763481333, $changed, -1, "androidx.compose.material3.CardElevation.shadowElevation (Card.kt:655)");
        }
        if (interactionSource == null) {
            ...
            if (it$iv == Composer.INSTANCE.getEmpty()) {
                Object value$iv = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m8148boximpl(this.defaultElevation), null, 2, null);
    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        CardElevation$animateElevation$2$1 value$iv;
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1421890746, $changed, -1, "androidx.compose.material3.CardElevation.animateElevation (Card.kt:666)");
        }
        ...
        if (invalid$iv || it$iv2 == Composer.INSTANCE.getEmpty()) {
            Object value$iv3 = (Function2) new CardElevation$animateElevation$1$1(interactionSource, interactions, null);
        ...
        if (invalid$iv2 || it$iv4 == Composer.INSTANCE.getEmpty()) {
            ...
            value$iv = new CardElevation$animateElevation$2$1(animatable, target, enabled, this, interaction, null);
            $composer.updateRememberedValue(value$iv);
        } else {
            animatable = animatable2;
            value$iv = it$iv4;
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof CardElevation) && Dp.m8155equalsimpl0(this.defaultElevation, ((CardElevation) other).defaultElevation) && Dp.m8155equalsimpl0(this.pressedElevation, ((CardElevation) other).pressedElevation) && Dp.m8155equalsimpl0(this.focusedElevation, ((CardElevation) other).focusedElevation) && Dp.m8155equalsimpl0(this.hoveredElevation, ((CardElevation) other).hoveredElevation) && Dp.m8155equalsimpl0(this.disabledElevation, ((CardElevation) other).disabledElevation)) {
            return true;
        }
        return false;
    }
