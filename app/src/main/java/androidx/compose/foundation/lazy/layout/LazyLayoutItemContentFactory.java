...
public final class LazyLayoutItemContentFactory {
    ...
    /* JADX INFO: compiled from: LazyLayoutItemContentFactory.kt */
    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u000b\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0082\u0004\u0018\u00002\u00020\u0001B!\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0001\u0012\b\u0010\u0005\u001a\u0004\u0018\u00010\u0001¢\u0006\u0004\b\u0006\u0010\u0007J\u0018\u0010\u0016\u001a\r\u0012\u0004\u0012\u00020\u00100\u000f¢\u0006\u0002\b\u0011H\u0002¢\u0006\u0002\u0010\u0015R\u0011\u0010\u0004\u001a\u00020\u0001¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\tR\u0013\u0010\u0005\u001a\u0004\u0018\u00010\u0001¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\tR\u001e\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u000b\u001a\u00020\u0003@BX\u0086\u000e¢\u0006\b\n\u0000\u001a\u0004\b\f\u0010\rR\u001d\u0010\u000e\u001a\u000f\u0012\u0004\u0012\u00020\u0010\u0018\u00010\u000f¢\u0006\u0002\b\u0011X\u0082\u000e¢\u0006\u0004\n\u0002\u0010\u0012R\u001c\u0010\u0013\u001a\r\u0012\u0004\u0012\u00020\u00100\u000f¢\u0006\u0002\b\u00118F¢\u0006\u0006\u001a\u0004\b\u0014\u0010\u0015¨\u0006\u0017"}, d2 = {"Landroidx/compose/foundation/lazy/layout/LazyLayoutItemContentFactory$CachedItemContent;", "", "index", "", "key", "contentType", "<init>", "(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemContentFactory;ILjava/lang/Object;Ljava/lang/Object;)V", "getKey", "()Ljava/lang/Object;", "getContentType", "value", "getIndex", "()I", "_content", "Lkotlin/Function0;", "", "Landroidx/compose/runtime/Composable;", "Lkotlin/jvm/functions/Function2;", "content", "getContent", "()Lkotlin/jvm/functions/Function2;", "createContentLambda", "foundation"}, k = 1, mv = {2, 1, 0}, xi = 48)
    final class CachedItemContent {
        ...
        static final Unit createContentLambda$lambda$0(LazyLayoutItemContentFactory this$0, final CachedItemContent this$1, Composer $composer, int $changed) {
            int index;
            Composer $composer2;
            ...
            if (!$composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
                ...
                LazyLayoutItemProvider itemProvider = this$0.getItemProvider().invoke();
                int index2 = this$1.index;
                if (index2 >= itemProvider.getItemCount() || !Intrinsics.areEqual(itemProvider.getKey(index2), this$1.key)) {
                    int index3 = itemProvider.getIndex(this$1.key);
                    if (index3 != -1) {
                        this$1.index = index3;
                    }
                    index = index3;
                ...
                if (index != -1) {
                    ...
                    $composer2 = $composer;
                    LazyLayoutItemContentFactoryKt.m1242SkippableItemJVlU9Rs(itemProvider, StableValue.m1270constructorimpl(this$0.saveableStateHolder), index, StableValue.m1270constructorimpl(this$1.key), $composer2, 0);
                ...
                Object obj = this$1.key;
                ComposerKt.sourceInformationMarkerStart($composer2, 361949752, "CC(remember):LazyLayoutItemContentFactory.kt#9igjgp");
                boolean invalid$iv = $composer2.changedInstance(this$1);
                Composer $this$cache$iv = $composer2;
                Object it$iv = $this$cache$iv.rememberedValue();
                if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                    Object value$iv = new Function1() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutItemContentFactory$CachedItemContent$$ExternalSyntheticLambda1
                ...
                EffectsKt.DisposableEffect(obj, (Function1<? super DisposableEffectScope, ? extends DisposableEffectResult>) it$iv, $composer2, 0);
                if (ComposerKt.isTraceInProgress()) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final DisposableEffectResult createContentLambda$lambda$0$0$0(final CachedItemContent this$0, DisposableEffectScope $this$DisposableEffect) {
