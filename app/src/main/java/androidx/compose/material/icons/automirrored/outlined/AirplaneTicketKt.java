...
public final class AirplaneTicketKt {
    ...
    public static final ImageVector getAirplaneTicket(Icons.AutoMirrored.Outlined $this$AirplaneTicket) {
        ...
        ImageVector.Builder $this$_get_AirplaneTicket__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Outlined.AirplaneTicket", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
