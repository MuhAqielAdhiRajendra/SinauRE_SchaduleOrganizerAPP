...
public final /* data */ class Rect {
    ...
    public static /* synthetic */ void m5093getSizeNHjbRc$annotations() {
    }
    ...
    /* JADX INFO: compiled from: Rect.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u001c\u0010\u0004\u001a\u00020\u00058\u0006X\u0087\u0004¢\u0006\u000e\n\u0000\u0012\u0004\b\u0006\u0010\u0003\u001a\u0004\b\u0007\u0010\b¨\u0006\t"}, d2 = {"Landroidx/compose/ui/geometry/Rect$Companion;", "", "<init>", "()V", "Zero", "Landroidx/compose/ui/geometry/Rect;", "getZero$annotations", "getZero", "()Landroidx/compose/ui/geometry/Rect;", "ui-geometry"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    public final long m5101getSizeNHjbRc() {
    ...
    public final Rect m5105translatek4lQ0M(long offset) {
        ...
        return new Rect(this.left + Float.intBitsToFloat(bits$iv$iv$iv), this.top + Float.intBitsToFloat(bits$iv$iv$iv2), this.right + Float.intBitsToFloat(bits$iv$iv$iv3), this.bottom + Float.intBitsToFloat(bits$iv$iv$iv4));
    }
    ...
    public final long m5103getTopLeftF1C5BW0() {
    ...
    public final long m5102getTopCenterF1C5BW0() {
    ...
    public final long m5104getTopRightF1C5BW0() {
    ...
    public final long m5099getCenterLeftF1C5BW0() {
        float x$iv = this.left;
    ...
    public final long m5098getCenterF1C5BW0() {
        float x$iv = this.left + ((getRight() - getLeft()) / 2.0f);
        float y$iv = this.top + ((getBottom() - getTop()) / 2.0f);
        long v1$iv$iv = Float.floatToRawIntBits(x$iv);
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
    ...
    public final long m5100getCenterRightF1C5BW0() {
        float x$iv = this.right;
        float y$iv = this.top + ((getBottom() - getTop()) / 2.0f);
        long v1$iv$iv = Float.floatToRawIntBits(x$iv);
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
    ...
    public final long m5096getBottomLeftF1C5BW0() {
        float x$iv = this.left;
    ...
    public final long m5095getBottomCenterF1C5BW0() {
        float x$iv = this.left + ((getRight() - getLeft()) / 2.0f);
        float y$iv = this.bottom;
        long v1$iv$iv = Float.floatToRawIntBits(x$iv);
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
    ...
    public final long m5097getBottomRightF1C5BW0() {
        float x$iv = this.right;
        float y$iv = this.bottom;
        long v1$iv$iv = Float.floatToRawIntBits(x$iv);
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
    ...
    public final boolean m5094containsk4lQ0M(long offset) {
        int bits$iv$iv$iv = (int) (offset >> 32);
