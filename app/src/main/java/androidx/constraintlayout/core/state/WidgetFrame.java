...
public class WidgetFrame {
    ...
    public void setCustomAttribute(String name, int type, float value) {
        boolean zContainsKey = this.mCustom.containsKey(name);
        HashMap<String, CustomVariable> map = this.mCustom;
        if (zContainsKey) {
            map.get(name).setFloatValue(value);
        } else {
            map.put(name, new CustomVariable(name, type, value));
        }
    }
    ...
    public void setCustomAttribute(String name, int type, int value) {
        ...
        HashMap<String, CustomVariable> map = this.mCustom;
        if (zContainsKey) {
            map.get(name).setIntValue(value);
        } else {
            map.put(name, new CustomVariable(name, type, value));
        }
    }
    ...
    public void setCustomAttribute(String name, int type, boolean value) {
        ...
        HashMap<String, CustomVariable> map = this.mCustom;
        if (zContainsKey) {
            map.get(name).setBooleanValue(value);
        } else {
            map.put(name, new CustomVariable(name, type, value));
        }
    }
    ...
    public void setCustomAttribute(String name, int type, String value) {
        ...
        HashMap<String, CustomVariable> map = this.mCustom;
        if (zContainsKey) {
            map.get(name).setStringValue(value);
        } else {
            map.put(name, new CustomVariable(name, type, value));
        }
    }
