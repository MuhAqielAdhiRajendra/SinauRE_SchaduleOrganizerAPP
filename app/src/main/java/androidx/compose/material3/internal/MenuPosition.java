...
public final class MenuPosition {
    ...
    public interface Horizontal {
        ...
        int mo3427position95KtPRI(IntRect anchorBounds, long windowSize, int menuWidth, LayoutDirection layoutDirection);
    }
    ...
    public interface Vertical {
        ...
        int mo3428positionJVtK1S4(IntRect anchorBounds, long windowSize, int menuHeight);
    }
