...
@Metadata(d1 = {"\u0000L\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u0011\n\u0002\u0010\u0015\n\u0000\n\u0002\u0010 \n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0010!\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\bÇ\u0002\u0018\u00002\u00020\u0001:\u0003\u001d\u001e\u001fB\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J5\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u00052\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\t0\b2\u0012\u0010\n\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\t0\u00050\u0005H\u0007¢\u0006\u0002\u0010\u000bJ5\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u00052\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\t0\u00052\u0012\u0010\n\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\t0\u00050\u0005H\u0007¢\u0006\u0002\u0010\fJO\u0010\r\u001a\u00020\u000e2\f\u0010\u000f\u001a\b\u0012\u0004\u0012\u00020\u00100\b2\f\u0010\u0011\u001a\b\u0012\u0004\u0012\u00020\t0\u00052$\u0010\u0012\u001a \u0012\u0004\u0012\u00020\u0014\u0012\u0004\u0012\u00020\u0014\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00100\b\u0012\u0004\u0012\u00020\u000e0\u0013H\u0002¢\u0006\u0002\u0010\u0015JV\u0010\u0016\u001a\u00020\u000e\"\u0004\b\u0000\u0010\u00172\u0012\u0010\u000f\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00170\b0\b2\u000e\b\u0002\u0010\u0018\u001a\b\u0012\u0004\u0012\u0002H\u00170\u00192\b\b\u0002\u0010\u001a\u001a\u00020\u00142\u0018\u0010\u001b\u001a\u0014\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00170\b\u0012\u0004\u0012\u00020\u000e0\u001cH\u0002¨\u0006 "}, d2 = {"Landroidx/room/AmbiguousColumnResolver;", "", "<init>", "()V", "resolve", "", "", "resultColumns", "", "", "mappings", "(Ljava/util/List;[[Ljava/lang/String;)[[I", "([Ljava/lang/String;[[Ljava/lang/String;)[[I", "rabinKarpSearch", "", "content", "Landroidx/room/AmbiguousColumnResolver$ResultColumn;", "pattern", "onHashMatch", "Lkotlin/Function3;", "", "(Ljava/util/List;[Ljava/lang/String;Lkotlin/jvm/functions/Function3;)V", "dfs", "T", "current", "", "depth", "block", "Lkotlin/Function1;", "ResultColumn", "Match", "Solution", "room-common"}, k = 1, mv = {2, 1, 0}, xi = 48)
public final class AmbiguousColumnResolver {
    ...
    public static final int[][] resolve(String[] resultColumns, String[][] mappings) {
        ...
        List<ResultColumn> list;
        List<ResultColumn> list2;
        ...
        while (i3 < length4) {
            ...
            if (requestedColumns2.contains(str)) {
                $this$resolve_u24lambda_u243.add(new ResultColumn(str, index$iv));
            }
            i3++;
            index$iv = index$iv2;
        }
        List<ResultColumn> $this$forEach$iv2 = CollectionsKt.build($this$resolve_u24lambda_u243);
        ...
        while (i5 < length6) {
            ...
            INSTANCE.rabinKarpSearch($this$forEach$iv2, mapping, new Function3() { // from class: androidx.room.AmbiguousColumnResolver$$ExternalSyntheticLambda0
            ...
            if (((List) mappingMatches.get(index$iv3)).isEmpty()) {
                ...
                while (i6 < length7) {
                    ...
                    List $this$resolve_u24lambda_u2416_u24lambda_u2412_u24lambda_u249 = listCreateListBuilder;
                    for (Object element$iv2 : $this$forEach$iv2) {
                        ...
                        if (Intrinsics.areEqual(mappingColumnName2, resultColumn.getName())) {
                            list2 = $this$forEach$iv2;
                            usefulResultColumns = $this$resolve_u24lambda_u2416_u24lambda_u2412_u24lambda_u249;
                            usefulResultColumns.add(Integer.valueOf(resultColumn.getIndex()));
                        } else {
                            list2 = $this$forEach$iv2;
                            usefulResultColumns = $this$resolve_u24lambda_u2416_u24lambda_u2412_u24lambda_u249;
                        }
                    ...
                    List<ResultColumn> list3 = $this$forEach$iv2;
        ...
        dfs$default(INSTANCE, mappingMatches, null, 0, new Function1() { // from class: androidx.room.AmbiguousColumnResolver$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return AmbiguousColumnResolver.resolve$lambda$19(bestSolution, (List) obj);
            }
        }, 6, null);
    ...
    static final Unit resolve$lambda$16$lambda$7(String[] $mapping, List $mappingMatches, int $mappingIndex, int startIndex, int endIndex, List resultColumnsSublist) {
        Object element$iv;
    ...
    static final Unit resolve$lambda$16$lambda$15(List $mappingMatches, int $mappingIndex, List indices) {
    ...
    static final Unit resolve$lambda$19(Ref.ObjectRef $bestSolution, List it) {
