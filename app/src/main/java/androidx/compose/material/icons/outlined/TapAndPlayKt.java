...
public final class TapAndPlayKt {
    ...
    public static final ImageVector getTapAndPlay(Icons.Outlined $this$TapAndPlay) {
        if (_tapAndPlay != null) {
        ...
        ImageVector.Builder $this$_get_TapAndPlay__u24lambda_u241 = new ImageVector.Builder("Outlined.TapAndPlay", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
