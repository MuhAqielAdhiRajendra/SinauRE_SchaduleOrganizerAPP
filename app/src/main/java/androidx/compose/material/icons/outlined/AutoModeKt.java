...
public final class AutoModeKt {
    ...
    public static final ImageVector getAutoMode(Icons.Outlined $this$AutoMode) {
        if (_autoMode != null) {
        ...
        ImageVector.Builder $this$_get_AutoMode__u24lambda_u246 = new ImageVector.Builder("Outlined.AutoMode", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
