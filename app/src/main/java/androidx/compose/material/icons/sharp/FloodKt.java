...
public final class FloodKt {
    ...
    public static final ImageVector getFlood(Icons.Sharp $this$Flood) {
        if (_flood != null) {
        ...
        ImageVector.Builder $this$_get_Flood__u24lambda_u242 = new ImageVector.Builder("Sharp.Flood", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
