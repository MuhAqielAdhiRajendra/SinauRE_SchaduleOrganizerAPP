...
public final class RenderNodeLayer implements OwnedLayer, GraphicLayerInfo {
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope) {
        ...
        if ((maybeChangedFields & 64) != 0) {
            this.renderNode.setAmbientShadowColor(ColorKt.m5367toArgb8_81llA(scope.getAmbientShadowColor()));
        }
        if ((maybeChangedFields & 128) != 0) {
            this.renderNode.setSpotShadowColor(ColorKt.m5367toArgb8_81llA(scope.getSpotShadowColor()));
        }
        ...
        if ((maybeChangedFields & 4096) != 0) {
            this.renderNode.setPivotX(TransformOrigin.m5721getPivotFractionXimpl(this.transformOrigin) * this.renderNode.getWidth());
            this.renderNode.setPivotY(TransformOrigin.m5722getPivotFractionYimpl(this.transformOrigin) * this.renderNode.getHeight());
        }
        ...
        if ((524288 & maybeChangedFields) != 0) {
            this.renderNode.mo7263setBlendModes9anfk8(scope.getBlendMode());
        }
        if ((32768 & maybeChangedFields) != 0) {
            this.renderNode.mo7264setCompositingStrategyaDBOjCE(scope.getCompositingStrategy());
        }
    ...
    public void mo7162resizeozmzZPI(long size) {
        ...
        this.renderNode.setPivotX(TransformOrigin.m5721getPivotFractionXimpl(this.transformOrigin) * width);
        this.renderNode.setPivotY(TransformOrigin.m5722getPivotFractionYimpl(this.transformOrigin) * height);
    ...
    public void mo7161movegyyYBs(long position) {
        ...
        int newLeft = IntOffset.m8278getXimpl(position);
        int newTop = IntOffset.m8279getYimpl(position);
    ...
    public void drawLayer(Canvas canvas, GraphicsLayer parentLayer) {
        ...
        if (this.renderNode.getAlpha() < 1.0f) {
            ...
            androidCanvas.saveLayer(left, top, right, bottom, AndroidPaint_androidKt.getNativePaint(it2));
        } else {
            canvas.save();
        }
        canvas.translate(left, top);
        canvas.mo5164concat58bKbWc(this.matrixCache.m7286calculateMatrixGrdbGEg(this.renderNode));
    ...
    public float[] mo7157getUnderlyingMatrixsQKQjiQ() {
        return this.matrixCache.m7286calculateMatrixGrdbGEg(this.renderNode);
    }
    ...
    public long mo7160mapOffset8S9VItk(long point, boolean inverse) {
        ...
        if (inverse) {
            return layerMatrixCache.m7288mapInverseR5De75A(this.renderNode, point);
        }
        return layerMatrixCache.m7287mapR5De75A(this.renderNode, point);
    }
    ...
    public void mo7163transform58bKbWc(float[] matrix) {
        androidx.compose.ui.graphics.Matrix.m5576timesAssign58bKbWc(matrix, this.matrixCache.m7286calculateMatrixGrdbGEg(this.renderNode));
    }

    @Override // androidx.compose.ui.node.OwnedLayer
    /* JADX INFO: renamed from: inverseTransform-58bKbWc */
    public void mo7158inverseTransform58bKbWc(float[] matrix) {
        float[] inverse = this.matrixCache.m7285calculateInverseMatrixbWbORWo(this.renderNode);
        if (inverse != null) {
