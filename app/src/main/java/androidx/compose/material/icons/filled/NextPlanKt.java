...
public final class NextPlanKt {
    ...
    public static final ImageVector getNextPlan(Icons.Filled $this$NextPlan) {
        if (_nextPlan != null) {
        ...
        ImageVector.Builder $this$_get_NextPlan__u24lambda_u241 = new ImageVector.Builder("Filled.NextPlan", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
