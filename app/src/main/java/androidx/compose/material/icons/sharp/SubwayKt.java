...
public final class SubwayKt {
    ...
    public static final ImageVector getSubway(Icons.Sharp $this$Subway) {
        if (_subway != null) {
        ...
        ImageVector.Builder $this$_get_Subway__u24lambda_u243 = new ImageVector.Builder("Sharp.Subway", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
