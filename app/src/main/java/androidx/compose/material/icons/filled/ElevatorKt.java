...
public final class ElevatorKt {
    ...
    public static final ImageVector getElevator(Icons.Filled $this$Elevator) {
        if (_elevator != null) {
        ...
        ImageVector.Builder $this$_get_Elevator__u24lambda_u241 = new ImageVector.Builder("Filled.Elevator", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
