...
public final class FolderDeleteKt {
    ...
    public static final ImageVector getFolderDelete(Icons.Outlined $this$FolderDelete) {
        ...
        ImageVector.Builder $this$_get_FolderDelete__u24lambda_u241 = new ImageVector.Builder("Outlined.FolderDelete", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(22.0f, 6.89f, 21.11f, 6.0f, 20.0f, 6.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
