...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u001e\u0010\u0002\u001a\u00020\u0001*\u00020\u00038FX\u0087\u0004¢\u0006\f\u0012\u0004\b\u0004\u0010\u0005\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, d2 = {"_nextPlan", "Landroidx/compose/ui/graphics/vector/ImageVector;", "NextPlan", "Landroidx/compose/material/icons/Icons$Sharp;", "getNextPlan$annotations", "(Landroidx/compose/material/icons/Icons$Sharp;)V", "getNextPlan", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class NextPlanKt {
    private static ImageVector _nextPlan;

    @Deprecated(message = "Use the AutoMirrored version at Icons.AutoMirrored.Sharp.NextPlan", replaceWith = @ReplaceWith(expression = "Icons.AutoMirrored.Sharp.NextPlan", imports = {"androidx.compose.material.icons.automirrored.sharp.NextPlan"}))
    public static /* synthetic */ void getNextPlan$annotations(Icons.Sharp sharp) {
    }

    public static final ImageVector getNextPlan(Icons.Sharp $this$NextPlan) {
        if (_nextPlan != null) {
        ...
        ImageVector.Builder $this$_get_NextPlan__u24lambda_u241 = new ImageVector.Builder("Sharp.NextPlan", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _nextPlan = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_NextPlan__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
