...
final class DefaultModalWideNavigationRailOverride$ModalWideNavigationRail$5$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    DefaultModalWideNavigationRailOverride$ModalWideNavigationRail$5$1$1(Animatable<Float, AnimationVector1D> animatable, float f, Continuation<? super DefaultModalWideNavigationRailOverride$ModalWideNavigationRail$5$1$1> continuation) {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((DefaultModalWideNavigationRailOverride$ModalWideNavigationRail$5$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
