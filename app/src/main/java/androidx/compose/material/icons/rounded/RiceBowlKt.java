...
public final class RiceBowlKt {
    ...
    public static final ImageVector getRiceBowl(Icons.Rounded $this$RiceBowl) {
        if (_riceBowl != null) {
        ...
        ImageVector.Builder $this$_get_RiceBowl__u24lambda_u241 = new ImageVector.Builder("Rounded.RiceBowl", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -5.48f, -4.4f, -9.93f, -9.86f, -10.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(8.52f, 1.95f, 5.29f, 4.03f, 3.43f, 7.14f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(0.1f, 12.69f, 2.98f, 18.27f, 8.0f, 20.25f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(0.25f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(8.0f, 21.33f, 8.67f, 22.0f, 9.5f, 22.0f);
