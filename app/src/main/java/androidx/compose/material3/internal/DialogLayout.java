...
final class DialogLayout extends AbstractComposeView implements DialogWindowProvider {
    ...
    static final Unit Content$lambda$0(DialogLayout dialogLayout, int i, Composer composer, int i2) {
    ...
    public DialogLayout(Context context, Window window) {
        ...
        this.window = window;
        this.content = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$BasicEdgeToEdgeDialog_androidKt.INSTANCE.getLambda$453789431$material3(), null, 2, null);
    }
    ...
    public void Content(Composer $composer, final int $changed) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material3.internal.DialogLayout$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return DialogLayout.Content$lambda$0(this.f$0, $changed, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
