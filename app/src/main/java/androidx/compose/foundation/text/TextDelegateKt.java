...
public final class TextDelegateKt {
    ...
    public static /* synthetic */ TextDelegate m1638updateTextDelegaterm0N8CA$default(TextDelegate textDelegate, AnnotatedString annotatedString, TextStyle textStyle, Density density, FontFamily.Resolver resolver, boolean z, int i, int i2, int i3, List list, int i4, Object obj) {
        if ((i4 & 32) != 0) {
            z = true;
        }
        if ((i4 & 64) != 0) {
            i = TextOverflow.INSTANCE.m8060getClipgIe3tQ8();
        }
        if ((i4 & 128) != 0) {
        ...
        return m1637updateTextDelegaterm0N8CA(textDelegate, annotatedString, textStyle, density, resolver, z, i, i2, i3, list);
    }

    /* JADX INFO: renamed from: updateTextDelegate-rm0N8CA, reason: not valid java name */
    public static final TextDelegate m1637updateTextDelegaterm0N8CA(TextDelegate current, AnnotatedString text, TextStyle style, Density density, FontFamily.Resolver fontFamilyResolver, boolean softWrap, int overflow, int maxLines, int minLines, List<AnnotatedString.Range<Placeholder>> list) {
        ...
        if (!Intrinsics.areEqual(current.getText(), text) || !Intrinsics.areEqual(current.getStyle(), style)) {
            ...
            if (current.getSoftWrap() != z) {
                ...
                i = overflow;
                if (!TextOverflow.m8051equalsimpl0(current.getOverflow(), i)) {
                    resolver = fontFamilyResolver;
                    i2 = maxLines;
                    i3 = minLines;
                    list2 = list;
                    ...
                    if (current.getMaxLines() != i2) {
                        ...
                        i3 = minLines;
                        if (current.getMinLines() != i3 || !Intrinsics.areEqual(current.getDensity(), density)) {
                            resolver = fontFamilyResolver;
                            list2 = list;
                        } else {
                            list2 = list;
