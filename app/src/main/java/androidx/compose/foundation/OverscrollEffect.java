...
public interface OverscrollEffect {
    ...
    Object mo263applyToFlingBMRW4eQ(long j, Function2<? super Velocity, ? super Continuation<? super Velocity>, ? extends Object> function2, Continuation<? super Unit> continuation);

    /* JADX INFO: renamed from: applyToScroll-Rhakbz0 */
    long mo264applyToScrollRhakbz0(long delta, int source, Function1<? super Offset, Offset> performScroll);
