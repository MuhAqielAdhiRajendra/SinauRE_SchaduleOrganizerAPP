...
public abstract class Transition implements Cloneable {
    ...
    private void matchInstances(ArrayMap<View, TransitionValues> unmatchedStart, ArrayMap<View, TransitionValues> unmatchedEnd) {
        ...
        for (int i = unmatchedStart.getSize() - 1; i >= 0; i--) {
    ...
    private void matchNames(ArrayMap<View, TransitionValues> unmatchedStart, ArrayMap<View, TransitionValues> unmatchedEnd, ArrayMap<String, View> startNames, ArrayMap<String, View> endNames) {
        View endView;
        int numStartNames = startNames.getSize();
    ...
    private void addUnmatched(ArrayMap<View, TransitionValues> unmatchedStart, ArrayMap<View, TransitionValues> unmatchedEnd) {
        for (int i = 0; i < unmatchedStart.getSize(); i++) {
        ...
        for (int i2 = 0; i2 < unmatchedEnd.getSize(); i2++) {
    ...
    void createAnimators(ViewGroup viewGroup, TransitionValuesMaps transitionValuesMaps, TransitionValuesMaps transitionValuesMaps2, ArrayList<TransitionValues> arrayList, ArrayList<TransitionValues> arrayList2) {
        ...
        while (i3 < size) {
            ...
            TransitionValues transitionValues2 = arrayList2.get(i3);
            ...
            if (transitionValues == null && transitionValues2 == null) {
                i = size;
                z = z2;
            } else if (transitionValues == null || transitionValues2 == null || isTransitionRequired(transitionValues, transitionValues2)) {
                Animator animatorCreateAnimator = createAnimator(viewGroup, transitionValues, transitionValues2);
                if (animatorCreateAnimator != null) {
                        ...
                        if (transitionProperties != null && transitionProperties.length > 0) {
                            ...
                            if (transitionValues5 != null) {
                                ...
                                while (true) {
                                    ...
                                    transitionValues4.values.put(transitionProperties[i5], transitionValues5.values.get(strArr[i5]));
                                    i4 = i5 + 1;
                                    z2 = z;
                            ...
                            while (true) {
                                ...
                                if (animationInfo.mValues == null || animationInfo.mView != view) {
                                    ...
                                    i2 = i6;
                                    if (animationInfo.mName.equals(getName()) && animationInfo.mValues.equals(transitionValues4)) {
                                        animator = null;
                                        transitionValues3 = transitionValues4;
                                        break;
                                    }
                    ...
                    if (animator != null) {
                        if (this.mPropagation != null) {
                            ...
                            jMin = Math.min(startDelay, j);
                        } else {
                            jMin = j;
                        }
                        AnimationInfo animationInfo2 = new AnimationInfo(view, getName(), this, viewGroup.getWindowId(), transitionValues3, animator);
        ...
        if (sparseIntArray.size() != 0) {
            for (int i8 = 0; i8 < sparseIntArray.size(); i8++) {
                ...
                animationInfo3.mAnimator.setStartDelay((((long) sparseIntArray.valueAt(i8)) - j) + animationInfo3.mAnimator.getStartDelay());
            }
        }
    }
    ...
    void captureValues(ViewGroup sceneRoot, boolean start) {
        ...
        if (!start && this.mNameOverrides != null) {
            int numOverrides = this.mNameOverrides.getSize();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x0035, code lost:
        ...
        r4 = r7.mEndValuesList;
     */
    /* JADX WARN: Code restructure failed: missing block: B:25:0x0038, code lost:
    
        r4 = r7.mStartValuesList;
     */
    ...
    */
    androidx.transition.TransitionValues getMatchedTransitionValues(android.view.View r8, boolean r9) {
        /*
            r7 = this;
            androidx.transition.TransitionSet r0 = r7.mParent
            if (r0 == 0) goto Lb
            androidx.transition.TransitionSet r0 = r7.mParent
            androidx.transition.TransitionValues r0 = r0.getMatchedTransitionValues(r8, r9)
            return r0
        Lb:
            if (r9 == 0) goto L10
            java.util.ArrayList<androidx.transition.TransitionValues> r0 = r7.mStartValuesList
            goto L12
        L10:
            java.util.ArrayList<androidx.transition.TransitionValues> r0 = r7.mEndValuesList
        L12:
            r1 = 0
            if (r0 != 0) goto L16
            return r1
    ...
    void playTransition(ViewGroup sceneRoot) {
        ...
        ArrayMap<Animator, AnimationInfo> runningAnimators = getRunningAnimators();
        int numOldAnims = runningAnimators.getSize();
        ...
        for (int i2 = 0; i2 < endedTransitions.size(); i2++) {
            Transition transition2 = endedTransitions.get(i2);
    ...
    void setCurrentPlayTimeMillis(long playTimeMillis, long lastPlayTimeMillis) {
        ...
        this.mAnimatorCache = cache;
        if ((playTimeMillis > duration3 && lastPlayTimeMillis <= duration3) || (playTimeMillis < 0 && lastPlayTimeMillis >= 0)) {
            if (playTimeMillis > duration3) {
                this.mEnded = true;
            }
    ...
    class SeekController extends TransitionListenerAdapter implements TransitionSeekController, DynamicAnimation.OnAnimationUpdateListener {
        ...
        public void setCurrentFraction(float fraction) {
            ...
            setCurrentPlayTimeMillis((long) (getDurationMillis() * fraction));
        }
        ...
        private void ensureAnimation() {
            ...
            this.mSpringAnimation.addEndListener(new DynamicAnimation.OnAnimationEndListener() { // from class: androidx.transition.Transition$SeekController$$ExternalSyntheticLambda0
                ...
                public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
                    this.f$0.m8650x76b2d240(dynamicAnimation, z, f, f2);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$ensureAnimation$0$androidx-transition-Transition$SeekController, reason: not valid java name */
        /* synthetic */ void m8650x76b2d240(DynamicAnimation anim, boolean canceled, float value, float velocity) {
            if (!canceled) {
