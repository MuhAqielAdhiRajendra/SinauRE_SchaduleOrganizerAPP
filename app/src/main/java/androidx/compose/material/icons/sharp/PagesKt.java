...
public final class PagesKt {
    ...
    public static final ImageVector getPages(Icons.Sharp $this$Pages) {
        if (_pages != null) {
        ...
        ImageVector.Builder $this$_get_Pages__u24lambda_u241 = new ImageVector.Builder("Sharp.Pages", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
