...
public final class TaskKt {
    ...
    public static final ImageVector getTask(Icons.Rounded $this$Task) {
        if (_task != null) {
        ...
        ImageVector.Builder $this$_get_Task__u24lambda_u241 = new ImageVector.Builder("Rounded.Task", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(10.23f, 17.29f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(11.26f, 17.68f, 10.62f, 17.68f, 10.23f, 17.29f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
