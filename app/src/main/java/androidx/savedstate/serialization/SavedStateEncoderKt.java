...
public final class SavedStateEncoderKt {
    ...
    public static /* synthetic */ Bundle encodeToSavedStateNullable$default(Object value, SavedStateConfiguration configuration, int i, Object obj) {
        if ((i & 2) != 0) {
            configuration = SavedStateConfiguration.DEFAULT;
        }
        Intrinsics.checkNotNullParameter(configuration, "configuration");
    ...
    public static final /* synthetic */ Bundle encodeToSavedState(SerializationStrategy serializer, Object value, SavedStateConfiguration configuration) {
        ...
        new SavedStateEncoder(result, configuration).encodeSerializableValue(serializer, value);
        return result;
    }
    ...
    public static final <T> Bundle encodeToSavedStateNullable(SerializationStrategy<? super T> serializer, T t, SavedStateConfiguration configuration) {
        ...
        Bundle result = BundleKt.bundleOf((Pair[]) Arrays.copyOf(pairs$iv, pairs$iv.length));
        SavedStateWriter.m8608constructorimpl(result);
        new SavedStateEncoder(result, configuration).encodeSerializableValue(serializer, t);
        return result;
    }
}
