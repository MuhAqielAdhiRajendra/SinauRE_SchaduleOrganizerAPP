...
public class ShapeAppearancePathProvider {
    ...
    public void calculatePath(ShapeAppearanceModel shapeAppearanceModel, float interpolation, RectF bounds, PathListener pathListener, Path path) {
        calculatePath(shapeAppearanceModel, null, interpolation, bounds, pathListener, path);
    }
    ...
    private void setCornerPathAndTransform(ShapeAppearancePathSpec spec, int index, float[] cornerSizes) {
        ...
        if (cornerSizes == null) {
            clampedCornerSize = getCornerSizeForIndex(index, spec.shapeAppearanceModel);
        } else {
            clampedCornerSize = new ClampedCornerSize(cornerSizes[index]);
        }
    ...
    CornerSize getCornerSizeForIndex(int index, ShapeAppearanceModel shapeAppearanceModel) {
        switch (index) {
            case 1:
