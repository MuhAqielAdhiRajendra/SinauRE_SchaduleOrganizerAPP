...
public final class OutboundKt {
    ...
    @Deprecated(message = "Use the AutoMirrored version at Icons.AutoMirrored.Rounded.Outbound", replaceWith = @ReplaceWith(expression = "Icons.AutoMirrored.Rounded.Outbound", imports = {"androidx.compose.material.icons.automirrored.rounded.Outbound"}))
    public static /* synthetic */ void getOutbound$annotations(Icons.Rounded rounded) {
    }

    public static final ImageVector getOutbound(Icons.Rounded $this$Outbound) {
        if (_outbound != null) {
        ...
        ImageVector.Builder $this$_get_Outbound__u24lambda_u241 = new ImageVector.Builder("Rounded.Outbound", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
