...
public final class QueueMusicKt {
    ...
    public static final ImageVector getQueueMusic(Icons.TwoTone $this$QueueMusic) {
        if (_queueMusic != null) {
        ...
        ImageVector.Builder $this$_get_QueueMusic__u24lambda_u242 = new ImageVector.Builder("TwoTone.QueueMusic", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
