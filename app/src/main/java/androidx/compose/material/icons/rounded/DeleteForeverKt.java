...
public final class DeleteForeverKt {
    ...
    public static final ImageVector getDeleteForever(Icons.Rounded $this$DeleteForever) {
        ...
        ImageVector.Builder $this$_get_DeleteForever__u24lambda_u241 = new ImageVector.Builder("Rounded.DeleteForever", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(9.17f, 12.59f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(9.17f, 12.59f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(14.61f, 3.11f, 14.35f, 3.0f, 14.09f, 3.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(18.55f, 4.0f, 18.0f, 4.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
