...
public final class LazyLayoutBeyondBoundsProviderModifierNode extends Modifier.Node implements LayoutModifierNode, BeyondBoundsLayoutProviderModifierNode, BeyondBoundsLayout {
    ...
    public <T> T mo1224layouto7g1Pn8(final int direction, Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> block) {
        ...
        boolean zM1222isForward4vf7U8o = m1222isForward4vf7U8o(direction);
        LazyLayoutBeyondBoundsState lazyLayoutBeyondBoundsState = this.state;
        if (zM1222isForward4vf7U8o) {
        ...
        int i = 0;
        while (tInvoke == null && m1221hasMoreContentFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction) && i < iCoerceAtMost) {
            T t = (T) m1220addNextIntervalFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction);
            ...
            tInvoke = block.invoke(new BeyondBoundsLayout.BeyondBoundsScope() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutBeyondBoundsProviderModifierNode$layout$2
                @Override // androidx.compose.ui.layout.BeyondBoundsLayout.BeyondBoundsScope
                public boolean getHasMoreContent() {
                    return this.this$0.m1221hasMoreContentFR3nfPY(objectRef.element, direction);
                }
            });
        }
        this.beyondBoundsInfo.removeInterval((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element);
    ...
    private final boolean m1222isForward4vf7U8o(int $this$isForward_u2d4vf7U8o) {
        if (BeyondBoundsLayout.LayoutDirection.m6766equalsimpl0($this$isForward_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.INSTANCE.m6772getBeforehoxUOeE())) {
            return false;
        }
        if (BeyondBoundsLayout.LayoutDirection.m6766equalsimpl0($this$isForward_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.INSTANCE.m6771getAfterhoxUOeE())) {
            return true;
        }
        if (BeyondBoundsLayout.LayoutDirection.m6766equalsimpl0($this$isForward_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.INSTANCE.m6770getAbovehoxUOeE())) {
            return this.reverseLayout;
        }
        if (BeyondBoundsLayout.LayoutDirection.m6766equalsimpl0($this$isForward_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.INSTANCE.m6773getBelowhoxUOeE())) {
            return !this.reverseLayout;
        }
        if (BeyondBoundsLayout.LayoutDirection.m6766equalsimpl0($this$isForward_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.INSTANCE.m6774getLefthoxUOeE())) {
        ...
        if (!BeyondBoundsLayout.LayoutDirection.m6766equalsimpl0($this$isForward_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.INSTANCE.m6775getRighthoxUOeE())) {
    ...
    private final LazyLayoutBeyondBoundsInfo.Interval m1220addNextIntervalFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval currentInterval, int direction) {
        int start = currentInterval.getStart();
        int end = currentInterval.getEnd();
        if (m1222isForward4vf7U8o(direction)) {
            end++;
        } else {
            start--;
        }
    ...
    public final boolean m1221hasMoreContentFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval $this$hasMoreContent_u2dFR3nfPY, int direction) {
        if (m1223isOppositeToOrientation4vf7U8o(direction)) {
            return false;
        }
        if (m1222isForward4vf7U8o(direction)) {
    ...
    private final boolean m1223isOppositeToOrientation4vf7U8o(int $this$isOppositeToOrientation_u2d4vf7U8o) {
        if (BeyondBoundsLayout.LayoutDirection.m6766equalsimpl0($this$isOppositeToOrientation_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.INSTANCE.m6770getAbovehoxUOeE()) || BeyondBoundsLayout.LayoutDirection.m6766equalsimpl0($this$isOppositeToOrientation_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.INSTANCE.m6773getBelowhoxUOeE())) {
            return this.orientation == Orientation.Horizontal;
        }
        if (BeyondBoundsLayout.LayoutDirection.m6766equalsimpl0($this$isOppositeToOrientation_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.INSTANCE.m6774getLefthoxUOeE()) || BeyondBoundsLayout.LayoutDirection.m6766equalsimpl0($this$isOppositeToOrientation_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.INSTANCE.m6775getRighthoxUOeE())) {
            return this.orientation == Orientation.Vertical;
        }
        if (BeyondBoundsLayout.LayoutDirection.m6766equalsimpl0($this$isOppositeToOrientation_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.INSTANCE.m6772getBeforehoxUOeE()) || BeyondBoundsLayout.LayoutDirection.m6766equalsimpl0($this$isOppositeToOrientation_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.INSTANCE.m6771getAfterhoxUOeE())) {
            return false;
        }
        LazyLayoutBeyondBoundsModifierLocalKt.unsupportedDirection();
        throw new KotlinNothingValueException();
