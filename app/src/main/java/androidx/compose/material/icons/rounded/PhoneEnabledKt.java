...
public final class PhoneEnabledKt {
    ...
    public static final ImageVector getPhoneEnabled(Icons.Rounded $this$PhoneEnabled) {
        ...
        ImageVector.Builder $this$_get_PhoneEnabled__u24lambda_u241 = new ImageVector.Builder("Rounded.PhoneEnabled", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(4.78f, 15.27f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(3.01f, 16.24f, 3.77f, 15.39f, 4.78f, 15.27f);
