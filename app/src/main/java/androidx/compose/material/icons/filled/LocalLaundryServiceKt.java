...
public final class LocalLaundryServiceKt {
    ...
    public static final ImageVector getLocalLaundryService(Icons.Filled $this$LocalLaundryService) {
        ...
        ImageVector.Builder $this$_get_LocalLaundryService__u24lambda_u241 = new ImageVector.Builder("Filled.LocalLaundryService", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(1.56f, -1.56f, 1.56f, -4.1f, 0.0f, -5.66f);
