...
public final class Oklab extends ColorSpace {
    ...
    public long toXy$ui_graphics(float v0, float v1, float v2) {
        ...
        float minimumValue$iv$iv = -0.5f;
        if (v1 >= -0.5f) {
            minimumValue$iv$iv = v1;
        }
        float maximumValue$iv$iv = 0.5f;
        if (minimumValue$iv$iv <= 0.5f) {
            maximumValue$iv$iv = minimumValue$iv$iv;
        }
        float minimumValue$iv$iv2 = -0.5f;
        if (v2 >= -0.5f) {
            minimumValue$iv$iv2 = v2;
        }
        float maximumValue$iv$iv2 = 0.5f;
        if (minimumValue$iv$iv2 <= 0.5f) {
            maximumValue$iv$iv2 = minimumValue$iv$iv2;
        }
        float[] lhs$iv = InverseM2;
        float r2$iv = maximumValue$iv$iv2;
        float v01 = (lhs$iv[0] * $this$fastCoerceAtLeast$iv$iv) + (lhs$iv[3] * maximumValue$iv$iv) + (lhs$iv[6] * r2$iv);
        float[] lhs$iv2 = InverseM2;
        float r1$iv = maximumValue$iv$iv;
        float r0$iv = $this$fastCoerceAtLeast$iv$iv;
        float v11 = (lhs$iv2[1] * r0$iv) + (lhs$iv2[4] * r1$iv) + (lhs$iv2[7] * r2$iv);
        float[] lhs$iv3 = InverseM2;
        float v21 = (lhs$iv3[2] * r0$iv) + (lhs$iv3[5] * r1$iv) + (lhs$iv3[8] * r2$iv);
