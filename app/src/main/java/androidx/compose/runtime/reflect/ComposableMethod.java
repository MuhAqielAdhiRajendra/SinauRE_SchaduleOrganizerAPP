    ...
    public final Object invoke(Composer composer, Object instance, Object... args) {
        ...
        while (i3 < totalParams) {
            if (i3 >= 0 && i3 < realParamsCount) {
                defaultValue = i3 >= 0 && i3 < args.length ? args[i3] : ComposableMethodKt.getDefaultValue(this.method.getParameterTypes()[i3]);
                ...
                defaultValue = objArr[i3 - defaultStartIndex];
            }
            arguments[i3] = defaultValue;
            i3++;
        }
