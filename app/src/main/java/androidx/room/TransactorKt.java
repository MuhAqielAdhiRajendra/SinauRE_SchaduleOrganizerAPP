...
public final class TransactorKt {
    public static final Object execSQL(PooledConnection $this$execSQL, String sql, Continuation<? super Unit> continuation) {
        Object objUsePrepared = $this$execSQL.usePrepared(sql, new Function1() { // from class: androidx.room.TransactorKt$$ExternalSyntheticLambda0
    ...
    static final boolean execSQL$lambda$0(SQLiteStatement it) {
