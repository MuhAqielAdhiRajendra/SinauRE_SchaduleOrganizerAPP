...
public final class RippleKt {
    ...
    public static final DelegatableNode m2132createRippleModifierNodeTDGSqEk(InteractionSource interactionSource, boolean bounded, float radius, ColorProducer color, Function0<RippleAlpha> function0) {
        return Ripple_androidKt.m2138createPlatformRippleNodeTDGSqEk(interactionSource, bounded, radius, color, function0);
    }
    ...
    public static final Indication m2133rememberRipple9IZ8Weo(boolean bounded, float radius, long color, Composer $composer, int $changed, int i) {
        ...
        if ((i & 2) != 0) {
            radius = Dp.INSTANCE.m8170getUnspecifiedD9Ej5fM();
        }
        if ((i & 4) != 0) {
            color = Color.INSTANCE.m5349getUnspecified0d7_KjU();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1635163520, $changed, -1, "androidx.compose.material.ripple.rememberRipple (Ripple.kt:144)");
        }
        State colorState = SnapshotStateKt.rememberUpdatedState(Color.m5303boximpl(color), $composer, ($changed >> 6) & 14);
