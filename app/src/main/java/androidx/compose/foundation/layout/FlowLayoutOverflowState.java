...
public final /* data */ class FlowLayoutOverflowState {
    ...
    public final IntIntPair m903ellipsisSizeF35zmw$foundation_layout(boolean hasNext, int lineIndex, int totalCrossAxisSize) {
            ...
            case 4:
                ...
                if (!hasNext) {
                    if (lineIndex >= this.minLinesToShowCollapse - 1 && totalCrossAxisSize >= this.minCrossAxisSizeToShowCollapse) {
                        ...
                        if (function2 == null || (measurableInvoke = function2.invoke(false, Integer.valueOf(getShownItemCount$foundation_layout()))) == null) {
                            measurableInvoke = this.collapseMeasurable;
                        }
                        measurable3 = measurableInvoke;
                    }
                    ...
                    if (function22 == null || (measurable2 = function22.invoke(true, Integer.valueOf(getShownItemCount$foundation_layout()))) == null) {
                        measurable2 = this.seeMoreMeasurable;
                    }
    ...
    public final void m905setOverflowMeasurableshBUhpc$foundation_layout(IntrinsicMeasurable seeMoreMeasurable, IntrinsicMeasurable collapseMeasurable, boolean isHorizontal, long constraints) {
        LayoutOrientation orientation = isHorizontal ? LayoutOrientation.Horizontal : LayoutOrientation.Vertical;
        long orientationIndependentConstraints = OrientationIndependentConstraints.m1017constructorimpl(constraints, orientation);
        if (seeMoreMeasurable != null) {
            int mainAxisSize = FlowLayoutKt.mainAxisMin(seeMoreMeasurable, isHorizontal, Constraints.m8102getMaxHeightimpl(orientationIndependentConstraints));
            int crossAxisSize = FlowLayoutKt.crossAxisMin(seeMoreMeasurable, isHorizontal, mainAxisSize);
            this.seeMoreSize = IntIntPair.m19boximpl(IntIntPair.m22constructorimpl(mainAxisSize, crossAxisSize));
        ...
        if (collapseMeasurable != null) {
            int mainAxisSize2 = FlowLayoutKt.mainAxisMin(collapseMeasurable, isHorizontal, Constraints.m8102getMaxHeightimpl(orientationIndependentConstraints));
            int crossAxisSize2 = FlowLayoutKt.crossAxisMin(collapseMeasurable, isHorizontal, mainAxisSize2);
            this.collapseSize = IntIntPair.m19boximpl(IntIntPair.m22constructorimpl(mainAxisSize2, crossAxisSize2));
    ...
    /* JADX INFO: renamed from: setOverflowMeasurables--hBUhpc$foundation_layout, reason: not valid java name */
    public final void m904setOverflowMeasurableshBUhpc$foundation_layout(final FlowLineMeasurePolicy measurePolicy, Measurable seeMoreMeasurable, Measurable collapseMeasurable, long constraints) {
        boolean isHorizontal = measurePolicy.isHorizontal();
        LayoutOrientation orientation = isHorizontal ? LayoutOrientation.Horizontal : LayoutOrientation.Vertical;
        long jM1017constructorimpl = OrientationIndependentConstraints.m1017constructorimpl(constraints, orientation);
        long orientationIndependentConstraints = OrientationIndependentConstraints.m1018copyyUG9Ft0(jM1017constructorimpl, (14 & 1) != 0 ? Constraints.m8105getMinWidthimpl(jM1017constructorimpl) : 0, (14 & 2) != 0 ? Constraints.m8103getMaxWidthimpl(jM1017constructorimpl) : 0, (14 & 4) != 0 ? Constraints.m8104getMinHeightimpl(jM1017constructorimpl) : 0, (14 & 8) != 0 ? Constraints.m8102getMaxHeightimpl(jM1017constructorimpl) : 0);
        long finalConstraints = OrientationIndependentConstraints.m1030toBoxConstraintsOenEA2s(orientationIndependentConstraints, orientation);
        if (seeMoreMeasurable != null) {
            FlowLayoutKt.m899measureAndCacherqJ1uqs(seeMoreMeasurable, measurePolicy, finalConstraints, new Function1() { // from class: androidx.compose.foundation.layout.FlowLayoutOverflowState$$ExternalSyntheticLambda0
        ...
        if (collapseMeasurable != null) {
            FlowLayoutKt.m899measureAndCacherqJ1uqs(collapseMeasurable, measurePolicy, finalConstraints, new Function1() { // from class: androidx.compose.foundation.layout.FlowLayoutOverflowState$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
    ...
    public static final Unit setOverflowMeasurables__hBUhpc$lambda$2$0(FlowLayoutOverflowState this$0, FlowLineMeasurePolicy $measurePolicy, Placeable placeable) {
        int mainAxisSize = 0;
        int crossAxisSize = 0;
        if (placeable != null) {
        ...
        this$0.seeMoreSize = IntIntPair.m19boximpl(IntIntPair.m22constructorimpl(mainAxisSize, crossAxisSize));
        this$0.seeMorePlaceable = placeable;
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit setOverflowMeasurables__hBUhpc$lambda$3$0(FlowLayoutOverflowState this$0, FlowLineMeasurePolicy $measurePolicy, Placeable placeable) {
        int mainAxisSize = 0;
        int crossAxisSize = 0;
        if (placeable != null) {
            mainAxisSize = $measurePolicy.mainAxisSize(placeable);
        ...
        this$0.collapseSize = IntIntPair.m19boximpl(IntIntPair.m22constructorimpl(mainAxisSize, crossAxisSize));
    ...
    public final void m906setOverflowMeasurablesVKLhPVY$foundation_layout(FlowLineMeasurePolicy measurePolicy, long constraints, Function2<? super Boolean, ? super Integer, ? extends Measurable> getOverflowMeasurable) {
        this.itemShown = 0;
        ...
        m904setOverflowMeasurableshBUhpc$foundation_layout(measurePolicy, seeMoreMeasurable, collapseMeasurable, constraints);
    }
}
