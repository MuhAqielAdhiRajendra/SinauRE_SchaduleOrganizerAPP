...
public final class TextAnnotatedStringNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    private final MultiParagraphLayoutCache getLayoutCache(Density density) {
        ...
        if (textSubstitutionValue != null && textSubstitutionValue.isShowingSubstitution() && (cache = textSubstitutionValue.getLayoutCache()) != null) {
            cache.setDensity$foundation(density);
            return cache;
        }
    ...
    public final boolean m2017updateLayoutRelatedArgsy0kMQk(TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow, TextAutoSize autoSize) {
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged, boolean callbacksChanged) {
        if (textChanged || layoutChanged || callbacksChanged) {
            getLayoutCache().m1992updateJ2qo7bo(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders, this.autoSize);
        }
        if (!getIsAttached()) {
            return;
        }
    ...
    private final boolean setSubstitution(AnnotatedString updatedText) {
        ...
        if (currentTextSubstitution != null) {
            ...
            layoutCache.m1992updateJ2qo7bo(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, CollectionsKt.emptyList(), this.autoSize);
            return true;
        }
    ...
    */
    static final boolean applySemantics$lambda$0(androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode r37, java.util.List r38) {
        /*
            r0 = r37
        ...
        L2a:
            ...
            r33 = 0
            r34 = 0
            androidx.compose.ui.text.TextStyle r5 = androidx.compose.ui.text.TextStyle.m7593mergedA7vx0o$default(r5, r6, r8, r10, r11, r12, r13, r14, r15, r17, r18, r19, r20, r22, r23, r24, r25, r26, r27, r29, r30, r31, r32, r33, r34, r35, r36)
            androidx.compose.ui.text.TextLayoutInput r1 = r2.getLayoutInput()
            ...
            r7 = 0
            r4 = 0
            androidx.compose.ui.text.TextLayoutResult r1 = androidx.compose.ui.text.TextLayoutResult.m7541copyO0kMr_c$default(r2, r3, r4, r6, r7)
            if (r1 == 0) goto Lb3
        Lab:
            r3 = r1
            r4 = 0
        ...
        Lbf:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode.applySemantics$lambda$0(androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode, java.util.List):boolean");
    }

    static final boolean applySemantics$lambda$1(TextAnnotatedStringNode this$0, AnnotatedString updatedText) {
        this$0.setSubstitution(updatedText);
        this$0.invalidateForTranslate();
        return true;
    }

    static final boolean applySemantics$lambda$2(TextAnnotatedStringNode this$0, boolean it) {
    ...
    static final boolean applySemantics$lambda$3(TextAnnotatedStringNode this$0) {
    ...
    public final MeasureResult m2016measureNonExtension3p2s80s(MeasureScope measureScope, Measurable measurable, long constraints) {
        return mo67measure3p2s80s(measureScope, measurable, constraints);
    }
    ...
    public MeasureResult mo67measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) throws Throwable {
        ...
        try {
            ...
            boolean didChangeLayout = layoutCache.m1991layoutWithConstraintsK40F9xA(constraints, $this$measure_u2d3p2s80s.getLayoutDirection());
            textLayoutResult = layoutCache.getTextLayoutResult();
            ...
            companion = Constraints.INSTANCE;
            ...
            try {
                ...
                i3 = (int) (arg0$iv4 & 4294967295L);
                arg0$iv = textLayoutResult.getSize();
            } catch (Throwable th2) {
                th = th2;
            }
        } catch (Throwable th3) {
        ...
        try {
            final Placeable placeable = measurable.mo6783measureBRTryo0(companion.m8112fitPrioritizingWidthZbe2FdA(i, i2, i3, (int) (arg0$iv & 4294967295L)));
            ...
            MeasureResult measureResultLayout = $this$measure_u2d3p2s80s.layout($i$f$unpackInt1, (int) (arg0$iv6 & 4294967295L), map, new Function1() { // from class: androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
    ...
    public void draw(ContentDrawScope $this$draw) throws Throwable {
        ...
        boolean willClip = textLayoutResult.getHasVisualOverflow() && !TextOverflow.m8051equalsimpl0(this.overflow, TextOverflow.INSTANCE.m8064getVisiblegIe3tQ8());
        if (willClip) {
            ...
            long v1$iv$iv2 = Float.floatToRawIntBits(height);
            long v2$iv$iv = (v1$iv$iv << 32) | (v1$iv$iv2 & 4294967295L);
            Rect bounds = RectKt.m5108Recttz77jQw(jM5084getZeroF1C5BW0, Size.m5128constructorimpl(v2$iv$iv));
            canvas.save();
            z = false;
            Canvas.m5286clipRectmtrdDE$default(canvas, bounds, 0, 2, null);
        } else {
            z = false;
        }
        try {
            ...
            if (brush != null) {
                ...
                z2 = z;
                z3 = true;
                localParagraph.m7439painthn5TExg(canvas, brush, (64 & 4) != 0 ? Float.NaN : alpha, (64 & 8) != 0 ? null : shadow, (64 & 16) != 0 ? null : textDecoration2, (64 & 32) != 0 ? null : drawStyle2, (64 & 64) != 0 ? DrawScope.INSTANCE.m5889getDefaultBlendMode0nO6VwU() : 0);
            } else {
                z2 = z;
                z3 = true;
                Shadow shadow2 = shadow;
                ColorProducer colorProducer = this.overrideColor;
                long overrideColorVal = colorProducer != null ? colorProducer.mo2472invoke0d7_KjU() : Color.INSTANCE.m5349getUnspecified0d7_KjU();
                long $this$isSpecified$iv = overrideColorVal;
                if ($this$isSpecified$iv != 16 ? true : z2) {
                    color = overrideColorVal;
                } else {
                    long $this$isSpecified$iv2 = this.style.m7603getColor0d7_KjU();
                    if ($this$isSpecified$iv2 != 16 ? true : z2) {
                        color = this.style.m7603getColor0d7_KjU();
                    } else {
                        color = Color.INSTANCE.m5339getBlack0d7_KjU();
                    }
                }
                localParagraph.m7437paintLG529CI(canvas, (32 & 2) != 0 ? Color.INSTANCE.m5349getUnspecified0d7_KjU() : color, (32 & 4) != 0 ? null : shadow2, (32 & 8) != 0 ? null : textDecoration2, (32 & 16) == 0 ? drawStyle2 : null, (32 & 32) != 0 ? DrawScope.INSTANCE.m5889getDefaultBlendMode0nO6VwU() : 0);
            }
            TextSubstitutionValue textSubstitutionValue = this.textSubstitution;
