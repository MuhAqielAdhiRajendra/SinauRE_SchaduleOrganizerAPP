...
final class GradientColorInflaterCompat {
    ...
    static Shader createFromXmlInner(Resources resources, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        int type = TypedArrayUtils.getNamedInt(a, parser, ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY, R.styleable.GradientColor_android_type, 0);
        ...
        int type2 = R.styleable.GradientColor_android_tileMode;
        int tileMode = TypedArrayUtils.getNamedInt(a, parser, "tileMode", type2, 0);
