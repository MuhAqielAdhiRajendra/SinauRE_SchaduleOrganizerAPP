...
public final class NavigationItemColors {
    ...
    /* JADX INFO: renamed from: getSelectedIndicatorColor-0d7_KjU, reason: not valid java name and from getter */
    ...
    public final NavigationItemColors m2737copy4JmcsL4(long selectedIconColor, long selectedTextColor, long selectedIndicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor) {
    ...
    public final long m2745iconColorWaAFU9c(boolean selected, boolean enabled) {
    ...
    public final long m2746textColorWaAFU9c(boolean selected, boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof NavigationItemColors) && Color.m5314equalsimpl0(this.selectedIconColor, ((NavigationItemColors) other).selectedIconColor) && Color.m5314equalsimpl0(this.unselectedIconColor, ((NavigationItemColors) other).unselectedIconColor) && Color.m5314equalsimpl0(this.selectedTextColor, ((NavigationItemColors) other).selectedTextColor) && Color.m5314equalsimpl0(this.unselectedTextColor, ((NavigationItemColors) other).unselectedTextColor) && Color.m5314equalsimpl0(this.selectedIndicatorColor, ((NavigationItemColors) other).selectedIndicatorColor) && Color.m5314equalsimpl0(this.disabledIconColor, ((NavigationItemColors) other).disabledIconColor) && Color.m5314equalsimpl0(this.disabledTextColor, ((NavigationItemColors) other).disabledTextColor)) {
            return true;
        }
        return false;
    }
