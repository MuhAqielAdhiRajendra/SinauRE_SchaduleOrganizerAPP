...
public final class FrameRateModifierNode extends Modifier.Node implements TraversableNode, DrawModifierNode {
    ...
    public void onDetach() {
        ...
        if (ancestor != null) {
            ...
            setChildrenLayerFrameRate(coordinator$ui != null ? coordinator$ui.getWrapped() : null, ancestor.frameRate);
        } else {
    ...
    public final void setChildrenLayerFrameRate(NodeCoordinator nodeCoordinator, float frameRate) {
        ...
        if (coordinatorToUse == null || (layoutNode = coordinatorToUse.getLayoutNode()) == null || (children$ui = layoutNode.getChildren$ui()) == null) {
            return;
        }
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            setChildrenLayerFrameRate(it.getOuterCoordinator$ui(), frameRate);
        }
    }
}
