...
public final class ScreenShareKt {
    ...
    @Deprecated(message = "Use the AutoMirrored version at Icons.AutoMirrored.Outlined.ScreenShare", replaceWith = @ReplaceWith(expression = "Icons.AutoMirrored.Outlined.ScreenShare", imports = {"androidx.compose.material.icons.automirrored.outlined.ScreenShare"}))
    public static /* synthetic */ void getScreenShare$annotations(Icons.Outlined outlined) {
    }

    public static final ImageVector getScreenShare(Icons.Outlined $this$ScreenShare) {
        ...
        ImageVector.Builder $this$_get_ScreenShare__u24lambda_u241 = new ImageVector.Builder("Outlined.ScreenShare", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
