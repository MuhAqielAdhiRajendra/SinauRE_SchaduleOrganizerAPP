...
public final class SelectableTextAnnotatedStringNode extends DelegatingNode implements LayoutModifierNode, DrawModifierNode, GlobalPositionAwareModifierNode {
    ...
    public MeasureResult mo67measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        return this.textAnnotatedStringNode.m2016measureNonExtension3p2s80s($this$measure_u2d3p2s80s, measurable, constraints);
    }
    ...
    public final void m2005update7NebLg4(AnnotatedString text, TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow, Function1<? super TextLayoutResult, Unit> onTextLayout, Function1<? super List<Rect>, Unit> onPlaceholderLayout, SelectionController selectionController, ColorProducer color, TextAutoSize autoSize) {
        this.textAnnotatedStringNode.doInvalidations(this.textAnnotatedStringNode.updateDraw(color, style), this.textAnnotatedStringNode.updateText$foundation(text), this.textAnnotatedStringNode.m2017updateLayoutRelatedArgsy0kMQk(style, placeholders, minLines, maxLines, softWrap, fontFamilyResolver, overflow, autoSize), this.textAnnotatedStringNode.updateCallbacks(onTextLayout, onPlaceholderLayout, selectionController, this.onShowTranslation));
        this.selectionController = selectionController;
