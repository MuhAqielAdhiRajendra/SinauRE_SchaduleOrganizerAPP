...
public final class PercentKt {
    ...
    public static final ImageVector getPercent(Icons.Outlined $this$Percent) {
        if (_percent != null) {
        ...
        ImageVector.Builder $this$_get_Percent__u24lambda_u241 = new ImageVector.Builder("Outlined.Percent", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
