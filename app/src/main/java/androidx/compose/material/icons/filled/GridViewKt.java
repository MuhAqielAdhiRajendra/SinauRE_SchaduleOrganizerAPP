...
public final class GridViewKt {
    ...
    public static final ImageVector getGridView(Icons.Filled $this$GridView) {
        if (_gridView != null) {
        ...
        ImageVector.Builder $this$_get_GridView__u24lambda_u241 = new ImageVector.Builder("Filled.GridView", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
