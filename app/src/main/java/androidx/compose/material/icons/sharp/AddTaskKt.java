...
public final class AddTaskKt {
    ...
    public static final ImageVector getAddTask(Icons.Sharp $this$AddTask) {
        if (_addTask != null) {
        ...
        ImageVector.Builder $this$_get_AddTask__u24lambda_u241 = new ImageVector.Builder("Sharp.AddTask", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
