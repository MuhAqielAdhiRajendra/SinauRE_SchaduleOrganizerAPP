...
public final class NoCellKt {
    ...
    public static final ImageVector getNoCell(Icons.Filled $this$NoCell) {
        if (_noCell != null) {
        ...
        ImageVector.Builder $this$_get_NoCell__u24lambda_u241 = new ImageVector.Builder("Filled.NoCell", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
