    ...
    public MeasureResult mo67measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, placeable.getWidth(), placeable.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.layout.OffsetPxNode$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return OffsetPxNode.measure_3p2s80s$lambda$0(this.f$0, placeable, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }

    static final Unit measure_3p2s80s$lambda$0(OffsetPxNode this$0, Placeable $placeable, Placeable.PlacementScope $this$layout) {
        long offsetValue = this$0.offset.invoke($this$layout).m8287unboximpl();
        if (this$0.rtlAware) {
            Placeable.PlacementScope.placeRelativeWithLayer$default($this$layout, $placeable, IntOffset.m8278getXimpl(offsetValue), IntOffset.m8279getYimpl(offsetValue), 0.0f, (Function1) null, 12, (Object) null);
        } else {
            Placeable.PlacementScope.placeWithLayer$default($this$layout, $placeable, IntOffset.m8278getXimpl(offsetValue), IntOffset.m8279getYimpl(offsetValue), 0.0f, (Function1) null, 12, (Object) null);
        }
