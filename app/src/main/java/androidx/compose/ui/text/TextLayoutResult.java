...
public final class TextLayoutResult {
    ...
    public final boolean getDidOverflowHeight() {
        if (!this.multiParagraph.getDidExceedMaxLines()) {
            ...
            if (((int) (4294967295L & arg0$iv)) >= this.multiParagraph.getHeight()) {
                return false;
            }
        }
        return true;
    ...
    public final boolean getDidOverflowWidth() {
        long arg0$iv = this.size;
        return ((float) ((int) (arg0$iv >> 32))) < this.multiParagraph.getWidth();
    }
    ...
    public final int m7543getOffsetForPositionk4lQ0M(long position) {
        return this.multiParagraph.m7434getOffsetForPositionk4lQ0M(position);
    }
    ...
    public final long m7545getWordBoundaryjx7JFs(int offset) {
        return this.multiParagraph.m7436getWordBoundaryjx7JFs(offset);
    }
    ...
    public static /* synthetic */ TextLayoutResult m7541copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textLayoutResult.m7542copyO0kMr_c(textLayoutInput, j);
    }

    /* JADX INFO: renamed from: copy-O0kMr_c, reason: not valid java name */
    public final TextLayoutResult m7542copyO0kMr_c(TextLayoutInput layoutInput, long size) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TextLayoutResult) || !Intrinsics.areEqual(this.layoutInput, ((TextLayoutResult) other).layoutInput) || !Intrinsics.areEqual(this.multiParagraph, ((TextLayoutResult) other).multiParagraph) || !IntSize.m8319equalsimpl0(this.size, ((TextLayoutResult) other).size)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        return (((((((((result * 31) + this.multiParagraph.hashCode()) * 31) + IntSize.m8322hashCodeimpl(this.size)) * 31) + Float.hashCode(this.firstBaseline)) * 31) + Float.hashCode(this.lastBaseline)) * 31) + this.placeholderRects.hashCode();
    }

    public String toString() {
        return "TextLayoutResult(layoutInput=" + this.layoutInput + ", multiParagraph=" + this.multiParagraph + ", size=" + ((Object) IntSize.m8324toStringimpl(this.size)) + ", firstBaseline=" + this.firstBaseline + ", lastBaseline=" + this.lastBaseline + ", placeholderRects=" + this.placeholderRects + ')';
    }
}
