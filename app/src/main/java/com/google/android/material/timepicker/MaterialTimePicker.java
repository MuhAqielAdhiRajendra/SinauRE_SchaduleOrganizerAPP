...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    private void restoreState(Bundle bundle) {
        ...
        boolean forceKeyboardInputMode = getResources().getBoolean(R.bool.timepicker_force_input_mode_keyboard);
        int defaultInputMode = 1;
        if (!forceKeyboardInputMode && this.time.format != 1) {
            defaultInputMode = 0;
        }
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        final ViewGroup root = (ViewGroup) layoutInflater.inflate(R.layout.material_timepicker_dialog, viewGroup);
        ...
        this.okButton = (Button) root.findViewById(R.id.material_timepicker_ok_button);
        ...
        this.okButton.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.timepicker.MaterialTimePicker$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                this.f$0.m8903x6d8f60b9(root, view);
            }
        });
        if (this.positiveButtonTextResId != 0) {
            this.okButton.setText(this.positiveButtonTextResId);
        ...
        this.modeButton.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.timepicker.MaterialTimePicker$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.m8905x8efafa3b(view);
            }
        });
        return root;
    }

    /* JADX INFO: renamed from: lambda$onCreateView$0$com-google-android-material-timepicker-MaterialTimePicker, reason: not valid java name */
    /* synthetic */ void m8903x6d8f60b9(ViewGroup root, View v) {
        if (this.activePresenter instanceof TimePickerTextInputPresenter) {
            TimePickerTextInputPresenter presenter = (TimePickerTextInputPresenter) this.activePresenter;
        ...
        for (View.OnClickListener listener : this.positiveButtonListeners) {
            listener.onClick(v);
        }
        dismiss();
    }

    /* JADX INFO: renamed from: lambda$onCreateView$1$com-google-android-material-timepicker-MaterialTimePicker, reason: not valid java name */
    /* synthetic */ void m8904x7e452d7a(View v) {
        for (View.OnClickListener listener : this.negativeButtonListeners) {
            listener.onClick(v);
        }
        dismiss();
    }

    /* JADX INFO: renamed from: lambda$onCreateView$2$com-google-android-material-timepicker-MaterialTimePicker, reason: not valid java name */
    /* synthetic */ void m8905x8efafa3b(View v) {
        ...
        if (this.activePresenter instanceof TimePickerTextInputPresenter) {
            view.postDelayed(new Runnable() { // from class: com.google.android.material.timepicker.MaterialTimePicker$$ExternalSyntheticLambda3
                ...
                public final void run() {
                    this.f$0.m8906xde954046();
                }
            }, 100L);
        }
    }

    /* JADX INFO: renamed from: lambda$onViewCreated$3$com-google-android-material-timepicker-MaterialTimePicker, reason: not valid java name */
    /* synthetic */ void m8906xde954046() {
        if (this.activePresenter instanceof TimePickerTextInputPresenter) {
    ...
    private void updateInputMode(MaterialButton modeButton) {
        ...
        modeButton.setContentDescription(getResources().getString(modeButtonData.contentDescriptionResId));
        TooltipCompat.setTooltipText(modeButton, getResources().getString(modeButtonData.tooltipTextResId));
    ...
    private ModeButtonData getModeButtonData(int mode) {
        switch (mode) {
            case 0:
    ...
    private static final class ModeButtonData {
        ...
        ModeButtonData(int iconResId, int contentDescriptionResId, int tooltipTextResId) {
