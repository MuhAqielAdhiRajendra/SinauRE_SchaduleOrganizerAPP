...
public final class SavedStateSerializer implements KSerializer<Bundle> {
    ...
    public void serialize(Encoder encoder, Bundle value) {
        ...
        if (Intrinsics.areEqual($this$serialize_u24lambda_u243.getKey(), "")) {
            ...
            Bundle $this$serialize_u24lambda_u243_u24lambda_u241 = SavedStateWriter.m8608constructorimpl($this$write$iv);
            SavedStateWriter.m8612putAllimpl($this$serialize_u24lambda_u243_u24lambda_u241, value);
        } else {
            Bundle $this$write$iv2 = $this$serialize_u24lambda_u243.getSavedState();
            Bundle $this$serialize_u24lambda_u243_u24lambda_u242 = SavedStateWriter.m8608constructorimpl($this$write$iv2);
            SavedStateWriter.m8635putSavedStateimpl($this$serialize_u24lambda_u243_u24lambda_u242, $this$serialize_u24lambda_u243.getKey(), value);
        }
    }
    ...
    public Bundle deserialize(Decoder decoder) {
        ...
        Bundle $this$deserialize_u24lambda_u246_u24lambda_u245 = SavedStateReader.m8522constructorimpl($this$read$iv);
        return SavedStateReader.m8579getSavedStateimpl($this$deserialize_u24lambda_u246_u24lambda_u245, $this$deserialize_u24lambda_u246.getKey());
    }
}
