...
public final class LinkedCameraKt {
    ...
    public static final ImageVector getLinkedCamera(Icons.Outlined $this$LinkedCamera) {
        ...
        ImageVector.Builder $this$_get_LinkedCamera__u24lambda_u241 = new ImageVector.Builder("Outlined.LinkedCamera", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(20.67f, 7.99f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(2.58f, 0.0f, 4.66f, 2.08f, 4.67f, 4.66f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(18.0f, 7.99f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _linkedCamera = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_LinkedCamera__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
