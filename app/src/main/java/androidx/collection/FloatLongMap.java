...
public abstract class FloatLongMap {
            ...
            if ((((~slot$iv) << 7) & slot$iv & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (j$iv < bitCount$iv) {
                    ...
                    if (!(value$iv$iv < 128)) {
                        ...
                        i = i2;
                        block.invoke(Float.valueOf(k2[index$iv]), Long.valueOf(v[index$iv]));
                    }
                    slot$iv >>= i;
                    j$iv++;
                    i2 = i;
            ...
            if ((((~slot$iv$iv) << 7) & slot$iv$iv & (-9187201950435737472L)) == -9187201950435737472L) {
                ...
                while (j$iv$iv < bitCount$iv$iv) {
                    ...
                    if (!(value$iv$iv$iv < 128)) {
                        ...
                        i = i2;
                        $i$f$all2 = $i$f$all3;
                        if (!predicate.invoke(Float.valueOf(key), Long.valueOf(value)).booleanValue()) {
                            return false;
                        }
                    }
                    slot$iv$iv2 >>= i;
    ...
    */
    ...
    public static /* synthetic */ String joinToString$default(FloatLongMap floatLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        ...
        return floatLongMap.joinToString(charSequence, charSequence2, charSequence3, i, (i2 & 16) != 0 ? "..." : charSequence4);
    }
                ...
                if ($this$maskEmptyOrDeleted$iv$iv$iv != -9187201950435737472L) {
                    ...
                    while (j$iv$iv < bitCount$iv$iv) {
                        ...
                        if (value$iv$iv$iv < 128) {
                            ...
                            $this$joinToString_u24lambda_u2410.append((CharSequence) transform.invoke(Float.valueOf(key), Long.valueOf(value)));
                            index3++;
                        } else {
                            separator3 = separator4;
                            i2 = i5;
                ...
                if ($this$maskEmptyOrDeleted$iv$iv$iv != -9187201950435737472L) {
                    ...
                    while (j$iv$iv < bitCount$iv$iv) {
                        ...
                        if (!(value$iv$iv$iv < 128)) {
                            ...
                            $this$joinToString_u24lambda_u2410.append(transform.invoke(Float.valueOf(key), Long.valueOf(value)));
                            index++;
                        }
                        slot$iv$iv >>= i;
                        j$iv$iv++;
                ...
                if ((((~slot$iv$iv) << 7) & slot$iv$iv & (-9187201950435737472L)) == -9187201950435737472L) {
                    ...
                    for (int j$iv$iv = 0; j$iv$iv < bitCount$iv$iv2; j$iv$iv++) {
                        ...
                        if (value$iv$iv$iv < 128) {
                            ...
                            float key = k$iv[index$iv$iv];
                            long value = v$iv[index$iv$iv];
                            hash += Float.hashCode(key) ^ Long.hashCode(value);
                        }
                        slot$iv$iv >>= 8;
                    }
    ...
    public boolean equals(Object other) {
        ...
        boolean z4 = false;
        if (!(obj instanceof FloatLongMap) || ((FloatLongMap) obj).get_size() != get_size()) {
            return false;
        }
        int $i$f$forEach = 0;
        float[] k$iv = this.keys;
            ...
            if ($this$maskEmptyOrDeleted$iv$iv$iv == -9187201950435737472L) {
                ...
                while (j$iv$iv < bitCount$iv$iv) {
                    ...
                    if (!(value$iv$iv$iv < 128 ? z5 : z6)) {
                        ...
                        long value = v$iv[index$iv$iv];
                        i = index;
                        int index2 = ((FloatLongMap) obj).findKeyIndex(key);
                        if (index2 < 0 || value != ((FloatLongMap) other).values[index2]) {
                            break loop0;
                        }
                    }
                    slot$iv$iv >>= i;
                ...
                if ($this$maskEmptyOrDeleted$iv$iv$iv$iv != -9187201950435737472L) {
                    ...
                    while (j$iv$iv$iv < bitCount$iv$iv$iv) {
                        ...
                        if (!(value$iv$iv$iv$iv < 128)) {
                            ...
                            truncated$iv2 = truncated$iv;
                            $this$joinToString_u24lambda_u2410$iv.append(transform.invoke(Float.valueOf(key$iv), Long.valueOf(value$iv)));
                            index$iv++;
                        }
                        slot$iv$iv$iv >>= i;
                        j$iv$iv$iv++;
