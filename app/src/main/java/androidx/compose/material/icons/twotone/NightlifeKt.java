...
public final class NightlifeKt {
    ...
    public static final ImageVector getNightlife(Icons.TwoTone $this$Nightlife) {
        if (_nightlife != null) {
        ...
        ImageVector.Builder $this$_get_Nightlife__u24lambda_u241 = new ImageVector.Builder("TwoTone.Nightlife", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
