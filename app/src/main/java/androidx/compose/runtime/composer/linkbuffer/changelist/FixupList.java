...
public final class FixupList extends DebugStringFormattable {
    ...
    public final void createAndInsertNode(Function0<? extends Object> factory, int insertIndex, long groupHandle) {
        ...
        Operations $this$createAndInsertNode_u24lambda_u240 = Operations.WriteScope.m4633constructorimpl(this_$iv);
        Operation.InsertNodeFixup insertNodeFixup = Operation.InsertNodeFixup.INSTANCE;
        Operations.WriteScope.m4643setObjectaWHcuVo($this$createAndInsertNode_u24lambda_u240, Operation.ObjectParameter.m4608constructorimpl(0), factory);
        Operation.InsertNodeFixup insertNodeFixup2 = Operation.InsertNodeFixup.INSTANCE;
        $this$createAndInsertNode_u24lambda_u240.intArgs[($this$createAndInsertNode_u24lambda_u240.intArgsSize - $this$createAndInsertNode_u24lambda_u240.opCodes[$this$createAndInsertNode_u24lambda_u240.opCodesSize - 1].getInts()) + 0] = insertIndex;
        Operation.InsertNodeFixup insertNodeFixup3 = Operation.InsertNodeFixup.INSTANCE;
        Operation.InsertNodeFixup this_$iv2 = Operation.InsertNodeFixup.INSTANCE;
        Operations.WriteScope.m4642setLongimpl($this$createAndInsertNode_u24lambda_u240, 1, 2, groupHandle);
        this_$iv.ensureAllArgumentsPushedFor(operation$iv);
        Operations this_$iv3 = this.pendingOperations;
        Operation operation$iv2 = Operation.PostInsertNodeFixup.INSTANCE;
        this_$iv3.pushOp(operation$iv2);
        Operations $this$createAndInsertNode_u24lambda_u241 = Operations.WriteScope.m4633constructorimpl(this_$iv3);
        ...
        Operation.PostInsertNodeFixup this_$iv4 = Operation.PostInsertNodeFixup.INSTANCE;
        Operations.WriteScope.m4642setLongimpl($this$createAndInsertNode_u24lambda_u241, 1, 2, groupHandle);
        this_$iv3.ensureAllArgumentsPushedFor(operation$iv2);
    }

    public final void createAndInsertNodeByAnchor(Function0<? extends Object> factory, int insertIndex, LinkAnchor anchor) {
        Operations this_$iv = this.operations;
        Operation operation$iv = Operation.InsertNodeFixupByAnchor.INSTANCE;
        this_$iv.pushOp(operation$iv);
        Operations $this$createAndInsertNodeByAnchor_u24lambda_u240 = Operations.WriteScope.m4633constructorimpl(this_$iv);
        Operation.InsertNodeFixupByAnchor insertNodeFixupByAnchor = Operation.InsertNodeFixupByAnchor.INSTANCE;
        Operations.WriteScope.m4643setObjectaWHcuVo($this$createAndInsertNodeByAnchor_u24lambda_u240, Operation.ObjectParameter.m4608constructorimpl(0), factory);
        Operation.InsertNodeFixupByAnchor insertNodeFixupByAnchor2 = Operation.InsertNodeFixupByAnchor.INSTANCE;
        int[] iArr = $this$createAndInsertNodeByAnchor_u24lambda_u240.intArgs;
        int $i$f$push = $this$createAndInsertNodeByAnchor_u24lambda_u240.intArgsSize;
        iArr[($i$f$push - $this$createAndInsertNodeByAnchor_u24lambda_u240.opCodes[$this$createAndInsertNodeByAnchor_u24lambda_u240.opCodesSize - 1].getInts()) + 0] = insertIndex;
        Operation.InsertNodeFixupByAnchor insertNodeFixupByAnchor3 = Operation.InsertNodeFixupByAnchor.INSTANCE;
        Operations.WriteScope.m4643setObjectaWHcuVo($this$createAndInsertNodeByAnchor_u24lambda_u240, Operation.ObjectParameter.m4608constructorimpl(1), anchor);
        this_$iv.ensureAllArgumentsPushedFor(operation$iv);
        Operations this_$iv2 = this.pendingOperations;
        Operation operation$iv2 = Operation.PostInsertNodeFixupByAnchor.INSTANCE;
        this_$iv2.pushOp(operation$iv2);
        Operations $this$createAndInsertNodeByAnchor_u24lambda_u241 = Operations.WriteScope.m4633constructorimpl(this_$iv2);
        Operation.PostInsertNodeFixupByAnchor postInsertNodeFixupByAnchor = Operation.PostInsertNodeFixupByAnchor.INSTANCE;
        int[] iArr2 = $this$createAndInsertNodeByAnchor_u24lambda_u241.intArgs;
        int $i$f$push2 = $this$createAndInsertNodeByAnchor_u24lambda_u241.intArgsSize;
        iArr2[($i$f$push2 - $this$createAndInsertNodeByAnchor_u24lambda_u241.opCodes[$this$createAndInsertNodeByAnchor_u24lambda_u241.opCodesSize - 1].getInts()) + 0] = insertIndex;
        Operation.PostInsertNodeFixupByAnchor postInsertNodeFixupByAnchor2 = Operation.PostInsertNodeFixupByAnchor.INSTANCE;
        Operations.WriteScope.m4643setObjectaWHcuVo($this$createAndInsertNodeByAnchor_u24lambda_u241, Operation.ObjectParameter.m4608constructorimpl(0), anchor);
    ...
    public final <V, T> void updateNode(V value, Function2<? super T, ? super V, Unit> block) {
        ...
        this_$iv.pushOp(operation$iv);
        Operations $this$updateNode_u24lambda_u240 = Operations.WriteScope.m4633constructorimpl(this_$iv);
        Operation.UpdateNode updateNode = Operation.UpdateNode.INSTANCE;
        Operations.WriteScope.m4643setObjectaWHcuVo($this$updateNode_u24lambda_u240, Operation.ObjectParameter.m4608constructorimpl(0), value);
        ...
        Operations.WriteScope.m4643setObjectaWHcuVo($this$updateNode_u24lambda_u240, iM4608constructorimpl, (Function2) TypeIntrinsics.beforeCheckcastToFunctionOfArity(block, 2));
        this_$iv.ensureAllArgumentsPushedFor(operation$iv);
    }
