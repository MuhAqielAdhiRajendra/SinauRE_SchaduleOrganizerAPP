...
public final /* data */ class ComposeStackTraceFrame {
    ...
    public int hashCode() {
        return (((Integer.hashCode(this.groupKey) * 31) + (this.sourceInfo == null ? 0 : this.sourceInfo.hashCode())) * 31) + (this.groupOffset != null ? this.groupOffset.hashCode() : 0);
    }
    ...
    public ComposeStackTraceFrame(int groupKey, SourceInformation sourceInfo, Integer groupOffset) {
