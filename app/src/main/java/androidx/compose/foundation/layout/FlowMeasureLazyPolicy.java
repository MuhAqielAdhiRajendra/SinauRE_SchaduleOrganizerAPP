...
final /* data */ class FlowMeasureLazyPolicy implements FlowLineMeasurePolicy {
    ...
    public static /* synthetic */ FlowMeasureLazyPolicy m915copyE4Q9ldg$default(FlowMeasureLazyPolicy flowMeasureLazyPolicy, boolean z, Arrangement.Horizontal horizontal, Arrangement.Vertical vertical, float f, CrossAxisAlignment crossAxisAlignment, float f2, int i, int i2, int i3, FlowLayoutOverflowState flowLayoutOverflowState, List list, Function4 function4, int i4, Object obj) {
        ...
        float f3 = f2;
        return flowMeasureLazyPolicy.m917copyE4Q9ldg(z, horizontal, vertical, f, crossAxisAlignment2, f3, i6, i7, i5, flowLayoutOverflowState2, list2, function42);
    }
    ...
    public String toString() {
        ...
        sb.append("FlowMeasureLazyPolicy(isHorizontal=").append(this.isHorizontal).append(", horizontalArrangement=").append(this.horizontalArrangement).append(", verticalArrangement=").append(this.verticalArrangement).append(", mainAxisSpacing=").append((Object) Dp.m8161toStringimpl(this.mainAxisSpacing)).append(", crossAxisAlignment=").append(this.crossAxisAlignment).append(", crossAxisArrangementSpacing=").append((Object) Dp.m8161toStringimpl(this.crossAxisArrangementSpacing)).append(", itemCount=").append(this.itemCount).append(", maxLines=").append(this.maxLines).append(", maxItemsInMainAxis=").append(this.maxItemsInMainAxis).append(", overflow=").append(this.overflow).append(", overflowComposables=").append(this.overflowComposables).append(", getComposable=");
    ...
    public final Function2<SubcomposeMeasureScope, Constraints, MeasureResult> getMeasurePolicy() {
        return new Function2() { // from class: androidx.compose.foundation.layout.FlowMeasureLazyPolicy$$ExternalSyntheticLambda1
            ...
            public final Object invoke(Object obj, Object obj2) {
                return this.f$0.m916measure0kLqBqw((SubcomposeMeasureScope) obj, ((Constraints) obj2).getValue());
            }
        };
    }
    ...
    public final MeasureResult m916measure0kLqBqw(final SubcomposeMeasureScope $this$measure_u2d0kLqBqw, long constraints) {
        LayoutOrientation layoutOrientation;
        if (this.itemCount <= 0 || this.maxLines == 0 || this.maxItemsInMainAxis == 0 || (Constraints.m8102getMaxHeightimpl(constraints) == 0 && this.overflow.getType$foundation_layout() != FlowLayoutOverflow.OverflowType.Visible)) {
            return MeasureScope.layout$default($this$measure_u2d0kLqBqw, 0, 0, null, new Function1() { // from class: androidx.compose.foundation.layout.FlowMeasureLazyPolicy$$ExternalSyntheticLambda2
        ...
        ContextualFlowItemIterator measurablesIterator = new ContextualFlowItemIterator(this.itemCount, new Function2() { // from class: androidx.compose.foundation.layout.FlowMeasureLazyPolicy$$ExternalSyntheticLambda3
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                ...
                return subcomposeMeasureScope.subcompose(Integer.valueOf(iIntValue), ComposableLambdaKt.composableLambdaInstance(-195060736, true, new Function2() { // from class: androidx.compose.foundation.layout.FlowMeasureLazyPolicy$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function2
        ...
        this.overflow.m906setOverflowMeasurablesVKLhPVY$foundation_layout(this, constraints, new Function2() { // from class: androidx.compose.foundation.layout.FlowMeasureLazyPolicy$$ExternalSyntheticLambda4
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                return FlowMeasureLazyPolicy.measure_0kLqBqw$lambda$2(this.f$0, $this$measure_u2d0kLqBqw, ((Boolean) obj).booleanValue(), ((Integer) obj2).intValue());
            }
        });
        SubcomposeMeasureScope subcomposeMeasureScope = $this$measure_u2d0kLqBqw;
        FlowMeasureLazyPolicy flowMeasureLazyPolicy = this;
        ...
        return FlowLayoutKt.m898breakDownItemsdi9J0FM(subcomposeMeasureScope, flowMeasureLazyPolicy, contextualFlowItemIterator, f, f2, OrientationIndependentConstraints.m1017constructorimpl(constraints, layoutOrientation), this.maxItemsInMainAxis, this.maxLines, this.overflow);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit measure_0kLqBqw$lambda$1$0(FlowMeasureLazyPolicy this$0, int $index, FlowLineInfo $info, Composer $composer, int $changed) {
        ComposerKt.sourceInformation($composer, "C486@20655L26:ContextualFlowLayout.kt#2w3rfo");
        if ($composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
            ...
            this$0.getComposable.invoke(Integer.valueOf($index), $info, $composer, 0);
            if (ComposerKt.isTraceInProgress()) {
