...
class ToolbarActionBar extends ActionBar {
    ...
    private final class MenuBuilderCallback implements MenuBuilder.Callback {
        ...
        public void onMenuModeChange(MenuBuilder menu) {
            boolean zIsOverflowMenuShowing = ToolbarActionBar.this.mDecorToolbar.isOverflowMenuShowing();
            ToolbarActionBar toolbarActionBar = ToolbarActionBar.this;
            if (zIsOverflowMenuShowing) {
                toolbarActionBar.mWindowCallback.onPanelClosed(AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR, menu);
            } else if (toolbarActionBar.mWindowCallback.onPreparePanel(0, null, menu)) {
