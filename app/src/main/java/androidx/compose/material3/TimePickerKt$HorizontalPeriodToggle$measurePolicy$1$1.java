...
final class TimePickerKt$HorizontalPeriodToggle$measurePolicy$1$1 implements MeasurePolicy {
        ...
        for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it), "Spacer")) {
                ...
                while (index$iv$iv3 < size3) {
                    ...
                    target$iv2.add(item.mo6783measureBRTryo0(Constraints.m8092copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m8105getMinWidthimpl(constraints) : 0, (11 & 2) != 0 ? Constraints.m8103getMaxWidthimpl(constraints) : Constraints.m8103getMaxWidthimpl(constraints) / 2, (11 & 4) != 0 ? Constraints.m8104getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m8102getMaxHeightimpl(constraints) : 0)));
                    index$iv$iv3++;
                    $this$fastMap$iv = $this$fastMap$iv;
                    $i$f$fastMap = $i$f$fastMap;
                }
                final List items = target$iv2;
                return MeasureScope.layout$default($this$MeasurePolicy, Constraints.m8103getMaxWidthimpl(constraints), Constraints.m8102getMaxHeightimpl(constraints), null, new Function1() { // from class: androidx.compose.material3.TimePickerKt$HorizontalPeriodToggle$measurePolicy$1$1$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
                        return TimePickerKt$HorizontalPeriodToggle$measurePolicy$1$1.measure_3p2s80s$lambda$3(items, spacerPlaceable, (Placeable.PlacementScope) obj);
                    }
                }, 4, null);
            }
        }
    ...
    static final Unit measure_3p2s80s$lambda$3(List $items, Placeable $spacerPlaceable, Placeable.PlacementScope $this$layout) {
        ...
        Placeable.PlacementScope.place$default($this$layout, (Placeable) $items.get(1), ((Placeable) $items.get(0)).getWidth(), 0, 0.0f, 4, null);
        Placeable.PlacementScope.place$default($this$layout, $spacerPlaceable, ((Placeable) $items.get(0)).getWidth() - ($spacerPlaceable.getWidth() / 2), 0, 0.0f, 4, null);
