...
public final class TrendingUpKt {
    ...
    public static final ImageVector getTrendingUp(Icons.Sharp $this$TrendingUp) {
        if (_trendingUp != null) {
        ...
        ImageVector.Builder $this$_get_TrendingUp__u24lambda_u241 = new ImageVector.Builder("Sharp.TrendingUp", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
