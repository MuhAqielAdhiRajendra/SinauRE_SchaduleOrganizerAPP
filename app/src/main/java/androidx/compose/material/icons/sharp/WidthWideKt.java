...
public final class WidthWideKt {
    ...
    public static final ImageVector getWidthWide(Icons.Sharp $this$WidthWide) {
        if (_widthWide != null) {
        ...
        ImageVector.Builder $this$_get_WidthWide__u24lambda_u241 = new ImageVector.Builder("Sharp.WidthWide", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
