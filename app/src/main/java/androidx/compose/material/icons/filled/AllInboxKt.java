...
public final class AllInboxKt {
    ...
    public static final ImageVector getAllInbox(Icons.Filled $this$AllInbox) {
        if (_allInbox != null) {
        ...
        ImageVector.Builder $this$_get_AllInbox__u24lambda_u241 = new ImageVector.Builder("Filled.AllInbox", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
