...
public abstract class FragmentStatePagerAdapter extends PagerAdapter {
    ...
    public void destroyItem(ViewGroup container, int position, Object object) {
        ...
        Fragment.SavedState savedStateSaveFragmentInstanceState;
        ...
        if (!fragment.isAdded()) {
            savedStateSaveFragmentInstanceState = null;
        } else {
            savedStateSaveFragmentInstanceState = this.mFragmentManager.saveFragmentInstanceState(fragment);
        }
        arrayList.set(position, savedStateSaveFragmentInstanceState);
