...
public final class TextDelegate {
    ...
    public /* synthetic */ TextDelegate(AnnotatedString annotatedString, TextStyle textStyle, int i, int i2, boolean z, int i3, Density density, FontFamily.Resolver resolver, List list, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, (i4 & 4) != 0 ? Integer.MAX_VALUE : i, (i4 & 8) != 0 ? 1 : i2, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? TextOverflow.INSTANCE.m8060getClipgIe3tQ8() : i3, density, resolver, (i4 & 256) != 0 ? CollectionsKt.emptyList() : list, null);
    }
    ...
    private final MultiParagraph m1634layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        int maxWidth;
        int width;
        layoutIntrinsics(layoutDirection);
        int minWidth = Constraints.m8105getMinWidthimpl(constraints);
        boolean widthMatters = this.softWrap || TextOverflow.m8051equalsimpl0(this.overflow, TextOverflow.INSTANCE.m8061getEllipsisgIe3tQ8());
        ...
        boolean overwriteMaxLines = !this.softWrap && TextOverflow.m8051equalsimpl0(this.overflow, TextOverflow.INSTANCE.m8061getEllipsisgIe3tQ8());
        ...
        return new MultiParagraph(getNonNullIntrinsics(), Constraints.INSTANCE.m8112fitPrioritizingWidthZbe2FdA(0, width, 0, Constraints.m8102getMaxHeightimpl(constraints)), finalMaxLines, this.overflow, (DefaultConstructorMarker) null);
    }

    /* JADX INFO: renamed from: layout-NN6Ew-U$default, reason: not valid java name */
    public static /* synthetic */ TextLayoutResult m1633layoutNN6EwU$default(TextDelegate textDelegate, long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult, int i, Object obj) {
        if ((i & 4) != 0) {
            textLayoutResult = null;
        }
        return textDelegate.m1636layoutNN6EwU(j, layoutDirection, textLayoutResult);
    }

    /* JADX INFO: renamed from: layout-NN6Ew-U, reason: not valid java name */
    public final TextLayoutResult m1636layoutNN6EwU(long constraints, LayoutDirection layoutDirection, TextLayoutResult prevResult) {
        if (prevResult == null || !TextLayoutHelperKt.m1673canReuse7_7YC6M(prevResult, this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints)) {
            long j = constraints;
            long j2 = 4294967295L;
            MultiParagraph multiParagraph = m1634layoutTextK40F9xA(constraints, layoutDirection);
            int width$iv = TextDelegateKt.ceilToIntPx(multiParagraph.getWidth());
            int height$iv = TextDelegateKt.ceilToIntPx(multiParagraph.getHeight());
            long size = ConstraintsKt.m8117constrain4WqzIAM(j, IntSize.m8316constructorimpl((((long) width$iv) << 32) | (((long) height$iv) & j2)));
        ...
        int width$iv2 = TextDelegateKt.ceilToIntPx(prevResult.getMultiParagraph().getWidth());
        int height$iv2 = TextDelegateKt.ceilToIntPx(prevResult.getMultiParagraph().getHeight());
        return prevResult.m7542copyO0kMr_c(textLayoutInput, ConstraintsKt.m8117constrain4WqzIAM(constraints, IntSize.m8316constructorimpl((((long) width$iv2) << 32) | (((long) height$iv2) & 4294967295L))));
    }

    /* JADX INFO: compiled from: TextDelegate.kt */
    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0016\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\t¨\u0006\n"}, d2 = {"Landroidx/compose/foundation/text/TextDelegate$Companion;", "", "<init>", "()V", "paint", "", "canvas", "Landroidx/compose/ui/graphics/Canvas;", "textLayoutResult", "Landroidx/compose/ui/text/TextLayoutResult;", "foundation"}, k = 1, mv = {2, 1, 0}, xi = 48)
