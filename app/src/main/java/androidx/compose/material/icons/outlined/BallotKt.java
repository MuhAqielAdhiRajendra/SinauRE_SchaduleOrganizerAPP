...
public final class BallotKt {
    ...
    public static final ImageVector getBallot(Icons.Outlined $this$Ballot) {
        if (_ballot != null) {
        ...
        ImageVector.Builder $this$_get_Ballot__u24lambda_u241 = new ImageVector.Builder("Outlined.Ballot", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
