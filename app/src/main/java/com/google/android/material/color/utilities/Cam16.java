...
public final class Cam16 {
    ...
    static Cam16 fromXyzInViewingConditions(double x, double y, double z, ViewingConditions viewingConditions) {
        ...
        double bAF2 = (((rA * 11.0d) + ((-12.0d) * gA)) + bA) / 11.0d;
        double rA2 = ((rA + gA) - (bA * 2.0d)) / 9.0d;
        double u = (((rA * 20.0d) + (gA * 20.0d)) + (21.0d * bA)) / 20.0d;
        double p2 = (((40.0d * rA) + (gA * 20.0d)) + bA) / 20.0d;
        double atan2 = Math.atan2(rA2, bAF2);
        ...
        double t = (Math.hypot(bAF2, rA2) * p1) / (u + 0.305d);
        double a = viewingConditions.getN();
        double alpha = Math.pow(1.64d - Math.pow(0.29d, a), 0.73d) * Math.pow(t, 0.9d);
        double c = alpha * Math.sqrt(j / 100.0d);
    ...
    double[] xyzInViewingConditions(ViewingConditions viewingConditions, double[] returnArray) {
        ...
        double gC2 = (Math.abs(bA) * 27.13d) / (400.0d - Math.abs(bA));
        double bCBase = Math.max(0.0d, gC2);
