...
public final class CompositeShaderBrush extends ShaderBrush {
    ...
    public Shader mo5282createShaderuvyYCjk(long size) {
        return ShaderKt.m5644CompositeShader7EN7VTw(this.dstBrush.mo5282createShaderuvyYCjk(size), this.srcBrush.mo5282createShaderuvyYCjk(size), this.blendMode);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof CompositeShaderBrush) && Intrinsics.areEqual(this.dstBrush, ((CompositeShaderBrush) other).dstBrush) && Intrinsics.areEqual(this.srcBrush, ((CompositeShaderBrush) other).srcBrush) && BlendMode.m5222equalsimpl0(this.blendMode, ((CompositeShaderBrush) other).blendMode);
    }

    public int hashCode() {
        int result = this.dstBrush.hashCode();
        return (((result * 31) + this.srcBrush.hashCode()) * 31) + BlendMode.m5223hashCodeimpl(this.blendMode);
    }

    public String toString() {
        return "CompositeShaderBrush(dstBrush=" + this.dstBrush + ", srcBrush=" + this.srcBrush + ", blendMode=" + ((Object) BlendMode.m5224toStringimpl(this.blendMode)) + ')';
    }
}
