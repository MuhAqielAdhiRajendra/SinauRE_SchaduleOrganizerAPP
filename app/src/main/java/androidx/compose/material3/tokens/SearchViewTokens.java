...
public final class SearchViewTokens {
    ...
    private static final float DockedHeaderContainerHeight = Dp.m8150constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens FullScreenContainerShape = ShapeKeyTokens.CornerNone;
    private static final float FullScreenHeaderContainerHeight = Dp.m8150constructorimpl((float) 72.0d);
    ...
    public final float m4151getContainerElevationD9Ej5fM() {
    ...
    public final float m4152getDockedHeaderContainerHeightD9Ej5fM() {
    ...
    public final float m4153getFullScreenHeaderContainerHeightD9Ej5fM() {
