...
public final class ViewListKt {
    ...
    @Deprecated(message = "Use the AutoMirrored version at Icons.AutoMirrored.TwoTone.ViewList", replaceWith = @ReplaceWith(expression = "Icons.AutoMirrored.TwoTone.ViewList", imports = {"androidx.compose.material.icons.automirrored.twotone.ViewList"}))
    public static /* synthetic */ void getViewList$annotations(Icons.TwoTone twoTone) {
    }

    public static final ImageVector getViewList(Icons.TwoTone $this$ViewList) {
        if (_viewList != null) {
        ...
        ImageVector.Builder $this$_get_ViewList__u24lambda_u242 = new ImageVector.Builder("TwoTone.ViewList", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
