...
final class ExposedDropdownMenuAnchorElement extends ModifierNodeElement<ExposedDropdownMenuAnchorNode> {
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        $this$inspectableProperties.setName("exposedDropdownMenuAnchorType");
        $this$inspectableProperties.getProperties().set("updateStateOnAttach", this.updateStateOnAttach);
    }
