...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM8929constructorimpl = Result.m8929constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM8929constructorimpl = Result.m8929constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m8935isFailureimpl(objM8929constructorimpl) ? null : objM8929constructorimpl);
    ...
    static final void installSignalHandler$lambda$1(Signal it) {
