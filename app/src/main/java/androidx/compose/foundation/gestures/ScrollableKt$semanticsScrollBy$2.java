...
@DebugMetadata(c = "androidx.compose.foundation.gestures.ScrollableKt$semanticsScrollBy$2", f = "Scrollable.kt", i = {}, l = {1150}, m = "invokeSuspend", n = {}, s = {}, v = 1)
final class ScrollableKt$semanticsScrollBy$2 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                float fM619toFloatk4lQ0M = this.$this_semanticsScrollBy.m619toFloatk4lQ0M(this.$offset);
                final Ref.FloatRef floatRef = this.$previousValue;
                final ScrollingLogic scrollingLogic = this.$this_semanticsScrollBy;
                this.label = 1;
                if (SuspendAnimationKt.animate$default(0.0f, fM619toFloatk4lQ0M, 0.0f, null, new Function2() { // from class: androidx.compose.foundation.gestures.ScrollableKt$semanticsScrollBy$2$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function2
                    public final Object invoke(Object obj, Object obj2) {
                        return ScrollableKt$semanticsScrollBy$2.invokeSuspend$lambda$0(floatRef, scrollingLogic, $this$scroll, ((Float) obj).floatValue(), ((Float) obj2).floatValue());
                    }
    ...
    static final Unit invokeSuspend$lambda$0(Ref.FloatRef $previousValue, ScrollingLogic $this_semanticsScrollBy, NestedScrollScope $$this$scroll, float currentValue, float f) {
        float delta = currentValue - $previousValue.element;
        float consumed = $this_semanticsScrollBy.reverseIfNeeded($this_semanticsScrollBy.m619toFloatk4lQ0M($$this$scroll.mo558scrollByOzD1aCk($this_semanticsScrollBy.m620toOffsettuRUvjQ($this_semanticsScrollBy.reverseIfNeeded(delta)), NestedScrollSource.INSTANCE.m6519getUserInputWNlRxjI())));
