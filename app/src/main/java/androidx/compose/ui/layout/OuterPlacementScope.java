...
final class OuterPlacementScope extends Placeable.PlacementScope {
    ...
    public float get_density() {
        return this.owner.getDensity().get_density();
    }
    ...
    public float get_fontScale() {
        return this.owner.getDensity().get_fontScale();
    }
}
