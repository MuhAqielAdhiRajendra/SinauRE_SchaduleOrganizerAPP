...
public final class LazyGridIntervalContent extends LazyLayoutIntervalContent<LazyGridInterval> implements LazyGridScope {
    ...
    private static final Function2<LazyGridItemSpanScope, Integer, GridItemSpan> DefaultSpan = new Function2() { // from class: androidx.compose.foundation.lazy.grid.LazyGridIntervalContent$$ExternalSyntheticLambda6
        ...
        public final Object invoke(Object obj, Object obj2) {
            ...
            return GridItemSpan.m1189boximpl(LazyGridSpanKt.GridItemSpan(1));
        }
    };
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final GridItemSpan item$lambda$1$0(Function1 $span, LazyGridItemSpanScope $this$let, int it) {
        return (GridItemSpan) $span.invoke($this$let);
    }

    static final Object item$lambda$2(Object $contentType, int it) {
        return $contentType;
    }

    static final Unit item$lambda$3(Function3 $content, LazyGridItemScope $this$LazyGridInterval, int it, Composer $composer, int $changed) {
    ...
    public void stickyHeader(Object key, Object contentType, final Function4<? super LazyGridItemScope, ? super Integer, ? super Composer, ? super Integer, Unit> content) {
        ...
        item(key, new Function1() { // from class: androidx.compose.foundation.lazy.grid.LazyGridIntervalContent$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return GridItemSpan.m1189boximpl(LazyGridSpanKt.GridItemSpan(((LazyGridItemSpanScope) obj).getMaxLineSpan()));
            }
            ...
            public final Object invoke(Object obj, Object obj2, Object obj3) {
                return LazyGridIntervalContent.stickyHeader$lambda$2(content, headerIndex, (LazyGridItemScope) obj, (Composer) obj2, ((Integer) obj3).intValue());
            }
        }));
    }

    static final Unit stickyHeader$lambda$2(Function4 $content, int $headerIndex, LazyGridItemScope $this$item, Composer $composer, int $changed) {
    ...
    /* JADX INFO: compiled from: LazyGridIntervalContent.kt */
    @Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0082\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R(\u0010\u0004\u001a\u0019\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u0007\u0012\u0004\u0012\u00020\b0\u0005¢\u0006\u0002\b\t¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000b¨\u0006\f"}, d2 = {"Landroidx/compose/foundation/lazy/grid/LazyGridIntervalContent$Companion;", "", "<init>", "()V", "DefaultSpan", "Lkotlin/Function2;", "Landroidx/compose/foundation/lazy/grid/LazyGridItemSpanScope;", "", "Landroidx/compose/foundation/lazy/grid/GridItemSpan;", "Lkotlin/ExtensionFunctionType;", "getDefaultSpan", "()Lkotlin/jvm/functions/Function2;", "foundation"}, k = 1, mv = {2, 1, 0}, xi = 48)
