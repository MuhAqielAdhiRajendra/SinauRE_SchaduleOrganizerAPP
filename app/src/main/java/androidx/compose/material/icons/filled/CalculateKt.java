...
public final class CalculateKt {
    ...
    public static final ImageVector getCalculate(Icons.Filled $this$Calculate) {
        if (_calculate != null) {
        ...
        ImageVector.Builder $this$_get_Calculate__u24lambda_u241 = new ImageVector.Builder("Filled.Calculate", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
