...
public final class BackspaceKt {
    ...
    public static final ImageVector getBackspace(Icons.Outlined $this$Backspace) {
        if (_backspace != null) {
        ...
        ImageVector.Builder $this$_get_Backspace__u24lambda_u241 = new ImageVector.Builder("Outlined.Backspace", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
