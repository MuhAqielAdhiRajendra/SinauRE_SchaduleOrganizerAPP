...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM8929constructorimpl2;
        ...
        try {
            ...
            objM8929constructorimpl = Result.m8929constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM8929constructorimpl = Result.m8929constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m8932exceptionOrNullimpl(objM8929constructorimpl) == null) {
            obj2 = objM8929constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM8929constructorimpl2 = Result.m8929constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM8929constructorimpl2 = Result.m8929constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m8932exceptionOrNullimpl(objM8929constructorimpl2) == null) {
            obj = objM8929constructorimpl2;
        }
    ...
    private static final Object recoverAndThrow$$forInline(Throwable exception, Continuation<?> continuation) throws Throwable {
        ...
        if (continuation2 instanceof CoroutineStackFrame) {
            throw recoverFromStackFrame(exception, (CoroutineStackFrame) continuation2);
        }
        throw exception;
    }
