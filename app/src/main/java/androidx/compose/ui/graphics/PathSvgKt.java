...
@Metadata(d1 = {"\u0000$\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a\u0012\u0010\u0000\u001a\u00020\u0001*\u00020\u00022\u0006\u0010\u0003\u001a\u00020\u0004\u001a\u0014\u0010\u0005\u001a\u00020\u0004*\u00020\u00022\b\b\u0002\u0010\u0006\u001a\u00020\u0007\u001a\u0018\u0010\b\u001a\u00020\u00042\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\nH\u0002¨\u0006\f"}, d2 = {"addSvg", "", "Landroidx/compose/ui/graphics/Path;", "pathData", "", "toSvg", "asDocument", "", "command", ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY, "Landroidx/compose/ui/graphics/PathSegment$Type;", "lastType", "ui-graphics"}, k = 2, mv = {2, 1, 0}, xi = 48)
public final class PathSvgKt {
    ...
    public static final String toSvg(Path $this$toSvg, boolean asDocument) {
        ...
        if (asDocument) {
            ...
            $this$toSvg_u24lambda_u240.append("viewBox=\"" + bounds.getLeft() + ' ' + bounds.getTop() + ' ' + (bounds.getRight() - bounds.getLeft()) + ' ' + (bounds.getBottom() - bounds.getTop()) + "\">").append('\n');
        }
        ...
        if (iterator.hasNext()) {
            if (asDocument) {
                if (PathFillType.m5605equalsimpl0($this$toSvg.mo5201getFillTypeRgk1Os(), PathFillType.INSTANCE.m5609getEvenOddRgk1Os())) {
            ...
            if (asDocument) {
                $this$toSvg_u24lambda_u240.append("\"/>").append('\n');
            }
        }
        if (asDocument) {
            $this$toSvg_u24lambda_u240.append("</svg>").append('\n');
        }
        return $this$toSvg_u24lambda_u240.toString();
    }
