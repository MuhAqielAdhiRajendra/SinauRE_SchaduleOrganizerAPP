...
public final class ArticleKt {
    ...
    public static final ImageVector getArticle(Icons.AutoMirrored.Outlined $this$Article) {
        if (_article != null) {
        ...
        ImageVector.Builder $this$_get_Article__u24lambda_u242 = new ImageVector.Builder("AutoMirrored.Outlined.Article", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
