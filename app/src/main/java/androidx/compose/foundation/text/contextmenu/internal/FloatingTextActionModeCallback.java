...
final class FloatingTextActionModeCallback extends ActionMode.Callback2 implements ActionMode.Callback {
    ...
    public void onGetContentRect(ActionMode mode, View view, Rect outRect) {
        androidx.compose.ui.geometry.Rect contentRect = this.textActionModeCallback.onGetContentRect(mode, view);
        ...
        outRect.set(iRound, iRound2, iRound3, Math.round($this$fastRoundToInt$iv4));
    }
}
