...
final class TooltipKt$TooltipBox$wrappedContent$1 implements Function2<Composer, Integer, Unit> {
    ...
    static final Unit invoke$lambda$1$lambda$0(MutableState $anchorBounds, LayoutCoordinates it) {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-23901870, $changed, -1, "androidx.compose.material3.TooltipBox.<anonymous> (Tooltip.kt:316)");
        }
        ...
        if (it$iv == Composer.INSTANCE.getEmpty()) {
            Object value$iv = new Function1() { // from class: androidx.compose.material3.TooltipKt$TooltipBox$wrappedContent$1$$ExternalSyntheticLambda0
        ...
        Modifier modifier$iv = OnGloballyPositionedModifierKt.onGloballyPositioned(companion, (Function1) it$iv);
