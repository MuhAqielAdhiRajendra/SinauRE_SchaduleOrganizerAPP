...
public class ArrayReadWriteBuf implements ReadWriteBuf {
    ...
    public long getLong(int index) {
        ...
        int index3 = index2 + 1;
        int index4 = index3 + 1;
        long j = (((long) this.buffer[index]) & 255) | ((((long) this.buffer[index2]) & 255) << 8) | ((((long) this.buffer[index3]) & 255) << 16);
        int index5 = index4 + 1;
        long j2 = j | ((((long) this.buffer[index4]) & 255) << 24);
        int index6 = index5 + 1;
        long j3 = j2 | ((((long) this.buffer[index5]) & 255) << 32);
        int index7 = index6 + 1;
        return j3 | ((((long) this.buffer[index6]) & 255) << 40) | ((255 & ((long) this.buffer[index7])) << 48) | (((long) this.buffer[index7 + 1]) << 56);
    }
