...
final /* data */ class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo1537measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        long childConstraints;
        int maxIntrinsicWidth = measurable.maxIntrinsicWidth(Constraints.m8102getMaxHeightimpl(constraints));
        if (maxIntrinsicWidth >= Constraints.m8103getMaxWidthimpl(constraints)) {
            childConstraints = Constraints.m8092copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m8105getMinWidthimpl(constraints) : 0, (11 & 2) != 0 ? Constraints.m8103getMaxWidthimpl(constraints) : Integer.MAX_VALUE, (11 & 4) != 0 ? Constraints.m8104getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m8102getMaxHeightimpl(constraints) : 0);
        } else {
        ...
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, width, placeable.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return HorizontalScrollLayoutModifier.measure_3p2s80s$lambda$0(this.f$0, $this$measure_u2d3p2s80s, placeable, width, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }

    static final Unit measure_3p2s80s$lambda$0(HorizontalScrollLayoutModifier this$0, MeasureScope $this_measure, Placeable $placeable, int $width, Placeable.PlacementScope $this$layout) {
        ...
        TextLayoutResultProxy textLayoutResultProxyInvoke = this$0.textLayoutResultProvider.invoke();
        Rect cursorRect = TextFieldScrollKt.getCursorRectInScroller(placementScope, i, transformedText, textLayoutResultProxyInvoke != null ? textLayoutResultProxyInvoke.getValue() : null, $this_measure.getLayoutDirection() == LayoutDirection.Rtl, $placeable.getWidth());
