...
public final class VectorPath extends VectorNode {
    ...
    private VectorPath(String name, List<? extends PathNode> list, int pathFillType, Brush fill, float fillAlpha, Brush stroke, float strokeAlpha, float strokeLineWidth, int strokeLineCap, int strokeLineJoin, float strokeLineMiter, float trimPathStart, float trimPathEnd, float trimPathOffset) {
        super(null);
        this.name = name;
        this.pathData = list;
    ...
    public boolean equals(Object other) {
        ...
        if (!z3 || !StrokeCap.m5683equalsimpl0(this.strokeLineCap, ((VectorPath) other).strokeLineCap) || !StrokeJoin.m5693equalsimpl0(this.strokeLineJoin, ((VectorPath) other).strokeLineJoin)) {
            return false;
        }
        ...
        if (z7 && PathFillType.m5605equalsimpl0(this.pathFillType, ((VectorPath) other).pathFillType) && Intrinsics.areEqual(this.pathData, ((VectorPath) other).pathData)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((((((((((((((((result3 + (brush2 != null ? brush2.hashCode() : 0)) * 31) + Float.hashCode(this.strokeAlpha)) * 31) + Float.hashCode(this.strokeLineWidth)) * 31) + StrokeCap.m5684hashCodeimpl(this.strokeLineCap)) * 31) + StrokeJoin.m5694hashCodeimpl(this.strokeLineJoin)) * 31) + Float.hashCode(this.strokeLineMiter)) * 31) + Float.hashCode(this.trimPathStart)) * 31) + Float.hashCode(this.trimPathEnd)) * 31) + Float.hashCode(this.trimPathOffset)) * 31) + PathFillType.m5606hashCodeimpl(this.pathFillType);
    }
}
