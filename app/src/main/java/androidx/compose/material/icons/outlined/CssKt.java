...
public final class CssKt {
    ...
    public static final ImageVector getCss(Icons.Outlined $this$Css) {
        if (_css != null) {
        ...
        ImageVector.Builder $this$_get_Css__u24lambda_u241 = new ImageVector.Builder("Outlined.Css", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
