...
public class MaterialToolbar extends Toolbar {
    ...
    public MaterialToolbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        ShapeAppearanceModel shapeAppearance = ShapeAppearanceModel.builder(context2, attrs, defStyleAttr, DEF_STYLE_RES).build();
        initBackground(context2, shapeAppearance);
    }
