...
public final class FlakyKt {
    ...
    public static final ImageVector getFlaky(Icons.Filled $this$Flaky) {
        if (_flaky != null) {
        ...
        ImageVector.Builder $this$_get_Flaky__u24lambda_u241 = new ImageVector.Builder("Filled.Flaky", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
