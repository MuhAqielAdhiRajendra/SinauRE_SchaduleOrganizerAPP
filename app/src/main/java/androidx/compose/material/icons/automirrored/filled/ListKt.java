...
public final class ListKt {
    ...
    public static final ImageVector getList(Icons.AutoMirrored.Filled $this$List) {
        if (_list != null) {
        ...
        ImageVector.Builder $this$_get_List__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Filled.List", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
