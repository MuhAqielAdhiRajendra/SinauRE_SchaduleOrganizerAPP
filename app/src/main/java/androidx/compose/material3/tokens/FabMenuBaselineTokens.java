...
/* JADX INFO: compiled from: FabMenuBaselineTokens.kt */
...
public final class FabMenuBaselineTokens {
    ...
    private static final float CloseButtonBetweenSpace = Dp.m8150constructorimpl((float) 8.0d);
    private static final float CloseButtonContainerElevation = ElevationTokens.INSTANCE.m3807getLevel3D9Ej5fM();
    private static final float CloseButtonContainerHeight = Dp.m8150constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens CloseButtonContainerShape = ShapeKeyTokens.CornerFull;
    private static final float CloseButtonContainerWidth = Dp.m8150constructorimpl((float) 56.0d);
    private static final float CloseButtonIconSize = Dp.m8150constructorimpl((float) 20.0d);
    private static final float ListItemBetweenSpace = Dp.m8150constructorimpl((float) 4.0d);
    private static final float ListItemContainerElevation = ElevationTokens.INSTANCE.m3807getLevel3D9Ej5fM();
    private static final float ListItemContainerHeight = Dp.m8150constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens ListItemContainerShape = ShapeKeyTokens.CornerFull;
    private static final float ListItemIconLabelSpace = Dp.m8150constructorimpl((float) 8.0d);
    private static final float ListItemIconSize = Dp.m8150constructorimpl((float) 24.0d);
    private static final float ListItemLeadingSpace = Dp.m8150constructorimpl((float) 24.0d);
    private static final float ListItemTrailingSpace = Dp.m8150constructorimpl((float) 24.0d);

    private FabMenuBaselineTokens() {
    }

    /* JADX INFO: renamed from: getCloseButtonBetweenSpace-D9Ej5fM, reason: not valid java name */
    public final float m3844getCloseButtonBetweenSpaceD9Ej5fM() {
        return CloseButtonBetweenSpace;
    }

    /* JADX INFO: renamed from: getCloseButtonContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m3845getCloseButtonContainerElevationD9Ej5fM() {
    ...
    public final float m3846getCloseButtonContainerHeightD9Ej5fM() {
