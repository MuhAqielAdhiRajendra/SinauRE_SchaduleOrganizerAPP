...
public final class _360Kt {
    ...
    @Deprecated(message = "Use the AutoMirrored version at Icons.AutoMirrored.Sharp._360", replaceWith = @ReplaceWith(expression = "Icons.AutoMirrored.Sharp._360", imports = {"androidx.compose.material.icons.automirrored.sharp._360"}))
    public static /* synthetic */ void get_360$annotations(Icons.Sharp sharp) {
    }

    public static final ImageVector get_360(Icons.Sharp $this$_360) {
        if (__360 != null) {
        ...
        ImageVector.Builder $this$_get__360__u24lambda_u241 = new ImageVector.Builder("Sharp._360", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
