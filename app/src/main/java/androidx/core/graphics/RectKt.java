...
public final class RectKt {
    ...
    public static final Region minus(Rect $this$minus, Rect r) {
        Region $this$minus_u24lambda_u240 = new Region($this$minus);
        $this$minus_u24lambda_u240.op(r, Region.Op.DIFFERENCE);
    ...
    public static final Region minus(RectF $this$minus, RectF r) {
        ...
        Region $this$minus_u24lambda_u241 = new Region(r$iv);
        Rect r$iv2 = new Rect();
        r.roundOut(r$iv2);
        $this$minus_u24lambda_u241.op(r$iv2, Region.Op.DIFFERENCE);
        return $this$minus_u24lambda_u241;
    }

    public static final Rect minus(Rect $this$minus, int xy) {
        Rect $this$minus_u24lambda_u242 = new Rect($this$minus);
        $this$minus_u24lambda_u242.offset(-xy, -xy);
        return $this$minus_u24lambda_u242;
    }

    public static final RectF minus(RectF $this$minus, float xy) {
        RectF $this$minus_u24lambda_u243 = new RectF($this$minus);
        $this$minus_u24lambda_u243.offset(-xy, -xy);
        return $this$minus_u24lambda_u243;
    }

    public static final Rect minus(Rect $this$minus, Point xy) {
        Rect $this$minus_u24lambda_u244 = new Rect($this$minus);
        $this$minus_u24lambda_u244.offset(-xy.x, -xy.y);
        return $this$minus_u24lambda_u244;
    }

    public static final RectF minus(RectF $this$minus, PointF xy) {
        RectF $this$minus_u24lambda_u245 = new RectF($this$minus);
        $this$minus_u24lambda_u245.offset(-xy.x, -xy.y);
        return $this$minus_u24lambda_u245;
    }

    public static final Rect times(Rect $this$times, int factor) {
        Rect $this$times_u24lambda_u240 = new Rect($this$times);
        $this$times_u24lambda_u240.top *= factor;
        $this$times_u24lambda_u240.left *= factor;
        $this$times_u24lambda_u240.right *= factor;
        $this$times_u24lambda_u240.bottom *= factor;
        return $this$times_u24lambda_u240;
    }

    public static final RectF times(RectF $this$times, int factor) {
        float factor$iv = factor;
        RectF $this$times_u24lambda_u241$iv = new RectF($this$times);
        $this$times_u24lambda_u241$iv.top *= factor$iv;
        $this$times_u24lambda_u241$iv.left *= factor$iv;
        $this$times_u24lambda_u241$iv.right *= factor$iv;
        $this$times_u24lambda_u241$iv.bottom *= factor$iv;
        return $this$times_u24lambda_u241$iv;
    }

    public static final RectF times(RectF $this$times, float factor) {
        RectF $this$times_u24lambda_u241 = new RectF($this$times);
        $this$times_u24lambda_u241.top *= factor;
        $this$times_u24lambda_u241.left *= factor;
        $this$times_u24lambda_u241.right *= factor;
        $this$times_u24lambda_u241.bottom *= factor;
        return $this$times_u24lambda_u241;
    }
    ...
    public static final Rect and(Rect $this$and, Rect r) {
        Rect $this$and_u24lambda_u240 = new Rect($this$and);
        $this$and_u24lambda_u240.intersect(r);
        return $this$and_u24lambda_u240;
    }

    public static final RectF and(RectF $this$and, RectF r) {
        RectF $this$and_u24lambda_u241 = new RectF($this$and);
        $this$and_u24lambda_u241.intersect(r);
        return $this$and_u24lambda_u241;
    }

    public static final Region xor(Rect $this$xor, Rect r) {
        Region $this$xor_u24lambda_u240 = new Region($this$xor);
        $this$xor_u24lambda_u240.op(r, Region.Op.XOR);
    ...
    public static final Region xor(RectF $this$xor, RectF r) {
        ...
        Region $this$xor_u24lambda_u241 = new Region(r$iv);
        Rect r$iv2 = new Rect();
        r.roundOut(r$iv2);
        $this$xor_u24lambda_u241.op(r$iv2, Region.Op.XOR);
        return $this$xor_u24lambda_u241;
    }
