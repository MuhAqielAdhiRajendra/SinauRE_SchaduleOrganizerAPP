...
public final class TimePickerColors {
    ...
    public static /* synthetic */ TimePickerColors m3160copydVHXu7A$default(TimePickerColors timePickerColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, long j14, int i, Object obj) {
        long j15;
        long j16;
        ...
        return timePickerColors.m3162copydVHXu7A(j24, j18, j19, j20, j21, j22, j23, j25, j26, j27, j28, j29, j15, j16);
    }

    /* JADX INFO: renamed from: copy-dVHXu7A, reason: not valid java name */
    public final TimePickerColors m3162copydVHXu7A(long clockDialColor, long selectorColor, long containerColor, long periodSelectorBorderColor, long clockDialSelectedContentColor, long clockDialUnselectedContentColor, long periodSelectorSelectedContainerColor, long periodSelectorUnselectedContainerColor, long periodSelectorSelectedContentColor, long periodSelectorUnselectedContentColor, long timeSelectorSelectedContainerColor, long timeSelectorUnselectedContainerColor, long timeSelectorSelectedContentColor, long timeSelectorUnselectedContentColor) {
        long j;
        long j2;
        long j3;
        long j4;
    ...
    public final long m3177periodSelectorContainerColorvNxB06k$material3(boolean selected) {
        if (selected) {
            return this.periodSelectorSelectedContainerColor;
        }
        return this.periodSelectorUnselectedContainerColor;
    ...
    public final long m3178periodSelectorContentColorvNxB06k$material3(boolean selected) {
        if (selected) {
            return this.periodSelectorSelectedContentColor;
        }
        return this.periodSelectorUnselectedContentColor;
    ...
    public final long m3179timeSelectorContainerColorvNxB06k$material3(boolean selected) {
        if (selected) {
            return this.timeSelectorSelectedContainerColor;
        }
        return this.timeSelectorUnselectedContainerColor;
    ...
    public final long m3180timeSelectorContentColorvNxB06k$material3(boolean selected) {
        if (selected) {
            return this.timeSelectorSelectedContentColor;
        }
        return this.timeSelectorUnselectedContentColor;
    ...
    public final long m3161clockDialContentColorvNxB06k$material3(boolean selected) {
        if (selected) {
            return this.clockDialSelectedContentColor;
        }
        return this.clockDialUnselectedContentColor;
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m5314equalsimpl0(this.clockDialColor, ((TimePickerColors) other).clockDialColor) && Color.m5314equalsimpl0(this.selectorColor, ((TimePickerColors) other).selectorColor) && Color.m5314equalsimpl0(this.containerColor, ((TimePickerColors) other).containerColor) && Color.m5314equalsimpl0(this.periodSelectorBorderColor, ((TimePickerColors) other).periodSelectorBorderColor) && Color.m5314equalsimpl0(this.periodSelectorSelectedContainerColor, ((TimePickerColors) other).periodSelectorSelectedContainerColor) && Color.m5314equalsimpl0(this.periodSelectorUnselectedContainerColor, ((TimePickerColors) other).periodSelectorUnselectedContainerColor) && Color.m5314equalsimpl0(this.periodSelectorSelectedContentColor, ((TimePickerColors) other).periodSelectorSelectedContentColor) && Color.m5314equalsimpl0(this.periodSelectorUnselectedContentColor, ((TimePickerColors) other).periodSelectorUnselectedContentColor) && Color.m5314equalsimpl0(this.timeSelectorSelectedContainerColor, ((TimePickerColors) other).timeSelectorSelectedContainerColor) && Color.m5314equalsimpl0(this.timeSelectorUnselectedContainerColor, ((TimePickerColors) other).timeSelectorUnselectedContainerColor) && Color.m5314equalsimpl0(this.timeSelectorSelectedContentColor, ((TimePickerColors) other).timeSelectorSelectedContentColor) && Color.m5314equalsimpl0(this.timeSelectorUnselectedContentColor, ((TimePickerColors) other).timeSelectorUnselectedContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m5320hashCodeimpl(this.clockDialColor);
        return (((((((((((((((((((((result * 31) + Color.m5320hashCodeimpl(this.selectorColor)) * 31) + Color.m5320hashCodeimpl(this.containerColor)) * 31) + Color.m5320hashCodeimpl(this.periodSelectorBorderColor)) * 31) + Color.m5320hashCodeimpl(this.periodSelectorSelectedContainerColor)) * 31) + Color.m5320hashCodeimpl(this.periodSelectorUnselectedContainerColor)) * 31) + Color.m5320hashCodeimpl(this.periodSelectorSelectedContentColor)) * 31) + Color.m5320hashCodeimpl(this.periodSelectorUnselectedContentColor)) * 31) + Color.m5320hashCodeimpl(this.timeSelectorSelectedContainerColor)) * 31) + Color.m5320hashCodeimpl(this.timeSelectorUnselectedContainerColor)) * 31) + Color.m5320hashCodeimpl(this.timeSelectorSelectedContentColor)) * 31) + Color.m5320hashCodeimpl(this.timeSelectorUnselectedContentColor);
    }
}
