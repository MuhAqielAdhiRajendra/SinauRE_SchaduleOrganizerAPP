...
public final class LazyStaggeredGridBeyondBoundsState implements LazyLayoutBeyondBoundsState {
    ...
    public int itemsPerViewport() {
        ...
        int viewportSize = LazyStaggeredGridMeasureResultKt.getSingleAxisViewportSize(this.state.getLayoutInfo());
        int lineAverageSize = LazyStaggeredGridMeasureResultKt.visibleItemsAverageSize(this.state.getLayoutInfo());
