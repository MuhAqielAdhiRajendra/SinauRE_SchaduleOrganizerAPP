...
public final class InnerShadowPainter extends Painter {
    ...
    public InnerShadowPainter(Shape shape, Shadow shadow, InnerShadowRendererProvider renderCreator) {
        this.shape = shape;
        this.shadow = shadow;
    ...
    protected void onDraw(DrawScope $this$onDraw) {
        InnerShadowRenderer renderer = this.renderCreator.mo6015obtainInnerShadowRenderereZhPAX0(this.shape, $this$onDraw.mo5887getSizeNHjbRc(), $this$onDraw.getLayoutDirection(), $this$onDraw, this.shadow);
        renderer.m6036drawShadowerFMhIw($this$onDraw, this.colorFilter, $this$onDraw.mo5887getSizeNHjbRc(), this.shadow.getColor(), this.shadow.getBrush(), RangesKt.coerceIn(this.alpha * this.shadow.getAlpha(), 0.0f, 1.0f), this.shadow.getBlendMode());
    }
