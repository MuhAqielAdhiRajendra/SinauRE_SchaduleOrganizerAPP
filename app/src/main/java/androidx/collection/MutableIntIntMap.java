...
public final class MutableIntIntMap extends IntIntMap {
    ...
    public final void removeIf(Function2<? super Integer, ? super Integer, Boolean> predicate) {
        ...
        int $i$f$removeIf3 = 0;
        MutableIntIntMap this_$iv = this;
            ...
            if ($this$maskEmptyOrDeleted$iv$iv == -9187201950435737472L) {
                ...
                while (j$iv < bitCount$iv) {
                    ...
                    if (!(value$iv$iv < 128)) {
                        ...
                        i = i2;
                        $i$f$removeIf2 = $i$f$removeIf3;
                        if (predicate.invoke(Integer.valueOf(this.keys[index$iv]), Integer.valueOf(this.values[index$iv])).booleanValue()) {
    ...
    */
    ...
    public final void dropDeletes$collection() {
        ...
        long[] metadata = mutableIntIntMap.metadata;
        int capacity = mutableIntIntMap._capacity;
        int[] keys = mutableIntIntMap.keys;
        int[] values = mutableIntIntMap.values;
        ...
        while (index != capacity) {
            ...
            if (m == 128) {
                ...
                int $i$f$h1 = k$iv >>> 7;
                int i = hash1;
                int targetIndex = mutableIntIntMap.findFirstAvailableSlot($i$f$h1);
    ...
    public final void resizeStorage$collection(int newCapacity) {
        ...
        long[] newMetadata = mutableIntIntMap.metadata;
        ...
        while (i < previousCapacity) {
            if (!(((previousMetadata2[i >> 3] >> ((i & 7) << 3)) & 255) < 128)) {
                ...
                int index = mutableIntIntMap.findFirstAvailableSlot($i$f$h1);
