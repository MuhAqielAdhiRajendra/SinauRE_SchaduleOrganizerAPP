...
@Metadata(d1 = {"\u0000\u001c\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\u0018\u0002\n\u0000\u001a\u001c\u0010\u0000\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00020\u00010\u00012\u0006\u0010\u0003\u001a\u00020\u0004H\u0000\u001a\f\u0010\u0005\u001a\u00020\u0006*\u00020\u0007H\u0002¨\u0006\b"}, d2 = {"getChildrenOfVirtualChildren", "", "Landroidx/compose/ui/layout/Measurable;", "scope", "Landroidx/compose/ui/layout/IntrinsicMeasureScope;", "isInLookaheadPass", "", "Landroidx/compose/ui/node/LayoutNode;", "ui"}, k = 2, mv = {2, 1, 0}, xi = 48)
public final class MeasureScopeWithLayoutNodeKt {
    ...
    public static final List<List<Measurable>> getChildrenOfVirtualChildren(IntrinsicMeasureScope scope) {
        Intrinsics.checkNotNull(scope, "null cannot be cast to non-null type androidx.compose.ui.node.MeasureScopeWithLayoutNode");
        ...
        List target$iv = new ArrayList(foldedChildren$ui.size());
        int size = foldedChildren$ui.size();
        for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
            Object item$iv$iv = foldedChildren$ui.get(index$iv$iv);
            LayoutNode it = (LayoutNode) item$iv$iv;
            target$iv.add(lookahead ? it.getChildLookaheadMeasurables$ui() : it.getChildMeasurables$ui());
        }
    ...
    private static final boolean isInLookaheadPass(LayoutNode $this$isInLookaheadPass) {
        switch (WhenMappings.$EnumSwitchMapping$0[$this$isInLookaheadPass.getLayoutState$ui().ordinal()]) {
            case 1:
            case 2:
                return true;
            case 3:
            case 4:
                return false;
            case 5:
                LayoutNode parent$ui = $this$isInLookaheadPass.getParent$ui();
                if (parent$ui != null) {
