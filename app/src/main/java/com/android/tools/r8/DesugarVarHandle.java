...
public final /* synthetic */ class DesugarVarHandle {
    ...
    public /* synthetic */ long m8651get(Object obj) {
        if (this.type == Long.TYPE) {
            return U.getLong(obj, this.offset);
        }
        return this.type == Integer.TYPE ? U.getInt(obj, r2) : toLongIfPossible(U.getObject(obj, this.offset), true);
    }
    ...
    /* JADX INFO: renamed from: get, reason: collision with other method in class */
    public /* synthetic */ Object m8652get(Object obj) {
        if (this.type == Integer.TYPE) {
    ...
    public /* synthetic */ long m8653getVolatile(Object obj) {
        if (this.type == Long.TYPE) {
            return U.getLongVolatile(obj, this.offset);
        }
        return this.type == Integer.TYPE ? U.getIntVolatile(obj, r2) : toLongIfPossible(U.getObjectVolatile(obj, this.offset), true);
    }
    ...
    /* JADX INFO: renamed from: getVolatile, reason: collision with other method in class */
    public /* synthetic */ Object m8654getVolatile(Object obj) {
        if (this.type == Integer.TYPE) {
