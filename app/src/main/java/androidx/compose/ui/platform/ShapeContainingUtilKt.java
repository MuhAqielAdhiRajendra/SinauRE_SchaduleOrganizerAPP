...
public final class ShapeContainingUtilKt {
    ...
    private static final boolean isInRoundedRect(Outline.Rounded outline, float x, float y, Path touchPointPath, Path opPath) {
        ...
        long arg0$iv = rrect.m5118getTopLeftCornerRadiuskKHJgLs();
        int bits$iv$iv$iv = (int) (arg0$iv >> 32);
        float topLeftX = left + Float.intBitsToFloat(bits$iv$iv$iv);
        float top = rrect.getTop();
        long arg0$iv2 = rrect.m5118getTopLeftCornerRadiuskKHJgLs();
        ...
        long arg0$iv5 = rrect.m5117getBottomRightCornerRadiuskKHJgLs();
        ...
        long arg0$iv6 = rrect.m5117getBottomRightCornerRadiuskKHJgLs();
        ...
        long arg0$iv7 = rrect.m5116getBottomLeftCornerRadiuskKHJgLs();
        ...
        long arg0$iv8 = rrect.m5116getBottomLeftCornerRadiuskKHJgLs();
        int bits$iv$iv$iv8 = (int) (arg0$iv8 >> 32);
        float bottomLeftY = left2 + Float.intBitsToFloat(bits$iv$iv$iv8);
        if (x < topLeftX && y < topLeftY) {
            return m7320isWithinEllipseVE1yxkc(x, y, rrect.m5118getTopLeftCornerRadiuskKHJgLs(), topLeftX, topLeftY);
        }
        if (x < bottomLeftY && y > bottomLeftX) {
            return m7320isWithinEllipseVE1yxkc(x, y, rrect.m5116getBottomLeftCornerRadiuskKHJgLs(), bottomLeftY, bottomLeftX);
        }
        if (x > topRightX && y < topRightY) {
            return m7320isWithinEllipseVE1yxkc(x, y, rrect.m5119getTopRightCornerRadiuskKHJgLs(), topRightX, topRightY);
        }
        if (x > bottomRightX && y > bottomRightY) {
            return m7320isWithinEllipseVE1yxkc(x, y, rrect.m5117getBottomRightCornerRadiuskKHJgLs(), bottomRightX, bottomRightY);
        }
        return true;
    }

    private static final boolean cornersFit(RoundRect $this$cornersFit) {
        long arg0$iv = $this$cornersFit.m5118getTopLeftCornerRadiuskKHJgLs();
        int bits$iv$iv$iv = (int) (arg0$iv >> 32);
        float fIntBitsToFloat = Float.intBitsToFloat(bits$iv$iv$iv);
        long arg0$iv2 = $this$cornersFit.m5119getTopRightCornerRadiuskKHJgLs();
        int bits$iv$iv$iv2 = (int) (arg0$iv2 >> 32);
        if (fIntBitsToFloat + Float.intBitsToFloat(bits$iv$iv$iv2) <= $this$cornersFit.getWidth()) {
            long arg0$iv3 = $this$cornersFit.m5116getBottomLeftCornerRadiuskKHJgLs();
            int bits$iv$iv$iv3 = (int) (arg0$iv3 >> 32);
            float fIntBitsToFloat2 = Float.intBitsToFloat(bits$iv$iv$iv3);
            long arg0$iv4 = $this$cornersFit.m5117getBottomRightCornerRadiuskKHJgLs();
            int bits$iv$iv$iv4 = (int) (arg0$iv4 >> 32);
            if (fIntBitsToFloat2 + Float.intBitsToFloat(bits$iv$iv$iv4) <= $this$cornersFit.getWidth()) {
                long arg0$iv5 = $this$cornersFit.m5118getTopLeftCornerRadiuskKHJgLs();
                int bits$iv$iv$iv5 = (int) (arg0$iv5 & 4294967295L);
                float fIntBitsToFloat3 = Float.intBitsToFloat(bits$iv$iv$iv5);
                long arg0$iv6 = $this$cornersFit.m5116getBottomLeftCornerRadiuskKHJgLs();
                int bits$iv$iv$iv6 = (int) (arg0$iv6 & 4294967295L);
                if (fIntBitsToFloat3 + Float.intBitsToFloat(bits$iv$iv$iv6) <= $this$cornersFit.getHeight()) {
                    long arg0$iv7 = $this$cornersFit.m5119getTopRightCornerRadiuskKHJgLs();
                    int bits$iv$iv$iv7 = (int) (arg0$iv7 & 4294967295L);
                    float fIntBitsToFloat4 = Float.intBitsToFloat(bits$iv$iv$iv7);
                    long arg0$iv8 = $this$cornersFit.m5117getBottomRightCornerRadiuskKHJgLs();
                    int bits$iv$iv$iv8 = (int) (4294967295L & arg0$iv8);
                    if (fIntBitsToFloat4 + Float.intBitsToFloat(bits$iv$iv$iv8) <= $this$cornersFit.getHeight()) {
                        return true;
                    }
                }
            }
    ...
    private static final boolean m7320isWithinEllipseVE1yxkc(float x, float y, long cornerRadius, float centerX, float centerY) {
        float px = x - centerX;
        float py = y - centerY;
    ...
    private static final boolean isInPath(Path path, float x, float y, Path tmpTouchPointPath, Path tmpOpPath) {
        ...
        opPath.mo5202opN5in7k0(path, touchPointPath, PathOperation.INSTANCE.m5620getIntersectb3I0S0c());
