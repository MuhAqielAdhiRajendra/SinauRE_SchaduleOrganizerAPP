...
public interface DeviceRenderNode {
    ...
    int mo7262getCompositingStrategyNrFUSI();
    ...
    void mo7263setBlendModes9anfk8(int i);
    ...
    void mo7264setCompositingStrategyaDBOjCE(int i);
