...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame, Waiter {
    ...
    private final DisposableHandle installParentHandle() {
        ...
        DisposableHandle handle = JobKt__JobKt.invokeOnCompletion$default(parent, false, new ChildContinuation(this), 1, null);
    ...
    static final Unit resume$lambda$13$lambda$12(Function1 $onCancellation, Throwable cause, Object obj, CoroutineContext coroutineContext) {
    ...
    public void resume(T value, final Function1<? super Throwable, Unit> onCancellation) {
        resumeImpl$kotlinx_coroutines_core(value, this.resumeMode, onCancellation != null ? new Function3() { // from class: kotlinx.coroutines.CancellableContinuationImpl$$ExternalSyntheticLambda1
        ...
        while (true) {
            ...
            if (state instanceof NotCompleted) {
                ...
                if ((state instanceof CancelledContinuation) && ((CancelledContinuation) state).makeResumed()) {
                    if (function32 != null) {
                        callOnCancellation(function32, ((CancelledContinuation) state).cause, r2);
                        return;
                    }
                    return;
                }
