...
public final class WrapTextKt {
    ...
    public static final ImageVector getWrapText(Icons.AutoMirrored.Outlined $this$WrapText) {
        if (_wrapText != null) {
        ...
        ImageVector.Builder $this$_get_WrapText__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Outlined.WrapText", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
