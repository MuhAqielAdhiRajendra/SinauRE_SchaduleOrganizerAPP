...
public final class IceSkatingKt {
    ...
    public static final ImageVector getIceSkating(Icons.Sharp $this$IceSkating) {
        if (_iceSkating != null) {
        ...
        ImageVector.Builder $this$_get_IceSkating__u24lambda_u241 = new ImageVector.Builder("Sharp.IceSkating", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
