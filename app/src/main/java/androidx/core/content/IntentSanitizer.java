...
public class IntentSanitizer {
    ...
    public Intent sanitize(Intent in, Consumer<String> penalty) {
        ...
        sanitizeClipData(in, intent, this.mAllowedClipData, this.mAllowClipDataText, this.mAllowedClipDataUri, penalty);
    ...
    public static final class Builder {
        ...
        private boolean mAllowSourceBounds;
        private int mAllowedFlags;
        private Predicate<String> mAllowedActions = new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda1
        ...
        private Predicate<String> mAllowedTypes = new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda3
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return IntentSanitizer.Builder.lambda$new$2((String) obj);
            }
        };
        private Predicate<String> mAllowedCategories = new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda4
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return IntentSanitizer.Builder.lambda$new$3((String) obj);
            }
        };
        private Predicate<String> mAllowedPackages = new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda5
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return IntentSanitizer.Builder.lambda$new$4((String) obj);
            }
        };
        private Predicate<ComponentName> mAllowedComponents = new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda6
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
        ...
        private Predicate<Uri> mAllowedClipDataUri = new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda7
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return IntentSanitizer.Builder.lambda$new$6((Uri) obj);
            }
        };
        private Predicate<ClipData> mAllowedClipData = new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda8
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
        ...
        public Builder allowAction(String action) {
            ...
            allowAction(new IntentSanitizer$Builder$$ExternalSyntheticLambda10(action));
            return this;
        }
        ...
        public Builder allowDataWithAuthority(final String authority) {
            ...
            allowData(new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda12
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
                    return authority.equals(((Uri) obj).getAuthority());
                }
            });
            return this;
        }
        ...
        public Builder allowType(String type) {
            ...
            return allowType(new IntentSanitizer$Builder$$ExternalSyntheticLambda10(type));
        }
        ...
        public Builder allowCategory(String category) {
            ...
            return allowCategory(new IntentSanitizer$Builder$$ExternalSyntheticLambda10(category));
        }
        ...
        public Builder allowPackage(String packageName) {
            ...
            return allowPackage(new IntentSanitizer$Builder$$ExternalSyntheticLambda10(packageName));
        }
        ...
        public Builder allowComponent(final ComponentName component) {
            ...
            return allowComponent(new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda14
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
                    return component.equals((ComponentName) obj);
                }
            });
        }
        ...
        public Builder allowComponentWithPackage(final String packageName) {
            ...
            return allowComponent(new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda11
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
                    return packageName.equals(((ComponentName) obj).getPackageName());
                }
            });
        }
        ...
        public Builder allowExtra(String key, Class<?> clazz) {
            return allowExtra(key, clazz, new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda9
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public <T> Builder allowExtra(String key, final Class<T> clazz, final Predicate<T> valueFilter) {
            ...
            return allowExtra(key, new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda13
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public Builder allowExtra(String key, Predicate<Object> filter) {
            ...
            if (allowedExtra == null) {
                allowedExtra = new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda17
                    @Override // androidx.core.util.Predicate
                    public final boolean test(Object obj) {
        ...
        public Builder allowExtraStreamUriWithAuthority(final String uriAuthority) {
            ...
            allowExtra("android.intent.extra.STREAM", Uri.class, new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda18
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
                    return uriAuthority.equals(((Uri) obj).getAuthority());
                }
            });
            return this;
        }
