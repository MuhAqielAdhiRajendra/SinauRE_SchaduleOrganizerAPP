...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mOnClickListener = new View.OnClickListener() { // from class: androidx.appcompat.widget.SearchView.5
            ...
            public void onClick(View v) {
                ...
                } else if (v == searchView4.mSearchSrcTextView) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, androidx.appcompat.R.styleable.SearchView, defStyleAttr, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, androidx.appcompat.R.styleable.SearchView, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        LayoutInflater inflater = LayoutInflater.from(context);
        int layoutResId = a.getResourceId(androidx.appcompat.R.styleable.SearchView_layout, androidx.appcompat.R.layout.abc_search_view);
        inflater.inflate(layoutResId, (ViewGroup) this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(androidx.appcompat.R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(androidx.appcompat.R.id.search_edit_frame);
        this.mSearchPlate = findViewById(androidx.appcompat.R.id.search_plate);
        this.mSubmitArea = findViewById(androidx.appcompat.R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(androidx.appcompat.R.id.search_button);
        this.mGoButton = (ImageView) findViewById(androidx.appcompat.R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(androidx.appcompat.R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(androidx.appcompat.R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(androidx.appcompat.R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(androidx.appcompat.R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(androidx.appcompat.R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(androidx.appcompat.R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(androidx.appcompat.R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(androidx.appcompat.R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(androidx.appcompat.R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(androidx.appcompat.R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(androidx.appcompat.R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(androidx.appcompat.R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = a.getResourceId(androidx.appcompat.R.styleable.SearchView_suggestionRowLayout, androidx.appcompat.R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(androidx.appcompat.R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(a.getBoolean(androidx.appcompat.R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(androidx.appcompat.R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(androidx.appcompat.R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(androidx.appcompat.R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(androidx.appcompat.R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(androidx.appcompat.R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        boolean focusable = a.getBoolean(androidx.appcompat.R.styleable.SearchView_android_focusable, true);
        setFocusable(focusable);
        a.recycle();
        this.mVoiceWebSearchIntent = new Intent("android.speech.action.WEB_SEARCH");
        this.mVoiceWebSearchIntent.addFlags(GroupFlagsKt.IsMovableContentFlag);
        this.mVoiceWebSearchIntent.putExtra("android.speech.extra.LANGUAGE_MODEL", "web_search");
        this.mVoiceAppSearchIntent = new Intent("android.speech.action.RECOGNIZE_SPEECH");
        this.mVoiceAppSearchIntent.addFlags(GroupFlagsKt.IsMovableContentFlag);
    ...
    protected void onQueryRefine(CharSequence queryText) {
        setQuery(queryText);
    }
    ...
    public void onActionViewExpanded() {
        ...
        this.mSearchSrcTextView.setImeOptions(this.mCollapsedImeOptions | GroupFlagsKt.HasAuxSlotFlag);
        this.mSearchSrcTextView.setText("");
        setIconified(false);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            if (this.mIconifiedByDefault) {
                iconOffset = res.getDimensionPixelSize(androidx.appcompat.R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(androidx.appcompat.R.dimen.abc_dropdownitem_text_padding_left);
            } else {
                iconOffset = 0;
            }
    ...
    private Intent createIntentFromSuggestion(Cursor c, int actionKey, String actionMsg) {
        ...
        String id;
        try {
            String action2 = SuggestionsAdapter.getColumnString(c, "suggest_intent_action");
            if (action2 == null) {
                try {
                    action2 = this.mSearchable.getSuggestIntentAction();
                    ...
                    Log.w(LOG_TAG, "Search suggestions cursor at row " + rowNum + " returned exception.", e2);
                    return null;
                }
            }
            if (action2 != null) {
            ...
            dataUri = data == null ? null : Uri.parse(data);
            query = SuggestionsAdapter.getColumnString(c, "suggest_intent_query");
            extraData = SuggestionsAdapter.getColumnString(c, "suggest_intent_extra_data");
        ...
        try {
            ...
            e = e5;
            RuntimeException e22 = e;
            rowNum = c.getPosition();
            Log.w(LOG_TAG, "Search suggestions cursor at row " + rowNum + " returned exception.", e22);
            return null;
        }
    }
    ...
    void forceSuggestionQuery() {
        ...
        if (i >= 29) {
            ...
            PRE_API_29_HIDDEN_METHOD_INVOKER.doBeforeTextChanged(searchAutoComplete);
