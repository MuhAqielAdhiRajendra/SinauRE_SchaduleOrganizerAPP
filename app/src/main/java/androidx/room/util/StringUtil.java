...
public final class StringUtil {
    ...
    public static final List<Integer> splitToIntList(String input) {
        ...
        Integer numValueOf;
        if (input == null || (iterableSplit$default = StringsKt.split$default((CharSequence) input, new char[]{','}, false, 0, 6, (Object) null)) == null) {
            return null;
        }
        Iterable $this$mapNotNull$iv = iterableSplit$default;
        Collection destination$iv$iv = new ArrayList();
        for (Object element$iv$iv$iv : $this$mapNotNull$iv) {
            String item = (String) element$iv$iv$iv;
            try {
                numValueOf = Integer.valueOf(Integer.parseInt(item));
            } catch (NumberFormatException e) {
                numValueOf = null;
            }
            if (numValueOf != null) {
                destination$iv$iv.add(numValueOf);
            }
        }
