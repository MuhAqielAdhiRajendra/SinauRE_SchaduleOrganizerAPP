...
public final class PianoKt {
    ...
    public static final ImageVector getPiano(Icons.Outlined $this$Piano) {
        if (_piano != null) {
        ...
        ImageVector.Builder $this$_get_Piano__u24lambda_u241 = new ImageVector.Builder("Outlined.Piano", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
