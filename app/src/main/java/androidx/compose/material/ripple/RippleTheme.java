...
public interface RippleTheme {
    ...
    public static final class Companion {
        ...
        public final long m2137defaultRippleColor5vOe2sY(long contentColor, boolean lightTheme) {
            float contentLuminance = ColorKt.m5365luminance8_81llA(contentColor);
            if (!lightTheme && contentLuminance < 0.5d) {
                return Color.INSTANCE.m5350getWhite0d7_KjU();
            }
            return contentColor;
        }
        ...
        public final RippleAlpha m2136defaultRippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
            if (lightTheme) {
                return ((double) ColorKt.m5365luminance8_81llA(contentColor)) > 0.5d ? RippleThemeKt.LightThemeHighContrastRippleAlpha : RippleThemeKt.LightThemeLowContrastRippleAlpha;
            }
