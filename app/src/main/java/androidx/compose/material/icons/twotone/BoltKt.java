...
public final class BoltKt {
    ...
    public static final ImageVector getBolt(Icons.TwoTone $this$Bolt) {
        if (_bolt != null) {
        ...
        ImageVector.Builder $this$_get_Bolt__u24lambda_u241 = new ImageVector.Builder("TwoTone.Bolt", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
