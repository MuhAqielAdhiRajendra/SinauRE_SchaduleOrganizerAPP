...
public final class FactCheckKt {
    ...
    public static final ImageVector getFactCheck(Icons.Sharp $this$FactCheck) {
        if (_factCheck != null) {
        ...
        ImageVector.Builder $this$_get_FactCheck__u24lambda_u241 = new ImageVector.Builder("Sharp.FactCheck", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
