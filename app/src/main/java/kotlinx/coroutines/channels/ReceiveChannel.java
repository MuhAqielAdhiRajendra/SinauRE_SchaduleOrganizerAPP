...
public interface ReceiveChannel<E> {
    ...
    Object mo10442receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo10443tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo10443tryReceivePtdJZtk = receiveChannel.mo10443tryReceivePtdJZtk();
            if (ChannelResult.m10460isSuccessimpl(objMo10443tryReceivePtdJZtk)) {
                return (E) ChannelResult.m10456getOrThrowimpl(objMo10443tryReceivePtdJZtk);
            }
            Throwable thM10454exceptionOrNullimpl = ChannelResult.m10454exceptionOrNullimpl(objMo10443tryReceivePtdJZtk);
            if (thM10454exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM10454exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            ...
            L37:
                ...
                r3 = 1
                r0.label = r3
                java.lang.Object r4 = r4.mo10442receiveCatchingJP2dKIU(r0)
                if (r4 != r2) goto L44
                return r2
            L44:
