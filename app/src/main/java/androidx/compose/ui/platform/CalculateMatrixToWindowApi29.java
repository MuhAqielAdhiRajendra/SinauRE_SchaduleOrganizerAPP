...
final class CalculateMatrixToWindowApi29 implements CalculateMatrixToWindow {
    ...
    public void mo7244calculateMatrixToWindowEL8BTi8(View view, float[] matrix) {
        ...
        AndroidMatrixConversions_androidKt.m5181setFromtUYjHk(matrix, this.tmpMatrix);
    }
}
