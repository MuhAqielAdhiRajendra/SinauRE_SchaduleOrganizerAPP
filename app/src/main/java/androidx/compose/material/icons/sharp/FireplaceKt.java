...
public final class FireplaceKt {
    ...
    public static final ImageVector getFireplace(Icons.Sharp $this$Fireplace) {
        if (_fireplace != null) {
        ...
        ImageVector.Builder $this$_get_Fireplace__u24lambda_u241 = new ImageVector.Builder("Sharp.Fireplace", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
