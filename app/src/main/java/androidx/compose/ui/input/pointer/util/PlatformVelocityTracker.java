...
public interface PlatformVelocityTracker {
    ...
    void mo6746addPointerInputChangeUv8p0NA(PointerInputChange event, long offset);

    /* JADX INFO: renamed from: addPosition-Uv8p0NA */
    void mo6747addPositionUv8p0NA(long timeMillis, long position);

    /* JADX INFO: renamed from: calculateVelocity-AH228Gc */
    long mo6748calculateVelocityAH228Gc(long maximumVelocity);
