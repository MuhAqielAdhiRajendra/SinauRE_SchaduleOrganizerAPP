...
public final class UnbiasedSelectBuilderImpl<R> extends UnbiasedSelectImplementation<R> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.selects.UnbiasedSelectBuilderImpl$initSelectResult$1", f = "SelectOld.kt", i = {}, l = {ConstraintLayout.LayoutParams.Table.GUIDELINE_USE_RTL}, m = "invokeSuspend", n = {}, s = {})
                ...
                case 0:
                    ...
                    try {
                        ...
                        if (objDoSelect != coroutine_suspended) {
                            result = objDoSelect;
                            SelectOldKt.resumeUndispatched(((UnbiasedSelectBuilderImpl) anonymousClass1.this$0).cont, result);
                        ...
                        SelectOldKt.resumeUndispatchedWithException(((UnbiasedSelectBuilderImpl) anonymousClass12.this$0).cont, e);
                        return Unit.INSTANCE;
                    }
                case 1:
    ...
    public final void handleBuilderException(Throwable e) {
        ...
        cancellableContinuationImpl.resumeWith(Result.m8929constructorimpl(ResultKt.createFailure(e)));
    }
}
