...
public final class PinchKt {
    ...
    public static final ImageVector getPinch(Icons.Sharp $this$Pinch) {
        if (_pinch != null) {
        ...
        ImageVector.Builder $this$_get_Pinch__u24lambda_u241 = new ImageVector.Builder("Sharp.Pinch", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(23.18f, 15.4f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(22.1f, 23.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(-9.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(8.0f, 17.62f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(23.18f, 15.4f);
