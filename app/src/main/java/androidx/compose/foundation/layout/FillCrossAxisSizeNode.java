...
public final class FillCrossAxisSizeNode extends Modifier.Node implements ParentDataModifierNode {
    ...
    public RowColumnParentData modifyParentData(Density $this$modifyParentData, Object parentData) {
        ...
        FlowLayoutData flowLayoutData = it.getFlowLayoutData();
        if (flowLayoutData == null) {
            flowLayoutData = new FlowLayoutData(this.fraction);
        }
        it.setFlowLayoutData(flowLayoutData);
        FlowLayoutData flowLayoutData2 = it.getFlowLayoutData();
