...
public final class PredicateAdapter {
    ...
    public final <T> Object buildPredicate(KClass<T> clazz, Function1<? super T, Boolean> predicate) {
        ...
        PredicateStubHandler predicateHandler = new PredicateStubHandler(clazz, predicate);
        Object objNewProxyInstance = Proxy.newProxyInstance(this.loader, new Class[]{predicateClassOrThrow()}, predicateHandler);
    ...
    public final <T, U> Object buildPairPredicate(KClass<T> firstClazz, KClass<U> secondClazz, Function2<? super T, ? super U, Boolean> predicate) {
        ...
        Intrinsics.checkNotNullParameter(predicate, "predicate");
        PairPredicateStubHandler predicateHandler = new PairPredicateStubHandler(firstClazz, secondClazz, predicate);
        Object objNewProxyInstance = Proxy.newProxyInstance(this.loader, new Class[]{predicateClassOrThrow()}, predicateHandler);
        Intrinsics.checkNotNullExpressionValue(objNewProxyInstance, "newProxyInstance(...)");
        return objNewProxyInstance;
    }
    ...
    /* JADX INFO: compiled from: PredicateAdapter.kt */
    @Metadata(d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\t\b\"\u0018\u0000*\b\b\u0000\u0010\u0001*\u00020\u00022\u00020\u0003B\u0015\u0012\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00028\u00000\u0005¢\u0006\u0004\b\u0006\u0010\u0007J0\u0010\b\u001a\u00020\u00022\u0006\u0010\t\u001a\u00020\u00022\u0006\u0010\n\u001a\u00020\u000b2\u0010\u0010\f\u001a\f\u0012\u0006\b\u0001\u0012\u00020\u0002\u0018\u00010\rH\u0096\u0002¢\u0006\u0002\u0010\u000eJ\u001d\u0010\u000f\u001a\u00020\u00102\u0006\u0010\t\u001a\u00020\u00022\u0006\u0010\u0011\u001a\u00028\u0000H&¢\u0006\u0002\u0010\u0012J#\u0010\u0013\u001a\u00020\u0010*\u00020\u000b2\u0010\u0010\u0014\u001a\f\u0012\u0006\b\u0001\u0012\u00020\u0002\u0018\u00010\rH\u0004¢\u0006\u0002\u0010\u0015J#\u0010\u0016\u001a\u00020\u0010*\u00020\u000b2\u0010\u0010\u0014\u001a\f\u0012\u0006\b\u0001\u0012\u00020\u0002\u0018\u00010\rH\u0004¢\u0006\u0002\u0010\u0015J#\u0010\u0017\u001a\u00020\u0010*\u00020\u000b2\u0010\u0010\u0014\u001a\f\u0012\u0006\b\u0001\u0012\u00020\u0002\u0018\u00010\rH\u0004¢\u0006\u0002\u0010\u0015J#\u0010\u0018\u001a\u00020\u0010*\u00020\u000b2\u0010\u0010\u0014\u001a\f\u0012\u0006\b\u0001\u0012\u00020\u0002\u0018\u00010\rH\u0004¢\u0006\u0002\u0010\u0015R\u0014\u0010\u0004\u001a\b\u0012\u0004\u0012\u00028\u00000\u0005X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0019"}, d2 = {"Landroidx/window/core/PredicateAdapter$BaseHandler;", "T", "", "Ljava/lang/reflect/InvocationHandler;", "clazz", "Lkotlin/reflect/KClass;", "<init>", "(Lkotlin/reflect/KClass;)V", "invoke", "obj", "method", "Ljava/lang/reflect/Method;", "parameters", "", "(Ljava/lang/Object;Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;", "invokeTest", "", "parameter", "(Ljava/lang/Object;Ljava/lang/Object;)Z", "isEquals", "args", "(Ljava/lang/reflect/Method;[Ljava/lang/Object;)Z", "isHashCode", "isTest", "isToString", "window_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
    private static abstract class BaseHandler<T> implements InvocationHandler {
        ...
        public Object invoke(Object obj, Method method, Object[] parameters) {
            ...
            if (isTest(method, parameters)) {
                Object argument = KClasses.cast(this.clazz, parameters != null ? parameters[0] : null);
                return Boolean.valueOf(invokeTest(obj, argument));
            }
        ...
        protected final boolean isEquals(Method $this$isEquals, Object[] args) {
            Intrinsics.checkNotNullParameter($this$isEquals, "<this>");
            if (Intrinsics.areEqual($this$isEquals.getName(), "equals") && $this$isEquals.getReturnType().equals(Boolean.TYPE)) {
                return args != null && args.length == 1;
            }
            return false;
        }

        protected final boolean isHashCode(Method $this$isHashCode, Object[] args) {
            Intrinsics.checkNotNullParameter($this$isHashCode, "<this>");
            return Intrinsics.areEqual($this$isHashCode.getName(), "hashCode") && $this$isHashCode.getReturnType().equals(Integer.TYPE) && args == null;
        }

        protected final boolean isTest(Method $this$isTest, Object[] args) {
            Intrinsics.checkNotNullParameter($this$isTest, "<this>");
            if (Intrinsics.areEqual($this$isTest.getName(), "test") && $this$isTest.getReturnType().equals(Boolean.TYPE)) {
                return args != null && args.length == 1;
            }
            return false;
        }

        protected final boolean isToString(Method $this$isToString, Object[] args) {
            Intrinsics.checkNotNullParameter($this$isToString, "<this>");
            return Intrinsics.areEqual($this$isToString.getName(), "toString") && $this$isToString.getReturnType().equals(String.class) && args == null;
        }
    }
