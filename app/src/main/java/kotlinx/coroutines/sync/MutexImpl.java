...
public class MutexImpl extends SemaphoreAndMutexImpl implements Mutex {
    ...
    public MutexImpl(boolean z) {
        ...
        this.onSelectCancellationUnlockConstructor = new Function3() { // from class: kotlinx.coroutines.sync.MutexImpl$$ExternalSyntheticLambda2
    ...
    static final Function3 onSelectCancellationUnlockConstructor$lambda$1(final MutexImpl this$0, SelectInstance selectInstance, final Object owner, Object obj) {
        return new Function3() { // from class: kotlinx.coroutines.sync.MutexImpl$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function3
            public final Object invoke(Object obj2, Object obj3, Object obj4) {
                return MutexImpl.onSelectCancellationUnlockConstructor$lambda$1$lambda$0(this.f$0, owner, (Throwable) obj2, obj3, (CoroutineContext) obj4);
            }
        };
    }

    static final Unit onSelectCancellationUnlockConstructor$lambda$1$lambda$0(MutexImpl this$0, Object $owner, Throwable th, Object obj, CoroutineContext coroutineContext) {
        this$0.unlock($owner);
    ...
    static /* synthetic */ Object lock$suspendImpl(MutexImpl $this, Object owner, Continuation<? super Unit> continuation) {
        ...
        return (!$this.tryLock(owner) && (objLockSuspend = $this.lockSuspend(owner, continuation)) == IntrinsicsKt.getCOROUTINE_SUSPENDED()) ? objLockSuspend : Unit.INSTANCE;
    }
        ...
        while (isLocked()) {
            ...
            if (curOwner != MutexKt.NO_OWNER) {
                if (curOwner == owner || owner == null) {
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(owner$volatile$FU, this, curOwner, MutexKt.NO_OWNER)) {
                        release();
                        return;
                    }
                } else {
    ...
    final class CancellableContinuationWithOwner implements CancellableContinuation<Unit>, Waiter {
        ...
        @Override // kotlinx.coroutines.CancellableContinuation
        public /* bridge */ /* synthetic */ void resume(Object value, Function3 onCancellation) {
            resume((Unit) value, (Function3<? super Throwable, ? super Unit, ? super CoroutineContext, Unit>) onCancellation);
        }

        @Override // kotlinx.coroutines.CancellableContinuation
        public /* bridge */ /* synthetic */ Object tryResume(Object value, Object idempotent, Function3 onCancellation) {
            return tryResume((Unit) value, idempotent, (Function3<? super Throwable, ? super Unit, ? super CoroutineContext, Unit>) onCancellation);
        }
        ...
        public <R extends Unit> Object tryResume(R value, Object idempotent, Function3<? super Throwable, ? super R, ? super CoroutineContext, Unit> onCancellation) {
            ...
            if (DebugKt.getASSERTIONS_ENABLED()) {
                if (!(MutexImpl.getOwner$volatile$FU().get(mutexImpl) == MutexKt.NO_OWNER)) {
                    throw new AssertionError();
                }
            }
            CancellableContinuationImpl<Unit> cancellableContinuationImpl = this.cont;
            final MutexImpl mutexImpl2 = MutexImpl.this;
            Object token = cancellableContinuationImpl.tryResume(value, idempotent, new Function3() { // from class: kotlinx.coroutines.sync.MutexImpl$CancellableContinuationWithOwner$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function3
                public final Object invoke(Object obj, Object obj2, Object obj3) {
            ...
            if (token != null) {
                ...
                if (DebugKt.getASSERTIONS_ENABLED()) {
                    if (!(MutexImpl.getOwner$volatile$FU().get(mutexImpl3) == MutexKt.NO_OWNER)) {
                        throw new AssertionError();
                    }
                }
        ...
        static final Unit tryResume$lambda$3(MutexImpl this$0, CancellableContinuationWithOwner this$1, Throwable th, Unit unit, CoroutineContext coroutineContext) {
            if (DebugKt.getASSERTIONS_ENABLED()) {
                Object it = MutexImpl.getOwner$volatile$FU().get(this$0);
                if (!(it == MutexKt.NO_OWNER || it == this$1.owner)) {
                    throw new AssertionError();
                }
            }
            MutexImpl.getOwner$volatile$FU().set(this$0, this$1.owner);
        ...
        static final Unit resume$lambda$6(MutexImpl this$0, CancellableContinuationWithOwner this$1, Throwable it) {
            this$0.unlock(this$1.owner);
            return Unit.INSTANCE;
        }
    }
