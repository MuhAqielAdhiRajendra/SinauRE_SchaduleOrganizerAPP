...
public final class WaterKt {
    ...
    public static final ImageVector getWater(Icons.Sharp $this$Water) {
        if (_water != null) {
        ...
        ImageVector.Builder $this$_get_Water__u24lambda_u241 = new ImageVector.Builder("Sharp.Water", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
