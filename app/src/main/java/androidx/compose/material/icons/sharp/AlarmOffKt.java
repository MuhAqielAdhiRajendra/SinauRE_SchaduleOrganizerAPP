...
public final class AlarmOffKt {
    ...
    public static final ImageVector getAlarmOff(Icons.Sharp $this$AlarmOff) {
        if (_alarmOff != null) {
        ...
        ImageVector.Builder $this$_get_AlarmOff__u24lambda_u241 = new ImageVector.Builder("Sharp.AlarmOff", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
