...
public final /* data */ class ParagraphInfo {
    ...
    public final long m7449toLocalMKHz9U(long $this$toLocal_u2dMK_u2dHz9U) {
    ...
    public final Rect toGlobal(Rect $this$toGlobal) {
        ...
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
        return $this$toGlobal.m5105translatek4lQ0M(Offset.m5060constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv)));
    }
    ...
    public final Rect toLocal(Rect $this$toLocal) {
        ...
        long v1$iv$iv = Float.floatToRawIntBits(0.0f);
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
        return $this$toLocal.m5105translatek4lQ0M(Offset.m5060constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv)));
    }
    ...
    public final Path toGlobal(Path $this$toGlobal) {
        ...
        long v1$iv$iv = Float.floatToRawIntBits(0.0f);
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
        $this$toGlobal.mo5205translatek4lQ0M(Offset.m5060constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv)));
        return $this$toGlobal;
    }

    /* JADX INFO: renamed from: toGlobal-xdX6-G0$default, reason: not valid java name */
    public static /* synthetic */ long m7447toGlobalxdX6G0$default(ParagraphInfo paragraphInfo, long j, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        return paragraphInfo.m7448toGlobalxdX6G0(j, z);
    }

    /* JADX INFO: renamed from: toGlobal-xdX6-G0, reason: not valid java name */
    public final long m7448toGlobalxdX6G0(long $this$toGlobal_u2dxdX6_u2dG0, boolean treatZeroAsNull) {
        if (treatZeroAsNull && TextRange.m7566equalsimpl0($this$toGlobal_u2dxdX6_u2dG0, TextRange.INSTANCE.m7578getZerod9O1mEE())) {
            return TextRange.INSTANCE.m7578getZerod9O1mEE();
        }
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m7573getStartimpl($this$toGlobal_u2dxdX6_u2dG0)), toGlobalIndex(TextRange.m7568getEndimpl($this$toGlobal_u2dxdX6_u2dG0)));
    }
}
