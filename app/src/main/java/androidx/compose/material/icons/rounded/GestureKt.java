...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_gesture", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Gesture", "Landroidx/compose/material/icons/Icons$Rounded;", "getGesture", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class GestureKt {
    private static ImageVector _gesture;

    public static final ImageVector getGesture(Icons.Rounded $this$Gesture) {
        if (_gesture != null) {
        ...
        ImageVector.Builder $this$_get_Gesture__u24lambda_u241 = new ImageVector.Builder("Rounded.Gesture", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(3.72f, 6.04f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.47f, 0.46f, 1.21f, 0.48f, 1.71f, 0.06f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.37f, -0.32f, 0.69f, -0.51f, 0.87f, -0.43f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(1.21f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-1.09f, 0.0f, -2.04f, 0.63f, -2.7f, 1.22f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.53f, 0.48f, -0.53f, 1.32f, -0.02f, 1.82f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _gesture = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_Gesture__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
