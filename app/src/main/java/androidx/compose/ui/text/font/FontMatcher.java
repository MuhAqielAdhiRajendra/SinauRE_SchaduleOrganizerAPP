...
public final class FontMatcher {
    ...
    public final List<Font> m7681matchFontRetOiIg(List<? extends Font> fontList, FontWeight fontWeight, int fontStyle) {
        ...
        while (true) {
            ...
            Font it = font;
            if (Intrinsics.areEqual(it.getWeight(), fontWeight) && FontStyle.m7685equalsimpl0(it.getStyle(), fontStyle)) {
                z = true;
            }
            if (z) {
                target$iv.add(font);
        ...
        for (int index$iv$iv2 = 0; index$iv$iv2 < size2; index$iv$iv2++) {
            ...
            if (FontStyle.m7685equalsimpl0(it3.getStyle(), fontStyle)) {
                target$iv2.add(it3);
            }
        }
        ...
        if (fontWeight.compareTo(FontWeight.INSTANCE.getW400()) < 0) {
            ...
            List target$iv$iv = new ArrayList(fontsToSearch.size());
            List $this$fastForEach$iv$iv$iv = fontsToSearch;
            int size4 = $this$fastForEach$iv$iv$iv.size();
            int index$iv$iv$iv2 = 0;
            while (index$iv$iv$iv2 < size4) {
                Object item$iv$iv$iv = $this$fastForEach$iv$iv$iv.get(index$iv$iv$iv2);
        ...
        if (fontWeight.compareTo(FontWeight.INSTANCE.getW500()) > 0) {
            ...
            while (index$iv$iv$iv3 < size6) {
                Object item$iv$iv$iv2 = fontsToSearch.get(index$iv$iv$iv3);
                ...
                index$iv$iv$iv3 = index$iv$iv$iv + 1;
                size6 = i2;
            }
        ...
        ArrayList target$iv$iv3 = new ArrayList(fontsToSearch.size());
        int size8 = fontsToSearch.size();
        int index$iv$iv$iv4 = 0;
        while (index$iv$iv$iv4 < size8) {
            Object item$iv$iv$iv3 = fontsToSearch.get(index$iv$iv$iv4);
        ...
        if (arrayList.isEmpty()) {
            FontWeight minSearchRange$iv2 = FontWeight.INSTANCE.getW500();
            ...
            while (true) {
                ...
                if ((minSearchRange$iv2 == null || possibleWeight$iv4.compareTo(minSearchRange$iv2) >= 0) && (0 == 0 || possibleWeight$iv4.compareTo((FontWeight) null) <= 0)) {
            ...
            ArrayList target$iv$iv4 = new ArrayList(fontsToSearch.size());
            int index$iv$iv$iv5 = 0;
            int size10 = fontsToSearch.size();
            while (index$iv$iv$iv5 < size10) {
                Object item$iv$iv$iv4 = fontsToSearch.get(index$iv$iv$iv5);
                ...
                index$iv$iv$iv5++;
                minSearchRange$iv2 = minSearchRange$iv;
                size10 = i3;
            }
    ...
    public static /* synthetic */ List filterByClosestWeight$ui_text$default(FontMatcher $this, List $receiver, FontWeight fontWeight, boolean preferBelow, FontWeight minSearchRange, FontWeight maxSearchRange, int i, Object obj) {
    ...
    public final List<Font> filterByClosestWeight$ui_text(List<? extends Font> list, FontWeight fontWeight, boolean preferBelow, FontWeight minSearchRange, FontWeight maxSearchRange) {
        FontWeight bestWeightAbove = null;
        FontWeight bestWeightBelow = null;
        int index = 0;
        int size = list.size();
    ...
    /* JADX INFO: renamed from: matchFont-RetOiIg, reason: not valid java name */
    public final List<Font> m7679matchFontRetOiIg(FontFamily fontFamily, FontWeight fontWeight, int fontStyle) {
        if (!(fontFamily instanceof FontListFontFamily)) {
            throw new IllegalArgumentException("Only FontFamily instances that presents a list of Fonts can be used");
        }
        return m7680matchFontRetOiIg((FontListFontFamily) fontFamily, fontWeight, fontStyle);
    }

    /* JADX INFO: renamed from: matchFont-RetOiIg, reason: not valid java name */
    public final List<Font> m7680matchFontRetOiIg(FontListFontFamily fontFamily, FontWeight fontWeight, int fontStyle) {
        return m7681matchFontRetOiIg(fontFamily.getFonts(), fontWeight, fontStyle);
    }
}
