...
public interface SQLiteStatement extends AutoCloseable {
    ...
    void mo8513bindBlob(int index, byte[] value);

    /* JADX INFO: renamed from: bindDouble */
    void mo8514bindDouble(int index, double value);

    /* JADX INFO: renamed from: bindLong */
    void mo8515bindLong(int index, long value);

    /* JADX INFO: renamed from: bindNull */
    void mo8516bindNull(int index);

    /* JADX INFO: renamed from: bindText */
    void mo8517bindText(int index, String value);

    /* JADX INFO: renamed from: clearBindings */
    void mo8518clearBindings();
