...
public final class SwipeUpKt {
    ...
    public static final ImageVector getSwipeUp(Icons.TwoTone $this$SwipeUp) {
        if (_swipeUp != null) {
        ...
        ImageVector.Builder $this$_get_SwipeUp__u24lambda_u242 = new ImageVector.Builder("TwoTone.SwipeUp", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_SwipeUp__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 0.3f, null, 0.3f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
        $this$PathData_u24lambda_u240$iv$iv$iv2.moveTo(2.06f, 5.56f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineTo(1.0f, 4.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineTo(4.5f, 1.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineTo(8.0f, 4.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineTo(6.94f, 5.56f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineTo(5.32f, 3.94f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveTo(5.11f, 4.76f, 5.0f, 5.62f, 5.0f, 6.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveToRelative(0.0f, 2.42f, 0.82f, 4.65f, 2.2f, 6.43f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineTo(6.13f, 14.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveTo(4.49f, 11.95f, 3.5f, 9.34f, 3.5f, 6.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveToRelative(0.0f, -0.92f, 0.1f, -1.82f, 0.3f, -2.68f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineTo(2.06f, 5.56f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
        _swipeUp = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_SwipeUp__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv2.getNodes(), pathFillType$iv2, "", fill$iv$iv2, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv2, strokeLineJoin$iv$iv2, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
