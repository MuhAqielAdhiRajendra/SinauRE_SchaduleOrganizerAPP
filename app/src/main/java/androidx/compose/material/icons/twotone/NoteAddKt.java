...
public final class NoteAddKt {
    ...
    public static final ImageVector getNoteAdd(Icons.TwoTone $this$NoteAdd) {
        if (_noteAdd != null) {
        ...
        ImageVector.Builder $this$_get_NoteAdd__u24lambda_u242 = new ImageVector.Builder("TwoTone.NoteAdd", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
