...
public final class ChildSemanticsNodeElement extends ModifierNodeElement<ChildSemanticsNode> {
    ...
    public ChildSemanticsNode getNode() {
        return new ChildSemanticsNode(this.properties);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void update(ChildSemanticsNode node) {
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        $this$inspectableProperties.setName("childSemantics");
        $this$inspectableProperties.getProperties().set("properties", this.properties);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ChildSemanticsNodeElement) && this.properties == ((ChildSemanticsNodeElement) other).properties;
    }
