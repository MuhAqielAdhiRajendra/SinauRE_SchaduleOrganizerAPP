...
public final /* data */ class IndicatorLineElement extends ModifierNodeElement<IndicatorLineNode> {
    ...
    public static /* synthetic */ IndicatorLineElement m2615copygv0btCI$default(IndicatorLineElement indicatorLineElement, boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, Shape shape, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return indicatorLineElement.m2618copygv0btCI(z, z2, interactionSource2, textFieldColors, shape2, f3, f4);
    }
    ...
    public final IndicatorLineElement m2618copygv0btCI(boolean enabled, boolean isError, InteractionSource interactionSource, TextFieldColors colors, Shape textFieldShape, float focusedIndicatorLineThickness, float unfocusedIndicatorLineThickness) {
    ...
    public final float m2619getFocusedIndicatorLineThicknessD9Ej5fM() {
        return this.focusedIndicatorLineThickness;
    }

    /* JADX INFO: renamed from: getUnfocusedIndicatorLineThickness-D9Ej5fM, reason: not valid java name */
    public final float m2620getUnfocusedIndicatorLineThicknessD9Ej5fM() {
        return this.unfocusedIndicatorLineThickness;
    }
    ...
    public void update(IndicatorLineNode node) {
        node.m2621updategv0btCI(this.enabled, this.isError, this.interactionSource, this.colors, this.textFieldShape, this.focusedIndicatorLineThickness, this.unfocusedIndicatorLineThickness);
    }
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("focusedIndicatorLineThickness", Dp.m8148boximpl(this.focusedIndicatorLineThickness));
        $this$inspectableProperties.getProperties().set("unfocusedIndicatorLineThickness", Dp.m8148boximpl(this.unfocusedIndicatorLineThickness));
    }
}
