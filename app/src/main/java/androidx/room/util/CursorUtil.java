...
public final class CursorUtil {
    ...
    public static final <R> R useCursor(Cursor $this$useCursor, Function1<? super Cursor, ? extends R> block) throws IOException {
