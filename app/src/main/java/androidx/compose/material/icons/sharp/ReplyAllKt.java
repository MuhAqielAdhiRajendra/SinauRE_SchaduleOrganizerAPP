...
public final class ReplyAllKt {
    ...
    public static final ImageVector getReplyAll(Icons.Sharp $this$ReplyAll) {
        if (_replyAll != null) {
        ...
        ImageVector.Builder $this$_get_ReplyAll__u24lambda_u241 = new ImageVector.Builder("Sharp.ReplyAll", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
