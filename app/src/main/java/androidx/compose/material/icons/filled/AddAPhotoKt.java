...
public final class AddAPhotoKt {
    ...
    public static final ImageVector getAddAPhoto(Icons.Filled $this$AddAPhoto) {
        if (_addAPhoto != null) {
        ...
        ImageVector.Builder $this$_get_AddAPhoto__u24lambda_u241 = new ImageVector.Builder("Filled.AddAPhoto", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(10.24f, 19.0f, 13.0f, 19.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(9.8f, 14.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(-1.43f, -3.2f, -3.2f, -3.2f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(9.8f, 12.23f, 9.8f, 14.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
