...
public final /* data */ class PointerHoverIconModifierElement extends ModifierNodeElement<PointerHoverIconModifierNode> {
    ...
    public PointerHoverIconModifierElement(PointerIcon icon, boolean overrideDescendants) {
        this.icon = icon;
