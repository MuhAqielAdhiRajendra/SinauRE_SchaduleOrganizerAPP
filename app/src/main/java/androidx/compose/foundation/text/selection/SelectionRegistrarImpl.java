...
public final class SelectionRegistrarImpl implements SelectionRegistrar {
    ...
    /* JADX INFO: compiled from: SelectionRegistrarImpl.kt */
    @Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\t\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u001d\u0010\u0004\u001a\u000e\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u00070\u0005¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\t¨\u0006\n"}, d2 = {"Landroidx/compose/foundation/text/selection/SelectionRegistrarImpl$Companion;", "", "<init>", "()V", "Saver", "Landroidx/compose/runtime/saveable/Saver;", "Landroidx/compose/foundation/text/selection/SelectionRegistrarImpl;", "", "getSaver", "()Landroidx/compose/runtime/saveable/Saver;", "foundation"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    static final SelectionRegistrarImpl Saver$lambda$1(long it) {
    ...
    static final int sort$lambda$0(LayoutCoordinates $containerLayoutCoordinates, Selectable a, Selectable b) {
        char c;
        long j;
        long positionATopLeft;
        long positionABottomRight;
        long positionBBottomRight;
        long positionBTopLeft;
        ...
        if (layoutCoordinatesA != null) {
            long positionATopLeft2 = $containerLayoutCoordinates.mo6792localPositionOfR5De75A(layoutCoordinatesA, Offset.INSTANCE.m5084getZeroF1C5BW0());
            j = 4294967295L;
            int bits$iv$iv$iv = (int) (positionATopLeft2 >> 32);
            float fIntBitsToFloat = Float.intBitsToFloat(bits$iv$iv$iv);
            long arg0$iv = layoutCoordinatesA.mo6791getSizeYbymL2g();
            c = ' ';
            positionATopLeft = positionATopLeft2;
            float x$iv = fIntBitsToFloat + ((int) (arg0$iv >> 32));
            long arg0$iv2 = positionATopLeft & 4294967295L;
            int bits$iv$iv$iv2 = (int) arg0$iv2;
            float fIntBitsToFloat2 = Float.intBitsToFloat(bits$iv$iv$iv2);
            long arg0$iv3 = layoutCoordinatesA.mo6791getSizeYbymL2g();
            float y$iv = fIntBitsToFloat2 + ((int) (arg0$iv3 & 4294967295L));
            long v1$iv$iv = Float.floatToRawIntBits(x$iv);
            long v1$iv$iv2 = Float.floatToRawIntBits(y$iv);
            long v2$iv$iv = (v1$iv$iv << 32) | (v1$iv$iv2 & 4294967295L);
            positionABottomRight = Offset.m5060constructorimpl(v2$iv$iv);
        } else {
            c = ' ';
            j = 4294967295L;
            long positionATopLeft3 = Offset.INSTANCE.m5084getZeroF1C5BW0();
            positionATopLeft = positionATopLeft3;
            positionABottomRight = Offset.INSTANCE.m5084getZeroF1C5BW0();
        }
        if (layoutCoordinatesB != null) {
            long positionBTopLeft2 = $containerLayoutCoordinates.mo6792localPositionOfR5De75A(layoutCoordinatesB, Offset.INSTANCE.m5084getZeroF1C5BW0());
            int bits$iv$iv$iv3 = (int) (positionBTopLeft2 >> c);
            float fIntBitsToFloat3 = Float.intBitsToFloat(bits$iv$iv$iv3);
            long arg0$iv4 = layoutCoordinatesB.mo6791getSizeYbymL2g();
            int $i$f$unpackInt1 = (int) (arg0$iv4 >> c);
            float x$iv2 = fIntBitsToFloat3 + $i$f$unpackInt1;
            int bits$iv$iv$iv4 = (int) (positionBTopLeft2 & j);
            float fIntBitsToFloat4 = Float.intBitsToFloat(bits$iv$iv$iv4);
            long arg0$iv5 = layoutCoordinatesB.mo6791getSizeYbymL2g();
            float y$iv2 = fIntBitsToFloat4 + ((int) (arg0$iv5 & j));
            long v1$iv$iv3 = Float.floatToRawIntBits(x$iv2);
            long v2$iv$iv2 = Float.floatToRawIntBits(y$iv2);
            positionBBottomRight = Offset.m5060constructorimpl((v1$iv$iv3 << c) | (v2$iv$iv2 & j));
            positionBTopLeft = positionBTopLeft2;
        } else {
            long positionBTopLeft3 = Offset.INSTANCE.m5084getZeroF1C5BW0();
            positionBBottomRight = Offset.INSTANCE.m5084getZeroF1C5BW0();
            positionBTopLeft = positionBTopLeft3;
        }
        boolean areTextLayoutsInARow = SelectionRegistrarImplKt.m2088inARowzwwh4xc(positionATopLeft, positionABottomRight, positionBTopLeft, positionBBottomRight);
        if (areTextLayoutsInARow) {
            long arg0$iv6 = positionATopLeft;
            int bits$iv$iv$iv5 = (int) (arg0$iv6 >> c);
            long arg0$iv7 = positionBTopLeft;
            int bits$iv$iv$iv6 = (int) (arg0$iv7 >> c);
        ...
        long arg0$iv8 = positionATopLeft;
        int bits$iv$iv$iv7 = (int) (arg0$iv8 & j);
        long arg0$iv9 = positionBTopLeft;
        int bits$iv$iv$iv8 = (int) (arg0$iv9 & j);
        return ComparisonsKt.compareValues(Float.valueOf(Float.intBitsToFloat(bits$iv$iv$iv7)), Float.valueOf(Float.intBitsToFloat(bits$iv$iv$iv8)));
    }
    ...
    public void mo2087notifySelectionUpdateStartubNVwUQ(LayoutCoordinates layoutCoordinates, long startPosition, SelectionAdjustment adjustment, boolean isInTouchMode) {
        ...
        if (function4 != null) {
            function4.invoke(Boolean.valueOf(isInTouchMode), layoutCoordinates, Offset.m5057boximpl(startPosition), adjustment);
        }
    }
    ...
    public boolean mo2086notifySelectionUpdatenjBpvok(LayoutCoordinates layoutCoordinates, long newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment, boolean isInTouchMode) {
        ...
        if (function6 != null) {
            return function6.invoke(Boolean.valueOf(isInTouchMode), layoutCoordinates, Offset.m5057boximpl(newPosition), Offset.m5057boximpl(previousPosition), Boolean.valueOf(isStartHandle), adjustment).booleanValue();
        }
        return true;
    }
