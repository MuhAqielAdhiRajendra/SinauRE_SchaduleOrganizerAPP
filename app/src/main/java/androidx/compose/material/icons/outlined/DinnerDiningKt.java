...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_dinnerDining", "Landroidx/compose/ui/graphics/vector/ImageVector;", "DinnerDining", "Landroidx/compose/material/icons/Icons$Outlined;", "getDinnerDining", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class DinnerDiningKt {
    private static ImageVector _dinnerDining;

    public static final ImageVector getDinnerDining(Icons.Outlined $this$DinnerDining) {
        ...
        ImageVector.Builder $this$_get_DinnerDining__u24lambda_u242 = new ImageVector.Builder("Outlined.DinnerDining", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_DinnerDining__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.horizontalLineToRelative(16.97f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.moveTo(14.5f, 14.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveToRelative(0.99f, 0.0f, 1.91f, 0.4f, 2.58f, 1.14f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveToRelative(0.24f, 0.26f, 0.44f, 0.55f, 0.58f, 0.86f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.horizontalLineToRelative(-6.32f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveTo(11.92f, 14.79f, 13.15f, 14.0f, 14.5f, 14.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.verticalLineTo(9.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
        _dinnerDining = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_DinnerDining__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv2.getNodes(), pathFillType$iv2, "", fill$iv$iv2, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv2, strokeLineJoin$iv$iv2, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
