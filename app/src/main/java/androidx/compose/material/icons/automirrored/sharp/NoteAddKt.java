...
public final class NoteAddKt {
    ...
    public static final ImageVector getNoteAdd(Icons.AutoMirrored.Sharp $this$NoteAdd) {
        if (_noteAdd != null) {
        ...
        ImageVector.Builder $this$_get_NoteAdd__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Sharp.NoteAdd", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
