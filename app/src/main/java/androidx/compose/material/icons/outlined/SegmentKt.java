...
public final class SegmentKt {
    ...
    public static final ImageVector getSegment(Icons.Outlined $this$Segment) {
        if (_segment != null) {
        ...
        ImageVector.Builder $this$_get_Segment__u24lambda_u241 = new ImageVector.Builder("Outlined.Segment", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
