...
public final class GestureKt {
    ...
    public static final ImageVector getGesture(Icons.Sharp $this$Gesture) {
        if (_gesture != null) {
        ...
        ImageVector.Builder $this$_get_Gesture__u24lambda_u241 = new ImageVector.Builder("Sharp.Gesture", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
