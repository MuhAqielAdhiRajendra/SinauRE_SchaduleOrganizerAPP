...
public final class SlideshowKt {
    ...
    public static final ImageVector getSlideshow(Icons.Outlined $this$Slideshow) {
        if (_slideshow != null) {
        ...
        ImageVector.Builder $this$_get_Slideshow__u24lambda_u241 = new ImageVector.Builder("Outlined.Slideshow", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
