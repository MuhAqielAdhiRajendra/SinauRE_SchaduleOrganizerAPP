...
public class MaterialDatePicker<S> extends DialogFragment {
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.confirmButton.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialDatePicker$$ExternalSyntheticLambda1
            ...
            public final void onClick(View view) {
                this.f$0.onPositiveButtonClick(view);
            }
        });
        ...
        cancelButton.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialDatePicker$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.onNegativeButtonClick(view);
            }
        });
        return root;
    }
    ...
    public void onPositiveButtonClick(View view) {
        for (MaterialPickerOnPositiveButtonClickListener<? super S> listener : this.onPositiveButtonClickListeners) {
    ...
    public void onNegativeButtonClick(View view) {
        for (View.OnClickListener listener : this.onNegativeButtonClickListeners) {
    ...
    private void enableEdgeToEdgeIfNeeded(Window window) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(headerLayout, new OnApplyWindowInsetsListener() { // from class: com.google.android.material.datepicker.MaterialDatePicker.1
    ...
    private void startPickerFragment() {
        ...
        String currentTag = this.inputMode == 1 ? TEXT_INPUT_FRAGMENT_TAG : CALENDAR_FRAGMENT_TAG;
        Fragment foundFragment = getChildFragmentManager().findFragmentByTag(currentTag);
        PickerFragment<S> fragment = foundFragment instanceof PickerFragment ? (PickerFragment) foundFragment : null;
        if (fragment == null) {
            if (this.inputMode == 1) {
                fragment = MaterialTextInputPicker.newInstance(getDateSelector(), themeResId, this.calendarConstraints);
            } else {
                this.calendar = MaterialCalendar.newInstance(getDateSelector(), themeResId, this.calendarConstraints, this.dayViewDecorator);
                fragment = this.calendar;
            }
        }
        this.pickerFragment = fragment;
        ...
        getChildFragmentManager().beginTransaction().replace(R.id.mtrl_calendar_frame, this.pickerFragment, currentTag).commitNow();
    }
    ...
    /* synthetic */ void m8841x8a93f18a(View v) {
    ...
    private void updateToggleTooltip(CheckableImageButton toggle) {
        String tooltipText;
        if (this.inputMode == 1) {
            tooltipText = toggle.getContext().getString(R.string.mtrl_picker_toggle_to_calendar_input_mode_tooltip);
        } else {
            tooltipText = toggle.getContext().getString(R.string.mtrl_picker_toggle_to_text_input_mode_tooltip);
        }
        TooltipCompat.setTooltipText(this.headerToggleButton, tooltipText);
    }
