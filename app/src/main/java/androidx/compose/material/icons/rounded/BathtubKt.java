...
public final class BathtubKt {
    ...
    public static final ImageVector getBathtub(Icons.Rounded $this$Bathtub) {
        if (_bathtub != null) {
        ...
        ImageVector.Builder $this$_get_Bathtub__u24lambda_u242 = new ImageVector.Builder("Rounded.Bathtub", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.verticalLineToRelative(-5.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveTo(22.0f, 13.45f, 21.55f, 13.0f, 21.0f, 13.0f);
