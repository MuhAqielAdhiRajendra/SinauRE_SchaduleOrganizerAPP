...
public final class ForwardKt {
    ...
    public static final ImageVector getForward(Icons.Rounded $this$Forward) {
        if (_forward != null) {
        ...
        ImageVector.Builder $this$_get_Forward__u24lambda_u241 = new ImageVector.Builder("Rounded.Forward", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
