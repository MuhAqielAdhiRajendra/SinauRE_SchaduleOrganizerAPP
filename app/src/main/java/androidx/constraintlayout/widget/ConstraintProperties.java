    ...
    public ConstraintProperties removeFromVerticalChain() {
        ...
        if (topId != -1 || bottomId != -1) {
            ...
            if (topId != -1 && bottomId != -1) {
                ...
                if (i != -1) {
                    topProp.connect(4, layoutParams.bottomToBottom, 4, 0);
                } else if (layoutParams.topToTop != -1) {
    ...
    public ConstraintProperties removeFromHorizontalChain() {
        ...
        if (leftId != -1 || rightId != -1) {
            ...
            if (leftId != -1 && rightId != -1) {
                ...
                ConstraintLayout.LayoutParams layoutParams = this.mParams;
                if (i != -1) {
                    leftProp.connect(2, layoutParams.rightToRight, 2, 0);
                } else if (layoutParams.leftToLeft != -1) {
            ...
            if (startId != -1 || endId != -1) {
                ...
                if (startId != -1 && endId != -1) {
                    ...
                    int i2 = this.mParams.rightToRight;
                    ConstraintLayout.LayoutParams layoutParams2 = this.mParams;
                    if (i2 != -1) {
                        startProp.connect(7, layoutParams2.rightToRight, 7, 0);
                    } else if (layoutParams2.leftToLeft != -1) {
