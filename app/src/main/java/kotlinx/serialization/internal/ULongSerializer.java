...
public final class ULongSerializer implements KSerializer<ULong> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return ULong.m9097boximpl(m10538deserializeI7RO_PI(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object value) {
        m10539serialize2TYgG_w(encoder, ((ULong) value).getData());
    }
    ...
    public void m10539serialize2TYgG_w(Encoder encoder, long value) {
    ...
    public long m10538deserializeI7RO_PI(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return ULong.m9103constructorimpl(decoder.decodeInline(getDescriptor()).decodeLong());
    }
}
