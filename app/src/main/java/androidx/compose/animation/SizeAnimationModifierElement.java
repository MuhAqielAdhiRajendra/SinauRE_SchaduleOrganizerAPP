...
final class SizeAnimationModifierElement extends ModifierNodeElement<SizeAnimationModifierNode> {
    ...
    public boolean equals(Object other) {
        return (other instanceof SizeAnimationModifierElement) && Intrinsics.areEqual(((SizeAnimationModifierElement) other).animationSpec, this.animationSpec) && ((SizeAnimationModifierElement) other).finishedListener == this.finishedListener && Intrinsics.areEqual(((SizeAnimationModifierElement) other).alignment, this.alignment);
    }
}
