...
public final class ComposableLambdaKt {
    ...
    public static final ComposableLambda rememberComposableLambda(int key, boolean tracked, Object block, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1573003438, $changed, -1, "androidx.compose.runtime.internal.rememberComposableLambda (ComposableLambda.kt:1372)");
        }
