...
public final class AppBarLargeFlexibleTokens {
    ...
    private static final float ContainerHeight = Dp.m8150constructorimpl((float) 120.0d);
    ...
    private static final float LargeContainerHeight = Dp.m8150constructorimpl((float) 152.0d);

    private AppBarLargeFlexibleTokens() {
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m3557getContainerHeightD9Ej5fM() {
    ...
    public final float m3558getLargeContainerHeightD9Ej5fM() {
