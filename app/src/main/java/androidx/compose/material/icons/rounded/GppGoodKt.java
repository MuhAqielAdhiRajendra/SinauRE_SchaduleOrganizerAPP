...
public final class GppGoodKt {
    ...
    public static final ImageVector getGppGood(Icons.Rounded $this$GppGood) {
        if (_gppGood != null) {
        ...
        ImageVector.Builder $this$_get_GppGood__u24lambda_u241 = new ImageVector.Builder("Rounded.GppGood", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(4.71f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(10.23f, 14.83f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(11.26f, 15.22f, 10.62f, 15.22f, 10.23f, 14.83f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
