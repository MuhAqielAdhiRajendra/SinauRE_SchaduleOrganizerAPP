...
public final class AlarmKt {
    ...
    public static final ImageVector getAlarm(Icons.Outlined $this$Alarm) {
        if (_alarm != null) {
        ...
        ImageVector.Builder $this$_get_Alarm__u24lambda_u241 = new ImageVector.Builder("Outlined.Alarm", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
