...
public final class PhoneCallbackKt {
    ...
    public static final ImageVector getPhoneCallback(Icons.AutoMirrored.Outlined $this$PhoneCallback) {
        ...
        ImageVector.Builder $this$_get_PhoneCallback__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Outlined.PhoneCallback", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
