...
public final class CommentKt {
    ...
    public static final ImageVector getComment(Icons.Filled $this$Comment) {
        if (_comment != null) {
        ...
        ImageVector.Builder $this$_get_Comment__u24lambda_u241 = new ImageVector.Builder("Filled.Comment", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
