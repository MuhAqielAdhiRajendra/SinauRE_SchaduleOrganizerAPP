...
public final class HikingKt {
    ...
    public static final ImageVector getHiking(Icons.Rounded $this$Hiking) {
        if (_hiking != null) {
        ...
        ImageVector.Builder $this$_get_Hiking__u24lambda_u241 = new ImageVector.Builder("Rounded.Hiking", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(18.25f, 9.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(9.41f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, 0.41f, 0.34f, 0.75f, 0.75f, 0.75f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(19.0f, 22.66f, 19.0f, 22.25f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineTo(9.75f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(19.0f, 9.34f, 18.66f, 9.0f, 18.25f, 9.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _hiking = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_Hiking__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
