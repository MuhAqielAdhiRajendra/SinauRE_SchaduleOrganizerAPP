...
public final class BadgeTokens {
    ...
    private static final float LargeSize = Dp.m8150constructorimpl((float) 16.0d);
    private static final ShapeKeyTokens Shape = ShapeKeyTokens.CornerFull;
    private static final float Size = Dp.m8150constructorimpl((float) 6.0d);
    ...
    public final float m3581getLargeSizeD9Ej5fM() {
        return LargeSize;
    }
    ...
    public final float m3582getSizeD9Ej5fM() {
        return Size;
    }
}
