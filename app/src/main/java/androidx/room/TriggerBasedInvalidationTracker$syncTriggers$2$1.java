...
final class TriggerBasedInvalidationTracker$syncTriggers$2$1 extends SuspendLambda implements Function2<Transactor, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:64:0x0109 A[Catch: all -> 0x00fd, TRY_LEAVE, TryCatch #4 {all -> 0x00fd, blocks: (B:53:0x00f1, B:64:0x0109), top: B:91:0x00f1 }] */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
