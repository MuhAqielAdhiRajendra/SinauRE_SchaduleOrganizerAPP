...
public final class CleanHandsKt {
    ...
    public static final ImageVector getCleanHands(Icons.Sharp $this$CleanHands) {
        if (_cleanHands != null) {
        ...
        ImageVector.Builder $this$_get_CleanHands__u24lambda_u241 = new ImageVector.Builder("Sharp.CleanHands", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-8.03f, -3.0f);
