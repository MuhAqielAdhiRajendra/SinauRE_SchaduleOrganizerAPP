...
public final class VelocityTracker {
    ...
    public final void m6756addPositionUv8p0NA(long timeMillis, long position) {
        this.platformVelocityTracker.mo6747addPositionUv8p0NA(timeMillis, position);
    }

    /* JADX INFO: renamed from: calculateVelocity-9UxMQ8M, reason: not valid java name */
    public final long m6757calculateVelocity9UxMQ8M() {
        return m6758calculateVelocityAH228Gc(VelocityKt.Velocity(Float.MAX_VALUE, Float.MAX_VALUE));
    }

    /* JADX INFO: renamed from: calculateVelocity-AH228Gc, reason: not valid java name */
    public final long m6758calculateVelocityAH228Gc(long maximumVelocity) {
        return this.platformVelocityTracker.mo6748calculateVelocityAH228Gc(maximumVelocity);
    }
