...
public final class AirlineSeatLegroomExtraKt {
    ...
    public static final ImageVector getAirlineSeatLegroomExtra(Icons.Rounded $this$AirlineSeatLegroomExtra) {
        ...
        ImageVector.Builder $this$_get_AirlineSeatLegroomExtra__u24lambda_u241 = new ImageVector.Builder("Rounded.AirlineSeatLegroomExtra", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(2.56f, 5.25f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.48f, 0.98f, 1.64f, 1.39f, 2.63f, 0.94f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(1.95f, -0.89f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.76f, -0.36f, 1.09f, -1.3f, 0.69f, -2.06f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
