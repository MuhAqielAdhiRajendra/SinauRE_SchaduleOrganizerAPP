...
final /* data */ class TextClassificationResult {
    ...
    public static /* synthetic */ TextClassificationResult m2089copySbBc2M$default(TextClassificationResult textClassificationResult, CharSequence charSequence, long j, TextClassification textClassification, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textClassificationResult.m2091copySbBc2M(charSequence, j, textClassification);
    }
    ...
    public final TextClassificationResult m2091copySbBc2M(CharSequence text, long selection, TextClassification textClassification) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.text, textClassificationResult.text) && TextRange.m7566equalsimpl0(this.selection, textClassificationResult.selection) && Intrinsics.areEqual(this.textClassification, textClassificationResult.textClassification);
    }

    public int hashCode() {
        return (((this.text.hashCode() * 31) + TextRange.m7574hashCodeimpl(this.selection)) * 31) + this.textClassification.hashCode();
    }

    public String toString() {
        return "TextClassificationResult(text=" + ((Object) this.text) + ", selection=" + ((Object) TextRange.m7576toStringimpl(this.selection)) + ", textClassification=" + this.textClassification + ')';
    }
    ...
    public final long m2092getSelectiond9O1mEE() {
        return this.selection;
    }
