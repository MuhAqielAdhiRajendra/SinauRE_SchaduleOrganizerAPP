...
public final class SquareFootKt {
    ...
    public static final ImageVector getSquareFoot(Icons.Rounded $this$SquareFoot) {
        if (_squareFoot != null) {
        ...
        ImageVector.Builder $this$_get_SquareFoot__u24lambda_u241 = new ImageVector.Builder("Rounded.SquareFoot", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(6.34f, 7.76f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.2f, 0.2f, -0.51f, 0.2f, -0.71f, 0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(0.0f, 0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.2f, -0.2f, -0.2f, -0.51f, 0.0f, -0.71f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(0.71f, -0.71f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(4.85f, 4.85f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(4.54f, 4.54f, 4.0f, 4.76f, 4.0f, 5.21f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(12.79f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(-4.76f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(12.76f, 17.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineTo(8.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(7.45f, 17.0f, 7.0f, 16.55f, 7.0f, 16.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _squareFoot = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_SquareFoot__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
