    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        ComposableLambda composableLambdaRememberComposableLambda = ComposableLambdaKt.rememberComposableLambda(-519581786, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffold$1$1.1
            ...
            public final void invoke(Composer $composer2, int $changed2) {
                ...
                function3.invoke(PaddingKt.m1045PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, f, 7, null), $composer2, 0);
                if (ComposerKt.isTraceInProgress()) {
        ...
        ComposableLambda composableLambdaRememberComposableLambda2 = ComposableLambdaKt.rememberComposableLambda(-815624571, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffold$1$1.2
            ...
            public final void invoke(Composer $composer2, int $changed2) {
                ...
                if ($composer2.shouldExecute(($changed2 & 3) != 2, $changed2 & 1)) {
                    ...
                    BottomSheetScaffoldKt.m2198StandardBottomSheetw7I5h1o(bottomSheetScaffoldState.getBottomSheetState(), f2, f3, z, shape, j, j2, f4, f5, function22, function32, $composer2, 0, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                        return;
                    }
        ...
        BottomSheetScaffoldKt.BottomSheetScaffoldLayout(function2, composableLambdaRememberComposableLambda, composableLambdaRememberComposableLambda2, composableLambdaRememberComposableLambda3, (Function0) it$iv, bottomSheetState, $composer, 3504);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    }
