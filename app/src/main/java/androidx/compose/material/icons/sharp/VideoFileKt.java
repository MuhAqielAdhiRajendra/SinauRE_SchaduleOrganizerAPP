...
public final class VideoFileKt {
    ...
    public static final ImageVector getVideoFile(Icons.Sharp $this$VideoFile) {
        if (_videoFile != null) {
        ...
        ImageVector.Builder $this$_get_VideoFile__u24lambda_u241 = new ImageVector.Builder("Sharp.VideoFile", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
