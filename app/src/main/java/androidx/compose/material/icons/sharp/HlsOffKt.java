...
public final class HlsOffKt {
    ...
    public static final ImageVector getHlsOff(Icons.Sharp $this$HlsOff) {
        if (_hlsOff != null) {
        ...
        ImageVector.Builder $this$_get_HlsOff__u24lambda_u241 = new ImageVector.Builder("Sharp.HlsOff", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
