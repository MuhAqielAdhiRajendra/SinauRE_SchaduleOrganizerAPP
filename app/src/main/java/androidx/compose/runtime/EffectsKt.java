...
public final class EffectsKt {
    ...
    public static final void SideEffect(Function0<Unit> function0, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1288466761, $changed, -1, "androidx.compose.runtime.SideEffect (Effects.kt:53)");
        }
    ...
    public static final void DisposableEffect(Function1<? super DisposableEffectScope, ? extends DisposableEffectResult> function1, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-904483903, $changed, -1, "androidx.compose.runtime.DisposableEffect (Effects.kt:122)");
        }
    ...
    public static final void DisposableEffect(Object key1, Function1<? super DisposableEffectScope, ? extends DisposableEffectResult> function1, Composer $composer, int $changed) {
        ComposerKt.sourceInformationMarkerStart($composer, -1371986847, "C(DisposableEffect)N(key1,effect)156@6734L47:Effects.kt#9igjgp");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1371986847, $changed, -1, "androidx.compose.runtime.DisposableEffect (Effects.kt:155)");
        }
    ...
    public static final void DisposableEffect(Object key1, Object key2, Function1<? super DisposableEffectScope, ? extends DisposableEffectResult> function1, Composer $composer, int $changed) {
        ComposerKt.sourceInformationMarkerStart($composer, 1429097729, "C(DisposableEffect)N(key1,key2,effect)193@8619L53:Effects.kt#9igjgp");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1429097729, $changed, -1, "androidx.compose.runtime.DisposableEffect (Effects.kt:192)");
        }
    ...
    public static final void DisposableEffect(Object key1, Object key2, Object key3, Function1<? super DisposableEffectScope, ? extends DisposableEffectResult> function1, Composer $composer, int $changed) {
        ComposerKt.sourceInformationMarkerStart($composer, -1239538271, "C(DisposableEffect)N(key1,key2,key3,effect)231@10542L59:Effects.kt#9igjgp");
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void DisposableEffect(Object[] keys, Function1<? super DisposableEffectScope, ? extends DisposableEffectResult> function1, Composer $composer, int $changed) {
        ComposerKt.sourceInformationMarkerStart($composer, -1307627122, "C(DisposableEffect)N(keys,effect)267@12434L48:Effects.kt#9igjgp");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1307627122, $changed, -1, "androidx.compose.runtime.DisposableEffect (Effects.kt:266)");
        }
        ...
        boolean invalid$iv$iv = invalid$iv;
    ...
    public static final void LaunchedEffect(final Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2, Composer $composer, final int $changed) {
        ...
        if ($composer2.shouldExecute(($changed & 1) != 0, $changed & 1)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-805415771, $changed, -1, "androidx.compose.runtime.LaunchedEffect (Effects.kt:328)");
            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.runtime.EffectsKt$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj, Object obj2) {
                    return EffectsKt.LaunchedEffect$lambda$0(function2, $changed, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    public static final void LaunchedEffect(Object key1, Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2, Composer $composer, int $changed) {
        ComposerKt.sourceInformationMarkerStart($composer, 1179185413, "C(LaunchedEffect)N(key1,block)346@15603L58:Effects.kt#9igjgp");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1179185413, $changed, -1, "androidx.compose.runtime.LaunchedEffect (Effects.kt:344)");
        }
    ...
    public static final void LaunchedEffect(Object key1, Object key2, Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2, Composer $composer, int $changed) {
        ComposerKt.sourceInformationMarkerStart($composer, 590241125, "C(LaunchedEffect)N(key1,key2,block)365@16604L64:Effects.kt#9igjgp");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(590241125, $changed, -1, "androidx.compose.runtime.LaunchedEffect (Effects.kt:363)");
        }
        CoroutineContext applyContext = $composer.getApplyCoroutineContext();
    ...
    public static final void LaunchedEffect(Object key1, Object key2, Object key3, Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2, Composer $composer, int $changed) {
        ComposerKt.sourceInformationMarkerStart($composer, -54093371, "C(LaunchedEffect)N(key1,key2,key3,block)389@17650L70:Effects.kt#9igjgp");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-54093371, $changed, -1, "androidx.compose.runtime.LaunchedEffect (Effects.kt:387)");
        }
        CoroutineContext applyContext = $composer.getApplyCoroutineContext();
    ...
    public static final void LaunchedEffect(Object[] keys, Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2, Composer $composer, int $changed) {
        ComposerKt.sourceInformationMarkerStart($composer, -139560008, "C(LaunchedEffect)N(keys,block)412@18816L59:Effects.kt#9igjgp");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-139560008, $changed, -1, "androidx.compose.runtime.LaunchedEffect (Effects.kt:410)");
        }
        CoroutineContext applyContext = $composer.getApplyCoroutineContext();
        Object[] keys$iv = Arrays.copyOf(keys, keys.length);
        ComposerKt.sourceInformationMarkerStart($composer, -568225417, "CC(remember)N(keys,calculation):Composables.kt#9igjgp");
    ...
    public static final CoroutineScope createCompositionCoroutineScope(CoroutineContext coroutineContext, Composer composer) {
        if (coroutineContext.get(Job.INSTANCE) != null) {
            CompletableJob $this$createCompositionCoroutineScope_u24lambda_u240 = JobKt__JobKt.Job$default((Job) null, 1, (Object) null);
            $this$createCompositionCoroutineScope_u24lambda_u240.completeExceptionally(new IllegalArgumentException("CoroutineContext supplied to rememberCoroutineScope may not include a parent job"));
            return CoroutineScopeKt.CoroutineScope($this$createCompositionCoroutineScope_u24lambda_u240);
        }
        CoroutineContext applyContext = composer.getApplyCoroutineContext();
