...
@DebugMetadata(c = "androidx.compose.foundation.AbstractClickableNode$handlePressInteractionStart$1$2", f = "Clickable.kt", i = {}, l = {2077}, m = "invokeSuspend", n = {}, s = {}, v = 1)
final class AbstractClickableNode$handlePressInteractionStart$1$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    AbstractClickableNode$handlePressInteractionStart$1$2(MutableInteractionSource mutableInteractionSource, PressInteraction.Press press, Continuation<? super AbstractClickableNode$handlePressInteractionStart$1$2> continuation) {
