...
public final class PendingKt {
    ...
    public static final ImageVector getPending(Icons.Sharp $this$Pending) {
        if (_pending != null) {
        ...
        ImageVector.Builder $this$_get_Pending__u24lambda_u241 = new ImageVector.Builder("Sharp.Pending", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
