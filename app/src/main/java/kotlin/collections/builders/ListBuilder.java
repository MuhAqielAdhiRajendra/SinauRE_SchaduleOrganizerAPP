...
public final class ListBuilder<E> extends AbstractMutableList<E> implements List<E>, RandomAccess, Serializable, KMutableList {
    ...
    public <T> T[] toArray(T[] array) {
        ...
        E[] eArr = this.backing;
        if (length < i) {
            T[] tArr = (T[]) Arrays.copyOfRange(eArr, 0, this.length, array.getClass());
            Intrinsics.checkNotNullExpressionValue(tArr, "copyOfRange(...)");
            return tArr;
        }
        ArraysKt.copyInto(eArr, array, 0, 0, this.length);
    ...
    public final int retainOrRemoveAllInternal(int rangeOffset, int rangeLength, Collection<? extends E> elements, boolean retain) {
        ...
        while (true) {
            ...
            if (elements.contains(eArr[rangeOffset + i]) == retain) {
        ...
        ArraysKt.copyInto(eArr, this.backing, rangeOffset + j, rangeOffset + rangeLength, this.length);
    ...
    public static final class BuilderSubList<E> extends AbstractMutableList<E> implements List<E>, RandomAccess, Serializable, KMutableList {
        ...
        public <T> T[] toArray(T[] array) {
            ...
            E[] eArr = this.backing;
            if (length < i) {
                T[] tArr = (T[]) Arrays.copyOfRange(eArr, this.offset, this.offset + this.length, array.getClass());
                Intrinsics.checkNotNullExpressionValue(tArr, "copyOfRange(...)");
                return tArr;
            }
            ArraysKt.copyInto(eArr, array, 0, this.offset, this.offset + this.length);
            return (T[]) CollectionsKt.terminateCollectionToArray(this.length, array);
        }
