...
public final class CallMergeKt {
    ...
    public static final ImageVector getCallMerge(Icons.Outlined $this$CallMerge) {
        if (_callMerge != null) {
        ...
        ImageVector.Builder $this$_get_CallMerge__u24lambda_u241 = new ImageVector.Builder("Outlined.CallMerge", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
