    ...
    */
    public void trimToSize(int r13) {
        ...
        L1:
            r0 = 0
            r1 = 0
            androidx.collection.internal.Lock r2 = r12.lock
            r3 = 0
            r4 = r2
            r5 = 0
            monitor-enter(r4)
            r6 = 0
            int r7 = r12.size     // Catch: java.lang.Throwable -> L71
            r8 = 1
            if (r7 < 0) goto L1f
            androidx.collection.internal.LruHashMap<K, V> r7 = r12.map     // Catch: java.lang.Throwable -> L71
        ...
        L20:
            ...
            if (r7 != 0) goto L2a
            r10 = 0
            java.lang.String r11 = "LruCache.sizeOf() is reporting inconsistent results!"
            androidx.collection.internal.RuntimeHelpersKt.throwIllegalStateException(r11)     // Catch: java.lang.Throwable -> L71
        L2a:
            int r7 = r12.size     // Catch: java.lang.Throwable -> L71
            if (r7 <= r13) goto L6e
            androidx.collection.internal.LruHashMap<K, V> r7 = r12.map     // Catch: java.lang.Throwable -> L71
        ...
        L38:
            androidx.collection.internal.LruHashMap<K, V> r7 = r12.map     // Catch: java.lang.Throwable -> L71
            java.util.Set r7 = r7.getEntries()     // Catch: java.lang.Throwable -> L71
            java.lang.Iterable r7 = (java.lang.Iterable) r7     // Catch: java.lang.Throwable -> L71
            java.lang.Object r7 = kotlin.collections.CollectionsKt.firstOrNull(r7)     // Catch: java.lang.Throwable -> L71
            java.util.Map$Entry r7 = (java.util.Map.Entry) r7     // Catch: java.lang.Throwable -> L71
            if (r7 != 0) goto L4a
            monitor-exit(r4)
            return
        L4a:
            java.lang.Object r9 = r7.getKey()     // Catch: java.lang.Throwable -> L71
            r0 = r9
            java.lang.Object r9 = r7.getValue()     // Catch: java.lang.Throwable -> L71
            r1 = r9
            androidx.collection.internal.LruHashMap<K, V> r9 = r12.map     // Catch: java.lang.Throwable -> L71
            r9.remove(r0)     // Catch: java.lang.Throwable -> L71
            int r9 = r12.size     // Catch: java.lang.Throwable -> L71
            int r10 = r12.safeSizeOf(r0, r1)     // Catch: java.lang.Throwable -> L71
            int r9 = r9 - r10
            r12.size = r9     // Catch: java.lang.Throwable -> L71
            int r9 = r12.evictionCount     // Catch: java.lang.Throwable -> L71
            int r9 = r9 + r8
            r12.evictionCount = r9     // Catch: java.lang.Throwable -> L71
            monitor-exit(r4)
            r2 = 0
            r12.entryRemoved(r8, r0, r1, r2)
            goto L1
        L6e:
            monitor-exit(r4)
            return
