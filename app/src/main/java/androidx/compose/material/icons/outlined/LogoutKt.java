...
public final class LogoutKt {
    ...
    public static final ImageVector getLogout(Icons.Outlined $this$Logout) {
        if (_logout != null) {
        ...
        ImageVector.Builder $this$_get_Logout__u24lambda_u241 = new ImageVector.Builder("Outlined.Logout", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
