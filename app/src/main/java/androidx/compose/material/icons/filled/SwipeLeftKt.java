...
public final class SwipeLeftKt {
    ...
    public static final ImageVector getSwipeLeft(Icons.Filled $this$SwipeLeft) {
        if (_swipeLeft != null) {
        ...
        ImageVector.Builder $this$_get_SwipeLeft__u24lambda_u241 = new ImageVector.Builder("Filled.SwipeLeft", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(4.74f, 0.0f, 7.67f, 2.52f, 8.43f, 4.5f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(6.21f, 3.64f, 8.97f, 2.5f, 12.0f, 2.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
