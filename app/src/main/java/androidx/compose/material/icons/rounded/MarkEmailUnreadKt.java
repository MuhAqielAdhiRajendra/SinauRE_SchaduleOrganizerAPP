...
public final class MarkEmailUnreadKt {
    ...
    public static final ImageVector getMarkEmailUnread(Icons.Rounded $this$MarkEmailUnread) {
        ...
        ImageVector.Builder $this$_get_MarkEmailUnread__u24lambda_u241 = new ImageVector.Builder("Rounded.MarkEmailUnread", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(1.13f, 0.0f, 2.16f, -0.39f, 3.0f, -1.02f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(4.77f, -2.98f);
