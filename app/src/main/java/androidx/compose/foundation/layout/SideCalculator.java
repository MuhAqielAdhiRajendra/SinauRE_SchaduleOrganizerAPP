...
interface SideCalculator {
    ...
    long mo1096consumedOffsetsMKHz9U(long available);

    /* JADX INFO: renamed from: consumedVelocity-QWom1Mo, reason: not valid java name */
    long mo1097consumedVelocityQWom1Mo(long available, float remaining);
    ...
    public static final class Companion {
        ...
        private static final SideCalculator$Companion$LeftSideCalculator$1 LeftSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$LeftSideCalculator$1
            ...
            public long mo1096consumedOffsetsMKHz9U(long available) {
            ...
            public long mo1097consumedVelocityQWom1Mo(long available, float remaining) {
                return VelocityKt.Velocity(Velocity.m8388getXimpl(available) - remaining, 0.0f);
            }
        };
        private static final SideCalculator$Companion$TopSideCalculator$1 TopSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$TopSideCalculator$1
            ...
            /* JADX INFO: renamed from: consumedVelocity-QWom1Mo */
            public long mo1097consumedVelocityQWom1Mo(long available, float remaining) {
                return VelocityKt.Velocity(0.0f, Velocity.m8389getYimpl(available) - remaining);
            }
        };
        ...
        public final SideCalculator m1098chooseCalculatorni1skBw(int side, LayoutDirection layoutDirection) {
            if (WindowInsetsSides.m1152equalsimpl0(side, WindowInsetsSides.INSTANCE.m1166getLeftJoeWqyM())) {
                return LeftSideCalculator;
            }
            if (WindowInsetsSides.m1152equalsimpl0(side, WindowInsetsSides.INSTANCE.m1169getTopJoeWqyM())) {
                return TopSideCalculator;
            }
            if (WindowInsetsSides.m1152equalsimpl0(side, WindowInsetsSides.INSTANCE.m1167getRightJoeWqyM())) {
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m1152equalsimpl0(side, WindowInsetsSides.INSTANCE.m1163getBottomJoeWqyM())) {
                return BottomSideCalculator;
            }
            if (WindowInsetsSides.m1152equalsimpl0(side, WindowInsetsSides.INSTANCE.m1168getStartJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return LeftSideCalculator;
                }
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m1152equalsimpl0(side, WindowInsetsSides.INSTANCE.m1164getEndJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return RightSideCalculator;
                }
                return LeftSideCalculator;
