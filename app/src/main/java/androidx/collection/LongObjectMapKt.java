...
public final class LongObjectMapKt {
    ...
    public static final <V> LongObjectMap<V> longObjectMapOf(long key1, V v) {
        MutableLongObjectMap map = new MutableLongObjectMap(0, 1, null);
        map.set(key1, v);
        return map;
    }

    public static final <V> LongObjectMap<V> longObjectMapOf(long key1, V v, long key2, V v2) {
        MutableLongObjectMap map = new MutableLongObjectMap(0, 1, null);
        map.set(key1, v);
        map.set(key2, v2);
        return map;
    ...
    public static final <V> LongObjectMap<V> longObjectMapOf(long key1, V v, long key2, V v2, long key3, V v3) {
        MutableLongObjectMap map = new MutableLongObjectMap(0, 1, null);
        map.set(key1, v);
        map.set(key2, v2);
        map.set(key3, v3);
    ...
    public static final <V> LongObjectMap<V> longObjectMapOf(long key1, V v, long key2, V v2, long key3, V v3, long key4, V v4) {
        MutableLongObjectMap map = new MutableLongObjectMap(0, 1, null);
        map.set(key1, v);
        map.set(key2, v2);
        map.set(key3, v3);
    ...
    public static final <V> LongObjectMap<V> longObjectMapOf(long key1, V v, long key2, V v2, long key3, V v3, long key4, V v4, long key5, V v5) {
        MutableLongObjectMap map = new MutableLongObjectMap(0, 1, null);
        map.set(key1, v);
        map.set(key2, v2);
        map.set(key3, v3);
    ...
    public static final <V> MutableLongObjectMap<V> mutableLongObjectMapOf(long key1, V v) {
        MutableLongObjectMap<V> mutableLongObjectMap = new MutableLongObjectMap<>(0, 1, null);
        mutableLongObjectMap.set(key1, v);
        return mutableLongObjectMap;
    }

    public static final <V> MutableLongObjectMap<V> mutableLongObjectMapOf(long key1, V v, long key2, V v2) {
        MutableLongObjectMap<V> mutableLongObjectMap = new MutableLongObjectMap<>(0, 1, null);
        mutableLongObjectMap.set(key1, v);
        mutableLongObjectMap.set(key2, v2);
        return mutableLongObjectMap;
    }

    public static final <V> MutableLongObjectMap<V> mutableLongObjectMapOf(long key1, V v, long key2, V v2, long key3, V v3) {
        MutableLongObjectMap<V> mutableLongObjectMap = new MutableLongObjectMap<>(0, 1, null);
        mutableLongObjectMap.set(key1, v);
        mutableLongObjectMap.set(key2, v2);
        mutableLongObjectMap.set(key3, v3);
        return mutableLongObjectMap;
    }

    public static final <V> MutableLongObjectMap<V> mutableLongObjectMapOf(long key1, V v, long key2, V v2, long key3, V v3, long key4, V v4) {
        MutableLongObjectMap<V> mutableLongObjectMap = new MutableLongObjectMap<>(0, 1, null);
        mutableLongObjectMap.set(key1, v);
        mutableLongObjectMap.set(key2, v2);
        mutableLongObjectMap.set(key3, v3);
        mutableLongObjectMap.set(key4, v4);
        return mutableLongObjectMap;
    }

    public static final <V> MutableLongObjectMap<V> mutableLongObjectMapOf(long key1, V v, long key2, V v2, long key3, V v3, long key4, V v4, long key5, V v5) {
        MutableLongObjectMap<V> mutableLongObjectMap = new MutableLongObjectMap<>(0, 1, null);
        mutableLongObjectMap.set(key1, v);
        mutableLongObjectMap.set(key2, v2);
        mutableLongObjectMap.set(key3, v3);
        mutableLongObjectMap.set(key4, v4);
        mutableLongObjectMap.set(key5, v5);
        return mutableLongObjectMap;
    }
    ...
    public static final <V> LongObjectMap<V> buildLongObjectMap(int initialCapacity, Function1<? super MutableLongObjectMap<V>, Unit> builderAction) {
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
        MutableLongObjectMap mutableLongObjectMap = new MutableLongObjectMap(initialCapacity);
        builderAction.invoke(mutableLongObjectMap);
        return mutableLongObjectMap;
    }
}
