...
public final class DisplayCompat {
    ...
    public static RoundedCornerCompat getRoundedCorner(Display display, int position) {
    ...
    public static DisplayShapeCompat getShape(Context context, Display display) {
        ...
        RoundedCornerCompat topLeft = getRoundedCorner(display, 0);
        RoundedCornerCompat topRight = getRoundedCorner(display, 1);
        RoundedCornerCompat bottomRight = getRoundedCorner(display, 2);
        RoundedCornerCompat bottomLeft = getRoundedCorner(display, 3);
        return DisplayShapeCompat.create(workaroundSize.x, workaroundSize.y, false, topLeft != null ? topLeft.getRadius() : 0, topRight != null ? topRight.getRadius() : 0, bottomRight != null ? bottomRight.getRadius() : 0, bottomLeft != null ? bottomLeft.getRadius() : 0);
    }
