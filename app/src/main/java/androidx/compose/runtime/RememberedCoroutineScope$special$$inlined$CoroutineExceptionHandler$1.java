...
public final class RememberedCoroutineScope$special$$inlined$CoroutineExceptionHandler$1 extends AbstractCoroutineContextElement implements CoroutineExceptionHandler {
    ...
    public RememberedCoroutineScope$special$$inlined$CoroutineExceptionHandler$1(CoroutineExceptionHandler.Companion $super_call_param$1, CompositionErrorContextImpl compositionErrorContextImpl, RememberedCoroutineScope rememberedCoroutineScope) {
    ...
    public void handleException(CoroutineContext context, Throwable exception) throws Throwable {
        CompositionErrorContextImpl $this$_get_coroutineContext__u24lambda_u240_u240 = this.$traceContext$inlined;
        $this$_get_coroutineContext__u24lambda_u240_u240.attachComposeStackTrace(exception, this.this$0);
