...
@Metadata(d1 = {"\u0000$\n\u0000\n\u0002\u0010\u000e\n\u0002\b\b\n\u0002\u0010 \n\u0000\n\u0002\u0010\u001e\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002\u001a!\u0010\t\u001a\b\u0012\u0004\u0012\u0002H\u000b0\n\"\u0006\b\u0000\u0010\u000b\u0018\u0001*\b\u0012\u0004\u0012\u00020\r0\fH\u0082\b\u001a\u001b\u0010\t\u001a\b\u0012\u0004\u0012\u0002H\u000b0\n\"\u0006\b\u0000\u0010\u000b\u0018\u0001*\u00020\rH\u0082\b\u001a&\u0010\u000e\u001a\u0004\u0018\u0001H\u000b\"\u0006\b\u0000\u0010\u000b\u0018\u0001*\u00020\r2\b\b\u0002\u0010\u000f\u001a\u00020\u0010H\u0082\b¢\u0006\u0002\u0010\u0011\"\u000e\u0010\u0000\u001a\u00020\u0001X\u0082T¢\u0006\u0002\n\u0000\"\u000e\u0010\u0002\u001a\u00020\u0001X\u0082T¢\u0006\u0002\n\u0000\"\u000e\u0010\u0003\u001a\u00020\u0001X\u0082T¢\u0006\u0002\n\u0000\"\u000e\u0010\u0004\u001a\u00020\u0001X\u0082T¢\u0006\u0002\n\u0000\"\u000e\u0010\u0005\u001a\u00020\u0001X\u0082T¢\u0006\u0002\n\u0000\"\u000e\u0010\u0006\u001a\u00020\u0001X\u0082T¢\u0006\u0002\n\u0000\"\u000e\u0010\u0007\u001a\u00020\u0001X\u0082T¢\u0006\u0002\n\u0000\"\u000e\u0010\b\u001a\u00020\u0001X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0012"}, d2 = {"UPDATE_TRANSITION", "", "ANIMATED_CONTENT", "ANIMATED_VISIBILITY", "ANIMATE_VALUE_AS_STATE", "REMEMBER", "REMEMBER_INFINITE_TRANSITION", "REMEMBER_UPDATED_STATE", "SIZE_ANIMATION_MODIFIER", "findRememberedData", "", "T", "", "Landroidx/compose/ui/tooling/data/Group;", "findData", "includeGrandchildren", "", "(Landroidx/compose/ui/tooling/data/Group;Z)Ljava/lang/Object;", "ui-tooling"}, k = 2, mv = {2, 1, 0}, xi = 48)
public final class AnimationSearch_androidKt {
    ...
    private static final /* synthetic */ <T> List<T> findRememberedData(Collection<? extends Group> collection) {
        ...
        for (Object element$iv$iv$iv2 : $this$mapNotNull$iv2) {
            ...
            Group it4 = PreviewUtils_androidKt.firstOrNull(it3, AnimationSearch_androidKt$findRememberedData$rememberCalls$1$1.INSTANCE);
            if (it4 != null) {
    ...
    */
    private static final /* synthetic */ <T> java.util.List<T> findRememberedData(androidx.compose.ui.tooling.data.Group r31) {
        /*
    ...
    static /* synthetic */ Object findData$default(Group $this$findData_u24default, boolean includeGrandchildren, int i, Object obj) {
        ...
        Collection<Group> children = $this$findData_u24default.getChildren();
        if (includeGrandchildren) {
            Collection<Group> $this$flatMap$iv = children;
            Collection destination$iv$iv = new ArrayList();
            ...
            children = CollectionsKt.plus((Collection) children, destination$iv$iv);
        }
        Collection<Group> $this$flatMap$iv2 = children;
        Collection destination$iv$iv2 = new ArrayList();
        for (Object element$iv$iv2 : $this$flatMap$iv2) {
            Group it = (Group) element$iv$iv2;
            Iterable list$iv$iv2 = it.getData();
    ...
    private static final /* synthetic */ <T> T findData(Group $this$findData, boolean includeGrandchildren) {
        ...
        Collection<Group> children = $this$findData.getChildren();
        if (includeGrandchildren) {
            Collection<Group> $this$flatMap$iv = children;
            Collection destination$iv$iv = new ArrayList();
            for (Object element$iv$iv : $this$flatMap$iv) {
