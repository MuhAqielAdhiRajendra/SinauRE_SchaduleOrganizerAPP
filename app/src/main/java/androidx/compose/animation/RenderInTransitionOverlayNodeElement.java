...
public final class RenderInTransitionOverlayNodeElement extends ModifierNodeElement<RenderInTransitionOverlayNode> {
    ...
    public RenderInTransitionOverlayNodeElement(SharedTransitionScopeImpl sharedTransitionScope, Function0<Boolean> function0, float zIndexInOverlay) {
    ...
    public boolean equals(Object other) {
        if ((other instanceof RenderInTransitionOverlayNodeElement) && Intrinsics.areEqual(this.sharedTransitionScope, ((RenderInTransitionOverlayNodeElement) other).sharedTransitionScope) && this.renderInOverlay == ((RenderInTransitionOverlayNodeElement) other).renderInOverlay) {
            return (this.zIndexInOverlay > ((RenderInTransitionOverlayNodeElement) other).zIndexInOverlay ? 1 : (this.zIndexInOverlay == ((RenderInTransitionOverlayNodeElement) other).zIndexInOverlay ? 0 : -1)) == 0;
        }
        return false;
    }
