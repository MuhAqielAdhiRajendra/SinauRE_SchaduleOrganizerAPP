...
public final class SendKt {
    ...
    public static final ImageVector getSend(Icons.AutoMirrored.Outlined $this$Send) {
        if (_send != null) {
        ...
        ImageVector.Builder $this$_get_Send__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Outlined.Send", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        _send = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_Send__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
