...
public final class RvHookupKt {
    ...
    public static final ImageVector getRvHookup(Icons.Filled $this$RvHookup) {
        if (_rvHookup != null) {
        ...
        ImageVector.Builder $this$_get_RvHookup__u24lambda_u241 = new ImageVector.Builder("Filled.RvHookup", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
