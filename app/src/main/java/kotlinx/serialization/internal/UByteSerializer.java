...
public final class UByteSerializer implements KSerializer<UByte> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return UByte.m8941boximpl(m10522deserializeWa3L5BU(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object value) {
        m10523serializeEK6454(encoder, ((UByte) value).getData());
    }
    ...
    public void m10523serializeEK6454(Encoder encoder, byte value) {
    ...
    public byte m10522deserializeWa3L5BU(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return UByte.m8947constructorimpl(decoder.decodeInline(getDescriptor()).decodeByte());
    }
}
