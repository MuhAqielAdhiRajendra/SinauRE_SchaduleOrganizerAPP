...
public final class TypographyTokensKt {
    private static final LineHeightStyle DefaultLineHeightStyle = new LineHeightStyle(LineHeightStyle.Alignment.INSTANCE.m7970getCenterPIaL0Z0(), LineHeightStyle.Trim.INSTANCE.m7995getNoneEVpEnUU(), (DefaultConstructorMarker) null);
    private static final TextStyle DefaultTextStyle = TextStyle.m7586copyp1EtxEg$default(TextStyle.INSTANCE.getDefault(), 0, 0, null, null, null, null, null, 0, null, null, null, 0, null, null, null, 0, 0, 0, null, DefaultPlatformTextStyle_androidKt.defaultPlatformTextStyle(), DefaultLineHeightStyle, 0, 0, null, 15204351, null);
