...
public final class UpdateKt {
    ...
    public static final ImageVector getUpdate(Icons.Outlined $this$Update) {
        if (_update != null) {
        ...
        ImageVector.Builder $this$_get_Update__u24lambda_u241 = new ImageVector.Builder("Outlined.Update", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
