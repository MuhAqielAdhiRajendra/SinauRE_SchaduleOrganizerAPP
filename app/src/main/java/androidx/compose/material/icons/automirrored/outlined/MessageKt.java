...
public final class MessageKt {
    ...
    public static final ImageVector getMessage(Icons.AutoMirrored.Outlined $this$Message) {
        if (_message != null) {
        ...
        ImageVector.Builder $this$_get_Message__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Outlined.Message", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
