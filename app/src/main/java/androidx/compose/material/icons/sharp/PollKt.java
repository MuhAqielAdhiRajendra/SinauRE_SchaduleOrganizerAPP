...
public final class PollKt {
    ...
    public static final ImageVector getPoll(Icons.Sharp $this$Poll) {
        if (_poll != null) {
        ...
        ImageVector.Builder $this$_get_Poll__u24lambda_u241 = new ImageVector.Builder("Sharp.Poll", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
