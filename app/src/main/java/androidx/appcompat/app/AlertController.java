...
class AlertController {
    ...
    private void setupButtons(ViewGroup buttonPanel) {
        int whichButtons = 0;
        this.mButtonPositive = (Button) buttonPanel.findViewById(android.R.id.button1);
        ...
        this.mButtonNegative = (Button) buttonPanel.findViewById(android.R.id.button2);
        ...
        this.mButtonNeutral = (Button) buttonPanel.findViewById(android.R.id.button3);
    ...
    public static class AlertParams {
        ...
        public void apply(AlertController dialog) {
            ...
            if (this.mNegativeButtonText != null || this.mNegativeButtonIcon != null) {
                dialog2.setButton(-2, this.mNegativeButtonText, this.mNegativeButtonListener, null, this.mNegativeButtonIcon);
            }
            if (this.mNeutralButtonText != null || this.mNeutralButtonIcon != null) {
                dialog2.setButton(-3, this.mNeutralButtonText, this.mNeutralButtonListener, null, this.mNeutralButtonIcon);
            }
            if (this.mItems != null || this.mCursor != null || this.mAdapter != null) {
                createListView(dialog2);
            }
            if (this.mView != null) {
                boolean z = this.mViewSpacingSpecified;
                View view = this.mView;
                if (z) {
                    dialog2.setView(view, this.mViewSpacingLeft, this.mViewSpacingTop, this.mViewSpacingRight, this.mViewSpacingBottom);
                    return;
                } else {
        ...
        private void createListView(AlertController dialog) {
            final AlertController dialog2;
            int layout;
            ListAdapter adapter;
            final RecycleListView listView = (RecycleListView) this.mInflater.inflate(dialog.mListLayout, (ViewGroup) null);
            if (this.mIsMultiChoice) {
                if (this.mCursor == null) {
                    adapter = new ArrayAdapter<CharSequence>(this.mContext, dialog.mMultiChoiceItemLayout, android.R.id.text1, this.mItems) { // from class: androidx.appcompat.app.AlertController.AlertParams.1
                    ...
                    adapter = new CursorAdapter(this.mContext, this.mCursor, false) { // from class: androidx.appcompat.app.AlertController.AlertParams.2
                        ...
                        public View newView(Context context, Cursor cursor, ViewGroup parent) {
                            return AlertParams.this.mInflater.inflate(dialog2.mMultiChoiceItemLayout, parent, false);
                        }
                    };
                }
            } else {
                ...
                if (this.mIsSingleChoice) {
                    ...
                    int layout2 = dialog2.mListItemLayout;
                    layout = layout2;
                }
                if (this.mCursor != null) {
                    ...
                    adapter = new CheckedItemAdapter(this.mContext, layout, android.R.id.text1, this.mItems);
                } else {
            ...
            if (this.mOnClickListener != null) {
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.app.AlertController.AlertParams.3
                    ...
                    public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                        AlertParams.this.mOnClickListener.onClick(dialog2.mDialog, position);
                        if (!AlertParams.this.mIsSingleChoice) {
                            dialog2.mDialog.dismiss();
                        }
                    }
                });
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.app.AlertController.AlertParams.4
                    ...
                    public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                        ...
                        AlertParams.this.mOnCheckboxClickListener.onClick(dialog2.mDialog, position, listView.isItemChecked(position));
                    }
                });
            }
