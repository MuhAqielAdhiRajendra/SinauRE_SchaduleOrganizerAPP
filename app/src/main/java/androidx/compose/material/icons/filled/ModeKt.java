...
public final class ModeKt {
    ...
    public static final ImageVector getMode(Icons.Filled $this$Mode) {
        ...
        ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_Mode__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
