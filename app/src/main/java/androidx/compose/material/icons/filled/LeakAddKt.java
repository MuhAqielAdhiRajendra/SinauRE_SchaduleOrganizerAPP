...
public final class LeakAddKt {
    ...
    public static final ImageVector getLeakAdd(Icons.Filled $this$LeakAdd) {
        if (_leakAdd != null) {
        ...
        ImageVector.Builder $this$_get_LeakAdd__u24lambda_u241 = new ImageVector.Builder("Filled.LeakAdd", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
