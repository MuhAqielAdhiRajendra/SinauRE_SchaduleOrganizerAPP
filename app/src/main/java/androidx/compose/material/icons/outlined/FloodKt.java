...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_flood", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Flood", "Landroidx/compose/material/icons/Icons$Outlined;", "getFlood", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class FloodKt {
    ...
    public static final ImageVector getFlood(Icons.Outlined $this$Flood) {
        ...
        ImageVector.Builder $this$_get_Flood__u24lambda_u242 = new ImageVector.Builder("Outlined.Flood", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.moveTo(10.42f, 4.41f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineToRelative(5.74f, 2.09f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineToRelative(2.15f, 8.02f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveToRelative(-1.54f, 0.11f, -1.82f, 0.89f, -2.85f, 0.96f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineToRelative(-1.42f, -5.31f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineToRelative(-3.86f, 1.04f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineToRelative(0.91f, 3.39f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveToRelative(-1.12f, 0.25f, -1.41f, 0.9f, -2.42f, 0.9f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveToRelative(-0.18f, 0.0f, -0.33f, -0.02f, -0.45f, -0.05f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineTo(6.5f, 9.09f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineTo(10.42f, 4.41f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
