...
public final class AttachEmailKt {
    ...
    public static final ImageVector getAttachEmail(Icons.Rounded $this$AttachEmail) {
        ...
        ImageVector.Builder $this$_get_AttachEmail__u24lambda_u242 = new ImageVector.Builder("Rounded.AttachEmail", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(1.9f, 2.0f, 1.01f, 2.9f, 1.01f, 4.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(11.53f, 10.67f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.32f, 0.2f, -0.74f, 0.2f, -1.06f, 0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(3.4f, 6.25f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(3.15f, 6.09f, 3.0f, 5.82f, 3.0f, 5.53f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(18.27f, 4.46f, 19.0f, 4.86f, 19.0f, 5.53f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, 0.29f, -0.15f, 0.56f, -0.4f, 0.72f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(11.53f, 10.67f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_AttachEmail__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.moveTo(22.0f, 14.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.reflectiveCurveTo(15.0f, 12.12f, 15.0f, 13.5f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.verticalLineToRelative(-3.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveTo(23.0f, 14.45f, 22.55f, 14.0f, 22.0f, 14.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
        _attachEmail = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_AttachEmail__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv2.getNodes(), pathFillType$iv2, "", fill$iv$iv2, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv2, strokeLineJoin$iv$iv2, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
        ImageVector imageVector2 = _attachEmail;
