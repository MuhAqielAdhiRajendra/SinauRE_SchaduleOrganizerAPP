...
public final class FloatingToolbarTokens {
    ...
    private static final float ContainerBetweenSpace = Dp.m8150constructorimpl((float) 4.0d);
    private static final float ContainerExternalPadding = Dp.m8150constructorimpl((float) 16.0d);
    private static final float ContainerHeight = Dp.m8150constructorimpl((float) 64.0d);
    private static final float ContainerLeadingSpace = Dp.m8150constructorimpl((float) 8.0d);
    private static final ShapeKeyTokens ContainerShape = ShapeKeyTokens.CornerFull;
    private static final float ContainerTrailingSpace = Dp.m8150constructorimpl((float) 8.0d);
