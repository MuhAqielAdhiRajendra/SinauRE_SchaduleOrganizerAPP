...
public final class SavedStateConfigurationKt {
    ...
    static {
        ...
        builder$iv.contextual(Reflection.getOrCreateKotlinClass(Bundle.class), SavedStateSerializer.INSTANCE);
        builder$iv.contextual(Reflection.getOrCreateKotlinClass(MutableStateFlow.class), new Function1() { // from class: androidx.savedstate.serialization.SavedStateConfigurationKt$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return SavedStateConfigurationKt.DEFAULT_SERIALIZERS_MODULE$lambda$1$lambda$0((List) obj);
            }
        });
        DEFAULT_SERIALIZERS_MODULE = SerializersModuleKt.plus(builder$iv.build(), SavedStateConfiguration_androidKt.getDefaultSerializersModuleOnPlatform());
    }
