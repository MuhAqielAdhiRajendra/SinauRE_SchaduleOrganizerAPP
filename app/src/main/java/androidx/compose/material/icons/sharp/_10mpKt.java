...
public final class _10mpKt {
    ...
    public static final ImageVector get_10mp(Icons.Sharp $this$_10mp) {
        if (__10mp != null) {
        ...
        ImageVector.Builder $this$_get__10mp__u24lambda_u241 = new ImageVector.Builder("Sharp._10mp", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(16.5f, 5.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(6.0f);
