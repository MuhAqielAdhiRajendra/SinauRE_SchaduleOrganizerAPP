...
public final class CellTowerKt {
    ...
    public static final ImageVector getCellTower(Icons.Outlined $this$CellTower) {
        if (_cellTower != null) {
        ...
        ImageVector.Builder $this$_get_CellTower__u24lambda_u245 = new ImageVector.Builder("Outlined.CellTower", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
