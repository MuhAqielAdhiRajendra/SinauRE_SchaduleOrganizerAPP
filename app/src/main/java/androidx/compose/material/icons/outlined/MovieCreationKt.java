...
public final class MovieCreationKt {
    ...
    public static final ImageVector getMovieCreation(Icons.Outlined $this$MovieCreation) {
        ...
        ImageVector.Builder $this$_get_MovieCreation__u24lambda_u241 = new ImageVector.Builder("Outlined.MovieCreation", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(5.76f, 10.0f);
