...
final class AnimationDataConverter implements TwoWayConverter<AnimationData, AnimationVector4D> {
    ...
    static final AnimationVector4D _get_convertToVector_$lambda$0(AnimationData it) {
        float zoom = it.getZoom();
        long arg0$iv = it.m457getOffsetF1C5BW0();
        int bits$iv$iv$iv = (int) (arg0$iv >> 32);
        float fIntBitsToFloat = Float.intBitsToFloat(bits$iv$iv$iv);
        long arg0$iv2 = it.m457getOffsetF1C5BW0();
        int bits$iv$iv$iv2 = (int) (4294967295L & arg0$iv2);
        return new AnimationVector4D(zoom, fIntBitsToFloat, Float.intBitsToFloat(bits$iv$iv$iv2), it.getDegrees());
    }
    ...
    static final AnimationData _get_convertFromVector_$lambda$0(AnimationVector4D it) {
        float v1 = it.getV1();
        float x$iv = it.getV2();
        float y$iv = it.getV3();
        long v1$iv$iv = Float.floatToRawIntBits(x$iv);
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
        return new AnimationData(v1, Offset.m5060constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv)), it.getV4(), null);
    }
