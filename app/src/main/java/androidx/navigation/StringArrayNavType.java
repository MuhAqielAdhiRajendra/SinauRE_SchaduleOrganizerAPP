...
public final class StringArrayNavType extends CollectionNavType<String[]> {
    ...
    public void put(Bundle bundle, String key, String[] value) {
        ...
        if (value != null) {
            SavedStateWriter.m8642putStringArrayimpl($this$put_u24lambda_u240, key, value);
        } else {
    ...
    public String[] get(Bundle bundle, String key) {
        ...
        return SavedStateReader.m8594getStringArrayimpl($this$get_u24lambda_u241, key);
    }
