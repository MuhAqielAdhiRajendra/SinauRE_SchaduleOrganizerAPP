...
public final class ArrowBackKt {
    ...
    public static final ImageVector getArrowBack(Icons.AutoMirrored.Rounded $this$ArrowBack) {
        if (_arrowBack != null) {
        ...
        ImageVector.Builder $this$_get_ArrowBack__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Rounded.ArrowBack", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
