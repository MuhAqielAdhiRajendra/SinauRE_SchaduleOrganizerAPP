...
final class TooltipCaretShape implements Shape {
    ...
    public Outline mo342createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        ...
        Outline tooltipOutline = this.tooltipShape.mo342createOutlinePq9zytI(size, layoutDirection, density);
        Outline caretOutline = this.caretShape.mo342createOutlinePq9zytI(size, layoutDirection, density);
        if (tooltipOutline instanceof Outline.Generic) {
            Path.m5597addPathUv8p0NA$default(this.tooltipPath, ((Outline.Generic) tooltipOutline).getPath(), 0L, 2, null);
        ...
        if (caretOutline instanceof Outline.Generic) {
            Path.m5597addPathUv8p0NA$default(this.caretPath, ((Outline.Generic) caretOutline).getPath(), 0L, 2, null);
        ...
        this.caretPath.mo5204transform58bKbWc(this.transformationMatrix.getValue().m5580unboximpl());
        this.combinedPath.mo5202opN5in7k0(this.tooltipPath, this.caretPath, PathOperation.INSTANCE.m5622getUnionb3I0S0c());
