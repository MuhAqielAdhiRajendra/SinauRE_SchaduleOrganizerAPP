...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        static {
            ...
            ACTION_SHOW_TEXT_SUGGESTIONS = new AccessibilityActionCompat(accessibilityAction, R.id.accessibilityActionShowTextSuggestions, null, null, null);
    ...
    public static class CollectionItemInfoCompat {
        ...
        public static final class Builder {
            ...
            public Builder setSortDirection(int sortDirection) {
    ...
    public static final class SelectionPositionCompat {
        ...
        public SelectionPositionCompat(AccessibilityNodeInfoCompat node, int offset) {
            if (BuildCompat.isAtLeastB_1()) {
                this.mPosition = new AccessibilityNodeInfo.SelectionPosition(node.unwrap(), offset);
            } else {
                this.mPosition = null;
            }
        }

        public SelectionPositionCompat(View view, int offset) {
            if (BuildCompat.isAtLeastB_1()) {
                this.mPosition = new AccessibilityNodeInfo.SelectionPosition(view, offset);
            } else {
                this.mPosition = null;
            }
        }

        public SelectionPositionCompat(View view, int virtualDescendantId, int offset) {
            if (BuildCompat.isAtLeastB_1()) {
                this.mPosition = new AccessibilityNodeInfo.SelectionPosition(view, virtualDescendantId, offset);
            } else {
                this.mPosition = null;
            }
        }

        public SelectionPositionCompat(AccessibilityNodeInfo.SelectionPosition position) {
            if (BuildCompat.isAtLeastB_1()) {
        ...
        public int hashCode() {
            if (!BuildCompat.isAtLeastB_1() || this.mPosition == null) {
                return 0;
            }
        ...
        public boolean equals(Object other) {
            ...
            return this.mPosition.equals(other);
        }
    }
    ...
    public static final class SelectionCompat {
        ...
        public SelectionCompat(SelectionPositionCompat start, SelectionPositionCompat end) {
            if (BuildCompat.isAtLeastB_1()) {
                this.mSelection = new AccessibilityNodeInfo.Selection(start.mPosition, end.mPosition);
            } else {
        ...
        public int hashCode() {
            if (!BuildCompat.isAtLeastB_1() || this.mSelection == null) {
                return 0;
            }
            return this.mSelection.hashCode();
        }
        ...
        public boolean equals(Object obj) {
            ...
            return this.mSelection.equals(obj);
        }
    }
    ...
    public void setExpandedState(int state) {
        ...
        AccessibilityNodeInfo accessibilityNodeInfo = this.mInfo;
        if (i >= 36) {
            Api36Impl.setExpandedState(accessibilityNodeInfo, state);
        } else {
            accessibilityNodeInfo.getExtras().putInt(EXPANDED_STATE_KEY, state);
        }
    }
    ...
    public void getBoundsInWindow(Rect outBounds) {
        ...
        AccessibilityNodeInfo accessibilityNodeInfo = this.mInfo;
        if (i >= 34) {
            Api34Impl.getBoundsInWindow(accessibilityNodeInfo, outBounds);
            return;
        }
        Rect extraBounds = (Rect) accessibilityNodeInfo.getExtras().getParcelable(BOUNDS_IN_WINDOW_KEY);
        if (extraBounds != null) {
    ...
    public void setBoundsInWindow(Rect bounds) {
        ...
        AccessibilityNodeInfo accessibilityNodeInfo = this.mInfo;
        if (i >= 34) {
            Api34Impl.setBoundsInWindow(accessibilityNodeInfo, bounds);
        } else {
            accessibilityNodeInfo.getExtras().putParcelable(BOUNDS_IN_WINDOW_KEY, bounds);
        }
    }
    ...
    public void setChecked(int checked) {
        if (Build.VERSION.SDK_INT < 36) {
            if (checked == 1 || checked == 2 || checked == 0) {
                this.mInfo.setChecked(checked == 1);
                this.mInfo.getExtras().putInt(CHECKED_KEY, checked);
                return;
            }
            throw new IllegalArgumentException("Unknown checked argument: " + checked);
        }
        Api36Impl.setChecked(this.mInfo, checked);
    }
    ...
    public void setFieldRequired(boolean required) {
        ...
        AccessibilityNodeInfo accessibilityNodeInfo = this.mInfo;
        if (i >= 36) {
            Api36Impl.setFieldRequired(accessibilityNodeInfo, required);
        } else {
            accessibilityNodeInfo.getExtras().putBoolean(IS_REQUIRED_KEY, required);
        }
    }
    ...
    public void setMinDurationBetweenContentChangesMillis(long duration) {
        ...
        AccessibilityNodeInfo accessibilityNodeInfo = this.mInfo;
        if (i >= 34) {
            Api34Impl.setMinDurationBetweenContentChangeMillis(accessibilityNodeInfo, duration);
        } else {
            accessibilityNodeInfo.getExtras().putLong(MIN_DURATION_BETWEEN_CONTENT_CHANGES_KEY, duration);
        }
    }
    ...
    public void setStateDescription(CharSequence stateDescription) {
        ...
        AccessibilityNodeInfo accessibilityNodeInfo = this.mInfo;
        if (i >= 30) {
            Api30Impl.setStateDescription(accessibilityNodeInfo, stateDescription);
        } else {
            accessibilityNodeInfo.getExtras().putCharSequence(STATE_DESCRIPTION_KEY, stateDescription);
        }
    }
    ...
    public void setUniqueId(String uniqueId) {
        ...
        AccessibilityNodeInfo accessibilityNodeInfo = this.mInfo;
        if (i >= 33) {
            Api33Impl.setUniqueId(accessibilityNodeInfo, uniqueId);
        } else {
            accessibilityNodeInfo.getExtras().putString(UNIQUE_ID_KEY, uniqueId);
        }
    }
    ...
    public void setContainerTitle(CharSequence containerTitle) {
        ...
        AccessibilityNodeInfo accessibilityNodeInfo = this.mInfo;
        if (i >= 34) {
            Api34Impl.setContainerTitle(accessibilityNodeInfo, containerTitle);
        } else {
            accessibilityNodeInfo.getExtras().putCharSequence(CONTAINER_TITLE_KEY, containerTitle);
        }
    }
    ...
    public void setHintText(CharSequence hintText) {
        ...
        if (i >= 26) {
            ...
            accessibilityNodeInfo.getExtras().putCharSequence(HINT_TEXT_KEY, hintText);
        }
    }
    ...
    public void addLabeledBy(View root, int virtualDescendantId) {
        if (Build.VERSION.SDK_INT < 36) {
            ...
            Api36Impl.addLabeledBy(this.mInfo, root, virtualDescendantId);
        }
    }
    ...
    public boolean removeLabeledBy(View label) {
        return removeLabeledBy(label, -1);
    }
    ...
    public boolean removeLabeledBy(View root, int virtualDescendantId) {
        ...
        return Api36Impl.removeLabeledBy(this.mInfo, root, virtualDescendantId);
    }
    ...
    public void setTooltipText(CharSequence tooltipText) {
        ...
        if (i >= 28) {
            ...
            accessibilityNodeInfo.getExtras().putCharSequence(TOOLTIP_TEXT_KEY, tooltipText);
        }
    }
    ...
    public void setPaneTitle(CharSequence paneTitle) {
        ...
        AccessibilityNodeInfo accessibilityNodeInfo = this.mInfo;
        if (i >= 28) {
            accessibilityNodeInfo.setPaneTitle(paneTitle);
        } else {
            accessibilityNodeInfo.getExtras().putCharSequence(PANE_TITLE_KEY, paneTitle);
        }
    }
    ...
    public void setSelection(SelectionCompat selection) {
        if (BuildCompat.isAtLeastB_1()) {
            AccessibilityNodeInfo accessibilityNodeInfo = this.mInfo;
            if (selection == null) {
                accessibilityNodeInfo.setSelection(null);
            } else {
                accessibilityNodeInfo.setSelection(selection.mSelection);
            }
        }
    }
    ...
    public void setSupplementalDescription(CharSequence supplementalDescription) {
        ...
        AccessibilityNodeInfo accessibilityNodeInfo = this.mInfo;
        if (i >= 36) {
            Api36Impl.setSupplementalDescription(accessibilityNodeInfo, supplementalDescription);
        } else {
            accessibilityNodeInfo.getExtras().putCharSequence(SUPPLEMENTAL_DESCRIPTION_KEY, supplementalDescription);
        }
    }
    ...
    public String toString() {
        ...
        builder.append("; expandedState: ").append(getExpandedStateSymbolicName(getExpandedState()));
    ...
    static String getExpandedStateSymbolicName(int state) {
        switch (state) {
            case 0:
                return "UNDEFINED";
            case 1:
    ...
    private static class Api35Impl {
        ...
        public static CollectionInfoCompat buildCollectionInfoCompat(int rowCount, int columnCount, boolean hierarchical, int selectionMode, int itemCount, int importantForAccessibilityItemCount) {
            return new CollectionInfoCompat(new AccessibilityNodeInfo.CollectionInfo.Builder().setRowCount(rowCount).setColumnCount(columnCount).setHierarchical(hierarchical).setSelectionMode(selectionMode).setItemCount(itemCount).setImportantForAccessibilityItemCount(importantForAccessibilityItemCount).build());
        }
    }
    ...
    private static class Api36Impl {
        ...
        public static void setExpandedState(AccessibilityNodeInfo info, int state) {
        ...
        public static void setSupplementalDescription(AccessibilityNodeInfo info, CharSequence supplementalDescription) {
            info.setSupplementalDescription(supplementalDescription);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static int getChecked(AccessibilityNodeInfo info) {
            return info.getChecked();
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static void setChecked(AccessibilityNodeInfo info, int checked) {
            info.setChecked(checked);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static void addLabeledBy(AccessibilityNodeInfo info, View root, int virtualDescendantId) {
            info.addLabeledBy(root, virtualDescendantId);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static List<AccessibilityNodeInfoCompat> getLabeledByList(AccessibilityNodeInfo info) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static boolean removeLabeledBy(AccessibilityNodeInfo info, View root, int virtualDescendantId) {
    ...
    private static class Api36MinorImpl {
        ...
        public static CollectionItemInfoCompat buildCollectionItemInfoCompat(boolean heading, int columnIndex, int rowIndex, int columnSpan, int rowSpan, boolean selected, String rowTitle, String columnTitle, int sortDirection) {
            return new CollectionItemInfoCompat(new AccessibilityNodeInfo.CollectionItemInfo.Builder().setHeading(heading).setColumnIndex(columnIndex).setRowIndex(rowIndex).setColumnSpan(columnSpan).setRowSpan(rowSpan).setSelected(selected).setRowTitle(rowTitle).setColumnTitle(columnTitle).setSortDirection(sortDirection).build());
        }

        public static int getCollectionItemSortDirection(Object info) {
