...
public final class TransparentObserverSnapshot extends Snapshot {
    ...
    public TransparentObserverSnapshot(Snapshot parentSnapshot, Function1<Object, Unit> function1, boolean mergeParentObservers, boolean ownsParentSnapshot) {
        ...
        this.readObserver = SnapshotKt.mergedReadObserver(function1, (snapshot == null || (readObserver = snapshot.getReadObserver()) == null) ? SnapshotKt.globalSnapshot.getReadObserver() : readObserver, this.mergeParentObservers);
