    ...
    public static void solvingPass(ConstraintWidgetContainer layout, BasicMeasure.Measurer measurer) {
        ...
        for (int i8 = 0; i8 < count; i8++) {
            ...
            if (child7.isMeasureRequested() && canMeasure(0, child7)) {
                ConstraintWidgetContainer.measure(0, child7, measurer, sMeasure, BasicMeasure.Measure.SELF_DIMENSIONS);
        ...
        if (left.getDependents() == null || !left.hasFinalValue()) {
            ...
            while (it.hasNext()) {
                ...
                if (!widget.isMeasureRequested() || !canMeasure) {
                    ...
                    f2 = 0.0f;
                    ConstraintWidgetContainer.measure(level + 1, widget, measurer, measure2, BasicMeasure.Measure.SELF_DIMENSIONS);
                }
        ...
        if (right.getDependents() != null && right.hasFinalValue()) {
            ...
            while (it2.hasNext()) {
                ...
                if (widget2.isMeasureRequested() && canMeasure2) {
                    ...
                    ConstraintWidgetContainer.measure(level + 1, widget2, measurer, measure3, BasicMeasure.Measure.SELF_DIMENSIONS);
                }
                ...
                if (widget2.getHorizontalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || canMeasure2) {
                    ...
                    if (widget2.getVisibility() == 8 || (widget2.mMatchConstraintDefaultWidth == 0 && widget2.getDimensionRatio() == f)) {
    ...
    private static void verticalSolvingPass(int level, ConstraintWidget layout, BasicMeasure.Measurer measurer) {
        ...
        if (bottom.getDependents() != null && bottom.hasFinalValue()) {
            ...
            while (it2.hasNext()) {
                ...
                } else if (widget2.getVerticalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && widget2.mMatchConstraintMaxHeight >= 0 && widget2.mMatchConstraintMinHeight >= 0 && (widget2.getVisibility() == 8 || (widget2.mMatchConstraintDefaultHeight == 0 && widget2.getDimensionRatio() == f))) {
        ...
        if (baseline.getDependents() != null && baseline.hasFinalValue()) {
            ...
            for (ConstraintAnchor first3 : baseline.getDependents()) {
                ...
                if (widget3.isMeasureRequested() && canMeasure3) {
                    ...
                    ConstraintWidgetContainer.measure(level + 1, widget3, measurer, measure4, BasicMeasure.Measure.SELF_DIMENSIONS);
                }
        ...
        while (true) {
            ...
            if (!done2) {
                ...
                if (numVisibleWidgets == 1) {
                    ...
                    int p1 = (int) (startPoint + 0.5f + (gap2 * bias));
                    if (orientation == 0) {
