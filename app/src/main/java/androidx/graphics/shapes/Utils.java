...
public final class Utils {
    ...
    public static final long directionVector(float x, float y) {
        ...
        if (d > 0.0f) {
            return FloatFloatPair.m10constructorimpl(x / d, y / d);
        }
    ...
    public static final long directionVector(float angleRadians) {
        return FloatFloatPair.m10constructorimpl((float) Math.cos(angleRadians), (float) Math.sin(angleRadians));
    }
    ...
    public static /* synthetic */ long m8495radialToCartesianL6JJ3z0$default(float f, float f2, long j, int i, Object obj) {
        if ((i & 4) != 0) {
            j = Zero;
        }
        return m8494radialToCartesianL6JJ3z0(f, f2, j);
    }

    /* JADX INFO: renamed from: radialToCartesian-L6JJ3z0, reason: not valid java name */
    public static final long m8494radialToCartesianL6JJ3z0(float radius, float angleRadians, long center) {
        return PointKt.m8479plusybeJwSQ(PointKt.m8481timesso9K2fw(directionVector(angleRadians), radius), center);
    }

    /* JADX INFO: renamed from: rotate90-DnnuFBc, reason: not valid java name */
    public static final long m8496rotate90DnnuFBc(long $this$rotate90_u2dDnnuFBc) {
        return FloatFloatPair.m10constructorimpl(-PointKt.m8476getYDnnuFBc($this$rotate90_u2dDnnuFBc), PointKt.m8475getXDnnuFBc($this$rotate90_u2dDnnuFBc));
    }
    ...
    public static final float findMinimum(float v0, float v1, float tolerance, FindMinimumFunction f) {
        ...
        float b = v1;
        while (b - a > tolerance) {
            float c1 = ((2.0f * a) + b) / 3.0f;
            float c2 = ((2.0f * b) + a) / 3.0f;
