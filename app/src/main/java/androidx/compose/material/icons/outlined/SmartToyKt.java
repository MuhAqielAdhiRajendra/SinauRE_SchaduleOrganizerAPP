...
public final class SmartToyKt {
    ...
    public static final ImageVector getSmartToy(Icons.Outlined $this$SmartToy) {
        if (_smartToy != null) {
        ...
        ImageVector.Builder $this$_get_SmartToy__u24lambda_u241 = new ImageVector.Builder("Outlined.SmartToy", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(-4.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(1.66f, 0.0f, 3.0f, -1.34f, 3.0f, -3.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(21.66f, 9.0f, 20.0f, 9.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(8.17f, 10.0f, 9.0f, 10.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(16.5f, 10.67f, 16.5f, 11.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
