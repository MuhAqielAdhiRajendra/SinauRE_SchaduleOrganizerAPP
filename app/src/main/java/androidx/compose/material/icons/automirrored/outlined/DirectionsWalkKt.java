...
public final class DirectionsWalkKt {
    ...
    public static final ImageVector getDirectionsWalk(Icons.AutoMirrored.Outlined $this$DirectionsWalk) {
        ...
        ImageVector.Builder $this$_get_DirectionsWalk__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Outlined.DirectionsWalk", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
