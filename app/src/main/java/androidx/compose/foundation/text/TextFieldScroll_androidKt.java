...
public final class TextFieldScroll_androidKt {
    ...
    public static final OverscrollEffect rememberTextFieldOverscrollEffect(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-73012098, $changed, -1, "androidx.compose.foundation.text.rememberTextFieldOverscrollEffect (TextFieldScroll.android.kt:37)");
        }
        if (ComposerKt.isTraceInProgress()) {
