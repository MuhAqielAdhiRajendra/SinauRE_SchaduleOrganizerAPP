...
public final class PointerHoverIconModifierNode extends HoverIconModifierNode {
    ...
    public boolean mo6554isRelevantPointerTypeuerMTgs(int pointerType) {
        return (PointerType.m6723equalsimpl0(pointerType, PointerType.INSTANCE.m6729getStylusT8wyACA()) || PointerType.m6723equalsimpl0(pointerType, PointerType.INSTANCE.m6727getEraserT8wyACA())) ? false : true;
    }
