...
public final class _360Kt {
    ...
    public static final ImageVector get_360(Icons.AutoMirrored.Rounded $this$_360) {
        if (__360 != null) {
        ...
        ImageVector.Builder $this$_get__360__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Rounded._360", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(1.52f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, 0.66f, -1.2f, 1.68f, -3.32f, 2.34f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.41f, 0.13f, -0.68f, 0.51f, -0.68f, 0.94f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, 0.67f, 0.65f, 1.16f, 1.28f, 0.96f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(20.11f, 15.36f, 22.0f, 13.79f, 22.0f, 12.0f);
