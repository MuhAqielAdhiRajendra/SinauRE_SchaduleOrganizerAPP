...
public final class NavigationRailExpandedTokens {
    ...
    private static final float ContainerWidthMaximum = Dp.m8150constructorimpl((float) 360.0d);
    private static final float ContainerWidthMinimum = Dp.m8150constructorimpl((float) 220.0d);
