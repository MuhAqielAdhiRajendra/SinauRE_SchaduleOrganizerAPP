...
public class MaterialDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void setDividerColor(int color) {
        ...
        this.dividerDrawable.setTint(color);
    }
    ...
    private void drawForHorizontalOrientation(Canvas canvas, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (shouldDrawDivider(parent, child)) {
                ...
                if (isRtl) {
                    left = rect.left + translationX;
                    right = this.thickness + left;
                } else {
                    int left2 = rect.right;
                    right = left2 + translationX;
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (shouldDrawDivider(parent, view)) {
            ...
            boolean zIsLayoutRtl = ViewUtils.isLayoutRtl(parent);
