...
public class CLContainer extends CLElement {
    ...
    public void remove(String name) {
        ...
        Iterator<CLElement> it = toRemove.iterator();
        while (it.hasNext()) {
            this.mElements.remove(it.next());
        }
    }
    ...
    public CLContainer mo8408clone() {
        CLContainer clone = (CLContainer) super.mo8408clone();
        ArrayList<CLElement> clonedArray = new ArrayList<>(this.mElements.size());
        for (CLElement element : this.mElements) {
            CLElement elementClone = element.mo8408clone();
