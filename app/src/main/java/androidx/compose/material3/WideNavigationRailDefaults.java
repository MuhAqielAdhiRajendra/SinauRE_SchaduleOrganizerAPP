...
public final class WideNavigationRailDefaults {
    ...
    /* JADX INFO: renamed from: colors-zjMxDiM */
    public final WideNavigationRailColors m3393colorszjMxDiM(long containerColor, long contentColor, long modalContainerColor, long modalScrimColor, long modalContentColor, Composer $composer, int $changed, int i) {
        ...
        if ((i & 8) != 0) {
            ...
            modalScrimColor2 = Color.m5311copywmQWz5c(value, (14 & 1) != 0 ? Color.m5315getAlphaimpl(value) : 0.32f, (14 & 2) != 0 ? Color.m5319getRedimpl(value) : 0.0f, (14 & 4) != 0 ? Color.m5318getGreenimpl(value) : 0.0f, (14 & 8) != 0 ? Color.m5316getBlueimpl(value) : 0.0f);
        } else {
            modalScrimColor2 = modalScrimColor;
        }
        long modalContentColor2 = (i & 16) != 0 ? ColorSchemeKt.m2347contentColorForek8zF_U(modalContainerColor2, $composer, ($changed >> 6) & 14) : modalContentColor;
        if (ComposerKt.isTraceInProgress()) {
        ...
        WideNavigationRailColors wideNavigationRailColorsM3387copyt635Npw = getDefaultWideWideNavigationRailColors(MaterialTheme.INSTANCE.getColorScheme($composer, 6), $composer, ($changed >> 12) & 112).m3387copyt635Npw(containerColor2, contentColor2, modalContainerColor2, modalScrimColor2, modalContentColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        return wideNavigationRailColorsM3387copyt635Npw;
    }
    ...
    private final WideNavigationRailColors getDefaultWideWideNavigationRailColors(ColorScheme $this$defaultWideWideNavigationRailColors, Composer $composer, int $changed) {
        ...
        if (it != null) {
            ...
            long jM2346contentColorFor4WTKRHQ = ColorSchemeKt.m2346contentColorFor4WTKRHQ($this$defaultWideWideNavigationRailColors, getContainerColor($composer, ($changed >> 3) & 14));
            long modalContainerColor = getModalContainerColor($composer, ($changed >> 3) & 14);
            long jM2346contentColorFor4WTKRHQ2 = ColorSchemeKt.m2346contentColorFor4WTKRHQ($this$defaultWideWideNavigationRailColors, getModalContainerColor($composer, ($changed >> 3) & 14));
            long value = ColorSchemeKt.getValue(ScrimTokens.INSTANCE.getContainerColor(), $composer, 6);
            it = new WideNavigationRailColors(containerColor, jM2346contentColorFor4WTKRHQ, modalContainerColor, Color.m5311copywmQWz5c(value, (14 & 1) != 0 ? Color.m5315getAlphaimpl(value) : 0.32f, (14 & 2) != 0 ? Color.m5319getRedimpl(value) : 0.0f, (14 & 4) != 0 ? Color.m5318getGreenimpl(value) : 0.0f, (14 & 8) != 0 ? Color.m5316getBlueimpl(value) : 0.0f), jM2346contentColorFor4WTKRHQ2, null);
