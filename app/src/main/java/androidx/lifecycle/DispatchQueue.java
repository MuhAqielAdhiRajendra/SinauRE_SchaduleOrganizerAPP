...
public final class DispatchQueue {
    ...
    public final void dispatchAndEnqueue(CoroutineContext context, final Runnable runnable) {
        ...
        MainCoroutineDispatcher $this$dispatchAndEnqueue_u24lambda_u240 = Dispatchers.getMain().getImmediate();
        if ($this$dispatchAndEnqueue_u24lambda_u240.isDispatchNeeded(context) || canRun()) {
            $this$dispatchAndEnqueue_u24lambda_u240.mo10498dispatch(context, new Runnable() { // from class: androidx.lifecycle.DispatchQueue$$ExternalSyntheticLambda0
