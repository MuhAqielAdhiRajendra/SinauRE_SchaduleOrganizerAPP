...
public interface SoftKeyboardInterceptionModifierNode extends DelegatableNode {
    ...
    boolean mo6157onInterceptKeyBeforeSoftKeyboardZmokQxo(android.view.KeyEvent event);

    /* JADX INFO: renamed from: onPreInterceptKeyBeforeSoftKeyboard-ZmokQxo */
    boolean mo6158onPreInterceptKeyBeforeSoftKeyboardZmokQxo(android.view.KeyEvent event);
}
