...
class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
    ...
    NotificationCompatBuilder(NotificationCompat.Builder b) {
        ...
        this.mBuilder.setLargeIcon(b.mLargeIcon == null ? null : b.mLargeIcon.toIcon(this.mContext));
        ...
        if (b.mStyle instanceof NotificationCompat.CallStyle) {
            ...
            for (NotificationCompat.Action action2 : b.mActions) {
                addAction(action2);
            }
        }
        if (b.mExtras != null) {
        ...
        this.mBuilder.setLocalOnly(b.mLocalOnly);
        this.mBuilder.setGroup(b.mGroupKey);
        this.mBuilder.setSortKey(b.mSortKey);
        this.mBuilder.setGroupSummary(b.mGroupSummary);
        this.mGroupAlertBehavior = b.mGroupAlertBehavior;
        this.mBuilder.setCategory(b.mCategory);
        this.mBuilder.setColor(b.mColor);
        this.mBuilder.setVisibility(b.mVisibility);
        this.mBuilder.setPublicVersion(b.mPublicVersion);
        this.mBuilder.setSound(n.sound, n.audioAttributes);
        ...
        if (b.mSmallIcon != null) {
            this.mBuilder.setSmallIcon((Icon) b.mSmallIcon);
        }
        ...
        if (Build.VERSION.SDK_INT >= 36) {
            Api36Impl.setShortCriticalText(this.mBuilder, b.mShortCriticalText);
        }
        if (b.mSilent) {
    ...
    static final class Api36Impl {
        ...
        static Notification.Builder setShortCriticalText(Notification.Builder builder, String shortCriticalText) {
