...
public final class SplitPinRule extends SplitRule {
    ...
    public SplitPinRule(String tag, SplitAttributes defaultSplitAttributes, boolean isSticky, int minWidthDp, int minHeightDp, int minSmallestWidthDp, EmbeddingAspectRatio maxAspectRatioInPortrait, EmbeddingAspectRatio maxAspectRatioInLandscape) {
    ...
    public static final class Builder {
        ...
        public final Builder setDefaultSplitAttributes(SplitAttributes defaultSplitAttributes) {
            Intrinsics.checkNotNullParameter(defaultSplitAttributes, "defaultSplitAttributes");
            Builder $this$setDefaultSplitAttributes_u24lambda_u245 = this;
            $this$setDefaultSplitAttributes_u24lambda_u245.defaultSplitAttributes = defaultSplitAttributes;
            return this;
        }

        public final Builder setTag(String tag) {
            Builder $this$setTag_u24lambda_u246 = this;
            $this$setTag_u24lambda_u246.tag = tag;
            return this;
        }

        public final Builder setSticky(boolean isSticky) {
            Builder $this$setSticky_u24lambda_u247 = this;
            $this$setSticky_u24lambda_u247.isSticky = isSticky;
            return this;
        }
    ...
    public int hashCode() {
        ...
        return (result * 31) + Boolean.hashCode(this.isSticky);
    }
