...
/* JADX INFO: compiled from: FastFloatParser.kt */
/* JADX INFO: loaded from: classes12.dex */
@Metadata(d1 = {"\u0000>\n\u0000\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0010\u0014\n\u0002\b\u0005\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0010\u0007\n\u0002\b\u0004\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\u0010\f\n\u0002\b\n\u001a \u0010\u0013\u001a\u00020\f2\u0006\u0010\u0014\u001a\u00020\u00152\u0006\u0010\u0016\u001a\u00020\u00012\u0006\u0010\u0017\u001a\u00020\u0001H\u0000\u001a\u0019\u0010\"\u001a\u00020\f2\u0006\u0010\u000b\u001a\u00020\u00012\u0006\u0010#\u001a\u00020\u0010H\u0082\b\u001a\u0019\u0010$\u001a\u00020\f2\u0006\u0010%\u001a\u00020\f2\u0006\u0010&\u001a\u00020\fH\u0082\b\u001a\u0019\u0010'\u001a\u00020\u00012\u0006\u0010(\u001a\u00020\u00152\u0006\u0010)\u001a\u00020\u0001H\u0082\b\"\u000e\u0010\u0000\u001a\u00020\u0001X\u0082T¢\u0006\u0002\n\u0000\"\u000e\u0010\u0002\u001a\u00020\u0001X\u0082T¢\u0006\u0002\n\u0000\"\u000e\u0010\u0003\u001a\u00020\u0001X\u0082T¢\u0006\u0002\n\u0000\"\u000e\u0010\u0004\u001a\u00020\u0001X\u0082T¢\u0006\u0002\n\u0000\"\u001a\u0010\u0005\u001a\u00020\u0006X\u0080\u0004¢\u0006\u000e\n\u0000\u0012\u0004\b\u0007\u0010\b\u001a\u0004\b\t\u0010\n\"\u0019\u0010\u000b\u001a\u00020\u0001*\u00020\f8À\u0002X\u0080\u0004¢\u0006\u0006\u001a\u0004\b\r\u0010\u000e\"\u0019\u0010\u000f\u001a\u00020\u0010*\u00020\f8À\u0002X\u0080\u0004¢\u0006\u0006\u001a\u0004\b\u0011\u0010\u0012\"\u001c\u0010\u0018\u001a\u00020\u0019X\u0080\u0004¢\u0006\u0010\n\u0002\u0010\u001d\u0012\u0004\b\u001a\u0010\b\u001a\u0004\b\u001b\u0010\u001c\"\u0019\u0010\u001e\u001a\u00020\u001f*\u00020 8À\u0002X\u0080\u0004¢\u0006\u0006\u001a\u0004\b\u001e\u0010!¨\u0006*"}, d2 = {"FloatMinExponent", "", "FloatMaxExponent", "FloatSmallestExponent", "FloatMaxExponentNumber", "PowersOfTen", "", "getPowersOfTen$annotations", "()V", "getPowersOfTen", "()[F", "index", "", "getIndex", "(J)I", "floatValue", "", "getFloatValue", "(J)F", "nextFloat", "s", "", "start", "end", "Mantissa64", "Lkotlin/ULongArray;", "getMantissa64$annotations", "getMantissa64", "()[J", "[J", "isDigit", "", "", "(C)Z", "pack", "value", "fullMultiplicationHighBits", "x", "y", "parseFourDigits", "str", TypedValues.CycleType.S_WAVE_OFFSET, "ui-graphics"}, k = 2, mv = {2, 1, 0}, xi = 48)
public final class FastFloatParserKt {
    ...
    public static final float getFloatValue(long $this$floatValue) {
        int bits$iv = (int) (4294967295L & $this$floatValue);
    ...
    public static final long nextFloat(String s, int start, int end) {
        ...
        char c5 = ' ';
        if (start == end) {
            return (4294967295L & ((long) Float.floatToRawIntBits(Float.NaN))) | (((long) start) << 32);
        }
        int index2 = start;
        char c6 = s.charAt(index2);
        boolean isNegative = c6 == '-';
        if (isNegative) {
            index2++;
            if (index2 == end) {
                return (4294967295L & ((long) Float.floatToRawIntBits(Float.NaN))) | (((long) index2) << 32);
            }
            c6 = s.charAt(index2);
            j = 4294967295L;
            if (!(((char) (c6 + 65488)) < '\n') && c6 != '.') {
                return (((long) index2) << 32) | (((long) Float.floatToRawIntBits(Float.NaN)) & 4294967295L);
            }
        } else {
            j = 4294967295L;
        }
        ...
        while (true) {
            ...
            char $this$isDigit$iv = c6;
            c = c5;
            if (!(((char) ($this$isDigit$iv + 65488)) < '\n')) {
                break;
            }
            significand5 = (10 * significand5) + ((long) (c6 - '0'));
            index2++;
            c6 = index2 < dataLength ? s.charAt(index2) : (char) 0;
            c5 = c;
        }
        int significandEndIndex2 = index2;
        int digitCount = index2 - significandStartIndex;
        int exponent = 0;
        int exponentStartIndex = index2;
        int exponentEndIndex3 = index2;
        if (index2 == end || c6 != '.') {
            c2 = '0';
            exponentEndIndex = exponentEndIndex3;
        } else {
            index2++;
            exponentStartIndex = index2;
            while (true) {
                c2 = '0';
                if (end - index2 < 4) {
                    significand3 = significand5;
                    break;
                }
                int offset$iv = index2;
                significand3 = significand5;
                long significand6 = s.charAt(offset$iv);
                long v$iv = significand6 | (((long) s.charAt(offset$iv + 1)) << 16) | (((long) s.charAt(offset$iv + 2)) << c) | (((long) s.charAt(offset$iv + 3)) << 48);
                long base$iv = v$iv - 13511005043687472L;
                long predicate$iv = (v$iv + 19703549022044230L) | base$iv;
                int digits = (predicate$iv & (-35747867511423104L)) != 0 ? -1 : (int) ((281475406208040961L * base$iv) >>> 48);
                if (digits < 0) {
                    break;
                }
                significand5 = (10000 * significand3) + ((long) digits);
                index2 += 4;
            }
            c6 = index2 < dataLength ? s.charAt(index2) : (char) 0;
            long significand7 = significand3;
            while (true) {
                if (index2 == end) {
                    significand4 = significand7;
                    break;
                }
                char $this$isDigit$iv2 = c6;
                significand4 = significand7;
                if (!(((char) ($this$isDigit$iv2 + 65488)) < '\n')) {
                    break;
                }
                significand7 = (significand4 * 10) + ((long) (c6 - '0'));
                index2++;
                c6 = index2 < dataLength ? s.charAt(index2) : (char) 0;
            }
            exponent = exponentStartIndex - index2;
            int exponentEndIndex4 = index2;
            digitCount -= exponent;
            significand5 = significand4;
            exponentEndIndex = exponentEndIndex4;
        }
        if (digitCount == 0) {
            int index$iv = index2;
            long significand8 = index$iv;
            return (significand8 << c) | (((long) Float.floatToRawIntBits(Float.NaN)) & j);
        }
        long significand9 = significand5;
        int exponentNumber2 = 0;
        if ((c6 | ' ') == 101) {
            int index3 = index2 + 1;
            char c7 = index3 < dataLength ? s.charAt(index3) : (char) 0;
            boolean isExponentNegative = c7 == '-';
            if (isExponentNegative || c7 == '+') {
                index3++;
            }
            char index4 = s.charAt(index3);
            while (true) {
                if (index3 == end) {
                    c4 = index4;
                    index = index3;
                ...
                char $this$isDigit$iv3 = index4;
                c4 = index4;
                index = index3;
                if (!(((char) ($this$isDigit$iv3 + 65488)) < '\n')) {
                    break;
                }
                if (exponentNumber2 < 1024) {
                    exponentNumber2 = (exponentNumber2 * 10) + (c4 - '0');
                }
                int index5 = index + 1;
                index3 = index5;
                index4 = index5 < dataLength ? s.charAt(index5) : (char) 0;
            }
            if (isExponentNegative) {
                exponentNumber2 = -exponentNumber2;
            }
            exponent += exponentNumber2;
            c6 = c4;
            index2 = index;
        }
        if (digitCount > 19) {
            int retryIndex = significandStartIndex;
            c6 = s.charAt(retryIndex);
            while (index2 != end && (c6 == c2 || c6 == '.')) {
                if (c6 == '0') {
                    digitCount--;
                }
                retryIndex++;
                c6 = retryIndex < dataLength ? s.charAt(retryIndex) : (char) 0;
                c2 = '0';
            }
            if (digitCount > 19) {
                boolean tooManyDigits2 = true;
                long significand10 = 0;
                int retryIndex2 = significandStartIndex;
                c6 = s.charAt(retryIndex2);
                while (true) {
                    exponentNumber = exponentNumber2;
                    if (retryIndex2 == significandEndIndex2) {
                        tooManyDigits = tooManyDigits2;
                        significandEndIndex = significandEndIndex2;
                        break;
                    }
                    tooManyDigits = tooManyDigits2;
                    significandEndIndex = significandEndIndex2;
                    if (Long.compare(ULong.m9103constructorimpl(significand10) ^ Long.MIN_VALUE, 1000000000000000000L ^ Long.MIN_VALUE) >= 0) {
                        break;
                    }
                    significand10 = (significand10 * 10) + ((long) (c6 - '0'));
                    retryIndex2++;
                    c6 = retryIndex2 < dataLength ? s.charAt(retryIndex2) : (char) 0;
                    exponentNumber2 = exponentNumber;
                    significandEndIndex2 = significandEndIndex;
                    tooManyDigits2 = tooManyDigits;
                }
                if (Long.compare(ULong.m9103constructorimpl(significand10) ^ Long.MIN_VALUE, 1000000000000000000L ^ Long.MIN_VALUE) >= 0) {
                    exponent = (significandEndIndex - retryIndex2) + exponentNumber;
                    significand = significand10;
                } else {
                    int retryIndex3 = exponentStartIndex;
                    c6 = s.charAt(retryIndex3);
                    for (j2 = 1000000000000000000L; retryIndex3 != exponentEndIndex && Long.compare(ULong.m9103constructorimpl(significand10) ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) < 0; j2 = 1000000000000000000L) {
                        significand10 = (significand10 * 10) + ((long) (c6 - '0'));
                        retryIndex3++;
                        c6 = retryIndex3 < dataLength ? s.charAt(retryIndex3) : (char) 0;
                    }
                    exponent = (exponentStartIndex - retryIndex3) + exponentNumber;
                    significand = significand10;
                }
            } else {
                tooManyDigits = false;
                significand = significand9;
            }
        } else {
            tooManyDigits = false;
            significand = significand9;
        }
        if (!(FloatMinExponent <= exponent && exponent < 11) || tooManyDigits) {
            significand2 = significand;
            c3 = c6;
            exponentEndIndex2 = exponentEndIndex;
        } else {
            c3 = c6;
            int exponentEndIndex5 = exponentEndIndex;
            if (Long.compare(ULong.m9103constructorimpl(significand) ^ Long.MIN_VALUE, ULong.m9103constructorimpl(16777216L) ^ Long.MIN_VALUE) <= 0) {
                float f = significand;
                float f2 = exponent < 0 ? f / PowersOfTen[-exponent] : f * PowersOfTen[exponent];
                float value$iv = isNegative ? -f2 : f2;
                int index$iv2 = index2;
                return (((long) index$iv2) << c) | (((long) Float.floatToRawIntBits(value$iv)) & j);
            }
            significand2 = significand;
            exponentEndIndex2 = exponentEndIndex5;
        }
        if (significand2 == 0) {
            float value$iv2 = isNegative ? -0.0f : 0.0f;
            int index$iv3 = index2;
            return (((long) Float.floatToRawIntBits(value$iv2)) & j) | (((long) index$iv3) << c);
        }
        if (!(-126 <= exponent && exponent < 128)) {
            String strSubstring = s.substring(start, index2);
            Intrinsics.checkNotNullExpressionValue(strSubstring, "substring(...)");
            float value$iv3 = Float.parseFloat(strSubstring);
            int index$iv4 = index2;
            return (((long) Float.floatToRawIntBits(value$iv3)) & j) | (((long) index$iv4) << c);
        }
        long significandFactor = ULongArray.m9163getsVKNKU(Mantissa64, exponent + 325);
        int lz = Long.numberOfLeadingZeros(significand2);
        long significand11 = significand2 << lz;
        long xLo$iv = significand11 & j;
        long xHi$iv = significand11 >>> c;
        long yLo$iv = significandFactor & j;
        long yHi$iv = significandFactor >>> c;
        long xTimesYHi$iv = xHi$iv * yHi$iv;
        long xTimesYMid$iv = xLo$iv * yHi$iv;
        long yTimesXMid$iv = xHi$iv * yLo$iv;
        long xTimesYLo$iv = xLo$iv * yLo$iv;
        long carry$iv = yTimesXMid$iv + (xTimesYLo$iv >>> c) + (xTimesYMid$iv & j);
        long upper = xTimesYHi$iv + (carry$iv >>> c) + (xTimesYMid$iv >>> c);
        int upperBit = (int) (upper >>> 63);
        long mantissa = upper >>> (upperBit + 9);
        int lz2 = lz + (upperBit ^ 1);
        if ((upper & 511) == 511 || ((upper & 511) == 0 && (mantissa & 3) == 1)) {
            String strSubstring2 = s.substring(start, index2);
            Intrinsics.checkNotNullExpressionValue(strSubstring2, "substring(...)");
            float value$iv4 = Float.parseFloat(strSubstring2);
            int index$iv5 = index2;
            return (((long) Float.floatToRawIntBits(value$iv4)) & j) | (((long) index$iv5) << c);
        }
        long mantissa2 = (mantissa + 1) >>> 1;
        if (mantissa2 >= 9007199254740992L) {
            mantissa2 = 4503599627370496L;
            lz2--;
        }
        long mantissa3 = mantissa2 & (-4503599627370497L);
        long adjustedExponent = ((((long) exponent) * 217706) >> 16) + 1024 + 63;
        long adjustedExponent2 = lz2;
        long realExponent = adjustedExponent - adjustedExponent2;
        if (realExponent >= 1 && realExponent <= 2046) {
            float value$iv5 = (float) Double.longBitsToDouble(mantissa3 | (realExponent << 52) | (isNegative ? Long.MIN_VALUE : 0L));
            int index$iv6 = index2;
            return (((long) Float.floatToRawIntBits(value$iv5)) & j) | (((long) index$iv6) << c);
        }
        String strSubstring3 = s.substring(start, index2);
        Intrinsics.checkNotNullExpressionValue(strSubstring3, "substring(...)");
        float value$iv6 = Float.parseFloat(strSubstring3);
        int index$iv7 = index2;
        return (((long) Float.floatToRawIntBits(value$iv6)) & j) | (((long) index$iv7) << c);
    }
    ...
    private static final long pack(int index, float value) {
        return (((long) index) << 32) | (((long) Float.floatToRawIntBits(value)) & 4294967295L);
    }
    ...
    private static final long fullMultiplicationHighBits(long x, long y) {
        ...
        return (carry >>> 32) + xTimesYHi + (xTimesYMid >>> 32);
    }
