...
public final class CharSequenceListSerializer implements KSerializer<List<? extends CharSequence>> {
    ...
    public void serialize(Encoder encoder, List<? extends CharSequence> value) {
        ...
        SavedStateWriter.m8620putCharSequenceListimpl($this$serialize_u24lambda_u242_u24lambda_u241, $this$serialize_u24lambda_u242.getKey(), value);
    }
    ...
    public List<CharSequence> deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m8542getCharSequenceListimpl($this$deserialize_u24lambda_u245_u24lambda_u244, $this$deserialize_u24lambda_u245.getKey());
    }
}
