...
public final class CollectionTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
        ...
        TypeAdapter<?> wrappedTypeAdapter = new TypeAdapterRuntimeTypeWrapper<>(gson, gson.getAdapter(TypeToken.get(elementType)), elementType);
        ObjectConstructor<T> constructor = this.constructorConstructor.get(typeToken, false);
