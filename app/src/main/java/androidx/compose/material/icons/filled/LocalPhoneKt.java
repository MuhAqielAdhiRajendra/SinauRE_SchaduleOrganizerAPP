...
public final class LocalPhoneKt {
    ...
    public static final ImageVector getLocalPhone(Icons.Filled $this$LocalPhone) {
        if (_localPhone != null) {
        ...
        ImageVector.Builder $this$_get_LocalPhone__u24lambda_u241 = new ImageVector.Builder("Filled.LocalPhone", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
