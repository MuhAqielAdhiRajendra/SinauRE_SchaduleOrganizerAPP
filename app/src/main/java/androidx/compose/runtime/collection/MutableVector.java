...
public final class MutableVector<T> implements RandomAccess {
    ...
    */
    public final boolean contains(T r8) {
        /*
            r7 = this;
            r0 = 0
            r1 = r7
        ...
        L1e:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.collection.MutableVector.contains(java.lang.Object):boolean");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final boolean containsAll(androidx.compose.runtime.collection.MutableVector<T> r8) {
        /*
            r7 = this;
            r0 = r8
            r1 = 0
        ...
        L28:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.collection.MutableVector.containsAll(androidx.compose.runtime.collection.MutableVector):boolean");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final boolean contentEquals(androidx.compose.runtime.collection.MutableVector<T> r10) {
        /*
            r9 = this;
            int r0 = r10.size
            int r1 = r9.size
        ...
        L2d:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.collection.MutableVector.contentEquals(androidx.compose.runtime.collection.MutableVector):boolean");
    }
    ...
    public final <R> R fold(R initial, Function2<? super R, ? super T, ? extends R> operation) {
        ...
        int size = getSize();
        for (int i = 0; i < size; i++) {
            rInvoke = operation.invoke(rInvoke, tArr[i]);
        }
        return rInvoke;
    }
    ...
    public final <R> R foldIndexed(R initial, Function3<? super Integer, ? super R, ? super T, ? extends R> operation) {
        ...
        int size = getSize();
        for (int i = 0; i < size; i++) {
            rInvoke = operation.invoke(Integer.valueOf(i), rInvoke, tArr[i]);
        }
        return rInvoke;
    }
    ...
    public final <R> R foldRight(R initial, Function2<? super T, ? super R, ? extends R> operation) {
        ...
        while (size >= 0) {
            rInvoke = operation.invoke(tArr[size], rInvoke);
            size--;
        }
        return rInvoke;
    }
    ...
    public final <R> R foldRightIndexed(R initial, Function3<? super Integer, ? super T, ? super R, ? extends R> operation) {
        ...
        while (size >= 0) {
            rInvoke = operation.invoke(Integer.valueOf(size), tArr[size], rInvoke);
            size--;
        }
        return rInvoke;
    }
    ...
    public final boolean removeAll(MutableVector<T> elements) {
        ...
        if (0 <= size) {
            while (true) {
                int index$iv = i;
                remove(elements.content[index$iv]);
                if (i == size) {
                    break;
                }
                i++;
    ...
    public final void removeIf(Function1<? super T, Boolean> predicate) {
        ...
        while (true) {
            ...
            if (i2 < size) {
                ...
                ArraysKt.fill(tArr, (Object) null, size - i, size);
                setSize(size - i);
                return;
            }
        }
    ...
    public final boolean retainAll(Collection<? extends T> elements) {
        ...
        for (int i = getSize() - 1; -1 < i; i--) {
            int index$iv = i;
            Object item = this.content[index$iv];
    ...
    /* JADX INFO: compiled from: MutableVector.kt */
    @Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010+\n\u0000\n\u0002\u0010!\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\t\b\u0002\u0018\u0000*\u0004\b\u0001\u0010\u00012\b\u0012\u0004\u0012\u0002H\u00010\u0002B\u001d\u0012\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00028\u00010\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0004\b\u0007\u0010\bJ\t\u0010\t\u001a\u00020\nH\u0096\u0002J\u000e\u0010\u000b\u001a\u00028\u0001H\u0096\u0002¢\u0006\u0002\u0010\fJ\b\u0010\r\u001a\u00020\u000eH\u0016J\b\u0010\u000f\u001a\u00020\nH\u0016J\b\u0010\u0010\u001a\u00020\u0006H\u0016J\r\u0010\u0011\u001a\u00028\u0001H\u0016¢\u0006\u0002\u0010\fJ\b\u0010\u0012\u001a\u00020\u0006H\u0016J\u0015\u0010\u0013\u001a\u00020\u000e2\u0006\u0010\u0014\u001a\u00028\u0001H\u0016¢\u0006\u0002\u0010\u0015J\u0015\u0010\u0016\u001a\u00020\u000e2\u0006\u0010\u0014\u001a\u00028\u0001H\u0016¢\u0006\u0002\u0010\u0015R\u0014\u0010\u0003\u001a\b\u0012\u0004\u0012\u00028\u00010\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0017"}, d2 = {"Landroidx/compose/runtime/collection/MutableVector$VectorListIterator;", "T", "", "list", "", "index", "", "<init>", "(Ljava/util/List;I)V", "hasNext", "", "next", "()Ljava/lang/Object;", "remove", "", "hasPrevious", "nextIndex", "previous", "previousIndex", "add", "element", "(Ljava/lang/Object;)V", "set", "runtime"}, k = 1, mv = {2, 1, 0}, xi = 48)
