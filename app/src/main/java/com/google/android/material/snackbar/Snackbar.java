...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
        ...
        if (TextUtils.isEmpty(text) || listener == null) {
            ...
            tv.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.snackbar.Snackbar$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    this.f$0.m8882lambda$setAction$0$comgoogleandroidmaterialsnackbarSnackbar(listener, view);
                }
            });
        }
        return this;
    ...
    /* synthetic */ void m8882lambda$setAction$0$comgoogleandroidmaterialsnackbarSnackbar(View.OnClickListener listener, View view) {
        listener.onClick(view);
        dispatchDismiss(1);
    }

    public Snackbar setCloseIconVisible(boolean visible) {
        Button closeButton = getCloseViewOrThrow();
        int newVisibility = visible ? 0 : 8;
        closeButton.setVisibility(newVisibility);
        closeButton.setOnClickListener(visible ? new View.OnClickListener() { // from class: com.google.android.material.snackbar.Snackbar$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.m8883x429a879c(view);
            }
        } : null);
        getSnackbarLayout().removeOrRestorePaddingEnd(visible);
        return this;
    }

    /* JADX INFO: renamed from: lambda$setCloseIconVisible$1$com-google-android-material-snackbar-Snackbar, reason: not valid java name */
    /* synthetic */ void m8883x429a879c(View v) {
        dismiss();
    }

    public Snackbar setCloseIconTint(int tint) {
        return setCloseIconTintList(ColorStateList.valueOf(tint));
    }

    public Snackbar setCloseIconTintList(ColorStateList tintList) {
        getCloseViewOrThrow().setIconTint(tintList);
        return this;
    }

    public Snackbar setCloseIconDrawable(Drawable icon) {
        getCloseViewOrThrow().m8785x11712a47(icon);
        return this;
    }

    public Snackbar setCloseIconResource(int iconResourceId) {
