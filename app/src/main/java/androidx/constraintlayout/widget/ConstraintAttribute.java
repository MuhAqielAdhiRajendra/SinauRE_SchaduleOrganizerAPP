    ...
    public static HashMap<String, ConstraintAttribute> extractAttributes(HashMap<String, ConstraintAttribute> base, View view) {
        ...
        for (String name : base.keySet()) {
            ...
            try {
                ...
                Log.e(TAG, " Custom Attribute \"" + name + "\" not found on " + cls.getName(), e);
            } catch (NoSuchMethodException e2) {
                Log.e(TAG, cls.getName() + " must have a method " + name, e2);
            ...
            try {
                switch (constraintAttribute.mType) {
                    ...
                    case FLOAT_TYPE:
                        ...
                        method2.invoke(view, Float.valueOf(constraintAttribute.mFloatValue));
                        break;
                    case COLOR_TYPE:
                        Method method3 = cls.getMethod(methodName, Integer.TYPE);
                        method3.invoke(view, Integer.valueOf(constraintAttribute.mColorValue));
                        break;
                    case COLOR_DRAWABLE_TYPE:
                    ...
                    case REFERENCE_TYPE:
                        ...
                        method8.invoke(view, Integer.valueOf(constraintAttribute.mIntegerValue));
                        break;
                }
            } catch (IllegalAccessException e) {
                Log.e(TAG, " Custom Attribute \"" + name + "\" not found on " + cls.getName(), e);
            } catch (NoSuchMethodException e2) {
                Log.e(TAG, cls.getName() + " must have a method " + methodName, e2);
            } catch (InvocationTargetException e3) {
                Log.e(TAG, " Custom Attribute \"" + name + "\" not found on " + cls.getName(), e3);
            }
        }
    ...
    public void applyCustom(View view) {
        ...
        try {
            switch (this.mType) {
                ...
                case FLOAT_TYPE:
                    Method method2 = cls.getMethod(methodName, Float.TYPE);
                    method2.invoke(view, Float.valueOf(this.mFloatValue));
                    break;
                case COLOR_TYPE:
                    Method method3 = cls.getMethod(methodName, Integer.TYPE);
                    method3.invoke(view, Integer.valueOf(this.mColorValue));
                    break;
                case COLOR_DRAWABLE_TYPE:
                    Method method4 = cls.getMethod(methodName, Drawable.class);
                    ColorDrawable drawable = new ColorDrawable();
                ...
                case STRING_TYPE:
                    Method method5 = cls.getMethod(methodName, CharSequence.class);
                    method5.invoke(view, this.mStringValue);
                    break;
                case BOOLEAN_TYPE:
                    Method method6 = cls.getMethod(methodName, Boolean.TYPE);
                    method6.invoke(view, Boolean.valueOf(this.mBooleanValue));
                    break;
                case DIMENSION_TYPE:
                    Method method7 = cls.getMethod(methodName, Float.TYPE);
