...
public class TooltipDrawable extends MaterialShapeDrawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private float calculatePointerOffset() {
        int i = ((this.displayFrame.right - getBounds().right) - this.locationOnScreenX) - this.layoutMargin;
        Rect rect = this.displayFrame;
        if (i < 0) {
            float pointerOffset = ((rect.right - getBounds().right) - this.locationOnScreenX) - this.layoutMargin;
