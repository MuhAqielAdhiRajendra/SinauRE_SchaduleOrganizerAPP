...
public final class SettingsVoiceKt {
    ...
    public static final ImageVector getSettingsVoice(Icons.Outlined $this$SettingsVoice) {
        ...
        ImageVector.Builder $this$_get_SettingsVoice__u24lambda_u241 = new ImageVector.Builder("Outlined.SettingsVoice", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(6.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, 0.56f, -0.44f, 1.0f, -1.0f, 1.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(6.7f, 13.0f, 6.7f, 10.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(3.28f, -0.49f, 6.0f, -3.31f, 6.0f, -6.72f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
