...
@DebugMetadata(c = "androidx.compose.ui.text.font.AsyncFontListLoader$load$2$typeface$1", f = "FontListFontFamilyTypefaceAdapter.kt", i = {}, l = {282}, m = "invokeSuspend", n = {}, s = {}, v = 1)
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                Object objLoadWithTimeoutOrNull$ui_text = this.this$0.loadWithTimeoutOrNull$ui_text(this.$font, this);
                if (objLoadWithTimeoutOrNull$ui_text == coroutine_suspended) {
                    return coroutine_suspended;
                }
                return objLoadWithTimeoutOrNull$ui_text;
            case 1:
                ResultKt.throwOnFailure($result);
                return $result;
            default:
