...
public final class SafetyCheckKt {
    ...
    public static final ImageVector getSafetyCheck(Icons.Rounded $this$SafetyCheck) {
        ...
        ImageVector.Builder $this$_get_SafetyCheck__u24lambda_u241 = new ImageVector.Builder("Rounded.SafetyCheck", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(11.5f, 9.22f, 11.72f, 9.0f, 12.0f, 9.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.28f, 0.0f, 0.5f, 0.22f, 0.5f, 0.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(2.29f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(1.5f, 1.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(14.2f, 13.49f, 14.2f, 13.8f, 14.0f, 14.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
