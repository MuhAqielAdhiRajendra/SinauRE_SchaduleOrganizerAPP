...
public final class PathIteratorPreApi34Impl extends PathIteratorImpl {
    ...
    public PathIteratorPreApi34Impl(Path path, PathIterator.ConicEvaluation conicEvaluation, float tolerance) {
