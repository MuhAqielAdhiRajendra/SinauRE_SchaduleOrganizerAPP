...
public final class BackStackEntryIdViewModel extends ViewModel {
    ...
    public BackStackEntryIdViewModel(SavedStateHandle handle) {
        String it = (String) handle.get(this.IdKey);
        if (it == null) {
            it = NavComposeUtils_androidKt.randomUUID();
