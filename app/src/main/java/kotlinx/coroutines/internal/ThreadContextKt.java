...
public final class ThreadContextKt {
    ...
    static final Object countAll$lambda$0(Object countOrElement, CoroutineContext.Element element) {
    ...
    static final ThreadContextElement<?> findOne$lambda$1(ThreadContextElement<?> threadContextElement, CoroutineContext.Element element) {
    ...
    static final ThreadState updateState$lambda$2(ThreadState state, CoroutineContext.Element element) {
        if (element instanceof ThreadContextElement) {
