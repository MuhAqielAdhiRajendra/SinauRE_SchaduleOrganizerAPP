...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static PrecomputedTextCompat create(CharSequence text, Params params) {
        ...
        try {
            ...
            int i2 = text.length();
            StaticLayout.Builder.obtain(text, 0, i2, params.getTextPaint(), Integer.MAX_VALUE).setBreakStrategy(params.getBreakStrategy()).setHyphenationFrequency(params.getHyphenationFrequency()).setTextDirection(params.getTextDirection()).build();
