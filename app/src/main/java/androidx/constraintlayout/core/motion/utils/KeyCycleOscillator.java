...
public abstract class KeyCycleOscillator {
    ...
    private static class CoreSpline extends KeyCycleOscillator {
        ...
        CoreSpline(String str) {
            this.mType = str;
            this.mTypeId = TypedValues.CycleType.getId(this.mType);
        }
    ...
    static class CycleOscillator {
        ...
        public double getValues(float time) {
            if (this.mCurveFit != null) {
                ...
                this.mSplineValueCache[0] = this.mOffsetArr[0];
                this.mSplineValueCache[1] = this.mPhaseArr[0];
        ...
        public double getSlope(float time) {
            ...
            return this.mSplineSlopeCache[0] + (this.mSplineSlopeCache[2] * waveValue) + (this.mSplineValueCache[2] * waveSlope);
        }
