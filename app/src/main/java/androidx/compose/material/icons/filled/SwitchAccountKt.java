...
public final class SwitchAccountKt {
    ...
    public static final ImageVector getSwitchAccount(Icons.Filled $this$SwitchAccount) {
        ...
        ImageVector.Builder $this$_get_SwitchAccount__u24lambda_u241 = new ImageVector.Builder("Filled.SwitchAccount", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -1.99f, 4.0f, -3.0f, 6.0f, -3.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(6.0f, 1.01f, 6.0f, 3.0f);
