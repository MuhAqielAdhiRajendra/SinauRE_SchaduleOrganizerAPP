...
public final class DoorbellKt {
    ...
    public static final ImageVector getDoorbell(Icons.Rounded $this$Doorbell) {
        if (_doorbell != null) {
        ...
        ImageVector.Builder $this$_get_Doorbell__u24lambda_u241 = new ImageVector.Builder("Rounded.Doorbell", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(16.0f, 15.78f, 15.78f, 16.0f, 15.5f, 16.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
