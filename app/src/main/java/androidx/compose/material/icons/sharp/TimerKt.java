...
public final class TimerKt {
    ...
    public static final ImageVector getTimer(Icons.Sharp $this$Timer) {
        if (_timer != null) {
        ...
        ImageVector.Builder $this$_get_Timer__u24lambda_u241 = new ImageVector.Builder("Sharp.Timer", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
