...
@DebugMetadata(c = "androidx.compose.foundation.text.CoreTextFieldKt$CoreTextField$5$1", f = "CoreTextField.kt", i = {}, l = {363}, m = "invokeSuspend", n = {}, s = {}, v = 1)
final class CoreTextFieldKt$CoreTextField$5$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    CoreTextFieldKt$CoreTextField$5$1(LegacyTextFieldState legacyTextFieldState, State<Boolean> state, TextInputService textInputService, TextFieldSelectionManager textFieldSelectionManager, ImeOptions imeOptions, Continuation<? super CoreTextFieldKt$CoreTextField$5$1> continuation) {
        ...
        try {
            switch (this.label) {
                case 0:
                    ...
                    Flow flowSnapshotFlow = SnapshotStateKt.snapshotFlow(new Function0() { // from class: androidx.compose.foundation.text.CoreTextFieldKt$CoreTextField$5$1$$ExternalSyntheticLambda0
                        @Override // kotlin.jvm.functions.Function0
                        public final Object invoke() {
                            return Boolean.valueOf(CoreTextFieldKt.CoreTextField$lambda$14(state));
                        }
                    });
                    ...
                    this.label = 1;
                    if (flowSnapshotFlow.collect(new FlowCollector() { // from class: androidx.compose.foundation.text.CoreTextFieldKt$CoreTextField$5$1.2
                        ...
                        public final Object emit(boolean writeable, Continuation<? super Unit> continuation) {
                            if (!writeable || !legacyTextFieldState.getHasFocus()) {
