    ...
    AnchoredDraggableState$draggableState$1(final AnchoredDraggableState<T> anchoredDraggableState) {
        ...
        this.dragScope = new DragScope() { // from class: androidx.compose.material3.internal.AnchoredDraggableState$draggableState$1$dragScope$1
            ...
            public void dragBy(float pixels) {
                AnchoredDragScope $this$dragBy_u24lambda_u240 = ((AnchoredDraggableState) anchoredDraggableState).anchoredDragScope;
                AnchoredDragScope.dragTo$default($this$dragBy_u24lambda_u240, anchoredDraggableState.newOffsetForDelta$material3(pixels), 0.0f, 2, null);
            }
        };
    }
