...
public final class ColumnScopeInstance implements ColumnScope {
    ...
    public Modifier weight(Modifier $this$weight, float weight, boolean fill) {
        boolean value$iv = ((double) weight) > 0.0d;
        if (!value$iv) {
    ...
    @Override // androidx.compose.foundation.layout.ColumnScope
    public Modifier alignBy(Modifier $this$alignBy, final Function1<? super Measured, Integer> function1) {
        return $this$alignBy.then(new WithAlignmentLineBlockElement(new AlignmentLineProviderBlock() { // from class: androidx.compose.foundation.layout.ColumnScopeInstance$$ExternalSyntheticLambda0
