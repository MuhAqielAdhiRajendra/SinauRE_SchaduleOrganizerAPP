...
public final class AnimationState<T, V extends AnimationVector> implements State<T> {
    ...
    public AnimationState(TwoWayConverter<T, V> twoWayConverter, T t, V v, long j, long j2, boolean z) {
        ...
        this.velocityVector = (v == null || (v2 = (V) AnimationVectorsKt.copy(v)) == null) ? (V) AnimationStateKt.createZeroVectorFrom(this.typeConverter, t) : v2;
