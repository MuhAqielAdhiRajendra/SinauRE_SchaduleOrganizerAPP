...
public final class PolicyKt {
    ...
    public static final ImageVector getPolicy(Icons.Outlined $this$Policy) {
        if (_policy != null) {
        ...
        ImageVector.Builder $this$_get_Policy__u24lambda_u241 = new ImageVector.Builder("Outlined.Policy", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, 1.85f, -0.51f, 3.65f, -1.38f, 5.21f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-1.45f, -1.45f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(1.29f, -1.94f, 1.07f, -4.58f, -0.64f, -6.29f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(1.71f, 1.71f, 4.35f, 1.92f, 6.29f, 0.64f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(1.72f, 1.72f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-1.19f, 1.42f, -2.73f, 2.51f, -4.47f, 3.04f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(7.98f, 19.69f, 5.0f, 15.52f, 5.0f, 11.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _policy = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_Policy__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
