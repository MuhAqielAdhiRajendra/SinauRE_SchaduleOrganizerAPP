...
public final class RedoKt {
    ...
    public static final ImageVector getRedo(Icons.AutoMirrored.Sharp $this$Redo) {
        if (_redo != null) {
        ...
        ImageVector.Builder $this$_get_Redo__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Sharp.Redo", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
