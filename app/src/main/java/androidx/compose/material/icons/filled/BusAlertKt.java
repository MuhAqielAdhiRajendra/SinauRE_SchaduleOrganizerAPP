...
public final class BusAlertKt {
    ...
    public static final ImageVector getBusAlert(Icons.Filled $this$BusAlert) {
        if (_busAlert != null) {
        ...
        ImageVector.Builder $this$_get_BusAlert__u24lambda_u241 = new ImageVector.Builder("Filled.BusAlert", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.arcToRelative(7.0f, 7.0f, 0.0f, false, false, -5.78f, 3.05f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.arcTo(7.0f, 7.0f, 0.0f, false, false, 16.0f, 1.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.arcToRelative(5.0f, 5.0f, 0.0f, true, true, 0.0f, -10.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.arcToRelative(5.0f, 5.0f, 0.0f, false, true, 0.0f, 10.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(-2.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _busAlert = ImageVector.Builder.m6044addPathoIyEayM$default($this$_get_BusAlert__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
