...
final class CacheDrawModifierNodeImpl extends Modifier.Node implements CacheDrawModifierNode, ObserverModifierNode, BuildDrawCacheParams {
    ...
    public CacheDrawModifierNodeImpl(CacheDrawScope cacheDrawScope, Function1<? super CacheDrawScope, DrawResult> function1) {
        ...
        this.cacheDrawScope.setCacheParams$ui(this);
        this.cacheDrawScope.setGraphicsContextProvider$ui(new Function0<GraphicsContext>() { // from class: androidx.compose.ui.draw.CacheDrawModifierNodeImpl.1
            {
                super(0);
            }
    ...
    public long mo4846getSizeNHjbRc() {
        return IntSizeKt.m8333toSizeozmzZPI(DelegatableNodeKt.m6955requireCoordinator64DMado(this, NodeKind.m7100constructorimpl(4)).mo6791getSizeYbymL2g());
    }
    ...
    private final DrawResult getOrBuildCachedDrawBlock(ContentDrawScope contentDrawScope) {
        if (!this.isCacheValid) {
            final CacheDrawScope $this$getOrBuildCachedDrawBlock_u24lambda_u240 = this.cacheDrawScope;
            $this$getOrBuildCachedDrawBlock_u24lambda_u240.setDrawResult$ui(null);
            $this$getOrBuildCachedDrawBlock_u24lambda_u240.setContentDrawScope$ui(contentDrawScope);
            ObserverModifierNodeKt.observeReads(this, new Function0<Unit>() { // from class: androidx.compose.ui.draw.CacheDrawModifierNodeImpl$getOrBuildCachedDrawBlock$1$1
                ...
                public final void invoke2() {
                    this.this$0.getBlock().invoke($this$getOrBuildCachedDrawBlock_u24lambda_u240);
                }
            });
            Object value$iv = $this$getOrBuildCachedDrawBlock_u24lambda_u240.getDrawResult();
            if (value$iv != null) {
    ...
    public void draw(ContentDrawScope $this$draw) {
        getOrBuildCachedDrawBlock($this$draw).getBlock$ui().invoke($this$draw);
    }
}
