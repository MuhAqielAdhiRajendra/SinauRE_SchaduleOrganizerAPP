...
public final class CompareArrowsKt {
    ...
    public static final ImageVector getCompareArrows(Icons.AutoMirrored.TwoTone $this$CompareArrows) {
        ...
        ImageVector.Builder $this$_get_CompareArrows__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.TwoTone.CompareArrows", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
