...
public final class PreferenceDataStoreFactory {
    ...
    public final DataStore<Preferences> create(ReplaceFileCorruptionHandler<Preferences> corruptionHandler, List<? extends DataMigration<Preferences>> migrations, CoroutineScope scope, final Function0<? extends File> produceFile) {
        ...
        Intrinsics.checkNotNullParameter(produceFile, "produceFile");
        DataStore delegate = DataStoreFactory.INSTANCE.create(PreferencesSerializer.INSTANCE, corruptionHandler, migrations, scope, new Function0<File>() { // from class: androidx.datastore.preferences.core.PreferenceDataStoreFactory$create$delegate$1
            ...
            public final File invoke() {
                File file = produceFile.invoke();
                if (!Intrinsics.areEqual(FilesKt.getExtension(file), PreferencesSerializer.INSTANCE.getFileExtension())) {
