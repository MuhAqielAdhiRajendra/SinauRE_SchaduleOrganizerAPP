...
public final class NoLuggageKt {
    ...
    public static final ImageVector getNoLuggage(Icons.Outlined $this$NoLuggage) {
        if (_noLuggage != null) {
        ...
        ImageVector.Builder $this$_get_NoLuggage__u24lambda_u241 = new ImageVector.Builder("Outlined.NoLuggage", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(17.65f, 20.91f, 17.34f, 21.0f, 17.0f, 21.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(12.75f, 9.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(9.84f, 7.01f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(18.1f, 6.0f, 19.0f, 6.9f, 19.0f, 8.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
