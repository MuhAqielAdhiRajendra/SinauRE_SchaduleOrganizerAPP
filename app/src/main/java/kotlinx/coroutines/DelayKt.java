...
public final class DelayKt {
    ...
    */
    public static final java.lang.Object awaitCancellation(kotlin.coroutines.Continuation<?> r9) {
        /*
            boolean r0 = r9 instanceof kotlinx.coroutines.DelayKt.AnonymousClass1
            if (r0 == 0) goto L14
            r0 = r9
    ...
    public static final Object delay(long timeMillis, Continuation<? super Unit> continuation) {
        ...
        if (timeMillis < Long.MAX_VALUE) {
            getDelay(cont.getContext()).mo10499scheduleResumeAfterDelay(timeMillis, cont);
        }
    ...
    public static final Object m10425delayVtjQ1oo(long duration, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m10426toDelayMillisLRDsOJo(duration), continuation);
    ...
    public static final long m10426toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        boolean zM10307isPositiveimpl = Duration.m10307isPositiveimpl($this$toDelayMillis_u2dLRDsOJo);
        if (zM10307isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m10291getInWholeMillisecondsimpl(Duration.m10309plusLRDsOJo($this$toDelayMillis_u2dLRDsOJo, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM10307isPositiveimpl) {
