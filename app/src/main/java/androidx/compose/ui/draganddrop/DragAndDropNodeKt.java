...
public final class DragAndDropNodeKt {
    ...
    public static final boolean m4826containsUv8p0NA(DragAndDropNode $this$contains_u2dUv8p0NA, long positionInRoot) {
        ...
        long arg0$iv = LayoutCoordinatesKt.positionInRoot(currentCoordinates);
        ...
        float x2 = ((int) ($this$contains_u2dUv8p0NA.getSize() >> 32)) + x1;
        float y2 = ((int) ($this$contains_u2dUv8p0NA.getSize() & 4294967295L)) + y1;
        int bits$iv$iv$iv = (int) (positionInRoot >> 32);
        float fIntBitsToFloat = Float.intBitsToFloat(bits$iv$iv$iv);
        if (x1 <= fIntBitsToFloat && fIntBitsToFloat <= x2) {
            int bits$iv$iv$iv2 = (int) (positionInRoot & 4294967295L);
            float fIntBitsToFloat2 = Float.intBitsToFloat(bits$iv$iv$iv2);
            if (y1 <= fIntBitsToFloat2 && fIntBitsToFloat2 <= y2) {
                return true;
            }
        }
        return false;
