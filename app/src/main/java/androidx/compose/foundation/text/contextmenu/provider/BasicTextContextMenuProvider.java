...
public final class BasicTextContextMenuProvider implements TextContextMenuProvider {
    ...
    public Object showTextContextMenu(TextContextMenuDataProvider dataProvider, Continuation<? super Unit> continuation) {
        ...
        Object objMutate$default = MutatorMutex.mutate$default(this.mutatorMutex, null, new AnonymousClass2(localSession, null), continuation, 1, null);
    ...
    public final void ContextMenu(final Function0<? extends LayoutCoordinates> function0, Composer $composer, final int $changed) {
        ...
        if (!$composer2.shouldExecute(($dirty & 19) != 18, $dirty & 1)) {
            ...
            if (session != null) {
                function02 = function0;
                this.contextMenuBlock.invoke(session, session.getDataProvider(), function02, $composer2, Integer.valueOf(($dirty << 6) & 896));
                if (ComposerKt.isTraceInProgress()) {
                ...
                if (scopeUpdateScopeEndRestartGroup != null) {
                    scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.foundation.text.contextmenu.provider.BasicTextContextMenuProvider$$ExternalSyntheticLambda0
                        ...
                        public final Object invoke(Object obj, Object obj2) {
                            return BasicTextContextMenuProvider.ContextMenu$lambda$0(this.f$0, function0, $changed, (Composer) obj, ((Integer) obj2).intValue());
                        }
                    });
                    return;
                }
        ...
        if (scopeUpdateScopeEndRestartGroup2 != null) {
            scopeUpdateScopeEndRestartGroup2.updateScope(new Function2() { // from class: androidx.compose.foundation.text.contextmenu.provider.BasicTextContextMenuProvider$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return BasicTextContextMenuProvider.ContextMenu$lambda$1(this.f$0, function02, $changed, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
