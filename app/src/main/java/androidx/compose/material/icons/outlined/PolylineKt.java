...
public final class PolylineKt {
    ...
    public static final ImageVector getPolyline(Icons.Outlined $this$Polyline) {
        if (_polyline != null) {
        ...
        ImageVector.Builder $this$_get_Polyline__u24lambda_u241 = new ImageVector.Builder("Outlined.Polyline", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
