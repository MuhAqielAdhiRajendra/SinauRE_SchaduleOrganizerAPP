...
public final class TocKt {
    ...
    public static final ImageVector getToc(Icons.TwoTone $this$Toc) {
        if (_toc != null) {
        ...
        ImageVector.Builder $this$_get_Toc__u24lambda_u241 = new ImageVector.Builder("TwoTone.Toc", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
