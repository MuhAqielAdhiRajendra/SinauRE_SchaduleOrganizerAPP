...
public final class WifiPasswordKt {
    ...
    public static final ImageVector getWifiPassword(Icons.Filled $this$WifiPassword) {
        ...
        ImageVector.Builder $this$_get_WifiPassword__u24lambda_u241 = new ImageVector.Builder("Filled.WifiPassword", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(15.53f, 17.46f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(12.0f, 21.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-3.53f, -3.54f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(9.37f, 16.56f, 10.62f, 16.0f, 12.0f, 16.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(14.63f, 16.56f, 15.53f, 17.46f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
