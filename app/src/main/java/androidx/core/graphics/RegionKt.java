...
public final class RegionKt {
    ...
    public static final Region minus(Region $this$minus, Region r) {
        Region $this$minus_u24lambda_u241 = new Region($this$minus);
        $this$minus_u24lambda_u241.op(r, Region.Op.DIFFERENCE);
        return $this$minus_u24lambda_u241;
    }

    public static final Region unaryMinus(Region $this$unaryMinus) {
        Region $this$unaryMinus_u24lambda_u240 = new Region($this$unaryMinus.getBounds());
        $this$unaryMinus_u24lambda_u240.op($this$unaryMinus, Region.Op.DIFFERENCE);
        return $this$unaryMinus_u24lambda_u240;
    }

    public static final Region not(Region $this$not) {
        Region $this$unaryMinus_u24lambda_u240$iv = new Region($this$not.getBounds());
        $this$unaryMinus_u24lambda_u240$iv.op($this$not, Region.Op.DIFFERENCE);
        return $this$unaryMinus_u24lambda_u240$iv;
    }
    ...
    public static final Region and(Region $this$and, Rect r) {
        Region $this$and_u24lambda_u240 = new Region($this$and);
        $this$and_u24lambda_u240.op(r, Region.Op.INTERSECT);
        return $this$and_u24lambda_u240;
    }

    public static final Region and(Region $this$and, Region r) {
        Region $this$and_u24lambda_u241 = new Region($this$and);
        $this$and_u24lambda_u241.op(r, Region.Op.INTERSECT);
    ...
    public static final Region xor(Region $this$xor, Region r) {
        Region $this$xor_u24lambda_u241 = new Region($this$xor);
        $this$xor_u24lambda_u241.op(r, Region.Op.XOR);
