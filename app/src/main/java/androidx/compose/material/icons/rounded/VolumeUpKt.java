...
public final class VolumeUpKt {
    ...
    public static final ImageVector getVolumeUp(Icons.Rounded $this$VolumeUp) {
        if (_volumeUp != null) {
        ...
        ImageVector.Builder $this$_get_VolumeUp__u24lambda_u241 = new ImageVector.Builder("Rounded.VolumeUp", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
