...
public final class ImageNotSupportedKt {
    ...
    public static final ImageVector getImageNotSupported(Icons.Outlined $this$ImageNotSupported) {
        ...
        ImageVector.Builder $this$_get_ImageNotSupported__u24lambda_u241 = new ImageVector.Builder("Outlined.ImageNotSupported", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-6.1f, -6.1f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(6.84f, 6.84f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(11.0f, 15.72f);
