...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public void setDisplayOptions(int newOpts) {
        ...
        if (changed != 0) {
            ...
            if ((changed & 16) != 0 && this.mCustomView != null) {
                ...
                if (i2 != 0) {
                    toolbar2.addView(this.mCustomView);
                } else {
                    toolbar2.removeView(this.mCustomView);
                }
            }
        }
    }
    ...
    private void ensureSpinner() {
        if (this.mSpinner == null) {
            ...
            Toolbar.LayoutParams lp = new Toolbar.LayoutParams(-2, -2, NavigationBarView.ITEM_GRAVITY_START_CENTER);
    ...
    private void updateNavigationIcon() {
        ...
        Toolbar toolbar = this.mToolbar;
        if (i != 0) {
            toolbar.setNavigationIcon(this.mNavIcon != null ? this.mNavIcon : this.mDefaultNavigationIcon);
        } else {
