...
public final class NoteKt {
    ...
    public static final ImageVector getNote(Icons.Rounded $this$Note) {
        if (_note != null) {
        ...
        ImageVector.Builder $this$_get_Note__u24lambda_u241 = new ImageVector.Builder("Rounded.Note", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
