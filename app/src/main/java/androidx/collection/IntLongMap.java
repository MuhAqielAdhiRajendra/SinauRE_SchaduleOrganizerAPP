...
public abstract class IntLongMap {
            ...
            if ((((~slot$iv) << 7) & slot$iv & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (j$iv < bitCount$iv) {
                    ...
                    if (!(value$iv$iv < 128)) {
                        ...
                        i = i2;
                        block.invoke(Integer.valueOf(k2[index$iv]), Long.valueOf(v[index$iv]));
                    }
                    slot$iv >>= i;
                    j$iv++;
                    i2 = i;
    ...
    */
    ...
    public static /* synthetic */ String joinToString$default(IntLongMap intLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        ...
        return intLongMap.joinToString(charSequence, charSequence2, charSequence3, i, (i2 & 16) != 0 ? "..." : charSequence4);
    }
    ...
    public boolean equals(Object other) {
        ...
        boolean z4 = false;
        if (!(obj instanceof IntLongMap) || ((IntLongMap) obj).get_size() != get_size()) {
            return false;
        }
        int $i$f$forEach = 0;
        int[] k$iv = this.keys;
            ...
            if ($this$maskEmptyOrDeleted$iv$iv$iv == -9187201950435737472L) {
                ...
                while (j$iv$iv < bitCount$iv$iv) {
                    ...
                    if (!(value$iv$iv$iv < 128 ? z5 : z6)) {
                        ...
                        long value = v$iv[index$iv$iv];
                        i = index;
                        int index2 = ((IntLongMap) obj).findKeyIndex(key);
                        if (index2 < 0 || value != ((IntLongMap) other).values[index2]) {
                            break loop0;
                        }
                    }
                    slot$iv$iv >>= i;
