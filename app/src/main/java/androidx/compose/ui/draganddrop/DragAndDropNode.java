...
public final class DragAndDropNode extends Modifier.Node implements TraversableNode, DragAndDropModifierNode, DragAndDropSourceModifierNode, DragAndDropTargetModifierNode, DragAndDropTarget {
    ...
    public final void m4822setSizeozmzZPI$ui(long j) {
        this.size = j;
    }
    ...
    public void mo4821requestDragAndDropTransferk4lQ0M(long offset) {
        boolean value$iv = this.onStartTransfer != null;
        if (!value$iv) {
            InlineClassHelperKt.throwIllegalStateException("Check failed.");
        }
        getDragAndDropManager().mo4817requestDragAndDropTransferUv8p0NA(this, offset);
    }

    /* JADX INFO: renamed from: startDragAndDropTransfer-d-4ec7I, reason: not valid java name */
    public final void m4823startDragAndDropTransferd4ec7I(final DragAndDropStartTransferScope $this$startDragAndDropTransfer_u2dd_u2d4ec7I, final long offset, final Function0<Boolean> function0) {
        ...
        DragAndDropNodeKt.traverseSelfAndDescendants(this, new Function1<DragAndDropNode, TraversableNode.Companion.TraverseDescendantsAction>() { // from class: androidx.compose.ui.draganddrop.DragAndDropNode$startDragAndDropTransfer$1
            ...
            public final TraversableNode.Companion.TraverseDescendantsAction invoke(DragAndDropNode currentNode) {
                if (currentNode.getIsAttached()) {
                    Function2 onStartTransfer = currentNode.onStartTransfer;
                    if (onStartTransfer == null) {
                        return TraversableNode.Companion.TraverseDescendantsAction.ContinueTraversal;
                    }
                    if (!Offset.m5065equalsimpl0(offset, Offset.INSTANCE.m5083getUnspecifiedF1C5BW0())) {
                        LayoutCoordinates currentCoordinates = DelegatableNodeKt.requireLayoutNode(currentNode).getCoordinates();
                        long localPosition = currentCoordinates.mo6792localPositionOfR5De75A(nodeCoordinates, offset);
                        if (!SizeKt.m5158toRectuvyYCjk(IntSizeKt.m8333toSizeozmzZPI(currentNode.getSize())).m5094containsk4lQ0M(localPosition)) {
                            return TraversableNode.Companion.TraverseDescendantsAction.ContinueTraversal;
                        }
                        onStartTransfer.invoke($this$startDragAndDropTransfer_u2dd_u2d4ec7I, Offset.m5057boximpl(localPosition));
                    } else {
                        onStartTransfer.invoke($this$startDragAndDropTransfer_u2dd_u2d4ec7I, Offset.m5057boximpl(Offset.INSTANCE.m5083getUnspecifiedF1C5BW0()));
                    }
    ...
    public void mo4819drag12SF9DM(final DragAndDropTransferData transferData, final long decorationSize, final Function1<? super DrawScope, Unit> drawDragDecoration) {
        boolean value$iv = this.onStartTransfer == null;
        if (!value$iv) {
            InlineClassHelperKt.throwIllegalStateException("Check failed.");
        }
        this.onStartTransfer = new Function2<DragAndDropStartTransferScope, Offset, Unit>() { // from class: androidx.compose.ui.draganddrop.DragAndDropNode$drag$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(DragAndDropStartTransferScope dragAndDropStartTransferScope, Offset offset) {
                m4824invokeUv8p0NA(dragAndDropStartTransferScope, offset.m5078unboximpl());
                return Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: invoke-Uv8p0NA, reason: not valid java name */
            public final void m4824invokeUv8p0NA(DragAndDropStartTransferScope dragAndDropStartTransferScope, long it) {
                dragAndDropStartTransferScope.mo4818startDragAndDropTransfer12SF9DM(transferData, decorationSize, drawDragDecoration);
            }
        };
        getDragAndDropManager().mo4817requestDragAndDropTransferUv8p0NA(this, Offset.INSTANCE.m5083getUnspecifiedF1C5BW0());
        ...
        DragAndDropNodeKt.traverseSelfAndDescendants(this, new Function1<DragAndDropNode, TraversableNode.Companion.TraverseDescendantsAction>() { // from class: androidx.compose.ui.draganddrop.DragAndDropNode.acceptDragAndDropTransfer.1
            ...
            public final TraversableNode.Companion.TraverseDescendantsAction invoke(DragAndDropNode currentNode) {
                if (currentNode.getIsAttached()) {
                    ...
                    Function1 function1 = currentNode.onDropTargetValidate;
                    currentNode.thisDragAndDropTarget = function1 != null ? (DragAndDropTarget) function1.invoke(startEvent) : null;
                    boolean accepted = currentNode.thisDragAndDropTarget != null;
                    if (accepted) {
                        this.getDragAndDropManager().registerTargetInterest(currentNode);
                    }
    ...
    public void onMoved(final DragAndDropEvent event) {
        ...
        boolean z = false;
        if (currentChildNode != null && DragAndDropNodeKt.m4826containsUv8p0NA(currentChildNode, DragAndDrop_androidKt.getPositionInRoot(event))) {
            z = true;
        }
        if (z) {
            ...
            if ($this$firstDescendantOrNull$iv.getNode().getIsAttached()) {
                ...
                TraversableNodeKt.traverseDescendants($this$firstDescendantOrNull$iv, new Function1<DragAndDropNode, TraversableNode.Companion.TraverseDescendantsAction>() { // from class: androidx.compose.ui.draganddrop.DragAndDropNode$onMoved$$inlined$firstDescendantOrNull$1
                    ...
                    public final TraversableNode.Companion.TraverseDescendantsAction invoke(DragAndDropNode dragAndDropNode) {
                        ...
                        if (this.getDragAndDropManager().isInterestedTarget(child) && DragAndDropNodeKt.m4826containsUv8p0NA(child, DragAndDrop_androidKt.getPositionInRoot(event))) {
                ...
                traversableNode = (TraversableNode) match$iv.element;
            } else {
                traversableNode = null;
            }
            newChildNode = (DragAndDropNode) traversableNode;
        }
