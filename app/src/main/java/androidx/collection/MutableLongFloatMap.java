...
public final class MutableLongFloatMap extends LongFloatMap {
    ...
    */
    ...
    public final void dropDeletes$collection() {
        ...
        long[] metadata = mutableLongFloatMap.metadata;
        int capacity = mutableLongFloatMap._capacity;
        long[] keys = mutableLongFloatMap.keys;
        float[] values = mutableLongFloatMap.values;
        ...
        while (index != capacity) {
            ...
            if (m == 128) {
                ...
                int $i$f$h1 = hash >>> 7;
                int i = hash1;
                int targetIndex = mutableLongFloatMap.findFirstAvailableSlot($i$f$h1);
    ...
    public final void resizeStorage$collection(int newCapacity) {
        ...
        long[] newMetadata = mutableLongFloatMap.metadata;
