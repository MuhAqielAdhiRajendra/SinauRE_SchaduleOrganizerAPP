...
public final class ForwardToInboxKt {
    ...
    public static final ImageVector getForwardToInbox(Icons.AutoMirrored.Rounded $this$ForwardToInbox) {
        ...
        ImageVector.Builder $this$_get_ForwardToInbox__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Rounded.ForwardToInbox", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
