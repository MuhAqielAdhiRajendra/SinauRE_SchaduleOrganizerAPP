        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material3.CustomAppBarItem$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj, Object obj2) {
                    return CustomAppBarItem.AppbarContent$lambda$0(this.f$0, $changed, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    public void MenuContent(final AppBarMenuState state, Composer $composer, final int $changed) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material3.CustomAppBarItem$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return CustomAppBarItem.MenuContent$lambda$1(this.f$0, state, $changed, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
