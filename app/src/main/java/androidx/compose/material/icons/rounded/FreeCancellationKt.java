...
public final class FreeCancellationKt {
    ...
    public static final ImageVector getFreeCancellation(Icons.Rounded $this$FreeCancellation) {
        ...
        ImageVector.Builder $this$_get_FreeCancellation__u24lambda_u241 = new ImageVector.Builder("Rounded.FreeCancellation", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(10.79f, 20.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(2.96f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(6.45f, 2.0f, 6.0f, 2.45f, 6.0f, 3.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(1.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineTo(5.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(5.79f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.89f, 0.0f, 1.34f, -1.08f, 0.71f, -1.71f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(0.0f, 0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(11.31f, 20.11f, 11.06f, 20.0f, 10.79f, 20.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(13.71f, 18.26f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(13.32f, 19.28f, 13.32f, 18.65f, 13.71f, 18.26f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(11.29f, 16.29f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.39f, 0.39f, -1.02f, 0.39f, -1.41f, 0.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(0.88f, 0.88f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(11.68f, 15.27f, 11.68f, 15.9f, 11.29f, 16.29f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
