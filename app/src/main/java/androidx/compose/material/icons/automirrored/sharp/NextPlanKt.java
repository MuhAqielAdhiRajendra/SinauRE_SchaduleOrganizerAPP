...
public final class NextPlanKt {
    ...
    public static final ImageVector getNextPlan(Icons.AutoMirrored.Sharp $this$NextPlan) {
        if (_nextPlan != null) {
        ...
        ImageVector.Builder $this$_get_NextPlan__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Sharp.NextPlan", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, true, 96, null);
