...
public final class AnimatedVisibilityComposeAnimation implements ComposeAnimation {
    ...
    private final Set<AnimatedVisibilityState> states = SetsKt.setOf((Object[]) new AnimatedVisibilityState[]{AnimatedVisibilityState.m8081boximpl(AnimatedVisibilityState.INSTANCE.m8088getEnterjXw82LU()), AnimatedVisibilityState.m8081boximpl(AnimatedVisibilityState.INSTANCE.m8089getExitjXw82LU())});
    ...
    public Transition<Boolean> m8072getAnimationObject() {
    ...
    public final Transition<Object> getChildTransition() {
        Object orNull = CollectionsKt.getOrNull(m8072getAnimationObject().getTransitions(), 0);
