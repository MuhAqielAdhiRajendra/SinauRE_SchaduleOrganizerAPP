...
public final class MusicOffKt {
    ...
    public static final ImageVector getMusicOff(Icons.Filled $this$MusicOff) {
        if (_musicOff != null) {
        ...
        ImageVector.Builder $this$_get_MusicOff__u24lambda_u241 = new ImageVector.Builder("Filled.MusicOff", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(5.18f);
