...
public final class SwipeLeftKt {
    ...
    public static final ImageVector getSwipeLeft(Icons.Rounded $this$SwipeLeft) {
        ...
        ImageVector.Builder $this$_get_SwipeLeft__u24lambda_u241 = new ImageVector.Builder("Rounded.SwipeLeft", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(3.5f, 4.02f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineTo(2.75f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(3.5f, 2.34f, 3.16f, 2.0f, 2.75f, 2.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(2.0f, 2.34f, 2.0f, 2.75f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(6.66f, 7.0f, 7.0f, 6.66f, 7.0f, 6.25f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveTo(6.66f, 5.5f, 6.25f, 5.5f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(4.42f, 0.0f, 7.27f, 2.19f, 8.25f, 4.1f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(20.37f, 6.85f, 20.63f, 7.0f, 20.91f, 7.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.56f, 0.0f, 0.93f, -0.59f, 0.67f, -1.08f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(20.3f, 3.39f, 16.81f, 1.0f, 12.0f, 1.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(8.78f, 1.0f, 5.82f, 2.13f, 3.5f, 4.02f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(5.2f, 17.43f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(5.3f, 17.94f, 5.2f, 17.69f, 5.2f, 17.43f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
