...
public final class RedeemKt {
    ...
    public static final ImageVector getRedeem(Icons.Outlined $this$Redeem) {
        if (_redeem != null) {
        ...
        ImageVector.Builder $this$_get_Redeem__u24lambda_u241 = new ImageVector.Builder("Outlined.Redeem", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
