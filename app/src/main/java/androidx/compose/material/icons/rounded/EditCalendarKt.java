...
public final class EditCalendarKt {
    ...
    public static final ImageVector getEditCalendar(Icons.Rounded $this$EditCalendar) {
        ...
        ImageVector.Builder $this$_get_EditCalendar__u24lambda_u241 = new ImageVector.Builder("Rounded.EditCalendar", $this$dp$iv$iv, $this$dp$iv$iv2, 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(3.01f, 6.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-5.01f, 5.01f);
