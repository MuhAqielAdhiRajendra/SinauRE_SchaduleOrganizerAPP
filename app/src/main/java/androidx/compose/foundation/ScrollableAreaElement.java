...
final class ScrollableAreaElement extends ModifierNodeElement<ScrollableAreaNode> {
    ...
    public ScrollableAreaElement(ScrollableState state, Orientation orientation, boolean enabled, boolean reverseScrolling, FlingBehavior flingBehavior, MutableInteractionSource interactionSource, BringIntoViewSpec bringIntoViewSpec, boolean useLocalOverscrollFactory, OverscrollEffect overscrollEffect) {
        this.state = state;
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        $this$inspectableProperties.setName("scrollableArea");
    ...
    public boolean equals(Object other) {
        ...
        if (Intrinsics.areEqual(this.state, ((ScrollableAreaElement) other).state) && this.orientation == ((ScrollableAreaElement) other).orientation && this.enabled == ((ScrollableAreaElement) other).enabled && this.reverseScrolling == ((ScrollableAreaElement) other).reverseScrolling && Intrinsics.areEqual(this.flingBehavior, ((ScrollableAreaElement) other).flingBehavior) && Intrinsics.areEqual(this.interactionSource, ((ScrollableAreaElement) other).interactionSource) && Intrinsics.areEqual(this.bringIntoViewSpec, ((ScrollableAreaElement) other).bringIntoViewSpec) && this.useLocalOverscrollFactory == ((ScrollableAreaElement) other).useLocalOverscrollFactory && Intrinsics.areEqual(this.overscrollEffect, ((ScrollableAreaElement) other).overscrollEffect)) {
            return true;
        }
        return false;
    }
