...
public final class DockedToolbarTokens {
    ...
    private static final float ContainerLeadingSpace = Dp.m8150constructorimpl((float) 16.0d);
    private static final float ContainerMaxSpacing = Dp.m8150constructorimpl((float) 32.0d);
    private static final float ContainerMinSpacing = Dp.m8150constructorimpl((float) 4.0d);
    private static final ShapeKeyTokens ContainerShape = ShapeKeyTokens.CornerNone;
    private static final float ContainerTrailingSpace = Dp.m8150constructorimpl((float) 16.0d);
    ...
    public final float m3781getContainerTrailingSpaceD9Ej5fM() {
